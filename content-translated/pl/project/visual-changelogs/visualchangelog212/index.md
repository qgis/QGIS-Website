...
section: projekt
sidebar: true
title: Wykaz zmian dla QGIS 2.12
type: visual-changelog

---
{{<content-start >}}
# Wykaz zmian dla QGIS 2.12{#changelog212 }
...
Dziękujemy programistom, osobom piszącym dokumentację, testerom i wszystkim osobom, które  w ramach wolontariatu poświęcają swój czas i wysiłek (lub znajdują chętnych do pomocy).

From the QGIS community we hope you enjoy this release! If you wish to donate time, money or otherwise get involved in making QGIS more awesome, please wander along to [qgis.org](https://qgis.org) and lend a hand!

Dziękujemy również naszym oficjalnym sponsorom za nieocenione wsparcie finansowe, które przekazują na rzecz rozwoju projektu:
...
{{<table-of-contents >}}
## General
### Funkcjonalność: Nowy ekran powitalny
Zamiast widoku pustego, białego płótna mapy, po otwarciu programu zobaczysz teraz listę ostatnich projektów wraz z ich miniaturami, aby łatwo i przyjemnie wrócić do pracy wykonywanej w ostatnich sesjach.
...
### Funkcjonalność: Kolejne ulepszenia jakości kodu
...
### Funkcjonalność: Edytor ustawień zaawansowanych
...
### Funkcjonalność: Wzajemne wykluczanie się warstw w grupach na liście warstw
Używając tej opcji możesz tworzyć grupy warstw, w których tylko jedna warstwa w grupie jest widoczna w tym samym czasie. Opcja jest uruchamiana indywidualnie dla grup w menu kontekstowym listy warstw.
...
### Funkcjonalność: Nowe funkcje wyrażeń w 2.12
...
Ponadto, kilka bardzo użytecznych wyrażeń zostało zaczerpniętych z wtyczki expressions+, włączając w to:
...
### Funkcjonalność: Zmienne i wyrażenia
...
Wyświetli etykietę w ten sposób:
...
### Funkcjonalność: Narzędzie wpasowywania rastrów
This new tool in qgis_analysis library is able to take several rasters as input and:
- przeprojektować do tego samego układu współrzędnych
- przepróbkować do tego samego rozmiaru komórki i offsetu
- przyciąć do obszaru zainteresowania
- przeskalować wartości według potrzeb
...
### Funkcje programu: Wtyczki sprawdzania i dociągania geometrii - Geometry Checker i Geometry Snapper
...
## Zarządzanie danymi
### Funkcjonalność: Ulepszenia Menadżera baz danych
...
## Wektoryzacja
### Funkcje programu: Usprawnienie wektoryzacji
...
### Funkcjonalność: Rysowanie etykiet, które zawierają się w poligonach
Do warstw poligonowych została dodana opcja umożliwiająca rysowanie tylko tych etykiet, które całkowicie mieszczą się w obiektach poligonowych.
...
### Funkcjonalność: Etykietowanie przy użyciu reguł
...
## Wydruki map
### Funkcje programu: Poprawa nawigacji w Atlasie
...
### Funkcjonalność: Opcja ukrycia stron z widoku/eksportu
...
**This feature was developed by:** [Nyall Dawson](http://nyalldawson.net/)
## Wtyczki
### Funkcje programu: Aktualizacja wtyczki GRASS
...
- Integracja przeglądarki QGIS z panelem przeglądania
- Wsparcie mapsetów, modułów i powłoki shell umożliwiające analizę danych
...
### Funkcjonalność : getMap w formacie dxf 
...
## Styl
### Funkcjonalność: Eksport miniaturek z menadżera stylów
...
- Możliwość ustawienia przezroczystości kolorów
...
### Funkcjonalność: Wszystkie palety kolorów są teraz edytowalne
...
### Funkcjonalność: Dodano piksele do wszystkich list wyboru opcji rozmiar symboli
