...
Algorytm zamienia wartości współrzędnych X i Y w geometrii wejściowej. Może być używany do naprawy geometrii, którym przypadkowo odwrócono wartości szerokości i długości geograficznej.
