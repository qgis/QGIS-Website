...
section: projekt
sidebar: true
title: Wykaz zmian dla QGIS 3.14
type: visual-changelog

---
{{<content-start >}}
# Wykaz zmian dla QGIS 3.14{#changelog314 }
...
1. Tworzenie losowej warstwy rastrowej (rozkład dwumianowy)
2. Tworzenie losowej warstwy rastrowej (rozkład wykładniczy)
3. Tworzenie losowej warstwy rastrowej (rozkład gamma)
4. Tworzenie losowej warstwy rastrowej (ujemny rozkład dwumianowy)
5. Tworzenie losowej warstwy rastrowej (rozkład normalny)
6. Tworzenie losowej warstwy rastrowej (rozkład Poissona)
7. Tworzenie losowej warstwy rastrowej (rozkład jednostajny)
...
| Fixes to numbered list handling in dox/PyQGIS API | unreported | [Commit 74400c7](https://github.com/qgis/QGIS/commit/74400c7ff88d563dad74dad41860f9b603214973) | Nie |
| Fix cross references in PyQGIS docs | unreported | [Commit 81a9db9](https://github.com/qgis/QGIS/commit/81a9db9f57706cba9b11e4372dd1bf50fcd7bc6a) | Nie |
