...
author: underdark
date: '2025-02-07'
description: 'Met het QGIS Grant Programme 2024 (Updates #1 & #2) waren we in staat
  7 aanvragen voor verbeteringen te ondersteunen die…'
draft: false
link: https://blog.qgis.org/2025/02/07/reports-from-the-winning-grant-proposals-2024/
sidebar: true
title: Rapporten van de winnende aanvragen voor financiële steun 2024

---
{{<content-start >}}

<p class="wp-block-paragraph">Met het <a href="https://blog.qgis.org/2024/05/01/qgis-grant-programme-2024-results/">QGIS Grant Programme 2024</a> (Updates <a href="https://blog.qgis.org/2024/05/08/qgis-grant-programme-2024-update/">#1</a> &amp; <a href="https://blog.qgis.org/2024/06/14/qgis-grant-programme-2024-update-no-2/">#2</a>) waren we in staat <a href="https://github.com/qgis/PSC/issues/60">7 aanvragen voor verbeteringen</a> te ondersteunen die het project verbeteren. De volgende rapporten vatten het uitgevoerde werk samen:  </p>
...
<p><a href="https://blog.qgis.org/2025/02/07/reports-from-the-winning-grant-proposals-2024/" target="_blank" rel="noopener noreferrer">Bekijk de originele post op blog.qgis.org ↗</a></p>
