...
| <span class="rm-current"> huidige</span> | <span class="rm-current"> momenteel ondersteunde uitgaven: {{< param "ltrrelease" >}} en {{< param "release" >}} </span> |
| <span class="rm-next"> volgende </span> | <span class="rm-next"> volgende uitgaven </span> |
