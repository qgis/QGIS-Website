...
Als u als Duits bedrijf of organisatie uw gift wilt aftrekken van de belasting, doneer dan via de Duitse QGIS gebruikersgroep. Zij kunnen u, als een van belasting vrijgestelde Duitse vereniging, een bevestiging van de betaling verschaffen.
...
## Donatie via Paypal
U kunt gebruik maken van PayPal om te doneren via uw eigen creditcard (maar wij hebben liever dat u Stripe daarvoor gebruikt). De betaling wordt verwerkt door PayPal, maar u hoeft geen account van PayPal te hebben of lid te worden als u wilt betalen met de creditcard.
