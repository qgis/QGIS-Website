...
![Tabel 1: Gazetteer databases](./images/usa_polczynski_table1.png){.align-right}
...
![Afbeelding 1: HGC-QGIS-Project.qgs geopend in QGIS.](./images/usa_polczynski_figure1.png){.align-right}
...
![Tabel 2: HGC databasevelden.](./images/usa_polczynski_table2.png){.align-right}
...
![Afbeelding 2: Openen van de URL ID voor Qarağy in een webbrowser.](./images/usa_polczynski_figure2.png){.align-right}
...
![Michael en Mark Polczynski](./images/usa_polczynski_authors.jpg){.align-left}
