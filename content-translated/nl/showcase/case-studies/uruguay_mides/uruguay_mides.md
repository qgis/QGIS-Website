...
![QGIS aan het werk: identificeren van huizen in informele nederzettingen om veldwerk te implementeren](./images/uruguay_mides1.png){.align-center}
...
![QGIS aan het werk: Montevideo, Uruguay’s hoofdstad en dichtstbevolkte stad, overlay met PostGIS-laag die nog te bezoeken plaatsen weergeeft (meestal bestaande uit sociaal kwetsbare huishoudens, aan de randen van de stad)](./images/uruguay_mides2.png){.align-center}
