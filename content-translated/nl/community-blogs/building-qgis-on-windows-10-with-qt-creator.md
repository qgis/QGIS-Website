...
showcase: planet
source: blog
title: 'ItOpen: QGIS bouwen op Windows 10 met Qt Creator'

---
<p class="lead clearfix">Gewoon een paar extra opmerkingen over hoe de laatste QGIS 3 master te bouwen op Win 10 64-bit, het basisdocument is: <a href="https://github.com/qgis/QGIS/blob/master/INSTALL">INSTALL</a></p>

<ul class="wp-block-list"><li>volg de instructies in het document INSTALL</li><li>installeer visual studio code (u heeft de &#8220;Visual C++&#8221; compiler tools nodig) vanafÂ <a href="http://download.microsoft.com/download/D/2/3/D23F4D0F-BA2D-4600-8725-6CCECEA05196/vs_community_ENU.exe">http://download.microsoft.com/download/D/2/3/D23F4D0F-BA2D-4600-8725-6CCECEA05196/vs_community_ENU.exe</a></li><li>installeer de Windows 10 SDK (u bent op zoek naar de debugger tools) vanaf <a href="https://developer.microsoft.com/en-US/windows/downloads/windows-10-sdk">https://developer.microsoft.com/en-US/windows/downloads/windows-10-sdk</a></li><li>installeer Qt Creator (alleen de IDE: geen Qt sources of pre-built binaries)</li><li>git clone QGIS en maak ene bouwmap</li><li>configureer Qt Creator kit zoals in de volgende afbeeldingen</li></ul>
...
<p>De configuratie voor de omgeving van de kit is:</p>
...
<p>Opmerking: Ik weet niet of al die variabelen echt nodig zijn, maar ze werkten voor mij.</p>
