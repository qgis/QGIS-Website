...
---
{{<content-start >}}
# Merci d'avoir choisi QGIS !
## Votre copie fraîchement préparée de QGIS est en cours de téléchargement.
{{<progress-bar autoHideAfter="60000" >}}

{{< rich-box-start icon="⬇️" layoutClass="tips">}} {{< rich-content-start themeClass="coloring-1" >}}
##### Surveillez votre téléchargement
...
Vous pouvez également consulter les études de cas – on y trouve de nombreuses histoires inspirantes.
...
[Local groups list]({{< ref "community/groups.md" >}}) {{< rich-content-end >}} {{< rich-right-start >}}<br />![Local user groups](../../project/img/groups.jpg "Local user groups") {{< rich-right-end >}} {{< rich-box-end >}}
