...
{{<content-start >}}
## Key features
{{<tabs tab1="Créer des cartes" tab2="Editer des couches" tab3="Traiter et analyser" tab4="Partager des cartes" >}}
...
{{< rich-box-start >}} {{< rich-content-start themeClass="coloring-6" >}}
### QGIS Desktop
Créez, éditez, visualisez, analysez et publiez des informations géographiques.
...
{{< rich-box-start >}} {{< rich-content-start themeClass="coloring-6" >}}
### QGIS sur les mobiles et les tablettes
