...
section: projet
sidebar: true
title: Modifications apportées par QGIS 3.22
type: visual-changelog

---
{{<content-start >}}
# Modifications apportées par QGIS 3.22{#changelog322 }
...
{{<table-of-contents >}}
## Annotations
### Fonctionnalité: Propriétés et effets de la couche d'annotation
Les propriétés supplémentaires pour les couches d'annotation sont désormais les suivantes :
- Une fenêtre de propriétés de la couche d'annotation, contenant des informations de base sur la couche et des options pour définir les plages d'échelle, l'opacité, le mode de fusion et les effets de dessin pour la couche.
...
### Fonctionnalité : Modification des nœuds dans un élément d'annotation
L'outil de modification des annotations peut désormais être utilisé pour modifier les nœuds d'un élément d'annotation en cliquant sur un nœud existant et en le déplaçant. Les interactions de l'utilisateur suivent les modèles standard de QGIS comme suit :
- Clic gauche pour commencer le déplacement
- Deuxième clic gauche pour appliquer les changements
- Clic droit pour annuler
- La sélection d'un nœud et l'appui sur la touche de suppression suppriment le nœud.
- Un double clic sur un segment ajoutera un nœud
...
This feature was developed by [Nyall Dawson](https://github.com/nyalldawson)
### Fonctionnalité : Déplacement de l'annotation sélectionnée à l'aide des touches du curseur
Lorsqu'un élément d'annotation est sélectionné, il peut être déplacé en appuyant sur les touches de curseur.

Cette fonctionnalité comprend la possibilité d'utiliser des raccourcis clavier de la même manière que pour les éléments de mise en page :
- `shift + cursor`: Big movement
- `alt + cursor`: 1px movement

This feature was developed by [Nyall Dawson](https://github.com/nyalldawson)
### Fonctionnalité : Outils de création d'éléments d'annotation ligne/polygone
Des fonctions permettant de créer de nouvelles annotation de type ligne et polygone ont été ajoutées aux outils d'annotation.

Celles-ci prennent en charge les mêmes interactions que les fonctions de dessin vectoriel, telles que l'accrochage, le traçage, l'ancrage des cadrans, le retour en arrière pour supprimer les sommets, les modes de numérisation des courbes et des flux, etc.

Cette fonctionnalité a été financée par le groupe Suisse des utilisateurs de QGIS.

This feature was developed by [Nyall Dawson](https://github.com/nyalldawson)
### Fonctionnalité : Nouvel outil de texte ponctuel
Un cadre a été créé pour que les outils cartographiques puissent créer de nouveaux éléments d'annotation, y compris la possibilité de créer de nouveaux éléments d'annotation en texte ponctuel.
...
This feature was developed by [Nyall Dawson](https://github.com/nyalldawson)
### Fonctionnalité : Barre d'outils des annotations
Une nouvelle barre d'outils d'annotations a été ajoutée qui fournit des actions suivantes :
- Créer une nouvelle couche d'annotation vide dans le projet actuel.
- The \"Modify Annotations\" tool, which provides an interface for editing existing annotations.

Les opérations prises en charge pour la fonction de modification des annotations sont les suivantes :
- Cliquezr sur une annotation existante pour la sélectionner, ses propriétés s'affichent dans le dock de style de la couche, notamment le symbole, l'échelle de référence, l'indice z, etc.
- Cliquez avec le bouton gauche de la souris sur un élément d'annotation sélectionné pour commencer à le déplacer. Un clic droit ou un échappement annule le déplacement, tandis qu'un second clic gauche confirme le déplacement.
- Si vous appuyez sur la touche de suppression alors qu'une annotation est sélectionnée, cette annotation sera supprimée.
...
### Fonctionnalité : Basculer l'édition sur plusieurs couches sélectionnées
...
### Fonctionnalité : Identification des groupes de couches et de toutes les couches sélectionnées
...
Cette fonctionnalité a été financée par North Road, merci à SLYR
...
- Indentation des éléments des groupes
- Indentation des éléments des sous-groupes
...
Cette fonctionnalité a été financée par QTIBIA Engineering
...
Par exemple, la requête suivante récupère tous les éléments situés dans un rayon de 50 unités cartographiques autour de la ligne fournie :
``` python
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | Correctif rétroporté sur la 3.16 (GitHub) | Remark |
| --- | --- | --- | --- | --- |
| WFS / GML parse issue, but QGIS loads GML as file fine? | [#45017](https://github.com/qgis/QGIS/issues/45017) | Pas un bug |  |  |
| POST request to modify timestamp does not respect defined format | [#44990](https://github.com/qgis/QGIS/issues/44990) | Non corrigé / pas un bug |  |  |
| Warning message \'Cannot create temporary SpatiaLite cache\' when adding many WFS-layers | [#44971](https://github.com/qgis/QGIS/issues/44971) | Doublon |  |  |
...
| QGIS on linux crashes when opening many geopackages at once | [#43620](https://github.com/qgis/QGIS/issues/43620) | [PR #45211](https://github.com/qgis/QGIS/pull/45211) | Non |  |
...
| QGIS crash after loading WMS layer via script and zooming in and out | [#44095](https://github.com/qgis/QGIS/issues/44095) | [PR #45254](https://github.com/qgis/QGIS/pull/45254) | Non | Mostly a usage issue |
| Integer unexpectedly large in GeoPackage | [#45178](https://github.com/qgis/QGIS/issues/45178) | Pas un bug |  |  |
...
| projecting label coordinates for multiPoint geometry crashes QGIS | [#45148](https://github.com/qgis/QGIS/issues/45148) | [PR #45150](https://github.com/qgis/QGIS/pull/45150) | Non |  |
...
| Attributes - Update All button - Creates Corrupted Fields - GeoJSON file | [#45139](https://github.com/qgis/QGIS/issues/45139) | [PR #45174](https://github.com/qgis/QGIS/pull/45174) | Non |  |
| WMS parent layer added via QGIS Browser doesn\'t use default style | [#45192](https://github.com/qgis/QGIS/issues/45192) | [PR #45209](https://github.com/qgis/QGIS/pull/45209) | Non |  |
...
| Copying table by Drag&Drop in Browser (2) doesn\'t copy the table structure correctly | [#45286](https://github.com/qgis/QGIS/issues/45286) | [PR #45375](https://github.com/qgis/QGIS/pull/45375) | Non |  |
...
| Create spatialite trigger with DBManager do not work | [#45420](https://github.com/qgis/QGIS/issues/45420) | [PR #45553](https://github.com/qgis/QGIS/pull/45553) | Non |  |
...
| macOS: Symbol not found: \_\_cg_jpeg_resync_to_restart when reprojecting raster layer with GDAL warp on macOS | [#40164](https://github.com/qgis/QGIS/issues/40164) | non | non | Not an issue with the nightly (qgis-deps-0.9) anymore |
...
| unable to open any ascii FLO-2D files in Mesh Layer | non signalé | [PR #45349](https://github.com/qgis/QGIS/pull/45349) | n/a |  |
...
### Bugs corrigés par by Sandro Santilli
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | Correctif rétroporté sur la 3.16 (GitHub) | Remark |
| --- | --- | --- | --- | --- |
| Make QgsGeos::prepareGeometry and QgsGeos::cacheGeos idempotent | non signalé | [PR #45147](https://github.com/qgis/QGIS/pull/45147) |  |  |
| Add a distanceWithin method to the QgsGeometryEngine virtual class | non signalé | [PR #45057](https://github.com/qgis/QGIS/pull/45057) |  |  |
| Allow calling testdata_pg.sh from any directory | non signalé | [PR #45378](https://github.com/qgis/QGIS/pull/45378) |  |  |
| Make TestPyQgsPostgresProvider.testGeneratedColumns idempotent | non signalé | [PR #45415](https://github.com/qgis/QGIS/pull/45415) |  |  |
| Improve PostgreSQL test DB setup documentation and script | non signalé | [PR #45413](https://github.com/qgis/QGIS/pull/45413) |  |  |
...
| Use GEOSDistanceWithin when available | non signalé | [PR #45340](https://github.com/qgis/QGIS/pull/45340) |  |  |
| Reduce GEOS conversions and preparations of geometries | non signalé | [PR #45195](https://github.com/qgis/QGIS/pull/45195) |  |  |
| More heuristics to determine whether to iterate over target source | non signalé | [PR #45339](https://github.com/qgis/QGIS/pull/45339) |  |  |

These bug fixes were funded by [QGIS.ORG (through donations and sustaining memberships)](https://www.qgis.org/)

Bugs fixed by [Sandro Santilli](https://strk.kbt.io/)
### Bugs corrigés par Loïc Bartoletti
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | Correctif rétroporté sur la 3.16 (GitHub) | Remark |
| --- | --- | --- | --- | --- |
...
| VertexTool. Fixes move vertex on Z layer if CRS are differents (with Vincent Cloarec) | Not reported | [PR #45020](https://github.com/qgis/QGIS/pull/45020) | Non rétroporté. Introduit de nouvelles méthodes. |  |
...
| Compile fails, \'None\' is not a member of \'QgsField::ConfigurationFlags\' | [#44681](https://github.com/qgis/QGIS/issues/44681) | Non corrigé / pas un bug |  |  |
| L'union échoue lorsqu'on utilise un point et une couche de polygone | [#44801](https://github.com/qgis/QGIS/issues/44801) | Différence entre GEOS 3.8 et 3.9 |  |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | Correctif rétroporté sur la 3.16 (GitHub) | Remark |
| --- | --- | --- | --- | --- |
| Régression : tenter d'exécuter l'algorithme de conversion de multiparties en monoparties génère une erreur python. | [#45331](https://github.com/qgis/QGIS/issues/45331) | [PR #45348](https://github.com/qgis/QGIS/pull/45348) |  |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | Correctif rétroporté sur la 3.16 (GitHub) | Remark |
| --- | --- | --- | --- | --- |
| Les styles dans la base de données ne fonctionnent pas pour le fournisseur postgres et les couches non géométriques | [#44749](https://github.com/qgis/QGIS/issues/44749) | [PR #45075](https://github.com/qgis/QGIS/pull/45075) | [PR #45102](https://github.com/qgis/QGIS/pull/45102) |  |
| \"Layer notes\" icon is not displayed when copy-pasting a style | [#44692](https://github.com/qgis/QGIS/issues/44692) | [PR #45302](https://github.com/qgis/QGIS/pull/45302) | pas nécessaire |  |
| Erreurs JSON ambiguës | [#42832](https://github.com/qgis/QGIS/issues/42832) | impossible à reproduire |  |  |
...
| La vue formulaire affiche des images jointes erronées lors du défilement des éléments. | [#42705](https://github.com/qgis/QGIS/issues/42705) | Déjà corrigé |  |  |
...
| Attachment widget options are reset when you reopen the field widget properties | [#45089](https://github.com/qgis/QGIS/issues/45089) | Doublon |  |  |
| Les attributs des entités effacées n'agissent pas comme s'ils avaient été effacés et empêchent l'enregistrement de la couche. | [#39146](https://github.com/qgis/QGIS/issues/39146) | [PR #45176](https://github.com/qgis/QGIS/pull/45176) | [PR #45292](https://github.com/qgis/QGIS/pull/45292) |  |
...
| a feature copy/paste sets a NULL field to its \"default value\" in a geopackage | [#44544](https://github.com/qgis/QGIS/issues/44544) | Question : Doit-on évaluer la valeur par défaut du champ NULL lors du copier-coller ? |  |  |
| Le générateur d'expressions de QGIS ne peut pas résoudre correctement les arrays de texte PostgreSQL | [#45290](https://github.com/qgis/QGIS/issues/45290) | [PR #45321](https://github.com/qgis/QGIS/pull/45321) |  |  |
...
| Correction d'un crash lors du rendu des entités et des formes découpées | [#45190](https://github.com/qgis/QGIS/issues/45190) | [Commit 6a4cdb36](https://github.com/qgis/QGIS/commit/6a4cdb36c91085c5bb1544fb02da1f83467a29d7) | [PR #45422](https://github.com/qgis/QGIS/pull/45422) |  |
| Correction d'un crash lors de l'utilisation des outils d'étiquetage des cartes avec des projets contenant des couches de tuiles vectorielles | [#44486](https://github.com/qgis/QGIS/issues/44486) | [PR #45311](https://github.com/qgis/QGIS/pull/45311) | [PR #45390](https://github.com/qgis/QGIS/pull/45390) |  |
| Correction de la taille des symboles en mètres à l'échelle ne peut être négative | [#45298](https://github.com/qgis/QGIS/issues/45298) | [Commit 360351a](https://github.com/qgis/QGIS/commit/360351a02704c370545fb8f92c0bdafbdfa35b2e) | Ne convient pas pour le backport |  |
| Correction de l'écrasement du style par défaut des couches de géopackage | [#42811](https://github.com/qgis/QGIS/issues/42811) | [Commit eef6939b96](https://github.com/qgis/QGIS/commit/eef6939b96407b3d050988be4a0eeb692ffc5b68) | [PR #45107](https://github.com/qgis/QGIS/pull/45107) |  |
...
| Update default toolbar locations | non signalé | [Commit 77be95feac](https://github.com/qgis/QGIS/commit/77be95feac7391e58f6bd487f30e09ed8ed63651) | N/A |  |
...
| Fix crash on exit with CAD dock open | non signalé | [Commit 1fb21f69f](https://github.com/qgis/QGIS/commit/1fb21f69fede05cabb8f1d27a8ad24564ae16f3d) | N/A |  |
...
| Avoid hangs when drawing symbol icons using inappropriate sizes in map units | [#41149](https://github.com/qgis/QGIS/issues/41149) | [PR #45233](https://github.com/qgis/QGIS/pull/45233) | Ne convient pas pour le backport |  |
| Fix inappropriate display of z/m values in cad dock when non-z/m layer is selected | non signalé | [Commit 55a76d1d](https://github.com/qgis/QGIS/commit/55a76d1d867c32f52ae4bd38ed671d44aa3ae92e) | N/A |  |
| Implement more responsive cancelation of map render for maps using complex effects | [#41149](https://github.com/qgis/QGIS/issues/41149) | [PR #45212](https://github.com/qgis/QGIS/pull/45212) | Ne convient pas pour le backport |  |
| Allow CAD dock to be used for geographic CRS, but only allow the x/y/z/m constraints to be set | non signalé | [PR #45185](https://github.com/qgis/QGIS/pull/45185) | Ne convient pas pour le backport |  |
...
| Fix QgsMapToolCapture coordinates when associated with a non-vector layer where the layer CRS != canvas CRS | non signalé | [PR #45183](https://github.com/qgis/QGIS/pull/45183) | N/A |  |
| Fix geometry generator rendering outside of vector layers | [#39159](https://github.com/qgis/QGIS/issues/39159) | [PR #45165](https://github.com/qgis/QGIS/pull/45165) | Ne convient pas pour le backport |  |
| Fix color customisation is lost when configuring renderers using geometry generators | [#38377](https://github.com/qgis/QGIS/issues/38377) | [PR #45166](https://github.com/qgis/QGIS/pull/45166) | Ne convient pas pour le backport |  |
...
| Fix digitizing features using CAD dock when layer CRS != canvas CRS | non signalé | [PR #45108](https://github.com/qgis/QGIS/pull/45108) | N/A |  |
| Correction du décalage de l'arrière-plan lors du dessin d'un texte pivoté | [#44907](https://github.com/qgis/QGIS/issues/44907) | [PR #45425](https://github.com/qgis/QGIS/pull/45425) | en cours |  |
| Échapper correctement les chaînes de caractères source complexes dans le journal de l'historique de traitement | [#45403](https://github.com/qgis/QGIS/issues/45403) | [PR #45426](https://github.com/qgis/QGIS/pull/45426) | en cours |  |
| Fix handling of ADF files in browser | non signalé | [PR #45393](https://github.com/qgis/QGIS/pull/45393) | Ne convient pas pour le backport |  |
