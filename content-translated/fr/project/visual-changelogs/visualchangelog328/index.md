...
section: projet
sidebar: true
title: Modifications apportées par QGIS 3.28
type: visual-changelog

---
{{<content-start >}}
# Modifications apportées par QGIS 3.28{#changelog328 }
...
Cette fonctionnalité a été financée par l’université d'Uppsala
...
| QGIS not responding when entering page size using custom width or height fields | [#50104](https://github.com/qgis/QGIS/issues/50104) | Ne peut pas se reproduire |  |
...
| Layer style panel and Layer panel do not show same visibility settings for layer style | [#49998](https://github.com/qgis/QGIS/issues/49998) | Ne peut pas se reproduire |  |
...
| unreported MSSQL connections API error | non signalé | [PR #50194](https://github.com/qgis/QGIS/pull/50194) | [PR #50454](https://github.com/qgis/QGIS/pull/50454) |
| Identify and select tools don\'t work with geometry-based query layers | [#50242](https://github.com/qgis/QGIS/issues/50242) | Ne peut pas se reproduire |  |
...
| Unreported endless alg splitwithlines | non signalé | [PR #50279](https://github.com/qgis/QGIS/pull/50279) | Not recommended |
| Processing algorithm \"Split with lines\" does not split polygon | [#50227](https://github.com/qgis/QGIS/issues/50227) | Pas un bug |  |
...
| Wrong interpretation of SLD color opacity | [#44657](https://github.com/qgis/QGIS/issues/44657) | Pas un bug |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | Correctif reporté sur la 3.22 (GitHub) |
| --- | --- | --- | --- |
| GML import is missing one feature without geometry | [#50215](https://github.com/qgis/QGIS/issues/50215) | [PR #50231](https://github.com/qgis/QGIS/pull/50231) | Inapproprié |
...
| \[Processing\] Fix typo in smoothing parameter name of gdal_grid algorithms | non signalé | [PR #50261](https://github.com/qgis/QGIS/pull/50261) | [PR #50331](https://github.com/qgis/QGIS/pull/50331) |
...
| QGIS ignores field inherited from parent feature type in WFS 2.0 services | [#42660](https://github.com/qgis/QGIS/issues/42660) | [PR #50300](https://github.com/qgis/QGIS/pull/50300) | Inapproprié |
...
| world_map.gpkg: little fix to avoid warning with recent GDAL versions | non signalé | [PR #50304](https://github.com/qgis/QGIS/pull/50304) | Not needed |
...
| Build fails with WITH_POSTGRESQL=OFF | [#50075](https://github.com/qgis/QGIS/issues/50075) | Retour d'informations |  |
...
| Cannot move labels | [#47542](https://github.com/qgis/QGIS/issues/47542) | Ne peut pas se reproduire |  |
...
| Fixes log messages when a job error is not related to a specific layer | non signalé | [PR #50372](https://github.com/qgis/QGIS/pull/50372) | Not needed |
...
| Improve selection of PostGIS raster overviews | non signalé | [PR #50554](https://github.com/qgis/QGIS/pull/50554) | [PR #50575](https://github.com/qgis/QGIS/pull/50575) |
...
| Include type name in message about unsupported qfield validations | non signalé | [PR #50589](https://github.com/qgis/QGIS/pull/50589) |  |
