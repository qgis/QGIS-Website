...
- Densité de ligne
- Raster aléatoire
- Filtre DTM (basé sur la pente)
- Fréquence de valeurs de pixel égales
...
| test_provider_ogr.py: do not alter source test data, to keep 'git status' clean | non signalé | [PR #58734](https://github.com/qgis/QGIS/pull/58734) | N/A |
...
| [BUGFIX] [PostgreSQL] Properly take into account 'name' type | non signalé | [PR #59147](https://github.com/qgis/QGIS/pull/59147) | À faire |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| QGIS Server filter does not work as expected for intersection filters | [#58220](https://github.com/qgis/QGIS/issues/58220) | Ne peut pas se reproduire |  |
...
| PostgreSQL authentication gets back to basic if a layer is opened with "execute SQL" from QGIS explorer panel | [#58784](https://github.com/qgis/QGIS/issues/58784) | Ne peut pas se reproduire |  |
...
| When using a computed or virtual field that refers to other layers's fields having the same name, the wrong value is returned | [#49469](https://github.com/qgis/QGIS/issues/49469) | [PR #58819](https://github.com/qgis/QGIS/pull/58819) | À faire |
...
| In layer Filter "lower" function not working with diacritical marks | [#58893](https://github.com/qgis/QGIS/issues/58893) | Ne peut pas se reproduire |  |
...
| Unwanted unique constraint added when exporting to geopackage, if not null constraint is applied via default style | [#58431](https://github.com/qgis/QGIS/issues/58431) | [PR #58986](https://github.com/qgis/QGIS/pull/58986) | Risqué? |
...
| Calling several times waitForFinished on task would cause a deadlock | non signalé | [PR #58799](https://github.com/qgis/QGIS/pull/58799) | Non |
...
| Fix unsafe use of QgsProject::instance from vector layer classes | non signalé | [PR #59118](https://github.com/qgis/QGIS/pull/59118) | Trop risqué |
| When excluding tests, only exclude exact matches | non signalé | [PR #59116](https://github.com/qgis/QGIS/pull/59116) | N/A |
| When layout scalebar settings are invalid, show warning message | non signalé | [PR #59088](https://github.com/qgis/QGIS/pull/59088) | N/A |
...
| QgsMapLayer::setDataSource don't require layer name, provider | non signalé | [PR #58953](https://github.com/qgis/QGIS/pull/58953) | N/A |
| Fix incompatibility between text wrapping and HTML text formatting | non signalé | [PR #58952](https://github.com/qgis/QGIS/pull/58952) | N/A |
...
| Fix missing canvas variables in some expression editors | non signalé | [PR #58907](https://github.com/qgis/QGIS/pull/58907) | [PR #58934](https://github.com/qgis/QGIS/pull/58934) |
...
| QgsDistanceArea methods should raise QgsCsException when errors occur | non signalé | [PR #58795](https://github.com/qgis/QGIS/pull/58795) | N/A |
| Don't apply reset-to-zero step size logic in spin boxes when no special value text is set | non signalé | [PR #58836](https://github.com/qgis/QGIS/pull/58836) | N/A |
...
| 3D view - completely flat MultiPolygonZ geometries don't show color correctly | [#52832](https://github.com/qgis/QGIS/issues/52832) | en cours |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix use of QgsReferencedGeometry in expressions | non signalé | [PR #59180](https://github.com/qgis/QGIS/pull/59180) |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Clipping of long WKT strings for geometry parameters by using our geometry widget | non signalé | [PR #59209](https://github.com/qgis/QGIS/pull/59209) | N/A |
...
| Bad styling of scrollbars in the plugin manager dialog | non signalé | [PR #58713](https://github.com/qgis/QGIS/pull/58713) | [PR #58721](https://github.com/qgis/QGIS/pull/58721) |
...
| Bad plugin manager's look on dark themes | non signalé | [PR #58606](https://github.com/qgis/QGIS/pull/58606) |  |
...
| Fix layout map item preview rendering of XYZ layers with known tile DPI | non signalé | [PR #58543](https://github.com/qgis/QGIS/pull/58543) | [PR #58566](https://github.com/qgis/QGIS/pull/58566) |
...
| Fix issue with vertical lines not visible in the elevation profile tool | non signalé | [PR #58959](https://github.com/qgis/QGIS/pull/58959) | N/A |
