...
| 0 port in OAuth2 callback URI | [#54562](https://github.com/qgis/QGIS/issues/54562) | Ne peut pas se reproduire | N/A |
| QGIS Crashes when editing multiple features simultaneously that have a Value Relation field | [#54164](https://github.com/qgis/QGIS/issues/54164) | [PR #54889](https://github.com/qgis/QGIS/pull/54889) | À faire |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgsgeos.cpp: fix a -Wunused-variable warning | non signalé | [PR #54612](https://github.com/qgis/QGIS/pull/54612) | N/A |
| qgsvirtualpointcloudprovider.cpp: add a missing variable initialization | non signalé | [PR #54613](https://github.com/qgis/QGIS/pull/54613) | N/A |
...
| Syntactical error with the use of == instead of = for comparison in the WHERE clause | [#54608](https://github.com/qgis/QGIS/issues/54608) | Déjà corrigé | Unable to write any additional layers to an existing FGDB |
...
| Spatial filtering of multipart polygons within a shapefile dataset broken | [GDAL issue 8481](https://github.com/OSGeo/gdal/issues/8481) | Pas un bug |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix segfault in coordinate transform | non signalé | [PR #54609](https://github.com/qgis/QGIS/pull/54609) | N/A |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Have QgsRectangle null rectangle printed as EMPTY in wkt | non signalé | [PR #54831](https://github.com/qgis/QGIS/pull/54831) | N/A |
| Fix aspect ratio computation in QgsLayoutItemMap::zoomToExtent | non signalé | [PR #54827](https://github.com/qgis/QGIS/pull/54827) | N/A |
| Do not include a BoundingBox tag in GetFeatureInfo responses, when it is null | non signalé | [PR #54858](https://github.com/qgis/QGIS/pull/54858) | N/A |
| Always run the spell and shell checkers if possible, print warning when not possible | non signalé | [PR #54847](https://github.com/qgis/QGIS/pull/54847) | N/A |
| Tweak Null rectangle handling | non signalé | [PR #54872](https://github.com/qgis/QGIS/pull/54872) | N/A |
| Run spellcheck only on changed files in prepare_commit.sh | non signalé | [PR #54893](https://github.com/qgis/QGIS/pull/54893) | N/A |
| Fix prepare_commit.sh | non signalé | [PR #54918](https://github.com/qgis/QGIS/pull/54918) | N/A |
| Fix extent computation in QgsSpatiaLiteProvider | non signalé | [PR #54917](https://github.com/qgis/QGIS/pull/54917) | N/A |
...
| Make QgsBookmark string output more explicit about it being EMPTY | non signalé | [PR #54923](https://github.com/qgis/QGIS/pull/54923) | N/A |
| Fix extent computation in QgsAFSProvider | non signalé | [PR #54944](https://github.com/qgis/QGIS/pull/54944) | N/A |
| Add `tags` make target | non signalé | [PR #54948](https://github.com/qgis/QGIS/pull/54948) | N/A |
| Handle null rectangles in QgsExtentWidget::outputExtent | non signalé | [PR #54953](https://github.com/qgis/QGIS/pull/54953) | N/A |
| Handle null in QgsRectangle grow() and include() methods | non signalé | [PR #54955](https://github.com/qgis/QGIS/pull/54955) | N/A |
| Add QgsRectangle::setNull(), deprecating setMinimal() | non signalé | [PR #54934](https://github.com/qgis/QGIS/pull/54934) | N/A |
| Handle Null rectangle in QgsRectangle::buffered | non signalé | [PR #54967](https://github.com/qgis/QGIS/pull/54967) | N/A |
| Fix extent computation in QgsVirtualLayerProvider | non signalé | [PR #54976](https://github.com/qgis/QGIS/pull/54976) | N/A |
| Add a QgsRectangle::createNull() temporary static method | non signalé | [PR #55008](https://github.com/qgis/QGIS/pull/55008) | N/A |
| Fix testRegisterFeatureUnprojectible - Use valid extent in testRegisterFeatureUnprojectible | non signalé | [PR #55011](https://github.com/qgis/QGIS/pull/55011) | N/A |
| Have QgsGeometry::boundingBox return null rect for null geom | non signalé | [PR #55012](https://github.com/qgis/QGIS/pull/55012) | N/A |
| Have QgsGeometry::fromRect(NULL RECT) return null geometry | non signalé | [PR #54954](https://github.com/qgis/QGIS/pull/54954) | N/A |
...
| Run doxygen layout checker in prepare-commit script, when possible | non signalé | [PR #54936](https://github.com/qgis/QGIS/pull/54936) | N/A |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgs3daxissettings: Correctly read viewport ratio on a saved project | non signalé | [PR #54870](https://github.com/qgis/QGIS/pull/54870) |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Don\'t show help for algorithms which can\'t be run in qgis_process | [#54914](https://github.com/qgis/QGIS/issues/54914) | [PR #54920](https://github.com/qgis/QGIS/pull/54920) | en cours |
| Fix crashes in layout designer | [#52079](https://github.com/qgis/QGIS/issues/52079) | [PR #54907](https://github.com/qgis/QGIS/pull/54907) | Trop intrusif |
| Fix layout label adjust size to text logic | non signalé | [PR #54896](https://github.com/qgis/QGIS/pull/54896) | en cours |
...
| Fix layout maps force rasterisation of whole layout when map item has transparency set | non signalé | [PR #54882](https://github.com/qgis/QGIS/pull/54882) | Trop intrusif |
...
| Fix hang when exporting 3d maps | [#50067](https://github.com/qgis/QGIS/issues/50067) | [PR #54845](https://github.com/qgis/QGIS/pull/54845) | Trop risqué |
| Fix layout labels don\'t immediately react to changes when semi-transparent | non signalé | [PR #54839](https://github.com/qgis/QGIS/pull/54839) | [PR #54863](https://github.com/qgis/QGIS/pull/54863) |
...
| Fix QgsField::ConfigurationFlag::None causes syntax error when starting PyQGIS | non signalé | [PR #54809](https://github.com/qgis/QGIS/pull/54809) | N/A |
...
| Fix crash when certain symbol pages are open in style dock and QGIS is closed or a new project opened | non signalé | [PR #54749](https://github.com/qgis/QGIS/pull/54749) | Trop intrusif |
