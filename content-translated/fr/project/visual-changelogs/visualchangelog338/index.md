...
| QGIS crashes while Export Data from a WFS-Service as DXF-File | [#57139](https://github.com/qgis/QGIS/issues/57139) | Ne peut pas se reproduire |  |
...
| GDAL processing provider: "FutureWarning: Neither ogr.UseExceptions() nor ogr.DontUseExceptions() has been explicitly called" warning | [#57344](https://github.com/qgis/QGIS/issues/57344) | [PR #57477](https://github.com/qgis/QGIS/pull/57477) | Inapproprié |
...
| Cannot connect to SQL Server on QGis 3.34.3 | [#56136](https://github.com/qgis/QGIS/issues/56136) | Ne peut pas se reproduire |  |
| Balloon annotations fails to adopt text formatting | [#57423](https://github.com/qgis/QGIS/issues/57423) | Ne peut pas se reproduire |  |
...
| [ux][layouts] Fix legend item style mutex | non signalé | [PR #57605](https://github.com/qgis/QGIS/pull/57605) | N/A |
...
| QGIS Server wrongly positions the map objects in the output when there's more than one map | [#57631](https://github.com/qgis/QGIS/issues/57631) | Pas un bug |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Wrongly displayed action widget | [#33464](https://github.com/qgis/QGIS/issues/33464), [#57398](https://github.com/qgis/QGIS/issues/57398), [#56966](https://github.com/qgis/QGIS/issues/56966) | [PR #57475](https://github.com/qgis/QGIS/pull/57475) | Inapproprié |
| Custom properties variableNames and variableValues are cleared when more than one layer custom variable exist | [#57334](https://github.com/qgis/QGIS/issues/57334) | [PR #57490](https://github.com/qgis/QGIS/pull/57490) | Inapproprié |
| Default values depending on other fields are not correctly applied when field not part of form made by Drag and Drop Designer | [#57411](https://github.com/qgis/QGIS/issues/57411) | [PR #57527](https://github.com/qgis/QGIS/pull/57527) | Inapproprié |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Source-tree documentation improvements | non signalé | [PR #57594](https://github.com/qgis/QGIS/pull/57594) |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Avoid crash on summary when error list is empty | non signalé | [PR #57658](https://github.com/qgis/QGIS/pull/57658) | [PR #57661](https://github.com/qgis/QGIS/pull/57661) |
...
| Qgis crashes while digitising lines | [#57617](https://github.com/qgis/QGIS/issues/57617) | Ne peut pas se reproduire |  |
...
| Postgres layer with multi geometry columns fails to export | [#57757](https://github.com/qgis/QGIS/issues/57757) | Pas un bug |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgsabstractmaterialsettings: Handle selection in addParametersToEffect | non signalé | [PR #57803](https://github.com/qgis/QGIS/pull/57803) | not backported |
| qgs3daxis: Fix cube face picking | non signalé | [PR #57848](https://github.com/qgis/QGIS/pull/57848) |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix bugs relating to selective masking vector exports | [#50734](https://github.com/qgis/QGIS/issues/50734) | [PR #57843](https://github.com/qgis/QGIS/pull/57843) | Trop intrusif |
| Fix bugs relating to selective masking vector exports | [#54788](https://github.com/qgis/QGIS/issues/54788) | [PR #57703](https://github.com/qgis/QGIS/pull/57703) | Trop intrusif |
| Fix bugs relating to selective masking vector exports | [PR #57623](https://github.com/qgis/QGIS/pull/57623) | Trop intrusif |  |
| Fix bugs relating to selective masking vector exports | [PR #57498](https://github.com/qgis/QGIS/pull/57498) | Trop intrusif |  |
...
| Fix some grass vectors incorrectly show as datasets | non signalé | [PR #57780](https://github.com/qgis/QGIS/pull/57780) | [PR #57786](https://github.com/qgis/QGIS/pull/57786) |
...
| Limit fixed interval classification to generate at most 999 classes | [PR #50290](https://github.com/qgis/QGIS/pull/50290) | [PR #57722](https://github.com/qgis/QGIS/pull/57722) | Inapproprié |
| Don't try to connect widget to null vector tile layers | non signalé | [PR #57721](https://github.com/qgis/QGIS/pull/57721) | N/A |
| Don't show invalid "Style not found in database" warning when adding vector tile layers | non signalé | [PR #57714](https://github.com/qgis/QGIS/pull/57714) | Inapproprié |
| Replace processing default extension setting with string based setting | [#57676](https://github.com/qgis/QGIS/issues/57676) | [PR #57702](https://github.com/qgis/QGIS/pull/57702) | Inapproprié |
...
| Fix add feature dialog does not restore position when shown modally | non signalé | [PR #57686](https://github.com/qgis/QGIS/pull/57686) | [PR #57700](https://github.com/qgis/QGIS/pull/57700) |
| Fix python script editor "open in external editor" action | non signalé | [PR #57682](https://github.com/qgis/QGIS/pull/57682) | Inapproprié |
| Fix broken prefetch capabilities for raster layers | non signalé | [PR #57663](https://github.com/qgis/QGIS/pull/57663) | [PR #57667](https://github.com/qgis/QGIS/pull/57667) |
| Fix missing field type information in eg the horizontal header tooltips in attribute table | non signalé | [PR #57621](https://github.com/qgis/QGIS/pull/57621) | Inapproprié |
| Don't try to paint to indexed image | non signalé | [PR #57601](https://github.com/qgis/QGIS/pull/57601) |  |
| Clamp values for set_color_part function to avoid qt warnings when out of range values are specified | non signalé | [PR #57600](https://github.com/qgis/QGIS/pull/57600) |  |
| Add some tests for rendering text with RTL markers | [PR #57586](https://github.com/qgis/QGIS/pull/57586) |  |  |
| Fix rotation based orientation when html labeling enabled | non signalé | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Trop intrusif |
| Fix data defined font size is ignored when HTML labeling is active | non signalé | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Trop intrusif |
| Don't set @value to line height when evaluating multi line alignment | non signalé | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Trop intrusif |
...
| Fix incorrect buffers drawn for html label item | non signalé | [PR #57551](https://github.com/qgis/QGIS/pull/57551) | [PR #57571](https://github.com/qgis/QGIS/pull/57571) |
| Fix label mask sizes get reset to 0 | non signalé | [PR #57555](https://github.com/qgis/QGIS/pull/57555) | [PR #57569](https://github.com/qgis/QGIS/pull/57569) |
...
| Make brush and stroke style combo box icons visible on dark themes | non signalé | [PR #57506](https://github.com/qgis/QGIS/pull/57506) | [PR #57510](https://github.com/qgis/QGIS/pull/57510) |
