...
section: projet
sidebar: true
title: Modifications apportées par QGIS 3.30
type: visual-changelog

---
{{<content-start >}}
# Modifications apportées par QGIS 3.30{#changelog330 }
...
L'intégration native de GeoNode a aussi été migrée vers un plugin externe, tirant parti des puissantes extensions de l'API QGIS pour les plugins implémentés dans les versions récentes.

Les utilisateurs peuvent également anticiper de nouvelles fonctionnalités et améliorations de l'expérience utilisateur, y compris la prise en charge des tables d'attributs raster, un tri intelligent et configurable pour le chargement des couches, des améliorations des utilitaires GPS, des widgets de formulaire plus dynamiques, des aperçus multimédias riches natifs pour les pièces jointes, une meilleure intégration avec les services cloud, des extensions aux normes de métadonnées QGIS, et une multitude d'autres ajouts remarquables.
...
QGIS est le fruit d'un travail communautaire, et nous tenons à remercier chaleureusement les développeurs, les rédacteurs de la documentation, les testeurs et toutes les personnes qui consacrent bénévolement leur temps et leurs efforts (ou financent d'autres personnes pour qu'elles le fassent) afin de rendre ces versions possibles. Au nom de la communauté QGIS, nous espérons que vous apprécierez cette version ! Si vous souhaitez donner de votre temps, de l'argent ou contribuer d'une autre manière à rendre QGIS encore plus génial, rendez-vous sur [QGIS.ORG](https://qgis.org) et donnez un coup de main !
...
Les versions précédentes de QGIS écrivaient des quantités importantes d'objets de compatibilité dans la structure XML des fichiers de projet pour maintenir la compatibilité ascendante des symbologies afin de permettre l'ouverture des fichiers de projet avec QGIS 3.16 et les versions antérieures. Cette compatibilité a été supprimée des versions futures.

This feature was developed by [Denis Rouzaud](https://github.com/3nids)
## Outils cartographiques
### Feature: Raster MapTips
Dans les versions précédentes, les MapTips n'étaient disponibles que pour les couches vectorielles, mais les nouvelles modification de l'API ont permis d'implémenter Maptips pour d'autres types de couches.

Les couches raster prennent désormais en charge les Maptips, et de nouvelles fonctions d'utilitaires d'expression ont été ajoutées pour étendre les capacités existantes des Maptips.
...
Cette fonctionnalité a été financée par NOAA OCS Hydrography

This feature was developed by [Alessandro Pasotti](https://github.com/elpaso)
### Fonctionnalité: Identifier lors du déplacement de la souris, sans clic de souris
Une nouvelle option permet d'utiliser l'outil d'identification en déclenchant un mouvement de souris, sans avoir besoin de cliquer sur le canevas.
...
Le déclencheur par défaut est un minuteur de 300 millisecondes qui exécutera l'action d'identification, qui est mise en œuvre pour éviter les problèmes de performance lors du déplacement de la souris.

![image4](images/entries/36bfbae2b85c46b304ea84c05ce819fd69a66d38.gif)

This feature was developed by [Alessandro Pasotti](https://github.com/elpaso)
## Interface utilisateur
### Fonctionnalité : Fonctionnalité de Contrainte basée sur les tables d'attributs
...
Cette fonctionnalité offre des options de filtrage pour afficher ou masquer les fonctionnalités qui ne respectent pas les contraintes (dures ou souples) et introduit un nouveau type de style conditionnel qui fonctionne avec les types de ligne et de champ existants pour mettre en évidence les fonctionnalités qui ne respectent pas les contraintes de la couche.

![image5](images/entries/4ad89600c1e78bca863927f30581319b86afe6f1.webp)

This feature was developed by [Mathieu Pellerin](https://github.com/nirvn)
### Fonctionnalité : Panneau d'information GPS supplémentaires et champs de la barre d'outils
Le panneau d'information GPS inclut désormais la longueur totale actuelle de la piste et la distance depuis le début de la piste. Ces fonctionnalités sont également disponibles en tant qu'option (désactivée par défaut) qui permet de les afficher dans l'étiquette d'information de la barre d'outils GPS.

Le panneau d'information GPS comprend également l'altitude ellipsoïdale dans les valeurs d'information GPS disponibles.

Cette fonctionnalité a été financée par NIWA

This feature was developed by [Nyall Dawson](https://github.com/nyalldawson)
### Fonctionnalité : UX du panneau d'information GPS et refactoring
Une refonte substantielle du panneau d'information GPS a été réalisée afin de simplifier l'utilisation de GPS par l'utilisateur dans QGIS et de fournir une expérience GPS plus fluide.
...
La fonctionnalité GPS a maintenant été divisée en parties distinctes:
...
This feature was developed by [Nyall Dawson](https://github.com/nyalldawson)
## Symbologie
### Fonctionnalité : Options d'exportation SLD améliorées
...
### Fonctionnalité : Ajouter le support des caractères en exposant et en indice pour le moteur de rendu de texte
...
Cette fonctionnalité a été financée par OSGEO UK
...
### Fonctionnalité : Amélioration du contrôle de la caméra
...
### Fonctionnalité : Ajouter des dates clés aux métadonnées de la couche et du projet
...
This feature was developed by [Mathieu Pellerin](https://github.com/nirvn)
### Fonctionnalité : État modifiable défini par les données pour les widgets de formulaire
...
This feature was developed by [Mathieu Pellerin](https://github.com/nirvn)
## Traitement
### Fonctionnalité : Options supplémentaires pour les exports de tuiles XYZ lors de l'utilisation de la sortie html de Leaflet
Three new optional advanced parameters have been exposed for the XYZ Tile generation algorithm:
- Titre de la sortie HTML de Leaflet
- Attribution de la sortie HTML de Leaflet
- Inclure le fond de carte OpenStreetMap dans la sortie HTML Leaflet
...
This feature was developed by [Mathieu Pellerin](https://github.com/nirvn)
### Fonctionnalité : Tracés de profil d'élévation dans les mises en page imprimées
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| DATETIME: Mauvais fuseau horaire pour UTC dans la table des attributs | [#48393](https://github.com/qgis/QGIS/issues/48393) | [PR #51625](https://github.com/qgis/QGIS/pull/51625) | [PR #51645](https://github.com/qgis/QGIS/pull/51645) |
...
| Importer des données dans une géodatabase basée sur un fichier créée avec QGIS | [#51435](https://github.com/qgis/QGIS/issues/51435) | <https://github.com/nyalldawson/QGIS/pull/36> | N/A |
| Importer des données dans une géodatabase basée sur un fichier créée avec QGIS | [#51435](https://github.com/qgis/QGIS/issues/51435) | [GDAL PR 7147](https://github.com/OSGeo/gdal/pull/7147) | [GDAL PR 7176](https://github.com/OSGeo/gdal/pull/7176) |
...
| Weird interval QgsDoubleSpinbox behavior in graduated symbology with fixed interval | [#51687](https://github.com/qgis/QGIS/issues/51687) | [PR #51714](https://github.com/qgis/QGIS/pull/51714) | Non |
...
| wms getLegendGraphic call the group and not the layer when many style layers add from browser | [#51759](https://github.com/qgis/QGIS/issues/51759) | [PR #51765](https://github.com/qgis/QGIS/pull/51765) | Non |
...
| multiedit in attribute table not working properly in version \>=3.22 | [#48077](https://github.com/qgis/QGIS/issues/48077) | [PR #51801](https://github.com/qgis/QGIS/pull/51801) | Risqué? |
...
| Changes on geometry get discarded on save edits when layer filter is enabled (gpkg layer) | [#51934](https://github.com/qgis/QGIS/issues/51934) | Fonctionne pour moi |  |
...
| PyQGIS La création de QgsPolygon plante | [#51978](https://github.com/qgis/QGIS/issues/51978) | [PR #52004](https://github.com/qgis/QGIS/pull/52004) | À faire |
...
| La table de l'éditeur de sommets affiche des colonnes incorrectes dans QGIS 3.28 | [#51433](https://github.com/qgis/QGIS/issues/51433) | [PR #51774](https://github.com/qgis/QGIS/pull/51774) | [PR #51986](https://github.com/qgis/QGIS/pull/51986) |
...
| Crash when switching style to point displacement from geometry generator | [#51070](https://github.com/qgis/QGIS/issues/51070) | [PR #51784](https://github.com/qgis/QGIS/pull/51784) | À faire |
| Fix trust parameter not saved and not read | non reporté | [PR #51854](https://github.com/qgis/QGIS/pull/51854) | À faire |
...
| Permet de sauter les tests dépendants du backend PostgreSQL à l'exécution | [Discussion in PR #51891](https://github.com/qgis/QGIS/pull/51891#discussion_r1109132667) | [PR #51910](https://github.com/qgis/QGIS/pull/51910) | N/A |
| Ne pas supprimer les attributs de géométrie n'ayant pas de SRID | [#49380](https://github.com/qgis/QGIS/issues/49380#issuecomment-1282913470) | [PR #51885](https://github.com/qgis/QGIS/pull/51885) | [PR #51997](https://github.com/qgis/QGIS/pull/51997) |

This feature was funded by [QGIS.ORG (through donations and sustaining memberships)](https://qgis.org/)

This feature was developed by [Sandro Santilli (strk)](https://strk.kbt.io/)
### Fonctionnalité : correction de bugs par Jean Felder
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| wms getcapabilities crashes on dimensional data if there are no values | non reporté | [PR #51930](https://github.com/qgis/QGIS/pull/51930) | [PR #51933](https://github.com/qgis/QGIS/pull/51933) |
| \[3D\] Fix Y-Z inversion in point3dsymbolwidget | non reporté | [PR #51855](https://github.com/qgis/QGIS/pull/51855) | [PR #51938](https://github.com/qgis/QGIS/pull/51938) |

This feature was funded by [QGIS.ORG (through donations and sustaining memberships)](https://qgis.org/)

This feature was developed by [Jean Felder](https://oslandia.com/)
### Fonctionnalité : correction de bugs par Jacky Volpes
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Missing \"Save style\...\" icon in Layer Style Panel | [#51515](https://github.com/qgis/QGIS/issues/51515) | [PR #52037](https://github.com/qgis/QGIS/pull/52037) | Risqué? |

This feature was funded by [QGIS.ORG (through donations and sustaining memberships)](https://qgis.org/)

This feature was developed by [Jacky Volpes](https://oslandia.com/)
### Fonctionnalité : Corrections de bug par Stefanos Natsis
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Drag and drop point clouds from the browser add the layer twice | non reporté | [PR #51685](https://github.com/qgis/QGIS/pull/51685) |  |
| Opening more than 16 vector layers at once causes crash | non reporté | [PR #51782](https://github.com/qgis/QGIS/pull/51782) |  |
| Plante lors de la tentative de division de la ligne par le point | [#51501](https://github.com/qgis/QGIS/issues/51501) | [PR #51797](https://github.com/qgis/QGIS/pull/51797) | [PR #51951](https://github.com/qgis/QGIS/pull/51951) |
...
| Split tool tries to split even without any digitized points | non reporté | [PR #51831](https://github.com/qgis/QGIS/pull/51831) | [PR #51955](https://github.com/qgis/QGIS/pull/51955) |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Corrigé en utilisant une couche de symboles de ligne interpolée pour les contours des polygones | non signalé | [PR #52030](https://github.com/qgis/QGIS/pull/52030) | [PR #52032](https://github.com/qgis/QGIS/pull/52032) |
...
| Immediately apply color ramp label precision and suffix changes when auto apply is checked | non signalé | [PR #51989](https://github.com/qgis/QGIS/pull/51989) | Inapproprié |
...
| Don\'t try to download whole COG locally in order to determine open options | non signalé | [PR #51982](https://github.com/qgis/QGIS/pull/51982) | Inapproprié |
...
| Fix inefficient vector iteration when no rule based rules match current map scale | non signalé | [PR #51904](https://github.com/qgis/QGIS/pull/51904) | Inapproprié |
| Fix logic for triggering a full model reset in attribute table after changing attributes | non signalé | [PR #51890](https://github.com/qgis/QGIS/pull/51890) | [PR #51892](https://github.com/qgis/QGIS/pull/51892) |
...
| Fix data loss in secondary geometry columns when displaying in attribute form | [#49380](https://github.com/qgis/QGIS/issues/49380) | [PR #51863](https://github.com/qgis/QGIS/pull/51863) | Inapproprié |
| Fix data loss when layers with secondary geometry columns are used in processing tools | [#49380](https://github.com/qgis/QGIS/issues/49380) | [PR #51846](https://github.com/qgis/QGIS/pull/51846) | Inapproprié |
...
| Show an icon for geometry fields | non signalé | [PR #51844](https://github.com/qgis/QGIS/pull/51844) | Inapproprié |
| Fix geometry fields incorrectly show as \"range\" types in fields list | non signalé | [PR #51842](https://github.com/qgis/QGIS/pull/51842) | [PR #51860](https://github.com/qgis/QGIS/pull/51860) |
...
| \[layouts\] Use nicer number formatting for dynamic map scale labels | [#51764](https://github.com/qgis/QGIS/issues/51764) | [PR #51768](https://github.com/qgis/QGIS/pull/51768) | Impossible |
| Re-permit format_number to omit group separators | non signalé | [PR #51761](https://github.com/qgis/QGIS/pull/51761) | [PR #51763](https://github.com/qgis/QGIS/pull/51763) |
| Remember the collapsed state of the vector layer renderer group box | non signalé | [PR #51719](https://github.com/qgis/QGIS/pull/51719) | Inapproprié |
| When unchecking render layers as a group, ensure child layers don\'t have clipping blend modes | [#51358](https://github.com/qgis/QGIS/issues/51358) | [PR #51707](https://github.com/qgis/QGIS/pull/51707) | Trop intrusif |
...
| Réparer le crash lors de l'affichage des infobulles pour les calques invalides | non signalé | [PR #51703](https://github.com/qgis/QGIS/pull/51703) | [PR #51708](https://github.com/qgis/QGIS/pull/51708) |
| Fix map tips do not show for vector layers where the HTML map tip option isn\'t used | non signalé | [PR #51702](https://github.com/qgis/QGIS/pull/51702) | Inaltéré |
| Correction de la création de GeoPDF avec des thèmes exportés contenant des barres obliques | [#51480](https://github.com/qgis/QGIS/issues/51480) | [PR #51633](https://github.com/qgis/QGIS/pull/51633) | [PR #51677](https://github.com/qgis/QGIS/pull/51677) |
...
| Optimiser le filtre de légende par les calculs de carte/expression. | [#51233](https://github.com/qgis/QGIS/issues/51233) | [PR #51675](https://github.com/qgis/QGIS/pull/51675) | Trop risqué |
| \[georeferencer\] Fix warning about missing output file name doesn\'t show in all circumstances | non signalé | [PR #51673](https://github.com/qgis/QGIS/pull/51673) | [PR #51739](https://github.com/qgis/QGIS/pull/51739) |
...
| Génération de correction des profils d'élévation raster pour les lignes exactement horizontales/verticales | [#51196](https://github.com/qgis/QGIS/issues/51196) | [PR #51637](https://github.com/qgis/QGIS/pull/51637) | [PR #52072](https://github.com/qgis/QGIS/pull/52072) |
| Coder les valeurs de texte en pourcentage lors de la création/mise à jour des champs sur les services d'entités ArcGIS. | [#51509](https://github.com/qgis/QGIS/issues/51509) | [PR #51636](https://github.com/qgis/QGIS/pull/51636) | [PR #51654](https://github.com/qgis/QGIS/pull/51654) |
| Fixer le glisser-déposer pour que les résultats de GDB soient décalés par colonnes. | [#51435](https://github.com/qgis/QGIS/issues/51435) | [PR #51634](https://github.com/qgis/QGIS/pull/51634) | [PR #51969](https://github.com/qgis/QGIS/pull/51969) |
...
### Fonctionnalité : correction de bugs par David Signer
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| La vue du formulaire de la table des attributs perd son index lorsqu'une couche dépendante a été modifiée. | [#43902](https://github.com/qgis/QGIS/issues/43902) | [PR #52046](https://github.com/qgis/QGIS/pull/52046) |  |
| Attribute table form view looses index when the \"yellow\" selection is changed | non signalé | [PR #52045](https://github.com/qgis/QGIS/pull/52045) |  |
| Les fonctionnalités de l'Éditeur de relations ne sont plus sélectionnables. | non signalé | [PR #51914](https://github.com/qgis/QGIS/pull/51914) | Inaltéré |
