...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| \[OAPIF\] Zooming triggers download of already loaded data | [\#66358](https://github.com/qgis/QGIS/issues/66358) | Pas un bug |  |
...
| Gml to Gml- Conversion succeeded, input and output are not the same in QGIS | [\#66413](https://github.com/qgis/QGIS/issues/66413) | Pas un bug |  |
...
| Cannot load VT layer from style only from the dialog (works in browser) | non reporté | [PR \#66500](https://github.com/qgis/QGIS/pull/66500) | À faire |
| "fix" every entry in relation reference widget is shown in italic | non reporté | [PR \#66649](https://github.com/qgis/QGIS/pull/66649) |  |
...
| No timeout for vsicurl layers when loading a project | [\#66496](https://github.com/qgis/QGIS/issues/66496) | Ne peut pas se reproduire |  |
...
| Data-defined override expression on a field is not evaluated until any field in the form is edited | [\#66504](https://github.com/qgis/QGIS/issues/66504) | Ne peut pas se reproduire |  |
...
| Qgis have problem to render GeometryCollection for Gml, other viewer like mygeodata website render ok | [\#66225](https://github.com/qgis/QGIS/issues/66225) | Doublon |  |
...
| QGIS Server: GetProjectSettings returns the error message "Layer(s) not valid" with two WMS layers | [\#65872](https://github.com/qgis/QGIS/issues/65872) | Ne peut pas se reproduire |  |
| raster histogram not working for raster with scale factor | [\#65920](https://github.com/qgis/QGIS/issues/65920) | [PR \#66640](https://github.com/qgis/QGIS/pull/66640) | À faire |
| Advanced Digitizing Floater is not wide enough to show whole value | [\#65171](https://github.com/qgis/QGIS/issues/65171) | [PR \#66663](https://github.com/qgis/QGIS/pull/66663) | À faire |
...
| Layout bleeding to edge outside map window | [\#49638](https://github.com/qgis/QGIS/issues/49638) | Fixé |  |
| Fix flaky test_gui_fileuploader | non signalé | [PR \#66543](https://github.com/qgis/QGIS/pull/66543) |  |
| Hidden actions from user defined toolbar are still visible. | non signalé | [PR \#66620](https://github.com/qgis/QGIS/pull/66620) |  |
| QGIS should never poll a PostGIS/WMS/WFS/etc connections unless specifically asked to | [\#58303](https://github.com/qgis/QGIS/issues/58303) | [PR \#66621](https://github.com/qgis/QGIS/pull/66621) | À faire |
| Password is not removed when it's at the the end of uri | non signalé | [PR \#66625](https://github.com/qgis/QGIS/pull/66625) | À faire |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
| Allow QGIS to access curves from OGC API provider | non signalé | [PR \#66452](https://github.com/qgis/QGIS/pull/66452) | N/A |
...
| QGIS hangs when opening raster calculator (Meu Qgis está travando ao tentar abrir a calculadora raster) | [\#66327](https://github.com/qgis/QGIS/issues/66327) | Ne peut pas se reproduire |  |
| Ensure consistency in MultiCurves: don't allow NurbsCurves | non signalé | [PR \#66676](https://github.com/qgis/QGIS/pull/66676) | N/A |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix field displayString on primitive JSON values | non signalé | [PR \#66575](https://github.com/qgis/QGIS/pull/66575) | N/A |
...
| Crash when clicking on an unavailable layer in Layers panel | [\#65913](https://github.com/qgis/QGIS/issues/65913) | [PR \#66578](https://github.com/qgis/QGIS/pull/66578) | À faire |
| QGIS server OGC API: Limits and offset parameters ignored when plugin changing parameters | [\#65858](https://github.com/qgis/QGIS/issues/65858) | Fixé | [PR \#66480](https://github.com/qgis/QGIS/pull/66480) |
...
| concat() returns NULL when all arguments are NULL: it should return an empty string | [\#65808](https://github.com/qgis/QGIS/issues/65808) | [PR \#66618](https://github.com/qgis/QGIS/pull/66618) | À faire |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
| Deleted last series still visible in chart | [\#63466](https://github.com/qgis/QGIS/issues/63466) | Ne peut pas se reproduire |  |
...
| Gestionnaire BD | [\#59470](https://github.com/qgis/QGIS/issues/59470) | Ne peut pas se reproduire |  |
...
| TestQgsProcessingAlgsPt2::exportMeshOnGrid() | [\#48605](https://github.com/qgis/QGIS/issues/48605) | Ne peut pas se reproduire |  |
| TestQgsProcessingAlgs::convertGpsData() fails | [\#45588](https://github.com/qgis/QGIS/issues/45588) | Cannot reproduce/Not a bug |  |
| gdal:merge parameter OPTIONS not shown with execAlgorithmDialog | [\#66396](https://github.com/qgis/QGIS/issues/66396) | Pas un bug |  |
| projects/anonymize_saved_projects doesn't seem to be available in the new settings tree | [\#65844](https://github.com/qgis/QGIS/issues/65844) | Pas un bug |  |
| bug for .Shp namefile | [\#62655](https://github.com/qgis/QGIS/issues/62655) | Pas un bug |  |
| Build virtual point cloud (VPC): dialog adds .las extension for output | [\#61934](https://github.com/qgis/QGIS/issues/61934) | Ne peut pas se reproduire |  |
...
| QGIS wants to open all .json files, including ones unrelated to any geodata | [\#61215](https://github.com/qgis/QGIS/issues/61215) | Ne peut pas se reproduire |  |
...
| QLR files not associated with QGIS | [\#56844](https://github.com/qgis/QGIS/issues/56844) | Ne peut pas se reproduire |  |
| TestQgsDatumTransformDialog fails | [\#48883](https://github.com/qgis/QGIS/issues/48883) | Ne peut pas se reproduire |  |
| TestProcessingGui::testDatabaseSchemaWrapper() Caught unhandled exception | [\#48885](https://github.com/qgis/QGIS/issues/48885) | Ne peut pas se reproduire |  |
...
| Raster Tools - Generate XYZ Tiles (Directory) always creates 0 tiles | [\#60069](https://github.com/qgis/QGIS/issues/60069) | Pas un bug |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix deadlock when rendering annotation layers | non signalé | [PR \#66712](https://github.com/qgis/QGIS/pull/66712) | [PR \#66742](https://github.com/qgis/QGIS/pull/66742) |
| Fix crashes in QgsFeatureListComboBox if layer is unloaded | non signalé | [PR \#66697](https://github.com/qgis/QGIS/pull/66697) | [PR \#66708](https://github.com/qgis/QGIS/pull/66708) |
| Every entry in relation reference widget is shown in italic | non signalé | [PR \#66649](https://github.com/qgis/QGIS/pull/66649) | Inapproprié |
| Fix buggy processing relief colors widget | non signalé | [PR \#66602](https://github.com/qgis/QGIS/pull/66602) | Inapproprié |
| Fix QgsImageCache lossy conversion of images | non signalé | [PR \#66585](https://github.com/qgis/QGIS/pull/66585) | Inapproprié |
...
| Fix intermittent failure of GRASS raster tests | non signalé | [PR \#66546](https://github.com/qgis/QGIS/pull/66546) | N/A |
| Fix symbology sizing issues on hidpi displays | [\#55349](https://github.com/qgis/QGIS/issues/55349) | [PR \#66531](https://github.com/qgis/QGIS/pull/66531) | Inapproprié |
| Fix symbology sizing issues on hidpi displays | [\#55349](https://github.com/qgis/QGIS/issues/55349) | [PR \#66530](https://github.com/qgis/QGIS/pull/66530) | Inapproprié |
| Fix broken color wheel widget on devices with pixel ratios | [\#55349](https://github.com/qgis/QGIS/issues/55349) | [PR \#66529](https://github.com/qgis/QGIS/pull/66529) | Inapproprié |
| Use correct lossless method to store metal rough colors | non signalé | [PR \#66521](https://github.com/qgis/QGIS/pull/66521) | N/A |
| Ensure color picker opens inline for 3d settings in style dock | non signalé | [PR \#66520](https://github.com/qgis/QGIS/pull/66520) | Inapproprié |
| Fix misalignment of spin boxes in color dialog | non signalé | [PR \#66498](https://github.com/qgis/QGIS/pull/66498) | Inapproprié |
| Use unlit material instead of phong material when more appropriate | non signalé | [PR \#66490](https://github.com/qgis/QGIS/pull/66490) | Inapproprié |
| Loosen the maximum number of grid ticks to draw | [\#45113](https://github.com/qgis/QGIS/issues/45113) | [PR \#66403](https://github.com/qgis/QGIS/pull/66403) | Inapproprié |
...
| Fix slow count of features for filtered SQL server layers | [\#64894](https://github.com/qgis/QGIS/issues/64894) | [PR \#66401](https://github.com/qgis/QGIS/pull/66401) | Inapproprié |
| Partially fix slow expression builder widget construction times | non signalé | [PR \#66385](https://github.com/qgis/QGIS/pull/66385) | Inapproprié |
| Use correct default font for legend text on symbol | Related to [\#63431](https://github.com/qgis/QGIS/issues/63431) | [PR \#66384](https://github.com/qgis/QGIS/pull/66384) | Inapproprié |
| Don't show missing font warnings for MS Shell Dlg font | [\#63431](https://github.com/qgis/QGIS/issues/63431) | [PR \#66383](https://github.com/qgis/QGIS/pull/66383) | Inapproprié |
...
| WMS Ensure we store deduced CRS in provider/layer sources | non signalé | [PR \#66379](https://github.com/qgis/QGIS/pull/66379) | Inapproprié |
...
| Fix model is zoomed right out when opening model designer | non signalé | [PR \#66335](https://github.com/qgis/QGIS/pull/66335) | QGIS 4 only |
