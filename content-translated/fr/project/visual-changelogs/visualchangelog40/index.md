...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Server: landingpage webapp only functions if built with server python plugins support | [\#64556](https://github.com/qgis/QGIS/issues/64556) | [PR \#64763](https://github.com/qgis/QGIS/pull/64763) | Non |
| Raster calculator fails when OpenCL acceleration is turned on | [\#64574](https://github.com/qgis/QGIS/issues/64574) | [PR \#64779](https://github.com/qgis/QGIS/pull/64779) | Non |
...
| Virtual raster provider memory leak - memory not released until QGIS closed | [\#64559](https://github.com/qgis/QGIS/issues/64559) | [PR \#64785](https://github.com/qgis/QGIS/pull/64785) | À faire |
...
| Raster Attribute Table for S-102 does not display correctly | [\#64797](https://github.com/qgis/QGIS/issues/64797) | [PR \#64811](https://github.com/qgis/QGIS/pull/64811) | À faire |
...
| SpatiaLite provider returns wrong schema for views (caches columns from underlying joined tables instead of view definition) | [\#64742](https://github.com/qgis/QGIS/issues/64742) | [PR \#64902](https://github.com/qgis/QGIS/pull/64902) | À faire |
...
| \[ogr\]\[gpkg\] Fix wrong row count when attribute filter | [\#65067](https://github.com/qgis/QGIS/issues/65067) | [PR \#65097](https://github.com/qgis/QGIS/pull/65097) | Non |
...
| Rendering of PostGIS rasters ignores Transparency NoData value setting | [\#63171](https://github.com/qgis/QGIS/issues/63171) | [PR \#63258](https://github.com/qgis/QGIS/pull/63258) | Oui |
...
| QGIS Server Layer(s) not valid Exception with multiple projects using same WMS Layer | [\#62608](https://github.com/qgis/QGIS/issues/62608) | Ne peut pas se reproduire |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgis/gdal garbage collection causes segfault | [\#58724](https://github.com/qgis/QGIS/issues/58724) | [PR \#64766](https://github.com/qgis/QGIS/pull/64766) | Non |
...
| QgsVectorFileWriter: fix writing NurbsCurve to OGR, by converting them to LineString | non signalé | [PR \#64906](https://github.com/qgis/QGIS/pull/64906) | N/A |
| Build issue on NixOS | [\#64937](https://github.com/qgis/QGIS/issues/64937) | Invalides |  |
...
| building master in pkgsrc; mostly ok! | [mail thread](https://lists.osgeo.org/pipermail/qgis-developer/2026-February/068072.html) | Pas un bug |  |
...
| Replace all remaining uses of connect(,SIGNAL,,SLOT) in src/ | non signalé | [PR \#63832](https://github.com/qgis/QGIS/pull/63832) | N/A |
...
| Fix build warnings on Fedora | non signalé | [PR \#63910](https://github.com/qgis/QGIS/pull/63910) | N/A |
| Fix cppcheck missingOverride and functionConst warnings | non signalé | [PR \#63913](https://github.com/qgis/QGIS/pull/63913) | N/A |
| \[CI\] Port OGC tests to ubuntu:25.10 Qt6 | non signalé | [PR \#64135](https://github.com/qgis/QGIS/pull/64135) | N/A |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| pyqt5_to_pyqt6.py: Some known incompatibilities do not lead to error exit code | [\#62559](https://github.com/qgis/QGIS/issues/62559) | [PR \#63526](https://github.com/qgis/QGIS/pull/63526) | Non |
| \[PyQt5_to_PyQt6\] Fix all imports coming from Qt module | non signalé | [PR \#63565](https://github.com/qgis/QGIS/pull/63565) |  |
...
| Broken themes in geospatial PDF | [\#62014](https://github.com/qgis/QGIS/issues/62014) | [PR \#63580](https://github.com/qgis/QGIS/pull/63580) | À faire |
...
| The "Session Role" function is not applied to loaded layers | [\#62930](https://github.com/qgis/QGIS/issues/62930) | Déjà corrigé |  |
| set session role not working on creation of tables and schema | [\#63866](https://github.com/qgis/QGIS/issues/63866) | impossible à reproduire |  |
| Layout export to GeoPDF: incorrect layers' order when a "PDF Group" is set | [\#63475](https://github.com/qgis/QGIS/issues/63475) | [PR \#64983](https://github.com/qgis/QGIS/pull/64983) | À faire |
| pyqt5_to_pyqt6.py: Some suggestions reference wrong class | [\#64462](https://github.com/qgis/QGIS/issues/64462) | [PR \#64989](https://github.com/qgis/QGIS/pull/64989) | À faire |
...
| With composite foreign keys, all widgets are configured by default | [\#32048](https://github.com/qgis/QGIS/issues/32048) | [PR \#65059](https://github.com/qgis/QGIS/pull/65059) | non |
...
| Crash in layer styling panel when closing a project if DD Property Assistant is open | non signalé | [PR \#63549](https://github.com/qgis/QGIS/pull/63549) |  |
...
| Attributes Form is not the same when called via GUI or when called via PyQGIS | [\#65010](https://github.com/qgis/QGIS/issues/65010) | Pas un bug |  |
| Layers added using a .qlr file cannot be added to an open Elevation Profile View | [\#58533](https://github.com/qgis/QGIS/issues/58533) | Déjà corrigé |  |
...
| Fix 3d view shortcuts | non signalé | [PR \#63523](https://github.com/qgis/QGIS/pull/63523) |  |
| Fix zooming with right mouse button in 3D views | non signalé | [PR \#63537](https://github.com/qgis/QGIS/pull/63537) |  |
| Fix 3d point lights | non signalé | [PR \#63525](https://github.com/qgis/QGIS/pull/63525) |  |
...
| \[3D\] Avoid clamping vertices to actual nodata value | non signalé | [PR \#64845](https://github.com/qgis/QGIS/pull/64845) |  |
| Data corruption using "Split Features" on a LineStringZ in GeoJSON | [\#63581](https://github.com/qgis/QGIS/issues/63581) | [PR \#64986](https://github.com/qgis/QGIS/pull/64986) | En attente |
...
| Fix sip_include.sh after pyqt5 removal | non signalé | [PR \#64974](https://github.com/qgis/QGIS/pull/64974) | N/A |
| Make the extent widget hold the full precision of the chosen extent | non signalé | [PR \#64919](https://github.com/qgis/QGIS/pull/64919) |  |
| Fix endless terrain levels generation | non signalé | [PR \#64875](https://github.com/qgis/QGIS/pull/64875) |  |
| Always check pointer initialized inside if initializer | non signalé | [PR \#64871](https://github.com/qgis/QGIS/pull/64871) |  |
...
| Tidy includes in point clouds and 3d code | non signalé | [PR \#64820](https://github.com/qgis/QGIS/pull/64820) |  |
| Remove code for QT version \< 6.6 | non signalé | [PR \#64809](https://github.com/qgis/QGIS/pull/64809) |  |
| Plugin installer can leave a plugin in a broken state on failed upgrade | [\#64790](https://github.com/qgis/QGIS/issues/64790) | [PR \#64807](https://github.com/qgis/QGIS/pull/64807) | À faire |
| Avoid module wide QtConcurrent imports | non signalé | [PR \#64775](https://github.com/qgis/QGIS/pull/64775) |  |
| Avoid crash when edit-in-place layer is removed | non signalé | [PR \#65107](https://github.com/qgis/QGIS/pull/65107) | Topo |
...
| Some feature are not rendered in a 3d map view when using rule based renderer | [\#47581](https://github.com/qgis/QGIS/issues/47581) | Déjà corrigé |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgs3daxis: Fix axis label visibility in qt6 | non signalé | [PR \#63585](https://github.com/qgis/QGIS/pull/63585) |  |
| qgs3daxis: Fix cube picking in qt6 when clicking on a label | non signalé | [PR \#63585](https://github.com/qgis/QGIS/pull/63585) |  |
| \[3D\] fix terrain obj export | non signalé | [PR \#63173](https://github.com/qgis/QGIS/pull/63173) |  |
...
| Fix handling of tiled scene and vector tile layers in Processing | non signalé | [PR \#63323](https://github.com/qgis/QGIS/pull/63323) | [PR \#63343](https://github.com/qgis/QGIS/pull/63343) |
...
| Fix crash and wrong coordinate order in the WCS source widget | non signalé | [PR \#63615](https://github.com/qgis/QGIS/pull/63615) | [PR \#63632](https://github.com/qgis/QGIS/pull/63632) |
| Fix several issues with geometry check algorithms | non signalé | [PR \#63304](https://github.com/qgis/QGIS/pull/63304) |  |
| WCS Request fails due to wrong BBox using "Map Canvas Extent" or "Draw on Canvas" | [\#62528](https://github.com/qgis/QGIS/issues/62528) | [PR \#63542](https://github.com/qgis/QGIS/pull/63542) | À faire |
| wcs spatial extent uses wrong projection | [\#50432](https://github.com/qgis/QGIS/issues/50432) |  |  |
| String aggregate-related functions treat NULL and empty strings interchangeably | [\#35433](https://github.com/qgis/QGIS/issues/35433) | [PR \#63324](https://github.com/qgis/QGIS/pull/63324) | À faire |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix nothing happens when zooming to very small line feature extent | non signalé | [PR \#65215](https://github.com/qgis/QGIS/pull/65215) | [PR \#65274](https://github.com/qgis/QGIS/pull/65274) |
| Don't immediately validate child algorithms in models | non signalé | [PR \#65183](https://github.com/qgis/QGIS/pull/65183) | N/A |
| \[browser\] Don't permit renaming tables which are open in the current project | non signalé | [PR \#65182](https://github.com/qgis/QGIS/pull/65182) | N/A |
| Extend timeout for processing executable tests | non signalé | [PR \#65161](https://github.com/qgis/QGIS/pull/65161) | [PR \#65224](https://github.com/qgis/QGIS/pull/65224) |
| Downgrade thread safety check to non-fatal | non signalé | [PR \#65148](https://github.com/qgis/QGIS/pull/65148) | N/A |
...
| \[server\] Fix completely broken service url setting handling | non signalé | [PR \#65117](https://github.com/qgis/QGIS/pull/65117) | [PR \#65226](https://github.com/qgis/QGIS/pull/65226) |
| Fix broken value range when calling deprecated setComponentValue int variant | non signalé | [PR \#65115](https://github.com/qgis/QGIS/pull/65115) | [PR \#65135](https://github.com/qgis/QGIS/pull/65135) |
| \[wms\] Fix regression in encode/decodeUri | non signalé | [PR \#65114](https://github.com/qgis/QGIS/pull/65114) | N/A |
| Fix a bunch of python tests weren't actually run on CI | non signalé | [PR \#65113](https://github.com/qgis/QGIS/pull/65113) |  |
| Fix assert triggered on qt6 builds | non signalé | [PR \#65079](https://github.com/qgis/QGIS/pull/65079) | N/A |
| \[gdal\] Fix openfilegdb raster path decoding/encoding | non signalé | [PR \#65078](https://github.com/qgis/QGIS/pull/65078) | [PR \#65096](https://github.com/qgis/QGIS/pull/65096) |
| Fix mdb files not shown in browser for non-windows platforms | non signalé | [PR \#65077](https://github.com/qgis/QGIS/pull/65077) | [PR \#65098](https://github.com/qgis/QGIS/pull/65098) |
| Fix failing dock widget test on newer Qt versions | non signalé | [PR \#65073](https://github.com/qgis/QGIS/pull/65073) | N/A |
| \[browser\] Prevent deletion or rename of fields when table is open in project | non signalé | [PR \#64958](https://github.com/qgis/QGIS/pull/64958) | Not suitable |
| Fix strict curved label anchoring when placement is on line | non signalé | [PR \#64736](https://github.com/qgis/QGIS/pull/64736) | [PR \#64801](https://github.com/qgis/QGIS/pull/64801) |
...
| Ensure QString and Qt::StringLiterals namespace are present when needed | non signalé | [PR \#64724](https://github.com/qgis/QGIS/pull/64724) | N/A |
