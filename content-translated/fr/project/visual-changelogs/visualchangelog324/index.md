...
section: projet
sidebar: true
title: Modifications apportées par QGIS 3.24
type: visual-changelog

---
{{<content-start >}}
# Modifications apportées par QGIS 3.24{#changelog324 }
...
### Fonctionnalité : Création simplifiée de systèmes de coordonnées de référence personnalisés
...
Cette fonctionnalité a été financée par Andrew Fletcher.
...
Cette fonctionnalité a été financée par la ville de Fribourg-en-Brisgau
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | Correctif reporté sur la 3.22 (GitHub) |
| --- | --- | --- | --- |
| Wrong raster projection on HIDPI screens | [#46882](https://github.com/qgis/QGIS/issues/46882) | [PR #46931](https://github.com/qgis/QGIS/pull/46931) | À faire |
| Data Source Manager title not translatable | [#46929](https://github.com/qgis/QGIS/issues/46929) | [PR #46932](https://github.com/qgis/QGIS/pull/46932) | À faire |
| QGIS 3.22 - Identical map names in print composer | [#46927](https://github.com/qgis/QGIS/issues/46927) | Fonctionne pour moi |  |
| Bold and italic attributes of labels that reinitialize | [#46896](https://github.com/qgis/QGIS/issues/46896) | Fonctionne pour moi |  |
...
| Virtual layer not loaded correctly after re-opening a project | [#46834](https://github.com/qgis/QGIS/issues/46834) | [PR #46938](https://github.com/qgis/QGIS/pull/46938) | À faire |
| QGIS crashes while calling readLayerXml() | [#46741](https://github.com/qgis/QGIS/issues/46741) | Fonctionne pour moi |  |
| Crash when changing orientation of page in layout | [#46575](https://github.com/qgis/QGIS/issues/46575) | [PR #46972](https://github.com/qgis/QGIS/pull/46972) | À faire |
| \"sort\" funcionality of attributes table sort numeric fields as text | [#34935](https://github.com/qgis/QGIS/issues/34935) | [PR #47035](https://github.com/qgis/QGIS/pull/47035) | À faire |
| OAPIF: api-key not included when requesting /collections endpoint | [#46535](https://github.com/qgis/QGIS/issues/46535) | [PR #47145](https://github.com/qgis/QGIS/pull/47145) | À faire |
| XML notation if missing from tooltips in vector file writer dialog | [#46508](https://github.com/qgis/QGIS/issues/46508) | [PR #47148](https://github.com/qgis/QGIS/pull/47148) | À faire |
| Ignore out of range option in interpolated symbol renderer creates artifacts if start value is out of range | [#46362](https://github.com/qgis/QGIS/issues/46362) | [PR #47174](https://github.com/qgis/QGIS/pull/47174) | À faire |
| start width \> end width is ignored when using the \"exact\" color interpolation method | [#46371](https://github.com/qgis/QGIS/issues/46371) | [PR #47195](https://github.com/qgis/QGIS/pull/47195) | À faire |
...
| (Un)force hide form in relation widget | [#47226](https://github.com/qgis/QGIS/issues/47226) | [PR #47245](https://github.com/qgis/QGIS/pull/47245) | À faire |
...
| HTML/String-ish QByteArray as result of expression function breaks expression preview display | [#46174](https://github.com/qgis/QGIS/issues/46174) | [PR #47229](https://github.com/qgis/QGIS/pull/47229) | À faire |
...
| Layout Attribute Table sorting does not work in Print Layouts when column name has spaces | [#43744](https://github.com/qgis/QGIS/issues/43744) | [PR #47249](https://github.com/qgis/QGIS/pull/47249) | À faire |
| Incorrect scale range legend after applying logarithmic graduated symbology to a vector layer | [#45454](https://github.com/qgis/QGIS/issues/45454) | [PR #47259](https://github.com/qgis/QGIS/pull/47259) | Risqué? |
| fix server crash | non signalé | [PR #47271](https://github.com/qgis/QGIS/pull/47271) | À faire |
| Load QGIS project from command line from a PostgreSQL project | [#47270](https://github.com/qgis/QGIS/issues/47270) | [PR #47272](https://github.com/qgis/QGIS/pull/47272) | À faire |
...
| Value map widget: \"value\"/\"description\" inconsistency when table added to print layouts | [#41798](https://github.com/qgis/QGIS/issues/41798) | [PR #47300](https://github.com/qgis/QGIS/pull/47300) | À faire |
| Missing entries in attributetable in layout with atlas at page break | [#44086](https://github.com/qgis/QGIS/issues/44086) | [PR #47303](https://github.com/qgis/QGIS/pull/47303) | À faire |
| Server OAPIF: bbox filter isn\'t working if data source CRS is not EPSG:4326/WGS84 | [#47302](https://github.com/qgis/QGIS/issues/47302) | [PR #47318](https://github.com/qgis/QGIS/pull/47318) | À faire |
| Drag & Drop designer control visibility by expression with field IS NOT NULL doesn\'t work if the field is configured with html | [#47363](https://github.com/qgis/QGIS/issues/47363) | [PR #47432](https://github.com/qgis/QGIS/pull/47432) | Risqué? |
...
| Filter for WFS layer: The \"Tables\" button is missing | [#46887](https://github.com/qgis/QGIS/issues/46887) | Pas un bug |  |
...
| Fixes to QgsGeometry::addPart + new test cases | non signalé | [PR #47009](https://github.com/qgis/QGIS/pull/47009) |  |
...
| Error opening data loader dialog from MetaSearch | [#40490](https://github.com/qgis/QGIS/issues/40490) | Fonctionne pour moi |  |
...
| Wrong signature of the QgsProcessingParameterMeshDatasetGroups when exporting to Python | non signalé | [PR #47152](https://github.com/qgis/QGIS/pull/47152) | [PR #47156](https://github.com/qgis/QGIS/pull/47156) |
...
| Unable to delete files .shp and .dbf using python code (removeMapLayers, deleteShapeFile) | [#39428](https://github.com/qgis/QGIS/issues/39428) | Fonctionne pour moi |  |
| QgsProcessingParameterFile extension option | [#45633](https://github.com/qgis/QGIS/issues/45633) | Pas un bug |  |
...
Bugs corrigés par Alex Bruy
### Correction de bugs par Paul Blottiere
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | Correctif reporté sur la 3.22 (GitHub) |
| --- | --- | --- | --- |
| Fixes WFS EXP_FILTER parsing in GetFeature request | [mailing list](https://www.mail-archive.com/qgis-user@lists.osgeo.org/msg50029.html) | [PR #47029](https://github.com/qgis/QGIS/pull/47029) | Trop risqué |
| Fix output filename when a raster is saved in a format without extension | non signalé | [PR #46992](https://github.com/qgis/QGIS/pull/46992) | À faire |
| WFS GetFeature document and exceptions | non signalé | [PR #47198](https://github.com/qgis/QGIS/pull/47198) | À faire |
| Exluding a print layout in project propteries -\> server do not avoid that a GetPrint request can be done for that layout | [#46140](https://github.com/qgis/QGIS/issues/46140) | [PR #47199](https://github.com/qgis/QGIS/pull/47199) | À faire |
| Server: Can\'t enable WFS3 API update endpoint (PUT/PATCH) on layers without geometry | [#46119](https://github.com/qgis/QGIS/issues/46119) | Fonctionne pour moi |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | Correctif reporté sur la 3.22 (GitHub) |
| --- | --- | --- | --- |
| Fix HTTP Post with MultiPart | [#46989](https://github.com/qgis/QGIS/issues/46989) | [PR #47006](https://github.com/qgis/QGIS/pull/47006) | pas nécessaire |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | Correctif reporté sur la 3.22 (GitHub) |
| --- | --- | --- | --- |
| Add .tsv extension to delimited text supported files filter | reported on youtube screencast | [PR #47181](https://github.com/qgis/QGIS/pull/47181) | en cours |
| Fix line anchor placements are reversed for labels which sit below lines | non signalé | [PR #47181](https://github.com/qgis/QGIS/pull/47181) | [PR #47181](https://github.com/qgis/QGIS/pull/47181) |
| Fix incorrect return code from QgsProcessingModelAlgorithm::fromFile when file does not exist | non signalé | [PR #47161](https://github.com/qgis/QGIS/pull/47161) | [PR #47162](https://github.com/qgis/QGIS/pull/47162) |
| Fix many georeferencer regressions | multiple | non signalé | en cours |
...
| Fix sqlite errors on startup caused by default style database import logic | non signalé | [PR #47070](https://github.com/qgis/QGIS/pull/47070) | not suitable |
| Fix color widgets incorrectly change colors when mouse is hovered over widget | non signalé | [PR #47069](https://github.com/qgis/QGIS/pull/47069) | [PR #47077](https://github.com/qgis/QGIS/pull/47077) |
...
| Fix duplicate shortcut registered warning on startup | non signalé | [PR #46983](https://github.com/qgis/QGIS/pull/46983) | not suitable |
| Fix scroll wheel events get \"stuck\" when scrolling to bottom of areas | non signalé | [PR #46958](https://github.com/qgis/QGIS/pull/46958) | [PR #46987](https://github.com/qgis/QGIS/pull/46987) |
...
| Fix broken merge features tool | non signalé | [PR #46924](https://github.com/qgis/QGIS/pull/46924) | n/a |
...
### Correction de bugs par Damiano Lombardi
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | Correctif reporté sur la 3.22 (GitHub) |
| --- | --- | --- | --- |
