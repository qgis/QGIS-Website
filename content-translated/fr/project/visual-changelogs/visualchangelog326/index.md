...
section: projet
sidebar: true
title: Modifications apportées par QGIS 3.26
type: visual-changelog

---
{{<content-start >}}
# Modifications apportées par QGIS 3.26{#changelog326 }
![image1](images/projects/916ce336f8f5939eb158506ea38290af6f1ce0f0.png)

Date de publication : 17/06/2022

La version riche en fonctionnalités de QGIS 3.26 Buenos Aires comprend un grand nombre d'améliorations apportées à une série de fonctionnalités natives avancées. Il s'agit notamment de nombreuses améliorations des capacités 3D, d'un outil amélioré pour les nuages de points et de l'introduction d'un nouveau cadre de traçage de profil pour la création de sections transversales et de profils d'élévation. Mieux encore, le nouveau cadre de traçage utilise les capacités de rendu natives de QGIS et est livré avec toutes les propriétés de style, de symbologie et de pilotage par les données que nous connaissons et aimons tous !
...
{{<table-of-contents >}}
## Changements majeurs
### Fonctionnalité: Support de DB2 retiré
Le fournisseur DB2 a été noté comme obsolète et masqué dans l'interface utilisateur de QGIS depuis plusieurs versions. Comme aucun responsable ne s'est présenté pour assurer la maintenance de ce fournisseur de données, il a été retiré et ne sera désormais plus disponible dans QGIS.
## Outils cartographiques
### Fonctionnalité: Sélectionner plusieurs entités par valeur d'attribut depuis le panneau d'identification
Les résultats de l'outil d'identification offrent désormais une option via le menu contextuel d'une valeur de champ attributaire qui permet une sélection rapide de toutes les entités de la même valeur du calque.
...
### Fonctionnalité: Classement des coordonnées par SCR
QGIS utilise désormais l'ordre correct des coordonnées pour le SCR du projet quand il affiche les coordonnées dans la barre d'état (et les résultats d'identification). Un paramètre a été ajouté dans les propriétés du projet pour permettre aux utilisateurs d'outrepasser cela avec un ordre de coordonnées spécifique si nécessaire (x/y ou y/x).

Tout particulièrement, cela signifie que les projets dans les SCR géographiques comme EPSG:4326 afficheront désormais des coordonnées dans l'ordre latitude/longitude plutôt que longitude/latitude (à moins que le SCR spécifique ait un ordre différent).

![image4](images/entries/7dada94231069c7f647d9a4a239d57506ad14bfd.gif)

Cette fonctionnalité a été financée par SevenCs GmbH
...
Cette fonctionnalité a été financée par le Canton de Soleure
...
| Intitulé du bug | URL Issues (if reported, Github) | URL du commit (Github) | Correctif reporté sur la 3.22 (GitHub) |
| --- | --- | --- | --- |
...
| Non-existent but registered attribute table in GPKG is added as empty table | [#30670](https://github.com/qgis/QGIS/issues/30670) | [GDAL PR 5752](https://github.com/OSGeo/gdal/pull/5752) | Inapproprié |
...
| Raster tiles are clipped based on the gpkg_contents bounding box of a GeoPackage | [#45530](https://github.com/qgis/QGIS/issues/45530) | Pas un bug |  |
...
| Intitulé du bug | URL Issues (if reported, Github) | URL du commit (Github) | Correctif reporté sur la 3.22 (GitHub) |
| --- | --- | --- | --- |
| \@project_keywords are no longer tested on Rule based filters | [#48480](https://github.com/qgis/QGIS/issues/48480) | Pas un bug |  |
...
| Highlight of identified feature not displaying correctly on \"geometry generator\" marker from different CRS | [#48439](https://github.com/qgis/QGIS/issues/48439) | [PR #48579](https://github.com/qgis/QGIS/pull/48579) | À faire |
| Cannot past copied features as temporary scratch layer | [#48401](https://github.com/qgis/QGIS/issues/48401) | [PR #48611](https://github.com/qgis/QGIS/pull/48611) | À faire |
| QGIS crash by opening a form with relation content | [#48443](https://github.com/qgis/QGIS/issues/48443) | [PR #48616](https://github.com/qgis/QGIS/pull/48616) | À faire |
| Relation reference widget: filter expression does not work with variables | [#48190](https://github.com/qgis/QGIS/issues/48190) | [PR #48619](https://github.com/qgis/QGIS/pull/48619) | À faire |
| Random order of attributes in oracle feature query | [#35309](https://github.com/qgis/QGIS/issues/35309) | [PR #48668](https://github.com/qgis/QGIS/pull/48668) | non |
...
| Documentation doctest failure | [QGIS developer mail list](https://lists.osgeo.org/pipermail/qgis-developer/2022-May/064720.html) | [QGIS Documentation PR 7581](https://github.com/qgis/QGIS-Documentation/pull/7581) | non |
| \"Add to group\" option in sub layer window always add at top of layer tree | [#48694](https://github.com/qgis/QGIS/issues/48694) | [PR #48696](https://github.com/qgis/QGIS/pull/48696) | non |
| Name/id of map objects in GetProjectSettings follows an order that is the inverse of the order used to add the map objects in a layout | [#46143](https://github.com/qgis/QGIS/issues/46143) | [PR #48728](https://github.com/qgis/QGIS/pull/48728) | non |
| Aborted inserts in Postgis geometryless tables are saved anyway | [#48171](https://github.com/qgis/QGIS/issues/48171) | [PR #48741](https://github.com/qgis/QGIS/pull/48741) | non |
| Inconsistent coordinate rounding in Raster \"Layer Properties\" | [#48767](https://github.com/qgis/QGIS/issues/48767) | [PR #48790](https://github.com/qgis/QGIS/pull/48790) | À faire |
| Drag and Drop Postgis-Table in QGIS Browser alters name of Geometry-Column | [#48748](https://github.com/qgis/QGIS/issues/48748) | [PR #48796](https://github.com/qgis/QGIS/pull/48796) | non |
| Layer filter does not work on multiline strings values with linebreaks | [#47530](https://github.com/qgis/QGIS/issues/47530) | [PR #48818](https://github.com/qgis/QGIS/pull/48818) | pas nécessaire |
...
| Server GetPrint with multiple maps following map themes apply prefixed LAYERS (map0:LAYERS) to all maps | [PR #48923](https://github.com/qgis/QGIS/pull/48923) | [PR #48923](https://github.com/qgis/QGIS/pull/48923) | À faire |
...
| GDAL Vector to Raster (gdal_rasterize) fail to produce ESRI ASCII as output | [#39140](https://github.com/qgis/QGIS/issues/39140) | Pas un bug |  |
...
| Intitulé du bug | URL Issues (if reported, Github) | URL du commit (Github) | Correctif reporté sur la 3.22 (GitHub) |
| --- | --- | --- | --- |
| Add simple bash script to run tests as done by CI | [QGIS QEP #244](https://github.com/qgis/QGIS-Enhancement-Proposals/issues/244) | [PR #48617](https://github.com/qgis/QGIS/pull/48617) | Inapproprié |
| test_provider_eptprovider occasionally aborts | [#48778](https://github.com/qgis/QGIS/issues/48778) | [PR #48793](https://github.com/qgis/QGIS/pull/48793) | pas nécessaire |
...
| Check that source files are not overridden | [#25830](https://github.com/qgis/QGIS/issues/25830) | [PR #48654](https://github.com/qgis/QGIS/pull/48654) | Inapproprié |
...
| Improve UX for virtual layer creation dialog | non signalé | [PR #49015](https://github.com/qgis/QGIS/pull/49015) | Inapproprié |
...
| Don\'t hang when an error occurs while trying to build a virtual layer | [#48908](https://github.com/qgis/QGIS/issues/48908) | [Commit 988edc8700](https://github.com/qgis/QGIS/commit/988edc8700bd8d6363ebc4e4379963924bfa02b5) | Trop intrusif |
| Don\'t offer non-vector layer providers as options for virtual layer | [#48908](https://github.com/qgis/QGIS/issues/48908) | [Commit 988edc8700](https://github.com/qgis/QGIS/commit/988edc8700bd8d6363ebc4e4379963924bfa02b5) | Trop intrusif |
...
| Fix some undersized icons on hidpi displays | non signalé | [PR #48875](https://github.com/qgis/QGIS/pull/48875) | Inapproprié |
...
| Fix clear values for offset along line spin boxes | non signalé | [PR #48872](https://github.com/qgis/QGIS/pull/48872) | [PR #48878](https://github.com/qgis/QGIS/pull/48878) |
| Fix ambiguous \"show all labels\" setting and address regressions in label when this setting is misinterpreted | [#41043](https://github.com/qgis/QGIS/issues/41043) | [PR #48771](https://github.com/qgis/QGIS/pull/48771) | Trop intrusif |
| Main annotation layer should follow project crs unless it has items added | [#42378](https://github.com/qgis/QGIS/issues/42378) | [PR #48815](https://github.com/qgis/QGIS/pull/48815) | Trop intrusif |
| Fix some misleading warnings about transformations for non-earth crs | [#42378](https://github.com/qgis/QGIS/issues/42378) | [PR #48815](https://github.com/qgis/QGIS/pull/48815) | Trop intrusif |
| Never show the transformation selection dialog for the first layer added to a project | non signalé | [PR #48811](https://github.com/qgis/QGIS/pull/48811) | [PR #48814](https://github.com/qgis/QGIS/pull/48814) |
...
| Fix loss of mesh layer styling when fixing a broken path to a mesh layer | non signalé | [PR #48765](https://github.com/qgis/QGIS/pull/48765) | [PR #48768](https://github.com/qgis/QGIS/pull/48768) |
...
| Don\'t hide parts of the mesh renderer widget if the layer is invalid | non signalé | [PR #48757](https://github.com/qgis/QGIS/pull/48757) |  |
| Add layer opacity widget in mesh layer renderer properties widget | non signalé | [PR #48756](https://github.com/qgis/QGIS/pull/48756) |  |
| Review and finish open PR [PR #44941](https://github.com/qgis/QGIS/pull/44941) |  |  |  |
| Fix a crash when QgsProject::instance() is accessed when no QgsApplication exists | non signalé | [PR #48721](https://github.com/qgis/QGIS/pull/48721) | N/A |
...
| Fix crash on QGIS exit | likely solves a number of open tickets, but needs end user confirmation | [Commit 5b052730b5](https://github.com/qgis/QGIS/commit/5b052730b5c10f12570dd5e68fca1962f113b3f3) | Trop intrusif |
| Add support for map field types to memory provider, avoid data loss in models/processing | non signalé | [PR #48638](https://github.com/qgis/QGIS/pull/48638) | Trop intrusif |
...
| Fix many memory leaks | non signalé | [PR #48590](https://github.com/qgis/QGIS/pull/48590) | N/A |
| Fix ctrl modifier scrolling on symbol buttons | non signalé | [PR #48581](https://github.com/qgis/QGIS/pull/48581) | N/A |
