...
| QGIS Server does not list one layer in WMS GetCapabilities if datum transformation is used | [\#61293](https://github.com/qgis/QGIS/issues/61293) | Retour d'informations |  |
...
| JSON array attribute fields are not supported | [\#61728](https://github.com/qgis/QGIS/issues/61728) | [PR \#61938](https://github.com/qgis/QGIS/pull/61938) | Risqué |
...
| PG: Can't add/update feature when numeric field with numeric default is set to default | [\#61529](https://github.com/qgis/QGIS/issues/61529) | [PR \#62010](https://github.com/qgis/QGIS/pull/62010) | Risqué |
...
| duplicated objectName in the oracle dialog | non signalé | [PR \#61944](https://github.com/qgis/QGIS/pull/61944) | N/A |
...
| Fix reshaping when snapping to segment | non signalé | [PR \#62315](https://github.com/qgis/QGIS/pull/62315) |  |
| Unhandled GEOS exception when reshaping | non signalé | [PR \#62322](https://github.com/qgis/QGIS/pull/62322) |  |
| Reshape returns Success instead of NothingHappened | non signalé | [PR \#62323](https://github.com/qgis/QGIS/pull/62323) | [PR \#62336](https://github.com/qgis/QGIS/pull/62336) |
| Reshape tool tries to run with a single digitized point | non signalé | [PR \#62324](https://github.com/qgis/QGIS/pull/62324) |  |
| Fix crash when undoing first digitized point in shape map tools | non signalé | [PR \#62335](https://github.com/qgis/QGIS/pull/62335) |  |
| Fix crashing shape tools when not enough points digitized | non signalé | [PR \#62338](https://github.com/qgis/QGIS/pull/62338) |  |
...
| Misbehavior of advanced topology settings on independant layers | pas un bug |  |  |
...
| Erreurs JSON ambiguës | [\#42832](https://github.com/qgis/QGIS/issues/42832) | [PR \#62247](https://github.com/qgis/QGIS/pull/62247) | [PR \#62262](https://github.com/qgis/QGIS/pull/62262) |
...
| When saving SLD to DB, make sure errors are reported to callers (like Package layers algorithm) | non signalé | [PR \#62332](https://github.com/qgis/QGIS/pull/62332) |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| QGIS fails to import sprites from OpenStreetMap vector tile styles | non signalé | [PR \#62175](https://github.com/qgis/QGIS/pull/62175) |  |
...
| QGIS fails to handle of source containing a relative path to the root of the server hosting the style json | non signalé | [PR \#62062](https://github.com/qgis/QGIS/pull/62062) | [PR \#62084](https://github.com/qgis/QGIS/pull/62084) |
...
| Various new connection dialog spacing and size issues | non signalé | [PR \#62041](https://github.com/qgis/QGIS/pull/62041) |  |
...
| Intitulé du bug | URL du ticket (le cas échéant) | URL du commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix walk mode key handling | non signalé | [PR \#62331](https://github.com/qgis/QGIS/pull/62331) | N/A |
| Increase QImageReader allocation limit for qt6 builds | non signalé | [PR \#62320](https://github.com/qgis/QGIS/pull/62320) | N/A |
...
| Use protected, not private virtual methods for map tool classes | non signalé | [PR \#62097](https://github.com/qgis/QGIS/pull/62097) | [PR \#62112](https://github.com/qgis/QGIS/pull/62112) |
| Avoid corrupted overlapping docks when first changing from dialog to dock | non signalé | [PR \#62102](https://github.com/qgis/QGIS/pull/62102) | N/A |
| Fix jumpy scroll area when using mouse wheel on qt6 builds | non signalé | [PR \#62099](https://github.com/qgis/QGIS/pull/62099) | N/A |
...
| Fix variables available for grid annotations missing for grid symbol | non signalé | [PR \#61943](https://github.com/qgis/QGIS/pull/61943) | [PR \#61957](https://github.com/qgis/QGIS/pull/61957) |
...
| Delimited text test can be run on qt6 now | non signalé | [PR \#61900](https://github.com/qgis/QGIS/pull/61900) | N/A |
| Fix mesh layer labeling tests not actually run | non signalé | [PR \#61899](https://github.com/qgis/QGIS/pull/61899) | [PR \#61909](https://github.com/qgis/QGIS/pull/61909) |
