...
title: Utilisation de QGIS par le groupe de déminage danois en Afghanistan.
type: case-study

---
{{<content-start >}}
# Utilisation de QGIS par le groupe de déminage danois en Afghanistan.
...
QGIS permet également de synchroniser les données collectées lors des opérations de terrain en utilisant un GPS Garmin, ce qui permet de réaliser des cartes de nettoyage avec l'emplacement précis des mines trouvées et détruites.
