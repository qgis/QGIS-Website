...
title: 'Système d''observation et d''information sur l''eau : favoriser l''utilisation
  des données d''observation de la terre pour la gestion intégrée des ressources en
  eau en Afrique'
type: case-study
