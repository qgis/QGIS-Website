...
### Comment poser une question sur QGIS ?
...
- de préférence un titre explicite à votre e-mail
- la version (précise) de QGIS que vous utilisez
- ce que vous espérez obtenir
- le cas échéant, qu'avez-vous essayé et quel est le résultat que vous avez obtenu
- si votre question porte sur quelque chose de cassé, vous pouvez également fournir :
  - quelle est exactement l'erreur (si possible: copie d'écran, trace de la pile, copie du message d'erreur)
  - quel système d'exploitation vous utilisez et sa version
  - comment vous l'avez installé (osgeo4w ? installeur msi ? version personnelle ?)
  - à quel moment y a-t-il eu un problème (nouvelle installation, réinstallation, mise à jour du système, modification du projet)
...
{{<rich-box-end >}}
### Comment sont choisis les noms des versions de QGIS ?
À la suite d'une réunion des développeurs réussie à Zurich (Suisse) nous avons décidé que la version suivante devait y être liée. Depuis lors, toutes les versions ont été nommées avec le lieu de la réunion des développeurs.
### Puis-je ouvrir un fichier ECW dans Qgis?
...
## Developer questions
### Puis-je compiler moi-même QGIS ?
...
**Citer le manuel d'utilisation de QGIS**
...
**Citer le manuel de QGIS Server**
...
```
### J'ai créé une carte avec QGIS, dois-je citer QGIS ?
...
{{<rich-content-start themeClass="coloring-1" >}}
##### Note
Ne pas écrire ©QGIS car QGIS ne détient pas de droit sur votre travail.
