...
section: Projekt
sidebar: true
title: Änderungsprotokoll für QGIS 2.14
type: visual-changelog

---
{{<content-start >}}
# Änderungsprotokoll für QGIS 2.14{#changelog214 }
...
**Extra-lang unterstützte Version**
...
Der Zweck von LTR-Veröffentlichungen ist es eine stabile und seltener veränderliche Plattform für Unternehmen und Organisationen zur Verfügung zu stellen, die sich nicht häufiger als einmal im jahr mit dem Aktualisieren von Anwenderkenntnissen, Übungsmaterial etc. beschäftigen möchten. Der Erfolg der LTR ist sehr von Ihnen abhängig, unseren geschätzten Anwendern: Wir benötigen Ihre Unterstützung, um Fehler bereinigen zu können und sicherzustellen, dass in Ihren Supportverträgen mit Supportanbietern festgehalten wird, dass sämtliche von Ihrer Seite ausgeführten Fehlerbeseitigungen auch auf unsere Entwicklungszweige sowohl für LTR als auch für die normale Entwicklung angewendet werden.
...
{{<table-of-contents >}}
## Gegenwärtige QGIS-Sponsoren
{{<fund type="changelog" >}}
## Allgemein
### Feature: Geändertes Verhalten der strpos-Funktion
...
Projektdateien früherer QGIS-Versionen müssen aktualisiert werden um diese Veränderung widerzuspiegeln.
...
### Feature: In der Attributtabelle mit Rechtsklick zum Objekt zoomen
Sie können jetzt innerhalb der Attributtabelle auf jedes Objekt vergrößern (ohne es zuerst auswählen zu müssen), indem Sie es mit der rechten Maustaste anklicken und "zum Objekt zoomen" auswählen.

![image48](images/entries/7a400f577a7d554f309297f8a1af05a61e448a27.png.400x300_q85_crop.webp)
### Feature: Verbesserung von Geschwindigkeit und Speicher
- **Eine Reihe ausgewählter Objekte speichern** auf einem größeren Layer ist jetzt viel schneller
- Das Aktualisieren nur der ausgewählten Objekte mittels Nutzung des **Feldrechners** ist schneller
- **Schnellerer Zoom** auf eine Auswahl auf größeren Layern
...
### Feature: Mehr Ausdrucksvariabeln
Während dem Rendering sind neue Variabeln verfügbar:
...
Diese sind nützlich um verschiedenen Teilen von mehrteiligen Geometrien unterschiedliche Stile zuzuweisen:
...
Variabeln mit Bezug zur Systemumgebung und Betriebsystem wurden ebenfalls hinzugefügt:
...
Dieses Feature wurde von Andreas Neumann finanziert (die Variabeln mit Bezug zum Betriebssystem und Nutzername)

Dieses Feature wurde von Nyall Dawson und Matthias Kuhn entwickelt
...
- WMS-Daten Dialog zur Layer-Baumgruppe (Kurzname, Titel, Zusammenfassung)
