...
section: Projekt
sidebar: true
title: Änderungsprotokoll für QGIS 3.16
type: visual-changelog

---
{{<content-start >}}
# Änderungsprotokoll für QGIS 3.16{#changelog316 }
![image1](images/projects/dbc0cef663f2f652e0961ac2ed168eb45ed2e182.png)

Veröffentlichungsdatum: 2020-10-23

Ein weiterer großartiger Tag für das QGIS-Projekt! Die neue Langzeit-Support-Version bietet eine breite Palette von Funktionen für QGIS Desktop und QGIS Server. Diese Version bietet eine Fülle neuer Optionen für 3D-Mapping, Netzgenerierung aus anderen Datentypen, zusätzliche Tools für die räumliche Analyse, Symbologie und Verbesserungen der Benutzeroberfläche, um nur einige zu nennen! In das ständig wachsende Verarbeitungsframework wurde eine Vielzahl von Tools integriert, und der QGIS-Browser unterstützt jetzt erweiterte Datenbankinteraktionsfunktionen, die zuvor für das DB Manager-Plugin reserviert waren. Dies sind einige der Verbesserungen, die in dieser Version eingeführt wurden, und Benutzer des vorherigen LTS werden seit 3.10 eine Vielzahl neuer Funktionen finden. Wir freuen uns, einige der zusätzlichen Highlights dieser neuen Version unten detailliert beschreiben zu können.
...
## Zeitlich
### Möglichkeit zum Exportieren von zeitlichen Animationsframes
...
| Error of the raster histogram of QGIS 3.10.8(LTR) | [#38298](https://github.com/qgis/QGIS/issues/38298) | [PR #38769](https://github.com/qgis/QGIS/pull/38769) | OFFEN |
...
| Server WFS-T 1.1.0 wrong case for totalUpdated, totalInserted, totalDeleted | [#38558](https://github.com/qgis/QGIS/issues/38558) | [PR #38764](https://github.com/qgis/QGIS/pull/38764) | OFFEN |
...
| Form view gets stuck in the last shown not-NULL-value for some attributes when browsing through data | [#38552](https://github.com/qgis/QGIS/issues/38552) | [PR #38801](https://github.com/qgis/QGIS/pull/38801) | OFFEN |
...
| Export report to PDF crashes QGIS if no layout is in edit mode | [#39086](https://github.com/qgis/QGIS/issues/39086) | [PR #39135](https://github.com/qgis/QGIS/pull/39135) | OFFEN |
...
| setting a field to NULL via field calculator freezes qgis | [#39178](https://github.com/qgis/QGIS/issues/39178) | [PR #39257](https://github.com/qgis/QGIS/pull/39257) | OFFEN |
...
| Exporting GRASS vector (save as\...) crashes QGIS | [#37508](https://github.com/qgis/QGIS/issues/37508) | [PR #39284](https://github.com/qgis/QGIS/pull/39284) | OFFEN |
| Crash when loading 3D project with DEM terrain and symbols that uses height value over the terrain | [#35483](https://github.com/qgis/QGIS/issues/35483) | [PR #39287](https://github.com/qgis/QGIS/pull/39287) | OFFEN |
...
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| correctly determine if variables are static in aggregate expression and filter, give \@parent in generic aggregates | [#33382](https://github.com/qgis/QGIS/issues/33382) | [PR #39391](https://github.com/qgis/QGIS/pull/39391) | nein |
...
| Ensure display expression is used for map action tool, not raw feature ids | not reported | [Commit e304d4d7e3eae0f48f336c7eb34542be6055df5d](https://github.com/qgis/QGIS/commit/e304d4d7e3eae0f48f336c7eb34542be6055df5d) | Niedrige Priorität |
