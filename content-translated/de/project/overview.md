...
HasBanner: true
LabelText: Freie und Open-Source
...
{{<content-start >}}
## Key features
{{<tabs tab1="Karten erstellen" tab2="Layer bearbeiten" tab3="Verarbeiten und analysieren" tab4="Karten teilen" >}}
...
{{< rich-box-start >}} {{< rich-content-start themeClass="coloring-6" >}}
### QGIS-Desktop
Erstellen, Bearbeiten, Anzeigen, Analysieren und Veröffentlichung von raumbezogener Information.
...
{{< rich-box-start >}} {{< rich-content-start themeClass="coloring-6" >}}
### QGIS für Mobilgeräte und Tablets
