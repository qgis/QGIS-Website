...
- Autoren: Hans van der Kwast, Kurt Menke
- Datum: Mai 2022
...
### QGIS entdecken
Das Arbeitsbuch für das GeoAcademy Curriculum
...
- Autor(en): Alex Mandel, Anita Graser, Victor Olaya Ferrero, Alexander Bruy
- Datum: April 2016

### Learning QGIS - Dritte Auflage
Nutzen Sie QGIS um großartige Karten herzustellen und alle notwendigen Geoprocessing-Aufgaben durchzuführen.
...
- Autor(en): Anita Graser
- Datum: März 2016

### QGIS Map Design
Lernen Sie, wie Sie QGIS nutzen um Ihre kartografischen Produkte auf Höchstniveau zu bringen
- [http://locatepress.com/qmd](http://locatepress.com/qmd)
- Autor(en): Anita Graser und Gretchen N. Peterson
- Datum: März 2016

### Mastering QGIS
Tauchen Sie in QGIS ein und beherrschen Sie raumbezogene Daten mithilfe dieses Fortgeschrittenen-Handbuches, das erstellt wurde um Ihnen dabei zu helfen Karten und Anwendungen zu entwickeln, die Sie die Welt auf neuen Wegen entdecken lassen.
...
- Autor(en): Kurt Menke, GISP - Dr. Richard Smith Jr., GISP - Dr. Luigi Pirelli - Dr John Van Hoesen, GISP
- Datum: März 2015

### QGIS Blueprints
Entwickeln Sie analytische standortbasierte Internetanwendungen mit QGIS
...
### QGIS By Example
Setzen Sie die Macht von QGIS in praxistauglichen Anwendungen ein, um ein leistungsstarker Nutzer der Kartografie und GIS-Analysen zu sein 
- [https://www.packtpub.com/application-development/qgis-example](https://www.packtpub.com/application-development/qgis-example)
- Autor(en): Alexander Bruy, Daria Svidzinsk
- Datum: Juni 2015

### The PyQGIS Programmer’s Guide - Extending QGIS with Python
Willkommen in der Welt von PyQGIS - der Vermengung von Quantum GIS und Python - um Ihr Open Source GIS-Werkzeug zu erweitern und zu verbessern. Mit PyQGIS können Sie Skripte und Plugins schreiben um neue Funktionen zu implementieren und automatisierte Aufgaben durchzuführen.
- [http://locatepress.com/ppg](http://locatepress.com/ppg)
- Autor(en): Gary Sherman
- Datum: April 2014

### The QGIS Training Manual - A Comprehensive Introduction to Quantum GIS
Für QGIS 1.8 bestimmt
...
- Autor(en): Rüdiger Thiede, Tim Sutton, Horst Düster, and Marcelle Sutton
- Datum: Mai 2013
...
- Autoren: Can Ayday, Levent Sabah, Nefise Yaman, Kübra Keser
- Datum: January 2016
