...
| Ort an dem der Fehler auftrat oder für die ein Erweiterungswunsch vorliegt | Wo das Problem zu melden ist |
| --- | --- |
| Applikationen (QGIS-Desktop, QGIS-Server) | https://github.com/qgis/QGIS/issues |
| QGIS-Website (https://qgis.org) | https://github.com/qgis/QGIS-Website/issues |
| QGIS-Dokumentation (https://docs.qgis.org) | https://github.com/qgis/QGIS-Documentation/issues |
...
| Externe Erweiterungen | Das Repositorium, dass der Autor in der Erweiterungsbeschreibung angegeben hat |
