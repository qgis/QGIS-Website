...
Вийдіть за межі початкового рівня та відкрийте всю потужність QGIS з практичними покроковими прикладами.
...
### Discover QGIS
Підручник GeoAcademy Curriculum
- [https://locatepress.com/dqw](https://locatepress.com/dqw)
- Автор(и): Kurt Menke
- Дата: липень 2016

### QGIS 2 Cookbook
Станьте досвідченим користувачем QGIS та опануйте управління даними, візуалізацію та просторовий аналіз.
...
- Автор(и): Alex Mandel, Anita Graser, Victor Olaya Ferrero, Alexander Bruy
- Дата: квітень 2016

### Learning QGIS - Third Edition
Використовуйте QGIS для створення чудових мап та проведення просторового аналізу.
...
- Автор(и): Anita Graser
- Дата: березень 2016

### QGIS Map Design
Дізнайтесь як використовувати QGIS, щоб піднести свої картографічні продукти на найвищий рівень.
- [http://locatepress.com/qmd](http://locatepress.com/qmd)
- Автор(и): Anita Graser та Gretchen N. Peterson
- Дата: березень 2016

### QGIS Blueprints
Розробляйте аналітичні застосунки з використанням визначення місцеположення та QGIS.
...
### QGIS By Example
Пізнайте потужність QGIS на реальних прикладах щоб стати просунутим користувачем у картографії та ГІС-аналізі.
...
- Автор(и): Alexander Bruy, Daria Svidzinskа
- Дата: червень 2015

### The PyQGIS Programmer’s Guide - Extending QGIS with Python
Ласкаво просимо до світу PyQGIS, суміші QGIS та Python для розширення та вдосконалення вашого вільного набору ГІС-інструментів. За допомогою PyQGIS ви можете писати сценарії та реалізовувати новий функціонал та автоматизувати задачі.
- [http://locatepress.com/ppg](http://locatepress.com/ppg)
- Автор(и): Gary Sherman
- Дата: квітень 2014

### The QGIS Training Manual - A Comprehensive Introduction to Quantum GIS
Написано для QGIS 1.8
...
- Автор(и): Rüdiger Thiede, Tim Sutton, Horst Düster та Marcelle Sutton
- Дата: травень 2013
...
### QGIS на середньому рівні - Географія - Картографія на середньому рівні - гра GISwijzer GO
...
### Learning QGIS by example (французькою)
Ця книга охоплює основні ГІС процеси від створення даних до їх картографічного представлення та базового просторового аналізу.
...
## Грецька
### Вступ у растровий аналіз (Learning QGIS Book 2)
- [https://www.kobo.com/cy/en/ebook/V7poK2Or2za3IqGN-__5ZA](https://www.kobo.com/cy/en/ebook/V7poK2Or2za3IqGN-__5ZA)
- Автор(и): Anthony Antoniou
- Дата: грудень 2016

### Базовий підручник з початкового вивчення QGIS (2.8)
...
## Польська
### Дізнайтеся про ГІС та QGIS (польською)
