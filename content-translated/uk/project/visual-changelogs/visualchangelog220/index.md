...
section: проект
sidebar: true
title: Список змін для QGIS 2.2
type: visual-changelog

---
{{<content-start >}}
# Список змін для QGIS 2.2{#changelog22 }
...
## Загальне
### Список останніх виразів
Редактор виразів тепер запам'ятовує 20 останніх виразів.
...
## Редактор макетів
### Вдосконалення рамки карти типу «зебра»
