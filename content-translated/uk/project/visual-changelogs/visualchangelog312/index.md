...
section: проект
sidebar: true
title: Список змін для QGIS 3.12
type: visual-changelog

---
{{<content-start >}}
# Список змін для QGIS 3.12{#changelog312 }
...
| Snapping not possible in new project with new layer | [#32969](https://github.com/qgis/QGIS/issues/32969) | Дублювати | - |
...
| Rubberband not working correctly with \"Shapes\" digtizing in rotated map window | [#33287](https://github.com/qgis/QGIS/issues/33287) | Дублювати |  |
