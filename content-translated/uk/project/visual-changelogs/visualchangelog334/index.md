...
| --- | --- | --- | --- |
| QGIS cannot connect to MySQL if user\'s password contains commas. | [#54493](https://github.com/qgis/QGIS/issues/54493) | [PR #54573](https://github.com/qgis/QGIS/pull/54573) | Ні |
...
| Cant subtract or add angles since the degrees symbol has been added | [#54501](https://github.com/qgis/QGIS/issues/54501) | [PR #54687](https://github.com/qgis/QGIS/pull/54687) | Н/Д |
| WCS Keep Unavailable Layers | [#54702](https://github.com/qgis/QGIS/issues/54702) | [PR #54707](https://github.com/qgis/QGIS/pull/54707) | Н/Д |
| taxon legend from map whis atlas | [#54654](https://github.com/qgis/QGIS/issues/54654) | [PR #54692](https://github.com/qgis/QGIS/pull/54692) | Н/Д |
| Spinbox for colum space in legends does not allow to set values above 99.99 units | [#54682](https://github.com/qgis/QGIS/issues/54682) | [PR #54709](https://github.com/qgis/QGIS/pull/54709) | Н/Д |
| Geometry Error SpatiaLite Database | [#54662](https://github.com/qgis/QGIS/issues/54662) | [PR #54734](https://github.com/qgis/QGIS/pull/54734) | Н/Д |
...
| Open project, then layer properties, close, close project: qgis thinks something has changed | [#54741](https://github.com/qgis/QGIS/issues/54741) | [PR #54757](https://github.com/qgis/QGIS/pull/54757) | Н/Д |
...
| Data Source Manger - Browser: Close and Help buttons are missing | [#54171](https://github.com/qgis/QGIS/issues/54171) | [PR #54770](https://github.com/qgis/QGIS/pull/54770) | Н/Д |
| 0 port in OAuth2 callback URI | [#54562](https://github.com/qgis/QGIS/issues/54562) | Cannot reproduce | Н/Д |
...
| QGIS fails to request more than one WMS-Layer | [#55042](https://github.com/qgis/QGIS/issues/55042) | [PR #55064](https://github.com/qgis/QGIS/pull/55064) | Н/Д |
...
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgsgeos.cpp: fix a -Wunused-variable warning | unreported | [PR #54612](https://github.com/qgis/QGIS/pull/54612) | Н/Д |
| qgsvirtualpointcloudprovider.cpp: add a missing variable initialization | unreported | [PR #54613](https://github.com/qgis/QGIS/pull/54613) | Н/Д |
...
| Does QGIS require units \"m\" for the projection coordinate variables in a netCDF/CF file? | [QGIS user mailing list](https://lists.osgeo.org/pipermail/qgis-user/2023-September/053413.html) | [GDAL PR 8407](https://github.com/OSGeo/gdal/pull/8407) | Н/Д |
...
| GPX Provider: missing element when importing gpx file | [#54119](https://github.com/qgis/QGIS/issues/54119) | [PR #54632](https://github.com/qgis/QGIS/pull/54632) | Н/Д |
| Saving edits on larger vector layers is slow | [#53043](https://github.com/qgis/QGIS/issues/53043) | [PR #54633](https://github.com/qgis/QGIS/pull/54633) | Н/Д |
...
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix segfault in coordinate transform | unreported | [PR #54609](https://github.com/qgis/QGIS/pull/54609) | Н/Д |
| Wrong rendering for HIGHLIGHT_LABEL_ROTATION above 89° | [#54598](https://github.com/qgis/QGIS/issues/54598) | [PR #54667](https://github.com/qgis/QGIS/pull/54667) | Н/Д |
| Database string connection visible in the message bar/QGIS logs | [#54437](https://github.com/qgis/QGIS/issues/54437) | [PR #54650](https://github.com/qgis/QGIS/pull/54650) | Н/Д |
| PostGIS Connection\'s \"Session ROLE\" is not kept | [#54638](https://github.com/qgis/QGIS/issues/54638) | [PR #54681](https://github.com/qgis/QGIS/pull/54681) | Н/Д |
| Example files are installed by the server build, and additionally they are in a wrong place | [#54423](https://github.com/qgis/QGIS/issues/54423) | [PR #54708](https://github.com/qgis/QGIS/pull/54708) | Н/Д |
...
| qgs/qgz project does not save mesh symbology correctly | [#54384](https://github.com/qgis/QGIS/issues/54384) | [PR #54711](https://github.com/qgis/QGIS/pull/54711) | Н/Д |
| Endless loop if profile is drawn outside layer extent | [#54349](https://github.com/qgis/QGIS/issues/54349) | [PR #54745](https://github.com/qgis/QGIS/pull/54745) | Н/Д |
| Server: Can\'t enable WFS3 API update endpoint (PUT/PATCH) on layers without geometry | [#46119](https://github.com/qgis/QGIS/issues/46119) | [PR #54789](https://github.com/qgis/QGIS/pull/54789) | Н/Д |
| Add safe guard around -of in gdal command for batch processing | [#54122](https://github.com/qgis/QGIS/issues/54122) | [PR #54800](https://github.com/qgis/QGIS/pull/54800) | Н/Д |
...
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Have QgsRectangle null rectangle printed as EMPTY in wkt | unreported | [PR #54831](https://github.com/qgis/QGIS/pull/54831) | Н/Д |
| Fix aspect ratio computation in QgsLayoutItemMap::zoomToExtent | unreported | [PR #54827](https://github.com/qgis/QGIS/pull/54827) | Н/Д |
| Do not include a BoundingBox tag in GetFeatureInfo responses, when it is null | unreported | [PR #54858](https://github.com/qgis/QGIS/pull/54858) | Н/Д |
| Always run the spell and shell checkers if possible, print warning when not possible | unreported | [PR #54847](https://github.com/qgis/QGIS/pull/54847) | Н/Д |
| Tweak Null rectangle handling | unreported | [PR #54872](https://github.com/qgis/QGIS/pull/54872) | Н/Д |
| Run spellcheck only on changed files in prepare_commit.sh | unreported | [PR #54893](https://github.com/qgis/QGIS/pull/54893) | Н/Д |
| Fix prepare_commit.sh | unreported | [PR #54918](https://github.com/qgis/QGIS/pull/54918) | Н/Д |
| Fix extent computation in QgsSpatiaLiteProvider | unreported | [PR #54917](https://github.com/qgis/QGIS/pull/54917) | Н/Д |
| Do not force verbose build in mingw build | [#54932](https://github.com/qgis/QGIS/issues/54932) | [PR #54924](https://github.com/qgis/QGIS/pull/54924) | Н/Д |
| Make QgsBookmark string output more explicit about it being EMPTY | unreported | [PR #54923](https://github.com/qgis/QGIS/pull/54923) | Н/Д |
| Fix extent computation in QgsAFSProvider | unreported | [PR #54944](https://github.com/qgis/QGIS/pull/54944) | Н/Д |
| Add `tags` make target | unreported | [PR #54948](https://github.com/qgis/QGIS/pull/54948) | Н/Д |
| Handle null rectangles in QgsExtentWidget::outputExtent | unreported | [PR #54953](https://github.com/qgis/QGIS/pull/54953) | Н/Д |
| Handle null in QgsRectangle grow() and include() methods | unreported | [PR #54955](https://github.com/qgis/QGIS/pull/54955) | Н/Д |
| Add QgsRectangle::setNull(), deprecating setMinimal() | unreported | [PR #54934](https://github.com/qgis/QGIS/pull/54934) | Н/Д |
| Handle Null rectangle in QgsRectangle::buffered | unreported | [PR #54967](https://github.com/qgis/QGIS/pull/54967) | Н/Д |
| Fix extent computation in QgsVirtualLayerProvider | unreported | [PR #54976](https://github.com/qgis/QGIS/pull/54976) | Н/Д |
| Add a QgsRectangle::createNull() temporary static method | unreported | [PR #55008](https://github.com/qgis/QGIS/pull/55008) | Н/Д |
| Fix testRegisterFeatureUnprojectible - Use valid extent in testRegisterFeatureUnprojectible | unreported | [PR #55011](https://github.com/qgis/QGIS/pull/55011) | Н/Д |
| Have QgsGeometry::boundingBox return null rect for null geom | unreported | [PR #55012](https://github.com/qgis/QGIS/pull/55012) | Н/Д |
| Have QgsGeometry::fromRect(NULL RECT) return null geometry | unreported | [PR #54954](https://github.com/qgis/QGIS/pull/54954) | Н/Д |
| Stop considering Rectangle(0,0,0,0) null - while Rectangle(1,1,1,1) is not null | [#45563](https://github.com/qgis/QGIS/issues/45563) | [PR #54646](https://github.com/qgis/QGIS/pull/54646) | Н/Д |
| Run doxygen layout checker in prepare-commit script, when possible | unreported | [PR #54936](https://github.com/qgis/QGIS/pull/54936) | Н/Д |
...
| Fix toggling visibility of group layers resets child layer mask blend modes | [#53088](https://github.com/qgis/QGIS/issues/53088) | [PR #54897](https://github.com/qgis/QGIS/pull/54897) | Н/Д |
...
| Fix crash when changing layers between editable/non-editable layers | [#54802](https://github.com/qgis/QGIS/issues/54802) | [PR #54813](https://github.com/qgis/QGIS/pull/54813) | Н/Д |
| Fix QgsField::ConfigurationFlag::None causes syntax error when starting PyQGIS | unreported | [PR #54809](https://github.com/qgis/QGIS/pull/54809) | Н/Д |
