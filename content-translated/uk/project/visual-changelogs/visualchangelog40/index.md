...
| Server: landingpage webapp only functions if built with server python plugins support | [\#64556](https://github.com/qgis/QGIS/issues/64556) | [PR \#64763](https://github.com/qgis/QGIS/pull/64763) | Ні |
| Raster calculator fails when OpenCL acceleration is turned on | [\#64574](https://github.com/qgis/QGIS/issues/64574) | [PR \#64779](https://github.com/qgis/QGIS/pull/64779) | Ні |
...
| \[ogr\]\[gpkg\] Fix wrong row count when attribute filter | [\#65067](https://github.com/qgis/QGIS/issues/65067) | [PR \#65097](https://github.com/qgis/QGIS/pull/65097) | Ні |
| \[ogr\] Add OGR_L_GetAttributeFilter | [\#65067](https://github.com/qgis/QGIS/issues/65067) | [PR \#14005](https://github.com/OSGeo/gdal/pull/14005) | Н/Д |
...
| Rendering of PostGIS rasters ignores Transparency NoData value setting | [\#63171](https://github.com/qgis/QGIS/issues/63171) | [PR \#63258](https://github.com/qgis/QGIS/pull/63258) | Так |
...
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgis/gdal garbage collection causes segfault | [\#58724](https://github.com/qgis/QGIS/issues/58724) | [PR \#64766](https://github.com/qgis/QGIS/pull/64766) | Ні |
| NetCDF with EPSG:3416 misaligned is latest qgis ltr | [\#64873](https://github.com/qgis/QGIS/issues/64873) | [PR \#13886](https://github.com/OSGeo/gdal/pull/13886) | Н/Д |
...
| QgsVectorFileWriter: fix writing NurbsCurve to OGR, by converting them to LineString | Unreported | [PR \#64906](https://github.com/qgis/QGIS/pull/64906) | Н/Д |
| Build issue on NixOS | [\#64937](https://github.com/qgis/QGIS/issues/64937) | Некоректні |  |
...
| Rasters with GCPs and overviews render incorrectly when zoomed out | [\#65011](https://github.com/qgis/QGIS/issues/65011) | [PR \#13968](https://github.com/OSGeo/gdal/pull/13968) | Н/Д |
...
| Replace all remaining uses of connect(,SIGNAL,,SLOT) in src/ | Unreported | [PR \#63832](https://github.com/qgis/QGIS/pull/63832) | Н/Д |
...
| Fix build warnings on Fedora | Unreported | [PR \#63910](https://github.com/qgis/QGIS/pull/63910) | Н/Д |
| Fix cppcheck missingOverride and functionConst warnings | Unreported | [PR \#63913](https://github.com/qgis/QGIS/pull/63913) | Н/Д |
| \[CI\] Port OGC tests to ubuntu:25.10 Qt6 | Unreported | [PR \#64135](https://github.com/qgis/QGIS/pull/64135) | Н/Д |
...
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| pyqt5_to_pyqt6.py: Some known incompatibilities do not lead to error exit code | [\#62559](https://github.com/qgis/QGIS/issues/62559) | [PR \#63526](https://github.com/qgis/QGIS/pull/63526) | Ні |
...
| With composite foreign keys, all widgets are configured by default | [\#32048](https://github.com/qgis/QGIS/issues/32048) | [PR \#65059](https://github.com/qgis/QGIS/pull/65059) | ні |
...
| QGIS crashes when opening print layout | [\#64218](https://github.com/qgis/QGIS/issues/64218) | [PR \#64813](https://github.com/qgis/QGIS/pull/64813) | Н/Д |
| Fix custom node initialization for custom elevation profiles | [\#65058](https://github.com/qgis/QGIS/issues/65058) | [PR \#64762](https://github.com/qgis/QGIS/pull/64762) | Н/Д |
...
| Fix sip_include.sh after pyqt5 removal | Unreported | [PR \#64974](https://github.com/qgis/QGIS/pull/64974) | Н/Д |
...
| Don't immediately validate child algorithms in models | Unreported | [PR \#65183](https://github.com/qgis/QGIS/pull/65183) | Н/Д |
| \[browser\] Don't permit renaming tables which are open in the current project | Unreported | [PR \#65182](https://github.com/qgis/QGIS/pull/65182) | Н/Д |
...
| Downgrade thread safety check to non-fatal | Unreported | [PR \#65148](https://github.com/qgis/QGIS/pull/65148) | Н/Д |
...
| \[wms\] Fix regression in encode/decodeUri | Unreported | [PR \#65114](https://github.com/qgis/QGIS/pull/65114) | Н/Д |
| Fix a bunch of python tests weren't actually run on CI | Unreported | [PR \#65113](https://github.com/qgis/QGIS/pull/65113) |  |
| Fix assert triggered on qt6 builds | Unreported | [PR \#65079](https://github.com/qgis/QGIS/pull/65079) | Н/Д |
...
| Fix failing dock widget test on newer Qt versions | Unreported | [PR \#65073](https://github.com/qgis/QGIS/pull/65073) | Н/Д |
...
| Move to QGIS4 settings storage, add migration from QGIS3 | [\#61636](https://github.com/qgis/QGIS/issues/61636) | [PR \#64752](https://github.com/qgis/QGIS/pull/64752) | Н/Д |
| Ensure QString and Qt::StringLiterals namespace are present when needed | Unreported | [PR \#64724](https://github.com/qgis/QGIS/pull/64724) | Н/Д |
