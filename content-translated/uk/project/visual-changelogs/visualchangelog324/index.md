...
section: проект
sidebar: true
title: Список змін для QGIS 3.24
type: visual-changelog

---
{{<content-start >}}
# Список змін для QGIS 3.24{#changelog324 }
...
| Avoid crs definition errors when closing options dialog | [#47014](https://github.com/qgis/QGIS/issues/47014) | [PR #47061](https://github.com/qgis/QGIS/pull/47061) | н/д |
...
| Fix broken merge features tool | unreported | [PR #46924](https://github.com/qgis/QGIS/pull/46924) | н/д |
