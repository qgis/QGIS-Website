...
Архів фотографій представляє великий інтерес як для дослідницького (наприклад, Godone et al, 2014) так і професійного (малюнок 4) середовища. Завдяки розробленій системі архів повністю доступний, а фотографії з 2009 р. активно використовуються з різних проектах як всередині інституту так і за його межами. Можливості QGIS та її плаґіни дозволили створити необхідні інструменти та оптимізувати роботу з архівом фотографій.
...
Franco Godone працює у Науково-дослідному інституті геогідрологічного захисту Турина (IRPI-CNR) з 1972 р. Він займається топографічними та аерофотографічними обстеженнями та аналізом даних високогірних регіонів.
