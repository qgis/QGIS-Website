...
title: Використання QGIS у датській групі з розмінування в Афганістані
type: case-study

---
{{<content-start >}}
# Використання QGIS у датській групі з розмінування в Афганістані
...
QGIS також добре працює з даними GPS, отриманими за допомогою приймачів Garmin під час польових операцій. Завдяки цьому можна створювати карти з розміщенням знайдених та знешкоджених мін.
