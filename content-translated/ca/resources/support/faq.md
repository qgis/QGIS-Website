...
- preferiblement un títol descriptiu per al seu email
- amb la versió de QGIS que utilitzeu en aquest moment (exacte)
- el que esperàveu obtenir
- si es pot, el que heu provat i els resultats obtinguts
- si la vostra pregunta fa referència a alguna cosa que no va, també hauríeu d'indicar:
  - quin és exactament l'error: (si es pot: còpia de la pantalla, traça de la pila, còpia del text de l'error)
  - quin sistema operatiu i versió
  - com l'heu instal·lat (osgeo4w? instal·lador standalone? compilació pròpia?)
...
### Puc obrir fitxers ECW amb QGIS?
