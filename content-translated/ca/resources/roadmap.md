...
- Els nombres senars de versió (2,99, 3,1, etc.) són versions de desenvolupament.
...
Cada tres llançaments (començant pel 2.8) es considera de llarg termini (LTR), és a dir, es va mantenint fins el proper llançament de llarg termini.
...
## Localització de les versions prèvies/compilacions nocturnes{#qgis-prereleases }
| Plataforma | Ubicació |
| --- | --- |
