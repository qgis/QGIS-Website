...
section: projecte
sidebar: true
title: Llista de canvis a QGIS 2.0
type: visual-changelog

---
{{<content-start >}}
# Llista de canvis a QGIS 2.0{#changelog20 }
Release date: 2013-09-09

{{<table-of-contents >}}
## Eines d'anàlisi
### Característica: Comandant de procés
...
### Característica: Millores del connector Mapa de calor
...
### Característica: Suport de procés
...
### Característica: Modelitzador de procés
...
### Característica: Variables d'entorn del sistema
...
### Característica: Escales de zoom definides per l'usuari
...
### Característica: Suport d'Oracle Spatial
QGIS 2.0 ara inclou suport a Oracle Spatial.
...
## Etiquetatge
### Característica: Nou sistema d'etiquetatge
...
- Grups i capes poden estar opcionalment amb un estil de tipus de lletra negreta
...
Una etiqueta amb una expressió tal com:
...
### Característica: Generació de sèries de mapes
...
### Característica: Mescla de capes
...
### Característica: Suport d'etiquetes HTML
...
### Característica: Actualitzacions de la gestió de compositor de mapes
Les següents millores s'han fet en la gestió de compositor de mapes
...
- Totes les accions de gestió del compositor són ara accessibles directament des l'àrea de treballs del compositor
...
## Programabilitat
### Característica: Nova consola Python
...
### Característica: Encara més funcions definides amb una expressió
...
### Característica: Compatibilitat de codi amb les versions de lliurçaments 1.x
...
### Característica: Millora de la gestió de la capa de símbols
...
### Característica: Copia la simbologia entre capes
...
### Característica: Desa estils a la vostra base de dades
...
### Característica: Suport degradats
...
## Interfície d'usuari
### Característica: Nou tema d'icona
...
QGIS 2.0 incorpora un nou i excel·lent sistema per crear formularis d'entrada de dades.  Amb el dissenyador de formularis de arrossega i enganxa pots crear formularis vistosos i intel·ligents amb pestanyes per agrupar camps comuns. Ara és més fàcil controlar l'experiència d'entrada de dades dels teus usuaris.

![image53](images/Screen_Shot_2013-09-14_at_2.17.27_PM.png)
### Característica: Eina d'acció per defecte
