...
section: projecte
sidebar: true
title: Llista de canvis a QGIS 2.8
type: visual-changelog

---
{{<content-start >}}
# Llista de canvis a QGIS 2.8{#changelog28 }
...
QGIS 2.8 és també un lliurament especial perquè inclou moltes noves i importants característiques, ajustaments i millores per fer del més popular GIS d'escriptori gratuït encara més útil i amb més funcions.
...
### Característica: Els preferits es poden importar/exportar
...
### Característica: Millores en les expressions
...
## Eines d'anàlisi
### Característica: Millores en el diàleg d'amidament
...
**Aquesta característica ha estat desenvolupada per:** Radim Blazek

![](images/entries/c8df646572084b8f12027fd54c1210f14c80c8e1.gif)
## Proveïdors de dades
### Característica: Suport als gràfics de llegendes WMS contextuals
...
- estadístiques respecte la reducció del nombre de vèrtexs
...
## Complements
### Característica: Millores a la consola Python
...
### Característica: Nous algoritmes
...
### Característica: Suport Qt5
Ara QGIS es pot generar amb llibreries Qt5.  Compte però que la majoria de binaris continuaran amb Qt4 per defecte.
...
### Característica: Executa exclusivament la part seleccionada de la consulta SQL
...
## Servidor QGIS
### Característica: Servidor de connectors python
...
### Característica: Suport als estils de capes
- El servidor QGIS ara inclou estils predefinits de capes a les sol·licituds GetMap
...
## Simbologia
### Característica: Tipus d'emplenat d'imatge ràster
Aquest tipus de capa de símbol nou permet omplir polígons amb una imatge ràster  (tessel·la).
...
### Característica: Múltiples estils per capa
