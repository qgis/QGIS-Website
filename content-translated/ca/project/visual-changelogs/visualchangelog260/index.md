...
section: projecte
sidebar: true
title: Llista de canvis a QGIS 2.6
type: visual-changelog

---
{{<content-start >}}
# Llista de canvis a QGIS 2.6{#changelog26 }
Release date: 2014-10-31

Registre de canvis del nou lliurament de QGIS 2.6.0. Hem afegit nous ajustaments, característiques i millores per fer el GIS d'escriptori lliure més popular, encara més pràctic i amb més funcions.
...
{{<table-of-contents >}}
## General
### Característica: Nom del fitxer del projecte a les propietats
...
Hem fet forces millores en l'editor de ginys:
- nou giny d'edició de data/hora que permet posar dates nul·les
- filter line edit
...
### Característica: Utilitza opcionalment només un subconjunt de camps de la capa unida
...
### Característica: Camps resultat d'una expressió (camps virtuals)
...
### Característica: Ara les accions poden tenir una icona associada
...
### Característica: Millores en les llegendes
...
## Proveïdors de dades
### Característica: Millores d'exportació DXF
- tree view and attribute selection for layer assigment in dialog
- suport d'emplenat de polígons/HATCH
...
### Característica: Més control sobre l'aparença dels elements fletxa/línia de la composició
...
### Característica: El compositor d'imatges es pot especificar com URLs remotes
...
- Ara podeu establir l'encapçalament de la taula i els colors del tipus de lletra del contingut.
...
- Ara ja podeu tenir varies graelles amb propietats diferents.
...
Models i scripts es poden baixar de la col·lecció en línia i instal·lar directament amb la interfície de Processing. La col·lecció s'anirà ampliant amb els nous scripts i models que proporcionin els usuaris de Processing.

![](images/entries/23e357ca0e559a33a7872206b306c0b1fbdb4b7d.webp)
### característica: Implementació d'un modelador nou
...
## Programabilitat
### Característica: Canvis a les API pels connectors QGIS
...
## Simbologia
### Característica: Selecció aleatòria d'acoloriment millorada
Hem millorat l'algoritme d'acoloriment aleatori al renderitzador de classes, fent que els colors generats siguin visualment més fàcils de distingir l'un de l'altre.

![](images/entries/ec29c9d6eb23d01b4dbbae32a6e20fe0b1f48198.webp)
### Característica: Millores de simbologia a la interfície d'usuari
- On sigui possible es mantindran les propietats de la capa de símbols quan es canviï  el tipus de capa de símbols.
...
### Característica: Paletes de colors
Ara ja podeu definir les vostres paletes de colors personalitzades per utilitzar-les a QGIS.
