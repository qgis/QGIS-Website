...
section: projecte
sidebar: true
title: Llista de canvis a QGIS 2.10
type: visual-changelog

---
{{<content-start >}}
# Llista de canvis a QGIS 2.10{#changelog210 }
...
### Característica: Millores en general
...
- Millores en el connector/proveïdor GRASS
...
## Gestió de dades
### Característica: Es poden actualitzar camps virtuals
...
Hi ha dues característiques noves al gestor de bases de dades:
...
**Integració d'un generador de consultes SQL**
...
**Aquestes característiques han estat desenvolupades per:** Hugo Mercier / Oslandia
...
## Diagrames
### Característica: Millores de diagrames
...
- Els diagrames es poden desactivar sense perdre la configuració
...
## Digitising
### Característica: Eina de rotació geomètrica millorada
...
- ara pots utilitzar una entrada numèrica a l'eina de rotació de mapes
...
## Programabilitat
### Característica: Millores pels programadors
Hem fet un nombre de canvis i millores que interessaran als desenvolupadors:
