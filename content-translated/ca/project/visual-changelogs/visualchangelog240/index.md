...
section: projecte
sidebar: true
title: Llista de canvis a QGIS 2.4
type: visual-changelog

---
{{<content-start >}}
# Llista de canvis a QGIS 2.4{#changelog24 }
...
### Característica: fitxers de capa QGIS QLR
...
Tenim disponibles algunes funcions noves al generador d'expressions.
- bounding box (bounds)
- bounding box width & height (bounds_width/bounds_height)
- mín/màx coordenades x/y (xmín/xmàx/ymín/ymàx)
...
### Característica: Renderització multi-thread
...
## Etiquetatge
### Característica: Etiqueta els objectes múltiples cops
...
## Composició de Mapa
### Característica: Millores en els elements imatge de la composició
...
- S'ha afegit suport per reordenar columnes dins una taula
...
- Els continguts de la taula es poden filtrar amb una expressió

![image11](images/entries/e39937a4b6533c14856b12d4a1064425eac52a31.webp)
### Característica: Millores generals del compositor
...
- Possibilitat d'exportar imatges SVG del compositor amb capes
