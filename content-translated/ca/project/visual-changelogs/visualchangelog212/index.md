...
section: projecte
sidebar: true
title: Llista de canvis a QGIS 2.12
type: visual-changelog

---
{{<content-start >}}
# Llista de canvis a QGIS 2.12{#changelog212 }
...
Volem agrair als desenvolupadors, documentalistes, provadors i en general a tot el munt de persones que ofereixen el seu temps i esforç (o que patrocinen la gent que ho fa).
...
{{<table-of-contents >}}
## General
### Característica: Nova pantalla de benvinguda
...
### Característica: Editor de configuració avançada
...
### Característica: Eina d'alineació de ràster
...
- Gestiona components de certificació com a Firefox
...
**Aquesta característica ha estat desenvolupada per:**  Larry Shaffer
...
S'han fet les següents millores en el proveïdor de PostGIS:
...
### Característica: Només dibuixa etiquetes que encaixin a l'interior de polígons
...
## Composició de Mapa
### Característiques: Millores en la navegació d'atles
...
### Característica: Parametrització avançada del color de fons de la cel·la
...
**This feature was developed by:** [Nyall Dawson](http://nyalldawson.net/)
## Complements
### Característica: Actualització del connector GRASS
...
- Actualització de la llibreria de connectors i generació multi versions
- Navegador QGIS i integració de la subfinestra del navegador
...
Aquest canvi permet reutilitzar eines per mapes de dins d'scripts PyQGIS i de connectors Python.

**This feature was developed by:** Matthias Kuhn at [OpenGIS](http://www.opengis.ch/)

**This feature was funded by:** [SIGE](http://www.sige.ch/)
### Característica: Edició de capes via \`with edit(layer):\`
Exemple:
...
Això cridarà automàticament commitChanges() en acabar. Si es produeix qualsevol excepció, es desfaran tots els canvis amb rollBack().
...
**This feature was funded by:** Tuscany Region (Italy) - SITA (CIG: 63526840AE)
### Característica: Obre scripts en un editor extern
Per satisfacció d'usuaris Python - ara podeu obrir els vostres scripts a un editor extern utilitzant el nou botó afegit a la consola. 

**This feature was developed by:** [Nathan Woodrow](http://nathanw.net/)

![image34](images/entries/78acf0058f4306bf408a58df3762dff5986633a7.webp)
### Característica: Noves classes pels programes PyQGIS 
...
**This feature was developed by:** [Nyall Dawson](http://nyalldawson.net/)
## Servidor QGIS
### Característica: API de servidor Python de QGIS
El servidor QGIS ara s'empaqueta com una llibreria amb unes enquadernacions API i Python bàsiques  (però en desenvolupament). Amb la nova API hem fet un conjunt de proves Python al component principal del servidor i als connectors del servidor. Invocar al servidor des Python ara és tan senzill com:
...
### Característica: getMap en format dxf
...
Ara el gestor d'estils us permet exportar les miniatures seleccionades tant en imatges PNG com SVG .
...
- Permet configurar la transparència pels colors
...
### Característica: Ara es poden editar tots els degradats
...
### Característica: Incloure opcionalment els píxels com unitat de mida en la selecció de qualsevol simbologia
