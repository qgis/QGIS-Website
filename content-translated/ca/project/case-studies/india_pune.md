...
title: Ús de la consola de Python per preparar un mapa fora de línia des WMS (baixador
  de tessel·les)
type: case-study

---
{{<content-start >}}
# Ús de la consola de Python per preparar un mapa fora de línia des WMS (baixador de tessel·les)
...
2. Mida de la tessel·la a baixar (p.e. 0,001 X 0,001 graus)
3. Nombre de tessel·les a baixar (s'ha calculat considerant l'extensió completa del mapa i la mida de la tessel·la)
...
- Lloc web www.gisappco.com (en construcció)
