...
title: QGIS com el principal software GIS en el Laboratori de Geografia Experimental
  i Aplicada
type: case-study

---
{{<content-start >}}
# QGIS com el principal software GIS en el Laboratori de Geografia Experimental i Aplicada
...
- Desenvolupament i integració ràpids de les característiques que volen els usuaris
- Estabilitat i interoperabilitat (utilitzem plataformes Windows i Ubuntu Linux)
...
- Creació de models 3D per visualització del terreny (i posterior ús com ombres de relleu)
