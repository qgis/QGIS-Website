...
title: QGIS i GRASS per modelitzar corredors ecològics pels llops al nord de Portugal
type: case-study

---
{{<content-start >}}
# QGIS i GRASS per modelitzar corredors ecològics pels llops al nord de Portugal
...
- connector Interpolation a QGIS: per crear un model d'elevació digital
...
- r.reclass de GRASS: per reclassificar capes del mapa
...
Aquest article fou una contribució de Juliol de 2012 de Mònica Almeida. Es tracta d'una biòloga conservacionista que treballa a una organització no governamental per la preservació del llop a Portugal.
