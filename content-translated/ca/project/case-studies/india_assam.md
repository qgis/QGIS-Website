...
title: QGIS per monitorar tigres (utilitzant càmeres trampa a la Reserva de Tigres
  de Nameri a  Assam, districte Sonitpur de l'Índia)
type: case-study

---
{{<content-start >}}
# QGIS per monitorar tigres (utilitzant càmeres trampa a la Reserva de Tigres de Nameri a  Assam, districte Sonitpur de l'Índia)
