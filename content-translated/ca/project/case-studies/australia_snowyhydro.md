...
title: Utilitza les eines de processament per automatitzar la classificació de les
  nevades
type: case-study

---
{{<content-start >}}
# Utilitza les eines de processament per automatitzar la classificació de les nevades
