...
- Evolució geològica recent;
- Mitigation of natural hazards;
- Geoarchaeology and archaeometry.
- Marine Geology
- Geomàtica, anàlisi GIS i desenvolupament.
...
El model pren com a entrada (Fig. 2):
...
- El nom de la capa poligonal resultant.
...
Quan s'implanti, el model realitzarà les operacions següents:
...
## Autors
Aquest article fou una contribució al Març de 2015 de Giuseppe Cosentino i de Francesco Pennica (www.igag.cnr.it).
