...
title: L'utilització de QGIS en la Infrastructura de Geodades de la Ciutat de Uster
type: case-study

---
{{<content-start >}}
# L'utilització de QGIS en la Infrastructura de Geodades de la Ciutat de Uster
...
Avui en dia, QGIS s'utilitza en els següents projectes GIS:
...
- consulta i edició de les dades d'infraestructures de carretera
...
Aquest article fou una contribució d'abril de 2011 del Dr. Andreas Neumann, Coordinador de GIS de la Ciutat d'Uster, Suïssa.
