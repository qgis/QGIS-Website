...
title: Utilització d'eines de codi obert per caracteritzar un paisatge. El connector
  LecosS
type: case-study

---
{{<content-start >}}
# Utilització d'eines de codi obert per caracteritzar un paisatge. El connector LecosS
