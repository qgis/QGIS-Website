...
- Gradu hamartarren balio batetik segundoen kopuru dezimala erauzten du. Graduak eta minutuak ez dira kontuan hartuko. Erauzitako segundoen balioa beti positiboa izango da.
...
| Server: landingpage webapp only functions if built with server python plugins support | [\#64556](https://github.com/qgis/QGIS/issues/64556) | [PR \#64763](https://github.com/qgis/QGIS/pull/64763) | Ez |
| Raster calculator fails when OpenCL acceleration is turned on | [\#64574](https://github.com/qgis/QGIS/issues/64574) | [PR \#64779](https://github.com/qgis/QGIS/pull/64779) | Ez |
...
| \[ogr\]\[gpkg\] Fix wrong row count when attribute filter | [\#65067](https://github.com/qgis/QGIS/issues/65067) | [PR \#65097](https://github.com/qgis/QGIS/pull/65097) | Ez |
| \[ogr\] Add OGR_L_GetAttributeFilter | [\#65067](https://github.com/qgis/QGIS/issues/65067) | [PR \#14005](https://github.com/OSGeo/gdal/pull/14005) | E/E |
...
| Rendering of PostGIS rasters ignores Transparency NoData value setting | [\#63171](https://github.com/qgis/QGIS/issues/63171) | [PR \#63258](https://github.com/qgis/QGIS/pull/63258) | Bai |
...
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgis/gdal garbage collection causes segfault | [\#58724](https://github.com/qgis/QGIS/issues/58724) | [PR \#64766](https://github.com/qgis/QGIS/pull/64766) | Ez |
| NetCDF with EPSG:3416 misaligned is latest qgis ltr | [\#64873](https://github.com/qgis/QGIS/issues/64873) | [PR \#13886](https://github.com/OSGeo/gdal/pull/13886) | E/E |
...
| QgsVectorFileWriter: fix writing NurbsCurve to OGR, by converting them to LineString | Unreported | [PR \#64906](https://github.com/qgis/QGIS/pull/64906) | E/E |
| Build issue on NixOS | [\#64937](https://github.com/qgis/QGIS/issues/64937) | Baliogabea |  |
...
| Rasters with GCPs and overviews render incorrectly when zoomed out | [\#65011](https://github.com/qgis/QGIS/issues/65011) | [PR \#13968](https://github.com/OSGeo/gdal/pull/13968) | E/E |
...
| Replace all remaining uses of connect(,SIGNAL,,SLOT) in src/ | Unreported | [PR \#63832](https://github.com/qgis/QGIS/pull/63832) | E/E |
...
| Fix build warnings on Fedora | Unreported | [PR \#63910](https://github.com/qgis/QGIS/pull/63910) | E/E |
| Fix cppcheck missingOverride and functionConst warnings | Unreported | [PR \#63913](https://github.com/qgis/QGIS/pull/63913) | E/E |
| \[CI\] Port OGC tests to ubuntu:25.10 Qt6 | Unreported | [PR \#64135](https://github.com/qgis/QGIS/pull/64135) | E/E |
...
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| pyqt5_to_pyqt6.py: Some known incompatibilities do not lead to error exit code | [\#62559](https://github.com/qgis/QGIS/issues/62559) | [PR \#63526](https://github.com/qgis/QGIS/pull/63526) | Ez |
...
| With composite foreign keys, all widgets are configured by default | [\#32048](https://github.com/qgis/QGIS/issues/32048) | [PR \#65059](https://github.com/qgis/QGIS/pull/65059) | ez |
...
| QGIS crashes when opening print layout | [\#64218](https://github.com/qgis/QGIS/issues/64218) | [PR \#64813](https://github.com/qgis/QGIS/pull/64813) | E/E |
| Fix custom node initialization for custom elevation profiles | [\#65058](https://github.com/qgis/QGIS/issues/65058) | [PR \#64762](https://github.com/qgis/QGIS/pull/64762) | E/E |
...
| Data corruption using "Split Features" on a LineStringZ in GeoJSON | [\#63581](https://github.com/qgis/QGIS/issues/63581) | [PR \#64986](https://github.com/qgis/QGIS/pull/64986) | Zain |
...
| Fix sip_include.sh after pyqt5 removal | Unreported | [PR \#64974](https://github.com/qgis/QGIS/pull/64974) | E/E |
...
| Don't immediately validate child algorithms in models | Unreported | [PR \#65183](https://github.com/qgis/QGIS/pull/65183) | E/E |
| \[browser\] Don't permit renaming tables which are open in the current project | Unreported | [PR \#65182](https://github.com/qgis/QGIS/pull/65182) | E/E |
...
| Downgrade thread safety check to non-fatal | Unreported | [PR \#65148](https://github.com/qgis/QGIS/pull/65148) | E/E |
...
| \[wms\] Fix regression in encode/decodeUri | Unreported | [PR \#65114](https://github.com/qgis/QGIS/pull/65114) | E/E |
| Fix a bunch of python tests weren't actually run on CI | Unreported | [PR \#65113](https://github.com/qgis/QGIS/pull/65113) |  |
| Fix assert triggered on qt6 builds | Unreported | [PR \#65079](https://github.com/qgis/QGIS/pull/65079) | E/E |
...
| Fix failing dock widget test on newer Qt versions | Unreported | [PR \#65073](https://github.com/qgis/QGIS/pull/65073) | E/E |
...
| Move to QGIS4 settings storage, add migration from QGIS3 | [\#61636](https://github.com/qgis/QGIS/issues/61636) | [PR \#64752](https://github.com/qgis/QGIS/pull/64752) | E/E |
| Ensure QString and Qt::StringLiterals namespace are present when needed | Unreported | [PR \#64724](https://github.com/qgis/QGIS/pull/64724) | E/E |
