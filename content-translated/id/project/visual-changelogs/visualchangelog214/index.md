...
section: project
sidebar: true
title: Catatan perubahan untuk QGIS 2.14
type: visual-changelog

---
{{<content-start >}}
# Catatan perubahan untuk QGIS 2.14{#changelog214 }
...
Browser QGIS adalah sistem arsip, Layanan Web OGC, dan panel Koneksi Database yang memungkinkan Anda dengan mudah menambahkan lapisan apa pun dari sumber di atas ke kanvas peta Anda (atau ke jendela Manajer DB). Dua peningkatan baru yang bermanfat tersebut telah ditambahkan pada rilis ini:
