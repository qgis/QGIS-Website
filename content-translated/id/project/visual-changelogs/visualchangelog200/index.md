...
section: project
sidebar: true
title: Catatan perubahan untuk QGIS 2.0
type: visual-changelog

---
{{<content-start >}}
# Catatan perubahan untuk QGIS 2.0{#changelog20 }
Release date: 2013-09-09

{{<table-of-contents >}}
## Peralatan Analisis
### Fitur : Perintah Pemrosesan
Untuk akses cepat ke fungsi geoprocessing, cukup jalankan perintah pengolahan (Ctrl + Alt + M) dan mulai mengetik nama alat yang Anda cari. Perintah akan menunjukkan pilihan yang tersedia dan menjalankannya untuk Anda. Tidak ada lagi pencarian melalui menu untuk menemukan alat. Semua ada di ujung jari Anda.

![image1](images/processing_commander_2.png)
### Feature: Heatmap Plugin Improvements
Plugin heatmap telah melalui banyak perbaikan dan optimisasi, sehingga dalam pembuatan hasilnya lebih cepat. Selain itu, Anda kini memiliki pilihan fungsi kernel yang digunakan untuk membuat heatmap.

![image2](images/Selection_027.png)
### Fitur : Dukungan Pemrosesan
