...
sidebar: true
subtitle: ''
title: Pertanyaan yang sering dipertanyakan
type: page
...
### Bagaimana untuk mengajukan pertanyaan QGIS?
...
- Diutamakan judul yang menggambarkan permasalahan pada email anda.
- Versi QGIS berapa yang anda gunakan pada saat ini (detil)
...
- if your question is about something broken, you may also provide:
  ...
  - Sistem operasi yang anda gunakan beserta versinya.
  - Bagaimana anda menginstal QGIS anda tersebut (osgeo4w? instalasi standalone? QGIS rancangan anda sendiri?)
...
### Bisakah saya membuka berkas ECW dengan QGIS?
