...
- предпочитано описателно заглавие за вашия мейл
- коя версия на QGIS използвате в настоящия момент (точно)
...
- if your question is about something broken, you may also provide:
  ...
  - коя операционна система и версия
  - как извършихте инсталацията (osgeo4w? самостоятелна инсталация? собствена разработка?)
...
### Може ли да се отворят ECW файлове с QGIS?
