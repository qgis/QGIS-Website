...
title: Създаване на карта на пешеходна пътека със QGIS
type: case-study

---
{{<content-start >}}
# Създаване на карта на пешеходна пътека със QGIS
...
- Събиране на данни
- Редактиране на данни и подготовка.
- Изработка на Карта
...
За тази статия е допринесъл с Джарет Тотън през януари 2013 г. Джарет е GIS Технолог живее в Алберта, Канада.
