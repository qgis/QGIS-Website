...
title: Датска група сапьори използва QGIS в Афганистан
type: case-study

---
{{<content-start >}}
# Датска група сапьори използва QGIS в Афганистан
...
QGIS също се синхронизира добре с данни, събрани от полевите операции с използване на ръчни GPS устройства Garmin , позволяващи на създадените карти да се маркира местонахождението на откритите и унищожени мини.
