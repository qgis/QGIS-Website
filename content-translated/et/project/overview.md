...
### QGIS Server
Avalda oma QGIS projektid ja kaardikihid kui OGC standarditega ühilduvate WMS, WMTS, WFS ja WCS teenustena. Kontrolli millised kihid, andmeväljad, küljendus ja koordinaatsüsteemid eksporditakse. QGIS serveri lahendust peetakse kui referents teostatud WMS 1.3 standardile.
...
{{<rich-content-start themeClass="coloring-6" >}}
### QGIS Desktop
Loo, muuda, visualiseeri, analüüsi ja avalda ruumiandmeid.
...
{{<rich-content-start themeClass="coloring-6" >}}
### QGIS mobiiliseadmetes ja tahvlites
