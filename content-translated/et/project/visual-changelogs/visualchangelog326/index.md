...
| --- | --- | --- | --- |
| WFS provider doesn\'t recognize CRS strings other than OGC URNs | [#46485](https://github.com/qgis/QGIS/issues/46485) | [PR #48550](https://github.com/qgis/QGIS/pull/48550) | ei kohaldu |
...
| Can not import excel File with new version of QGIS | [#47838](https://github.com/qgis/QGIS/issues/47838) | N/A - freexl bug. Patch submitted to upstream | ei kohaldu |
...
| \[regression\] New filter for duplicated WFS layer is also applied on source layer | [#48465](https://github.com/qgis/QGIS/issues/48465) | [PR #48998](https://github.com/qgis/QGIS/pull/48998) | ei kohaldu |
...
| Drop gpkg_metadata_reference_column_name_update trigger generated by GDAL \< 2.4.0 | ei kohaldu | [PR #48953](https://github.com/qgis/QGIS/pull/48953) | [PR #48957](https://github.com/qgis/QGIS/pull/48957) |
...
| Fix old GDAL triggers in geopackage files | ei kohaldu | [PR #49037](https://github.com/qgis/QGIS/pull/49037) | [PR #49039](https://github.com/qgis/QGIS/pull/49039) |
...
| Show pinned label highlights also for pinned curved labels | [#48753](https://github.com/qgis/QGIS/issues/48753) | [PR #48764](https://github.com/qgis/QGIS/pull/48764) | ei kohaldu |
...
| Fix a crash when QgsProject::instance() is accessed when no QgsApplication exists | unreported | [PR #48721](https://github.com/qgis/QGIS/pull/48721) | ei kohaldu |
| Better approach to filtering lists by tags which works across different styles | [#48659](https://github.com/qgis/QGIS/issues/48659) | [PR #48689](https://github.com/qgis/QGIS/pull/48689) | ei kohaldu |
...
| Fix many memory leaks | unreported | [PR #48590](https://github.com/qgis/QGIS/pull/48590) | ei kohaldu |
| Fix ctrl modifier scrolling on symbol buttons | unreported | [PR #48581](https://github.com/qgis/QGIS/pull/48581) | ei kohaldu |
