...
draft: false
sidebar: true
title: Kasutajarühmad
type: page

---
{{<content-start >}}
# Kasutajarühmad
## Olemasolevate QGIS kasutajate gruppide nimekiri
...
## Kasutajate gruppide eesmärgid
* Kasutajate kohtumiste organiseerimine
...
* Kohalikul tasemel QGIS-i kasutuslugude kogumine
...
* Huvigruppide moodustamine, nt mõõdistamine, linnaplaneerimine, server/veebiklient jne.
* Rakenduse moodulite algatamine/koordineerimine, nt mõõdistamine, linnaplaneerimine, server/veebiklient jne.
* Electing a representative to act as a [QGIS Voting Member]({{< ref "/community/organisation#voting-members" >}})

## Üldised eeldused/soovitused
...
* aegajalt teavita rahvusvahelist projekti kohalikest tegevustest 
...
Šveitsi QGIS kasutajate grupi põhikirja näide:
...
Liikmeks astumise avalduse vormid:
