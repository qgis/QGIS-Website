...
### Kuidas küsida QGIS'iga seotud küsimust?
...
- eelistatavalt kirjeldav e-maili pealkiri
- millist QGIS versiooni sa kasutad sellel momendil (täpne number)
- millist abi sa ootad saada
- võimaluse korral, mida oled proovinud ja millise tulemuse said
- kui sa küsid midagi mingi vea kohta, siis võiksid lisada:
  - what exactly is the error (if possible: screendump, stacktrace, copy of error text)
  - mis operatsioonisüsteem ja versioon
