...
title: گروه مین‌روب دانمارکی در  افغانستان از کیو جی آی اس استفاده می‌کنند.
type: case-study

---
{{<content-start >}}
# گروه مین‌روب دانمارکی در  افغانستان از کیو جی آی اس استفاده می‌کنند.
...
QGIS خیلی راحت با داده های جمع آوری شده توسط GPS های دستی گارمین جهت تولید نقشه های پاکسازی از مکان مین های پیدا شده و نابود شده ارتباط گرفته و همزمان می شود.
