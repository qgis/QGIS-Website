...
- ترجیحا عنوانی توصیفی برای ایمیل شما
- در حال حاضر از چه نسخه QGIS استفاده می کنید (نام کام نسخه)
...
- if your question is about something broken, you may also provide:
  ...
  - چه سیستم عامل و چه نسخه ای
  - از چه منبعی آن را نصب کرده اید (osgeo4w؟ بصورت مستقل؟ نسخه ساخت خودتان؟)
...
### می توان فایلهای ECW را در کوانتم جی ای اس باز کرد؟
