...
section: 專案
sidebar: true
title: QGIS 2.18 更新日誌
type: visual-changelog

---
{{<content-start >}}
# QGIS 2.18 更新日誌{#changelog218 }
![image1](images/projects/ac3b0a08203e87505a823b0d8a0895d44489f916.png)

Release date: 2016-10-21

這個版本是 2.x 系列的最後一次版本釋出。目前的長期維護版本 (LTR) 仍然是 2.14.x 版本。這次版本比起前次釋出提供一些增量改進。目前主要的變動集中在開發下一代版本 QGIS 3.0，計畫在 2017 年第一季結束時釋出。
