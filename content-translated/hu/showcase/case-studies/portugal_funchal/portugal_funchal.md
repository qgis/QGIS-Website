...
---
# Egy ingyenes GIS szoftver használata a Moniz Középiskolában: QGIS
...
![Distribution of dustbins (green) and garden benches (yellow) at Jaime Moniz Secondary School](./images/portugal_funchal1.jpg){.align-right}
...
![Functional map of an area in the old part of the town of Funchal, surrounding Jaime Moniz Secondary School](./images/portugal_funchal2.jpg){.align-right}
## A QGIS kiválasztása 
...
## Az osztályteremből az oktató közösséghez
...
![Placement proposal for recycle containers in the parish of Santo António](./images/portugal_funchal3.jpg){.align-right}
## Következtetés
A projekt gyors értékeléseként úgy érzem, hogy a QGIS, mint tanítást segítő eszköz választása kiváló választás volt. Először is nagy várakozás előzte meg. Nem használtam még GIS szoftver korábban, így gyakorlatilag egyszerre tanultam és tanítottam is. Az interneten elérhető információkkal együtt a felhasználóbarát GIS rendkívül hasznosnak bizonyult számomra. Mindezen felül az iskolának nem kelett még egy lincenszre költenie, a szoftver nem függ a licensz megújításától, ami végső soron az oktatás minőségét javította, extra költségek nélkül. Jelenleg, tanulóink gyakorlatilag önállóan használják a QGIS-t a különböző feladataik megoldásához. Remélhetőleg az eredmények megszolgálják a tanulási folyamatba fektetett erőfeszítéseiket.
## Hivatkozások
...
## Szerző
![Fátima Vale](./images/portugal_funchalaut.png){.align-left height="200px"}

A cikket Fátima Vale készítette 2011 márciusában Luís Antunes (a tanulók témavezetője). A cikk írásakor Fátima a Jaime Moniz Középiskola tanára, valamint számos diák gyakorlati témavezetője volt különböző szervezeteknél.
