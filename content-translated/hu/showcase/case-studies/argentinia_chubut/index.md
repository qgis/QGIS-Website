...
## A projektről
A kísérlet fő célja az volt, hogy 12. osztályos tanulókat tanítsunk a GIS eszközök használatára a térbeli információk kezelésének elősegítése érdekében, valamint döntéshozási folyamat támogatása.
...
- Felhasználni a térinformatikai eszközöket a felállított térbeli-társadalmi hipotézisek validálásában. 
...
A projekt létrehozáskor a következő módszertant követtük:
- Gyakorlati és elméleti előadások; Főleg a QGIS használatáról és a városi zöldterületek és azok területi hatásainak előnyeiről. 
- Térképészeti modellezés, vektor rétegek létrehozása, GIS adatbázisok fejlesztése.
- Terepi munka (fakataszter GPS koordinátákkal).
- Google Earth (GeoEye) felvételekről vektorizáltunk városi kataszteri blokkokat és fa lombkoronákat. A lakosok számának összesítése érdekében egy kataszteri blokkra átlagosan 4 lakost számoltunk telkenként.
- Eredményeket bemutató tematikus térképek.
...
Bár a projekt tudományos kísérlet volt a középiskolákban, a QGIS felhasználásával kapott eredményeket nagyra értékeljük. A tanulók nagy pontossággal és tudományos feltételeknek megfelelően dolgoztak, és megmutatva a kapott tematikus térképeket (városi zöldterület) és a (QGIS) eszköz használatát. Ez a tapasztalat gazdagította a tanulók tudását de az oktatóknak is fejlődést hozott.
