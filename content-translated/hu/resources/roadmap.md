...
| <span class="rm-current"> aktuális </span> | <span class="rm-current"> a jelenleg támogatott kiadások: {{< param "ltrrelease" >}} és {{< param "release" >}} </span> |
| <span class="rm-next"> következő </span> | <span class="rm-next"> következő kiadások </span> |
