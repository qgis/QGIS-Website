...
### Hogyan tegyek fel egy QGIS kérdést?
...
- célszerű egy, az email címéhez tartozó leírás
- melyik QGIS verziót használta akkor (pontosan)
- mit gondol mit fog kapni
- ha alkalmazható, mit próbált meg és mi lett az eredmény
- ha a kérdés egy összeomláshoz kapcsolódik, meg kell adnia a következőket
  - pontosan mi a hiba (ha lehetséges képernyőkép, stacktrace, a hiba szövege)
  - melyik operációs rendszer és verzió
  - hogyan telepítette (OSGeo4W? önálló telepítő? saját szerkesztés?)
  - mikor történt a hiba (újratelepítés, első telepítés, rendszerfrissítés, projekt változás)
...
{{<rich-box-end >}}
### Hogyan választjuk ki a QGIS kiadások nevét?
...
### Megnyithatok ECW fájlt a QGIS-sel
...
## Developer questions
### Le tudom fordítani magam a QGIS-t?
...
```
### A QGIS-sel készítettem egy térképet, meg kell említenem a QGIS-t?
