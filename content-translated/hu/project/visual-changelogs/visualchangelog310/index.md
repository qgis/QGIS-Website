...
section: projekt
sidebar: true
title: A QGIS 3.10 változásnaplója
type: visual-changelog

---
{{<content-start >}}
# A QGIS 3.10 változásnaplója{#changelog310 }
![image1](images/projects/ce6ba8fc893e51ec721c9dded4dd98d11806a223.png)

Release date: 2019-10-25

A QGIS 3.10 új változások terjedelmes listájával, és számos meglévő tulajdonság finomításával érkezett - melyek közül a kiemelendőkkel itt is megpróbálunk foglalkozni. Mint mindig, most is emlékeztetnénk arra, hogy a QGIS egy nyílt forráskódú projekt, és ha lehetősége van rá, támogassa munkánkat adományokkal szponzorálással vagy hozzájárulással a dokumentációhoz, weboldalhoz, stb..
...
{{<table-of-contents >}}
## Térképeszközök
### Funkció: 3D vonalhossz megjelenítése az azonosítás eredményében
Az Elem Azonosítás eszköz 3D vonalláncok esetében a 3D vetületi hosszt is tartalmazza (a 2D vetületi ill. ellipszoidi hossz mellett).
...
## Jelrendszer
### Funkció: Alapértelmezett mintavétel beállítása új raszter réteg betöltésekor
...
### Funkció: Szimbólumok tovább fejlesztett másolása/beillesztése
