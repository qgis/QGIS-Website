...
section: projekt
sidebar: true
title: A QGIS 3.14 változásnaplója
type: visual-changelog

---
{{<content-start >}}
# A QGIS 3.14 változásnaplója{#changelog314 }
...
1. Véletlen raszter réteg létrehozása (binomiális eloszlás)
...
| Fixes to numbered list handling in dox/PyQGIS API | unreported | [Commit 74400c7](https://github.com/qgis/QGIS/commit/74400c7ff88d563dad74dad41860f9b603214973) | Nem |
| Fix cross references in PyQGIS docs | unreported | [Commit 81a9db9](https://github.com/qgis/QGIS/commit/81a9db9f57706cba9b11e4372dd1bf50fcd7bc6a) | Nem |
