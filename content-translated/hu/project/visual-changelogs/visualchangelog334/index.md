...
section: projekt
sidebar: true
title: A QGIS 3.34 változásnaplója
type: visual-changelog

---
{{<content-start >}}
# A QGIS 3.34 változásnaplója{#changelog334 }
![image0](images/entries/334splash.webp)

Megjelenés dátuma: 2023-10-29

Bemutatjuk a QGIS 3.34-et, a QGIS projekt következő fő kiadását, amely jelentős fejlesztéseket hoz a QGIS nyílt forráskódú térinformatikai adatelemző és -vizualizációs szoftver képességeiben.

Ez a kiadás a meglévő API-k, kifejezések és eszközök számos továbbfejlesztését, a nyomtatási elrendezés módosításait, valamint a 2D és 3D nézetek megjelenítési opcióinak fejlesztését tartalmazza.
...
| --- | --- | --- | --- |
| QGIS cannot connect to MySQL if user\'s password contains commas. | [#54493](https://github.com/qgis/QGIS/issues/54493) | [PR #54573](https://github.com/qgis/QGIS/pull/54573) | Nem |
