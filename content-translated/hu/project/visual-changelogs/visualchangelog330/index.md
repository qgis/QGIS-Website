...
section: projekt
sidebar: true
title: A QGIS 3.30 változásnaplója
type: visual-changelog

---
{{<content-start >}}
# A QGIS 3.30 változásnaplója{#changelog330 }
![image1](images/projects/af9e5405a8329d7de8959238a3d499da780c1598.png)

Megjelenés dátuma: 2023-03-04
...
A natív GeoNode integráció is átkerült egy külső modulba, kihasználva a QGIS API bővítményekre vonatkozó, a legutóbbi kiadásokban bevezetett hatékony bővítéseit.

Felhasználóként új funkciókkal és a felhasználói élmény javításával találkozhatunk, beleértve a raszter-attribútumtáblák támogatását, a rétegek betöltésének intelligens és konfigurálható rendezést, a GPS segédprogramok fejlesztését, dinamikusabb űrlapvezérlőket, a mellékletek natív multimédiás előnézetét, jobb integrációt a felhőszolgáltatásokkal, a QGIS metaadat-szabványok kiterjesztését, és számos más figyelemre méltó kiegészítést.
...
- Leaflet HTML-kimenet címe
- Leaflet HTML-kimenet forrásmegjelölése
- OpenStreetMap alapétrkép beágyazása a HMTL-kimenetbe
...
| Weird interval QgsDoubleSpinbox behavior in graduated symbology with fixed interval | [#51687](https://github.com/qgis/QGIS/issues/51687) | [PR #51714](https://github.com/qgis/QGIS/pull/51714) | Nem |
...
| wms getLegendGraphic call the group and not the layer when many style layers add from browser | [#51759](https://github.com/qgis/QGIS/issues/51759) | [PR #51765](https://github.com/qgis/QGIS/pull/51765) | Nem |
