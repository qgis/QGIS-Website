...
section: projekt
sidebar: true
title: A QGIS 2.0 változásnaplója
type: visual-changelog

---
{{<content-start >}}
# A QGIS 2.0 változásnaplója{#changelog20 }
...
### Funkció: Hőtérkép modul fejlesztések
...
### Funkció: Alapértelmezett kezdő projekt és projekt sablon megadás
...
### Funkció: Rendszer környezeti változók
...
## Böngésző
### Funkció: Fejlesztések az alkalmazáson belüli böngésző panelban
- A könyvtárak joker karakterekkel vagy szabályos kifejezésekkel szűrhetők
...
## Adatszolgáltatók
### Funkció: Raszter adatszolgáltató nagyjavítás
...
### Funkció: Oracle Spatial támogatás
A QGIS 2.0 tartalmazza az Oracle Spatial támogtást

![image10](images/oracle.png)
### Funkció: Web Coverage Service szolgáltató
...
### Funkció: Kifejezés alapú címke tulajdonságok
...
### Funkció: Korábbi címkéző motor elavult
...
**MEGJEGYZÉS**: Nagy a valószínűsége, hogy az elavult címkéző motort teljesen eltávolítjuk a következő stabil QGIS kiadás előtt. Kérjük migrálja a régebbi projektjeit. 
...
### Funkció: Térkép réteg duplikálása
...
### Funkció: kifejezés a lapösszeállítás címkékben
...
### Funkció: még több kifejezés függvény
...
### Funkció: Egyéni függvények a kifejezésekhez
...
### Funkció: Új tisztább Python API
...
### Funkció: Stílusok mentése az adatbázisába
