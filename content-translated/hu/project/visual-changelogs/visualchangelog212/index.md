...
section: projekt
sidebar: true
title: A QGIS 2.12 változásnaplója
type: visual-changelog

---
{{<content-start >}}
# A QGIS 2.12 változásnaplója{#changelog212 }
...
Az üres térképvászon helyett a QGIS a legutóbb használt projektek listáját jeleníti meg egy kis képpel, hogy gyorsan és egyszerűen visszatérhessünk a legutóbbi munkáinkhoz.
...
- Az Oracle Spatial mostantól támogatott a DBManagerben.
...
Egy új lehetőséget adtunk a felületrétegekhez, hogy csak a teljesen beleeső címkéket rajzolja ki.
...
### Funkció: A vektoros rétegek raszteres képekként való megjelenítésének kikényszerítése
...
### Funkció: Új osztályok a PyQGIS programokhoz
