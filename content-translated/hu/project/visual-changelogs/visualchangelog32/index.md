...
section: projekt
sidebar: true
title: A QGIS 3.2 változásnaplója
type: visual-changelog

---
{{<content-start >}}
# A QGIS 3.2 változásnaplója{#changelog32 }
...
## Általános
### Funkció: Új tömörített projekt fájl formátum .qgz az alapértelmezett formátum.
...
### Funkció: Szűrés a mező értékekre a Lekérdezés szerkesztőben
Egy új kifejezés szűrő létrehozásánál a lekérdezés szerkesztőben, szűrheti mező értékeket az előnézetpanelben.
...
### Funkció: Teljes képernyős térkép Ctrl-Shift-Tab-bal
...
### Funkció: Azonosítás eszköz extra opciókkal
Az új fejlesztésekkel a felhasználó a kiválasztáshoz hasonló eszközöket használhat több elem azonosítására.

Ezt a funkciót támogatta Leicestershire County Council és East Hampshire District Council
...
Az új térkép nézetet úgy konfigurálhatjuk, hogy automatikusan az aktuális szelekcióra nagyítson. Kombinálhatjuk a különböző térkép témákkal mint ebben a példában.
...
### Funkció: Egyszerűsítési módszer kiválasztása az egyszerűsítési eszközhöz
...
### Funkció: síkbeli területek/hosszak/kerületek az azonosítás eredményeiben
A QGIS 3.2-ben külön megjelennek az ellipszoidi és a síkbeli területek, hosszak és kerületek az azonosítás eredményei panelen. A két különböző eredmény látványa segíti a felhasználókat abban, hogy felismerjék a nem megfelelő vetület vagy ellipszoid választás okozta terület vagy távolság számítási hibákat.
...
- A hibaüzenetek teljes listáját mutatja, melyet a kifejezést értelmezése során kaptunk
...
- térképi réteg hibás geometriákkal
- map layer with on-the-fly reprojection exceptions
- térképi réteg hiányzó adatforrással
- térképi réteg hibás vetülettel
...
Ezt a funkciót fejlesztette Nathan Woodrow, Nyall Dawson
### Funkció: Nem mentett módosítások jelölés a címsorban
...
This feature was developed by [Nyall Dawson (North Road)](https://north-road.com)
## Jelrendszer
### Funkció: szebb színek az új rétegekhez
...
This feature was developed by [Nyall Dawson (North Road)](https://north-road.com)
## Megjelenítés
### Funkció: Javított térkép szerzői jogok dekoráció
- Kifejezés támogatása a szerzői jog szövegben.
- Javított szöveg formatizáló beállítások, árnyék. körvonal, háttér, stb.

This feature was developed by [Mathieu Pellerin](http://www.imhere-asia.com/)
### Funkció: A fő ablak lépték vonalzó betűcsalád és méret testreszabható
This feature was developed by [Mathieu Pellerin](http://www.imhere-asia.com/)
### Funkció: egyéni SVG útvonal és méret az észak nyíl dekorációhoz
This feature was developed by [Mathieu Pellerin](http://www.imhere-asia.com/)
## Adatkezelés
...
## Réteg jelmagyarázat
### Funkció: Opcionális szöveg a vektor réteg szimbólumai felett
Ez a funkció lehetővé teszi a felhasználóknak extra információ hozzáadását a jelmagyarázatban a szimbólumokhoz.
...
This feature was developed by [Nyall Dawson (North Road)](https://north-road.com)
### Funkció: Jobb szöveg formattálás a léptékvonalzó felirathoz
...
Az olvashatatlan lépték vonalzó felirat már a múlté!
...
### Funkció: Szkript betöltése sablonból
Új opció a feldolgozás szkript betöltésére egy egyéni sabkomból
...
This feature was developed by [Mathieu Pellerin](http://www.imhere-asia.com/)
### Funkció: Unió, különbség és metszet algoritmusok portolása C++-ba
...
A 3.2-ben a következő algoritmusok támogatják a dinamikus paramétereket:
- Lyukak törlése
...
Ez az algoritmus felcseréli az X és Y koordináta értékeket az input geometriákban. A geometria javítására használhatjuk, ha a szélesség és hosszúság értékeket fordított sorrendben adták meg.
...
This feature was developed by [Martin Dobias (Lutra Consulting)](https://www.lutraconsulting.co.uk) and [Faunalia](https://www.faunalia.eu)
### Funkció: Projekt mentése és betöltése PostgreSQL adatbázisból
...
## Böngésző
### Fumció: Kapcsolatok mentése/betöltése XYZ csempékhez
...
This feature was developed by [Nyall Dawson (North Road)](https://north-road.com)
## Bővítmények
### Funkció: lekérdezéstörténet hozzáadása a DB kezelőhöz
A 3.2-benlehetőség van az SQL lekérdezések tárolására. A lekérdezés történet a DB kezelő modul SQL ablak fülén érhető el.

![image33](images/entries/9c6074aaf1e989c460833535788d0b396a677e34.png.400x300_q85_crop.webp)

This feature was developed by [Salvatore Larosa](https://github.com/slarosa)
### Funkció: DB kezelőben az SQL végrehajtása a háttérben
Ezt a funkciót fejlesztette Paul Blottiere
## 3D funkciók
...
A kép a szabadon elérhető prágai épület adathalmazt tartalmazza.
