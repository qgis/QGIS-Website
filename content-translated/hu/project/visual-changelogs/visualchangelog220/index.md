...
section: projekt
sidebar: true
title: A QGIS 2.2 változásnaplója
type: visual-changelog

---
{{<content-start >}}
# A QGIS 2.2 változásnaplója{#changelog22 }
...
### Funkció: Mérés tengeri mérföldekben
...
## Adatszolgáltatók
### Funkció: egy a többhöz kapcsolatok támogatása
...
### Funkció: Beillesztés új vektor rétegként
...
## Általános
### Funkció: Korábbi kifejezések mentése
A kifejezés szerkesztő megjegyzi az utolsó 20 kifejezést.

![image7](images/entries/90a6b4d181fb2dc7699402d17c1f31522c4f3409.webp)
### Funkció: WKT beillesztés a vágólapról
...
## QGIS Szerver
### Funkció: WCS támogatás a QGIS szerverhez
...
## Jelrendszer
### Funkció: Színátmenet kitöltés támogatása
...
- Két szín vagy skála alapú kitöltés
...
### Funkció: Elem generalizálás röptében
...
### Funkció: Tematikus térképek kifejezések alapján
...
### Funkció: Javított tulajdonságok párbeszédablak
...
### Funkció: Kifejezés párbeszédablak fejlesztések
