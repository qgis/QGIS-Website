...
section: projekt
sidebar: true
title: A QGIS 2.4 változásnaplója
type: visual-changelog

---
{{<content-start >}}
# A QGIS 2.4 változásnaplója{#changelog24 }
...
### Funkció: Szorzó és eltolás alkalmazása raszter adatokhoz
Néhány raszter adatforrásnál az adatokat egész számként tároljuk egy szorzóval és egy eltolással a metaadatokban. A szorzót és a eltolást használhatjuk a valós adatok megkapásához.A QGIS alkalmazza a raszter adatokra a jelmagyarázat, hisztogram és azonosítás esetén, hogy a helyes adatokat adja a felhasználóknak.

![image2](images/entries/9ec1681e4318f92a886405cf8215ec98068cf8ba.webp)
### Funkció: Gyors mező számító sor az attribútum táblában
Egy nagyszerű új funkcióval rendelkezünk azoknak, akik számított mezőkkel dolgoznak az attribútum táblákban. Az új gyors számítás sor lehetővé teszi az attribútum tábla egy oszlopában lévő értékek gyors és egyszerű aktualizálását.

![image3](images/entries/386f372e4b7be45426a62005813c8d58a9a2cb43.webp)
### Funkció: Színes előnézet módok a lap összeállításokhoz és a térképhez
...
Több új függvény adtunk a kifejezés szerkesztőhöz.
- befoglaló téglalap (bounds)
- bounding box width & height (bounds_width/bounds_height)
- min/max x/y koordináta (xmin/xmax/ymin/ymax)
...
- Tábla tartalom szűrhető egy kifejezéssel
...
### Funkció: stílusok mentése és visszatöltése Spatialite rétegekkel
