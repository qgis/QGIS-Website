...
title: Python konzol használta offline térképek előkészítéséhez WMS-ből (csempe letöltő)
type: case-study

---
{{<content-start >}}
# Python konzol használta offline térképek előkészítéséhez WMS-ből (csempe letöltő)
...
1. az első csempe X,Y koordinátája (bal felső és jobb alsó)
2. Letöltendő csempe mérete (pl. 0.001 X 0.001 fok)
3. No of tiles to download (calculated based on full extent of map and size of tile)
4. Output könyvtár az output csempék, fájlok tárolásához
...
- Honlap www.gisappco.com (fejlesztés alatt)
