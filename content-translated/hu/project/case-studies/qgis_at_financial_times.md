...
title: A QGIS használata a Financial Times grafikai csapatánál
type: case-study

---
{{<content-start >}}
# A QGIS használata a Financial Times grafikai csapatánál
...
## Interjú Steven Bernarddal (interaktív dizájn szerkesztő)
...
*Példa: Gotthard vasúti és közúti alagút a svájci Alpokban.*
...
**QGIS**: Milyen további eszközöket használ a QGIS mellett és hogyan kombinálja ezeket?
...
**QGIS**: Használ más térinformatikai eszközt a QGI mellett, ha igen melyiket?
...
**QGIS**: Milyen koncepciókat vagy funkciókat kedvel leginkább a QGIS-ben? 
