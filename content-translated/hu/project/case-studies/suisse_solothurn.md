...
A következő aspektusok vezérelték a döntéseket:
- Due to our use of desktop GIS in a Linux Terminal Server environment, Java wasn\'t an option.
- OSGeo projekt szervezet
- A GUI-t németre fordították
- Német nyelvű dokumentáció
- Egy aktív fejlesztő (Marco Hugentobler) Solothurn közelében Svájcban.
- We could contract Marco Hugentobler to implement missing / lacking features like Digitizing and Mapcomposing.
- Alkalmazás és modul fejlesztés Pythonnal
- Felhasználói közösség növelése
- Nagyon aktív fejlesztői közösség
- Függetlenség egy bizonyos operációs rendszertől

## Hol használjuk a QGIS-t
