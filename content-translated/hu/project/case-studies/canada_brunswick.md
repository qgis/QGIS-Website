...
title: Fundy Gyalogtúra útvonaltérkép létrehozás QGIS segítségével
type: case-study

---
{{<content-start >}}
# Fundy Gyalogtúra útvonaltérkép létrehozás QGIS segítségével
...
## A projekt
A Fundy Gyalogtúra térkép előállítása QGIS-ben három fő lépésre csoportosítható:
- Adatgyűjtés.
- Adat-előkészítés és szerkesztés.
- Térkép előállítás.
...
A végleges térkép előállításához szükséges adat-előkészítést a következő QGIS eszközökkel végeztük a specifikus feladatok megvalósítása érdekében:
- A GPS-es adatgyűjtés után az adatok tisztítottuk a szerkesztő eszköztár segítségével.
- A vektor adatok az NRCan és a SNB szervezetketől kerültek beszerzésre, lekérdezés, egyesítés és levágás műveletek elvégzése után állt elő a végleges térkép a vektor eszközök felhasználásával.
