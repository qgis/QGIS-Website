...
title: Nyugat-portugáliai őslénytani felmérés QGIS és GRASS felhasználásával
type: case-study

---
{{<content-start >}}
# Nyugat-portugáliai őslénytani felmérés QGIS és GRASS felhasználásával
...
- A lelőhelyek koordinátáinak helyszíni felmérése differenciális GPS alkalmazásával;
- Rendszeres helyszíni felmérések segítségével létrehozni egy kockázati modellt, amely azonosítja az őslénytani leletek előfordulásának valószínűségét, ezáltal is védettséget biztosítani azoknak. 
- Létrehozni egy gyűjtemény leltár és egy Földrajzi Információs Adatbázist az adatok tárolására. 

## Felhasznált szoftverek
A QGIS szoftver által biztosított lehetőségeket használtuk fel a projekt feladatok teljes elvégzésére. Az adatokat közvetlenül QGIS-ben szerkesztettük és módosítottuk, hogy megkapjuk az elvárt eredményeket. A QGIS által biztosított GRASS felhasználói felület lehetőséget adott a komplex térbeli elemzések raszter adatokon történő elvégzésére, ezáltal létrejött egy kockázati modell, amely alapján meg tudtuk tervezni a terepi munkánkat és a további kutatásokat. Továbbá, lehetővé tette hogy importáljunk és megjelenítsünk PostGIS rétegeket is a QGIS-ben.
