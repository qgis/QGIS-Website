...
A logística para viabilizar tal trabalho de campo envolvendo o uso de pacotes estatísticos para gerir o banco de dados gerado, juntamente com um uso intensivo de GIS para organizar viagens de campo e georeferenciação de dados aliviados.
