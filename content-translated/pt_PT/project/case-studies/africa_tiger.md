...
title: 'Sistema de Informação de Observação da Água: Possibilitando o Uso de Dados
  de Observação da Terra para a Gestão Integrada de Recursos Hídricos em África'
type: case-study

---
{{<content-start >}}
# Sistema de Informação de Observação da Água: Possibilitando o Uso de Dados de Observação da Terra para a Gestão Integrada de Recursos Hídricos em África
