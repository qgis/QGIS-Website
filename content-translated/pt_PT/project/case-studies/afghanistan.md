...
title: Grupo Dinamarquês de desminagem usando o QGIS no Afeganistão
type: case-study

---
{{<content-start >}}
# Grupo Dinamarquês de desminagem usando o QGIS no Afeganistão
...
O QGIS também sincroniza bem com os dados recolhidos a partir de operações de campo usando um dispositivo Garmin GPS, permitindo apurar o mapeamento a ser feito tendo em conta os locais das minas encontradas e destruídas.
