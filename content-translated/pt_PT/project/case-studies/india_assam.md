...
title: QGIS para monitorização de tigres (usando armadilhas fotográficas na Reserva
  de Tigres de Nameri, Assam, Distrito de Sonipur, Índia)
type: case-study

---
{{<content-start >}}
# QGIS para monitorização de tigres (usando armadilhas fotográficas na Reserva de Tigres de Nameri, Assam, Distrito de Sonipur, Índia)
...
## Aplicação do QGIS para desenhar o local de estudo da armadilha fotográfica
...
Este artigo teve o contributo do Rajendra G. Garawad em Março de 2013. Ele é Diretor de campo da Reserva de Tigres em Nameri, Assam, Índia. Possui um Mestrado em Ciências Florestais e Conservação & Ordenamento do Território.
