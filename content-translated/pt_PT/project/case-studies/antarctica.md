...
title: 'Quantarctica: Um pacote SIG Antártica'
type: case-study

---
{{<content-start >}}
# Quantarctica: Um pacote SIG Antártica
...
Quantarctica está a ser usado para examinar dados geográficos de escala continental a escala local, para ver informação científica projetada em cima de mapas de base ou com outros conjuntos de dados específicos, e preparar mapas para publicações e propostas. Quantarctica até agora tem provado ser uma ótima ferramenta, e uma boa alternativa e complemento para outros softwares utilizados pelos investigadores. Veio fornecer novas oportunidades para os nossos investigadores no seu trabalho diário.
...
Desde que o Quantarctica foi usado pelos nossos glaciólogos há três anos, tem havido muitos pedidos por parte da comunidade de investigação fora do instituto para partilhar este produto, e começámos a desenvolver uma versão pública e melhorada para substituir a versão interna. Após testes de campo na Antártica, e de adicionar novos conjuntos de dados relevantes, o Quantarctica versão 1.0 foi finalmente concluído e disponibilizado para transferência em julho de 2013.
...
Este artigo foi contribuído em Agosto de 2013 por Anders Skoglund (esquerda), Especialista SIG, e Kenichi Matsuoka (direita), galciólogo, ambos do Instituto Polar Norueguês.
