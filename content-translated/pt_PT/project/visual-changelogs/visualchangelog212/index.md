...
section: projeto
sidebar: true
title: Registo de alterações do QGIS 2.12
type: visual-changelog

---
{{<content-start >}}
# Registo de alterações do QGIS 2.12{#changelog212 }
...
## Gestão de Dados
### Funcionalidade: Melhorias no Gestor de BD
Foram efetuadas várias melhorias na ferramenta do Gestor de BD:
...
## Simbologia
### Funcionalidade: Exportar miniaturas a partir do gestor de estilos
