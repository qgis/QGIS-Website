...
section: projeto
sidebar: true
title: Registo de Alterações para o QGIS 3.10
type: visual-changelog

---
{{<content-start >}}
# Registo de Alterações para o QGIS 3.10{#changelog310 }
![image1](images/projects/ce6ba8fc893e51ec721c9dded4dd98d11806a223.png)

Release date: 2019-10-25

O QGIS 3.10 vem uma lista completa de novas alterações e muitas melhorias das funcionalidades existentes - os destaques que nós iremos abordar aqui. Como sempre, nós lembramos que o QGIS é um projeto de código aberto e, se puder, apoie o nosso trabalho através de doações ou contribuições para a documentação do código, do "site" da Web, e assim por diante.
...
{{<table-of-contents >}}
## Ferramentas de Mapa
### Funcionalidade: Comprimentos de linha 3D mostrados nos resultados da ferramenta de identificação
Agora, o uso da ferramenta Identificar Elementos numa sequência de linhas 3D inclui nos resultados o comprimento cartesiano 3D da linha (ao lado dos comprimentos 2D cartesiano e elipsoidal 2D existentes).
...
### Funcionalidade: Melhorado o copiar/colar de símbolos
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
### Funcionalidade: Definição de expressões de afastamento por dados mais flexível
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
## Etiquetagem
### Funcionalidade: Criar e gerir formatos de texto e configurações de etiquetas nos estilos do QGIS
...
### Funcionalidade: Símbolos marcadores como fundo de etiquetas
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
### Funcionalidade: Alterar o alinhamento de etiquetas de várias linhas para etiquetas individuais
...
This feature was developed by [Mathieu Pellerin](http://www.imhere-asia.com/)
### Funcionalidade: Mostrar etiquetas não colocadas
...
Esta funcionalidade foi desenvolvida por Isghj5
...
Esta funcionalidade foi financiada por QGIS.org
...
![image55](images/entries/57f395b303ba963e67242e0f2cfe7104e61f2ad0.webp)
 ...
 Esta funcionalidade foi desenvolvida por DelazJ
...
Esta funcionalidade foi desenvolvida por Oslandia
...
This feature was developed by [Mathieu Pellerin](http://www.imhere-asia.com/)
### Funcionalidade: Fornecedores de Dados Estático 
...
## Servidor QGIS
### Funcionalidade: Utilização de SVG no servidor QGIS
...
This feature was developed by [René-Luc D\'Hont (3Liz)](https://www.3liz.com/)
### Funcionalidade: Suporte para servir OAPIF (aka WFS3)
...
This feature was developed by [Alessandro Pasotti](https://www.qcooperative.net)
## Programabilidade
### Funcionalidade: Nova Classe QgsBookmarkManager
...
Esta funcionalidade foi financiada por QGIS

This feature was developed by [Alessandro Pasotti](https://www.qcooperative.net)
## Correções Notáveis
### Funcionalidade: Correções de defeitos por Alessandro Pasotti
| Título do Defeito | URL issues (if reported) | URL PR or commit | 3.4 backport PR or commit |
| --- | --- | --- | --- |
...
### Funcionalidade: Correções de defeitos por Sandro Santilli
| Título do Defeito | URL issues (if reported) | URL PR or commit | 3.4 backport PR or commit |
| --- | --- | --- | --- |
...
### Funcionalidade: Correções de defeitos por Matthias Kuhn
| Título do Defeito | URL issues (if reported) | URL PR or commit | 3.4 backport PR or commit |
| --- | --- | --- | --- |
...
Esta funcionalidade foi desenvolvida por Paul Blottiere
