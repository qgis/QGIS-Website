...
section: projeto
sidebar: true
title: Registo de alterações do QGIS 2.16
type: visual-changelog

---
{{<content-start >}}
# Registo de alterações do QGIS 2.16{#changelog216 }
...
{{<table-of-contents >}}
## Patrocinadores para QGIS versão 2.16.0
Anualmente, nós também recebemos apoio de várias organizações que valorizam o trabalho que nós fazemos e que gostariam de facilitar o esforço sustentado de desenvolvimento que vai para o projeto. Estes patrocinadores estão listados em baixo com o nosso agradecimento!
