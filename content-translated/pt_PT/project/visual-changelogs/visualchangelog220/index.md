...
section: projeto
sidebar: true
title: Registo de alterações do QGIS 2.2
type: visual-changelog

---
{{<content-start >}}
# Registo de alterações do QGIS 2.2{#changelog22 }
...
Nós atualizámos os atalhos do teclado no |qg| para tornar mais eficiente tarefas repetitivas.
