...
section: projeto
sidebar: true
title: Registo de alterações para QGIS 3.14
type: visual-changelog

---
{{<content-start >}}
# Registo de alterações para QGIS 3.14{#changelog314 }
...
{{<table-of-contents >}}
## Geral
### Funcionalidade: novas definições de tipo de letra para as anotações de decoração da nova grelha
...
Esta funcionalidade foi apoiada por iMHere Asia

This feature was developed by [Mathieu Pellerin](https://api.github.com/users/nirvn)
## Temporal
### Funcionalidade: definição de limite temporal cumulativa no controlador temporal
...
Esta funcionalidade foi apoiada por ARPA Piemonte
...
As escolhas incluem:
- Ponto mais próximo (comportamento anterior)
- Label Centroid
...
| Título do Defeito | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Vectorlayer from spatialite missing features and inconsistent feature count | [#29264](https://github.com/qgis/QGIS/issues/29264) | [PR #37277](https://github.com/qgis/QGIS/pull/37277) | POR FAZER |
...
### Funcionalidade: Correções de defeitos por Paul Blottiere
| Título do Defeito | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Attributes shift in the Service area algorithm results | unreported | [PR #37074](https://github.com/qgis/QGIS/pull/37074), [PR #37097](https://github.com/qgis/QGIS/pull/37097) | N/A |
| Processing testing framework does not apply rounding to values casted to numbers | unreported | [PR #37234](https://github.com/qgis/QGIS/pull/37234) | N/A |

This feature was funded by [QGIS.ORG (through donations and sustaining memberships)](https://www.qgis.org/)

Esta funcionalidade foi desenvolvida pelo Alexander Bruy
### Funcionalidade: Correções de defeitos por Nyall Dawson
| Título do Defeito | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix leak in mesh 3d renderer | unreported | [Commit 4b5a63d](https://github.com/qgis/QGIS/commit/4b5a63d11b7ea5baf6931c8abf86e132c706c1be) | N/A |
...
| Fixes to numbered list handling in dox/PyQGIS API | unreported | [Commit 74400c7](https://github.com/qgis/QGIS/commit/74400c7ff88d563dad74dad41860f9b603214973) | Não |
| Fix cross references in PyQGIS docs | unreported | [Commit 81a9db9](https://github.com/qgis/QGIS/commit/81a9db9f57706cba9b11e4372dd1bf50fcd7bc6a) | Não |
...
| Fix list item formatting in PyQGIS docs | unreported | [Commit 84ec481](https://github.com/qgis/QGIS/commit/84ec481aa8f3d3bb487272122414c765e77a2ea2) | N/A |
...
| Avoid some QGIS startup warnings | unreported | [Commit 013f682](https://github.com/qgis/QGIS/commit/013f682bd3c6addd163a78d3776c578ae37377c6) | N/A |
...
| Don\'t block creation of new geopackages in vector save as dialog | unreported | [Commit 8ccd127](https://github.com/qgis/QGIS/commit/8ccd127f4d8bf66fb04b6484147ed116acf66d91) | N/A |
...
| \[3d\] When showing edges, data defined polygon height was not accounted for | unreported | [Commit e516231](https://github.com/qgis/QGIS/commit/e516231bb2854405ea78a0cec40ad96295e9f8c6) | N/A |
| Fixes for \"Show all\" labeling mode | unreported | [Commit 2b91bd0](https://github.com/qgis/QGIS/commit/2b91bd0cafff66f14ceb49b104bf2f2cc6ae714d) | N/A |
...
| Avoid corrupted project thumbnail images in some circumstances | unreported | [Commit f404e6e](https://github.com/qgis/QGIS/commit/f404e6e162df954ffb200d550b6c32375b7270c1) | N/A |
...
| Fix incorrect warning message when turning off atlas preview | unreported | [Commit 3b0af960](https://github.com/qgis/QGIS/commit/3b0af960dd90af15cbe32e2fd7642408031e70f5) | N/A |
...
| fix layer tree dependencies (showinf symbols and main layer) | unreported | [PR #37000](https://github.com/qgis/QGIS/pull/37000) | N/A |
