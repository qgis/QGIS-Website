...
section: projeto
sidebar: true
title: Registo de alterações do QGIS 2.18
type: visual-changelog

---
{{<content-start >}}
# Registo de alterações do QGIS 2.18{#changelog218 }
...
{{<table-of-contents >}}
## Patrocinadores para QGIS versão 2.18.0
...
## Plugins
### Funcionalidade: Gestor de BD: Adicionar a capacidade de atualizar a Camada de SQL
