...
section: projeto
sidebar: true
title: Registo de alterações do QGIS 3.0
type: visual-changelog

---
{{<content-start >}}
# Registo de alterações do QGIS 3.0{#changelog30 }
...
### Funcionalidade: Remover módulo de conversão "dxf2shp"
This functionality is available in OGR and there is no longer a need for a dedicated QGIS plugin to do this task
### Funcionalidade: Remover módulo "oracle raster"
### Funcionalidade: Remoção do fornecedor TauDEM do core do menu Processamento
...
### Funcionalidade: Mais ajuda e possibilidade de configurar a localização dos ficheiros de ajuda do QGIS
...
### Funcionalidade: Migração dos widgets Foto, WebView e FileName para o Anexo
![image113](images/entries/d2e949a9804de76d196af6e58996165d01350fec.jpeg.400x300_q85_crop.webp)
### Funcionalidade: Remoção dos fornecedor otb e lidartools do core do menu Processamento
...
Esta funcionalidade foi desenvolvida pelo Alexander Bruy
### Funcionalidade: Barra de Localização
The Locator bar is a fast, always ready, generic and pluggable search facility in the Left Bottom corner of QGIS.

Atualmente é possível procurar algoritmos, ações e nomes de camadas, mas também é possível selecionar um elemento na camada atual ativa digitando um valor do atributo. 
...
Esta funcionalidade foi desenvolvida pelo Nyall Dawson
...
### Funcionalidade: Adicionado uma opção para mostrar os menus de esquemas de cor
...
![image70](images/entries/a2adf1e9930f23fa739e68a6e2c55e1b553867b9.png.400x300_q85_crop.webp)
 ...
 Esta funcionalidade foi financiada pelo Andreas Neumann (financiamento parcial)
...
This feature was developed by [Mathieu Pellerin](http://www.imhere-asia.com/)
### Funcionalidade: Melhoria na consistência na interface do utilizador
...
Thanks to the QGIS PSC and project donors for sponsoring this work and allowing it to proceed!
 ...
 Esta funcionalidade foi financiada pelos Doadores e Patrocinadores do QGIS

This feature was developed by [Nyall Dawson](https://north-road.com)
### Funcionalidade: Abrir camadas num grupo único
Se tentar abrir muitas subcamadas, agora poderá abri-las todas na legenda num mesmo grupo.
...
## Funcionalidades 3D
### Funcionalidade: Vista do mapa 3D e geração de terreno
...
## Expressões
### Funcionalidade: Nova expressão de variáveis
...
Esta funcionalidade foi desenvolvida pelo Alexander Bruy
### Funcionalidade: Novas variáveis de expressão para as definições do mapa
...
Esta funcionalidade foi desenvolvida por vários programadores
...
This feature was developed by [Nyall Dawson (North Road)](https://north-road.com/)
## Documentação
### Funcionalidade: Melhorias nos algoritmos do menu Processamento
...
This feature was developed by [Mathieu Pellerin](http://www.imhere-asia.com/)
### Funcionalidade: Gestor de estilo, melhorias e refinamentos
...
Esta funcionalidade foi desenvolvida por Even Rouault
...
- muitas limpezas de código + de documentação.
...
### Funcionalidade: NOVOS ALGORITMOS PARA COLORIR MAPAS NO QGIS 3.0
...
This feature was developed by [Nyall Dawson (North Road)](https://north-road.com/)
### Funcionalidade: Estilos fáceis para rasters discretos
...
## Etiquetagem
### Feature: Permite tamanho de fonte para etiquetas em mm/pixels
This feature was funded by [North Road](https://north-road.com/)
...
Esta funcionalidade foi desenvolvida pela Kartoza e North Road
...
Esta funcionalidade foi desenvolvida pelo Alexander Lisovenko / Paul Blottiere
...
Esta funcionalidade foi desenvolvida pelo Denis Rouzaud
...
Esta funcionalidade foi financiada pela Boundless

This feature was developed by [Alessandro Pasotti](https://www.itopen.it)
### Funcionalidade: Remoção da ferramenta OSM Downloader
...
Esta funcionalidade foi desenvolvida pelo Patrick Valsecchi
...
Esta funcionalidade foi financiada por QGIS - Grupo de Utilizadores da Suíça e outros!
...
This feature was developed by [Nyall Dawson (North Road)](https://north-road.com/)
### Funcionalidade: Novo tipo de entrada para expressões
...
This feature was developed by [Nyall Dawson (North Road)](https://north-road.com/)
### Funcionalidade: Dvidir com Linhas
...
Esta funcionalidade foi desenvolvida pelo Bernhard Ströbl
...
Esta funcionalidade foi desenvolvida por Alessandro Pasotti
...
Esta funcionalidade foi desenvolvida pelo Mathieu Pellerin, Alexander Bury, Paul Blottiere
...
Esta funcionalidade foi desenvolvida pelo Hugo Mercier
### Feature: dxf export: support reprojection
Esta funcionalidade foi desenvolvida pelo Juergen E. Fischer
...
Esta funcionalidade foi desenvolvida pelo Matthias Kuhn, Nyall e outros
