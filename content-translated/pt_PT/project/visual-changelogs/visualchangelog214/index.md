...
section: projeto
sidebar: true
title: Lista de alterações para o QGIS 2.14
type: visual-changelog

---
{{<content-start >}}
# Lista de alterações para o QGIS 2.14{#changelog214 }
...
Para garantir a estabilidade a longo prazo do módulo de processamento, foi introduzida uma nova framework de testes.
