...
{{<content-start >}}
## Key features
{{<tabs tab1="Cria mapas" tab2="Edita camadas" tab3="Processa e analisa" tab4="Partilha mapas" >}}
...
### Servidor QGIS
Publique os seus projetos QGIS e camadas como serviços OGC compatíveis WMS, WMTS, WFS e WCS. Controle as camadas, atributos, layouts e sistemas de coordenadas que pretende exportar. O QGIS Server é considerado como uma referência na implementação do WMS 1.3.
