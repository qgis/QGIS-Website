...
{{<content-start >}}
# Infraestrutura
Esta página deverá mostrar-lhe toda a infraestrutura e serviços que o QGIS utiliza, e os contactos atuais ou proprietários.
...
**Main contact:** Gary
## Servidor principal
{{<rich-list listLink="http://documentation.qgis.org" layoutClass="half" listTitle="Servidor principal" listSubtitle="http://documentation.qgis.org" >}}
...
Documentação e Site da Web
-
{{<rich-list listLink="http://docs.qgis.org" layoutClass="half" listTitle="Documentação" listSubtitle="http://docs.qgis.org" >}}

{{<rich-list listLink="http://new.qgis.org" layoutClass="half" listTitle="Site da Web" listSubtitle="http://new.qgis.org" >}}
...
Grupos do Flickr
-
{{<rich-list listLink="http://www.flickr.com/groups/qgis/pool/" layoutClass="half" listTitle="Capturas de ecrã" listSubtitle="http://www.flickr.com/groups/qgis/pool/" >}}

{{<rich-list listLink="http://www.flickr.com/groups/qgis-screenshots/" layoutClass="half" listTitle="Mapas" listSubtitle="http://www.flickr.com/groups/qgis-screenshots/" >}}
