...
title: Lucrul cu QGIS într-o infrastructură de date spațiale din Jalisco, Mexic
type: case-study

---
{{<content-start >}}
# Lucrul cu QGIS într-o infrastructură de date spațiale din Jalisco, Mexic
...
Institutul de Informații Teritoriale din statul Jalisco este o organizație guvernamentală, care a fost înființată în anul 1998 pentru a partaja informații geografice între agențiile guvernamentale din Jalisco, Mexic.
...
În timp, instituția a adunat o mulțime de informații în mai multe formate, cum ar fi SHP, DWG, DXF, GeoTIFF și ECW, printre altele. Ceea ce am vrut, a fost să avem toate aceste informații organizate și într-un format comun, pentru a fi în măsură să le oferim și să le afișăm pe Internet.
