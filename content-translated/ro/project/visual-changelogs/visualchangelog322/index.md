...
section: proiect
sidebar: true
title: Jurnalul schimbărilor pentru QGIS 3.22
type: visual-changelog

---
{{<content-start >}}
# Jurnalul schimbărilor pentru QGIS 3.22{#changelog322 }
...
{{<table-of-contents >}}
## Adnotări
### Funcționalitate: Proprietăți și efecte pentru straturile de adnotare
...
### Funcționalitate: Editarea nodurilor dintr-o adnotare
...
Această funcționalitate a fost dezvoltată de [Nyall Dawson](https://github.com/nyalldawson)
### Funcționalitate: Mutarea adnotării selectate folosind cu tastele cu săgeți
...
Această funcționalitate a fost dezvoltată de [Nyall Dawson](https://github.com/nyalldawson)
### Funcționalitate: Instrument de creare adnotări de tip linie/poligon
...
Această funcționalitate a fost dezvoltată de [Nyall Dawson](https://github.com/nyalldawson)
### Funcționalitate: Instrument de adnotare pentru puncte
...
Această funcționalitate a fost dezvoltată de [Nyall Dawson](https://github.com/nyalldawson)
### Funcționalitate: Instrumente pentru adnotări
...
Această funcționalitate a fost finanțată de [Hydrotec](https://www.hydrotec.de/)
...
Această funcționalitate a fost dezvoltată de [Lutra Consulting (Vincent Cloarec)](https://www.lutraconsulting.co.uk/)
### Funcționalitate: Instrument de editare a suprafețelor poliedrice
...
Această funcționalitate a fost dezvoltată de [Matthias Kuhn](https://github.com/m-kuhn)
...
Această funcționalitate a fost dezvoltată de [Jürnjakob Dugge](https://github.com/jdugge)
## Expresii
...
Această funcționalitate a fost finanțată de [Swiss QGIS user group](https://qgis.ch/)

Această funcționalitate a fost dezvoltată de [Olivier Dalang](https://github.com/olivierdalang)
...
Această funcționalitate a fost finanțată de [Lille Metropole](https://www.lillemetropole.fr/)
...
Această funcționalitate a fost finanțată de [Cantonul Glarus](https://www.gl.ch/verwaltung/bau-und-umwelt/hochbau/raumentwicklung-und-geoinformation/geoportal-kanton-glarus.html/808)
...
Această funcționalitate a fost dezvoltată de [Francesco Bursi](https://github.com/Franc-Brs)
...
Această funcționalitate a fost dezvoltată de [Étienne Trimaille](https://github.com/Gustry)
...
Această funcționalitate a fost finanțată de [ms.GIS](http://www.msgis.com)
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.16 backport commit (GitHub) | Comentariu |
| --- | --- | --- | --- | --- |
| WFS / GML parse issue, but QGIS loads GML as file fine? | [#45017](https://github.com/qgis/QGIS/issues/45017) | Nu este o eroare |  |  |
...
| Warning message \'Cannot create temporary SpatiaLite cache\' when adding many WFS-layers | [#44971](https://github.com/qgis/QGIS/issues/44971) | Duplicat |  |  |
...
| QGIS on linux crashes when opening many geopackages at once | [#43620](https://github.com/qgis/QGIS/issues/43620) | [PR #45211](https://github.com/qgis/QGIS/pull/45211) | Nu |  |
...
| QGIS crash after loading WMS layer via script and zooming in and out | [#44095](https://github.com/qgis/QGIS/issues/44095) | [PR #45254](https://github.com/qgis/QGIS/pull/45254) | Nu | Mostly a usage issue |
| Integer unexpectedly large in GeoPackage | [#45178](https://github.com/qgis/QGIS/issues/45178) | Nu este o eroare |  |  |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.16 backport commit (GitHub) | Comentariu |
| --- | --- | --- | --- | --- |
| Data Source Manager - ArcGIS REST Server - dialog/window closes when adding a layer | [#45050](https://github.com/qgis/QGIS/issues/45050) | [PR #45059](https://github.com/qgis/QGIS/pull/45059) | nedisponibil |  |
| \"Display no data value as\" option is not available in raster layer properties | [#44949](https://github.com/qgis/QGIS/issues/44949) | [PR #45063](https://github.com/qgis/QGIS/pull/45063) | Non critic |  |
...
| Update selected feature ids before emitting featuresDeleted | [#44921](https://github.com/qgis/QGIS/issues/44921) | [PR #45078](https://github.com/qgis/QGIS/pull/45078) | Non critic |  |
...
| Copying objects containing multiline strings into another project does not work properly | [#44989](https://github.com/qgis/QGIS/issues/44989) | [PR #45129](https://github.com/qgis/QGIS/pull/45129) | Non critic |  |
| projecting label coordinates for multiPoint geometry crashes QGIS | [#45148](https://github.com/qgis/QGIS/issues/45148) | [PR #45150](https://github.com/qgis/QGIS/pull/45150) | Nu |  |
...
| Attributes - Update All button - Creates Corrupted Fields - GeoJSON file | [#45139](https://github.com/qgis/QGIS/issues/45139) | [PR #45174](https://github.com/qgis/QGIS/pull/45174) | Nu |  |
| WMS parent layer added via QGIS Browser doesn\'t use default style | [#45192](https://github.com/qgis/QGIS/issues/45192) | [PR #45209](https://github.com/qgis/QGIS/pull/45209) | Nu |  |
| \"Display nodata as\" color widget is not automatically updated in layer styling panel | [#45132](https://github.com/qgis/QGIS/issues/45132) | [PR #45264](https://github.com/qgis/QGIS/pull/45264) | nedisponibil |  |
...
| WFS Layer from QGIS Server is not rendered because of an issue with coordinate axis order | [#45216](https://github.com/qgis/QGIS/issues/45216) | [PR #45270](https://github.com/qgis/QGIS/pull/45270) | Non critic |  |
...
| Copying table by Drag&Drop in Browser (2) doesn\'t copy the table structure correctly | [#45286](https://github.com/qgis/QGIS/issues/45286) | [PR #45375](https://github.com/qgis/QGIS/pull/45375) | Nu |  |
...
| Create spatialite trigger with DBManager do not work | [#45420](https://github.com/qgis/QGIS/issues/45420) | [PR #45553](https://github.com/qgis/QGIS/pull/45553) | Nu |  |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.16 backport commit (GitHub) | Comentariu |
| --- | --- | --- | --- | --- |
| QGIS 3.20 on Mac crashes when certain Qt signals are emitted | [#44182](https://github.com/qgis/QGIS/issues/44182) | [QGIS-Mac-Packager Commit bf925f311](https://github.com/qgis/QGIS-Mac-Packager/commit/bf925f3118a5d51080dfed46dddcb7cba3bbbc00) | nedisponibil |  |
| Unable to view LAS files written in WGS84 (EPSG:4326) coordinates | [#44755](https://github.com/qgis/QGIS/issues/44755) | duplicat al problemei [#41765](https://github.com/qgis/QGIS/issues/41765) |  |  |
| macOS: Symbol not found: \_\_cg_jpeg_resync_to_restart when reprojecting raster layer with GDAL warp on macOS | [#40164](https://github.com/qgis/QGIS/issues/40164) | nu | nu | Not an issue with the nightly (qgis-deps-0.9) anymore |
...
| icons not visible in the Layer Notes | [#44425](https://github.com/qgis/QGIS/issues/44425) | [PR #45332](https://github.com/qgis/QGIS/pull/45332) | nedisponibil |  |
| unable to open any ascii FLO-2D files in Mesh Layer | neraportat | [PR #45349](https://github.com/qgis/QGIS/pull/45349) | nedisponibil |  |
...
| Matplotlib QT backend imports not working on MacOS | [#45398](https://github.com/qgis/QGIS/issues/45398) | investigație |  |  |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.16 backport commit (GitHub) | Comentariu |
| --- | --- | --- | --- | --- |
| Make QgsGeos::prepareGeometry and QgsGeos::cacheGeos idempotent | neraportat | [PR #45147](https://github.com/qgis/QGIS/pull/45147) |  |  |
| Add a distanceWithin method to the QgsGeometryEngine virtual class | neraportat | [PR #45057](https://github.com/qgis/QGIS/pull/45057) |  |  |
| Allow calling testdata_pg.sh from any directory | neraportat | [PR #45378](https://github.com/qgis/QGIS/pull/45378) |  |  |
| Make TestPyQgsPostgresProvider.testGeneratedColumns idempotent | neraportat | [PR #45415](https://github.com/qgis/QGIS/pull/45415) |  |  |
| Improve PostgreSQL test DB setup documentation and script | neraportat | [PR #45413](https://github.com/qgis/QGIS/pull/45413) |  |  |
...
| Use GEOSDistanceWithin when available | neraportat | [PR #45340](https://github.com/qgis/QGIS/pull/45340) |  |  |
| Reduce GEOS conversions and preparations of geometries | neraportat | [PR #45195](https://github.com/qgis/QGIS/pull/45195) |  |  |
| More heuristics to determine whether to iterate over target source | neraportat | [PR #45339](https://github.com/qgis/QGIS/pull/45339) |  |  |

These bug fixes were funded by [QGIS.ORG (through donations and sustaining memberships)](https://www.qgis.org/)

Bugs fixed by [Sandro Santilli](https://strk.kbt.io/)
### Corecții efectuate de Loïc Bartoletti
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.16 backport commit (GitHub) | Comentariu |
| --- | --- | --- | --- | --- |
...
| VertexTool. Fixes move vertex on Z layer if CRS are differents (with Vincent Cloarec) | Neraportată | [PR #45020](https://github.com/qgis/QGIS/pull/45020) | Not backported. Introduce new methods. |  |
...
| \[FIX\] GeometryValidator init curve support | Neraportată | [PR #45272](https://github.com/qgis/QGIS/pull/45272) |  |  |
...
| Form view shows wrong image attachments when scrolling through features | [#42705](https://github.com/qgis/QGIS/issues/42705) | Remediat deja |  |  |
...
| Attachment widget options are reset when you reopen the field widget properties | [#45089](https://github.com/qgis/QGIS/issues/45089) | Duplicat |  |  |
...
| Update default toolbar locations | neraportat | [Commit 77be95feac](https://github.com/qgis/QGIS/commit/77be95feac7391e58f6bd487f30e09ed8ed63651) | N/A |  |
...
| Fix crash on exit with CAD dock open | neraportat | [Commit 1fb21f69f](https://github.com/qgis/QGIS/commit/1fb21f69fede05cabb8f1d27a8ad24564ae16f3d) | N/A |  |
...
| Fix inappropriate display of z/m values in cad dock when non-z/m layer is selected | neraportat | [Commit 55a76d1d](https://github.com/qgis/QGIS/commit/55a76d1d867c32f52ae4bd38ed671d44aa3ae92e) | N/A |  |
...
| Allow CAD dock to be used for geographic CRS, but only allow the x/y/z/m constraints to be set | neraportat | [PR #45185](https://github.com/qgis/QGIS/pull/45185) | Not suitable for backport |  |
...
| Fix QgsMapToolCapture coordinates when associated with a non-vector layer where the layer CRS != canvas CRS | neraportat | [PR #45183](https://github.com/qgis/QGIS/pull/45183) | N/A |  |
...
| Fix digitizing features using CAD dock when layer CRS != canvas CRS | neraportat | [PR #45108](https://github.com/qgis/QGIS/pull/45108) | N/A |  |
...
| Fix handling of ADF files in browser | neraportat | [PR #45393](https://github.com/qgis/QGIS/pull/45393) | Not suitable for backport |  |
