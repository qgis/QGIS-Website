...
Această funcționalitate a fost finanțată de Septima, Klimadatastyrelsen
...
Această funcționalitate a fost finanțată de Cesium Ecosystem Grant

Această funcționalitate a fost dezvoltată de Lutra Consulting & North Road
...
- Selectare după un Poligon
- Selecție după Instrumentul Pensulă
...
Această funcționalitate a fost finanțată de [Hauts-de-France](https://www.hautsdefrance.fr/)
...
Această funcționalitate a fost finanțată de [level2](https://level2.si/)

Această funcționalitate a fost dezvoltată de [Uroš Preložnik](https://github.com/uprel)
## Profile Plots
...
Această funcționalitate a fost finanțată de BRGM
...
Această funcționalitate a fost finanțată de QGIS grant program 2025
...
Această funcționalitate a fost finanțată de Regiodata
...
Această funcționalitate a fost finanțată de Dorset Council
...
Această funcționalitate a fost finanțată de [the Danish Nature Agency, Naturstyrelsen](https://naturstyrelsen.dk/)
...
| New HTTP (WMS & friends) connection dialog too tall | [\#61867](https://github.com/qgis/QGIS/issues/61867) | [PR \#61912](https://github.com/qgis/QGIS/pull/61912) | Non critic |
...
| JSON array attribute fields are not supported | [\#61728](https://github.com/qgis/QGIS/issues/61728) | [PR \#61938](https://github.com/qgis/QGIS/pull/61938) | Riscant |
...
| PG: Can't add/update feature when numeric field with numeric default is set to default | [\#61529](https://github.com/qgis/QGIS/issues/61529) | [PR \#62010](https://github.com/qgis/QGIS/pull/62010) | Riscant |
...
| duplicated objectName in the oracle dialog | neraportat | [PR \#61944](https://github.com/qgis/QGIS/pull/61944) | N/A |
...
| Fix reshaping when snapping to segment | neraportat | [PR \#62315](https://github.com/qgis/QGIS/pull/62315) |  |
| Unhandled GEOS exception when reshaping | neraportat | [PR \#62322](https://github.com/qgis/QGIS/pull/62322) |  |
| Reshape returns Success instead of NothingHappened | neraportat | [PR \#62323](https://github.com/qgis/QGIS/pull/62323) | [PR \#62336](https://github.com/qgis/QGIS/pull/62336) |
| Reshape tool tries to run with a single digitized point | neraportat | [PR \#62324](https://github.com/qgis/QGIS/pull/62324) |  |
| Fix crash when undoing first digitized point in shape map tools | neraportat | [PR \#62335](https://github.com/qgis/QGIS/pull/62335) |  |
| Fix crashing shape tools when not enough points digitized | neraportat | [PR \#62338](https://github.com/qgis/QGIS/pull/62338) |  |
...
| Misbehavior of advanced topology settings on independant layers | nu este o eroare |  |  |
...
| \[Processing toolbox\] Search box (result) not updated when list of providers change | [\#26435](https://github.com/qgis/QGIS/issues/26435) | [PR \#62162](https://github.com/qgis/QGIS/pull/62162) | Nu |
...
| When saving SLD to DB, make sure errors are reported to callers (like Package layers algorithm) | neraportat | [PR \#62332](https://github.com/qgis/QGIS/pull/62332) |  |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| QGIS fails to import sprites from OpenStreetMap vector tile styles | neraportat | [PR \#62175](https://github.com/qgis/QGIS/pull/62175) |  |
...
| QGIS fails to handle of source containing a relative path to the root of the server hosting the style json | neraportat | [PR \#62062](https://github.com/qgis/QGIS/pull/62062) | [PR \#62084](https://github.com/qgis/QGIS/pull/62084) |
...
| Various new connection dialog spacing and size issues | neraportat | [PR \#62041](https://github.com/qgis/QGIS/pull/62041) |  |
...
| \[Oracle\] Fix PyQgsProviderRegistry test | qt6 test failing | [PR \#62109](https://github.com/qgis/QGIS/pull/62109) | Nu |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix walk mode key handling | Neraportată | [PR \#62331](https://github.com/qgis/QGIS/pull/62331) | N/A |
| Increase QImageReader allocation limit for qt6 builds | Neraportată | [PR \#62320](https://github.com/qgis/QGIS/pull/62320) | N/A |
...
| Use protected, not private virtual methods for map tool classes | Neraportată | [PR \#62097](https://github.com/qgis/QGIS/pull/62097) | [PR \#62112](https://github.com/qgis/QGIS/pull/62112) |
| Avoid corrupted overlapping docks when first changing from dialog to dock | Neraportată | [PR \#62102](https://github.com/qgis/QGIS/pull/62102) | N/A |
| Fix jumpy scroll area when using mouse wheel on qt6 builds | Neraportată | [PR \#62099](https://github.com/qgis/QGIS/pull/62099) | N/A |
...
| Fix variables available for grid annotations missing for grid symbol | Neraportată | [PR \#61943](https://github.com/qgis/QGIS/pull/61943) | [PR \#61957](https://github.com/qgis/QGIS/pull/61957) |
...
| Delimited text test can be run on qt6 now | Neraportată | [PR \#61900](https://github.com/qgis/QGIS/pull/61900) | N/A |
| Fix mesh layer labeling tests not actually run | Neraportată | [PR \#61899](https://github.com/qgis/QGIS/pull/61899) | [PR \#61909](https://github.com/qgis/QGIS/pull/61909) |
