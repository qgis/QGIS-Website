...
section: proiect
sidebar: true
title: Jurnalul schimbărilor pentru QGIS 3.6
type: visual-changelog

---
{{<content-start >}}
# Jurnalul schimbărilor pentru QGIS 3.6{#changelog36 }
![image1](images/projects/f335c2ee37b714ad6eec143246d947f09a5ff2f1.png)

Data lansării: 2019-02-22
...
### Funcționalitate: Etichetă decorativă pentru titlu
O facilitate, nou adăugată, permite utilizatorilor să adauge rapid un titlu pe canevas. Posibilitățile de decorare constau într-o bară cu fundaluri, culori și opacitate personalizabile.
...
### Funcționalitate: Centrarea elementelor decorative în zona superioară/inferioară
De acum, drepturile de autor și titlurile nou adăugate pe canevas pot fi poziționate central, în partea de sus sau în partea de jos a hărții.

Această funcționalitate a fost dezvoltată de [Mathieu Pellerin](http://imhere-asia.com/)
### Funcționalitate: Corecții și îmbunătățiri aduse instrumentului Vertex
Notă: toate elementele menționate mai jos au fost retroportate în LTR, astfel încât acestea vor fi disponibile și în QGIS 3.4.5.
...
Această funcționalitate a fost finanțată de [German QGIS user group](http://qgis.de/)
...
Această funcționalitate a fost finanțată de [Mairie de Megève](https://www.megeve.fr/)
...
Această facilitate a fost finanțată de Lutra Consulting
...
Această funcționalitate a fost dezvoltată de Nyall Dawson, Mathieu Pellerin
...
Această funcționalitate a fost dezvoltată de Alexis Roy-Lizotte
...
Această facilitate a fost finanțată de Grupul Utilizatorilor Germani de QGIS
...
Această funcționalitate a fost finanțată de [SMEC/SJ](http://www.smec.com/en_au)
...
Această facilitate a fost finanțată de OSGeo UK, GeoServer PSC, Brad Hards

Această funcționalitate a fost dezvoltată de [Luigi Pirelli and GeoSolutions](https://www.geo-solutions.it/)
## Digitizarea
...
Această funcționalitate a fost dezvoltată de [Faneva Andriamiadantsoa](https://github.com/Fanevanjanahary)
...
Această funcționalitate a fost dezvoltată de [Corentin Falcone (SIRS)](https://www.sirs-fr.com/sirs/fr/)
...
Această funcționalitate a fost dezvoltată de konst
...
La exportarea machetelor imprimabile, identifică automat unele greșeli comune, caz în care îi avertizează pe utilizatori:
...
Această facilitate a fost finanțată de Alessandro Pasotti - ItOpen
...
Această funcționalitate a fost dezvoltată de Nyall Dawson, Nathan Woodrow
...
Această funcționalitate a fost finanțată de [Solspec](http://solspec.io)
...
Această funcționalitate a fost finanțată de [Cantonul Zug, Amt für Geoinformation](https://geo.zg.ch/)

Această funcționalitate a fost dezvoltată de David Signer (OPENGIS.ch)
...
Această funcționalitate a fost finanțată de [Veolia](https://www.veolia.com)
...
Această facilitate a fost finanțată de Comunitatea QGIS
...
| --- | --- | --- | --- |
| QGIS Server: WFS issue using the EXP_FILTER parameter | [#20927](https://issues.qgis.org/issues/20927) | [PR #8924](https://github.com/qgis/QGIS/pull/8924) | Îndeplinit |
...
| QGIS Server WFS DescribeFeatureType not following TYPENAME parameter | [#20198](https://issues.qgis.org/issues/20198) | [PR #8948](https://github.com/qgis/QGIS/pull/8948) | Îndeplinit |
| QGIS Server 3.4 can\'t reset numeric field using WFS Update | [#20961](https://issues.qgis.org/issues/20961) | [PR #8958](https://github.com/qgis/QGIS/pull/8958) | Îndeplinit |
| WFS provider shows numeric NULL fields with 0 instead of NULL | [#20961](https://issues.qgis.org/issues/20961) | [PR #8958](https://github.com/qgis/QGIS/pull/8958) | Îndeplinit |
| OWS project title in project properties cannot be set to blank/empty | neraportat | [PR #8958](https://github.com/qgis/QGIS/pull/8958) | Îndeplinit |
| Form Value relation based on WFS layer | [#21077](https://issues.qgis.org/issues/21077) | [PR #8970](https://github.com/qgis/QGIS/pull/8970) | Îndeplinit |
| Button positions in Database styles manager dialog | [#21068](https://issues.qgis.org/issues/21068) | [PR #8971](https://github.com/qgis/QGIS/pull/8971) | Îndeplinit |
...
| Error opening network KML page: Range downloading not supported by this server! | [#21091](https://issues.qgis.org/issues/21091) | [PR #8985](https://github.com/qgis/QGIS/pull/8985) | Îndeplinit |
| Can\'t add a virtual field or update a existing field of a WFS layer using the field calculator | [#21086](https://issues.qgis.org/issues/21086) | [PR #8990](https://github.com/qgis/QGIS/pull/8990) | Îndeplinit |
...
| Delimitedtext layer saves absolute path when project in relative path mode | [#21150](https://issues.qgis.org/issues/21150) | [PR #9099](https://github.com/qgis/QGIS/pull/9099) | Îndeplinit |
| field calculator doesn\'t load values for gpkg containing blank spaces or n dash (hypen) in field names | [#21100](https://issues.qgis.org/issues/21100) | [PR #9071](https://github.com/qgis/QGIS/pull/9071) | Îndeplinit |
...
| Layer Properties \> Load Style \> From database \> \'Other styles \...\' \> Description column contains Name text, should contain Description text (it is a geopackage layer) | [#21254](https://issues.qgis.org/issues/21254) | [PR #9170](https://github.com/qgis/QGIS/pull/9170) | Îndeplinit |
...
| Bug with multiple Else items in rule-based style | [#21281](https://issues.qgis.org/issues/21281) | [PR #9181](https://github.com/qgis/QGIS/pull/9181) | Îndeplinit |
...
| Geometry Checker Crashes | [#21259](https://issues.qgis.org/issues/21259) | [PR #9191](https://github.com/qgis/QGIS/pull/9191) | Îndeplinit |
| QGIS crashes when createInstance() uses wrong constructor in a QgsProcessingAlgorithm subclass | [#21270](https://issues.qgis.org/issues/21270) | [PR #9193](https://github.com/qgis/QGIS/pull/9193) | Îndeplinit |
...
| Puncte în interiorul poligoanelor | [#20798](https://issues.qgis.org/issues/20798) | Cannot reproduce with 3.5 |  |
...
| v.surf.rst NU FUNCȚIONEAZĂ ÎN QGIS 3.2.0 BONN | [#19472](https://issues.qgis.org/issues/19472) | [PR #8959](https://github.com/qgis/QGIS/pull/8959) | [Direct commit](https://github.com/qgis/QGIS/commit/c2465fc4a66425c296ffedb491d220a3db8ba453) |
...
| Add option to control export features without categories in Processing GRASS algorithms | neraportat | [PR #9003](https://github.com/qgis/QGIS/pull/9003) | [PR #9043](https://github.com/qgis/QGIS/pull/9043) |
...
| v.net.report and v.net.nreport algorithms failed | neraportat | [PR #9046](https://github.com/qgis/QGIS/pull/9046) | [PR #9058](https://github.com/qgis/QGIS/pull/9058) |
...
### Funcționalitate: Corecții efectuate de Jürgen Fischer
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.4 backport commit (GitHub) |
| --- | --- | --- | --- |
...
Această funcționalitate a fost dezvoltată de [Jürgen Fischer](https://www.norbit.de/)
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.4 backport commit (GitHub) |
| --- | --- | --- | --- |
| QGis 3.4 reproducible crash while in idle state | [#20581](https://issues.qgis.org/issues/20581) | [PR #8988](https://github.com/qgis/QGIS/pull/8988) și [PR #9019](https://github.com/qgis/QGIS/pull/9019) | [PR #9027](https://github.com/qgis/QGIS/pull/9027) și (https://github.com/qgis/QGIS/commit/9ea7f1efa44c47d4070a1623b18059014e658017) [commit direct] |
...
| QgsExternalResourceWidgetWrapper crashes | [#20140](https://issues.qgis.org/issues/20140) | Duplicat |  |
...
| Adding new features in postgis fails with attribute window popup | [#20523](https://issues.qgis.org/issues/20523) | Funcționează pentru mine |  |
...
| QGIS 3.5 not loading or saving multi-dimensional arrays properly from PostGIS layers | [#20872](https://issues.qgis.org/issues/20872) | [PR #9048](https://github.com/qgis/QGIS/pull/9048) | DE EFECTUAT |
...
| Add the possibility to return a shp if ogr is not compiled with gpkg | neraportat | [PR #9037](https://github.com/qgis/QGIS/pull/9037) |  |
| fix qgsRound for negative numbers | [#20861](https://issues.qgis.org/issues/20861) | [PR #9030](https://github.com/qgis/QGIS/pull/9030) și [PR #9025](https://github.com/qgis/QGIS/pull/9025) |  |
...
### Funcționalitate: Corecții efectuate de Martin Dobias
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.4 backport commit (GitHub) |
| --- | --- | --- | --- |
...
Această funcționalitate a fost finanțată de [QGIS user group Germany](https://www.qgis.de/)

Această funcționalitate a fost dezvoltată de [Martin Dobias](https://www.lutraconsulting.co.uk/)
...
Această funcționalitate a fost dezvoltată de [Nyall Dawson](https://north-road.com/)
### Funcționalitate: Corecții efectuate de Hugo Mercier
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.4 backport commit (GitHub) |
| --- | --- | --- | --- |
| Qgis 3.4.1 crashes when accessing methods of feature | [#20752](https://issues.qgis.org/issues/20752) | închis |  |
...
| Range widget does not honor default value on not null column | [#20831](https://issues.qgis.org/issues/20831) | [PR #9033](https://github.com/qgis/QGIS/pull/9033) și [PR #9033](https://github.com/qgis/QGIS/pull/9033) |  |
...
| QGIS 3.4.1 advanced modification and snap block QGIS | [#20568](https://issues.qgis.org/issues/20568) | închis |  |
...
Această funcționalitate a fost dezvoltată de [Hugo Mercier](https://oslandia.com/)
