...
section: proiect
sidebar: true
title: Jurnalul schimbărilor pentru QGIS 3.26
type: visual-changelog

---
{{<content-start >}}
# Jurnalul schimbărilor pentru QGIS 3.26{#changelog326 }
![image1](images/projects/916ce336f8f5939eb158506ea38290af6f1ce0f0.png)

Data lansării: 2022-06-17
...
| Raster tiles are clipped based on the gpkg_contents bounding box of a GeoPackage | [#45530](https://github.com/qgis/QGIS/issues/45530) | Nu este o eroare |  |
...
| Titlul Erorii | URL Issues (if reported, Github) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| \@project_keywords are no longer tested on Rule based filters | [#48480](https://github.com/qgis/QGIS/issues/48480) | Nu este o eroare |  |
...
| Highlight of identified feature not displaying correctly on \"geometry generator\" marker from different CRS | [#48439](https://github.com/qgis/QGIS/issues/48439) | [PR #48579](https://github.com/qgis/QGIS/pull/48579) | DE EFECTUAT |
| Cannot past copied features as temporary scratch layer | [#48401](https://github.com/qgis/QGIS/issues/48401) | [PR #48611](https://github.com/qgis/QGIS/pull/48611) | DE EFECTUAT |
| QGIS crash by opening a form with relation content | [#48443](https://github.com/qgis/QGIS/issues/48443) | [PR #48616](https://github.com/qgis/QGIS/pull/48616) | DE EFECTUAT |
| Relation reference widget: filter expression does not work with variables | [#48190](https://github.com/qgis/QGIS/issues/48190) | [PR #48619](https://github.com/qgis/QGIS/pull/48619) | DE EFECTUAT |
| Random order of attributes in oracle feature query | [#35309](https://github.com/qgis/QGIS/issues/35309) | [PR #48668](https://github.com/qgis/QGIS/pull/48668) | nu |
...
| Documentation doctest failure | [QGIS developer mail list](https://lists.osgeo.org/pipermail/qgis-developer/2022-May/064720.html) | [QGIS Documentation PR 7581](https://github.com/qgis/QGIS-Documentation/pull/7581) | nu |
| \"Add to group\" option in sub layer window always add at top of layer tree | [#48694](https://github.com/qgis/QGIS/issues/48694) | [PR #48696](https://github.com/qgis/QGIS/pull/48696) | nu |
| Name/id of map objects in GetProjectSettings follows an order that is the inverse of the order used to add the map objects in a layout | [#46143](https://github.com/qgis/QGIS/issues/46143) | [PR #48728](https://github.com/qgis/QGIS/pull/48728) | nu |
| Aborted inserts in Postgis geometryless tables are saved anyway | [#48171](https://github.com/qgis/QGIS/issues/48171) | [PR #48741](https://github.com/qgis/QGIS/pull/48741) | nu |
| Inconsistent coordinate rounding in Raster \"Layer Properties\" | [#48767](https://github.com/qgis/QGIS/issues/48767) | [PR #48790](https://github.com/qgis/QGIS/pull/48790) | DE EFECTUAT |
| Drag and Drop Postgis-Table in QGIS Browser alters name of Geometry-Column | [#48748](https://github.com/qgis/QGIS/issues/48748) | [PR #48796](https://github.com/qgis/QGIS/pull/48796) | nu |
...
| Server GetPrint with multiple maps following map themes apply prefixed LAYERS (map0:LAYERS) to all maps | [PR #48923](https://github.com/qgis/QGIS/pull/48923) | [PR #48923](https://github.com/qgis/QGIS/pull/48923) | DE EFECTUAT |
...
| GDAL Vector to Raster (gdal_rasterize) fail to produce ESRI ASCII as output | [#39140](https://github.com/qgis/QGIS/issues/39140) | Nu este o eroare |  |
...
| test_provider_eptprovider occasionally aborts | [#48778](https://github.com/qgis/QGIS/issues/48778) | [PR #48793](https://github.com/qgis/QGIS/pull/48793) | nu este necesar |
...
| Improve UX for virtual layer creation dialog | neraportat | [PR #49015](https://github.com/qgis/QGIS/pull/49015) | Not appropriate |
...
| Fix clear values for offset along line spin boxes | neraportat | [PR #48872](https://github.com/qgis/QGIS/pull/48872) | [PR #48878](https://github.com/qgis/QGIS/pull/48878) |
...
| Never show the transformation selection dialog for the first layer added to a project | neraportat | [PR #48811](https://github.com/qgis/QGIS/pull/48811) | [PR #48814](https://github.com/qgis/QGIS/pull/48814) |
...
| Fix loss of mesh layer styling when fixing a broken path to a mesh layer | neraportat | [PR #48765](https://github.com/qgis/QGIS/pull/48765) | [PR #48768](https://github.com/qgis/QGIS/pull/48768) |
...
| Add support for map field types to memory provider, avoid data loss in models/processing | neraportat | [PR #48638](https://github.com/qgis/QGIS/pull/48638) | Too intrusive |
...
| Fix many memory leaks | neraportat | [PR #48590](https://github.com/qgis/QGIS/pull/48590) | N/A |
| Fix ctrl modifier scrolling on symbol buttons | neraportat | [PR #48581](https://github.com/qgis/QGIS/pull/48581) | N/A |
