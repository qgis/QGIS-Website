...
section: proiect
sidebar: true
title: Jurnalul schimbărilor pentru QGIS 3.24
type: visual-changelog

---
{{<content-start >}}
# Jurnalul schimbărilor pentru QGIS 3.24{#changelog324 }
![image1](images/projects/dce49bc182a307d8b4d60cfa0ba8caede109cf69.png)

Data lansării: 2022-02-18
...
### Funcționalitate: Preluarea extinderilor hărții direct din compoziții și din repere spațiale
Această facilitate aduce multă economie de timp! Controlul grafic al extinderii din QGIS permite, de acum, preluarea extinderilor hărților direct din compozițiile și reperele spațiale ale proiectului.
...
### Funcționalitate: Personalizarea mai ușoară a sistemelor de referință a coordonatelor 
...
De acum puteți specifica *decalajul în lung de linie*, în procente, atât pentru markere cât și pentru liniile hașurate. (Aceste decalaje sunt calculate ca procente din lungimea totală a liniei).

În plus, atunci când *decalajul în lung de linie*, pentru un marker sau o hașură liniară, depășește dimensiunea unui inel **închis**, QGIS va continua decalarea de-a lungul inelului, cu valoarea care depășește 100%. De exemplu, setarea decalajului la 150% conduce la tratarea decalării la 50% din lungimea inelului închis.

De asemenea, este posibilă specificarea unui *decalaj negativ în lung de linie* pentru un inel închis. Decalajele negative sunt calculate în sens invers, de-a lungul inelului.

![image5](images/entries/78402d91402744c434c0501a4fa078b686f31251.webp)

Această funcționalitate a fost finanțată de [North Road, thanks to SLYR](https://north-road.com)

Această funcționalitate a fost dezvoltată de [Nyall Dawson](https://github.com/nyalldawson)
### Funcționalitate: Posibilitate de poziționare pe primul/ultimul vertex al fiecărei părți dintr-o geometrie cu părți multiple
Această nouă opțiune de simbolizare permite poziționarea Markerelor și Liniilor Hașurate pe Primul și pe Ultimul Vertex al fiecărei părți dintr-o linie (ori poligon) cu părți multiple, sau numai pe primul sau pe ultimul vertex din întreaga geometrie cu părți multiple.
...
Noul mod *Pe Vertecșii Interiori* plasează simbolurile doar pe vertecșii **interiori** (adică toți vertecșii, cu excepția primului sau ultimului).
...
Această funcționalitate a fost dezvoltată de [Nyall Dawson](https://github.com/nyalldawson)
### Funcționalitate: Opțiunile de poziționare în straturile cu markere și hașuri liniare constau, de acum, în casete de selectare, în locul butoanelor cu excludere reciprocă
Această îmbunătățire face considerabil mai ușoară crearea de markere (sau hașuri) liniare atât pe primul cât **și** pe ultimul vârf (printre alte combinații utile!)

Această funcționalitate a fost finanțată de [North Road, thanks to SLYR](https://north-road.com)

Această funcționalitate a fost dezvoltată de [Nyall Dawson](https://github.com/nyalldawson)
### Funcționalitate: Controlarea modelului culorii utilizate la interpolarea rampelor gradienților
La momentul generării rampei unui gradient, unele combinații de culori vor face ca rampa să treacă prin tonuri medii de gri obscure, dacă interpolarea este efectuată folosindu-se în mod independent canalele roșu/verde/albastru. O abordare alternativă este de a interpola culorile prin canalele de nuanță/saturație/luminozitate sau valoare. În acest fel se pot evita tonurile medii desaturate, rezultând gradienți mai plăcuți.
...
Această funcționalitate a fost dezvoltată de [Nyall Dawson](https://github.com/nyalldawson)
### Funcționalitate: Miniaturi redimensionabile în dialogul managerului de stiluri
...
Există opțiuni pentru a controla:
- calea imaginii (inclusiv calea definită de date)
- lățimea liniei
- opacitatea
- stilurile de îmbinare a liniilor
...
Această funcționalitate a fost dezvoltată de [Nyall Dawson](https://github.com/nyalldawson)
### Funcționalitate: Alegerea comportamentului de tăiere pentru umplerile cu modele liniare
De acum se poate controla modul în care sunt tăiate la forma unui poligon, liniile dintr-un simbol de umplere cu model liniar. Opțiunile disponibile sunt:
- **Decupare doar pe durata randării**: se creează linii de acoperire a întregii *casete de încadrare* a entității, care ulterior sunt tăiate în timpul desenării. Extremitățile liniilor (începutul și sfârșitul) nu vor fi vizibile (același comportament din versiunile QGIS anterioare).
- **Decupare linii înainte de randare**: liniile sunt tăiate la *forma exactă* a poligonului înaintea randării. Extremitățile liniei (stilurile capetelor de linie, markerele de la începutul/sfârșitul liniilor etc.) vor fi vizibile și uneori se pot extinde în afara poligonului (în funcție de setările simbolului liniar).
- **Fără tăiere**: nu se efectuează nicio tăiere - liniile vor acoperi întreaga casetă de încadrare a entității
...
Această funcționalitate a fost dezvoltată de [Nyall Dawson](https://github.com/nyalldawson)
### Funcționalitate: Randare îmbunătățită a umplerilor cu modele liniare
De acum, la exportarea într-un format vectorial (cum ar fi PDF sau SVG) sau atunci când un sub-simbol liniar are proprietăți dinamice (definite de date), are loc o abordare de umplere automată, linie-cu-linie. (Anterior, s-a utilizat umplerea cu plăcuțe a modelului, ceea ce a produs adesea artefacte nedorite și cusături vizibile în cadrul modelului).

Unele dintre numeroasele beneficii ale acestei schimbări sunt următoarele:
...
- Pentru post-producție, fișierele PDF/SVG exportate sunt mai ușor de modificat în aplicații externe (cum ar fi Inkscape sau Adobe Illustrator), întrucât fiecare linie individuală a modelului poate fi modificată.
...
- Nu există artefacte vizibile la diverse unghiuri, distanțe sau la folosirea anumitor stiluri de simboluri liniare

Și chiar mai interesant, se deschide ușa unei serii noi de stiluri pentru simboluri, cum ar fi:
- modele linare în care fiecare linie își schimbă culoarea/lățimea/forma/ etc.
- modele liniare cu markere plasate pe punctul central/etc
- efecte în generatorul de geometrie pentru fiecare linie, cum ar fi modele de linii ondulate, stil de linie desenată manual etc
...
Această funcționalitate a fost dezvoltată de [Nyall Dawson](https://github.com/nyalldawson)
### Funcționalitate: Unghiul de rotație pentru umplerile cu modele de puncte
Acum puteți specifica un unghi de rotație opțional pentru umplerile cu modele de puncte, ceea ce face ca orice model să poată fi înclinat. Acest lucru poate fi extrem de util atunci când sunt suprapuse mai multe umpleri cu modele de puncte!
...
Această funcționalitate a fost dezvoltată de [Nyall Dawson](https://github.com/nyalldawson)
### Funcționalitate: Decalaje aleatorii ale punctelor pentru umplerea modelului de puncte
...
Această funcționalitate a fost dezvoltată de [Nyall Dawson](https://github.com/nyalldawson)
### Funcționalitate: Setarea modului de referință a coordonatelor pentru straturile simbolurilor umplute cu modele liniare sau cu modele de puncte
Straturile simbolurilor umplute cu modele liniare și modele de puncte au o nouă setare pentru modul de referință a coordonatelor, care permite ajustarea ancorării modelelor. Practic vorbind, acest lucru permite modelelor să se alinieze armonios între entitățile adiacente și cele suprapuse.
...
Această funcționalitate a fost dezvoltată de [Mathieu Pellerin](https://www.opengis.ch/)
### Funcționalitate: Control asupra decupării modelului de puncte care umple un marker
Această nouă opțiune oferă control asupra modului în care este decupat modelul de puncte care umple markerele. Opțiunile disponibile sunt:
...
- **Centroidul markerului în interiorul formei**: punctele vor fi desenate numai dacă centroidul lor se încadrează în formă, punctele **nefiind** tăiate la limita formei
- **Marker complet inclus în formă**: punvtele vor fi desenate numai dacă se potrivesc complet în formă
- **Fără tăiere**: punctele vor fi desenate dacă **orice** parte a acestora, indiferent cât de mică, intră în cadrul formei
...
Această funcționalitate a fost dezvoltată de [Nyall Dawson](https://github.com/nyalldawson)
### Funcționalitate: Funcții dedicate creării undelor triunghiulare/pătrate/curbe
...
- Unde (similare celor sinusoidale)
- Triunghiulare
- Pătratice

În plus, au fost adăugate și funcții dedicate creării undelor într-o manieră clasică sau cu randomizare.

Atunci când sunt utilizate cu generatoare de geometrie, aceste expresii pot fi folosite pentru unele efecte cartografice foarte avansate!
...
De acum, este permisă stabilirea ca procent din dimensiunea fontului în cazul dimensiunilor pentru zona tampon din jurul textului de text, pentru decalarea umbrei și a razei de estompare. Acest lucru este de dorit pe măsură ce dimensiunea textului este schimbată, deoarece permite crearea unor formate de text în care componentele se scalează aspectuos, în loc să aibă o zonă tampon/umbră cu dimensiuni fixe care trebuie ajustate independent.
...
Această funcționalitate a fost dezvoltată de [Nyall Dawson](https://github.com/nyalldawson)
### Funcționalitate: Poziții definite de date pentru etichete, în funcție de geometriile de tip punct
De acum, poziționarea definită de date a etichetelor se  poate lega de câmpul unei geometrii de tip punct sau printr-o expresie. (Versiunile anterioare de QGIS permiteau poziționarea definită cu ajutorul datelor prin intermediul a două câmpuri numerice x și y separate).

Această modificare permite, de asemenea, utilizarea instrumentului de *Mutare a etichetei*, orice schimbare a poziției etichetei stocându-se într-un atribut, sub formă de geometrie de tip punct.
...
Această funcționalitate a fost dezvoltată de [Damiano Lombardi](http://OPENGIS.ch)
...
Această funcționalitate a fost finanțată de Andrew Fletcher.
...
Această funcționalitate a fost finanțată de [Crowdfunding: Enhancing elevation data and point clouds in QGIS](https://www.lutraconsulting.co.uk/crowdfunding/elevation-pointcloud-enhancements-qgis/)
...
Această funcționalitate a fost dezvoltată de [Nedjima Belgacem (Lutra Consulting)](https://www.lutraconsulting.co.uk/)
...
Această facilitate a fost finanțată prin Programul de Granturi QGIS.org (2021)
...
Această funcționalitate a fost finanțată de [Cantonul Solothurn, Amt für Geoinformation](https://geo.so.ch/)
...
Această funcționalitate a fost dezvoltată de [Alex](https://github.com/roya0045)
## Gestiunea Datelor
...
Această funcționalitate a fost finanțată de [QGIS Model Baker](https://opengisch.github.io/QgisModelBaker)

Această funcționalitate a fost dezvoltată de [Damiano Lombardi, OPENGIS.ch](https://github.com/domi4484)
...
Această funcționalitate a fost dezvoltată de [Tom Kralidis](https://github.com/tomkralidis)
...
Această funcționalitate a fost finanțată de [TEKSI](https://www.teksi.ch/)
...
Această funcționalitate a fost finanțată de the [Research Institute for Nature and Forest](https://www.inbo.be/en), Flemish Govt
...
- Refactor algorithm;
- Algoritm de agregare;
- Add field to attributes table algorithm;
- Field calculator algorithm; and
- Advanced (i.e. python) field calculator algorithm

Această funcționalitate a fost finanțată de [SwissTierras Colombia](https://www.swisstierrascolombia.com/)
...
Această funcționalitate a fost sugerată și codificată în direct de către Giuseppe Baiamonte, în cadrul QGIS Open Day din 17 decembrie 2021.

![image49](images/entries/3b60790eb1b2f970940e9280d3eccee6a6f2b8f9.webp)

Această funcționalitate a fost dezvoltată de [Tim Sutton](https://github.com/timlinux)
...
Această funcționalitate a fost finanțată de Stadt Freiburg im Breisgau
...
Această funcționalitate a fost dezvoltată de [Tom C](https://github.com/Cumminsc9)
...
Această funcționalitate a fost finanțată de [OPENGIS.ch](https://www.opengis.ch)

Această funcționalitate a fost dezvoltată de [Matthias Kuhn, OPENGIS.ch](https://github.com/m-kuhn)
## QGIS Server
...
| --- | --- | --- | --- |
| Wrong raster projection on HIDPI screens | [#46882](https://github.com/qgis/QGIS/issues/46882) | [PR #46931](https://github.com/qgis/QGIS/pull/46931) | DE EFECTUAT |
| Data Source Manager title not translatable | [#46929](https://github.com/qgis/QGIS/issues/46929) | [PR #46932](https://github.com/qgis/QGIS/pull/46932) | DE EFECTUAT |
| QGIS 3.22 - Identical map names in print composer | [#46927](https://github.com/qgis/QGIS/issues/46927) | Funcționează pentru mine |  |
| Bold and italic attributes of labels that reinitialize | [#46896](https://github.com/qgis/QGIS/issues/46896) | Funcționează pentru mine |  |
...
| Virtual layer not loaded correctly after re-opening a project | [#46834](https://github.com/qgis/QGIS/issues/46834) | [PR #46938](https://github.com/qgis/QGIS/pull/46938) | DE EFECTUAT |
| QGIS crashes while calling readLayerXml() | [#46741](https://github.com/qgis/QGIS/issues/46741) | Funcționează pentru mine |  |
| Crash when changing orientation of page in layout | [#46575](https://github.com/qgis/QGIS/issues/46575) | [PR #46972](https://github.com/qgis/QGIS/pull/46972) | DE EFECTUAT |
| \"sort\" funcionality of attributes table sort numeric fields as text | [#34935](https://github.com/qgis/QGIS/issues/34935) | [PR #47035](https://github.com/qgis/QGIS/pull/47035) | DE EFECTUAT |
| OAPIF: api-key not included when requesting /collections endpoint | [#46535](https://github.com/qgis/QGIS/issues/46535) | [PR #47145](https://github.com/qgis/QGIS/pull/47145) | DE EFECTUAT |
| XML notation if missing from tooltips in vector file writer dialog | [#46508](https://github.com/qgis/QGIS/issues/46508) | [PR #47148](https://github.com/qgis/QGIS/pull/47148) | DE EFECTUAT |
| Ignore out of range option in interpolated symbol renderer creates artifacts if start value is out of range | [#46362](https://github.com/qgis/QGIS/issues/46362) | [PR #47174](https://github.com/qgis/QGIS/pull/47174) | DE EFECTUAT |
| start width \> end width is ignored when using the \"exact\" color interpolation method | [#46371](https://github.com/qgis/QGIS/issues/46371) | [PR #47195](https://github.com/qgis/QGIS/pull/47195) | DE EFECTUAT |
| QGIS Layouts: using \"Data defined override\" for HTML Source URL not working | [#34395](https://github.com/qgis/QGIS/issues/34395) | la mine funcționează (închisă - nu este o eroare) |  |
| (Un)force hide form in relation widget | [#47226](https://github.com/qgis/QGIS/issues/47226) | [PR #47245](https://github.com/qgis/QGIS/pull/47245) | DE EFECTUAT |
| Oauth2 authentication protocol does not honors the defined port number in redirect URL in QGIS 3.22.1 | [#46354](https://github.com/qgis/QGIS/issues/46354) | la mine funcționează (rămâne deschisă) |  |
| HTML/String-ish QByteArray as result of expression function breaks expression preview display | [#46174](https://github.com/qgis/QGIS/issues/46174) | [PR #47229](https://github.com/qgis/QGIS/pull/47229) | DE EFECTUAT |
| Raster layer exported to GeoPackage with the character \'ß\' in the name is not immediately loaded in the project | [#45965](https://github.com/qgis/QGIS/issues/45965) | la mine funcționează (închisă) |  |
| Layout Attribute Table sorting does not work in Print Layouts when column name has spaces | [#43744](https://github.com/qgis/QGIS/issues/43744) | [PR #47249](https://github.com/qgis/QGIS/pull/47249) | DE EFECTUAT |
| Incorrect scale range legend after applying logarithmic graduated symbology to a vector layer | [#45454](https://github.com/qgis/QGIS/issues/45454) | [PR #47259](https://github.com/qgis/QGIS/pull/47259) | Riscant? |
| fix server crash | neraportat | [PR #47271](https://github.com/qgis/QGIS/pull/47271) | DE EFECTUAT |
| Load QGIS project from command line from a PostgreSQL project | [#47270](https://github.com/qgis/QGIS/issues/47270) | [PR #47272](https://github.com/qgis/QGIS/pull/47272) | DE EFECTUAT |
...
| Value map widget: \"value\"/\"description\" inconsistency when table added to print layouts | [#41798](https://github.com/qgis/QGIS/issues/41798) | [PR #47300](https://github.com/qgis/QGIS/pull/47300) | DE EFECTUAT |
| Missing entries in attributetable in layout with atlas at page break | [#44086](https://github.com/qgis/QGIS/issues/44086) | [PR #47303](https://github.com/qgis/QGIS/pull/47303) | DE EFECTUAT |
| Server OAPIF: bbox filter isn\'t working if data source CRS is not EPSG:4326/WGS84 | [#47302](https://github.com/qgis/QGIS/issues/47302) | [PR #47318](https://github.com/qgis/QGIS/pull/47318) | DE EFECTUAT |
| Drag & Drop designer control visibility by expression with field IS NOT NULL doesn\'t work if the field is configured with html | [#47363](https://github.com/qgis/QGIS/issues/47363) | [PR #47432](https://github.com/qgis/QGIS/pull/47432) | Riscant? |
...
### Corecții efectuate de Sandro Santilli
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Filter for WFS layer: The \"Tables\" button is missing | [#46887](https://github.com/qgis/QGIS/issues/46887) | Nu este o eroare |  |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| Trying to add GPKG from data source manager crashes QGIS master | [#46463](https://github.com/qgis/QGIS/issues/46463) | [PR #46928](https://github.com/qgis/QGIS/pull/46928) | nerelevant |
...
| Fixes to QgsGeometry::addPart + new test cases | neraportat | [PR #47009](https://github.com/qgis/QGIS/pull/47009) |  |

These bugfixes were funded by [QGIS.ORG (through donations and sustaining memberships)](https://qgis.org/)

Bugs fixed by [Denis Rouzaud](http://www.opengis.ch/)
### Erori remediate de Alex Bruy
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Error opening data loader dialog from MetaSearch | [#40490](https://github.com/qgis/QGIS/issues/40490) | Funcționează pentru mine |  |
...
| Wrong signature of the QgsProcessingParameterMeshDatasetGroups when exporting to Python | neraportat | [PR #47152](https://github.com/qgis/QGIS/pull/47152) | [PR #47156](https://github.com/qgis/QGIS/pull/47156) |
...
| Unable to delete files .shp and .dbf using python code (removeMapLayers, deleteShapeFile) | [#39428](https://github.com/qgis/QGIS/issues/39428) | Funcționează pentru mine |  |
| Opțiunea extinsă QgsProcessingParameterFile | [#45633](https://github.com/qgis/QGIS/issues/45633) | Nu este o eroare |  |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fixes WFS EXP_FILTER parsing in GetFeature request | [mailing list](https://www.mail-archive.com/qgis-user@lists.osgeo.org/msg50029.html) | [PR #47029](https://github.com/qgis/QGIS/pull/47029) | Prea riscant |
| Fix output filename when a raster is saved in a format without extension | neraportat | [PR #46992](https://github.com/qgis/QGIS/pull/46992) | DE EFECTUAT |
| WFS GetFeature document and exceptions | neraportat | [PR #47198](https://github.com/qgis/QGIS/pull/47198) | DE EFECTUAT |
| Exluding a print layout in project propteries -\> server do not avoid that a GetPrint request can be done for that layout | [#46140](https://github.com/qgis/QGIS/issues/46140) | [PR #47199](https://github.com/qgis/QGIS/pull/47199) | DE EFECTUAT |
| Server: Can\'t enable WFS3 API update endpoint (PUT/PATCH) on layers without geometry | [#46119](https://github.com/qgis/QGIS/issues/46119) | Funcționează pentru mine |  |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix HTTP Post with MultiPart | [#46989](https://github.com/qgis/QGIS/issues/46989) | [PR #47006](https://github.com/qgis/QGIS/pull/47006) | nu este necesar |
...
| Fix line anchor placements are reversed for labels which sit below lines | neraportat | [PR #47181](https://github.com/qgis/QGIS/pull/47181) | [PR #47181](https://github.com/qgis/QGIS/pull/47181) |
| Fix incorrect return code from QgsProcessingModelAlgorithm::fromFile when file does not exist | neraportat | [PR #47161](https://github.com/qgis/QGIS/pull/47161) | [PR #47162](https://github.com/qgis/QGIS/pull/47162) |
| Remediere serie de regresii ale georeferențiatorului | multiplu | neraportat | pending |
...
| Don\'t slightly colorise the icons for selected items in lists | [#47065](https://github.com/qgis/QGIS/issues/47065) | [PR #47133](https://github.com/qgis/QGIS/pull/47133) | nu este adecvat |
| Remediere excepție Python, generată după rularea algoritmului pe poziție, care nu necesită parametri | reported on youtube screencast | [PR #47108](https://github.com/qgis/QGIS/pull/47108) | [PR #47130](https://github.com/qgis/QGIS/pull/47130) |
...
| Show descriptive error when label rotation tool cannot be used because of invalid expressions | [#47091](https://github.com/qgis/QGIS/issues/47091) | [PR #47112](https://github.com/qgis/QGIS/pull/47112) | nu este adecvat |
| QgsRasterDataProvider.block() returnează QgsRasterBlock nevalid, dacă dimensiunea blocului solicitat depășește un anumit prag | [#47097](https://github.com/qgis/QGIS/issues/47097) | [PR #47106](https://github.com/qgis/QGIS/pull/47106) | [PR #47129](https://github.com/qgis/QGIS/pull/47129) |
| Fix missing icons for array field types | [#47078](https://github.com/qgis/QGIS/issues/47078) | [PR #47086](https://github.com/qgis/QGIS/pull/47086) | nu este adecvat |
...
| Fix \'Save all Styles/Save current Style\' only appears after close/reopen the layer properties window | [#46596](https://github.com/qgis/QGIS/issues/46596) | [PR #47080](https://github.com/qgis/QGIS/pull/47080) | nu este adecvat |
...
| Fix sqlite errors on startup caused by default style database import logic | neraportat | [PR #47070](https://github.com/qgis/QGIS/pull/47070) | nu este adecvat |
| Fix color widgets incorrectly change colors when mouse is hovered over widget | neraportat | [PR #47069](https://github.com/qgis/QGIS/pull/47069) | [PR #47077](https://github.com/qgis/QGIS/pull/47077) |
| Avoid crs definition errors when closing options dialog | [#47014](https://github.com/qgis/QGIS/issues/47014) | [PR #47061](https://github.com/qgis/QGIS/pull/47061) | nedisponibil |
| Fix duplicate shortcut registered warning on startup | neraportat | [PR #46983](https://github.com/qgis/QGIS/pull/46983) | nu este adecvat |
| Fix scroll wheel events get \"stuck\" when scrolling to bottom of areas | neraportat | [PR #46958](https://github.com/qgis/QGIS/pull/46958) | [PR #46987](https://github.com/qgis/QGIS/pull/46987) |
...
| Fix crashes when saving layer styles | [#46954](https://github.com/qgis/QGIS/issues/46954) | [PR #46955](https://github.com/qgis/QGIS/pull/46955) | nu este adecvat |
| Fix broken merge features tool | neraportat | [PR #46924](https://github.com/qgis/QGIS/pull/46924) | nedisponibil |
...
### Corecții efectuate de Damiano Lombardi
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
