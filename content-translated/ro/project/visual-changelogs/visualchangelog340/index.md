...
Această funcționalitate a fost dezvoltată de [Speedrace4](https://github.com/Speedrace4)
## Simbologie
...
Această funcționalitate a fost finanțată de the [Cantonul Solothurn](https://so.ch/verwaltung/bau-und-justizdepartement/amt-fuer-geoinformation/)

Această funcționalitate a fost dezvoltată de [Dave Signer (OPENGIS.ch)](https://opengis.ch)
...
Această funcționalitate a fost finanțată de the [Swiss QGIS User Group](https://www.qgis.ch/de/)

Această funcționalitate a fost dezvoltată de [Nyall Dawson (North Road)](https://north-road.com)
### Feature: Implement color ramp interpolation for CMYK
Această funcționalitate a fost finanțată de Bordeaux Métropôle
...
Această funcționalitate a fost finanțată de [Middle Third Geological](https://www.linkedin.com/in/deryk-forster-44a415104/?original_referer=https%3A%2F%2Fwww%2Egoogle%2Ecom%2F&originalSubdomain=au)
...
Această funcționalitate a fost finanțată de [QGIS Grant Programme 2024](https://github.com/qgis/PSC/issues/60)
...
Această funcționalitate a fost finanțată de Rubicon Concierge Real Estate
...
Această funcționalitate a fost finanțată de [Landesamt für Vermessung und Geoinformation (LVG) Vorarlberg in collaboration with the QGIS user group Elveția.](https://vorarlberg.at/-/landesamt-fuer-vermessung-und-geoinformation-l-1)
...
Această funcționalitate a fost finanțată de FLYGHT7
...
Această funcționalitate a fost dezvoltată de [Vedran Stojnović](https://github.com/phidrho)
...
Această funcționalitate a fost dezvoltată de [Hannes](https://github.com/kannes)
...
Această funcționalitate a fost finanțată de Bordeaux Metropole
...
Această funcționalitate a fost finanțată de QGIS User Group Denmark
...
Această funcționalitate a fost finanțată de Bordeaux Métrôpole\*\*
...
Această funcționalitate a fost dezvoltată de [Simon](https://github.com/Simon-Lopez)
...
Această funcționalitate a fost finanțată de [NaturalGIS](https://www.naturalgis.pt/)
...
Această funcționalitate a fost finanțată de CEA/DAM, CP4SC, Oslandia
...
| test_provider_ogr.py: do not alter source test data, to keep 'git status' clean | Neraportată | [PR #58734](https://github.com/qgis/QGIS/pull/58734) | N/A |
...
| [BUGFIX] [PostgreSQL] Properly take into account 'name' type | Neraportată | [PR #59147](https://github.com/qgis/QGIS/pull/59147) | DE EFECTUAT |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| QGIS Server filter does not work as expected for intersection filters | [#58220](https://github.com/qgis/QGIS/issues/58220) | Nu se poate reproduce |  |
| [Layout] Missing atlas layer attributes in expression "Fields and Values" group for fixed table item | [#58774](https://github.com/qgis/QGIS/issues/58774) | [PR #58778](https://github.com/qgis/QGIS/pull/58778) | Nu |
| Clearing the default value expression cannot be canceled / undone | [#58767](https://github.com/qgis/QGIS/issues/58767) | [PR #58787](https://github.com/qgis/QGIS/pull/58787) | Nu |
| PostgreSQL authentication gets back to basic if a layer is opened with "execute SQL" from QGIS explorer panel | [#58784](https://github.com/qgis/QGIS/issues/58784) | Nu se poate reproduce |  |
| QGIS Server: fixed width of 200 px of cascaded WMS layer legends | [#57422](https://github.com/qgis/QGIS/issues/57422) | [PR #58790](https://github.com/qgis/QGIS/pull/58790) | Nu |
| Random Points in Polygons behaves unexpectedly | [#58737](https://github.com/qgis/QGIS/issues/58737) | [PR #58815](https://github.com/qgis/QGIS/pull/58815) | Nu |
| When using a computed or virtual field that refers to other layers's fields having the same name, the wrong value is returned | [#49469](https://github.com/qgis/QGIS/issues/49469) | [PR #58819](https://github.com/qgis/QGIS/pull/58819) | DE EFECTUAT |
...
| In layer Filter "lower" function not working with diacritical marks | [#58893](https://github.com/qgis/QGIS/issues/58893) | Nu se poate reproduce |  |
...
| Unwanted unique constraint added when exporting to geopackage, if not null constraint is applied via default style | [#58431](https://github.com/qgis/QGIS/issues/58431) | [PR #58986](https://github.com/qgis/QGIS/pull/58986) | Riscant? |
...
| pyqt5_to_pyqt6.py fails on infinite recursion | [#58659](https://github.com/qgis/QGIS/issues/58659) | [PR #58785](https://github.com/qgis/QGIS/pull/58785) | Nu |
...
| Calling several times waitForFinished on task would cause a deadlock | Neraportată | [PR #58799](https://github.com/qgis/QGIS/pull/58799) | Nu |
...
| Fix unsafe use of QgsProject::instance from vector layer classes | Neraportată | [PR #59118](https://github.com/qgis/QGIS/pull/59118) | Prea riscant |
| When excluding tests, only exclude exact matches | Neraportată | [PR #59116](https://github.com/qgis/QGIS/pull/59116) | N/A |
| When layout scalebar settings are invalid, show warning message | Neraportată | [PR #59088](https://github.com/qgis/QGIS/pull/59088) | N/A |
...
| QgsMapLayer::setDataSource don't require layer name, provider | Neraportată | [PR #58953](https://github.com/qgis/QGIS/pull/58953) | N/A |
| Fix incompatibility between text wrapping and HTML text formatting | Neraportată | [PR #58952](https://github.com/qgis/QGIS/pull/58952) | N/A |
...
| Fix missing canvas variables in some expression editors | Neraportată | [PR #58907](https://github.com/qgis/QGIS/pull/58907) | [PR #58934](https://github.com/qgis/QGIS/pull/58934) |
...
| QgsDistanceArea methods should raise QgsCsException when errors occur | Neraportată | [PR #58795](https://github.com/qgis/QGIS/pull/58795) | N/A |
| Don't apply reset-to-zero step size logic in spin boxes when no special value text is set | Neraportată | [PR #58836](https://github.com/qgis/QGIS/pull/58836) | N/A |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix use of QgsReferencedGeometry in expressions | Neraportată | [PR #59180](https://github.com/qgis/QGIS/pull/59180) |  |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Clipping of long WKT strings for geometry parameters by using our geometry widget | Neraportată | [PR #59209](https://github.com/qgis/QGIS/pull/59209) | N/A |
...
| Bad styling of scrollbars in the plugin manager dialog | Neraportată | [PR #58713](https://github.com/qgis/QGIS/pull/58713) | [PR #58721](https://github.com/qgis/QGIS/pull/58721) |
...
| Bad plugin manager's look on dark themes | Neraportată | [PR #58606](https://github.com/qgis/QGIS/pull/58606) |  |
...
| Fix layout map item preview rendering of XYZ layers with known tile DPI | Neraportată | [PR #58543](https://github.com/qgis/QGIS/pull/58543) | [PR #58566](https://github.com/qgis/QGIS/pull/58566) |

Această funcționalitate a fost finanțată de [QGIS.ORG (through donations and sustaining memberships)](https://qgis.org/)

Această funcționalitate a fost dezvoltată de [Mathieu Pellerin (OPENGIS)](https://www.opengis.ch/)
...
| Fix issue with vertical lines not visible in the elevation profile tool | neraportat | [PR #58959](https://github.com/qgis/QGIS/pull/58959) | N/A |
