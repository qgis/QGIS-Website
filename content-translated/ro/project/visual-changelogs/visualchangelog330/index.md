...
section: proiect
sidebar: true
title: Jurnalul schimbărilor pentru QGIS 3.30
type: visual-changelog

---
{{<content-start >}}
# Jurnalul schimbărilor pentru QGIS 3.30{#changelog330 }
![image1](images/projects/af9e5405a8329d7de8959238a3d499da780c1598.png)

Data lansării: 2023-03-04
...
- Titlul hărții HTML Leaflet
- Autorul hărții HTML Leaflet
- Include OpenStreetMap ca fundal pentru harta HTML Leaflet
...
| Weird interval QgsDoubleSpinbox behavior in graduated symbology with fixed interval | [#51687](https://github.com/qgis/QGIS/issues/51687) | [PR #51714](https://github.com/qgis/QGIS/pull/51714) | Nu |
...
| wms getLegendGraphic call the group and not the layer when many style layers add from browser | [#51759](https://github.com/qgis/QGIS/issues/51759) | [PR #51765](https://github.com/qgis/QGIS/pull/51765) | Nu |
...
| multiedit in attribute table not working properly in version \>=3.22 | [#48077](https://github.com/qgis/QGIS/issues/48077) | [PR #51801](https://github.com/qgis/QGIS/pull/51801) | Riscant? |
...
| Changes on geometry get discarded on save edits when layer filter is enabled (gpkg layer) | [#51934](https://github.com/qgis/QGIS/issues/51934) | Funcționează pentru mine |  |
...
| Crash when switching style to point displacement from geometry generator | [#51070](https://github.com/qgis/QGIS/issues/51070) | [PR #51784](https://github.com/qgis/QGIS/pull/51784) | DE EFECTUAT |
| Fix trust parameter not saved and not read | neraportat | [PR #51854](https://github.com/qgis/QGIS/pull/51854) | DE EFECTUAT |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix using interpolated line symbol layer for polygon outlines | Neraportată | [PR #52030](https://github.com/qgis/QGIS/pull/52030) | [PR #52032](https://github.com/qgis/QGIS/pull/52032) |
...
| Immediately apply color ramp label precision and suffix changes when auto apply is checked | Neraportată | [PR #51989](https://github.com/qgis/QGIS/pull/51989) | Not appropriate |
...
| Don\'t try to download whole COG locally in order to determine open options | Neraportată | [PR #51982](https://github.com/qgis/QGIS/pull/51982) | Not appropriate |
...
| Fix inefficient vector iteration when no rule based rules match current map scale | Neraportată | [PR #51904](https://github.com/qgis/QGIS/pull/51904) | Not appropriate |
| Fix logic for triggering a full model reset in attribute table after changing attributes | Neraportată | [PR #51890](https://github.com/qgis/QGIS/pull/51890) | [PR #51892](https://github.com/qgis/QGIS/pull/51892) |
...
| Show an icon for geometry fields | Neraportată | [PR #51844](https://github.com/qgis/QGIS/pull/51844) | Not appropriate |
| Fix geometry fields incorrectly show as \"range\" types in fields list | Neraportată | [PR #51842](https://github.com/qgis/QGIS/pull/51842) | [PR #51860](https://github.com/qgis/QGIS/pull/51860) |
...
| Re-permit format_number to omit group separators | Neraportată | [PR #51761](https://github.com/qgis/QGIS/pull/51761) | [PR #51763](https://github.com/qgis/QGIS/pull/51763) |
| Remember the collapsed state of the vector layer renderer group box | Neraportată | [PR #51719](https://github.com/qgis/QGIS/pull/51719) | Not appropriate |
...
| Fix crash when showing tooltips for invalid layers | Neraportată | [PR #51703](https://github.com/qgis/QGIS/pull/51703) | [PR #51708](https://github.com/qgis/QGIS/pull/51708) |
| Fix map tips do not show for vector layers where the HTML map tip option isn\'t used | Neraportată | [PR #51702](https://github.com/qgis/QGIS/pull/51702) | Unaffected |
...
| Optimise legend filter by map/expression calculations | [#51233](https://github.com/qgis/QGIS/issues/51233) | [PR #51675](https://github.com/qgis/QGIS/pull/51675) | Prea riscant |
| \[georeferencer\] Fix warning about missing output file name doesn\'t show in all circumstances | Neraportată | [PR #51673](https://github.com/qgis/QGIS/pull/51673) | [PR #51739](https://github.com/qgis/QGIS/pull/51739) |
