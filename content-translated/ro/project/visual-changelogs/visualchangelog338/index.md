...
| QGIS crashes while Export Data from a WFS-Service as DXF-File | [#57139](https://github.com/qgis/QGIS/issues/57139) | Nu se poate reproduce |  |
...
| Cannot connect to SQL Server on QGis 3.34.3 | [#56136](https://github.com/qgis/QGIS/issues/56136) | Nu se poate reproduce |  |
| Balloon annotations fails to adopt text formatting | [#57423](https://github.com/qgis/QGIS/issues/57423) | Nu se poate reproduce |  |
...
| [ux][layouts] Fix legend item style mutex | neraportat | [PR #57605](https://github.com/qgis/QGIS/pull/57605) | N/A |
...
| QGIS Server wrongly positions the map objects in the output when there's more than one map | [#57631](https://github.com/qgis/QGIS/issues/57631) | Nu este o eroare |  |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Source-tree documentation improvements | neraportat | [PR #57594](https://github.com/qgis/QGIS/pull/57594) |  |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Avoid crash on summary when error list is empty | neraportat | [PR #57658](https://github.com/qgis/QGIS/pull/57658) | [PR #57661](https://github.com/qgis/QGIS/pull/57661) |
...
| Qgis crashes while digitising lines | [#57617](https://github.com/qgis/QGIS/issues/57617) | Nu se poate reproduce |  |
...
| Fix some grass vectors incorrectly show as datasets | neraportat | [PR #57780](https://github.com/qgis/QGIS/pull/57780) | [PR #57786](https://github.com/qgis/QGIS/pull/57786) |
...
| Don't try to connect widget to null vector tile layers | neraportat | [PR #57721](https://github.com/qgis/QGIS/pull/57721) | N/A |
| Don't show invalid "Style not found in database" warning when adding vector tile layers | neraportat | [PR #57714](https://github.com/qgis/QGIS/pull/57714) | Not appropriate |
...
| Fix add feature dialog does not restore position when shown modally | neraportat | [PR #57686](https://github.com/qgis/QGIS/pull/57686) | [PR #57700](https://github.com/qgis/QGIS/pull/57700) |
| Fix python script editor "open in external editor" action | neraportat | [PR #57682](https://github.com/qgis/QGIS/pull/57682) | Not appropriate |
| Fix broken prefetch capabilities for raster layers | neraportat | [PR #57663](https://github.com/qgis/QGIS/pull/57663) | [PR #57667](https://github.com/qgis/QGIS/pull/57667) |
| Fix missing field type information in eg the horizontal header tooltips in attribute table | neraportat | [PR #57621](https://github.com/qgis/QGIS/pull/57621) | Not appropriate |
| Don't try to paint to indexed image | neraportat | [PR #57601](https://github.com/qgis/QGIS/pull/57601) |  |
| Clamp values for set_color_part function to avoid qt warnings when out of range values are specified | neraportat | [PR #57600](https://github.com/qgis/QGIS/pull/57600) |  |
| Add some tests for rendering text with RTL markers | [PR #57586](https://github.com/qgis/QGIS/pull/57586) |  |  |
| Fix rotation based orientation when html labeling enabled | neraportat | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Too intrusive |
| Fix data defined font size is ignored when HTML labeling is active | neraportat | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Too intrusive |
| Don't set @value to line height when evaluating multi line alignment | neraportat | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Too intrusive |
...
| Fix incorrect buffers drawn for html label item | neraportat | [PR #57551](https://github.com/qgis/QGIS/pull/57551) | [PR #57571](https://github.com/qgis/QGIS/pull/57571) |
| Fix label mask sizes get reset to 0 | neraportat | [PR #57555](https://github.com/qgis/QGIS/pull/57555) | [PR #57569](https://github.com/qgis/QGIS/pull/57569) |
