...
section: proiect
sidebar: true
title: Jurnalul schimbărilor pentru QGIS 3.8
type: visual-changelog

---
{{<content-start >}}
# Jurnalul schimbărilor pentru QGIS 3.8{#changelog38 }
![image1](images/projects/403e44c7e958cff5d07a1eaf12af76ade88c564d.png)

Data lansării: 2019-06-21

QGIS 3.8 aduce o listă extinsă de noi modificări și o mulțime de îmbunătățiri ale caracteristicilor existente - pe cele mai importante încercând să le expunem aici. Ca întotdeauna, vă reamintim că proiectul QGIS este open source, de aceea, dacă vă permiteți, puteți lua în considerare susținerea activității noastre prin intermediul unor donații, sponsorizări sau contribuții la documentația codului, site-ului web etc.
...
Această funcționalitate a fost dezvoltată de henrik
...
Această funcționalitate a fost dezvoltată de Matteo Nastasi
...
Noi funcții pentru expresii, dezvoltate de Nyall Dawson de la North Road:
...
Noi funcții pentru expresii, dezvoltate de Mathieu Pellerin de la iMHere Asia:
...
Această funcționalitate a fost dezvoltată de Raymond Nijssen
...
Această funcționalitate a fost dezvoltată de Rashad Kanavath
...
### Funcționalitate: Nou parametru pentru prefixul câmpurilor, utilizabil în algoritmii de suprapunere
...
Această funcționalitate a fost dezvoltată de Nyall Dawson (North Road) & Mathieu Pellerin (iMHere Asia)
...
| --- | --- | --- | --- |
| Raster Calculator wrong results | [#21405](https://issues.qgis.org/issues/21405) | remediat în master |  |
| QGIS server ignores custom rendering order when loading parent group | [#21917](https://issues.qgis.org/issues/21917) | [PR #9878](https://github.com/qgis/QGIS/pull/9878) | Îndeplinit |
| WMS Client: GetFeatureInfo in JSON format doesn\'t display numeric attribute values | [#21735](https://issues.qgis.org/issues/21735) | [PR #9879](https://github.com/qgis/QGIS/pull/9879) | Îndeplinit |
| Crash when adding New Field to ShapeLayer | [#22100](https://issues.qgis.org/issues/22100) |  |  |
| Priority in labelling not greyed out when data defined settings are enabled | [#22077](https://issues.qgis.org/issues/22077) | Nevalid |  |
...
| Issue exporting raster layer to Geopackage | [#20848](https://issues.qgis.org/issues/20848) | [PR #10036](https://github.com/qgis/QGIS/pull/10036) | Îndeplinit |
| Create vector New shapefile POLYGON | [#22107](https://issues.qgis.org/issues/22107) | nevalid |  |
...
| Relation reference widget wrong feature when \"on map identification\" | [#22071](https://issues.qgis.org/issues/22071) | [PR #10047](https://github.com/qgis/QGIS/pull/10047) | Îndeplinit |
| DB Manger imports the wrong data | [#22033](https://issues.qgis.org/issues/22033) | [PR #10077](https://github.com/qgis/QGIS/pull/10077) | Îndeplinit |
| qgis crash when filtering a layer with an attachment field | [#21775](https://issues.qgis.org/issues/21775) | Remediat de Nyall |  |
| Raster calculator, abs() not working | [#29824](https://github.com/qgis/QGIS/issues/29824) | [PR #29965](https://github.com/qgis/QGIS/pull/29965) | Îndeplinit |
| Valid file URL link fails in Identify window | [#29879](https://github.com/qgis/QGIS/issues/29879) | [PR #29967](https://github.com/qgis/QGIS/pull/29967) | Îndeplinit |
| QgsProject.instance().clear() crashes QGIS when LayoutDesigner Window is open | [#29821](https://github.com/qgis/QGIS/issues/29821) | [PR #29968](https://github.com/qgis/QGIS/pull/29968) | Îndeplinit |
| QGIS Server WFS DescribeFeatureType advertises double precision virtual fields as integer | [#29767](https://github.com/qgis/QGIS/issues/29767) | [PR #29970](https://github.com/qgis/QGIS/pull/29970) | Îndeplinit |
| QGIS crahses when exporting a template | [#29798](https://github.com/qgis/QGIS/issues/29798) | [PR #29981](https://github.com/qgis/QGIS/pull/29981) | Îndeplinit |
| Export atlas as image fail when expression filename contain dot | [#29980](https://github.com/qgis/QGIS/issues/29980) | [PR #29983](https://github.com/qgis/QGIS/pull/29983) | Îndeplinit |
...
| Map Composer crashes QGIS when copying mixture of elements in page layout | [#29747](https://github.com/qgis/QGIS/issues/29747) | [PR #30017](https://github.com/qgis/QGIS/pull/30017) | DE EFECTUAT |
...
| Browser - \"Project home\" folder shortcut does not appear when a new project is saved | [#29919](https://github.com/qgis/QGIS/issues/29919) | [PR #30025](https://github.com/qgis/QGIS/pull/30025) | DE EFECTUAT |
| Crash when calling QgsRasterHistogram.histogramVector | [#29700](https://github.com/qgis/QGIS/issues/29700) | [PR #30033](https://github.com/qgis/QGIS/pull/30033) | Îndeplinit |
| Do not offer to \"Import settings from Qgis2?\" if no such settings exist | [#30082](https://github.com/qgis/QGIS/issues/30082) | [PR #30092](https://github.com/qgis/QGIS/pull/30092) | Îndeplinit |
| In gpkg, query builder prevents autogenerate of pasted feature with same fid as hidden feature | [#30062](https://github.com/qgis/QGIS/issues/30062) | [PR #30096](https://github.com/qgis/QGIS/pull/30096) | DE EFECTUAT |
| Drag and drop geopackage from filesystem into map misses vector layers, loses names for raster layers | [#30050](https://github.com/qgis/QGIS/issues/30050) | [PR #30098](https://github.com/qgis/QGIS/pull/30098) | Îndeplinit |
| Qgis crashes when try to identify a layer with duplicated fields | [#29937](https://github.com/qgis/QGIS/issues/29937) | [PR #30100](https://github.com/qgis/QGIS/pull/30100) | DE EFECTUAT |
...
| Saving edits to a layer with JSON field throws an error | [#30131](https://github.com/qgis/QGIS/issues/30131) | [PR #30137](https://github.com/qgis/QGIS/pull/30137) | Riscant? |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.4 backport commit (GitHub) |
| --- | --- | --- | --- |
| v.net.distance - node cost column | [#22013](https://issues.qgis.org/issues/22013) | [PR #10060](https://github.com/qgis/QGIS/pull/10060) | Îndeplinit |
| shapefile to raster conversion does not work | [#21922](https://issues.qgis.org/issues/21922) |  |  |
| GRASS r.in.lidar.info, can only choose *.txt not the intended* .las | [#21910](https://issues.qgis.org/issues/21910) | [PR #10061](https://github.com/qgis/QGIS/pull/10061) | Îndeplinit |
| SAGA OpenCV Image Analysis | [#21746](https://issues.qgis.org/issues/21746) |  |  |
| SAGA \"saga split rgb bands\" tool is not inside any (SAGA) group of tools | [#21849](https://issues.qgis.org/issues/21849) | [PR #10062](https://github.com/qgis/QGIS/pull/10062) | Îndeplinit |
| r.sun cannot be executed because it calls on two incompatible options | [#21637](https://issues.qgis.org/issues/21637) | [PR #10074](https://github.com/qgis/QGIS/pull/10074) | Îndeplinit |
| i.segment (GRASS 7.4.2) only produces a Goodness Raster but no Segmented Raster | [#20646](https://issues.qgis.org/issues/20646) | funcționează bine în master și în versiunea 3.4 |  |
| Filtrul majorității (SAGA) returnează rezultate eronate dacă intrarea este .tif | [#22118](https://issues.qgis.org/issues/22118) | nevalid |  |
| Processing batch process interface: no way to go back | [#16893](https://issues.qgis.org/issues/16893) | [PR #10080](https://github.com/qgis/QGIS/pull/10080) | Îndeplinit |
| DB Manager rename PostGIS column error | [#21425](https://issues.qgis.org/issues/21425) | [PR #10082](https://github.com/qgis/QGIS/pull/10082) | nu este necesar |
| Word wrapping not working in maptips | [#21388](https://issues.qgis.org/issues/21388) | [PR #10081](https://github.com/qgis/QGIS/pull/10081) | Îndeplinit |
| Styles stored in QML files with same name as layer no longer auto loaded | [#21691](https://issues.qgis.org/issues/21691) | [PR #14660](https://github.com/qgis/QGIS/pull/14660) | Îndeplinit |
| QGIS 3.4.6 crashed when I tried classifying a layer | [#21693](https://issues.qgis.org/issues/21693) | [PR #29951](https://github.com/qgis/QGIS/pull/29951) | Îndeplinit |
...
| WFS GetFeature fails on TypeNames parameter | [#21768](https://issues.qgis.org/issues/21768) | [PR #29946](https://github.com/qgis/QGIS/pull/29946) | Îndeplinit |
| Cannot load GPX file automatically after creating it QGIS 3.4.7 QGIS 3.6.2 | [#22005](https://issues.qgis.org/issues/22005) | [PR #29947](https://github.com/qgis/QGIS/pull/29947) | Îndeplinit |
| Nu se poate crea spațiul de stocare temporară SpatiaLite | [#29819](https://github.com/qgis/QGIS/issues/29819) | [PR #29949](https://github.com/qgis/QGIS/pull/29949) | Îndeplinit |
| PostGIS closed circle in Curved Polygon is not displayed | [#29895](https://github.com/qgis/QGIS/issues/29895) | [PR #30010](https://github.com/qgis/QGIS/pull/30010) | Îndeplinit |
| Fix GeoJSON output of MultiPolygon/MultiSurface | [PR #30012](https://github.com/qgis/QGIS/pull/30012) | [PR #30012](https://github.com/qgis/QGIS/pull/30012) | Nu este necesar |
| Multipatch features are not shown anymore | [#29376](https://github.com/qgis/QGIS/issues/29376) | [PR #30024](https://github.com/qgis/QGIS/pull/30024) | Îndeplinit |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.4 backport commit (GitHub) |
| --- | --- | --- | --- |
| Editing a GeoPackage feature with spaces in the field names can crash QGIS | [#29630](https://github.com/qgis/QGIS/issues/29630) | [PR #29997](https://github.com/qgis/QGIS/pull/29997) | DE EFECTUAT |
| Crash on update pg layer | [#29814](https://github.com/qgis/QGIS/issues/29814) | duplicat | N/A |
| XMDF file type missing from Madiera 3.4.5 | [#29381](https://github.com/qgis/QGIS/issues/29381) | nevalid | N/A |
...
| Crash when editing fields | [#29200](https://github.com/qgis/QGIS/issues/29200) | Nu se poate replica | N/A |
...
| Crashs when working with auxiliary storage label and data defined | [#30078](https://github.com/qgis/QGIS/issues/30078) | Nu se poate replica |  |
