...
section: proiect
sidebar: true
title: Jurnalul schimbărilor pentru QGIS 3.32
type: visual-changelog

---
{{<content-start >}}
# Jurnalul schimbărilor pentru QGIS 3.32{#changelog332 }
![image1](images/projects/0316fbcb7ba30bcf1caee80daf0662a1a15d99b0.png)

Data lansării: 2023-06-26
...
Această funcționalitate a fost finanțată de [Point cloud processing and 3D data enhancements crowdfunding](https://www.lutraconsulting.co.uk/crowdfunding/pointcloud-processing-qgis/)
...
Această funcționalitate a fost finanțată de ChartWorld International
...
Această funcționalitate a fost finanțată de QTIBIA Engineering și QCooperative.
...
Această funcționalitate a fost finanțată de [Mergin Maps](https://merginmaps.com/)
...
Această funcționalitate a fost finanțată de [camptocamp](https://camptocamp.com)
...
Această funcționalitate a fost dezvoltată de [Luke Pinner](https://github.com/lpinner)
...
Această funcționalitate a fost dezvoltată de [Chris Shucksmith](https://github.com/shuckc)
...
Această funcționalitate a fost finanțată de [Sevenson Environmental Services](https://sevenson.com/)
...
Această funcționalitate a fost finanțată de [KoBold Metals](https://www.koboldmetals.com/)
...
Această funcționalitate a fost finanțată de Oficiul de Stat pentru Topografie și Geoinformații din Feldkirch, Austria
...
Această funcționalitate a fost finanțată de [3liz.com](https://3liz.com)
...
| Titlul Erorii | URL issues (Github, if reported) | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Longer opening time of GPKG file in newer versions | [#53525](https://github.com/qgis/QGIS/issues/53525) | [PR #53566](https://github.com/qgis/QGIS/pull/53566) | DE EFECTUAT |
...
| Qgis Server WMTS returns wrong WGS84BoundingBox for the layer | [#53213](https://github.com/qgis/QGIS/issues/53213) | nu se poate reproduce | Form not showing (randomly) values except when triggering \"Editing Mode\" |
...
| Snap to random vertices after splitting features | [#53040](https://github.com/qgis/QGIS/issues/53040) | nu se poate reproduce | Cartographic label placement with \"Distance Offset: From Symbol Bounds\" shows offset for MultiPoint features |
...
Această funcționalitate a fost dezvoltată de [Alex Bruy (LutraConsulting)](https://www.lutraconsulting.co.uk/)
...
| Options for some values in Processing are not saved after close window | [#53204](https://github.com/qgis/QGIS/issues/53204) | [PR #53458](https://github.com/qgis/QGIS/pull/53458) | nu |
| Unable to import layer from Postgis view or materialized view , if it has no no primary key | [#52943](https://github.com/qgis/QGIS/issues/52943) | Nu este o eroare |  |
...
| Avoid UI lock when closing Execute SQL window | Neraportată | [PR #53448](https://github.com/qgis/QGIS/pull/53448) | Prea riscant |
| Gracefully cleanup empty python faulthandler log files | [#50609](https://github.com/qgis/QGIS/issues/50609) | [PR #53417](https://github.com/qgis/QGIS/pull/53417) | Prea riscant |
| Fix a crash on QGIS close | Neraportată | [PR #53414](https://github.com/qgis/QGIS/pull/53414) | [PR #53418](https://github.com/qgis/QGIS/pull/53418) |
| Correctly cleanup project archive files before attempting to clear/replace archive | [#53034](https://github.com/qgis/QGIS/issues/53034) | [PR #53400](https://github.com/qgis/QGIS/pull/53400) | Prea riscant |
...
| Fix crash when writing processing history entry | Neraportată | [PR #53394](https://github.com/qgis/QGIS/pull/53394) | NA |
...
| Fix point text annotation rotation, alignment issues | Neraportată | [PR #53337](https://github.com/qgis/QGIS/pull/53337) | NA |
| Expand range of z index spin for annotations | Neraportată | [PR #53319](https://github.com/qgis/QGIS/pull/53319) | [PR #53326](https://github.com/qgis/QGIS/pull/53326) |
| Fix incorrect scaling of text background markers in annotations | Neraportată | [PR #53318](https://github.com/qgis/QGIS/pull/53318) | Fix crash on invalid grass layer paths |
| Flag OneDrive remote folders as remote, slow to open paths on Windows | [#51710](https://github.com/qgis/QGIS/issues/51710) | [PR #53315](https://github.com/qgis/QGIS/pull/53315) | Prea riscant |
| Fix crash when creating new grass mapsets when \"set\" is pressed and no region is selected | Neraportată | [PR #53293](https://github.com/qgis/QGIS/pull/53293) | [PR #53311](https://github.com/qgis/QGIS/pull/53311) |
