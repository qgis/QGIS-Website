...
section: proiect
sidebar: true
title: Jurnalul schimbărilor pentru QGIS 3.34
type: visual-changelog

---
{{<content-start >}}
# Jurnalul schimbărilor pentru QGIS 3.34{#changelog334 }
![image0](images/entries/334splash.webp)

Data lansării: 2023-10-29
...
Această funcționalitate a fost dezvoltată de [Martin Dobias](https://github.com/wonder-sk) and [Nyall Dawson](https://github.com/nyalldawson)
...
Această funcționalitate a fost dezvoltată de [Hannes & Nyall Dawson](https://github.com/kannes)
## Simbologie
...
Această funcționalitate a fost finanțată de Summer is getting warmer and warmer.
...
Această funcționalitate a fost dezvoltată de [ASAI Hitoshi](https://github.com/hito-asa)
...
Această funcționalitate a fost finanțată de Comune di Roma
...
Această funcționalitate a fost finanțată de Métropole de Lille
...
| --- | --- | --- | --- |
| QGIS cannot connect to MySQL if user\'s password contains commas. | [#54493](https://github.com/qgis/QGIS/issues/54493) | [PR #54573](https://github.com/qgis/QGIS/pull/54573) | Nu |
...
| 0 port in OAuth2 callback URI | [#54562](https://github.com/qgis/QGIS/issues/54562) | Nu se poate reproduce | N/A |
| QGIS Crashes when editing multiple features simultaneously that have a Value Relation field | [#54164](https://github.com/qgis/QGIS/issues/54164) | [PR #54889](https://github.com/qgis/QGIS/pull/54889) | DE EFECTUAT |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgsgeos.cpp: fix a -Wunused-variable warning | neraportat | [PR #54612](https://github.com/qgis/QGIS/pull/54612) | N/A |
| qgsvirtualpointcloudprovider.cpp: add a missing variable initialization | neraportat | [PR #54613](https://github.com/qgis/QGIS/pull/54613) | N/A |
...
| Syntactical error with the use of == instead of = for comparison in the WHERE clause | [#54608](https://github.com/qgis/QGIS/issues/54608) | Remediat deja | Unable to write any additional layers to an existing FGDB |
...
| Spatial filtering of multipart polygons within a shapefile dataset broken | [GDAL issue 8481](https://github.com/OSGeo/gdal/issues/8481) | Nu este o eroare |  |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix segfault in coordinate transform | neraportat | [PR #54609](https://github.com/qgis/QGIS/pull/54609) | N/A |
...
Această funcționalitate a fost dezvoltată de [Paul Blottiere (Hytech-imaging)](https://hytech-imaging.fr/)
### Feature: Bug fixes by Sandro Santilli (strk)
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Have QgsRectangle null rectangle printed as EMPTY in wkt | neraportat | [PR #54831](https://github.com/qgis/QGIS/pull/54831) | N/A |
| Fix aspect ratio computation in QgsLayoutItemMap::zoomToExtent | neraportat | [PR #54827](https://github.com/qgis/QGIS/pull/54827) | N/A |
| Do not include a BoundingBox tag in GetFeatureInfo responses, when it is null | neraportat | [PR #54858](https://github.com/qgis/QGIS/pull/54858) | N/A |
| Always run the spell and shell checkers if possible, print warning when not possible | neraportat | [PR #54847](https://github.com/qgis/QGIS/pull/54847) | N/A |
| Tweak Null rectangle handling | neraportat | [PR #54872](https://github.com/qgis/QGIS/pull/54872) | N/A |
| Run spellcheck only on changed files in prepare_commit.sh | neraportat | [PR #54893](https://github.com/qgis/QGIS/pull/54893) | N/A |
| Fix prepare_commit.sh | neraportat | [PR #54918](https://github.com/qgis/QGIS/pull/54918) | N/A |
| Fix extent computation in QgsSpatiaLiteProvider | neraportat | [PR #54917](https://github.com/qgis/QGIS/pull/54917) | N/A |
...
| Make QgsBookmark string output more explicit about it being EMPTY | neraportat | [PR #54923](https://github.com/qgis/QGIS/pull/54923) | N/A |
| Fix extent computation in QgsAFSProvider | neraportat | [PR #54944](https://github.com/qgis/QGIS/pull/54944) | N/A |
| Add `tags` make target | neraportat | [PR #54948](https://github.com/qgis/QGIS/pull/54948) | N/A |
| Handle null rectangles in QgsExtentWidget::outputExtent | neraportat | [PR #54953](https://github.com/qgis/QGIS/pull/54953) | N/A |
| Handle null in QgsRectangle grow() and include() methods | neraportat | [PR #54955](https://github.com/qgis/QGIS/pull/54955) | N/A |
| Add QgsRectangle::setNull(), deprecating setMinimal() | neraportat | [PR #54934](https://github.com/qgis/QGIS/pull/54934) | N/A |
| Handle Null rectangle in QgsRectangle::buffered | neraportat | [PR #54967](https://github.com/qgis/QGIS/pull/54967) | N/A |
| Fix extent computation in QgsVirtualLayerProvider | neraportat | [PR #54976](https://github.com/qgis/QGIS/pull/54976) | N/A |
| Add a QgsRectangle::createNull() temporary static method | neraportat | [PR #55008](https://github.com/qgis/QGIS/pull/55008) | N/A |
| Fix testRegisterFeatureUnprojectible - Use valid extent in testRegisterFeatureUnprojectible | neraportat | [PR #55011](https://github.com/qgis/QGIS/pull/55011) | N/A |
| Have QgsGeometry::boundingBox return null rect for null geom | neraportat | [PR #55012](https://github.com/qgis/QGIS/pull/55012) | N/A |
| Have QgsGeometry::fromRect(NULL RECT) return null geometry | neraportat | [PR #54954](https://github.com/qgis/QGIS/pull/54954) | N/A |
...
| Run doxygen layout checker in prepare-commit script, when possible | neraportat | [PR #54936](https://github.com/qgis/QGIS/pull/54936) | N/A |

Această funcționalitate a fost finanțată de [QGIS.ORG (through donations and sustaining memberships)](https://qgis.org/)

Această funcționalitate a fost dezvoltată de [Sandro Santilli (strk)](http://strk.kbt.io/)
### Feature: Bug fixes by Jean Felder (Oslandia)
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgs3daxissettings: Correctly read viewport ratio on a saved project | neraportat | [PR #54870](https://github.com/qgis/QGIS/pull/54870) |  |
...
| Fix layout label adjust size to text logic | neraportat | [PR #54896](https://github.com/qgis/QGIS/pull/54896) | pending |
...
| Fix layout maps force rasterisation of whole layout when map item has transparency set | neraportat | [PR #54882](https://github.com/qgis/QGIS/pull/54882) | Too intrusive |
...
| Fix hang when exporting 3d maps | [#50067](https://github.com/qgis/QGIS/issues/50067) | [PR #54845](https://github.com/qgis/QGIS/pull/54845) | Prea riscant |
| Fix layout labels don\'t immediately react to changes when semi-transparent | neraportat | [PR #54839](https://github.com/qgis/QGIS/pull/54839) | [PR #54863](https://github.com/qgis/QGIS/pull/54863) |
...
| Fix QgsField::ConfigurationFlag::None causes syntax error when starting PyQGIS | neraportat | [PR #54809](https://github.com/qgis/QGIS/pull/54809) | N/A |
...
| Fix crash when certain symbol pages are open in style dock and QGIS is closed or a new project opened | neraportat | [PR #54749](https://github.com/qgis/QGIS/pull/54749) | Too intrusive |
