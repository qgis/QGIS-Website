...
Această funcționalitate a fost dezvoltată de [Martin Dobias](https://github.com/wonder-sk)
...
Această funcționalitate a fost dezvoltată de [David Koňařík](https://github.com/dvdkon)
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| \[OAPIF\] Zooming triggers download of already loaded data | [\#66358](https://github.com/qgis/QGIS/issues/66358) | Nu este o eroare |  |
...
| Gml to Gml- Conversion succeeded, input and output are not the same in QGIS | [\#66413](https://github.com/qgis/QGIS/issues/66413) | Nu este o eroare |  |
...
| Cannot load VT layer from style only from the dialog (works in browser) | neraportat | [PR \#66500](https://github.com/qgis/QGIS/pull/66500) | DE EFECTUAT |
| "fix" every entry in relation reference widget is shown in italic | neraportat | [PR \#66649](https://github.com/qgis/QGIS/pull/66649) |  |
...
| No timeout for vsicurl layers when loading a project | [\#66496](https://github.com/qgis/QGIS/issues/66496) | Nu se poate reproduce |  |
...
| Data-defined override expression on a field is not evaluated until any field in the form is edited | [\#66504](https://github.com/qgis/QGIS/issues/66504) | Nu se poate reproduce |  |
...
| Edit layer properties of an invalid layer (broken source) is not working | [\#66324](https://github.com/qgis/QGIS/issues/66324) | [PR \#66607](https://github.com/qgis/QGIS/pull/66607) | Nerecomandat |
| Qgis have problem to render GeometryCollection for Gml, other viewer like mygeodata website render ok | [\#66225](https://github.com/qgis/QGIS/issues/66225) | Duplicat |  |
...
| QGIS Server: GetProjectSettings returns the error message "Layer(s) not valid" with two WMS layers | [\#65872](https://github.com/qgis/QGIS/issues/65872) | Nu se poate reproduce |  |
| raster histogram not working for raster with scale factor | [\#65920](https://github.com/qgis/QGIS/issues/65920) | [PR \#66640](https://github.com/qgis/QGIS/pull/66640) | DE EFECTUAT |
| Advanced Digitizing Floater is not wide enough to show whole value | [\#65171](https://github.com/qgis/QGIS/issues/65171) | [PR \#66663](https://github.com/qgis/QGIS/pull/66663) | DE EFECTUAT |
...
| Layout bleeding to edge outside map window | [\#49638](https://github.com/qgis/QGIS/issues/49638) | Fixat |  |
| Fix flaky test_gui_fileuploader | Neraportată | [PR \#66543](https://github.com/qgis/QGIS/pull/66543) |  |
| Hidden actions from user defined toolbar are still visible. | Neraportată | [PR \#66620](https://github.com/qgis/QGIS/pull/66620) |  |
| QGIS should never poll a PostGIS/WMS/WFS/etc connections unless specifically asked to | [\#58303](https://github.com/qgis/QGIS/issues/58303) | [PR \#66621](https://github.com/qgis/QGIS/pull/66621) | DE EFECTUAT |
| Password is not removed when it's at the the end of uri | Neraportată | [PR \#66625](https://github.com/qgis/QGIS/pull/66625) | DE EFECTUAT |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
| Allow QGIS to access curves from OGC API provider | Neraportată | [PR \#66452](https://github.com/qgis/QGIS/pull/66452) | N/A |
...
| QGIS hangs when opening raster calculator (Meu Qgis está travando ao tentar abrir a calculadora raster) | [\#66327](https://github.com/qgis/QGIS/issues/66327) | Nu se poate reproduce |  |
| Ensure consistency in MultiCurves: don't allow NurbsCurves | Neraportată | [PR \#66676](https://github.com/qgis/QGIS/pull/66676) | N/A |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix field displayString on primitive JSON values | Neraportată | [PR \#66575](https://github.com/qgis/QGIS/pull/66575) | N/A |
...
| Crash when clicking on an unavailable layer in Layers panel | [\#65913](https://github.com/qgis/QGIS/issues/65913) | [PR \#66578](https://github.com/qgis/QGIS/pull/66578) | DE EFECTUAT |
| QGIS server OGC API: Limits and offset parameters ignored when plugin changing parameters | [\#65858](https://github.com/qgis/QGIS/issues/65858) | Fixat | [PR \#66480](https://github.com/qgis/QGIS/pull/66480) |
...
| concat() returns NULL when all arguments are NULL: it should return an empty string | [\#65808](https://github.com/qgis/QGIS/issues/65808) | [PR \#66618](https://github.com/qgis/QGIS/pull/66618) | DE EFECTUAT |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
| Deleted last series still visible in chart | [\#63466](https://github.com/qgis/QGIS/issues/63466) | Nu se poate reproduce |  |
...
| DB Manager | [\#59470](https://github.com/qgis/QGIS/issues/59470) | Nu se poate reproduce |  |
...
| TestQgsProcessingAlgsPt2::exportMeshOnGrid() | [\#48605](https://github.com/qgis/QGIS/issues/48605) | Nu se poate reproduce |  |
| TestQgsProcessingAlgs::convertGpsData() fails | [\#45588](https://github.com/qgis/QGIS/issues/45588) | Cannot reproduce/Not a bug |  |
| gdal:merge parameter OPTIONS not shown with execAlgorithmDialog | [\#66396](https://github.com/qgis/QGIS/issues/66396) | Nu este o eroare |  |
| projects/anonymize_saved_projects doesn't seem to be available in the new settings tree | [\#65844](https://github.com/qgis/QGIS/issues/65844) | Nu este o eroare |  |
| bug for .Shp namefile | [\#62655](https://github.com/qgis/QGIS/issues/62655) | Nu este o eroare |  |
| Build virtual point cloud (VPC): dialog adds .las extension for output | [\#61934](https://github.com/qgis/QGIS/issues/61934) | Nu se poate reproduce |  |
...
| QGIS wants to open all .json files, including ones unrelated to any geodata | [\#61215](https://github.com/qgis/QGIS/issues/61215) | Nu se poate reproduce |  |
...
| QLR files not associated with QGIS | [\#56844](https://github.com/qgis/QGIS/issues/56844) | Nu se poate reproduce |  |
| TestQgsDatumTransformDialog fails | [\#48883](https://github.com/qgis/QGIS/issues/48883) | Nu se poate reproduce |  |
| TestProcessingGui::testDatabaseSchemaWrapper() Caught unhandled exception | [\#48885](https://github.com/qgis/QGIS/issues/48885) | Nu se poate reproduce |  |
...
| Raster Tools - Generate XYZ Tiles (Directory) always creates 0 tiles | [\#60069](https://github.com/qgis/QGIS/issues/60069) | Nu este o eroare |  |
...
| Titlul Erorii | URL issues.qgis.org (dacă a fost raportată) | URL Commit (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix deadlock when rendering annotation layers | Neraportată | [PR \#66712](https://github.com/qgis/QGIS/pull/66712) | [PR \#66742](https://github.com/qgis/QGIS/pull/66742) |
| Fix crashes in QgsFeatureListComboBox if layer is unloaded | Neraportată | [PR \#66697](https://github.com/qgis/QGIS/pull/66697) | [PR \#66708](https://github.com/qgis/QGIS/pull/66708) |
| Every entry in relation reference widget is shown in italic | Neraportată | [PR \#66649](https://github.com/qgis/QGIS/pull/66649) | Not appropriate |
| Fix buggy processing relief colors widget | Neraportată | [PR \#66602](https://github.com/qgis/QGIS/pull/66602) | Not appropriate |
| Fix QgsImageCache lossy conversion of images | Neraportată | [PR \#66585](https://github.com/qgis/QGIS/pull/66585) | Not appropriate |
...
| Fix intermittent failure of GRASS raster tests | Neraportată | [PR \#66546](https://github.com/qgis/QGIS/pull/66546) | N/A |
...
| Use correct lossless method to store metal rough colors | Neraportată | [PR \#66521](https://github.com/qgis/QGIS/pull/66521) | N/A |
| Ensure color picker opens inline for 3d settings in style dock | Neraportată | [PR \#66520](https://github.com/qgis/QGIS/pull/66520) | Not appropriate |
| Fix misalignment of spin boxes in color dialog | Neraportată | [PR \#66498](https://github.com/qgis/QGIS/pull/66498) | Not appropriate |
| Use unlit material instead of phong material when more appropriate | Neraportată | [PR \#66490](https://github.com/qgis/QGIS/pull/66490) | Not appropriate |
...
| Partially fix slow expression builder widget construction times | Neraportată | [PR \#66385](https://github.com/qgis/QGIS/pull/66385) | Not appropriate |
...
| WMS Ensure we store deduced CRS in provider/layer sources | Neraportată | [PR \#66379](https://github.com/qgis/QGIS/pull/66379) | Not appropriate |
...
| Fix model is zoomed right out when opening model designer | Neraportată | [PR \#66335](https://github.com/qgis/QGIS/pull/66335) | QGIS 4 only |
