...
![Picture of a male tiger that was captured in one of the camera traps](./images/india_assam2.png){.align-right}
...
![Block wise distribution of camera trap locations and assigning camera traps to different forest camps by using voronoi polygons & hub distance.](./images/india_assam3.png)
...
![Survey grids with tiger presence](./images/india_assam4.png){.align-right}
## Concluzii
...
## Autor
![Rajendra Garawad](./images/india_assamaut.png){.align-left height="200px"}
