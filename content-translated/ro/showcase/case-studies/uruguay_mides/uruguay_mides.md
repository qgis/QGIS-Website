...
![QGIS at work: identifying houses on informal settlements to implement fieldwork](./images/uruguay_mides1.png){.align-center}
...
![QGIS at work: Montevideo, Uruguay's capital and most populated city, overlayed with PostGIS layer showing to-do visits (mostly composed of socially vulnerable households, in the outskirts of the city)](./images/uruguay_mides2.png){.align-center}
