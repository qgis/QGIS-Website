...
| fix server crash | ei-raportoitu | [PR #47271](https://github.com/qgis/QGIS/pull/47271) | TODO |
...
| Fixes to QgsGeometry::addPart + new test cases | ei-raportoitu | [PR #47009](https://github.com/qgis/QGIS/pull/47009) |  |
...
| Wrong signature of the QgsProcessingParameterMeshDatasetGroups when exporting to Python | ei-raportoitu | [PR #47152](https://github.com/qgis/QGIS/pull/47152) | [PR #47156](https://github.com/qgis/QGIS/pull/47156) |
...
| Fix output filename when a raster is saved in a format without extension | ei-raportoitu | [PR #46992](https://github.com/qgis/QGIS/pull/46992) | TODO |
| WFS GetFeature document and exceptions | ei-raportoitu | [PR #47198](https://github.com/qgis/QGIS/pull/47198) | TODO |
...
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| Add .tsv extension to delimited text supported files filter | reported on youtube screencast | [PR #47181](https://github.com/qgis/QGIS/pull/47181) | odottaa |
| Fix line anchor placements are reversed for labels which sit below lines | ei-raportoitu | [PR #47181](https://github.com/qgis/QGIS/pull/47181) | [PR #47181](https://github.com/qgis/QGIS/pull/47181) |
| Fix incorrect return code from QgsProcessingModelAlgorithm::fromFile when file does not exist | ei-raportoitu | [PR #47161](https://github.com/qgis/QGIS/pull/47161) | [PR #47162](https://github.com/qgis/QGIS/pull/47162) |
| Fix many georeferencer regressions | multiple | ei-raportoitu | odottaa |
...
| Fix sqlite errors on startup caused by default style database import logic | ei-raportoitu | [PR #47070](https://github.com/qgis/QGIS/pull/47070) | not suitable |
| Fix color widgets incorrectly change colors when mouse is hovered over widget | ei-raportoitu | [PR #47069](https://github.com/qgis/QGIS/pull/47069) | [PR #47077](https://github.com/qgis/QGIS/pull/47077) |
...
| Fix duplicate shortcut registered warning on startup | ei-raportoitu | [PR #46983](https://github.com/qgis/QGIS/pull/46983) | not suitable |
| Fix scroll wheel events get \"stuck\" when scrolling to bottom of areas | ei-raportoitu | [PR #46958](https://github.com/qgis/QGIS/pull/46958) | [PR #46987](https://github.com/qgis/QGIS/pull/46987) |
...
| Fix broken merge features tool | ei-raportoitu | [PR #46924](https://github.com/qgis/QGIS/pull/46924) | n/a |
