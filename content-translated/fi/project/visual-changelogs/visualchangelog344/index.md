...
| duplicated objectName in the oracle dialog | ei-raportoitu | [PR \#61944](https://github.com/qgis/QGIS/pull/61944) | N/A |
...
| Fix reshaping when snapping to segment | ei-raportoitu | [PR \#62315](https://github.com/qgis/QGIS/pull/62315) |  |
| Unhandled GEOS exception when reshaping | ei-raportoitu | [PR \#62322](https://github.com/qgis/QGIS/pull/62322) |  |
| Reshape returns Success instead of NothingHappened | ei-raportoitu | [PR \#62323](https://github.com/qgis/QGIS/pull/62323) | [PR \#62336](https://github.com/qgis/QGIS/pull/62336) |
| Reshape tool tries to run with a single digitized point | ei-raportoitu | [PR \#62324](https://github.com/qgis/QGIS/pull/62324) |  |
| Fix crash when undoing first digitized point in shape map tools | ei-raportoitu | [PR \#62335](https://github.com/qgis/QGIS/pull/62335) |  |
| Fix crashing shape tools when not enough points digitized | ei-raportoitu | [PR \#62338](https://github.com/qgis/QGIS/pull/62338) |  |
...
| When saving SLD to DB, make sure errors are reported to callers (like Package layers algorithm) | ei-raportoitu | [PR \#62332](https://github.com/qgis/QGIS/pull/62332) |  |
...
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| QGIS fails to import sprites from OpenStreetMap vector tile styles | ei-raportoitu | [PR \#62175](https://github.com/qgis/QGIS/pull/62175) |  |
...
| QGIS fails to handle of source containing a relative path to the root of the server hosting the style json | ei-raportoitu | [PR \#62062](https://github.com/qgis/QGIS/pull/62062) | [PR \#62084](https://github.com/qgis/QGIS/pull/62084) |
...
| Various new connection dialog spacing and size issues | ei-raportoitu | [PR \#62041](https://github.com/qgis/QGIS/pull/62041) |  |
