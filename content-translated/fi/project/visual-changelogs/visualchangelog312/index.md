...
section: projekti
sidebar: true
title: QGIS 3.12 muutosloki
type: visual-changelog

---
{{<content-start >}}
# QGIS 3.12 muutosloki{#changelog312 }
...
| unreported: wrong link in server WFS3 items page (too many slashes) | ei-raportoitu | [PR #33926](https://github.com/qgis/QGIS/pull/33926) | risky |
...
| Snapping not possible in new project with new layer | [#32969](https://github.com/qgis/QGIS/issues/32969) | Kopioi | - |
...
| Rubberband not working correctly with \"Shapes\" digtizing in rotated map window | [#33287](https://github.com/qgis/QGIS/issues/33287) | Kopioi |  |
...
| Fix identify menu when an expression is used as display name | ei-raportoitu | [PR #34361](https://github.com/qgis/QGIS/pull/34361) | [PR #34402](https://github.com/qgis/QGIS/pull/34402) |
...
| BUG: fix invalid layer result when Oracle version is under 12 | ei-raportoitu | [PR #34546](https://github.com/qgis/QGIS/pull/34546) |  |
