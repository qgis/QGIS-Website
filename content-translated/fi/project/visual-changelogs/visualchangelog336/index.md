...
| SHP: Fix unreported issue with spatialindex | ei-raportoitu | [PR #56366](https://github.com/qgis/QGIS/pull/56366) | [PR #56399](https://github.com/qgis/QGIS/pull/56399) |
...
| [PostgreSQL provider] Add missing namespace escaping in SQL requests | ei-raportoitu | [PR #56173](https://github.com/qgis/QGIS/pull/56173) | [PR #56186](https://github.com/qgis/QGIS/pull/56186) |
...
| Catch potential QgsCsException at various places; improve qgscoordinatetransform.h doc | ei-raportoitu | [PR #56212](https://github.com/qgis/QGIS/pull/56212) | [PR #56244](https://github.com/qgis/QGIS/pull/56244) |
...
| Boolean discrepancy between expression editor and layer property | [#55923](https://github.com/qgis/QGIS/issues/55923) | [PR #56369](https://github.com/qgis/QGIS/pull/56369) | Ei |
...
| Remove expression evaluation in layout legend widget | [#53442](https://github.com/qgis/QGIS/issues/53442) | [PR #56372](https://github.com/qgis/QGIS/pull/56372) | Ei |
...
| TIN: Enable fromWkb/fromWkt | ei-raportoitu | [PR #56071](https://github.com/qgis/QGIS/pull/56071) | ei |
| [OGC] Polygon: fix rings order | ei-raportoitu | [PR #55306](https://github.com/qgis/QGIS/pull/55306) | ei |
...
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| [3D] disable altitude binding if altitude clamping is absolute | ei-raportoitu | [PR #56154](https://github.com/qgis/QGIS/pull/56154) | [PR #56198](https://github.com/qgis/QGIS/pull/56198) |
...
| Fix GUI freezing when changing raster renderer | ei-raportoitu | [PR #56000](https://github.com/qgis/QGIS/pull/56000) | [PR #56077](https://github.com/qgis/QGIS/pull/56077) |
...
| Allow deleting geometry part of singlepart features | ei-raportoitu | [PR #56279](https://github.com/qgis/QGIS/pull/56279) |  |
...
| Ensure that saving map [canvas] as image/PDF takes high DPI scaling factor into account | ei-raportoitu | [PR #56400](https://github.com/qgis/QGIS/pull/56400) |  |
| MBTiles layers are valid when dataset is missing | ei-raportoitu | [PR #56296](https://github.com/qgis/QGIS/pull/56296) | [PR #56298](https://github.com/qgis/QGIS/pull/56298) |
...
| DXF map theme style override not respected | ei-raportoitu | [PR #56162](https://github.com/qgis/QGIS/pull/56162) | [PR #56164](https://github.com/qgis/QGIS/pull/56164) |
...
| Pixelated QGIS logo in user profile selector dialog on high DPI screens | ei-raportoitu | [PR #56053](https://github.com/qgis/QGIS/pull/56053) | [PR #56065](https://github.com/qgis/QGIS/pull/56065) |
| Pixelated overview panel rendering on high DPI screens | ei-raportoitu | [PR #56050](https://github.com/qgis/QGIS/pull/56050) | [PR #56087](https://github.com/qgis/QGIS/pull/56087) |
| Welcome screen issues on high DPI screens | ei-raportoitu | [PR #56048](https://github.com/qgis/QGIS/pull/56048) | [PR #56084](https://github.com/qgis/QGIS/pull/56084) |
...
| Missing checkbox partially checked state styling for non-default themes | ei-raportoitu | [PR #56290](https://github.com/qgis/QGIS/pull/56290) | [PR #56306](https://github.com/qgis/QGIS/pull/56306) |
...
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix broken coordinate transforms on qt6 builds | ei-raportoitu | [PR #55914](https://github.com/qgis/QGIS/pull/55914) | [PR #55935](https://github.com/qgis/QGIS/pull/55935) |
| Fix crash in QgsRasterPipe when removing roles | ei-raportoitu | [PR #55955](https://github.com/qgis/QGIS/pull/55955) | [PR #56008](https://github.com/qgis/QGIS/pull/56008) |
| Fix broken data defined override buttons in text format widget when no layer is associated | ei-raportoitu | [PR #55989](https://github.com/qgis/QGIS/pull/55989) | N/A |
| Avoid use of pygments in metasearch | ei-raportoitu | [PR #56160](https://github.com/qgis/QGIS/pull/56160) | N/A |
| Fixes filters applied to a duplicated AFS layer also incorrectly apply to the original layer | ei-raportoitu | [PR #56195](https://github.com/qgis/QGIS/pull/56195) | [PR #56221](https://github.com/qgis/QGIS/pull/56221) |
| [processing] Don't try to interpret distance widget value as CRS | ei-raportoitu | [PR #56292](https://github.com/qgis/QGIS/pull/56292) | [PR #56297](https://github.com/qgis/QGIS/pull/56297) |
...
| Fix calculation of string stats when nulls are present | ei-raportoitu | [PR #56305](https://github.com/qgis/QGIS/pull/56305) | [PR #56322](https://github.com/qgis/QGIS/pull/56322) |
| Don't use (broken) QgsCoordinateReferenceSystem::createFromSrsId method for virtual point clouds | ei-raportoitu | [PR #56325](https://github.com/qgis/QGIS/pull/56325) | [PR #56333](https://github.com/qgis/QGIS/pull/56333) |
| Make datetime stats range type consistent across Qt versions | ei-raportoitu | [PR #56355](https://github.com/qgis/QGIS/pull/56355) | [PR #56437](https://github.com/qgis/QGIS/pull/56437) |
| Fix crash in QgsStringUtils::truncateMiddleOfString on qt 6 | ei-raportoitu | [PR #56356](https://github.com/qgis/QGIS/pull/56356) | N/A |
| Fix handling of font family from HTML on Qt 6 builds | ei-raportoitu | [PR #56358](https://github.com/qgis/QGIS/pull/56358) | [PR #56436](https://github.com/qgis/QGIS/pull/56436) |
...
| Fix crash when applying vector properties dialog | ei-raportoitu | [PR #56412](https://github.com/qgis/QGIS/pull/56412) | N/A |
| Don't force calculate layer extents when saving layers | ei-raportoitu | [PR #56433](https://github.com/qgis/QGIS/pull/56433) | [PR #56444](https://github.com/qgis/QGIS/pull/56444) |
| Don't force full calculation of layer extent when cloning layers | ei-raportoitu | [PR #56434](https://github.com/qgis/QGIS/pull/56434) | N/A |
...
| Fix a deadlock in remote COPC handling (3D views) | ei-raportoitu | [PR #56388](https://github.com/qgis/QGIS/pull/56388) | [PR #56419](https://github.com/qgis/QGIS/pull/56419) |
| Fix a crash in point cloud renderer when cleaning up preview painter | ei-raportoitu | [PR #56409](https://github.com/qgis/QGIS/pull/56409) | N/A |
| Fix a deadlock with local COPC files in 2D rendering | ei-raportoitu | [PR #56432](https://github.com/qgis/QGIS/pull/56432) | [PR #56458](https://github.com/qgis/QGIS/pull/56458) |
