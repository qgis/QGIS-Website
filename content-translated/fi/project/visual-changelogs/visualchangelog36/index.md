...
section: projekti
sidebar: true
title: QGIS 3.6 muutosloki
type: visual-changelog

---
{{<content-start >}}
# QGIS 3.6 muutosloki{#changelog36 }
...
| OWS project title in project properties cannot be set to blank/empty | ei-raportoitu | [PR #8958](https://github.com/qgis/QGIS/pull/8958) | Valmis |
...
| Pisteet polygonin sisällä | [#20798](https://issues.qgis.org/issues/20798) | Cannot reproduce with 3.5 |  |
...
| Add option to control export features without categories in Processing GRASS algorithms | ei-raportoitu | [PR #9003](https://github.com/qgis/QGIS/pull/9003) | [PR #9043](https://github.com/qgis/QGIS/pull/9043) |
...
| v.net.report and v.net.nreport algorithms failed | ei-raportoitu | [PR #9046](https://github.com/qgis/QGIS/pull/9046) | [PR #9058](https://github.com/qgis/QGIS/pull/9058) |
...
| QgsExternalResourceWidgetWrapper crashes | [#20140](https://issues.qgis.org/issues/20140) | Kopioi |  |
...
| Add the possibility to return a shp if ogr is not compiled with gpkg | ei-raportoitu | [PR #9037](https://github.com/qgis/QGIS/pull/9037) |  |
