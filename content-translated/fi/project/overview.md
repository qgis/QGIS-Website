...
### QGIS-palvelin
Julkaise QGIS projektisi ja sen sisältö OGC yhteensopivissa WMS, WMTS, WFS ja WCS rajapintapalveluina. Voit kontrolloida mitkä tasot, ominaisuustiedot, taitot ja koordinaattijärjestelmät julkaistaan. QGIS Server on WMS 1.3 -rajapintapalvelun referenssitoteutus.
...
{{<rich-content-start themeClass="coloring-6" >}}
### QGIS-työasema
Luo, muokkaa, visualisoi, analysoi ja julkaise geospatiaalista tietoa.
