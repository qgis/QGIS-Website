...
- mieluiten kuvaava otsikko sähköpostiisi
- mitä QGIS versiota käytät parhaillaan (tarkka)
...
- if your question is about something broken, you may also provide:
  ...
  - mikä käyttöjärjestelmä ja versio
  - kuinka asensit sen (osgeow4? itsenäinen asentaja? oma käännös?)
...
### Voinko avata ECW tiedostot käyttäen QGIS:ä?
