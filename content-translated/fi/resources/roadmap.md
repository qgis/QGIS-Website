...
Joka kolmas lukistus (alkaen versiosta 2.8) on pitkäaikais-julkistus (LTR) jota ylläpidetään seuraavaan pitkäaikais-julkistukseen.
## Kehitysvaihe
...
| Abbreviation | Kuvaus |
| --- | --- |
| LTR | Pitkäaikaisjulkistus, uuden kehitysvaiheen alku |
| LR | Normaali julkistus, uuden kehitysvaiheen alku |
| FF | Ominaisuuksien jäädytys, kehitysvaiheen loppu |
...
## Esijulkaisujen / yöllisten versioiden sijainti{#qgis-prereleases }
| Ympäristö | Sijainti |
| --- | --- |
