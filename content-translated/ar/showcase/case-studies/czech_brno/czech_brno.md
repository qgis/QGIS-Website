...
---
# QGIS كبرمجيات نظم المعلومات الجغرافية الرئيسية في المختبر على الجغرافيا التجريبية والتطبيقية
## المقدمة
مختبر في الجغرافيا التجريبية والتطبيقية (LEAG) هو جزء من كلية إدارة الفنادق والأعمال التجارية المحدودة في برنو ، الجمهورية التشيكية (Vysoká škola obchodní a hotelová، s.r.o.) التي تقدم التعليم العالي في إدارة السياحة والأعمال وإدارة الفنادق. وتركز LEAG على نمذجة العمليات المكانية الاجتماعية والاقتصادية ، وتحليل الأنماط المكانية ، ووصف ورصد واقع المناطق والمناطق.
...
- واجهة المستخدم الرسومية (بالقرب من المنتجات التجارية)
- التطوير السريع ودمج الميزات التي يريدها المستخدم
- الاستقرار وقابلية التشغيل البيني (نحن نستخدم نظامي التشغيل Windows و Ubuntu Linux)
- الآخرين (المذكورة على سبيل المثال في دراسة الحالة التي كتبها الدكتور هورست Düster)

ويتم التحليل المكاني بشكل رئيسي باستخدام وظائف المعالجة الأساسية الأساسية والمكوّنات الإضافية المعتمدة على بايثون. المشاريع الأخيرة التي استخدمت فيها QGIS:
- أنماط النمذجة بين الموقع المكاني والسكان
- Creating 3D models for terrain visualization (and further use as hill-shadowing)
- تخزين وإنشاء وتحرير قاعدة بيانات الشركات الصغيرة والمتوسطة (+ مزيد من التصور)
...
يستخدم QGIS مع التآزر لمنتجات أخرى مفتوحة المصدر. على سبيل المثال ، يتم إنشاء التخطيط النهائي في الغالب باستخدام Inkscape أو GIMP (أقل في رسم LibreOffice). يتم تحرير الخرائط المستندة إلى الويب باستخدام Inkscape (بعد تصدير SVG) ويتم تحرير الخرائط النقطية مسبقًا باستخدام GIMP.
...
ساهم هذا المقال في نوفمبر 2010 بواسطة Jakub Trojan. وهو باحث أكاديمي في كلية إدارة الأعمال والفندقة المحدودة (برنو ، تشيكوسلوفاكيا) حيث أسس ويرأس مختبر في الجغرافيا التجريبية والتطبيقية. وهو أيضا طالب الدكتوراه في معهد الجغرافيا ، كلية العلوم ، جامعة Masaryk (برنو ، تشيكوسلوفاكيا).
