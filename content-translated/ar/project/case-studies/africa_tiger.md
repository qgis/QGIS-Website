...
title: 'نظام رصد ومراقبة المياه: تمكين استخدام بيانات رصد الأرض من أجل الإدارة المتكاملة
  للموارد المائية في إفريقيا'
type: case-study

---
{{<content-start >}}
# نظام رصد ومراقبة المياه: تمكين استخدام بيانات رصد الأرض من أجل الإدارة المتكاملة للموارد المائية في إفريقيا
