...
title: إنتاج a arcHymro مثل الإخراج مع QGIS
type: case-study

---
{{<content-start >}}
# إنتاج a arcHymro مثل الإخراج مع QGIS
...
لإنشاء شبكات هطول الأمطار قمت بإجراء تحليل إحصائي على جداول GHCN للعثور على أعماق سقوط الأمطار لعواصف التصميم التي تصل إلى 1،2،5،10،50،100 عامًا. ثم قمت بتنزيل شبكة عينة مجانية من PRISM للصين وافتراض علاقة خطية ، وتحويل قيم خلية متوسطة إلى قيم خلايا قصوى من أجل بناء شبكات كثافة الأمطار القصوى.
## الخاتمة
