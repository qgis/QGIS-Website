...
title: المعجم التاريخي لشبه جزيرة القرم
type: case-study

---
{{<content-start >}}
# المعجم التاريخي لشبه جزيرة القرم
...
لاحظ أنه يمكن فتح المعرِّف في متصفح ويب ، وبالتالي عرض خريطة GeoNames تلقائيًا مع المكان المكوَّن في وسطه ، كما هو موضح في الشكل 2.
