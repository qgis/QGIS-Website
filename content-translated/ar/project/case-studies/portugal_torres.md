...
title: تم تطبيق QGIS و GRASS على المسح الأحفوري في غرب البرتغال
type: case-study

---
{{<content-start >}}
# تم تطبيق QGIS و GRASS على المسح الأحفوري في غرب البرتغال
...
- مسح ميداني باستخدام GPS Differencial لتجميع إحداثيات المواقع ؛
- بناء نموذج المخاطر لتحديد المخاطر التي تتعرض لها التراث الحفري وبالتالي منعها من خلال المسوحات الميدانية المنتظمة ؛
- بناء قاعدة بيانات جغرافية للتعامل مع جميع المعلومات وبدء مخزون المجموعة.

## البرمجيات التي استخدمناها
كان QGIS هو الإطار الرئيسي لكل المشروع. ألقيت البيانات مباشرة إلى QGIS ، ومن ثم تحريرها والتلاعب بها من أجل تحقيق المخرجات المرجوة. سمحت لنا واجهة GRASS التي توفرها QGIS بإجراء تحليل مكاني معقد على النقط من أجل الحصول على نموذج المخاطر الذي نحتاجه لتخطيط عملنا الميداني والتنقيب المستقبلي. وعلاوة على ذلك ، سمح لنا باستيراد طبقات PostGIS وتصورها على QGIS.
