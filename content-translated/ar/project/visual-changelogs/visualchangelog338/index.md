...
| QGIS cannot load feature classes from a .gdb with a 64bit ObjectID | [#57471](https://github.com/qgis/QGIS/issues/57471) | [GDAL PR 9980](https://github.com/OSGeo/gdal/pull/9980) | غير قابل للتطبيق |
...
| QGIS3.28.15:Polygon Features from ArcGIS GDB Turn into TABLE after Editing in QGIS | [#57536](https://github.com/qgis/QGIS/issues/57536) | [GDAL PR 10008](https://github.com/OSGeo/gdal/pull/10008) | غير قابل للتطبيق |
...
| [ux][layouts] Fix legend item style mutex | unreported | [PR #57605](https://github.com/qgis/QGIS/pull/57605) | غير قابل للتطبيق |
...
| JSON-String not read from GPKG | [#57673](https://github.com/qgis/QGIS/issues/57673) | [PR #57707](https://github.com/qgis/QGIS/pull/57707) | غير قابل للتطبيق |
...
| Pressing escape should clear current identify results | [#47984](https://github.com/qgis/QGIS/issues/47984) | [PR #57774](https://github.com/qgis/QGIS/pull/57774) | غير قابل للتطبيق |
...
| Don't try to connect widget to null vector tile layers | unreported | [PR #57721](https://github.com/qgis/QGIS/pull/57721) | غير قابل للتطبيق |
...
| Fix tab stops in legend text | [#56981](https://github.com/qgis/QGIS/issues/56981) | [PR #57554](https://github.com/qgis/QGIS/pull/57554) | غير قابل للتطبيق |
