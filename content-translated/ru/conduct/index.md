...
Эти правила применяются ко всем площадкам, управляемым проектом QGIS, включая IRC, списки рассылки, систему отслеживания ошибок, события DSF, а также любые другие форумы, созданные командой проекта, которые сообщество использует для коммуникации.

Если вы считаете, что кое-кто нарушает нормы и правила сообщества, просим вас сообщить об этом по адресу [psc@qgis.org](mailto:psc%40qgis.org).
## Будьте приветливы, дружелюбны и терпеливы
## Будьте тактичны
Ваша работа будет использоваться другими людьми, и вы, в свою очередь, будет зависеть от работы других. Любое принятое вами решение повлияет на пользователей и коллег, и вы должны принимать это во внимание при принятии решений. Помните, что мы всемирное сообщество, так что вы можете не знать родной язык кого-то другого.
## Будьте почтительны
...
## Аккуратно подбирайте слова и выражения
Мы сообщество профессионалов, и мы ведем себя профессионально. Будьте добры к другим. Не оскорбляйте и не подавляйте других участников. Навязчивость и другое подобное поведение не приемлемы. Это включает в себя, но не ограничивается следующим:
- Угрозы или брань по отношению к другому человеку.
- Сексистские, расистские или любые другие дискриминационные шутки или стиль речи.
