...
ButtonText: Скачать
HasBanner: true
LabelText: Бесплатно и с открытым исходным кодом
...
### Сервер QGIS
Публикуйте свои проекты и слои QGIS как сервисы WMS, WMTS, WFS и WCS, совместимые с OGC. Контролируйте, какие слои, атрибуты, макеты и системы координат экспортируются. Сервер QGIS рассматривается как эталонная реализация WMS 1.3.
...
{{<rich-content-start themeClass="coloring-6" >}}
### QGIS на мобильных устройствах и планшетах
