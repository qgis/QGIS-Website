...
section: project
sidebar: true
title: Список изменений для QGIS 2.14
type: visual-changelog

---
{{<content-start >}}
# Список изменений для QGIS 2.14{#changelog214 }
...
- Еще одна новая функция, которая упрощает использование виджета: **пути к файлам теперь могут отображаться в виде гиперссылок**. При нажатии на гиперссылку файл будет открыт в QGIS. Вы можете настроить отображение полного пути файла или только его имени. Файл будет открыт с помощью программы по умолчанию для этого формата файла в вашей операционной системе.
