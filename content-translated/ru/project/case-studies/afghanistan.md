...
title: Датская группа разминирования использует QGIS в Афганистане
type: case-study

---
{{<content-start >}}
# Датская группа разминирования использует QGIS в Афганистане
...
Также QGIS хорошо синхронизируется с данными полевых операций, полученными с помощью портативных устройств Garmin GPS, что позволяет использовать местоположения найденных и обезвреженных мин для создания карт расчисток.
