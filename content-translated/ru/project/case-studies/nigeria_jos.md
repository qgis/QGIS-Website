...
title: Отображение авифауны и обитателей лесного заповедника Амурум в Нигерии с помощью
  QGIS
type: case-study

---
{{<content-start >}}
# Отображение авифауны и обитателей лесного заповедника Амурум в Нигерии с помощью QGIS
...
## Построение карт распределения и разнообразия птиц
