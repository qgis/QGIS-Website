...
{{< rich-content-end >}} {{< rich-right-start mode="html" >}}

<!-- {{< stripe-widget otherMethods="true" skipToDownload="true" >}} -->

{{< payrexx-widget otherMethods="true" skipToDownload="true" >}} {{< rich-right-end >}} {{< rich-box-end >}}
...
{{< spoiler-start id="download-mac" title="🍏 macOS" >}} {{< download-macos >}}
