...
Используйте QGIS для создания великолепных карт и выполнения задач геообработки.
...
### QGIS Blueprints
Разрабатывайте веб-приложения для пространственного анализа с помощью QGIS
...
Добро пожаловать в мир PyQGIS, объединившем в себе Quantum GIS и Python, для расширения и улучшения инструментов Вашей открытой ГИС. С помощью PyQGIS Вы можете написать скрипты и плагины для реализации новых возможностей и автоматизации задач.
...
Разработано для QGIS версии 1.8
...
- Авторы: Rüdiger Thiede, Tim Sutton, Horst Düster, и Marcelle Sutton
