...
title: 'Quantarctica: Um pacote SIG da Antártida'
...
Quantarctica está a ser usado para examinar dados geográficos de escala continental a escala local, para ver informação científica projectada em cima de mapas de base ou com outros conjuntos de dados específicos, e preparar mapas para publicações e propostas. Quantarctica até agora tem provado ser uma óptima ferramenta, e uma boa alternativa e complemento para outros softwares utilizados pelos investigadores. Veio fornecer novas oportunidades para os nossos investigadores no seu trabalho diário.
