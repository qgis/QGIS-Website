...
---
# QGIS no Departamento Federal de Planejamento da Cidade e e Região, Peninsular Malaysia
## Introdução
O Departamento Federal de Planeamento Urbanístico, da Malásia Peninsular (JPBD) é um agência federal que faz aconselhamento em questões de planeamento urbanístico. O âmbito desta administração para o departamento, porém, é limitado à península da Malásia porque Sabah e Sarawak na Malásia Oriental têm as suas respectivas agências de planeamento urbanístico. O Ordenamento do território está na lista actual da Legislação Federal, portanto, no nível federal, JPBD aconselha a Habitação e o Ministro do Governo local a partir do qual JPBD recebe o seu auxílio, bem como aconselha o Conselho Nacional de Planeamento Físico presidido pelo Primeiro-Ministro . No nível estadual, o director estadual informa o Comité de Planeamento do Estado presidido pelo ministro-chefe. No nível local, JPBD aconselha as autoridades de planeamento local em matéria de planeamento estando envolvido na preparação obrigatória de planos de desenvolvimento. Na sede, a Divisão Nacional de Plano Físico prepara o Plano obrigatório Nacional Físico enquanto quatro escritórios regionais de projectos auxiliam na elaboração de Planos de estrutura do Estado, os Planos Distritais Locais e os Planos de Área especial. Como os órgãos públicos eram tradicionalmente estabelecido de base em sua especialização, JPBD é o que guarda a informação do uso do solo.
## O Projeto
QGIS foi introduzido pela primeira vez para a comunidade Malaysian de código aberto como uma alternativa viável para SIG proprietário para órgãos públicos por JPBD na Conferência de Código Aberto do Governo da Malásia (MyGOSSCON) em 2009 e para a comunidade SIG da Malásia na 4ª Conferência Nacional de SIG e Exposições (NGIS) em 2010. JPBD tem sido tradicionalmente um usuário de SIG proprietário, assim, a introdução de QGIS foi uma abertura de olhos não só do ponto de vista de Software de Código Aberto (OSS), mais, OSS SIG. A filosofia código aberto era diferente assim com QGIS me senti estranho, incerto e inseguro, não surpreendentemente a idéia de usar QGIS não recebeu muito apoio internamente, na verdade, ele enfrentou a resistência em 2010 a partir do gerente geral e todo o caminho para baixo para o grupo de apoio.
...
O estudo destacou prós e contras na personalização do módulo e o elevado nível de compromisso no gerenciamento necessário para garantir o seu sucesso e adoção. Em 2011, JPBD começou mais pesquisas sobre QGIS, mais como uma ferramenta analítica em vez de uma ferramenta de mapeamento, a fim de abrir caminho para módulos inexplorados ou novas abordagens a explorar no QGIS.
...
Interesse em QGIS mesclado e em 2012, com o apoio de todos os diretores do escritório de projeto, um esforço em conjunto foi empreendido pela Divisão de Informação Nacional Landuse que liderou QGIS, para treinar os 4 escritórios de projetos, pois eles mantêm o maior número de usuários de SIG. Até o final de 2012, prevê-se que pelo menos 320 funcionários em todo JPBD vai usar QGIS que corresponde por aproximadamente 90% dos usuários de SIG do departamento.
...
- Os usuários ficam mais encorajados a começar a aventurar-se no Google Maps e outras fontes da internet para informação secundária;
- Sendo amigável o QGIS incentiva os usuários a serem mais aventureiros e explorar muitos dos módulos disponíveis tornando-se uma vantagem e faz com a sua tarefa seja mais fácil.
