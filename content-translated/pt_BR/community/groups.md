...
{{<content-start >}}
# Grupos de usuários
## Lista atual de grupos de usuários QGIS
### Registrado em 2016 ou antes
...
{{<rich-list listLink="http://qgis-us.org" icon="🇺🇸" layoutClass="half" listTitle="QGIS EUA" listSubtitle="Contact: Randal Hale" >}}

{{<rich-list listLink="https://qgis.mx" icon="🇲🇽" layoutClass="half" listTitle="QGIS México" listSubtitle="Contact: Hennessy Amor Becerra Ayala" >}}

{{<rich-list listLink="https://qgis.org" icon="🇬🇪" layoutClass="half" listTitle="QGIS Geórgia" listSubtitle="Contact: Zurab Archvadze –> REMOVED in 2018" >}}
### Registrado em 2018
{{<rich-list listLink="https://qgis.ro/" icon="🇷🇴" layoutClass="half" listTitle="Asociația Utilizatorilor QGIS (Romania)" listSubtitle="Contato: Tudor Bărăscu" >}}

{{<rich-list listLink="https://qgis.es/" icon="🇪🇸" layoutClass="half" listTitle="Association of QGIS users in Spain" listSubtitle="Contato: Carlos López Quintanilla" >}}

{{<rich-list listLink="https://github.com/qgisco" icon="🇨🇴" layoutClass="half" listTitle="Grupo de Usuarios QGIS Colombia" listSubtitle="Contato: Germán Carrillo" >}}
### Removido em 2018
{{<rich-list listLink="https://teamwork.niwa.co.nz/display/NQUG/NIWA+QGIS+Users+Group" icon="🇳🇿 " layoutClass="half" listTitle="NIWA QGIS user group (New Zealand)" listSubtitle="Contato: Brent Wood" >}}

{{<rich-list listLink="https://qgis.org" icon="🇬🇪" layoutClass="half" listTitle="QGIS Geórgia" listSubtitle="Contato: Zurab Archvadze" >}}
### Registrado em 2020
...
{{<rich-list listLink="https://qgis-id.github.io/" icon="🇮🇩" layoutClass="half" listTitle="Komunitas Pengguna QGIS Indonesia" listSubtitle="Contato: Ismail Sunni" >}}

{{<rich-list listLink="https://qgis.sk/" icon="🇸🇰" layoutClass="half" listTitle="QGIS Slovensko (Slovakia)" listSubtitle="Contato: Jana Michalkova" >}}

{{<rich-list listLink="https://qgis.ec/" icon="🇪🇨" layoutClass="half" listTitle="Grupo de usuarios QGIS Ecuador" listSubtitle="Contato: Adrián Benavides" >}}
### Registrado em 2021
{{<rich-list listLink="https://qgis.at/" icon="🇦🇹" layoutClass="half" listTitle="QGIS Anwendergruppe Österreich (Austria)" listSubtitle="Contato: Paul Stampfl" >}}
...
### Registered 2022
{{<rich-list listLink="https://qgis.ar/" icon="🇦🇷" layoutClass="half" listTitle="QGIS Argentina" listSubtitle="Contato: Ariel Anthieni" >}}
### Registrado em 2024
{{<rich-list listLink="https://www.facebook.com/groups/612486875596534" icon="🌐" layoutClass="half" listTitle="QGIS Global virtual FB group" listSubtitle="Contato: Adelcides Varela" >}}

{{<rich-list listLink="https://qgis-mk.blogspot.com" icon="🇲🇰" layoutClass="half" listTitle="Qgis Macedônia do Norte " listSubtitle="Contato: Ivica Milevski" >}}

{{<rich-list listLink="https://qgis-al.blogspot.com/" icon="🇦🇱" layoutClass="half" listTitle="QGIS Albânia" listSubtitle="Contato: Emiliano Qose" >}}

{{<rich-list listLink="https://www.facebook.com/profile.php?id=100094072457586" icon="🇽🇰" layoutClass="half" listTitle="QGIS República de Kosovo" listSubtitle="Contato: Milot Lubishtani" >}}
### Registrado em 2025
...
* Coleção de estudos de caso de uso local do QGIS
...
* Estabelecimento de grupos de interesse, por ex. topografia, planejamento urbano, servidor/cliente da web, etc.
* Inicialização/coordenação de módulos de aplicação, por ex. topografia, planejamento urbano, servidor/cliente da web, etc.
* Electing a representative to act as a [QGIS Voting Member]({{< ref "/community/organisation#voting-members" >}})

## Requisitos gerais/ recomendações
...
* Informe o Projeto Internacional constantemente sobre suas atividades locais
...
Estatutos do grupo de usuários Suíço do QGIS como um exemplo:
