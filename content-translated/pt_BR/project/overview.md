...
### QGIS Server
Publique os seus projetos e camadas do QGIS compatíveis com OGC através de serviços WMS, WMTS, WFS e WCS.  Controle quais camadas, atributos, layouts e sistemas de coordenadas são exportados. O servidor QGIS é considerado como uma implementação de referência para o WMS 1.3.
...
{{<rich-content-start themeClass="coloring-6" >}}
### QGIS Desktop
Criar, editar, visualizar, analisar e publicar informações geoespaciais.
