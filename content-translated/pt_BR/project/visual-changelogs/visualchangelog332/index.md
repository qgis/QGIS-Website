...
| Título do bug | URL issues (Github, if reported) | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Longer opening time of GPKG file in newer versions | [#53525](https://github.com/qgis/QGIS/issues/53525) | [PR #53566](https://github.com/qgis/QGIS/pull/53566) | A Fazer |
...
| Options for some values in Processing are not saved after close window | [#53204](https://github.com/qgis/QGIS/issues/53204) | [PR #53458](https://github.com/qgis/QGIS/pull/53458) | não |
...
| Avoid UI lock when closing Execute SQL window | Não relatados | [PR #53448](https://github.com/qgis/QGIS/pull/53448) | Too risky |
...
| Fix a crash on QGIS close | Não relatados | [PR #53414](https://github.com/qgis/QGIS/pull/53414) | [PR #53418](https://github.com/qgis/QGIS/pull/53418) |
...
| Fix crash when writing processing history entry | Não relatados | [PR #53394](https://github.com/qgis/QGIS/pull/53394) | NA |
...
| Fix point text annotation rotation, alignment issues | Não relatados | [PR #53337](https://github.com/qgis/QGIS/pull/53337) | NA |
| Expand range of z index spin for annotations | Não relatados | [PR #53319](https://github.com/qgis/QGIS/pull/53319) | [PR #53326](https://github.com/qgis/QGIS/pull/53326) |
| Fix incorrect scaling of text background markers in annotations | Não relatados | [PR #53318](https://github.com/qgis/QGIS/pull/53318) | Fix crash on invalid grass layer paths |
...
| Fix crash when creating new grass mapsets when \"set\" is pressed and no region is selected | Não relatados | [PR #53293](https://github.com/qgis/QGIS/pull/53293) | [PR #53311](https://github.com/qgis/QGIS/pull/53311) |
