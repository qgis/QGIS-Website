...
| [ux][layouts] Fix legend item style mutex | não relatado | [PR #57605](https://github.com/qgis/QGIS/pull/57605) | N/A |
...
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Source-tree documentation improvements | não relatado | [PR #57594](https://github.com/qgis/QGIS/pull/57594) |  |
...
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Avoid crash on summary when error list is empty | não relatado | [PR #57658](https://github.com/qgis/QGIS/pull/57658) | [PR #57661](https://github.com/qgis/QGIS/pull/57661) |
...
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgsabstractmaterialsettings: Handle selection in addParametersToEffect | não relatado | [PR #57803](https://github.com/qgis/QGIS/pull/57803) | not backported |
| qgs3daxis: Fix cube face picking | não relatado | [PR #57848](https://github.com/qgis/QGIS/pull/57848) |  |
...
| Fix some grass vectors incorrectly show as datasets | não relatado | [PR #57780](https://github.com/qgis/QGIS/pull/57780) | [PR #57786](https://github.com/qgis/QGIS/pull/57786) |
...
| Don't try to connect widget to null vector tile layers | não relatado | [PR #57721](https://github.com/qgis/QGIS/pull/57721) | N/A |
| Don't show invalid "Style not found in database" warning when adding vector tile layers | não relatado | [PR #57714](https://github.com/qgis/QGIS/pull/57714) | Not appropriate |
...
| Fix add feature dialog does not restore position when shown modally | não relatado | [PR #57686](https://github.com/qgis/QGIS/pull/57686) | [PR #57700](https://github.com/qgis/QGIS/pull/57700) |
| Fix python script editor "open in external editor" action | não relatado | [PR #57682](https://github.com/qgis/QGIS/pull/57682) | Not appropriate |
| Fix broken prefetch capabilities for raster layers | não relatado | [PR #57663](https://github.com/qgis/QGIS/pull/57663) | [PR #57667](https://github.com/qgis/QGIS/pull/57667) |
| Fix missing field type information in eg the horizontal header tooltips in attribute table | não relatado | [PR #57621](https://github.com/qgis/QGIS/pull/57621) | Not appropriate |
| Don't try to paint to indexed image | não relatado | [PR #57601](https://github.com/qgis/QGIS/pull/57601) |  |
| Clamp values for set_color_part function to avoid qt warnings when out of range values are specified | não relatado | [PR #57600](https://github.com/qgis/QGIS/pull/57600) |  |
| Add some tests for rendering text with RTL markers | [PR #57586](https://github.com/qgis/QGIS/pull/57586) |  |  |
| Fix rotation based orientation when html labeling enabled | não relatado | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Too intrusive |
| Fix data defined font size is ignored when HTML labeling is active | não relatado | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Too intrusive |
| Don't set @value to line height when evaluating multi line alignment | não relatado | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Too intrusive |
...
| Fix incorrect buffers drawn for html label item | não relatado | [PR #57551](https://github.com/qgis/QGIS/pull/57551) | [PR #57571](https://github.com/qgis/QGIS/pull/57571) |
| Fix label mask sizes get reset to 0 | não relatado | [PR #57555](https://github.com/qgis/QGIS/pull/57555) | [PR #57569](https://github.com/qgis/QGIS/pull/57569) |
...
| Make brush and stroke style combo box icons visible on dark themes | não relatado | [PR #57506](https://github.com/qgis/QGIS/pull/57506) | [PR #57510](https://github.com/qgis/QGIS/pull/57510) |
