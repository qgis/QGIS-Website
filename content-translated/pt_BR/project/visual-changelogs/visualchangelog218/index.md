...
section: projeto
sidebar: true
title: Histórico de alterações do QGIS 2.18
type: visual-changelog

---
{{<content-start >}}
# Histórico de alterações do QGIS 2.18{#changelog218 }
![image1](images/projects/ac3b0a08203e87505a823b0d8a0895d44489f916.png)

Release date: 2016-10-21

Esse é o último lançamento da série 2.x. A versão de longa duração  (LTR) atual permanece sendo a versão 2.14.x. Esta versão fornece melhorias incrementais em relação à nossa versão anterior. A maior parte das atividades estão atualmente focadas no desenvolvimento do QGIS 3.0, que é a nova geração do QGIS com lançamento planejado para o final do primeiro trimestre de 2017.
...
{{<table-of-contents >}}
## Patrocinadores da versão 2.18.0 do QGIS
...
## Geral
### Recurso: Links automáticos em identificar resultados
...
### Recurso: Roda do mouse sobre controles deslizantes de cor
No QGIS 2.18, agora você pode rolar a roda do mouse sobre qualquer um dos controles deslizantes dentro da caixa de diálogo do selecionador de cores para incrementar o valor em pequenas quantidades. Este é um atalho acessível para ajustes pequenos aos componentes da cor.
...
### Recurso: Adicionar esquemas de cores personalizados ao botão de cores no menu suspenso.
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
## Simbologia
### Recurso: selecionador de cores agora é incorporado no painel de estilo de camada
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
## Rótulo
### Recurso: Suporte de lista de substituição para rotulagem
Adds the ability to specify a list of text substitutes to make which apply to label text. Eg abbrevating street types.

Os usuários podem exportar e importar listas de substitutos para facilitar a reutilização e o compartilhamento.
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
### Recurso: Algoritmo melhorado de posicionamento de rótulo de linha
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
### Recurso: Rotular polígonos usando etiquetas curvas ao longo do perímetro
Isso adiciona um novo modo para rotular polígonos onde o perímetro do polígono é rotulado usando rótulos curvados.
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
## Renderização
### Recurso: visualização de raster tiles (WMTS e camadas XYZ)
...
### Recurso: Cancelar a renderização de rasters (WMS, WMTS, WCS e camadas XYZ)
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
## Compositor de mapas
### Recurso: Setas orientadas ao Norte Verdadeiro
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
## Processamento
### Recurso: Algoritimo Ponto dentro da superfície
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
### Recurso: Processamento do algoritmo dissolver agora aceita vários campos
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
### Recurso: Processamento otimizado do algoritimo Cortar
O algoritmo  de processamento  de corte foi otimizado para cenários de uso comum, resultando em acelerações dramáticas para operações de recorte. Por exemplo:

** Cortando uma camada de estradas com 1 milhão de linhas contra 2 polígonos **

| **Earlier versions:** 5 mins 30 seconds | **QGIS 2.18:** 10 seconds

** Cortar uma camada de endereço de 5 milhões de pontos contra 2 polígonos **
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
### Recurso: Algoritmo de caixas de limite
Este novo algoritmo calcula a caixa delimitadora (envelope) de cada feição na camada de entrada.
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
### Recurso: Algoritmo para combinar linhas conectadas
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
### Recurso: Algoritmo de limite de geometria
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
## Funcionalidade: Novas classes PyGIS no 2.18
