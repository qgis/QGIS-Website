...
## Expressões
### Recurso: novas variáveis e funções para expressões
...
Este recurso foi financiado por Leicestershire County Council
...
Este recurso foi desenvolvido por Mathieu Pellerin (iMHere Asia), Nyall Dawson (North Road)
...
Este recurso foi desenvolvido por Alessandro Pasotti (with North Road)
## Compositor de mapas
...
Este recurso foi financiado por Good will
