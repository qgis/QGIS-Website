...
| unreported: wrong link in server WFS3 items page (too many slashes) | não relatado | [PR #33926](https://github.com/qgis/QGIS/pull/33926) | risky |
...
### Função: Correção de bugs por Sandro Santilli
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Provedor Oracle: avisos para correção do compilador | - | [PR #33930](https://github.com/qgis/QGIS/pull/33930) | - |
...
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| Remove o detalhamento dos botões da barra de ferramentas layout | [#30161](https://github.com/qgis/QGIS/issues/30161) | [PR #33912](https://github.com/qgis/QGIS/pull/33912) |  |
...
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fixes compilation on Arch Linux | Não relatados | [PR #34110](https://github.com/qgis/QGIS/pull/34110) | [PR #34146](https://github.com/qgis/QGIS/pull/34146) |
...
| Fix map layer actions rendering in attribute table | Não relatados | [PR #34266](https://github.com/qgis/QGIS/pull/34266) | done |
...
| Snapping not possible in new project with new layer | [#32969](https://github.com/qgis/QGIS/issues/32969) | Duplicata | - |
...
| \"view feature form\" opens the wrong feature/record | [#33880](https://github.com/qgis/QGIS/issues/33880) | [PR #34009](https://github.com/qgis/QGIS/pull/34009) | A Fazer |
| setFilterExpression and QGIS Filter output different results | [#33454](https://github.com/qgis/QGIS/issues/33454) | Fechado (não é um problema do QGIS) | - |
| Crash while using Oracle views with primary key defined as number without precision | [#31626](https://github.com/qgis/QGIS/issues/31626) | [PR #34312](https://github.com/qgis/QGIS/pull/34312) | A Fazer |
| WCS client stopped working on a specific service from 2.18 to 3.x | [#33339](https://github.com/qgis/QGIS/issues/33339) | [PR #34300](https://github.com/qgis/QGIS/pull/34300) | A Fazer |
| Crash in relation reference test | [#34779](https://github.com/qgis/QGIS/issues/34779) | [PR #34822](https://github.com/qgis/QGIS/pull/34822) | A Fazer |
...
| Rubberband not working correctly with \"Shapes\" digtizing in rotated map window | [#33287](https://github.com/qgis/QGIS/issues/33287) | Duplicata |  |
...
| Fix identify menu when an expression is used as display name | não relatado | [PR #34361](https://github.com/qgis/QGIS/pull/34361) | [PR #34402](https://github.com/qgis/QGIS/pull/34402) |
...
| BUG: fix invalid layer result when Oracle version is under 12 | não relatado | [PR #34546](https://github.com/qgis/QGIS/pull/34546) |  |
...
| \[processing\] Fix modeler draws lines to wrong output when connecting green output boxes | Não relatados | [Commit 5ae9807](https://github.com/qgis/QGIS/commit/5ae9807303e909a504288d97a2efc4cc04a62670) | [Commit 528a45d](https://github.com/qgis/QGIS/commit/528a45d7453b7cbeb44450d5c81de80c8dd66611) |
...
| \[processing\] Fix QStringList values are not accepted as valid values for multi-field parameters | Não relatados | [Commit abcb8d2](https://github.com/qgis/QGIS/commit/abcb8d20c66b3c235802b10e68d6abc34736e2c5) | [Commit d421313](https://github.com/qgis/QGIS/commit/d421313f05fd0e5a6974568eccd36c4213f41f8f) |
| \[processing\] Fix some field names are rejected in modeler for non-multi field parameters | Não relatados | [Commit 9bcd980](https://github.com/qgis/QGIS/commit/9bcd98094c015265e7e94c55f248248e56c24e51) | N/A - 3.12 only |
| Fix crash in server feature info | Não relatados | [Commit b3f37fde](https://github.com/qgis/QGIS/commit/b3f37fde9bc4785aebca29e6553d6c1de715f523) | Submitted |
| Fix overflow by assigning double max to float, invalid min | Não relatados | [Commit 2b15e255](https://github.com/qgis/QGIS/commit/2b15e255eaf63f1d45b8e963fca7f9f9e4bf8d40) | N/A - 3.12 only |
| Fix crash in QgsGeometryDuplicateCheck due to heap use after free | Não relatados | [Commit 195576e](https://github.com/qgis/QGIS/commit/195576e57f0aff064e962ce16b37533ab4924dce) | [Commit dc647bc](https://github.com/qgis/QGIS/commit/dc647bc56fb37207a75d55638926e7a2db75a8be) |
| Fix crash on destruction of QgsPointLocator, if object is destroyed while indexing is happening in the background | Não relatados | [Commit 08adb23](https://github.com/qgis/QGIS/commit/08adb23a7ec284a2f84ecf7ac469fbe9004ab57e) | N/A - 3.12 only |
...
| Fix use after free in 3d point symbol | Não relatados | [Commit df7979c](https://github.com/qgis/QGIS/commit/df7979cf94c43352cd10db97c16075b8816ec6c4) | [Commit 7204de2](https://github.com/qgis/QGIS/commit/7204de27f3305146fbd6f8e32355c365030afc31) |
| Fix leaks in geometry generator symbol layer | Não relatados | [Commit 1610fb8](https://github.com/qgis/QGIS/commit/1610fb8766a13351bb303ee3bfd6301dbdc6648b) | [Commit 3944db4](https://github.com/qgis/QGIS/commit/3944db47dda6b08ea4b22f61c5e72d97597362b1) |
