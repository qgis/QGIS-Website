...
section: projeto
sidebar: true
title: Registro de Alterações no QGIS 3.14
type: visual-changelog

---
{{<content-start >}}
# Registro de Alterações no QGIS 3.14{#changelog314 }
...
Este recurso foi financiado por iMHere Asia
...
Algumas limitações/deficiências conhecidas:
...
Portanto, atualmente, o desempenho é muito pior com camadas grandes em comparação com o Time Manager (e o conjunto de recursos expostos é menor, por exemplo, sem manipulação de interpolação), mas a vantagem é que podemos usar a estrutura temporal nativa e ter camadas vetoriais animadas ao lado de malha e camadas raster!

This feature was developed by [Nyall Dawson](https://api.github.com/users/nyalldawson)
### Feature: Postgres raster temporal API support
Adicionado integração de recursos temporais para os rasters do Postgres.
...
### Recurso: Configurações temporais do Projeto QGIS
Esse recurso adiciona a funcionalidade de configurações de tempo do projeto.
...
This feature was developed by [Nyall Dawson](https://api.github.com/users/nyalldawson)
### Recurso: permitir que o estilo da linha da barra de escala seja definido usando símbolos de linha QGIS padrão
...
This feature was developed by [Nyall Dawson](https://api.github.com/users/nyalldawson)
### Recurso: Retrabalhar a interface do usuário e o comportamento do item de imagem
...
Este recurso foi desenvolvido por Etienne Trimaille, Jan Caha, Julien Monticolo, Nyall Dawson
...
Este recurso foi financiado por Kanton Solothurn e Land Vorarlberg
...
Este recurso foi financiado por ecoptima e Planteam
...
1. Criar camada raster aleatória (distribuição binominal)
2. Criar camada raster aleatória (distribuição exponencial)
3. Criar camada raster aleatória (distribuição gama)
4. Criar camada raster aleatória (distribuição binomial negativa)
5. Criar camada raster aleatória (distribuição normal)
6. Criar camada raster aleatória (distribuição poisson)
7. Criar camada raster aleatória (distribuição uniforme)
...
Refs Contrato NRCan #3000707093
...
### Função: Correção de bugs por Alessandro Pasotti
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| GPKG browser drag&drop not working | não relatado | [PR #36972](https://github.com/qgis/QGIS/pull/36972) | [PR #37159](https://github.com/qgis/QGIS/pull/37159) |
...
| Vectorlayer from spatialite missing features and inconsistent feature count | [#29264](https://github.com/qgis/QGIS/issues/29264) | [PR #37277](https://github.com/qgis/QGIS/pull/37277) | A Fazer |
...
### Função: Correção de bugs por Even Rouault
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Armazenamento auxiliar não utilizável em camada não editável | [#30376](https://github.com/qgis/QGIS/issues/30376) | Already fixed. Closed. | N/A |
...
### Função: Correção de bugs por Julien Cabieces
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Fix redirection of the stdout results to temporary files in GRASS Processing algorithms | não relatado | [PR #36618](https://github.com/qgis/QGIS/pull/36618) | [PR #36684](https://github.com/qgis/QGIS/pull/36684) |
| Fix GRASS r.tileset algorithm | não relatado | [PR #36645](https://github.com/qgis/QGIS/pull/36645) | [PR #36695](https://github.com/qgis/QGIS/pull/36695) |
...
| Attributes shift in the Service area algorithm results | não relatado | [PR #37074](https://github.com/qgis/QGIS/pull/37074), [PR #37097](https://github.com/qgis/QGIS/pull/37097) | N/A |
| Processing testing framework does not apply rounding to values casted to numbers | não relatado | [PR #37234](https://github.com/qgis/QGIS/pull/37234) | N/A |

This feature was funded by [QGIS.ORG (through donations and sustaining memberships)](https://www.qgis.org/)

Esse recurso foi desenvolvido por Alexander Bruy 
### Função: Correção de bugs por Nyall Dawson
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix leak in mesh 3d renderer | não relatado | [Commit 4b5a63d](https://github.com/qgis/QGIS/commit/4b5a63d11b7ea5baf6931c8abf86e132c706c1be) | N/A |
...
| Fix font in CSS code editor | não relatado | [Commit 63cb42c](https://github.com/qgis/QGIS/commit/63cb42c298ef5ab732274bce205e49171b797ae4) | not critical |
...
| Fix all Qt 5.14 deprecation warnings | não relatado | [Commit 3717adc](https://github.com/qgis/QGIS/commit/3717adcef6315f4b9a0089bfc2393cede937b644) | No \-- too intrusive |
...
| Fixes to numbered list handling in dox/PyQGIS API | não relatado | [Commit 74400c7](https://github.com/qgis/QGIS/commit/74400c7ff88d563dad74dad41860f9b603214973) | Não |
| Fix cross references in PyQGIS docs | não relatado | [Commit 81a9db9](https://github.com/qgis/QGIS/commit/81a9db9f57706cba9b11e4372dd1bf50fcd7bc6a) | Não |
...
| Fix list item formatting in PyQGIS docs | não relatado | [Commit 84ec481](https://github.com/qgis/QGIS/commit/84ec481aa8f3d3bb487272122414c765e77a2ea2) | N/A |
...
| Avoid some QGIS startup warnings | não relatado | [Commit 013f682](https://github.com/qgis/QGIS/commit/013f682bd3c6addd163a78d3776c578ae37377c6) | N/A |
...
| \[labeling\] Fix incorrect label placement after moving an \'unplaced\' label | não relatado | [Commit cbfb7f4](https://github.com/qgis/QGIS/commit/cbfb7f4ce25e10aab5f7b8cee147afb801042704) | [PR 36718 Commit 9189dec](https://github.com/qgis/QGIS/pull/36718/commits/9189dec7633b2eb6a1075bb35c2f90f6b90ba63a) |
| Don\'t block creation of new geopackages in vector save as dialog | não relatado | [Commit 8ccd127](https://github.com/qgis/QGIS/commit/8ccd127f4d8bf66fb04b6484147ed116acf66d91) | N/A |
...
| \[3d\] When showing edges, data defined polygon height was not accounted for | não relatado | [Commit e516231](https://github.com/qgis/QGIS/commit/e516231bb2854405ea78a0cec40ad96295e9f8c6) | N/A |
| Fixes for \"Show all\" labeling mode | não relatado | [Commit 2b91bd0](https://github.com/qgis/QGIS/commit/2b91bd0cafff66f14ceb49b104bf2f2cc6ae714d) | N/A |
...
| Avoid corrupted project thumbnail images in some circumstances | não relatado | [Commit f404e6e](https://github.com/qgis/QGIS/commit/f404e6e162df954ffb200d550b6c32375b7270c1) | N/A |
...
| Fix placement of message bar \'clear all\' menu arrow on hidpi screens | não relatado | [Commit 8a9975b](https://github.com/qgis/QGIS/commit/8a9975b4ff6b7a8a79bef05230db28754500fa40) | not critical |
...
| Fix incorrect warning message when turning off atlas preview | não relatado | [Commit 3b0af960](https://github.com/qgis/QGIS/commit/3b0af960dd90af15cbe32e2fd7642408031e70f5) | N/A |
...
| Improve plugin watchdog message and UX | não relatado | [Commit 150b373](https://github.com/qgis/QGIS/commit/150b373c7ae61c0548ab0803f9b30a36b15e7ab4) | No \-- too intrusive |
...
| Avoid proj \'object is not a concatenated operation\' warnings | não relatado | [Commit 6baa209](https://github.com/qgis/QGIS/commit/6baa209285f452e5996537b1b0f1b5d924d5c59b) |  |
...
| Implementa detecção de índice espacial para o provedor OGR | [#30530](https://github.com/qgis/QGIS/issues/30530) | [Commit f20801a](https://github.com/qgis/QGIS/commit/f20801a8bb3f23576e5e0d2abc6d3229e5044200) | [PR 36718 Commit 536906e](https://github.com/qgis/QGIS/pull/36718/commits/536906ec6375b70d88767e58a08550369a25d1a0) |
| Corrige título da caixa de diálogo incorreto para propriedades da camada raster | [#35510](https://github.com/qgis/QGIS/issues/35510) | [Commit 2099261](https://github.com/qgis/QGIS/commit/2099261230f82c5cd4439538e38754947c8f6bd6) | [PR 36718 Commit e809f48](https://github.com/qgis/QGIS/pull/36718/commits/e809f48cb9aaf03dfe8671c2d885f99b4a91922b) |
| Don\'t try to identify CRSes created just for ellipsoid definitions | não relatado | [Commit 15b318b](https://github.com/qgis/QGIS/commit/15b318b50de9131ed1dd6bbf73ae5eb7572579a7) | No \-- too intrusive |
...
| fix layer tree dependencies (showinf symbols and main layer) | não relatado | [PR #37000](https://github.com/qgis/QGIS/pull/37000) | N/A |
