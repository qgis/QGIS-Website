...
section: projeto
sidebar: true
title: Alterações no QGIS 2.16
type: visual-changelog

---
{{<content-start >}}
# Alterações no QGIS 2.16{#changelog216 }
...
This feature was developed by [Paul Blottiere (Oslandia)](http://oslandia.com/)
### Recurso: Suporte aprimorado ao HiDPI
Os usuários da tela HiDPI perceberão uma interface de usuário aprimorada à medida que mais trabalho for feito para atualizar ícones de imagens SVG. A partir do QGIS 2.16, todas as barras de ferramentas agora são compatíveis com HiDPI
...
- Distância (algoritmo padrão e a única opção disponível em versões anteriores do QGIS)
- SnapToGrid
- Visvalingam
...
### Recurso: Renderizador de sombreamento ao vivo
O QGIS 2.16 possui um novo renderizador raster que criará dinamicamente um modelo de relevo sombreado a partir de um Modelo Digital de Elevação.
...
Algoritmos relacionados ao PostGIS agora usam o gerente de autenticação QGIS para obter credenciais para o banco de dados PostGIS.
...
- Migração para novo kernel de geometria
...
This feature was developed by [Matthias Kuhn](http://www.opengis.ch)
### Feição: API: Inclui páginas às propriedades da camada vetorial
Permite a inclusão de páginas adicionais ao diálogo das propriedades da camada vetorial.
...
Este recurso foi financiado por Master Thesis UZH
...
This feature was developed by [Sandro Mani (Sourcepole)](https://www.sourcepole.com/)
### Funcionalidade: Novas classes PyQGIS no QGIS 2.16
...
- A correção não pode definir atalho para aumento do zoom (#14958 - normal)
