...
section: projeto
sidebar: true
title: Registro de alterações para QGIS 3.6
type: visual-changelog

---
{{<content-start >}}
# Registro de alterações para QGIS 3.6{#changelog36 }
...
{{<table-of-contents >}}
## Ferramentas de mapa
### Feição: Decoração de rótulo do título
Um novo decorador foi adicionado para permitir ao usuários adicionar rapidamente um título em suas telas. As feições decorador possui uma barra de fundo com custonização de cor e opacidade.
...
### Feição: Topo/botão posicionamento centralizado para decoração de itens
Os direitos autorais da tela do mapa e as decorações de título recém-adicionadas agora podem ser centralizadas na parte superior ou inferior da visualização do mapa.

This feature was developed by [Mathieu Pellerin](http://imhere-asia.com/)
### Feição: Vértice de ferramentas de correções e melhorias
Nota: Todos os itens mencionados a baixo foram portados para o LTR, então ele também aparecem no QGIS 3.4.5.
...
Na versão QGIS 3 anterior, clicar com o botão direito do mouse em uma feição exibia um pequeno menu pop-up que oferece exibição do editor de vértices. **Agora, clique direto na feição mostrando imediatamente o editor de vértice e desabilitando a edição de qualquer outras feições.**
...
**Quando há múltiplas feições onde o mouse está posicionado, repetidos cliques com o botão direito vão passar por cada uma delas** - a cada clique com o botão direito, você vai se fixar uma feição diferente. Finalmente, quando todas as feições tiverem sido mostradas, nenhuma feição será fixada e cliques adicionais vão recomeçar este ciclo.
...
Este recurso foi desenvolvido por Nyall Dawson, Mathieu Pellerin
...
Este recurso foi desenvolvido por Alexis Roy-Lizotte
...
Este recurso foi financiado por QGIS User Group Germany
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
### Recurso: marcador de imagem raster
...
Este recurso foi financiado por OSGeo UK, GeoServer PSC, Brad Hards

This feature was developed by [Luigi Pirelli and GeoSolutions](https://www.geo-solutions.it/)
## Digitalização
### Feição: Aprimoramentos do Georreferenciador
...
Este recurso foi desenvolvido por konst
...
Agora a aceleração OpenCL está disponível como padrão para operações da calculadora raster.

Este recurso foi financiado por Alessandro Pasotti - ItOpen
...
Este recurso foi desenvolvido por Nyall Dawson, Nathan Woodrow
...
O suporte a JSON permite o armazanamento de dados estruturados dentro de um único campo em arquivos GeoPackage.

Os dados armazenados como JSON podem ser representados e editados em
...
Este recurso foi desenvolvido por Martin Dobias (Lutra Consulting)
...
Este recurso foi financiado pela comunidade QGIS
...
| --- | --- | --- | --- |
| QGIS Server: WFS issue using the EXP_FILTER parameter | [#20927](https://issues.qgis.org/issues/20927) | [PR #8924](https://github.com/qgis/QGIS/pull/8924) | Feito |
...
| QGIS Server WFS DescribeFeatureType not following TYPENAME parameter | [#20198](https://issues.qgis.org/issues/20198) | [PR #8948](https://github.com/qgis/QGIS/pull/8948) | Feito |
| QGIS Server 3.4 can\'t reset numeric field using WFS Update | [#20961](https://issues.qgis.org/issues/20961) | [PR #8958](https://github.com/qgis/QGIS/pull/8958) | Feito |
| WFS provider shows numeric NULL fields with 0 instead of NULL | [#20961](https://issues.qgis.org/issues/20961) | [PR #8958](https://github.com/qgis/QGIS/pull/8958) | Feito |
| OWS project title in project properties cannot be set to blank/empty | não relatado | [PR #8958](https://github.com/qgis/QGIS/pull/8958) | Feito |
| Form Value relation based on WFS layer | [#21077](https://issues.qgis.org/issues/21077) | [PR #8970](https://github.com/qgis/QGIS/pull/8970) | Feito |
| Button positions in Database styles manager dialog | [#21068](https://issues.qgis.org/issues/21068) | [PR #8971](https://github.com/qgis/QGIS/pull/8971) | Feito |
...
| Error opening network KML page: Range downloading not supported by this server! | [#21091](https://issues.qgis.org/issues/21091) | [PR #8985](https://github.com/qgis/QGIS/pull/8985) | Feito |
| Can\'t add a virtual field or update a existing field of a WFS layer using the field calculator | [#21086](https://issues.qgis.org/issues/21086) | [PR #8990](https://github.com/qgis/QGIS/pull/8990) | Feito |
...
| Delimitedtext layer saves absolute path when project in relative path mode | [#21150](https://issues.qgis.org/issues/21150) | [PR #9099](https://github.com/qgis/QGIS/pull/9099) | Feito |
| field calculator doesn\'t load values for gpkg containing blank spaces or n dash (hypen) in field names | [#21100](https://issues.qgis.org/issues/21100) | [PR #9071](https://github.com/qgis/QGIS/pull/9071) | Feito |
...
| Layer Properties \> Load Style \> From database \> \'Other styles \...\' \> Description column contains Name text, should contain Description text (it is a geopackage layer) | [#21254](https://issues.qgis.org/issues/21254) | [PR #9170](https://github.com/qgis/QGIS/pull/9170) | Feito |
...
| Bug with multiple Else items in rule-based style | [#21281](https://issues.qgis.org/issues/21281) | [PR #9181](https://github.com/qgis/QGIS/pull/9181) | Feito |
...
| Geometry Checker Crashes | [#21259](https://issues.qgis.org/issues/21259) | [PR #9191](https://github.com/qgis/QGIS/pull/9191) | Feito |
| QGIS crashes when createInstance() uses wrong constructor in a QgsProcessingAlgorithm subclass | [#21270](https://issues.qgis.org/issues/21270) | [PR #9193](https://github.com/qgis/QGIS/pull/9193) | Feito |
...
| Pontos dentro de polígonos | [#20798](https://issues.qgis.org/issues/20798) | Cannot reproduce with 3.5 |  |
...
| Add option to control export features without categories in Processing GRASS algorithms | não relatado | [PR #9003](https://github.com/qgis/QGIS/pull/9003) | [PR #9043](https://github.com/qgis/QGIS/pull/9043) |
...
| v.net.report and v.net.nreport algorithms failed | não relatado | [PR #9046](https://github.com/qgis/QGIS/pull/9046) | [PR #9058](https://github.com/qgis/QGIS/pull/9058) |
...
| QgsExternalResourceWidgetWrapper crashes | [#20140](https://issues.qgis.org/issues/20140) | Duplicata |  |
...
| QGIS 3.5 not loading or saving multi-dimensional arrays properly from PostGIS layers | [#20872](https://issues.qgis.org/issues/20872) | [PR #9048](https://github.com/qgis/QGIS/pull/9048) | A Fazer |
...
| Add the possibility to return a shp if ogr is not compiled with gpkg | não relatado | [PR #9037](https://github.com/qgis/QGIS/pull/9037) |  |
...
This feature was developed by [Nyall Dawson](https://north-road.com/)
### Feição: Correções de bugs por Hugo Mercier
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.4 backport commit (GitHub) |
| --- | --- | --- | --- |
| Qgis 3.4.1 crashes when accessing methods of feature | [#20752](https://issues.qgis.org/issues/20752) | fechado |  |
...
| QGIS 3.4.1 advanced modification and snap block QGIS | [#20568](https://issues.qgis.org/issues/20568) | fechado |  |
