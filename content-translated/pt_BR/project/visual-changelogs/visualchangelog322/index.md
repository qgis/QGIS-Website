...
- Recuo de itens do grupo
- Recuo de itens do subgrupo
...
- Converter dados do GPS
- Carregar dados de GPS no dispositivo
- Baixar dados de um receptor GPS
...
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.16 backport commit (GitHub) | Remark |
| --- | --- | --- | --- | --- |
...
| Warning message \'Cannot create temporary SpatiaLite cache\' when adding many WFS-layers | [#44971](https://github.com/qgis/QGIS/issues/44971) | Duplicata |  |  |
...
| QGIS on linux crashes when opening many geopackages at once | [#43620](https://github.com/qgis/QGIS/issues/43620) | [PR #45211](https://github.com/qgis/QGIS/pull/45211) | Não |  |
...
| QGIS crash after loading WMS layer via script and zooming in and out | [#44095](https://github.com/qgis/QGIS/issues/44095) | [PR #45254](https://github.com/qgis/QGIS/pull/45254) | Não | Mostly a usage issue |
...
| projecting label coordinates for multiPoint geometry crashes QGIS | [#45148](https://github.com/qgis/QGIS/issues/45148) | [PR #45150](https://github.com/qgis/QGIS/pull/45150) | Não |  |
...
| Attributes - Update All button - Creates Corrupted Fields - GeoJSON file | [#45139](https://github.com/qgis/QGIS/issues/45139) | [PR #45174](https://github.com/qgis/QGIS/pull/45174) | Não |  |
| WMS parent layer added via QGIS Browser doesn\'t use default style | [#45192](https://github.com/qgis/QGIS/issues/45192) | [PR #45209](https://github.com/qgis/QGIS/pull/45209) | Não |  |
...
| Copying table by Drag&Drop in Browser (2) doesn\'t copy the table structure correctly | [#45286](https://github.com/qgis/QGIS/issues/45286) | [PR #45375](https://github.com/qgis/QGIS/pull/45375) | Não |  |
...
| Create spatialite trigger with DBManager do not work | [#45420](https://github.com/qgis/QGIS/issues/45420) | [PR #45553](https://github.com/qgis/QGIS/pull/45553) | Não |  |
...
| macOS: Symbol not found: \_\_cg_jpeg_resync_to_restart when reprojecting raster layer with GDAL warp on macOS | [#40164](https://github.com/qgis/QGIS/issues/40164) | não | não | Not an issue with the nightly (qgis-deps-0.9) anymore |
...
| unable to open any ascii FLO-2D files in Mesh Layer | não relatado | [PR #45349](https://github.com/qgis/QGIS/pull/45349) | n/a |  |
...
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.16 backport commit (GitHub) | Remark |
| --- | --- | --- | --- | --- |
| Make QgsGeos::prepareGeometry and QgsGeos::cacheGeos idempotent | não relatado | [PR #45147](https://github.com/qgis/QGIS/pull/45147) |  |  |
| Add a distanceWithin method to the QgsGeometryEngine virtual class | não relatado | [PR #45057](https://github.com/qgis/QGIS/pull/45057) |  |  |
| Allow calling testdata_pg.sh from any directory | não relatado | [PR #45378](https://github.com/qgis/QGIS/pull/45378) |  |  |
| Make TestPyQgsPostgresProvider.testGeneratedColumns idempotent | não relatado | [PR #45415](https://github.com/qgis/QGIS/pull/45415) |  |  |
| Improve PostgreSQL test DB setup documentation and script | não relatado | [PR #45413](https://github.com/qgis/QGIS/pull/45413) |  |  |
...
| Use GEOSDistanceWithin when available | não relatado | [PR #45340](https://github.com/qgis/QGIS/pull/45340) |  |  |
| Reduce GEOS conversions and preparations of geometries | não relatado | [PR #45195](https://github.com/qgis/QGIS/pull/45195) |  |  |
| More heuristics to determine whether to iterate over target source | não relatado | [PR #45339](https://github.com/qgis/QGIS/pull/45339) |  |  |
...
| Attachment widget options are reset when you reopen the field widget properties | [#45089](https://github.com/qgis/QGIS/issues/45089) | Duplicata |  |  |
...
| Update default toolbar locations | não relatado | [Commit 77be95feac](https://github.com/qgis/QGIS/commit/77be95feac7391e58f6bd487f30e09ed8ed63651) | N/A |  |
...
| Fix crash on exit with CAD dock open | não relatado | [Commit 1fb21f69f](https://github.com/qgis/QGIS/commit/1fb21f69fede05cabb8f1d27a8ad24564ae16f3d) | N/A |  |
...
| Fix inappropriate display of z/m values in cad dock when non-z/m layer is selected | não relatado | [Commit 55a76d1d](https://github.com/qgis/QGIS/commit/55a76d1d867c32f52ae4bd38ed671d44aa3ae92e) | N/A |  |
...
| Allow CAD dock to be used for geographic CRS, but only allow the x/y/z/m constraints to be set | não relatado | [PR #45185](https://github.com/qgis/QGIS/pull/45185) | Not suitable for backport |  |
...
| Fix QgsMapToolCapture coordinates when associated with a non-vector layer where the layer CRS != canvas CRS | não relatado | [PR #45183](https://github.com/qgis/QGIS/pull/45183) | N/A |  |
...
| Fix digitizing features using CAD dock when layer CRS != canvas CRS | não relatado | [PR #45108](https://github.com/qgis/QGIS/pull/45108) | N/A |  |
...
| Fix handling of ADF files in browser | não relatado | [PR #45393](https://github.com/qgis/QGIS/pull/45393) | Not suitable for backport |  |
