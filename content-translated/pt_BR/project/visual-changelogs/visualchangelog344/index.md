...
| duplicated objectName in the oracle dialog | não relatado | [PR \#61944](https://github.com/qgis/QGIS/pull/61944) | N/A |
...
| Fix reshaping when snapping to segment | não relatado | [PR \#62315](https://github.com/qgis/QGIS/pull/62315) |  |
| Unhandled GEOS exception when reshaping | não relatado | [PR \#62322](https://github.com/qgis/QGIS/pull/62322) |  |
| Reshape returns Success instead of NothingHappened | não relatado | [PR \#62323](https://github.com/qgis/QGIS/pull/62323) | [PR \#62336](https://github.com/qgis/QGIS/pull/62336) |
| Reshape tool tries to run with a single digitized point | não relatado | [PR \#62324](https://github.com/qgis/QGIS/pull/62324) |  |
| Fix crash when undoing first digitized point in shape map tools | não relatado | [PR \#62335](https://github.com/qgis/QGIS/pull/62335) |  |
| Fix crashing shape tools when not enough points digitized | não relatado | [PR \#62338](https://github.com/qgis/QGIS/pull/62338) |  |
...
| \[Processing toolbox\] Search box (result) not updated when list of providers change | [\#26435](https://github.com/qgis/QGIS/issues/26435) | [PR \#62162](https://github.com/qgis/QGIS/pull/62162) | Não |
...
| When saving SLD to DB, make sure errors are reported to callers (like Package layers algorithm) | não relatado | [PR \#62332](https://github.com/qgis/QGIS/pull/62332) |  |
...
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| QGIS fails to import sprites from OpenStreetMap vector tile styles | não relatado | [PR \#62175](https://github.com/qgis/QGIS/pull/62175) |  |
...
| QGIS fails to handle of source containing a relative path to the root of the server hosting the style json | não relatado | [PR \#62062](https://github.com/qgis/QGIS/pull/62062) | [PR \#62084](https://github.com/qgis/QGIS/pull/62084) |
...
| Various new connection dialog spacing and size issues | não relatado | [PR \#62041](https://github.com/qgis/QGIS/pull/62041) |  |
...
| \[Oracle\] Fix PyQgsProviderRegistry test | qt6 test failing | [PR \#62109](https://github.com/qgis/QGIS/pull/62109) | Não |
...
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix walk mode key handling | Não relatados | [PR \#62331](https://github.com/qgis/QGIS/pull/62331) | N/A |
| Increase QImageReader allocation limit for qt6 builds | Não relatados | [PR \#62320](https://github.com/qgis/QGIS/pull/62320) | N/A |
...
| Use protected, not private virtual methods for map tool classes | Não relatados | [PR \#62097](https://github.com/qgis/QGIS/pull/62097) | [PR \#62112](https://github.com/qgis/QGIS/pull/62112) |
| Avoid corrupted overlapping docks when first changing from dialog to dock | Não relatados | [PR \#62102](https://github.com/qgis/QGIS/pull/62102) | N/A |
| Fix jumpy scroll area when using mouse wheel on qt6 builds | Não relatados | [PR \#62099](https://github.com/qgis/QGIS/pull/62099) | N/A |
...
| Fix variables available for grid annotations missing for grid symbol | Não relatados | [PR \#61943](https://github.com/qgis/QGIS/pull/61943) | [PR \#61957](https://github.com/qgis/QGIS/pull/61957) |
...
| Delimited text test can be run on qt6 now | Não relatados | [PR \#61900](https://github.com/qgis/QGIS/pull/61900) | N/A |
| Fix mesh layer labeling tests not actually run | Não relatados | [PR \#61899](https://github.com/qgis/QGIS/pull/61899) | [PR \#61909](https://github.com/qgis/QGIS/pull/61909) |
