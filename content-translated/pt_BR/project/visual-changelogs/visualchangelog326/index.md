...
| Título do bug | URL Issues (if reported, Github) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Highlight of identified feature not displaying correctly on \"geometry generator\" marker from different CRS | [#48439](https://github.com/qgis/QGIS/issues/48439) | [PR #48579](https://github.com/qgis/QGIS/pull/48579) | A Fazer |
| Cannot past copied features as temporary scratch layer | [#48401](https://github.com/qgis/QGIS/issues/48401) | [PR #48611](https://github.com/qgis/QGIS/pull/48611) | A Fazer |
| QGIS crash by opening a form with relation content | [#48443](https://github.com/qgis/QGIS/issues/48443) | [PR #48616](https://github.com/qgis/QGIS/pull/48616) | A Fazer |
| Relation reference widget: filter expression does not work with variables | [#48190](https://github.com/qgis/QGIS/issues/48190) | [PR #48619](https://github.com/qgis/QGIS/pull/48619) | A Fazer |
| Random order of attributes in oracle feature query | [#35309](https://github.com/qgis/QGIS/issues/35309) | [PR #48668](https://github.com/qgis/QGIS/pull/48668) | não |
...
| Documentation doctest failure | [QGIS developer mail list](https://lists.osgeo.org/pipermail/qgis-developer/2022-May/064720.html) | [QGIS Documentation PR 7581](https://github.com/qgis/QGIS-Documentation/pull/7581) | não |
| \"Add to group\" option in sub layer window always add at top of layer tree | [#48694](https://github.com/qgis/QGIS/issues/48694) | [PR #48696](https://github.com/qgis/QGIS/pull/48696) | não |
| Name/id of map objects in GetProjectSettings follows an order that is the inverse of the order used to add the map objects in a layout | [#46143](https://github.com/qgis/QGIS/issues/46143) | [PR #48728](https://github.com/qgis/QGIS/pull/48728) | não |
| Aborted inserts in Postgis geometryless tables are saved anyway | [#48171](https://github.com/qgis/QGIS/issues/48171) | [PR #48741](https://github.com/qgis/QGIS/pull/48741) | não |
| Inconsistent coordinate rounding in Raster \"Layer Properties\" | [#48767](https://github.com/qgis/QGIS/issues/48767) | [PR #48790](https://github.com/qgis/QGIS/pull/48790) | A Fazer |
| Drag and Drop Postgis-Table in QGIS Browser alters name of Geometry-Column | [#48748](https://github.com/qgis/QGIS/issues/48748) | [PR #48796](https://github.com/qgis/QGIS/pull/48796) | não |
...
| Server GetPrint with multiple maps following map themes apply prefixed LAYERS (map0:LAYERS) to all maps | [PR #48923](https://github.com/qgis/QGIS/pull/48923) | [PR #48923](https://github.com/qgis/QGIS/pull/48923) | A Fazer |
...
| Improve UX for virtual layer creation dialog | não relatado | [PR #49015](https://github.com/qgis/QGIS/pull/49015) | Not appropriate |
...
| Fix some undersized icons on hidpi displays | não relatado | [PR #48875](https://github.com/qgis/QGIS/pull/48875) | Not appropriate |
...
| Fix clear values for offset along line spin boxes | não relatado | [PR #48872](https://github.com/qgis/QGIS/pull/48872) | [PR #48878](https://github.com/qgis/QGIS/pull/48878) |
...
| Never show the transformation selection dialog for the first layer added to a project | não relatado | [PR #48811](https://github.com/qgis/QGIS/pull/48811) | [PR #48814](https://github.com/qgis/QGIS/pull/48814) |
...
| Fix loss of mesh layer styling when fixing a broken path to a mesh layer | não relatado | [PR #48765](https://github.com/qgis/QGIS/pull/48765) | [PR #48768](https://github.com/qgis/QGIS/pull/48768) |
...
| Don\'t hide parts of the mesh renderer widget if the layer is invalid | não relatado | [PR #48757](https://github.com/qgis/QGIS/pull/48757) |  |
| Add layer opacity widget in mesh layer renderer properties widget | não relatado | [PR #48756](https://github.com/qgis/QGIS/pull/48756) |  |
| Review and finish open PR [PR #44941](https://github.com/qgis/QGIS/pull/44941) |  |  |  |
| Fix a crash when QgsProject::instance() is accessed when no QgsApplication exists | não relatado | [PR #48721](https://github.com/qgis/QGIS/pull/48721) | N/A |
...
| Add support for map field types to memory provider, avoid data loss in models/processing | não relatado | [PR #48638](https://github.com/qgis/QGIS/pull/48638) | Too intrusive |
...
| Fix many memory leaks | não relatado | [PR #48590](https://github.com/qgis/QGIS/pull/48590) | N/A |
| Fix ctrl modifier scrolling on symbol buttons | não relatado | [PR #48581](https://github.com/qgis/QGIS/pull/48581) | N/A |
