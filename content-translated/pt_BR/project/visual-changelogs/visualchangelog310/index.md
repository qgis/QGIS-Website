...
Este recurso foi financiado pelo grupo de exportação GeoPDF: Land Vorarlberg; Cantons of Zug, Thurgovia e Neuchâtel; Cidades de Vienna e Dornbirn; Biodiversity Information Service for Powys & Brecon Beacons National Park
...
Este recurso foi financiado pelo grupo de exportação GeoPDF
...
Este recurso foi desenvolvido por Olivier Dalang
...
Este recurso foi desenvolvido por Isghj5
...
Este recurso foi desenvolvido por DelazJ
...
Este recurso foi desenvolvido por Oslandia
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
### Feição: Novo API para provedor de conexões do banco de dados
...
Este recurso foi financiado por QGIS

This feature was developed by [Alessandro Pasotti](https://www.qcooperative.net)
## Correções Importantes
### Função: Correção de bugs por Alessandro Pasotti
| Título do bug | Problemas de URL (se relatados) | URL PR ou commit | 3.4 backport PR or commit |
| --- | --- | --- | --- |
...
| Fix unreported issue with QVariantList to JSON conversion in QgsJsonUtils | não relatado | [PR #3192](https://github.com/qgis/QGIS/pull/31920) |  |
...
| WFS contextual legend issue when canvas CRS is different than layer\'s CRS | não relatado | [PR #3212](https://github.com/qgis/QGIS/pull/32120) |  |
...
| Unreported issue with missed import in the Processing algorithms dialog | não relatado | [PR #3190](https://github.com/qgis/QGIS/pull/31902) |  |
...
| arquivo INSTALL não consegue encontrar doc/api/html | [#31842](https://github.com/qgis/QGIS/issues/31842) | [Commit 3225f491](https://github.com/qgis/QGIS/commit/3225f4911a1199fc217aeca9fa63d9bf3d1b82c0) | n/a |
...
| Fix uncaught transform exception when determining AFS layer bounds | não relatado | [Commit 857697dd](https://github.com/qgis/QGIS/commit/857697dd9919e80fc03e0c2059e56ce7311e9b49) | n/a |
| Fix qt warning thrown when converting a 2.18 project | não relatado | [Commit 12ad9fca](https://github.com/qgis/QGIS/commit/12ad9fca1ed5027129161ee5b5c764b8374d0b51) | n/a |
...
| Don\'t force fallback to WGS84 for unknown layer CRSes | não relatado | [Commit 93741566](https://github.com/qgis/QGIS/commit/937415663f609fa7e41056aeb1176a0a145accc1) | n/a |
...
| Ensure polygon rings generated for rendering are always closed | não relatado | [Commit a69e38d9](https://github.com/qgis/QGIS/commit/a69e38d9c358faea5ae4a8628add1e6721cc23e8) | n/a |
| Don\'t crash QgsTessellator when an empty polygon is added | não relatado | [Commit 761b2e77](https://github.com/qgis/QGIS/commit/761b2e778594f4051a72d02b898354f501e336fe) | n/a |
| Fix crash in topology checker plugin after a check is canceled | não relatado | [Commit 606bcd35](https://github.com/qgis/QGIS/commit/606bcd35143d09cca5b1ec45bdb5b13236e4376b) | n/a |
...
| Fix crash on exit when topology checker dock is open with visible results | não relatado | [Commit 64375ad4](https://github.com/qgis/QGIS/commit/64375ad4d28597eb97808f64e1481915df7a676c) | n/a |
...
| \[reports\] Fix crash when print button clicked before a report section is opened | não relatado | [Commit c93fd0a4](https://github.com/qgis/QGIS/commit/c93fd0a4350ea14db9728ad17ada06e70eb9ffd6) | n/a |
...
| Fix project load status indicator can get \"stuck\" after project load | não relatado | [Commit 40d95b69](https://github.com/qgis/QGIS/commit/40d95b69d91ade71473f5ea0182040d8398cc668) | n/a |
