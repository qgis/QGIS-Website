...
| test_provider_ogr.py: do not alter source test data, to keep 'git status' clean | Não relatados | [PR #58734](https://github.com/qgis/QGIS/pull/58734) | N/A |
...
| [BUGFIX] [PostgreSQL] Properly take into account 'name' type | Não relatados | [PR #59147](https://github.com/qgis/QGIS/pull/59147) | A Fazer |
...
| [Layout] Missing atlas layer attributes in expression "Fields and Values" group for fixed table item | [#58774](https://github.com/qgis/QGIS/issues/58774) | [PR #58778](https://github.com/qgis/QGIS/pull/58778) | Não |
| Clearing the default value expression cannot be canceled / undone | [#58767](https://github.com/qgis/QGIS/issues/58767) | [PR #58787](https://github.com/qgis/QGIS/pull/58787) | Não |
...
| QGIS Server: fixed width of 200 px of cascaded WMS layer legends | [#57422](https://github.com/qgis/QGIS/issues/57422) | [PR #58790](https://github.com/qgis/QGIS/pull/58790) | Não |
| Random Points in Polygons behaves unexpectedly | [#58737](https://github.com/qgis/QGIS/issues/58737) | [PR #58815](https://github.com/qgis/QGIS/pull/58815) | Não |
| When using a computed or virtual field that refers to other layers's fields having the same name, the wrong value is returned | [#49469](https://github.com/qgis/QGIS/issues/49469) | [PR #58819](https://github.com/qgis/QGIS/pull/58819) | A Fazer |
...
| pyqt5_to_pyqt6.py fails on infinite recursion | [#58659](https://github.com/qgis/QGIS/issues/58659) | [PR #58785](https://github.com/qgis/QGIS/pull/58785) | Não |
...
| Calling several times waitForFinished on task would cause a deadlock | Não relatados | [PR #58799](https://github.com/qgis/QGIS/pull/58799) | Não |
...
| Fix unsafe use of QgsProject::instance from vector layer classes | Não relatados | [PR #59118](https://github.com/qgis/QGIS/pull/59118) | Too risky |
| When excluding tests, only exclude exact matches | Não relatados | [PR #59116](https://github.com/qgis/QGIS/pull/59116) | N/A |
| When layout scalebar settings are invalid, show warning message | Não relatados | [PR #59088](https://github.com/qgis/QGIS/pull/59088) | N/A |
...
| QgsMapLayer::setDataSource don't require layer name, provider | Não relatados | [PR #58953](https://github.com/qgis/QGIS/pull/58953) | N/A |
| Fix incompatibility between text wrapping and HTML text formatting | Não relatados | [PR #58952](https://github.com/qgis/QGIS/pull/58952) | N/A |
...
| Fix missing canvas variables in some expression editors | Não relatados | [PR #58907](https://github.com/qgis/QGIS/pull/58907) | [PR #58934](https://github.com/qgis/QGIS/pull/58934) |
...
| QgsDistanceArea methods should raise QgsCsException when errors occur | Não relatados | [PR #58795](https://github.com/qgis/QGIS/pull/58795) | N/A |
| Don't apply reset-to-zero step size logic in spin boxes when no special value text is set | Não relatados | [PR #58836](https://github.com/qgis/QGIS/pull/58836) | N/A |
...
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix use of QgsReferencedGeometry in expressions | Não relatados | [PR #59180](https://github.com/qgis/QGIS/pull/59180) |  |
...
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Clipping of long WKT strings for geometry parameters by using our geometry widget | Não relatados | [PR #59209](https://github.com/qgis/QGIS/pull/59209) | N/A |
...
| Bad styling of scrollbars in the plugin manager dialog | Não relatados | [PR #58713](https://github.com/qgis/QGIS/pull/58713) | [PR #58721](https://github.com/qgis/QGIS/pull/58721) |
...
| Bad plugin manager's look on dark themes | Não relatados | [PR #58606](https://github.com/qgis/QGIS/pull/58606) |  |
...
| Fix layout map item preview rendering of XYZ layers with known tile DPI | Não relatados | [PR #58543](https://github.com/qgis/QGIS/pull/58543) | [PR #58566](https://github.com/qgis/QGIS/pull/58566) |
...
| Fix issue with vertical lines not visible in the elevation profile tool | não relatado | [PR #58959](https://github.com/qgis/QGIS/pull/58959) | N/A |
