...
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Cannot load VT layer from style only from the dialog (works in browser) | not reported | [PR \#66500](https://github.com/qgis/QGIS/pull/66500) | A Fazer |
...
| Qgis have problem to render GeometryCollection for Gml, other viewer like mygeodata website render ok | [\#66225](https://github.com/qgis/QGIS/issues/66225) | Duplicata |  |
...
| raster histogram not working for raster with scale factor | [\#65920](https://github.com/qgis/QGIS/issues/65920) | [PR \#66640](https://github.com/qgis/QGIS/pull/66640) | A Fazer |
| Advanced Digitizing Floater is not wide enough to show whole value | [\#65171](https://github.com/qgis/QGIS/issues/65171) | [PR \#66663](https://github.com/qgis/QGIS/pull/66663) | A Fazer |
...
| Fix flaky test_gui_fileuploader | Não relatados | [PR \#66543](https://github.com/qgis/QGIS/pull/66543) |  |
| Hidden actions from user defined toolbar are still visible. | Não relatados | [PR \#66620](https://github.com/qgis/QGIS/pull/66620) |  |
| QGIS should never poll a PostGIS/WMS/WFS/etc connections unless specifically asked to | [\#58303](https://github.com/qgis/QGIS/issues/58303) | [PR \#66621](https://github.com/qgis/QGIS/pull/66621) | A Fazer |
| Password is not removed when it's at the the end of uri | Não relatados | [PR \#66625](https://github.com/qgis/QGIS/pull/66625) | A Fazer |
...
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
| Allow QGIS to access curves from OGC API provider | Não relatados | [PR \#66452](https://github.com/qgis/QGIS/pull/66452) | N/A |
...
| Ensure consistency in MultiCurves: don't allow NurbsCurves | Não relatados | [PR \#66676](https://github.com/qgis/QGIS/pull/66676) | N/A |
...
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix field displayString on primitive JSON values | Não relatados | [PR \#66575](https://github.com/qgis/QGIS/pull/66575) | N/A |
...
| Crash when clicking on an unavailable layer in Layers panel | [\#65913](https://github.com/qgis/QGIS/issues/65913) | [PR \#66578](https://github.com/qgis/QGIS/pull/66578) | A Fazer |
...
| concat() returns NULL when all arguments are NULL: it should return an empty string | [\#65808](https://github.com/qgis/QGIS/issues/65808) | [PR \#66618](https://github.com/qgis/QGIS/pull/66618) | A Fazer |
...
| Gerenciador BD | [\#59470](https://github.com/qgis/QGIS/issues/59470) | Cannot reproduce |  |
...
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix deadlock when rendering annotation layers | Não relatados | [PR \#66712](https://github.com/qgis/QGIS/pull/66712) | [PR \#66742](https://github.com/qgis/QGIS/pull/66742) |
| Fix crashes in QgsFeatureListComboBox if layer is unloaded | Não relatados | [PR \#66697](https://github.com/qgis/QGIS/pull/66697) | [PR \#66708](https://github.com/qgis/QGIS/pull/66708) |
| Every entry in relation reference widget is shown in italic | Não relatados | [PR \#66649](https://github.com/qgis/QGIS/pull/66649) | Not appropriate |
| Fix buggy processing relief colors widget | Não relatados | [PR \#66602](https://github.com/qgis/QGIS/pull/66602) | Not appropriate |
| Fix QgsImageCache lossy conversion of images | Não relatados | [PR \#66585](https://github.com/qgis/QGIS/pull/66585) | Not appropriate |
...
| Fix intermittent failure of GRASS raster tests | Não relatados | [PR \#66546](https://github.com/qgis/QGIS/pull/66546) | N/A |
...
| Use correct lossless method to store metal rough colors | Não relatados | [PR \#66521](https://github.com/qgis/QGIS/pull/66521) | N/A |
| Ensure color picker opens inline for 3d settings in style dock | Não relatados | [PR \#66520](https://github.com/qgis/QGIS/pull/66520) | Not appropriate |
| Fix misalignment of spin boxes in color dialog | Não relatados | [PR \#66498](https://github.com/qgis/QGIS/pull/66498) | Not appropriate |
| Use unlit material instead of phong material when more appropriate | Não relatados | [PR \#66490](https://github.com/qgis/QGIS/pull/66490) | Not appropriate |
...
| Partially fix slow expression builder widget construction times | Não relatados | [PR \#66385](https://github.com/qgis/QGIS/pull/66385) | Not appropriate |
...
| WMS Ensure we store deduced CRS in provider/layer sources | Não relatados | [PR \#66379](https://github.com/qgis/QGIS/pull/66379) | Not appropriate |
...
| Fix model is zoomed right out when opening model designer | Não relatados | [PR \#66335](https://github.com/qgis/QGIS/pull/66335) | QGIS 4 only |
