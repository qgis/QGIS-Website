...
A tela inicial apresenta um mapa raro e extraordinário de 1847 de Firenze, ou Florença, Itália, de Giuseppe Molini. Este mapa magnificamente gravado foi originalmente desenhado em 1731 pelo arquiteto florentino Ferdinando Ruggieri. Orientado para o sul, o mapa cobre o antigo centro murado de Florença, que se estende em ambos os lados do rio Arno. O quadrante superior direito apresenta o símbolo do lírio de Florença. Embora impresso em 1847, este mapa foi preparado no estilo do século XVII por gravura em chapa de cobre em papel grosso. Firenze em 1847 estava à beira da transformação política. Um ano após a produção deste mapa raro, o Grão-Duque da Toscana, respondendo às manifestações políticas em Florença, concedeu à Toscana sua primeira constituição.
...
## Temporal
### Função: Adiciona suporte a gerenciador temporal para camadas WMTS com a dimensão TIME
...
Isso deve unificar a experiência do usuário para que o uso de camadas habilitadas para tempo WMTS seja essencialmente idêntico ao uso de camadas WMS(T).

![image3](images/entries/8f0a6c8e4850886732633ab76d5873dffd7746c4.gif)

This feature was developed by [Nyall Dawson](https://github.com/nyalldawson)
## Ferramentas de mapa
### Função: Permite seleção em feições tile layers vetoriais
Foi adicionado suporte para selecionar feições de camadas de mosaicos vetoriais, o que permite que os usuários usem as ferramentas de seleção padrão baseadas em mapa para selecionar interativamente feições dessas fontes.

Quanto uma camada vetorial tile layer tem uma seleção, o usuário pode:
- Copiar as feições e colar elas em outras camadas, ou colar elas em uma camada de rascunho
- Use other (non-editing) tools which operate on selections, such as \"zoom to selected features\"/\"pan to selected features\"

As seleções podem ser feitas usando qualquer uma das ferramentas de seleção baseadas em mapas interativos, por exemplo. selecione por retângulo, à mão livre, polígono ou raio. Todos os atalhos que se aplicam às seleções de vetor para adicionar/subtrair/interseccionar seleções também se aplicam.
...
| Crash while opening Options dialog after switching locale | [#50239](https://github.com/qgis/QGIS/issues/50239)9 | [PR #50263](https://github.com/qgis/QGIS/pull/50263) | Desnecessário |
| unreported MSSQL connections API error | Não relatados | [PR #50194](https://github.com/qgis/QGIS/pull/50194) | [PR #50454](https://github.com/qgis/QGIS/pull/50454) |
...
| Unreported endless alg splitwithlines | Não relatados | [PR #50279](https://github.com/qgis/QGIS/pull/50279) | Not recommended |
...
| Wrong label size for SLD export/import | [#35561](https://github.com/qgis/QGIS/issues/35561) | [PR #50347](https://github.com/qgis/QGIS/pull/50347) | Desnecessário |
...
| WFS/QgsOapifProvider does not take the pageSize from the dialog into account | [#49404](https://github.com/qgis/QGIS/issues/49404) | [PR #50236](https://github.com/qgis/QGIS/pull/50236) | Desnecessário |
...
| \[Processing\] Fix typo in smoothing parameter name of gdal_grid algorithms | Não relatados | [PR #50261](https://github.com/qgis/QGIS/pull/50261) | [PR #50331](https://github.com/qgis/QGIS/pull/50331) |
...
| world_map.gpkg: little fix to avoid warning with recent GDAL versions | Não relatados | [PR #50304](https://github.com/qgis/QGIS/pull/50304) | Desnecessário |
...
| Fixes log messages when a job error is not related to a specific layer | Não relatados | [PR #50372](https://github.com/qgis/QGIS/pull/50372) | Desnecessário |
...
| Improve selection of PostGIS raster overviews | Não relatados | [PR #50554](https://github.com/qgis/QGIS/pull/50554) | [PR #50575](https://github.com/qgis/QGIS/pull/50575) |
...
| Include type name in message about unsupported qfield validations | Não relatados | [PR #50589](https://github.com/qgis/QGIS/pull/50589) |  |
