...
| Título do bug | URL issues.qgis.org (se relatado) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| Wrong raster projection on HIDPI screens | [#46882](https://github.com/qgis/QGIS/issues/46882) | [PR #46931](https://github.com/qgis/QGIS/pull/46931) | A Fazer |
| Data Source Manager title not translatable | [#46929](https://github.com/qgis/QGIS/issues/46929) | [PR #46932](https://github.com/qgis/QGIS/pull/46932) | A Fazer |
...
| Virtual layer not loaded correctly after re-opening a project | [#46834](https://github.com/qgis/QGIS/issues/46834) | [PR #46938](https://github.com/qgis/QGIS/pull/46938) | A Fazer |
| QGIS crashes while calling readLayerXml() | [#46741](https://github.com/qgis/QGIS/issues/46741) | Works for me |  |
| Crash when changing orientation of page in layout | [#46575](https://github.com/qgis/QGIS/issues/46575) | [PR #46972](https://github.com/qgis/QGIS/pull/46972) | A Fazer |
| \"sort\" funcionality of attributes table sort numeric fields as text | [#34935](https://github.com/qgis/QGIS/issues/34935) | [PR #47035](https://github.com/qgis/QGIS/pull/47035) | A Fazer |
| OAPIF: api-key not included when requesting /collections endpoint | [#46535](https://github.com/qgis/QGIS/issues/46535) | [PR #47145](https://github.com/qgis/QGIS/pull/47145) | A Fazer |
| XML notation if missing from tooltips in vector file writer dialog | [#46508](https://github.com/qgis/QGIS/issues/46508) | [PR #47148](https://github.com/qgis/QGIS/pull/47148) | A Fazer |
| Ignore out of range option in interpolated symbol renderer creates artifacts if start value is out of range | [#46362](https://github.com/qgis/QGIS/issues/46362) | [PR #47174](https://github.com/qgis/QGIS/pull/47174) | A Fazer |
| start width \> end width is ignored when using the \"exact\" color interpolation method | [#46371](https://github.com/qgis/QGIS/issues/46371) | [PR #47195](https://github.com/qgis/QGIS/pull/47195) | A Fazer |
...
| (Un)force hide form in relation widget | [#47226](https://github.com/qgis/QGIS/issues/47226) | [PR #47245](https://github.com/qgis/QGIS/pull/47245) | A Fazer |
...
| HTML/String-ish QByteArray as result of expression function breaks expression preview display | [#46174](https://github.com/qgis/QGIS/issues/46174) | [PR #47229](https://github.com/qgis/QGIS/pull/47229) | A Fazer |
...
| Layout Attribute Table sorting does not work in Print Layouts when column name has spaces | [#43744](https://github.com/qgis/QGIS/issues/43744) | [PR #47249](https://github.com/qgis/QGIS/pull/47249) | A Fazer |
...
| fix server crash | não relatado | [PR #47271](https://github.com/qgis/QGIS/pull/47271) | A Fazer |
| Load QGIS project from command line from a PostgreSQL project | [#47270](https://github.com/qgis/QGIS/issues/47270) | [PR #47272](https://github.com/qgis/QGIS/pull/47272) | A Fazer |
...
| Value map widget: \"value\"/\"description\" inconsistency when table added to print layouts | [#41798](https://github.com/qgis/QGIS/issues/41798) | [PR #47300](https://github.com/qgis/QGIS/pull/47300) | A Fazer |
| Missing entries in attributetable in layout with atlas at page break | [#44086](https://github.com/qgis/QGIS/issues/44086) | [PR #47303](https://github.com/qgis/QGIS/pull/47303) | A Fazer |
| Server OAPIF: bbox filter isn\'t working if data source CRS is not EPSG:4326/WGS84 | [#47302](https://github.com/qgis/QGIS/issues/47302) | [PR #47318](https://github.com/qgis/QGIS/pull/47318) | A Fazer |
...
| Fixes to QgsGeometry::addPart + new test cases | não relatado | [PR #47009](https://github.com/qgis/QGIS/pull/47009) |  |
...
| Wrong signature of the QgsProcessingParameterMeshDatasetGroups when exporting to Python | não relatado | [PR #47152](https://github.com/qgis/QGIS/pull/47152) | [PR #47156](https://github.com/qgis/QGIS/pull/47156) |
...
| Fix output filename when a raster is saved in a format without extension | não relatado | [PR #46992](https://github.com/qgis/QGIS/pull/46992) | A Fazer |
| WFS GetFeature document and exceptions | não relatado | [PR #47198](https://github.com/qgis/QGIS/pull/47198) | A Fazer |
| Exluding a print layout in project propteries -\> server do not avoid that a GetPrint request can be done for that layout | [#46140](https://github.com/qgis/QGIS/issues/46140) | [PR #47199](https://github.com/qgis/QGIS/pull/47199) | A Fazer |
...
| Fix line anchor placements are reversed for labels which sit below lines | não relatado | [PR #47181](https://github.com/qgis/QGIS/pull/47181) | [PR #47181](https://github.com/qgis/QGIS/pull/47181) |
| Fix incorrect return code from QgsProcessingModelAlgorithm::fromFile when file does not exist | não relatado | [PR #47161](https://github.com/qgis/QGIS/pull/47161) | [PR #47162](https://github.com/qgis/QGIS/pull/47162) |
| Fix many georeferencer regressions | multiple | não relatado | pending |
...
| Fix sqlite errors on startup caused by default style database import logic | não relatado | [PR #47070](https://github.com/qgis/QGIS/pull/47070) | not suitable |
| Fix color widgets incorrectly change colors when mouse is hovered over widget | não relatado | [PR #47069](https://github.com/qgis/QGIS/pull/47069) | [PR #47077](https://github.com/qgis/QGIS/pull/47077) |
...
| Fix duplicate shortcut registered warning on startup | não relatado | [PR #46983](https://github.com/qgis/QGIS/pull/46983) | not suitable |
| Fix scroll wheel events get \"stuck\" when scrolling to bottom of areas | não relatado | [PR #46958](https://github.com/qgis/QGIS/pull/46958) | [PR #46987](https://github.com/qgis/QGIS/pull/46987) |
...
| Fix broken merge features tool | não relatado | [PR #46924](https://github.com/qgis/QGIS/pull/46924) | n/a |
