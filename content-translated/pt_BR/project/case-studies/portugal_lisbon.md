...
title: O Uso do QGIS para mapear Áreas Hotspot para Biodiversidade e Serviços de Ecossistema
  (HABEaS)
type: case-study

---
{{<content-start >}}
# O Uso do QGIS para mapear Áreas Hotspot para Biodiversidade e Serviços de Ecossistema (HABEaS)
...
O principal objectivo desta plataforma é proporcionar livre acesso a uma ampla variedade de dados sobre biodiversidade e serviços de ecossistemas para a Bacia do Mediterrâneo que foi espalhados por uma série de entidades públicas e privadas. Atualmente HABEaS WebGIS abrange o sul de Portugal, mas até o final de 2012 / início de 2013 ele será expandida para o norte de Portugal e também para a Tuzla Canton na Bósnia e Herzegovina. No longo prazo, nós queremos expandir essa ferramenta para toda a bacia do Mediterrâneo.
...
Para determinar que valores de conservação ocorre em cada propriedade nós usámos o Modelador SEXTANTE para criar um script que intersecta todos as camadas HABEaS com os limites da propriedade. Usando a mesma ferramenta nós conseguimos também criar um script que automaticamente calcula a quantidade de carbono que actualmente é armazenada em cada propriedade.

![](../images/portugal_lisbon4.jpg)
## Conclusões
QGIS é fácil de usar e tem recursos de geoprocessamento muito poderosos. A integração de GRASS SIG e ferramentas SAGA SIG através da ferramenta SEXTANTE nos permitiu realizar uma série de análises espaciais complexas e alinhá-los usando SEXTANTE Modeler. Foi também muito fácil produzir mapas de alta qualidade com o novo Printer Composer e exportá-los em formato SVG para posterior edição com o Inkscape, que é um poderoso editor de gráficos vetoriais em código aberto.
