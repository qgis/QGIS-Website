...
A colecção de fotogramas é de grande interesse para a investigação (ex.: Godone et al, 2014) e em ambientes profissionais (Figura 4). Agora devido aos procedimentos descritos e as ferramentas, a colecção está completamente acessível desde 2009, e os fotogramas são usados em vários projectos, seja internamente e externamente ao Instituto. as características do QGIS e os seus módulos permitiram desenvolver ferramentas e procedimentos que optimizaram o arquivo de fotogramas quer na implementação quer na sua gestão e a sua exploração.
...
Franco Godone é um técnico especializado no Instituto de Investigação para Protecção Geo-Hidrológica de Turin (IRPI-CNR) desde 1972. Ele está envolvido nos levantamentos topográficos e aéreo-fotogramétricos e análise de dados nas regiões alpinas.
