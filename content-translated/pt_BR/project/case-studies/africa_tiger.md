...
title: 'Sistema de Informação de Observação de Água: Permitindo o Uso de Dados de
  Observação na Terra para a Gerenciamento Integrado de Recursos Hídricos na África'
type: case-study
