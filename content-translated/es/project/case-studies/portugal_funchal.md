...
title: 'Usando un GIS libre en la Escuela Secundaria Jaime Moniz: QGIS'
type: case-study

---
{{<content-start >}}
# Usando un GIS libre en la Escuela Secundaria Jaime Moniz: QGIS
...
## Del aula a la comunidad educativa
...
## Conclusión
En un análisis retrospectivo de todo el proceso, siento que la idea de usar QGIS como herramienta, para lograr algunos propósitos de enseñanza, fue una excelente elección. Al principio, su uso trajo mucha expectación. Nunca antes había usado SIG y, por lo tanto, estaba aprendiendo y enseñando al mismo tiempo. El hecho de que el SIG resultó ser extremadamente fácil de usar en conjunto, con la información disponible en línea, fue una bendición para mí. Además, la escuela no tenía que pagar por otra licencia de software ni dependía de las renovaciones de licencias, lo que mejoraba sustancialmente la calidad de la enseñanza, sin gastos adicionales. En la actualidad, los estudiantes casi usan solo QGIS para lograr sus diferentes planes de trabajo. Espero que el resultado final muestre la cantidad de esfuerzo involucrado en todo el proceso de aprendizaje.
## Referencias
...
Este artículo fue elaborado en marzo de 2011 por Fátima Vale con el apoyo de Luís Antunes (supervisor de los estudiantes en DRIGOT). En ese momento, es maestra en la Escuela Secundaria Jaime Moniz y maestra supervisora durante el período de formación de los estudiantes en las diferentes instituciones.
