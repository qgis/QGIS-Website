...
title: QGIS y GRASS aplicado al reconocimiento paleontológico en el oeste de Portugal
type: case-study

---
{{<content-start >}}
# QGIS y GRASS aplicado al reconocimiento paleontológico en el oeste de Portugal
...
- Estudio de Campo con GPS Diferencial para colectar las coordenadas de los sitios;
- Construir un modelo de riesgo para identificar los peligros para el patrimonio paleontológico y así prevenirlos a través de estudios de campo regulares;
- Construir una Base de Datos Geográfica para manejar toda la información e iniciar el inventario de la colección.

## Software que usamos
QGIS fue el marco principal de todo el proyecto. Los datos se volcaron directamente a QGIS y luego se editaron y manipularon para lograr los resultados deseados. La interfaz GRASS proporcionada por QGIS nos permitió realizar análisis espaciales complejos en rásteres para obtener el modelo de riesgo que necesitábamos para planificar nuestro trabajo de campo y prospección futura. Además, nos permitió importar capas PostGIS y visualizarlas en QGIS.
