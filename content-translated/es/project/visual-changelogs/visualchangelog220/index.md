...
section: proyecto
sidebar: true
title: Registro de cambios para QGIS 2.2
type: visual-changelog

---
{{<content-start >}}
# Registro de cambios para QGIS 2.2{#changelog22 }
Fecha de lanzamiento: 2014-02-22

Registro de cambios para la próxima versión de QGIS 2.2.0. El énfasis en esta versión se ha centrado mucho en el pulido y el rendimiento: hemos agregado muchas características nuevas, ajustes y mejoras para hacer que la interfaz de usuario sea más consistente y de aspecto profesional (y con suerte más fácil de usar). Al compositor (utilizado para crear mapas listos para imprimir) se le ha dedicado mucho trabajo para que sea una plataforma más viable para obtener grandes resultados cartográficos.
...
### Característica: Soporte para la medición en Millas Náuticas
...
### Característica: Soporte para relaciones uno a muchos
...
### Característica: Herramienta de Exportación DXF
...
### Característica: Pegar como nueva capa vector
...
### Característica: gráfico leyenda WMS en tabla de contenido y diseñador
...
## Digitalizando
### Función: herramienta de relleno digitado en anillo
...
## General
### Característica: Expresiones recientes guardadas
El constructor de expresiones ahora recordará las últimas 20 expresiones usadas.

![image7](images/entries/90a6b4d181fb2dc7699402d17c1f31522c4f3409.webp)
### Característica: Pegar WKT desde el portapapeles
...
## Compositor de Mapa
### Característica: Mejoras para bordes de mapa zebra
...
### Característica: Soporte para rotación de elemento
Todo tipo de elemento en el diseñador de impresión ahora se puede rotar, incluyendo barra de escala, tablas y leyendas. Por ejemplo, puede rotar una etiqueta en el diseñador de manera que se ajuste mejor a su diseño de página (como se ilustra). Cambiar el tamaño de los elementos rotados también ha sido mejorada.

![image9](images/entries/700e0999552bc2e2bb2cef86ed14240b05f1da4e.webp)
### Característica: Adicionada escala en diseñado y mejoras de la regla
...
### Característica: Generación de archivo World
...
### Característica: Trabajando con múltiples elementos
...
### Característica: Mejoras de atlas
...
### Característica: Selección de elemento mejorada
...
### Característica: Mejor navegación de composiciones
...
### Característica: Estilo mejorado de páginas y formas
...
## Servidor de QGIS
### Característica: Soporte WCS adicionado al Servidor QGIS
QGIS-Server ya admite estándares: Servicio de mapas web (WMS versión 1.3.0 y 1.1.1) y Servicio de entidades web (WFS versión 1.0.0) y Servicio web de entidades con transacciones (WFS-T). Con esta nueva versión de QGIS, ahora puede servir capas ráster utilizando el estándar del Servicio de cobertura web (WCS versión 1.0.0).

![image13](images/entries/b93abbe00e7a32ffb06144ac839619ab50521e5c.webp)
## Simbología
### Característica: Soporte para llenado de gradiente
La nueva función de relleno con degradado le permite crear una cartografía aún mejor que nunca. La función tiene numerosas opciones que proporcionan una gran flexibilidad en la forma de aplicar degradados a sus presentaciones. Estas incluyen:
- Rellenos de dos colores o basados en rampa
- Origen basado en tela u objeto para sus gradientes
- Gradientes que se originan en el centroide de la entidad
- Tipos gradientes cónico, lineal y radial
- Opciones definidas por datos (para usar una expresión o una columna de tabla) para todas las propiedades de gradiente.
...
### Prestación: Soporte de etiquetas para rasters paletizados
Los rásteres que usan una paleta de colores fija (típico, por ejemplo, en un mapa de cobertura del suelo) ahora pueden tener etiquetas asignadas por categorías que se mostrarán en la leyenda del mapa y en la leyenda del compositor.

![image15](images/entries/232d60f2aa3accb19eb4da3a08b75ad4c15d068a.webp)
### Característica: Las rampas de colores pueden ser invertidas
Se ha adicionado una nueva opción a los diálogos de simbología que tienen rampas de color para permitirle invertir la rampa de color cuando es creada.

![image16](images/entries/3b1e65705f751bb468cc6495267633d613edbe34.webp)
### Característica: Copiar y Pegar basado en representador
En el renderizador basado en reglas, ahora puede hacer clic derecho en una regla y luego copiar y pegar la regla como una nueva regla.

![image17](images/entries/8e69ef57ed6ae838e813d798312d7d1e39913749.webp)
### Característica: Generalización de entidades al vuelo
QGIS 2.2 presenta soporte para la generalización de funciones sobre la marcha. Esto puede mejorar los tiempos de renderizado al dibujar muchas entidades complejas a escalas pequeñas. Esta característica se puede habilitar o deshabilitar en la configuración de la capa. También hay una nueva configuración global que permite la generalización de forma predeterminada para las capas recién agregadas. **Nota:** La generalización de entidades puede introducir artefactos en su salida renderizada en algunos casos. Estos pueden incluir astillas en polígonos y renderizado incorrecto cuando se usan capas de símbolos basadas en desplazamiento.

![image18](images/entries/baa801841f58883d93d0ea6ecb5363da963e4ee2.webp)
### Característica: Puntos ancla pueden definirse para capas marcador
...
### Característica: Mapas temáticos basados en expresiones
Ahora se pueden crear mapas temáticos categorizados y graduados utilizando el resultado de una expresión. En el cuadro de diálogo de propiedades para capas vectoriales se ha aumentado el selector de atributos con un generador de expresiones. Ahora ya no necesita escribir el atributo de clasificación en una nueva columna en su tabla de atributos si desea que el atributo de clasificación sea un compuesto de múltiples campos o una fórmula de algún tipo.

![image20](images/entries/cc5cad88da77d1868e394a115606f4b1e6ee8c29.webp)
### Característica: Soporte de expresión en diagramas de símbolo para tamaño y atributos
...
### Característica: Regla Else en representador basado en reglas
El procesador basado en reglas ahora admite una regla ELSE que se ejecutará si ninguna de las otras reglas en ese nivel coincide. Las reglas Else pueden anidarse como cualquier otra regla.
...
### Característica: Soporte de contorno interno para polígonos
Se ha agregado soporte para que los trazos de polígono se limiten al interior del polígono (para que no se desborde en un polígono vecino).
...
## Interfaz de usuario
### Característica: Diálogos de propiedades mejorados
Todos los diálogos de propiedades han tenido sus menús principales actualizados para que se viera mas pulido, con una barra lateral de color inverso. Esto es puramente estético pero debe hacerlo más fácil saber cual es el contexto actual en un diálogo.

![image24](images/entries/9d817847f89a3ea7836f86ddff3317040543a78f.webp)
### Característica: Mejoras en diálogo de expresiones
...
### Característica: Nuevos keybindings
Hemos actualizado los atajos de teclado en QGIS para hacerlo mas eficiente para llevar a cabo tareas repetitivas.
