...
| Título del Error | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Virtual raster provider memory leak - memory not released until QGIS closed | [\#64559](https://github.com/qgis/QGIS/issues/64559) | [PR \#64785](https://github.com/qgis/QGIS/pull/64785) | PORHACER. |
...
| Raster Attribute Table for S-102 does not display correctly | [\#64797](https://github.com/qgis/QGIS/issues/64797) | [PR \#64811](https://github.com/qgis/QGIS/pull/64811) | PORHACER. |
...
| SpatiaLite provider returns wrong schema for views (caches columns from underlying joined tables instead of view definition) | [\#64742](https://github.com/qgis/QGIS/issues/64742) | [PR \#64902](https://github.com/qgis/QGIS/pull/64902) | PORHACER. |
...
| \[ogr\] Add OGR_L_GetAttributeFilter | [\#65067](https://github.com/qgis/QGIS/issues/65067) | [PR \#14005](https://github.com/OSGeo/gdal/pull/14005) | N/D |
...
| Rendering of PostGIS rasters ignores Transparency NoData value setting | [\#63171](https://github.com/qgis/QGIS/issues/63171) | [PR \#63258](https://github.com/qgis/QGIS/pull/63258) | Sí |
...
| QGIS Server Layer(s) not valid Exception with multiple projects using same WMS Layer | [\#62608](https://github.com/qgis/QGIS/issues/62608) | No puede reproducir |  |
...
| NetCDF with EPSG:3416 misaligned is latest qgis ltr | [\#64873](https://github.com/qgis/QGIS/issues/64873) | [PR \#13886](https://github.com/OSGeo/gdal/pull/13886) | N/D |
...
| QgsVectorFileWriter: fix writing NurbsCurve to OGR, by converting them to LineString | No reportado | [PR \#64906](https://github.com/qgis/QGIS/pull/64906) | N/D |
| Build issue on NixOS | [\#64937](https://github.com/qgis/QGIS/issues/64937) | No válido |  |
...
| building master in pkgsrc; mostly ok! | [mail thread](https://lists.osgeo.org/pipermail/qgis-developer/2026-February/068072.html) | No es un error |  |
| Rasters with GCPs and overviews render incorrectly when zoomed out | [\#65011](https://github.com/qgis/QGIS/issues/65011) | [PR \#13968](https://github.com/OSGeo/gdal/pull/13968) | N/D |
...
| Replace all remaining uses of connect(,SIGNAL,,SLOT) in src/ | No reportado | [PR \#63832](https://github.com/qgis/QGIS/pull/63832) | N/D |
...
| Fix build warnings on Fedora | No reportado | [PR \#63910](https://github.com/qgis/QGIS/pull/63910) | N/D |
| Fix cppcheck missingOverride and functionConst warnings | No reportado | [PR \#63913](https://github.com/qgis/QGIS/pull/63913) | N/D |
| \[CI\] Port OGC tests to ubuntu:25.10 Qt6 | No reportado | [PR \#64135](https://github.com/qgis/QGIS/pull/64135) | N/D |
...
| \[PyQt5_to_PyQt6\] Fix all imports coming from Qt module | No reportado | [PR \#63565](https://github.com/qgis/QGIS/pull/63565) |  |
...
| Broken themes in geospatial PDF | [\#62014](https://github.com/qgis/QGIS/issues/62014) | [PR \#63580](https://github.com/qgis/QGIS/pull/63580) | PORHACER. |
...
| The "Session Role" function is not applied to loaded layers | [\#62930](https://github.com/qgis/QGIS/issues/62930) | Ya corregida |  |
| set session role not working on creation of tables and schema | [\#63866](https://github.com/qgis/QGIS/issues/63866) | No se ha podido reproducir |  |
| Layout export to GeoPDF: incorrect layers' order when a "PDF Group" is set | [\#63475](https://github.com/qgis/QGIS/issues/63475) | [PR \#64983](https://github.com/qgis/QGIS/pull/64983) | PORHACER. |
| pyqt5_to_pyqt6.py: Some suggestions reference wrong class | [\#64462](https://github.com/qgis/QGIS/issues/64462) | [PR \#64989](https://github.com/qgis/QGIS/pull/64989) | PORHACER. |
...
| Crash in layer styling panel when closing a project if DD Property Assistant is open | No reportado | [PR \#63549](https://github.com/qgis/QGIS/pull/63549) |  |
| QGIS crashes when opening print layout | [\#64218](https://github.com/qgis/QGIS/issues/64218) | [PR \#64813](https://github.com/qgis/QGIS/pull/64813) | N/D |
| Fix custom node initialization for custom elevation profiles | [\#65058](https://github.com/qgis/QGIS/issues/65058) | [PR \#64762](https://github.com/qgis/QGIS/pull/64762) | N/D |
...
| Attributes Form is not the same when called via GUI or when called via PyQGIS | [\#65010](https://github.com/qgis/QGIS/issues/65010) | No es un error |  |
| Layers added using a .qlr file cannot be added to an open Elevation Profile View | [\#58533](https://github.com/qgis/QGIS/issues/58533) | Ya corregida |  |
...
| Fix 3d view shortcuts | No reportado | [PR \#63523](https://github.com/qgis/QGIS/pull/63523) |  |
| Fix zooming with right mouse button in 3D views | No reportado | [PR \#63537](https://github.com/qgis/QGIS/pull/63537) |  |
| Fix 3d point lights | No reportado | [PR \#63525](https://github.com/qgis/QGIS/pull/63525) |  |
...
| \[3D\] Avoid clamping vertices to actual nodata value | No reportado | [PR \#64845](https://github.com/qgis/QGIS/pull/64845) |  |
| Data corruption using "Split Features" on a LineStringZ in GeoJSON | [\#63581](https://github.com/qgis/QGIS/issues/63581) | [PR \#64986](https://github.com/qgis/QGIS/pull/64986) | Pendiente |
...
| Fix sip_include.sh after pyqt5 removal | No reportado | [PR \#64974](https://github.com/qgis/QGIS/pull/64974) | N/D |
| Make the extent widget hold the full precision of the chosen extent | No reportado | [PR \#64919](https://github.com/qgis/QGIS/pull/64919) |  |
| Fix endless terrain levels generation | No reportado | [PR \#64875](https://github.com/qgis/QGIS/pull/64875) |  |
| Always check pointer initialized inside if initializer | No reportado | [PR \#64871](https://github.com/qgis/QGIS/pull/64871) |  |
...
| Tidy includes in point clouds and 3d code | No reportado | [PR \#64820](https://github.com/qgis/QGIS/pull/64820) |  |
| Remove code for QT version \< 6.6 | No reportado | [PR \#64809](https://github.com/qgis/QGIS/pull/64809) |  |
| Plugin installer can leave a plugin in a broken state on failed upgrade | [\#64790](https://github.com/qgis/QGIS/issues/64790) | [PR \#64807](https://github.com/qgis/QGIS/pull/64807) | PORHACER. |
| Avoid module wide QtConcurrent imports | No reportado | [PR \#64775](https://github.com/qgis/QGIS/pull/64775) |  |
| Avoid crash when edit-in-place layer is removed | No reportado | [PR \#65107](https://github.com/qgis/QGIS/pull/65107) | Topo |
...
| Some feature are not rendered in a 3d map view when using rule based renderer | [\#47581](https://github.com/qgis/QGIS/issues/47581) | Ya corregida |  |
...
| Título del Error | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgs3daxis: Fix axis label visibility in qt6 | No reportado | [PR \#63585](https://github.com/qgis/QGIS/pull/63585) |  |
| qgs3daxis: Fix cube picking in qt6 when clicking on a label | No reportado | [PR \#63585](https://github.com/qgis/QGIS/pull/63585) |  |
| \[3D\] fix terrain obj export | No reportado | [PR \#63173](https://github.com/qgis/QGIS/pull/63173) |  |
...
| Fix handling of tiled scene and vector tile layers in Processing | No reportado | [PR \#63323](https://github.com/qgis/QGIS/pull/63323) | [PR \#63343](https://github.com/qgis/QGIS/pull/63343) |
...
| Fix crash and wrong coordinate order in the WCS source widget | No reportado | [PR \#63615](https://github.com/qgis/QGIS/pull/63615) | [PR \#63632](https://github.com/qgis/QGIS/pull/63632) |
| Fix several issues with geometry check algorithms | No reportado | [PR \#63304](https://github.com/qgis/QGIS/pull/63304) |  |
| WCS Request fails due to wrong BBox using "Map Canvas Extent" or "Draw on Canvas" | [\#62528](https://github.com/qgis/QGIS/issues/62528) | [PR \#63542](https://github.com/qgis/QGIS/pull/63542) | PORHACER. |
| wcs spatial extent uses wrong projection | [\#50432](https://github.com/qgis/QGIS/issues/50432) |  |  |
| String aggregate-related functions treat NULL and empty strings interchangeably | [\#35433](https://github.com/qgis/QGIS/issues/35433) | [PR \#63324](https://github.com/qgis/QGIS/pull/63324) | PORHACER. |
...
| Título del Error | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix nothing happens when zooming to very small line feature extent | No reportado | [PR \#65215](https://github.com/qgis/QGIS/pull/65215) | [PR \#65274](https://github.com/qgis/QGIS/pull/65274) |
| Don't immediately validate child algorithms in models | No reportado | [PR \#65183](https://github.com/qgis/QGIS/pull/65183) | N/D |
| \[browser\] Don't permit renaming tables which are open in the current project | No reportado | [PR \#65182](https://github.com/qgis/QGIS/pull/65182) | N/D |
| Extend timeout for processing executable tests | No reportado | [PR \#65161](https://github.com/qgis/QGIS/pull/65161) | [PR \#65224](https://github.com/qgis/QGIS/pull/65224) |
| Downgrade thread safety check to non-fatal | No reportado | [PR \#65148](https://github.com/qgis/QGIS/pull/65148) | N/D |
...
| \[server\] Fix completely broken service url setting handling | No reportado | [PR \#65117](https://github.com/qgis/QGIS/pull/65117) | [PR \#65226](https://github.com/qgis/QGIS/pull/65226) |
| Fix broken value range when calling deprecated setComponentValue int variant | No reportado | [PR \#65115](https://github.com/qgis/QGIS/pull/65115) | [PR \#65135](https://github.com/qgis/QGIS/pull/65135) |
| \[wms\] Fix regression in encode/decodeUri | No reportado | [PR \#65114](https://github.com/qgis/QGIS/pull/65114) | N/D |
| Fix a bunch of python tests weren't actually run on CI | No reportado | [PR \#65113](https://github.com/qgis/QGIS/pull/65113) |  |
| Fix assert triggered on qt6 builds | No reportado | [PR \#65079](https://github.com/qgis/QGIS/pull/65079) | N/D |
| \[gdal\] Fix openfilegdb raster path decoding/encoding | No reportado | [PR \#65078](https://github.com/qgis/QGIS/pull/65078) | [PR \#65096](https://github.com/qgis/QGIS/pull/65096) |
| Fix mdb files not shown in browser for non-windows platforms | No reportado | [PR \#65077](https://github.com/qgis/QGIS/pull/65077) | [PR \#65098](https://github.com/qgis/QGIS/pull/65098) |
| Fix failing dock widget test on newer Qt versions | No reportado | [PR \#65073](https://github.com/qgis/QGIS/pull/65073) | N/D |
| \[browser\] Prevent deletion or rename of fields when table is open in project | No reportado | [PR \#64958](https://github.com/qgis/QGIS/pull/64958) | No apto |
| Fix strict curved label anchoring when placement is on line | No reportado | [PR \#64736](https://github.com/qgis/QGIS/pull/64736) | [PR \#64801](https://github.com/qgis/QGIS/pull/64801) |
...
| Ensure QString and Qt::StringLiterals namespace are present when needed | No reportado | [PR \#64724](https://github.com/qgis/QGIS/pull/64724) | N/D |
