...
| Open Feld Calculator Crash | [#55898](https://github.com/qgis/QGIS/issues/55898) | retroalimentación |  |
| Secured WMS regression in 3.28 / 3.34?; service does not load but loads in earlier QGIS versions / other wms clients. | [#55984](https://github.com/qgis/QGIS/issues/55984) | Trabaja para mí |  |
...
| Attribute table frame, with "allow url to be read as HTML format" has not expected result like hyperlink when output PDF file is maked from "GetPrint" request from QGIS Server | [#52370](https://github.com/qgis/QGIS/issues/52370) | No es un error |  |
| WMS provider Cannot calculate extent error adding a WMTS layer from QGIS server | [#47349](https://github.com/qgis/QGIS/issues/47349) | Trabaja para mí |  |
| Raster Calculator Raster Menu - on the fly layer name gives issues | [#55890](https://github.com/qgis/QGIS/issues/55890) | [PR #56067](https://github.com/qgis/QGIS/pull/56067) | PORHACER. |
...
| Running VACUUM via browser shows an error messages without identififiers | [#56377](https://github.com/qgis/QGIS/issues/56377) | [PR #56380](https://github.com/qgis/QGIS/pull/56380) | PORHACER. |
| SHP: Fix unreported issue with spatialindex | no reportado | [PR #56366](https://github.com/qgis/QGIS/pull/56366) | [PR #56399](https://github.com/qgis/QGIS/pull/56399) |
| WFS sublayer is missing when FeatureType is added from QGIS browser | [#56403](https://github.com/qgis/QGIS/issues/56403) | [PR #56404](https://github.com/qgis/QGIS/pull/56404) | PORHACER. |
...
| Hang/Crash when attempting to drag&drop multiple layers into gpkg | [#29510](https://github.com/qgis/QGIS/issues/29510) | [PR #55950](https://github.com/qgis/QGIS/pull/55950) | PORHACER. |
...
| [PostgreSQL provider] Add missing namespace escaping in SQL requests | no reportado | [PR #56173](https://github.com/qgis/QGIS/pull/56173) | [PR #56186](https://github.com/qgis/QGIS/pull/56186) |
| Export Save features to gpkg does not keep Field Domains, but using Convert Format does | [#56184](https://github.com/qgis/QGIS/issues/56184) | [PR #56209](https://github.com/qgis/QGIS/pull/56209) | No apropiado |
...
| Catch potential QgsCsException at various places; improve qgscoordinatetransform.h doc | no reportado | [PR #56212](https://github.com/qgis/QGIS/pull/56212) | [PR #56244](https://github.com/qgis/QGIS/pull/56244) |
...
| Título del Error | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Oracle database connection lists table multiple times | [#55961](https://github.com/qgis/QGIS/issues/55961) | PORHACER. |  |
...
| Harmonize use of password lineedit in auth method editors | no reportado | [PR #55970](https://github.com/qgis/QGIS/pull/55970) |  |
...
| Filling the Raster attribute tables tab with buttons should not be systematic in Layer Styling panel | [#55501](https://github.com/qgis/QGIS/issues/55501) | trabaja para mi |  |
| List of predefined scales in 2D map view does not update | [#51327](https://github.com/qgis/QGIS/issues/51327) | trabaja para mi |  |
| Data defined Assistant: closing the dialog without setting an expression invalidates the widget | [#24665](https://github.com/qgis/QGIS/issues/24665) | trabaja para mi |  |
...
| TIN: Enable fromWkb/fromWkt | no reportado | [PR #56071](https://github.com/qgis/QGIS/pull/56071) | no |
| [OGC] Polygon: fix rings order | no reportado | [PR #55306](https://github.com/qgis/QGIS/pull/55306) | no |
...
| Título del Error | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| [3D] disable altitude binding if altitude clamping is absolute | no reportado | [PR #56154](https://github.com/qgis/QGIS/pull/56154) | [PR #56198](https://github.com/qgis/QGIS/pull/56198) |
...
| Fix GUI freezing when changing raster renderer | no reportado | [PR #56000](https://github.com/qgis/QGIS/pull/56000) | [PR #56077](https://github.com/qgis/QGIS/pull/56077) |
...
| Allow deleting geometry part of singlepart features | no reportado | [PR #56279](https://github.com/qgis/QGIS/pull/56279) |  |
...
| Problem with Georeferencing Tool-QGIS 3.28.12 Firenze | [#55167](https://github.com/qgis/QGIS/issues/55167) | No es un error |  |
...
| Ensure that saving map [canvas] as image/PDF takes high DPI scaling factor into account | no reportado | [PR #56400](https://github.com/qgis/QGIS/pull/56400) |  |
| MBTiles layers are valid when dataset is missing | no reportado | [PR #56296](https://github.com/qgis/QGIS/pull/56296) | [PR #56298](https://github.com/qgis/QGIS/pull/56298) |
...
| DXF map theme style override not respected | no reportado | [PR #56162](https://github.com/qgis/QGIS/pull/56162) | [PR #56164](https://github.com/qgis/QGIS/pull/56164) |
...
| Pixelated QGIS logo in user profile selector dialog on high DPI screens | no reportado | [PR #56053](https://github.com/qgis/QGIS/pull/56053) | [PR #56065](https://github.com/qgis/QGIS/pull/56065) |
| Pixelated overview panel rendering on high DPI screens | no reportado | [PR #56050](https://github.com/qgis/QGIS/pull/56050) | [PR #56087](https://github.com/qgis/QGIS/pull/56087) |
| Welcome screen issues on high DPI screens | no reportado | [PR #56048](https://github.com/qgis/QGIS/pull/56048) | [PR #56084](https://github.com/qgis/QGIS/pull/56084) |
...
| Missing checkbox partially checked state styling for non-default themes | no reportado | [PR #56290](https://github.com/qgis/QGIS/pull/56290) | [PR #56306](https://github.com/qgis/QGIS/pull/56306) |
...
| Título del Error | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix broken coordinate transforms on qt6 builds | no reportado | [PR #55914](https://github.com/qgis/QGIS/pull/55914) | [PR #55935](https://github.com/qgis/QGIS/pull/55935) |
| Fix crash in QgsRasterPipe when removing roles | no reportado | [PR #55955](https://github.com/qgis/QGIS/pull/55955) | [PR #56008](https://github.com/qgis/QGIS/pull/56008) |
| Fix broken data defined override buttons in text format widget when no layer is associated | no reportado | [PR #55989](https://github.com/qgis/QGIS/pull/55989) | N/D |
| Avoid use of pygments in metasearch | no reportado | [PR #56160](https://github.com/qgis/QGIS/pull/56160) | N/D |
| Fixes filters applied to a duplicated AFS layer also incorrectly apply to the original layer | no reportado | [PR #56195](https://github.com/qgis/QGIS/pull/56195) | [PR #56221](https://github.com/qgis/QGIS/pull/56221) |
| [processing] Don't try to interpret distance widget value as CRS | no reportado | [PR #56292](https://github.com/qgis/QGIS/pull/56292) | [PR #56297](https://github.com/qgis/QGIS/pull/56297) |
...
| Fix calculation of string stats when nulls are present | no reportado | [PR #56305](https://github.com/qgis/QGIS/pull/56305) | [PR #56322](https://github.com/qgis/QGIS/pull/56322) |
| Don't use (broken) QgsCoordinateReferenceSystem::createFromSrsId method for virtual point clouds | no reportado | [PR #56325](https://github.com/qgis/QGIS/pull/56325) | [PR #56333](https://github.com/qgis/QGIS/pull/56333) |
| Make datetime stats range type consistent across Qt versions | no reportado | [PR #56355](https://github.com/qgis/QGIS/pull/56355) | [PR #56437](https://github.com/qgis/QGIS/pull/56437) |
| Fix crash in QgsStringUtils::truncateMiddleOfString on qt 6 | no reportado | [PR #56356](https://github.com/qgis/QGIS/pull/56356) | N/D |
| Fix handling of font family from HTML on Qt 6 builds | no reportado | [PR #56358](https://github.com/qgis/QGIS/pull/56358) | [PR #56436](https://github.com/qgis/QGIS/pull/56436) |
...
| Fix crash when applying vector properties dialog | no reportado | [PR #56412](https://github.com/qgis/QGIS/pull/56412) | N/D |
| Don't force calculate layer extents when saving layers | no reportado | [PR #56433](https://github.com/qgis/QGIS/pull/56433) | [PR #56444](https://github.com/qgis/QGIS/pull/56444) |
| Don't force full calculation of layer extent when cloning layers | no reportado | [PR #56434](https://github.com/qgis/QGIS/pull/56434) | N/D |
...
| Hundreds of fixes to PyQGIS for qt6 compatibility | N/D |  |  |
...
| Título del Error | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| 3D Tiles dataset without textures not shaded correctly | [#55752](https://github.com/qgis/QGIS/issues/55752) | [PR #56185](https://github.com/qgis/QGIS/pull/56185) | N/D |
...
| Fix a deadlock in remote COPC handling (3D views) | no reportado | [PR #56388](https://github.com/qgis/QGIS/pull/56388) | [PR #56419](https://github.com/qgis/QGIS/pull/56419) |
| Fix a crash in point cloud renderer when cleaning up preview painter | no reportado | [PR #56409](https://github.com/qgis/QGIS/pull/56409) | N/D |
| Fix a deadlock with local COPC files in 2D rendering | no reportado | [PR #56432](https://github.com/qgis/QGIS/pull/56432) | [PR #56458](https://github.com/qgis/QGIS/pull/56458) |
