...
| QGIS crashes while Export Data from a WFS-Service as DXF-File | [#57139](https://github.com/qgis/QGIS/issues/57139) | No puede reproducir |  |
...
| GDAL processing provider: "FutureWarning: Neither ogr.UseExceptions() nor ogr.DontUseExceptions() has been explicitly called" warning | [#57344](https://github.com/qgis/QGIS/issues/57344) | [PR #57477](https://github.com/qgis/QGIS/pull/57477) | No apropiado |
...
| QGIS cannot load feature classes from a .gdb with a 64bit ObjectID | [#57471](https://github.com/qgis/QGIS/issues/57471) | [GDAL PR 9980](https://github.com/OSGeo/gdal/pull/9980) | N/D |
...
| QGIS3.28.15:Polygon Features from ArcGIS GDB Turn into TABLE after Editing in QGIS | [#57536](https://github.com/qgis/QGIS/issues/57536) | [GDAL PR 10008](https://github.com/OSGeo/gdal/pull/10008) | N/D |
...
| Título del Error | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| QGIS Server GetFeatureInfo issue on WMTS layer | [#57441](https://github.com/qgis/QGIS/issues/57441) | [PR #57491](https://github.com/qgis/QGIS/pull/57491) | en cola |
| Cannot connect to SQL Server on QGis 3.34.3 | [#56136](https://github.com/qgis/QGIS/issues/56136) | No puede reproducir |  |
| Balloon annotations fails to adopt text formatting | [#57423](https://github.com/qgis/QGIS/issues/57423) | No puede reproducir |  |
| Generate XYZ tiles' does not render labels from ArcGIS Vector Tile Service layers | [#57443](https://github.com/qgis/QGIS/issues/57443) | [PR #57517](https://github.com/qgis/QGIS/pull/57517) | en cola |
| Empty space after host name in SQL server, cause inconsistent error | [#57358](https://github.com/qgis/QGIS/issues/57358) | [PR #57518](https://github.com/qgis/QGIS/pull/57518) | en cola |
| GDAL/OGR processing algorithms may silently output incorrect result if an input is a vector "memory" layer with a "fid" column | [#57343](https://github.com/qgis/QGIS/issues/57343) | [PR #57522](https://github.com/qgis/QGIS/pull/57522) | en cola |
| attribute table row sorting doesn't work | [#57338](https://github.com/qgis/QGIS/issues/57338) | [PR #57624](https://github.com/qgis/QGIS/pull/57624) | en cola |
| Unable to edit elements in the print layout after locking an element | [#57331](https://github.com/qgis/QGIS/issues/57331) | [PR #57543](https://github.com/qgis/QGIS/pull/57543) | en cola |
...
| Server: OAPIF/WFS3 service collection id missmatch | [#57556](https://github.com/qgis/QGIS/issues/57556) | [PR #57561](https://github.com/qgis/QGIS/pull/57561) | en cola |
...
| [ux][layouts] Fix legend item style mutex | no reportado | [PR #57605](https://github.com/qgis/QGIS/pull/57605) | N/D |
...
| QGIS Server wrongly positions the map objects in the output when there's more than one map | [#57631](https://github.com/qgis/QGIS/issues/57631) | No es un error |  |
...
| JSON-String not read from GPKG | [#57673](https://github.com/qgis/QGIS/issues/57673) | [PR #57707](https://github.com/qgis/QGIS/pull/57707) | N/D |
...
| Identify Results for raster data value does not use correct decimal separator | [#57765](https://github.com/qgis/QGIS/issues/57765) | [PR #57769](https://github.com/qgis/QGIS/pull/57769) | en cola |
...
| Título del Error | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Wrongly displayed action widget | [#33464](https://github.com/qgis/QGIS/issues/33464), [#57398](https://github.com/qgis/QGIS/issues/57398), [#56966](https://github.com/qgis/QGIS/issues/56966) | [PR #57475](https://github.com/qgis/QGIS/pull/57475) | No apropiado |
| Custom properties variableNames and variableValues are cleared when more than one layer custom variable exist | [#57334](https://github.com/qgis/QGIS/issues/57334) | [PR #57490](https://github.com/qgis/QGIS/pull/57490) | No apropiado |
| Default values depending on other fields are not correctly applied when field not part of form made by Drag and Drop Designer | [#57411](https://github.com/qgis/QGIS/issues/57411) | [PR #57527](https://github.com/qgis/QGIS/pull/57527) | No apropiado |
...
| Título del Error | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Source-tree documentation improvements | no reportado | [PR #57594](https://github.com/qgis/QGIS/pull/57594) |  |
...
| Título del Error | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Avoid crash on summary when error list is empty | no reportado | [PR #57658](https://github.com/qgis/QGIS/pull/57658) | [PR #57661](https://github.com/qgis/QGIS/pull/57661) |
...
| Qgis crashes while digitising lines | [#57617](https://github.com/qgis/QGIS/issues/57617) | No puede reproducir |  |
...
| Postgres layer with multi geometry columns fails to export | [#57757](https://github.com/qgis/QGIS/issues/57757) | No es un error |  |
...
| Título del Error | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgsabstractmaterialsettings: Handle selection in addParametersToEffect | no reportado | [PR #57803](https://github.com/qgis/QGIS/pull/57803) | not backported |
| qgs3daxis: Fix cube face picking | no reportado | [PR #57848](https://github.com/qgis/QGIS/pull/57848) |  |
...
| Título del Error | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix bugs relating to selective masking vector exports | [#50734](https://github.com/qgis/QGIS/issues/50734) | [PR #57843](https://github.com/qgis/QGIS/pull/57843) | Demasiado intrusivo |
| Fix bugs relating to selective masking vector exports | [#54788](https://github.com/qgis/QGIS/issues/54788) | [PR #57703](https://github.com/qgis/QGIS/pull/57703) | Demasiado intrusivo |
| Fix bugs relating to selective masking vector exports | [PR #57623](https://github.com/qgis/QGIS/pull/57623) | Demasiado intrusivo |  |
| Fix bugs relating to selective masking vector exports | [PR #57498](https://github.com/qgis/QGIS/pull/57498) | Demasiado intrusivo |  |
| Pressing escape should clear current identify results | [#47984](https://github.com/qgis/QGIS/issues/47984) | [PR #57774](https://github.com/qgis/QGIS/pull/57774) | N/D |
| Fix some grass vectors incorrectly show as datasets | no reportado | [PR #57780](https://github.com/qgis/QGIS/pull/57780) | [PR #57786](https://github.com/qgis/QGIS/pull/57786) |
...
| Limit fixed interval classification to generate at most 999 classes | [PR #50290](https://github.com/qgis/QGIS/pull/50290) | [PR #57722](https://github.com/qgis/QGIS/pull/57722) | No apropiado |
| Don't try to connect widget to null vector tile layers | no reportado | [PR #57721](https://github.com/qgis/QGIS/pull/57721) | N/D |
| Don't show invalid "Style not found in database" warning when adding vector tile layers | no reportado | [PR #57714](https://github.com/qgis/QGIS/pull/57714) | No apropiado |
| Replace processing default extension setting with string based setting | [#57676](https://github.com/qgis/QGIS/issues/57676) | [PR #57702](https://github.com/qgis/QGIS/pull/57702) | No apropiado |
...
| Fix add feature dialog does not restore position when shown modally | no reportado | [PR #57686](https://github.com/qgis/QGIS/pull/57686) | [PR #57700](https://github.com/qgis/QGIS/pull/57700) |
| Fix python script editor "open in external editor" action | no reportado | [PR #57682](https://github.com/qgis/QGIS/pull/57682) | No apropiado |
| Fix broken prefetch capabilities for raster layers | no reportado | [PR #57663](https://github.com/qgis/QGIS/pull/57663) | [PR #57667](https://github.com/qgis/QGIS/pull/57667) |
| Fix missing field type information in eg the horizontal header tooltips in attribute table | no reportado | [PR #57621](https://github.com/qgis/QGIS/pull/57621) | No apropiado |
| Don't try to paint to indexed image | no reportado | [PR #57601](https://github.com/qgis/QGIS/pull/57601) |  |
| Clamp values for set_color_part function to avoid qt warnings when out of range values are specified | no reportado | [PR #57600](https://github.com/qgis/QGIS/pull/57600) |  |
| Add some tests for rendering text with RTL markers | [PR #57586](https://github.com/qgis/QGIS/pull/57586) |  |  |
| Fix rotation based orientation when html labeling enabled | no reportado | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Demasiado intrusivo |
| Fix data defined font size is ignored when HTML labeling is active | no reportado | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Demasiado intrusivo |
| Don't set @value to line height when evaluating multi line alignment | no reportado | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Demasiado intrusivo |
...
| Fix incorrect buffers drawn for html label item | no reportado | [PR #57551](https://github.com/qgis/QGIS/pull/57551) | [PR #57571](https://github.com/qgis/QGIS/pull/57571) |
| Fix label mask sizes get reset to 0 | no reportado | [PR #57555](https://github.com/qgis/QGIS/pull/57555) | [PR #57569](https://github.com/qgis/QGIS/pull/57569) |
| Fix tab stops in legend text | [#56981](https://github.com/qgis/QGIS/issues/56981) | [PR #57554](https://github.com/qgis/QGIS/pull/57554) | N/D |
...
| Make brush and stroke style combo box icons visible on dark themes | no reportado | [PR #57506](https://github.com/qgis/QGIS/pull/57506) | [PR #57510](https://github.com/qgis/QGIS/pull/57510) |
