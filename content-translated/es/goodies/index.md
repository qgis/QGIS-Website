...
Comprar ropa de QGIS no solo le permite demostrar de que usas QGIS, sino que por cada camiseta vendida se da una comisión al proyecto QGIS.

{{<columns-start >}}

{{<column-start class="is-flex-direction-column is-one-third" >}}
## Spreadshirt
Cooperamos con Spreadshirt. Producen en la zona y envían los productos a todos los países del mundo.
...
{{<column-start class="is-flex-direction-column is-one-third" >}}
## Redbubble
Se pueden encontrar algunos diseños creativos y divertidos (pero no oficiales) en la tienda Red Bubble.
