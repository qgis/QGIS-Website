...
section: projekt
sidebar: true
title: Přehled změn pro QGIS 3.24
type: visual-changelog

---
{{<content-start >}}
# Přehled změn pro QGIS 3.24{#changelog324 }
![image1](images/projects/dce49bc182a307d8b4d60cfa0ba8caede109cf69.png)

Datum vydání: 2022-02-18
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| fix server crash | nehlášeno | [PR #47271](https://github.com/qgis/QGIS/pull/47271) | TODO |
...
| Filter for WFS layer: The \"Tables\" button is missing | [#46887](https://github.com/qgis/QGIS/issues/46887) | Není to chyba |  |
...
| Fixes to QgsGeometry::addPart + new test cases | nehlášeno | [PR #47009](https://github.com/qgis/QGIS/pull/47009) |  |
...
| Wrong signature of the QgsProcessingParameterMeshDatasetGroups when exporting to Python | nehlášeno | [PR #47152](https://github.com/qgis/QGIS/pull/47152) | [PR #47156](https://github.com/qgis/QGIS/pull/47156) |
...
| QgsProcessingParameterFile extension option | [#45633](https://github.com/qgis/QGIS/issues/45633) | Není to chyba |  |
...
| Fix output filename when a raster is saved in a format without extension | nehlášeno | [PR #46992](https://github.com/qgis/QGIS/pull/46992) | TODO |
| WFS GetFeature document and exceptions | nehlášeno | [PR #47198](https://github.com/qgis/QGIS/pull/47198) | TODO |
...
| Fix line anchor placements are reversed for labels which sit below lines | nehlášeno | [PR #47181](https://github.com/qgis/QGIS/pull/47181) | [PR #47181](https://github.com/qgis/QGIS/pull/47181) |
| Fix incorrect return code from QgsProcessingModelAlgorithm::fromFile when file does not exist | nehlášeno | [PR #47161](https://github.com/qgis/QGIS/pull/47161) | [PR #47162](https://github.com/qgis/QGIS/pull/47162) |
| Fix many georeferencer regressions | multiple | nehlášeno | pending |
...
| Fix sqlite errors on startup caused by default style database import logic | nehlášeno | [PR #47070](https://github.com/qgis/QGIS/pull/47070) | not suitable |
| Fix color widgets incorrectly change colors when mouse is hovered over widget | nehlášeno | [PR #47069](https://github.com/qgis/QGIS/pull/47069) | [PR #47077](https://github.com/qgis/QGIS/pull/47077) |
...
| Fix duplicate shortcut registered warning on startup | nehlášeno | [PR #46983](https://github.com/qgis/QGIS/pull/46983) | not suitable |
| Fix scroll wheel events get \"stuck\" when scrolling to bottom of areas | nehlášeno | [PR #46958](https://github.com/qgis/QGIS/pull/46958) | [PR #46987](https://github.com/qgis/QGIS/pull/46987) |
...
| Fix broken merge features tool | nehlášeno | [PR #46924](https://github.com/qgis/QGIS/pull/46924) | n/a |
