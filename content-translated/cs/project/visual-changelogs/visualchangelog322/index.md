...
section: projekt
sidebar: true
title: Přehled změn QGIS 3.22
type: visual-changelog

---
{{<content-start >}}
# Přehled změn QGIS 3.22{#changelog322 }
...
Tato funkce podporuje dva režimy chování s různými předvolbami výběru, a to následujícím způsobem:
- Budou vybrány prvky, které se dotýkají (výchozí nastavení), nebo částečně zahrnuté/protínající se prvky (zelená gumička).
...
- Odsazení položek skupiny
- Odsazení položek podskupiny
...
### Funkce: Podpora virtuálních rastrů v rastrové kalkulačce
Do rastrového kalkulátoru QGIS byla přidána podpora virtuálního poskytovatele rastrových dat, která nyní umožňuje uživatelům provádět operace s rastrovým kalkulátorem bez zadání výstupního souboru nebo zápisu výsledného rastru na disk.
...
Výsledné rastrové vrstvy lze použít při dalších analytických operacích a umožňují zadat názvy rastrů uživatelem. Pokud není pro výsledný rastr zadán název, bude pojmenován podle vzorce použitého k jeho vygenerování.

![image34](images/entries/844b2b463a26d035fe25d43d7221a24a570ac615.gif)

This feature was developed by [Francesco Bursi](https://github.com/Franc-Brs)
## Zpracování
### Funkce: Typ parametru anotační vrstvy pro zpracování
Do rámce zpracování QGIS byl přidán typ parametru anotační vrstvy, který obsahuje nový algoritmus pro převod položek hlavní anotační vrstvy na vedlejší anotační vrstvy. To je užitečné pro přesun položek vytvořených v hlavní vrstvě do sekundární vrstvy, aby bylo možné upravit umístění položek v rámci zásobníku vrstev.
...
- Konverze údajů GPS
- Nahrávání dat GPS do zařízení
- Stažení dat GPS ze zařízení
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.16 backport commit (GitHub) | Remark |
| --- | --- | --- | --- | --- |
| WFS / GML parse issue, but QGIS loads GML as file fine? | [#45017](https://github.com/qgis/QGIS/issues/45017) | Není to chyba |  |  |
...
| Warning message \'Cannot create temporary SpatiaLite cache\' when adding many WFS-layers | [#44971](https://github.com/qgis/QGIS/issues/44971) | Duplicita |  |  |
...
| QGIS on linux crashes when opening many geopackages at once | [#43620](https://github.com/qgis/QGIS/issues/43620) | [PR #45211](https://github.com/qgis/QGIS/pull/45211) | Ne |  |
...
| QGIS crash after loading WMS layer via script and zooming in and out | [#44095](https://github.com/qgis/QGIS/issues/44095) | [PR #45254](https://github.com/qgis/QGIS/pull/45254) | Ne | Mostly a usage issue |
| Integer unexpectedly large in GeoPackage | [#45178](https://github.com/qgis/QGIS/issues/45178) | Není to chyba |  |  |
...
| projecting label coordinates for multiPoint geometry crashes QGIS | [#45148](https://github.com/qgis/QGIS/issues/45148) | [PR #45150](https://github.com/qgis/QGIS/pull/45150) | Ne |  |
...
| Attributes - Update All button - Creates Corrupted Fields - GeoJSON file | [#45139](https://github.com/qgis/QGIS/issues/45139) | [PR #45174](https://github.com/qgis/QGIS/pull/45174) | Ne |  |
...
| Create spatialite trigger with DBManager do not work | [#45420](https://github.com/qgis/QGIS/issues/45420) | [PR #45553](https://github.com/qgis/QGIS/pull/45553) | Ne |  |
...
| macOS: Symbol not found: \_\_cg_jpeg_resync_to_restart when reprojecting raster layer with GDAL warp on macOS | [#40164](https://github.com/qgis/QGIS/issues/40164) | ne | ne | Not an issue with the nightly (qgis-deps-0.9) anymore |
...
| unable to open any ascii FLO-2D files in Mesh Layer | nehlášeno | [PR #45349](https://github.com/qgis/QGIS/pull/45349) | n/a |  |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.16 backport commit (GitHub) | Remark |
| --- | --- | --- | --- | --- |
| Make QgsGeos::prepareGeometry and QgsGeos::cacheGeos idempotent | nehlášeno | [PR #45147](https://github.com/qgis/QGIS/pull/45147) |  |  |
| Add a distanceWithin method to the QgsGeometryEngine virtual class | nehlášeno | [PR #45057](https://github.com/qgis/QGIS/pull/45057) |  |  |
| Allow calling testdata_pg.sh from any directory | nehlášeno | [PR #45378](https://github.com/qgis/QGIS/pull/45378) |  |  |
| Make TestPyQgsPostgresProvider.testGeneratedColumns idempotent | nehlášeno | [PR #45415](https://github.com/qgis/QGIS/pull/45415) |  |  |
| Improve PostgreSQL test DB setup documentation and script | nehlášeno | [PR #45413](https://github.com/qgis/QGIS/pull/45413) |  |  |
...
| Use GEOSDistanceWithin when available | nehlášeno | [PR #45340](https://github.com/qgis/QGIS/pull/45340) |  |  |
| Reduce GEOS conversions and preparations of geometries | nehlášeno | [PR #45195](https://github.com/qgis/QGIS/pull/45195) |  |  |
| More heuristics to determine whether to iterate over target source | nehlášeno | [PR #45339](https://github.com/qgis/QGIS/pull/45339) |  |  |
...
| Form view shows wrong image attachments when scrolling through features | [#42705](https://github.com/qgis/QGIS/issues/42705) | Již opraveno |  |  |
...
| Attachment widget options are reset when you reopen the field widget properties | [#45089](https://github.com/qgis/QGIS/issues/45089) | Duplicita |  |  |
...
| Update default toolbar locations | nehlášeno | [Commit 77be95feac](https://github.com/qgis/QGIS/commit/77be95feac7391e58f6bd487f30e09ed8ed63651) | N/A |  |
...
| Fix crash on exit with CAD dock open | nehlášeno | [Commit 1fb21f69f](https://github.com/qgis/QGIS/commit/1fb21f69fede05cabb8f1d27a8ad24564ae16f3d) | N/A |  |
...
| Fix inappropriate display of z/m values in cad dock when non-z/m layer is selected | nehlášeno | [Commit 55a76d1d](https://github.com/qgis/QGIS/commit/55a76d1d867c32f52ae4bd38ed671d44aa3ae92e) | N/A |  |
...
| Allow CAD dock to be used for geographic CRS, but only allow the x/y/z/m constraints to be set | nehlášeno | [PR #45185](https://github.com/qgis/QGIS/pull/45185) | Not suitable for backport |  |
...
| Fix QgsMapToolCapture coordinates when associated with a non-vector layer where the layer CRS != canvas CRS | nehlášeno | [PR #45183](https://github.com/qgis/QGIS/pull/45183) | N/A |  |
...
| Fix digitizing features using CAD dock when layer CRS != canvas CRS | nehlášeno | [PR #45108](https://github.com/qgis/QGIS/pull/45108) | N/A |  |
...
| Fix handling of ADF files in browser | nehlášeno | [PR #45393](https://github.com/qgis/QGIS/pull/45393) | Not suitable for backport |  |
