...
Nástroj vás vyzve k výběru hranice (úseku), na které bude prodloužen nebo oříznut další úsek. Na rozdíl od nástroje pro uzly se provádí kontrola, zda je upravena pouze upravovaná vrstva.
...
Tato funkce byla financována od Lutra Consulting
...
Tuto funkci vyvinul Nyall Dawson, Mathieu Pellerin
...
Tuto funkci vyvinul Alexis Roy-Lizotte
...
Tato funkce byla financována od QGIS User Group Germany
...
Tuto funkci vyvinul Matthias Kuhn
...
Tato funkce byla financována od OSGeo UK, GeoServer PSC, Brad Hards
...
Tuto funkci vyvinul konst
### Feature: Improved handling of text and label export
Při exportu tiskového rozvržení do formátů PDF nebo SVG mají nyní uživatelé na výběr, jakým způsobem se má text a štítky v rámci daného rozvržení exportovat. Dostupné možnosti jsou převést veškerý text na obrysy / křivky (předchozí výchozí nastavení) nebo ponechat text a štítky jako textové objekty.
...
This feature was developed by [Nyall Dawson (North Road)](https://north-road.com)
### Funkce: Nové výrazové proměnné pro položky legendy
...
Tato funkce byla financována od Alessandro Pasotti - ItOpen
...
Tento nový algoritmus umožňuje uživatelům extrahovat binární pole do souborů.
...
Tuto funkci vyvinul Nyall Dawson, Nathan Woodrow
...
Pokud vstupní geometrie obsahuje hodnoty M nebo Z, budou tyto hodnoty lineárně interpolovány pro nové vrcholy vytvořené na antimeridiánu.
...
### Funkce: Smazat nastavení z karty Rozšířené v možnostech
...
This feature was developed by [Nyall Dawson (North Road)](https://north-road.com)
### Funkce: Přidání přepínací akce k položkám legendy vektorové vrstvy
...
Vrstvy ArcGIS Feature Serveru mají novou možnost nabídky pravým tlačítkem myši v panelu prohlížeče, která umožňuje uživatelům přímo otevřít webovou stránku s informacemi o službě pro vybranou vrstvu.
...
- Widgety ValueRelation s aktivovaným vícenásobným výběrem
- KeyValue widgets
- List widgets
...
Tuto funkci vyvinul David Signer (OPENGIS.ch)
...
Takový požadavek by vypadal následovně:
...
Tuto funkci vyvinul Marco Hugentobler
...
Tuto funkci vyvinul Nathan Woodrow
...
This feature was developed by [Nyall Dawson (North Road)](http://north-road.com)
### Funkce: API pro výpočet geodetických čar
...
- QgsDistanceArea.geodesicLine : vypočítá geodetickou přímku mezi dvěma body.
...
- QgsDistanceArea.splitGeometryAtAntimeridian : rozdělí (multi)liniový řetězec na antimeridiánu pomocí geodetických přímek pro výpočet přesného bodu, ve kterém dojde k rozdělení na antimeridiánu.
...
Tuto funkci vyvinul Martin Dobias (Lutra Consulting)
...
Tato funkce byla financována od QGIS community
...
| --- | --- | --- | --- |
| QGIS Server: WFS issue using the EXP_FILTER parameter | [#20927](https://issues.qgis.org/issues/20927) | [PR #8924](https://github.com/qgis/QGIS/pull/8924) | Hotovo |
...
| QGIS Server WFS DescribeFeatureType not following TYPENAME parameter | [#20198](https://issues.qgis.org/issues/20198) | [PR #8948](https://github.com/qgis/QGIS/pull/8948) | Hotovo |
| QGIS Server 3.4 can\'t reset numeric field using WFS Update | [#20961](https://issues.qgis.org/issues/20961) | [PR #8958](https://github.com/qgis/QGIS/pull/8958) | Hotovo |
| WFS provider shows numeric NULL fields with 0 instead of NULL | [#20961](https://issues.qgis.org/issues/20961) | [PR #8958](https://github.com/qgis/QGIS/pull/8958) | Hotovo |
| OWS project title in project properties cannot be set to blank/empty | nehlášeno | [PR #8958](https://github.com/qgis/QGIS/pull/8958) | Hotovo |
| Form Value relation based on WFS layer | [#21077](https://issues.qgis.org/issues/21077) | [PR #8970](https://github.com/qgis/QGIS/pull/8970) | Hotovo |
| Button positions in Database styles manager dialog | [#21068](https://issues.qgis.org/issues/21068) | [PR #8971](https://github.com/qgis/QGIS/pull/8971) | Hotovo |
...
| Error opening network KML page: Range downloading not supported by this server! | [#21091](https://issues.qgis.org/issues/21091) | [PR #8985](https://github.com/qgis/QGIS/pull/8985) | Hotovo |
| Can\'t add a virtual field or update a existing field of a WFS layer using the field calculator | [#21086](https://issues.qgis.org/issues/21086) | [PR #8990](https://github.com/qgis/QGIS/pull/8990) | Hotovo |
...
| Delimitedtext layer saves absolute path when project in relative path mode | [#21150](https://issues.qgis.org/issues/21150) | [PR #9099](https://github.com/qgis/QGIS/pull/9099) | Hotovo |
| field calculator doesn\'t load values for gpkg containing blank spaces or n dash (hypen) in field names | [#21100](https://issues.qgis.org/issues/21100) | [PR #9071](https://github.com/qgis/QGIS/pull/9071) | Hotovo |
...
| Layer Properties \> Load Style \> From database \> \'Other styles \...\' \> Description column contains Name text, should contain Description text (it is a geopackage layer) | [#21254](https://issues.qgis.org/issues/21254) | [PR #9170](https://github.com/qgis/QGIS/pull/9170) | Hotovo |
...
| Bug with multiple Else items in rule-based style | [#21281](https://issues.qgis.org/issues/21281) | [PR #9181](https://github.com/qgis/QGIS/pull/9181) | Hotovo |
...
| Geometry Checker Crashes | [#21259](https://issues.qgis.org/issues/21259) | [PR #9191](https://github.com/qgis/QGIS/pull/9191) | Hotovo |
| QGIS crashes when createInstance() uses wrong constructor in a QgsProcessingAlgorithm subclass | [#21270](https://issues.qgis.org/issues/21270) | [PR #9193](https://github.com/qgis/QGIS/pull/9193) | Hotovo |
...
| Body uvnitř polygonů | [#20798](https://issues.qgis.org/issues/20798) | Cannot reproduce with 3.5 |  |
...
| Add option to control export features without categories in Processing GRASS algorithms | nehlášeno | [PR #9003](https://github.com/qgis/QGIS/pull/9003) | [PR #9043](https://github.com/qgis/QGIS/pull/9043) |
...
| v.net.report and v.net.nreport algorithms failed | nehlášeno | [PR #9046](https://github.com/qgis/QGIS/pull/9046) | [PR #9058](https://github.com/qgis/QGIS/pull/9058) |
...
| Podpora GeoPackage Raster WEBP | [#21083](https://issues.qgis.org/issues/21083) |  |  |
...
| ods tabulky se v QGIS 3.4 nenačítají správně | [#20588](https://issues.qgis.org/issues/20588) | upstream: <https://github.com/OSGeo/gdal/issues/1243> |  |
...
| QgsExternalResourceWidgetWrapper crashes | [#20140](https://issues.qgis.org/issues/20140) | Duplicita |  |
...
| Odstranění starých nastavení pro vrcholové značky | [#17366](https://issues.qgis.org/issues/17366) | Works as intended |  |
...
| Add the possibility to return a shp if ogr is not compiled with gpkg | nehlášeno | [PR #9037](https://github.com/qgis/QGIS/pull/9037) |  |
...
| ods tabulky se v QGIS 3.4 nenačítají správně | [#20588](https://issues.qgis.org/issues/20588) | [GDAL master commit](https://github.com/OSGeo/gdal/commit/ee6278f8dd1be7064db87be87fe31fa8943730ec) and [GDAL 2.4 commit](https://github.com/OSGeo/gdal/commit/4e84cd44868e3b91def41057b7adf28767b4c273) | - |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.4 backport commit (GitHub) |
| --- | --- | --- | --- |
| Qgis 3.4.1 crashes when accessing methods of feature | [#20752](https://issues.qgis.org/issues/20752) | uzavřeno |  |
...
| QGIS 3.4.1 advanced modification and snap block QGIS | [#20568](https://issues.qgis.org/issues/20568) | uzavřeno |  |
