...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Attribute table frame, with "allow url to be read as HTML format" has not expected result like hyperlink when output PDF file is maked from "GetPrint" request from QGIS Server | [#52370](https://github.com/qgis/QGIS/issues/52370) | Není to chyba |  |
...
| SHP: Fix unreported issue with spatialindex | nehlášeno | [PR #56366](https://github.com/qgis/QGIS/pull/56366) | [PR #56399](https://github.com/qgis/QGIS/pull/56399) |
...
| [PostgreSQL provider] Add missing namespace escaping in SQL requests | nehlášeno | [PR #56173](https://github.com/qgis/QGIS/pull/56173) | [PR #56186](https://github.com/qgis/QGIS/pull/56186) |
| Export Save features to gpkg does not keep Field Domains, but using Convert Format does | [#56184](https://github.com/qgis/QGIS/issues/56184) | [PR #56209](https://github.com/qgis/QGIS/pull/56209) | Nevhodné |
...
| Catch potential QgsCsException at various places; improve qgscoordinatetransform.h doc | nehlášeno | [PR #56212](https://github.com/qgis/QGIS/pull/56212) | [PR #56244](https://github.com/qgis/QGIS/pull/56244) |
...
| Harmonize use of password lineedit in auth method editors | nehlášeno | [PR #55970](https://github.com/qgis/QGIS/pull/55970) |  |
...
| TIN: Enable fromWkb/fromWkt | nehlášeno | [PR #56071](https://github.com/qgis/QGIS/pull/56071) | ne |
| [OGC] Polygon: fix rings order | nehlášeno | [PR #55306](https://github.com/qgis/QGIS/pull/55306) | ne |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| [3D] disable altitude binding if altitude clamping is absolute | nehlášeno | [PR #56154](https://github.com/qgis/QGIS/pull/56154) | [PR #56198](https://github.com/qgis/QGIS/pull/56198) |
...
| Fix GUI freezing when changing raster renderer | nehlášeno | [PR #56000](https://github.com/qgis/QGIS/pull/56000) | [PR #56077](https://github.com/qgis/QGIS/pull/56077) |
...
| Allow deleting geometry part of singlepart features | nehlášeno | [PR #56279](https://github.com/qgis/QGIS/pull/56279) |  |
...
| Problem with Georeferencing Tool-QGIS 3.28.12 Firenze | [#55167](https://github.com/qgis/QGIS/issues/55167) | Není to chyba |  |
...
| Ensure that saving map [canvas] as image/PDF takes high DPI scaling factor into account | nehlášeno | [PR #56400](https://github.com/qgis/QGIS/pull/56400) |  |
| MBTiles layers are valid when dataset is missing | nehlášeno | [PR #56296](https://github.com/qgis/QGIS/pull/56296) | [PR #56298](https://github.com/qgis/QGIS/pull/56298) |
...
| DXF map theme style override not respected | nehlášeno | [PR #56162](https://github.com/qgis/QGIS/pull/56162) | [PR #56164](https://github.com/qgis/QGIS/pull/56164) |
...
| Pixelated QGIS logo in user profile selector dialog on high DPI screens | nehlášeno | [PR #56053](https://github.com/qgis/QGIS/pull/56053) | [PR #56065](https://github.com/qgis/QGIS/pull/56065) |
| Pixelated overview panel rendering on high DPI screens | nehlášeno | [PR #56050](https://github.com/qgis/QGIS/pull/56050) | [PR #56087](https://github.com/qgis/QGIS/pull/56087) |
| Welcome screen issues on high DPI screens | nehlášeno | [PR #56048](https://github.com/qgis/QGIS/pull/56048) | [PR #56084](https://github.com/qgis/QGIS/pull/56084) |
...
| Missing checkbox partially checked state styling for non-default themes | nehlášeno | [PR #56290](https://github.com/qgis/QGIS/pull/56290) | [PR #56306](https://github.com/qgis/QGIS/pull/56306) |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix broken coordinate transforms on qt6 builds | nehlášeno | [PR #55914](https://github.com/qgis/QGIS/pull/55914) | [PR #55935](https://github.com/qgis/QGIS/pull/55935) |
| Fix crash in QgsRasterPipe when removing roles | nehlášeno | [PR #55955](https://github.com/qgis/QGIS/pull/55955) | [PR #56008](https://github.com/qgis/QGIS/pull/56008) |
| Fix broken data defined override buttons in text format widget when no layer is associated | nehlášeno | [PR #55989](https://github.com/qgis/QGIS/pull/55989) | N/A |
| Avoid use of pygments in metasearch | nehlášeno | [PR #56160](https://github.com/qgis/QGIS/pull/56160) | N/A |
| Fixes filters applied to a duplicated AFS layer also incorrectly apply to the original layer | nehlášeno | [PR #56195](https://github.com/qgis/QGIS/pull/56195) | [PR #56221](https://github.com/qgis/QGIS/pull/56221) |
| [processing] Don't try to interpret distance widget value as CRS | nehlášeno | [PR #56292](https://github.com/qgis/QGIS/pull/56292) | [PR #56297](https://github.com/qgis/QGIS/pull/56297) |
...
| Fix calculation of string stats when nulls are present | nehlášeno | [PR #56305](https://github.com/qgis/QGIS/pull/56305) | [PR #56322](https://github.com/qgis/QGIS/pull/56322) |
| Don't use (broken) QgsCoordinateReferenceSystem::createFromSrsId method for virtual point clouds | nehlášeno | [PR #56325](https://github.com/qgis/QGIS/pull/56325) | [PR #56333](https://github.com/qgis/QGIS/pull/56333) |
| Make datetime stats range type consistent across Qt versions | nehlášeno | [PR #56355](https://github.com/qgis/QGIS/pull/56355) | [PR #56437](https://github.com/qgis/QGIS/pull/56437) |
| Fix crash in QgsStringUtils::truncateMiddleOfString on qt 6 | nehlášeno | [PR #56356](https://github.com/qgis/QGIS/pull/56356) | N/A |
| Fix handling of font family from HTML on Qt 6 builds | nehlášeno | [PR #56358](https://github.com/qgis/QGIS/pull/56358) | [PR #56436](https://github.com/qgis/QGIS/pull/56436) |
...
| Fix crash when applying vector properties dialog | nehlášeno | [PR #56412](https://github.com/qgis/QGIS/pull/56412) | N/A |
| Don't force calculate layer extents when saving layers | nehlášeno | [PR #56433](https://github.com/qgis/QGIS/pull/56433) | [PR #56444](https://github.com/qgis/QGIS/pull/56444) |
| Don't force full calculation of layer extent when cloning layers | nehlášeno | [PR #56434](https://github.com/qgis/QGIS/pull/56434) | N/A |
...
| Fix a deadlock in remote COPC handling (3D views) | nehlášeno | [PR #56388](https://github.com/qgis/QGIS/pull/56388) | [PR #56419](https://github.com/qgis/QGIS/pull/56419) |
| Fix a crash in point cloud renderer when cleaning up preview painter | nehlášeno | [PR #56409](https://github.com/qgis/QGIS/pull/56409) | N/A |
| Fix a deadlock with local COPC files in 2D rendering | nehlášeno | [PR #56432](https://github.com/qgis/QGIS/pull/56432) | [PR #56458](https://github.com/qgis/QGIS/pull/56458) |
