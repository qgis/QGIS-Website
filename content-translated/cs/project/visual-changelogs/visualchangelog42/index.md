...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| \[OAPIF\] Zooming triggers download of already loaded data | [\#66358](https://github.com/qgis/QGIS/issues/66358) | Není to chyba |  |
...
| Gml to Gml- Conversion succeeded, input and output are not the same in QGIS | [\#66413](https://github.com/qgis/QGIS/issues/66413) | Není to chyba |  |
...
| Cannot load VT layer from style only from the dialog (works in browser) | nehlášeno | [PR \#66500](https://github.com/qgis/QGIS/pull/66500) | TODO |
| "fix" every entry in relation reference widget is shown in italic | nehlášeno | [PR \#66649](https://github.com/qgis/QGIS/pull/66649) |  |
...
| No timeout for vsicurl layers when loading a project | [\#66496](https://github.com/qgis/QGIS/issues/66496) | Nelze reprodukovat |  |
...
| Data-defined override expression on a field is not evaluated until any field in the form is edited | [\#66504](https://github.com/qgis/QGIS/issues/66504) | Nelze reprodukovat |  |
...
| Qgis have problem to render GeometryCollection for Gml, other viewer like mygeodata website render ok | [\#66225](https://github.com/qgis/QGIS/issues/66225) | Duplicita |  |
...
| QGIS Server: GetProjectSettings returns the error message "Layer(s) not valid" with two WMS layers | [\#65872](https://github.com/qgis/QGIS/issues/65872) | Nelze reprodukovat |  |
...
| Layout bleeding to edge outside map window | [\#49638](https://github.com/qgis/QGIS/issues/49638) | Pevná |  |
...
| QGIS hangs when opening raster calculator (Meu Qgis está travando ao tentar abrir a calculadora raster) | [\#66327](https://github.com/qgis/QGIS/issues/66327) | Nelze reprodukovat |  |
...
| QGIS server OGC API: Limits and offset parameters ignored when plugin changing parameters | [\#65858](https://github.com/qgis/QGIS/issues/65858) | Pevná | [PR \#66480](https://github.com/qgis/QGIS/pull/66480) |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
| Deleted last series still visible in chart | [\#63466](https://github.com/qgis/QGIS/issues/63466) | Nelze reprodukovat |  |
...
| Správce databází | [\#59470](https://github.com/qgis/QGIS/issues/59470) | Nelze reprodukovat |  |
...
| TestQgsProcessingAlgsPt2::exportMeshOnGrid() | [\#48605](https://github.com/qgis/QGIS/issues/48605) | Nelze reprodukovat |  |
| TestQgsProcessingAlgs::convertGpsData() fails | [\#45588](https://github.com/qgis/QGIS/issues/45588) | Cannot reproduce/Not a bug |  |
| gdal:merge parameter OPTIONS not shown with execAlgorithmDialog | [\#66396](https://github.com/qgis/QGIS/issues/66396) | Není to chyba |  |
| projects/anonymize_saved_projects doesn't seem to be available in the new settings tree | [\#65844](https://github.com/qgis/QGIS/issues/65844) | Není to chyba |  |
| bug for .Shp namefile | [\#62655](https://github.com/qgis/QGIS/issues/62655) | Není to chyba |  |
| Build virtual point cloud (VPC): dialog adds .las extension for output | [\#61934](https://github.com/qgis/QGIS/issues/61934) | Nelze reprodukovat |  |
...
| QGIS wants to open all .json files, including ones unrelated to any geodata | [\#61215](https://github.com/qgis/QGIS/issues/61215) | Nelze reprodukovat |  |
...
| QLR files not associated with QGIS | [\#56844](https://github.com/qgis/QGIS/issues/56844) | Nelze reprodukovat |  |
| TestQgsDatumTransformDialog fails | [\#48883](https://github.com/qgis/QGIS/issues/48883) | Nelze reprodukovat |  |
| TestProcessingGui::testDatabaseSchemaWrapper() Caught unhandled exception | [\#48885](https://github.com/qgis/QGIS/issues/48885) | Nelze reprodukovat |  |
...
| Raster Tools - Generate XYZ Tiles (Directory) always creates 0 tiles | [\#60069](https://github.com/qgis/QGIS/issues/60069) | Není to chyba |  |
...
| Every entry in relation reference widget is shown in italic | Unreported | [PR \#66649](https://github.com/qgis/QGIS/pull/66649) | Nevhodné |
| Fix buggy processing relief colors widget | Unreported | [PR \#66602](https://github.com/qgis/QGIS/pull/66602) | Nevhodné |
| Fix QgsImageCache lossy conversion of images | Unreported | [PR \#66585](https://github.com/qgis/QGIS/pull/66585) | Nevhodné |
...
| Fix symbology sizing issues on hidpi displays | [\#55349](https://github.com/qgis/QGIS/issues/55349) | [PR \#66531](https://github.com/qgis/QGIS/pull/66531) | Nevhodné |
| Fix symbology sizing issues on hidpi displays | [\#55349](https://github.com/qgis/QGIS/issues/55349) | [PR \#66530](https://github.com/qgis/QGIS/pull/66530) | Nevhodné |
| Fix broken color wheel widget on devices with pixel ratios | [\#55349](https://github.com/qgis/QGIS/issues/55349) | [PR \#66529](https://github.com/qgis/QGIS/pull/66529) | Nevhodné |
| Use correct lossless method to store metal rough colors | Unreported | [PR \#66521](https://github.com/qgis/QGIS/pull/66521) | N/A |
| Ensure color picker opens inline for 3d settings in style dock | Unreported | [PR \#66520](https://github.com/qgis/QGIS/pull/66520) | Nevhodné |
| Fix misalignment of spin boxes in color dialog | Unreported | [PR \#66498](https://github.com/qgis/QGIS/pull/66498) | Nevhodné |
| Use unlit material instead of phong material when more appropriate | Unreported | [PR \#66490](https://github.com/qgis/QGIS/pull/66490) | Nevhodné |
| Loosen the maximum number of grid ticks to draw | [\#45113](https://github.com/qgis/QGIS/issues/45113) | [PR \#66403](https://github.com/qgis/QGIS/pull/66403) | Nevhodné |
...
| Fix slow count of features for filtered SQL server layers | [\#64894](https://github.com/qgis/QGIS/issues/64894) | [PR \#66401](https://github.com/qgis/QGIS/pull/66401) | Nevhodné |
| Partially fix slow expression builder widget construction times | Unreported | [PR \#66385](https://github.com/qgis/QGIS/pull/66385) | Nevhodné |
| Use correct default font for legend text on symbol | Related to [\#63431](https://github.com/qgis/QGIS/issues/63431) | [PR \#66384](https://github.com/qgis/QGIS/pull/66384) | Nevhodné |
| Don't show missing font warnings for MS Shell Dlg font | [\#63431](https://github.com/qgis/QGIS/issues/63431) | [PR \#66383](https://github.com/qgis/QGIS/pull/66383) | Nevhodné |
...
| WMS Ensure we store deduced CRS in provider/layer sources | Unreported | [PR \#66379](https://github.com/qgis/QGIS/pull/66379) | Nevhodné |
