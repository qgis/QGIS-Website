...
section: projekt
sidebar: true
title: Přehled změn pro QGIS 3.10
type: visual-changelog

---
{{<content-start >}}
# Přehled změn pro QGIS 3.10{#changelog310 }
...
Tuto funkci vyvinul Matthias Kuhn (Opengis.ch)
...
Tato funkce byla financována od GeoPDF export group: Land Vorarlberg; Cantons of Zug, Thurgovia and Neuchâtel; Cities of Vienna and Dornbirn; Biodiversity Information Service for Powys & Brecon Beacons National Park
...
Tato funkce byla financována od GeoPDF export group
...
Tuto funkci vyvinul Olivier Dalang
...
Tato funkce byla financována od QGIS.org
...
Tuto funkci vyvinul Mathieu Pellerin, Nyall Dawson
...
Tato funkce byla financována od QGIS

This feature was developed by [Alessandro Pasotti](https://www.qcooperative.net)
## Významné opravy
### Feature: Bug fixes by Alessandro Pasotti
| Název chyby | URL issues (if reported) | URL PR or commit | 3.4 backport PR or commit |
| --- | --- | --- | --- |
...
| Fix unreported issue with QVariantList to JSON conversion in QgsJsonUtils | nehlášeno | [PR #3192](https://github.com/qgis/QGIS/pull/31920) |  |
...
| WFS contextual legend issue when canvas CRS is different than layer\'s CRS | nehlášeno | [PR #3212](https://github.com/qgis/QGIS/pull/32120) |  |
...
| Unreported issue with missed import in the Processing algorithms dialog | nehlášeno | [PR #3190](https://github.com/qgis/QGIS/pull/31902) |  |
...
Tuto funkci vyvinul Paul Blottiere
...
| Fix uncaught transform exception when determining AFS layer bounds | nehlášeno | [Commit 857697dd](https://github.com/qgis/QGIS/commit/857697dd9919e80fc03e0c2059e56ce7311e9b49) | n/a |
| Fix qt warning thrown when converting a 2.18 project | nehlášeno | [Commit 12ad9fca](https://github.com/qgis/QGIS/commit/12ad9fca1ed5027129161ee5b5c764b8374d0b51) | n/a |
...
| Don\'t force fallback to WGS84 for unknown layer CRSes | nehlášeno | [Commit 93741566](https://github.com/qgis/QGIS/commit/937415663f609fa7e41056aeb1176a0a145accc1) | n/a |
...
| Ensure polygon rings generated for rendering are always closed | nehlášeno | [Commit a69e38d9](https://github.com/qgis/QGIS/commit/a69e38d9c358faea5ae4a8628add1e6721cc23e8) | n/a |
| Don\'t crash QgsTessellator when an empty polygon is added | nehlášeno | [Commit 761b2e77](https://github.com/qgis/QGIS/commit/761b2e778594f4051a72d02b898354f501e336fe) | n/a |
| Fix crash in topology checker plugin after a check is canceled | nehlášeno | [Commit 606bcd35](https://github.com/qgis/QGIS/commit/606bcd35143d09cca5b1ec45bdb5b13236e4376b) | n/a |
...
| Fix crash on exit when topology checker dock is open with visible results | nehlášeno | [Commit 64375ad4](https://github.com/qgis/QGIS/commit/64375ad4d28597eb97808f64e1481915df7a676c) | n/a |
...
| \[reports\] Fix crash when print button clicked before a report section is opened | nehlášeno | [Commit c93fd0a4](https://github.com/qgis/QGIS/commit/c93fd0a4350ea14db9728ad17ada06e70eb9ffd6) | n/a |
...
| Fix project load status indicator can get \"stuck\" after project load | nehlášeno | [Commit 40d95b69](https://github.com/qgis/QGIS/commit/40d95b69d91ade71473f5ea0182040d8398cc668) | n/a |
