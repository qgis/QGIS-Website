...
section: projekt
sidebar: true
title: Přehled změn pro QGIS 3.14
type: visual-changelog

---
{{<content-start >}}
# Přehled změn pro QGIS 3.14{#changelog314 }
...
QGIS je svobodný software a nemáte žádnou povinnost cokoliv platit za jeho použití – ve skutečnosti vybízíme lidi široko daleko aby jej používali bez ohledu na jejich finanční situaci – věříme, že když vybavíme lidi nástroji pro prostorové rozhodování, povede to k lepší společnosti pro celé lidstvo

{{<table-of-contents >}}
## Obecné
### Funkce: Nové nastavení písma pro anotace s dekorací mřížky
...
Tato funkce byla financována od iMHere Asia
...
Při nastavení tohoto režimu se vrstva automaticky překreslí, kdykoli se změní časový rozsah, ale na prvky se nepoužije žádné filtrování podle času.
...
Tím se zpřístupní některé základní nativní časové možnosti pro vektorové vrstvy:
...
Některá známá omezení/nedostatky:
...
Tato funkce byla financována od ARPA Piemonte
...
This feature was developed by [Kartoza / Samweli Mwakisambwe](https://kartoza.com)
### Funkce: Podpora časových omezení vrstev WMS-T
...
### Funkce: Přidání datově definované vlastnosti k rodině/stylu písma pro značky písma
...
A nyní několik pěkných obrázků:
...
Tato funkce přidává možnost automaticky umístit štítky mimo prvky polygonu.
...
Předchozí výsledek (režim nejbližšího bodu):
...
This feature was developed by [Lutra Consulting (Vincent Cloarec)](https://www.lutraconsulting.co.uk/)
### Funkce: Podpora vícenásobné sítě (od verze MDAL 0.5.91)
...
#### Zpracování času v síťové vrstvě
...
Výchozí referenční čas vrstvy je nastaven podle (seřazeno podle priority):
- From the data provider if defined in data
- From the project if defined
- Od aktuálního data s časem 00h00
...
- Sleduje výchozí nastavení legendy pro rozdělení
...
Umožňuje stylovat symboly dělení a dělení jiným způsobem než symbol vodorovné čáry na panelu zaškrtávacích znamének.
...
### Funkce: Umožnit nadefinování velikosti políčka legendy pro jednotlivé položky
...
This feature was developed by [Nyall Dawson](https://api.github.com/users/nyalldawson)
### Funkce: Umožňuje ovládat vodorovné rozestupy před skupinou/podskupinou/symboly legendy
Gives flexibility to allow \"nesting\" legend groups/subgroups/symbols and much greater control over legend item placement.

Sponsored by SLYR

This feature was developed by [Nyall Dawson](https://api.github.com/users/nyalldawson)
### Funkce: Správa tvarů legendy prostřednictvím správce stylů
...
This feature was developed by [Nyall Dawson](https://api.github.com/users/nyalldawson)
### Funkce: Umožnění konfigurace tvarů políček legendy dvojitým kliknutím na položky legendy
...
Namísto dřívějšího nastavení stylů barvy/šířky/kapky řádku stupnice nyní zobrazujeme tuto možnost jako symbol celého řádku pro pokročilejší stylování.
...
Toto umožňuje ovládat Map CRS pomocí proměnné.
...
- `close_line`
- `is_multipart`
- geometrie Z a M minimum a maximum
- `@frame_number`
- `@frame_rate`
- `@frame_duration`
...
Tuto funkci vyvinul Etienne Trimaille, Jan Caha, Julien Monticolo, Nyall Dawson
...
Aby bylo možné tyto nové režimy vybírat, lze zvolit několik režimů přichycení současně.

![image67](images/entries/71798125-35201280-3051-11ea-959d-a5897ca3391a.webp)

Pořadí upřednostňovaného přichycení je následující: - Vrchol, průsečík - střed - středník - hrana - plocha
...
Tato funkce byla financována od Kanton Solothurn and Land Vorarlberg

This feature was developed by [Olivier Dalang](https://api.github.com/users/olivierdalang)
### Funkce: Obkreslování nyní podporuje zakřivené geometrie
...
Tato funkce byla financována od ecoptima a Planteam
...
Ve formuláři lze nyní upravovat odkazy ve widgetu souboru (pokud widget není určen pouze pro čtení).

![image71](images/entries/81038564-bcb64a80-8ea6-11ea-8289-46340dee9a88.gif)

Sponzorováno švýcarskou skupinou uživatelů QGIS
...
### Funkce: Nový widget názvu databázové tabulky
...
Do konfigurace widgetu vztahu přidává možnost potlačit otevírání vyskakovacího okna formuláře při přidání nových funkcí v kontextu vloženého formuláře.
...
Přesouvání vrstev ve velkých projektech bylo usnadněno pomocí funkce *Přesunout na začátek*, ale stále bylo nutné ručně přesouvat základní mapy na konec seznamu vrstev, což je ve velkých stromech vrstev obtížný úkol. Tato funkce přidává do kontextové nabídky stromu vrstev možnost *Přesunout na konec*, která funguje stejným způsobem jako možnost Přesunout na začátek.
...
This feature was developed by [uclaros](https://api.github.com/users/uclaros)
### Funkce: Umožnit přejmenování aktuálního tématu mapy
...
2. Vytvoření náhodné rastrové vrstvy (exponenciální rozdělení)
3. Create random raster layer (gamma distribution)
4. Vytvořit náhodnou rastrovou vrstvu (negativní binomické rozdělení)
...
Tento algoritmus umožňuje uživatelům nastavit více podmínek (prostřednictvím výrazů qgis), které v závislosti na výsledku vyhodnocení výrazu způsobí spuštění nebo přeskočení příslušné větve modelu.

![image92](images/entries/79409609-b6d4f400-7fe1-11ea-8f7a-f42542f3fbfe.gif)

Tato funkce byla financována od Andreas Neumann
...
This feature was developed by [Nyall Dawson](https://api.github.com/users/nyalldawson)
### Funkce: Přidána podpora pro různé typy rastrových dat v algoritmu Vytvořit konstantní rastrovou vrstvu
...
Hlavní funkcí algoritmu je buď standardní zaokrouhlování hodnot buněk s pohyblivou řádovou čárkou nahoru/nejblíže/níže, nebo zaokrouhlování na mocniny uživatelsky zadaného základu *n*. Algoritmus lze použít s rastry všech typů (dokonce i s byte/celočíselnými rastry při zaokrouhlování na mocniny n) a výstupem je stejný datový typ rastru. Standardní zaokrouhlení celočíselného rastru s pohyblivou řádovou čárkou jej zkopíruje a vyvolá varování.

Příklad ukazuje výstupní rastr zaokrouhlený na násobky 10.
...
Tato změna umožňuje uživatelům přímo procházet zdroje vrstev, které nejsou založeny na disku, pro jakékoli vstupy zdrojů funkcí zpracování. Umožňuje tyto vstupy přebírat přímo z vrstev postgres, sql server, oracle, wfs, afs atd., aniž by je bylo nutné nejprve načíst do projektu!

K tomu plně využíváme prohlížeč QGIS:
...
This feature was developed by [Nyall Dawson](https://api.github.com/users/nyalldawson)
### Funkce: Vystavení pokročilých možností zpracování vstupů pro jednotlivé zdroje funkcí
...
Iterativní návrh modelu je tak mnohem snazší!
...
Financováno společností Fisel + König
...
Sponzorováno společností Fisel + König
...
This feature was developed by [Germán Carrillo](https://github.com/gacarrillor)
### Funkce: Nový algoritmus převodu na křivky
...
Přidání možnosti filtrování mezi seznamy WMS nebo WMTS z dialogového okna zdroje
...
This feature was developed by [Alessandro Pasotti](https://www.itopen.it)
### Funkce: Umožnění přímého ukládání výstupů do více databázových formátů (a další příjemné věci)
...
Mezi další pěkné věci patří:
- Nyní můžete přetáhnout soubor nebo složku z průzkumníka nebo prohlížeče qgis na výstupní parametry, abyste tyto soubory snadno přepsali (nebo uložili do složky), což odpovídá chování možnému u vstupů.
...
Pro programátory je nyní validátor volatelný také z PyQGIS, takže jej nyní mohou používat i zásuvné moduly.
...
> 
> Bezeztrátové obrázky WebP mají ve srovnání s PNG o 26 % menší velikost. Ztrátové obrázky WebP jsou o 25-34 % menší než srovnatelné obrázky JPEG při stejném indexu kvality SSIM.
...
This feature was developed by [Germán Carrillo](https://github.com/gacarrillor)
### Funkce: Přenesení wrapperů výstupních parametrů do nového API
...
Tato aktualizace přenáší vstupní parametr Raster Band a vstupní parametr Multi Layer do nového rozhraní C++.
...
- Změna uspořádání vstupů pro vícevrstvé parametry v modelech za účelem nastavení konkrétních pořadí vrstev
...
This feature was developed by [Nyall Dawson](https://api.github.com/users/nyalldawson)
### Funkce: Vektorová vrstva dlaždic - část 1
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| Getfeatureinfo does not show relation reference items for QGIS Server | [#36549](https://github.com/qgis/QGIS/issues/36549) | Ukázalo se, že jde o požadavek na funkci | N/A |
...
| GetFeatureInfo Hodnota Fid se liší mezi application/json a application/vnd.ogc.gml | [#36262](https://github.com/qgis/QGIS/issues/36262) | [PR #36733](https://github.com/qgis/QGIS/pull/36733) | [PR #37158](https://github.com/qgis/QGIS/pull/37158) |
...
| Správce DB již nezobrazuje výsledky dotazů | [#36205](https://github.com/qgis/QGIS/issues/36205) | [PR #36823](https://github.com/qgis/QGIS/pull/36823) | N/A |
| Správce DB již nezobrazuje výsledky dotazů | [#36205](https://github.com/qgis/QGIS/issues/36205) | [PR #36831](https://github.com/qgis/QGIS/pull/36831) | N/A |
| GPKG browser drag&drop not working | nehlášeno | [PR #36972](https://github.com/qgis/QGIS/pull/36972) | [PR #37159](https://github.com/qgis/QGIS/pull/37159) |
...
| QGIS Server: WFS Request nepoužívá SrsName na geometrii | [#36398](https://github.com/qgis/QGIS/issues/36398) | [PR #36926](https://github.com/qgis/QGIS/pull/36926), [PR #37071](https://github.com/qgis/QGIS/pull/37071) | není kritický |
...
| Joined tables cannot be edited even if the \"editable join layer\" option is checked | [#36934](https://github.com/qgis/QGIS/issues/36934) | není reprodukovatelný/neprobíhá | N/A |
...
| Using \"Add feature\" to create feature and child feature with transaction group causes foreign key error | [#37222](https://github.com/qgis/QGIS/issues/37222) | [PR #37249](https://github.com/qgis/QGIS/pull/37249) | není kritický |
...
| Umožňuje vyhledávat qmlplugindump v různých cestách | N/A | [PR #36513](https://github.com/qgis/QGIS/pull/36513) | N/A |
...
| Chybný rozsah, pokud vrstva obsahuje bod v 0,0 | [#33823](https://github.com/qgis/QGIS/issues/33823) | Not a QGIS bug. Fixed in GDAL 3.1 | N/A |
| Projekce není rozpoznána z konverze Mapinfo | [#34471](https://github.com/qgis/QGIS/issues/34471) | [PR #36758](https://github.com/qgis/QGIS/pull/36758) | [PR #36783](https://github.com/qgis/QGIS/pull/36783) |
...
| QGIS 3.12 neznámý CRS nebo Vybrat transformaci | [#36837](https://github.com/qgis/QGIS/issues/36837) | [GDAL Commit 68133b8](https://github.com/OSGeo/gdal/commit/68133b8b6f724a581a5dcb19fbdcd657ddbd6c4c) | [GDAL Commit 6ae7f60](https://github.com/OSGeo/gdal/commit/6ae7f60a5914a2f16b8b1a94758f10e6621e4aca) |
| Chyba BIGTIFF není v protokolu zpracování zřejmá | [#36867](https://github.com/qgis/QGIS/issues/36867) | [GDAL Commit cfc8e61](https://github.com/OSGeo/gdal/commit/cfc8e613ad86dd4b00604dd64df239916ccda135) | [GDAL Commit fb88e3c](https://github.com/OSGeo/gdal/commit/fb88e3ca5c8905fbcaab79e96a2bfc1c36f72d08) |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| Oprava segfault při přidávání vrstvy | [Mailing list](https://lists.osgeo.org/pipermail/qgis-developer/2020-June/061421.html) | [PR #36910](https://github.com/qgis/QGIS/pull/36910) | N/A |
| Fix signal connection | Neohlášený problém | [PR #35836](https://github.com/qgis/QGIS/pull/35836) | N/A |
| Update the API to export a legend in JSON | Neohlášený problém s vazbou | [PR #36370](https://github.com/qgis/QGIS/pull/36370) | N/A |
...
| Pád při otevření projektu, když mapcanvas extents = nan | [#35899](https://github.com/qgis/QGIS/issues/35899) | cannot reproduce | N/A |
| Použití některých funkcí v rastrovém kalkulátoru způsobí pád QGIS | [#35583](https://github.com/qgis/QGIS/issues/35583) | [PR #37273](https://github.com/qgis/QGIS/pull/37273) | N/A |
| Pomocné úložiště nelze použít v neupravitelné vrstvě | [#30376](https://github.com/qgis/QGIS/issues/30376) | Již opraveno. Uzavřeno. | N/A |
| Oprava kompilace s GCC 10, Qt/PyQt 5.15.0 a SIP 4.19.23 | [#37072](https://github.com/qgis/QGIS/issues/37072) | [PR #37116](https://github.com/qgis/QGIS/pull/37116) | [PR #37250](https://github.com/qgis/QGIS/pull/37250) |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| Reprodukovatelný pád při použití QgsMapCanvas.items() s vrstvami Oracle | [#33791](https://github.com/qgis/QGIS/issues/33791) | [PR #36240](https://github.com/qgis/QGIS/pull/36240) | [PR #36246](https://github.com/qgis/QGIS/pull/36246) |
| V panelu nápovědy pro uživatelské výrazy jsou ignorovány řádkové zlomy. | [#36191](https://github.com/qgis/QGIS/issues/36191) | [PR #36249](https://github.com/qgis/QGIS/pull/36249) | [PR #36387](https://github.com/qgis/QGIS/pull/36387) |
...
| Nelze změnit štítky tříd rastrové symboliky | [#36172](https://github.com/qgis/QGIS/issues/36172) | [PR #36376](https://github.com/qgis/QGIS/pull/36376) | [PR #36533](https://github.com/qgis/QGIS/pull/36533) |
| Pád při nedostupnosti vrstvy | [#33300](https://github.com/qgis/QGIS/issues/33300) | Nelze reprodukovat | N/A |
| Výběr podle výrazu vrací chybné výsledky s celočíselným dělením polí pro soubory shapefile | [#35449](https://github.com/qgis/QGIS/issues/35449) | [PR #2531](https://github.com/OSGeo/gdal/pull/2531) | N/A |
...
| Zaseknutí v okně Poslední projekt při otevření prázdného souboru v 3.10.3 | [#34809](https://github.com/qgis/QGIS/issues/34809) | Nelze reprodukovat | N/A |
| QGIS havaruje při získávání položek scény mapCanvas, pokud jsou identifikovány prvky | [#34457](https://github.com/qgis/QGIS/issues/34457) | [PR #36439](https://github.com/qgis/QGIS/pull/36439) | [PR #36450](https://github.com/qgis/QGIS/pull/36450) |
| řazení ve sloupci s hodnotovým vztahem je nekonzistentní. | [#36114](https://github.com/qgis/QGIS/issues/36114) | [PR #36776](https://github.com/qgis/QGIS/pull/36776) | [PR #36887](https://github.com/qgis/QGIS/pull/36887) |
| Chybějící body (v závislosti na měřítku plátna) ve virtuální vrstvě na základě souboru sqlite | [#36054](https://github.com/qgis/QGIS/issues/36054) | [PR #36792](https://github.com/qgis/QGIS/pull/36792) | [PR #36718](https://github.com/qgis/QGIS/pull/36718) |
| Projekt je upraven, jakmile najedete kurzorem na plátno. | [#36796](https://github.com/qgis/QGIS/issues/36796) | [PR #36797](https://github.com/qgis/QGIS/pull/36797) | [PR #36718](https://github.com/qgis/QGIS/pull/36718) |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| Nástroj Vertex přepíše globální parametry přichycení | [#36229](https://github.com/qgis/QGIS/issues/36229) | [PR #36231](https://github.com/qgis/QGIS/pull/36231) | N/A |
| QGIS havaruje s metodou QgsGeometry na prázdné kolekci | [#36142](https://github.com/qgis/QGIS/issues/36142) | [PR #36351](https://github.com/qgis/QGIS/pull/36351) | N/A |
| Selektivní maskování: fantomové linie na tmavém pozadí | [#34650](https://github.com/qgis/QGIS/issues/34650) | [PR #36697](https://github.com/qgis/QGIS/pull/36697) | N/A |
| Selektivní maskování: problém s neprůhledností masky | [#34947](https://github.com/qgis/QGIS/issues/34947) | [PR #36697](https://github.com/qgis/QGIS/pull/36697) | N/A |
...
| Neplatný dotaz na výchozí hodnotu sloupce datum vrstvy Oracle | [#32401](https://github.com/qgis/QGIS/issues/32401) | [PR #36769](https://github.com/qgis/QGIS/pull/36769) | N/A |
...
| Vlastní stupnice projektu se zobrazují s vědeckou notací | [#36859](https://github.com/qgis/QGIS/issues/36859) | [PR #36860](https://github.com/qgis/QGIS/pull/36860) | N/A |
...
| Fix redirection of the stdout results to temporary files in GRASS Processing algorithms | nehlášeno | [PR #36618](https://github.com/qgis/QGIS/pull/36618) | [PR #36684](https://github.com/qgis/QGIS/pull/36684) |
| Fix GRASS r.tileset algorithm | nehlášeno | [PR #36645](https://github.com/qgis/QGIS/pull/36645) | [PR #36695](https://github.com/qgis/QGIS/pull/36695) |
...
| \[Style Manager\] Missing Favorites category in the \"select by group\" dialog from \"Export symbols\" | [#27315](https://github.com/qgis/QGIS/issues/27315) | [PR #36793](https://github.com/qgis/QGIS/pull/36793) | není kritický |
...
| Layer panel: \"Edit Symbol\" does nothing if no symbol defined for a rule (in rule-based rendering) | [#23048](https://github.com/qgis/QGIS/issues/23048) | [PR #36954](https://github.com/qgis/QGIS/pull/36954) | není kritický |
| Attributes shift in the Service area algorithm results | nehlášeno | [PR #37074](https://github.com/qgis/QGIS/pull/37074), [PR #37097](https://github.com/qgis/QGIS/pull/37097) | N/A |
| Processing testing framework does not apply rounding to values casted to numbers | nehlášeno | [PR #37234](https://github.com/qgis/QGIS/pull/37234) | N/A |

This feature was funded by [QGIS.ORG (through donations and sustaining memberships)](https://www.qgis.org/)

Tuto funkci vyvinul Alexander Bruy
### Funkce: Opravy chyb od Nyall Dawson
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix leak in mesh 3d renderer | nehlášeno | [Commit 4b5a63d](https://github.com/qgis/QGIS/commit/4b5a63d11b7ea5baf6931c8abf86e132c706c1be) | N/A |
...
| Fix font in CSS code editor | nehlášeno | [Commit 63cb42c](https://github.com/qgis/QGIS/commit/63cb42c298ef5ab732274bce205e49171b797ae4) | není kritický |
...
| Fix all Qt 5.14 deprecation warnings | nehlášeno | [Commit 3717adc](https://github.com/qgis/QGIS/commit/3717adcef6315f4b9a0089bfc2393cede937b644) | No \-- too intrusive |
...
| Fixes to numbered list handling in dox/PyQGIS API | nehlášeno | [Commit 74400c7](https://github.com/qgis/QGIS/commit/74400c7ff88d563dad74dad41860f9b603214973) | Ne |
| Fix cross references in PyQGIS docs | nehlášeno | [Commit 81a9db9](https://github.com/qgis/QGIS/commit/81a9db9f57706cba9b11e4372dd1bf50fcd7bc6a) | Ne |
...
| Oprava formátování položek seznamu v dokumentech PyQGIS | nehlášeno | [Commit 84ec481](https://github.com/qgis/QGIS/commit/84ec481aa8f3d3bb487272122414c765e77a2ea2) | N/A |
...
| Avoid some QGIS startup warnings | nehlášeno | [Commit 013f682](https://github.com/qgis/QGIS/commit/013f682bd3c6addd163a78d3776c578ae37377c6) | N/A |
...
| \[labeling\] Fix incorrect label placement after moving an \'unplaced\' label | nehlášeno | [Commit cbfb7f4](https://github.com/qgis/QGIS/commit/cbfb7f4ce25e10aab5f7b8cee147afb801042704) | [PR 36718 Commit 9189dec](https://github.com/qgis/QGIS/pull/36718/commits/9189dec7633b2eb6a1075bb35c2f90f6b90ba63a) |
| Don\'t block creation of new geopackages in vector save as dialog | nehlášeno | [Commit 8ccd127](https://github.com/qgis/QGIS/commit/8ccd127f4d8bf66fb04b6484147ed116acf66d91) | N/A |
...
| \[3d\] When showing edges, data defined polygon height was not accounted for | nehlášeno | [Commit e516231](https://github.com/qgis/QGIS/commit/e516231bb2854405ea78a0cec40ad96295e9f8c6) | N/A |
| Fixes for \"Show all\" labeling mode | nehlášeno | [Commit 2b91bd0](https://github.com/qgis/QGIS/commit/2b91bd0cafff66f14ceb49b104bf2f2cc6ae714d) | N/A |
...
| Avoid corrupted project thumbnail images in some circumstances | nehlášeno | [Commit f404e6e](https://github.com/qgis/QGIS/commit/f404e6e162df954ffb200d550b6c32375b7270c1) | N/A |
| Auto focus search box when opening \"add layer to legend\" dialog | [#36905](https://github.com/qgis/QGIS/issues/36905) | [Commit 019e494](https://github.com/qgis/QGIS/commit/019e494f1d61851ea192900a2cc9cce460d1ea73) | není kritický |
...
| Pamatovat si pozice oken návrháře rozvržení | [#36907](https://github.com/qgis/QGIS/issues/36907) | [Commit 97d31d0](https://github.com/qgis/QGIS/commit/97d31d025fe2264afadcf6afcb3eb6ebcfe9e91d) | není kritický |
...
| Fix placement of message bar \'clear all\' menu arrow on hidpi screens | nehlášeno | [Commit 8a9975b](https://github.com/qgis/QGIS/commit/8a9975b4ff6b7a8a79bef05230db28754500fa40) | není kritický |
...
| \[layouts\] Don\'t refresh the map canvas multiple times during atlas exports | [#30144](https://github.com/qgis/QGIS/issues/30144) | [Commit 57519e9](https://github.com/qgis/QGIS/commit/57519e9faa95fbfe6196134d9128caee48cb4b84) | není kritický |
...
| Fix incorrect warning message when turning off atlas preview | nehlášeno | [Commit 3b0af960](https://github.com/qgis/QGIS/commit/3b0af960dd90af15cbe32e2fd7642408031e70f5) | N/A |
...
| Improve plugin watchdog message and UX | nehlášeno | [Commit 150b373](https://github.com/qgis/QGIS/commit/150b373c7ae61c0548ab0803f9b30a36b15e7ab4) | No \-- too intrusive |
...
| Avoid proj \'object is not a concatenated operation\' warnings | nehlášeno | [Commit 6baa209](https://github.com/qgis/QGIS/commit/6baa209285f452e5996537b1b0f1b5d924d5c59b) |  |
...
| Don\'t try to identify CRSes created just for ellipsoid definitions | nehlášeno | [Commit 15b318b](https://github.com/qgis/QGIS/commit/15b318b50de9131ed1dd6bbf73ae5eb7572579a7) | No \-- too intrusive |
...
| fix layer tree dependencies (showinf symbols and main layer) | nehlášeno | [PR #37000](https://github.com/qgis/QGIS/pull/37000) | N/A |
...
| Freeze when showing attribute table of WFS layer | [#37224](https://github.com/qgis/QGIS/issues/37224) | not yet fixed | N/A |
