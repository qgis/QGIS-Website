...
Dialogové okno Vlastnosti projektu obsahuje také nové nastavení formátu úložiště specifického pro projekt.
...
Tato funkce byla financována od GEM foundation
...
Tuto funkci vyvinul Alessandro Pasotti
## Symbologie
...
Nově se chování vrátí ke statickým, nakonfigurovaným hodnotám, což umožňuje velmi intuitivní konfiguraci legendy pro tyto případy.
...
Tato funkce přidává k nové náhodné výplni značek metodu počítání bodů založenou na hustotě.
...
Základní vykreslovač vektorové vrstvy a vykreslovač založený na pravidlech byly převedeny na použití QgsChunkedEntity, která se již používá pro vykreslování terénu. Kromě odemčení grafického uživatelského rozhraní došlo ještě ke dvěma dalším vylepšením:
- loading process is multi-threaded instead of using just a single core
- načítání probíhá po dlaždicích - je tedy možné vidět dlaždice s 3D daty, které se objevují, zatímco ostatní data se stále načítají.
...
Tato funkce byla financována od QGIS.org grant.
...
Tato nová funkce umožňuje uživateli např. přetáhnout svg z průzkumníka souborů na rozvržení a vytvořit novou položku obrázku obsahující tento svg obrázek.
...
Tuto funkci vyvinul Nyall Dawson
## Výrazy
...
Naproti tomu tento jednoduchý algoritmus Rename Field se pěkně přizpůsobí použití modelu, protože funguje pouze na jediném poli a všechna ostatní pole ponechává nedotčená.
...
Tuto funkci vyvinul Richard Duivenvoorde
...
Tuto funkci vyvinul Raymond Nijssen, Nyall Dawson
...
Tuto funkci vyvinul olivierdalang
...
Tato funkce byla financována od QGIS.org bugfixing
...
Algoritmus Fuzzify raster (linear membership) je nativní implementací algoritmu fuzzy logiky. Transformuje vstupní rastr na fuzzifikovaný rastr a přiřazuje mu hodnoty mezi 0 a 1 podle lineární fuzzy funkce příslušnosti. Hodnota 0 znamená žádnou příslušnost k definované fuzzy množině, hodnota 1 znázorňuje plnou příslušnost. Mezi tím se stupeň příslušnosti hodnot rastru řídí lineární funkcí příslušnosti.
...
Algoritmus Fuzzify raster (power membership) je nativní implementací algoritmu fuzzy logiky. Transformuje vstupní rastr na fuzzifikovaný rastr a přiřazuje mu hodnoty mezi 0 a 1 podle mocninné fuzzy funkce příslušnosti. Hodnota 0 znamená žádnou příslušnost k definované fuzzy množině, hodnota 1 znázorňuje plnou příslušnost. Mezi tím se stupeň příslušnosti hodnot rastru řídí mocninnou funkcí příslušnosti.
...
Při kliknutí pravým tlačítkem myši na určité soubory v prohlížeči umožnit jejich otevření pomocí výchozí externí aplikace pro daný typ souboru.

Např. soubory PDF se otevřou ve výchozím externím prohlížeči PDF.
...
Tato funkce byla financována od Limerick City and County Council
...
Tato funkce byla financována od Lille Metropole
...
Tato funkce byla financována od Christmas Holidays Inc.
...
Může být užitečný při vývoji a testování projektů, modulů a zásuvných modulů QGIS Serveru, aniž byste museli používat celý stack webového serveru/FCGI.
...
Tuto funkci vyvinul Éric Lemoine
## Programovatelnost
...
Tato funkce byla financována od QWAT/QGEP group
...
Tuto funkci vyvinul Stephen Knox
...
| unreported: wrong link in server WFS3 items page (too many slashes) | nehlášeno | [PR #33926](https://github.com/qgis/QGIS/pull/33926) | risky |
...
| QgsVectorLayer readStyle nečte viditelnost na základě měřítka | [#33840](https://github.com/qgis/QGIS/issues/33840) | [PR #33987](https://github.com/qgis/QGIS/pull/33987) | [PR #34289](https://github.com/qgis/QGIS/pull/34289) |
...
| chyba výrazu filtru vrací true | [#34259](https://github.com/qgis/QGIS/issues/34259) | [PR #34309](https://github.com/qgis/QGIS/pull/34309) | [PR #34512](https://github.com/qgis/QGIS/pull/34512) |
...
| \"split features\" of PostGIS layers become slow since 3.6 | [#34326](https://github.com/qgis/QGIS/issues/34326) | uzavřeno: nelze reprodukovat s žádnou z (několika) poskytnutých datových sad |  |
| Nelze přidat/uložit více než 1 záznam/funkci ve vrstvě/tabulce Spatialite | [#34379](https://github.com/qgis/QGIS/issues/34379) | [PR #34423](https://github.com/qgis/QGIS/pull/34423) | [PR #34513](https://github.com/qgis/QGIS/pull/34513) |
...
| Rastrový kalkulátor změní jeden řádek pixelů na nodata | [#34435](https://github.com/qgis/QGIS/issues/34435) | [PR #34460](https://github.com/qgis/QGIS/pull/34460) | [PR #34511](https://github.com/qgis/QGIS/pull/34511) |
...
| QGIS 3.10 nedokáže načíst tabulku PostGIS na MacOS Catalina | [#32558](https://github.com/qgis/QGIS/issues/32558) | [Commit d15ce6b](https://github.com/qgis/QGIS/commit/d15ce6b4c30f9faed8b818c575d6b729192fa064) | [Commit a06b164](https://github.com/qgis/QGIS/commit/a06b164b5465ee7a0f8509e737d7c71ea7c166db) |

This feature was funded by [QGIS.ORG (through donations and sustaining memberships)](https://www.qgis.org/)

Tuto funkci vyvinul Sandro Santilli
...
| \[Oracle\] Fix MultiSurface with straight polygon | - | [PR #33959](https://github.com/qgis/QGIS/pull/33959) | neproveditelné |
| Geometries stored in Oracle table fail sdo_geom.validate_geometry_with_context(..) check | [#29085](https://github.com/qgis/QGIS/issues/29085) | [PR #33959](https://github.com/qgis/QGIS/pull/33959) | neproveditelné |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| Opravy kompilace v systému Arch Linux | Unreported | [PR #34110](https://github.com/qgis/QGIS/pull/34110) | [PR #34146](https://github.com/qgis/QGIS/pull/34146) |
...
| Havárie s relacemi V2 | [#33120](https://github.com/qgis/QGIS/issues/33120) | [PR #34403](https://github.com/qgis/QGIS/pull/34403) | hotovo |
| Oprava vykreslování akcí mapové vrstvy v tabulce atributů | Unreported | [PR #34266](https://github.com/qgis/QGIS/pull/34266) | hotovo |
| Vylepšení DnD (synchronizace výběru) | [#28570](https://github.com/qgis/QGIS/issues/28570) | [PR #34411](https://github.com/qgis/QGIS/pull/34411) | TODO? |
| Vylepšení DnD (konfigurace kontejneru) | [#29063](https://github.com/qgis/QGIS/issues/29063) | [PR #34433](https://github.com/qgis/QGIS/pull/34433) |  |
| Vylepšení DnD ("neskrývá se za dvojklikem") | [#29063](https://github.com/qgis/QGIS/issues/29063) | [PR #34479](https://github.com/qgis/QGIS/pull/34479) |  |
| zakázat automatické posouvání/změny velikosti v tabulce atributů při zobrazení pouze viditelných prvků. | [#34486](https://github.com/qgis/QGIS/issues/34486) | [PR #34493](https://github.com/qgis/QGIS/pull/34493) |  |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| Přichycení a nástroj vertex nefungují s některými vrstvami, pokud bylo při načítání povoleno přichycení | [#33449](https://github.com/qgis/QGIS/issues/33449) | [PR #33757](https://github.com/qgis/QGIS/pull/33757) | N/A |
| Přichycení není možné v novém projektu s novou vrstvou | [#32969](https://github.com/qgis/QGIS/issues/32969) | Duplicita | - |
| Nedochází k obnovení cache nástroje Vertex po změnách funkcí řádků | [#33947](https://github.com/qgis/QGIS/issues/33947) | Won\'t fix | - |
| \"fill ring\" do not trigger the correct computation of the area in the \"default value\" expression | [#32377](https://github.com/qgis/QGIS/issues/32377) | Uzavřeno (opraveno v 3.10 a masteru) | - |
...
| setFilterExpression and QGIS Filter output different results | [#33454](https://github.com/qgis/QGIS/issues/33454) | Uzavřeno (není to problém QGIS) | - |
| Pád při použití pohledů Oracle s primárním klíčem definovaným jako číslo bez přesnosti | [#31626](https://github.com/qgis/QGIS/issues/31626) | [PR #34312](https://github.com/qgis/QGIS/pull/34312) | TODO |
| Klient WCS přestal fungovat na konkrétní službě od verze 2.18 do 3.x | [#33339](https://github.com/qgis/QGIS/issues/33339) | [PR #34300](https://github.com/qgis/QGIS/pull/34300) | TODO |
...
| Oprava linkování Grass ve FreeBSD | hlášeno na FreeBSD ML | [PR #34088](https://github.com/qgis/QGIS/pull/34088) | [PR #34238](https://github.com/qgis/QGIS/pull/34238) |
...
| Rubberband not working correctly with \"Shapes\" digtizing in rotated map window | [#33287](https://github.com/qgis/QGIS/issues/33287) | Duplicita |  |
| Digitalizace: LineStringZ nedědí souřadnice Z od bodů, pokud linie začíná přichycením k bodu bez souřadnice Z. | [#33201](https://github.com/qgis/QGIS/issues/33201) | [PR #33642](https://github.com/qgis/QGIS/pull/33642) | [PR #33951](https://github.com/qgis/QGIS/pull/33951) |
| Split feature makes QGIS 3.4.6 crash | [#33408](https://github.com/qgis/QGIS/issues/33408) | Již opraveno |  |
...
| Fix identify menu when an expression is used as display name | nehlášeno | [PR #34361](https://github.com/qgis/QGIS/pull/34361) | [PR #34402](https://github.com/qgis/QGIS/pull/34402) |
...
| QGIS zamrzá při vytváření nových shapefile | [#32069](https://github.com/qgis/QGIS/issues/32069) | Již opraveno |  |
...
| BUG: fix invalid layer result when Oracle version is under 12 | nehlášeno | [PR #34546](https://github.com/qgis/QGIS/pull/34546) |  |
...
| \[processing\] Define Layer Projection tool should write .prj files using ESRI WKT1 format | [#34007](https://github.com/qgis/QGIS/issues/34007) | [Commit f41dd11e](https://github.com/qgis/QGIS/commit/f41dd11e9214b4d6ca5dcc31c6612a65d134ce83) | Odesláno |
| Show \'unknown CRS\' in status bar instead of blank text when project is set to an unknown CRS | [#33458](https://github.com/qgis/QGIS/issues/33458) | [Commit c6319b2](https://github.com/qgis/QGIS/commit/c6319b263992c9d52646096d851cab6c674125ff) | Odesláno |
| Don\'t force users to make a choice in the datum transform dialog | [#34234](https://github.com/qgis/QGIS/issues/34234) | [Commit 644a552](https://github.com/qgis/QGIS/commit/644a5525ec08a77b4c703a7066c94802bbfa1036) | Odesláno |
...
| \[processing\] Fix some field names are rejected in modeler for non-multi field parameters | Unreported | [Commit 9bcd980](https://github.com/qgis/QGIS/commit/9bcd98094c015265e7e94c55f248248e56c24e51) | N/A - pouze 3.12  |
| Fix crash in server feature info | Unreported | [Commit b3f37fde](https://github.com/qgis/QGIS/commit/b3f37fde9bc4785aebca29e6553d6c1de715f523) | Odesláno |
| Fix overflow by assigning double max to float, invalid min | Unreported | [Commit 2b15e255](https://github.com/qgis/QGIS/commit/2b15e255eaf63f1d45b8e963fca7f9f9e4bf8d40) | N/A - pouze 3.12  |
...
| Fix crash on destruction of QgsPointLocator, if object is destroyed while indexing is happening in the background | Unreported | [Commit 08adb23](https://github.com/qgis/QGIS/commit/08adb23a7ec284a2f84ecf7ac469fbe9004ab57e) | N/A - pouze 3.12  |
...
| Don\'t try to label empty geometries | [#33931](https://github.com/qgis/QGIS/issues/33931) | [Commit 1144974](https://github.com/qgis/QGIS/commit/11449743788f3fd346c01c46cff01bcf3f84edf0) | N/A - pouze 3.12  |
...
| Fix shapefile encoding issues | [#21264](https://github.com/qgis/QGIS/issues/21264) | Odesláno | Held off to 3.10.4 |
