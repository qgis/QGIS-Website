...
section: projekt
sidebar: true
title: Přehled změn pro QGIS 3.34
type: visual-changelog

---
{{<content-start >}}
# Přehled změn pro QGIS 3.34{#changelog334 }
![image0](images/entries/334splash.webp)

Datum vydání: 2023-10-29

Představujeme QGIS 3.34, hlavní vydání projektu QGIS, které přináší významná vylepšení open-source softwaru QGIS pro geoprostorové datové analýzy a vizualizace.

Toto vydání zahrnuje různá vylepšení existujících API, výrazů a nástrojů, úpravy tiskových rozvržení a lepší možnosti vykreslování jak pro 2D tak pro 3D kontext.
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| 0 port in OAuth2 callback URI | [#54562](https://github.com/qgis/QGIS/issues/54562) | Nelze reprodukovat | N/A |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgsgeos.cpp: fix a -Wunused-variable warning | nehlášeno | [PR #54612](https://github.com/qgis/QGIS/pull/54612) | N/A |
| qgsvirtualpointcloudprovider.cpp: add a missing variable initialization | nehlášeno | [PR #54613](https://github.com/qgis/QGIS/pull/54613) | N/A |
...
| Syntactical error with the use of == instead of = for comparison in the WHERE clause | [#54608](https://github.com/qgis/QGIS/issues/54608) | Již opraveno | Unable to write any additional layers to an existing FGDB |
...
| Spatial filtering of multipart polygons within a shapefile dataset broken | [GDAL issue 8481](https://github.com/OSGeo/gdal/issues/8481) | Není to chyba |  |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix segfault in coordinate transform | nehlášeno | [PR #54609](https://github.com/qgis/QGIS/pull/54609) | N/A |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Have QgsRectangle null rectangle printed as EMPTY in wkt | nehlášeno | [PR #54831](https://github.com/qgis/QGIS/pull/54831) | N/A |
| Fix aspect ratio computation in QgsLayoutItemMap::zoomToExtent | nehlášeno | [PR #54827](https://github.com/qgis/QGIS/pull/54827) | N/A |
| Do not include a BoundingBox tag in GetFeatureInfo responses, when it is null | nehlášeno | [PR #54858](https://github.com/qgis/QGIS/pull/54858) | N/A |
| Always run the spell and shell checkers if possible, print warning when not possible | nehlášeno | [PR #54847](https://github.com/qgis/QGIS/pull/54847) | N/A |
| Tweak Null rectangle handling | nehlášeno | [PR #54872](https://github.com/qgis/QGIS/pull/54872) | N/A |
| Run spellcheck only on changed files in prepare_commit.sh | nehlášeno | [PR #54893](https://github.com/qgis/QGIS/pull/54893) | N/A |
| Fix prepare_commit.sh | nehlášeno | [PR #54918](https://github.com/qgis/QGIS/pull/54918) | N/A |
| Fix extent computation in QgsSpatiaLiteProvider | nehlášeno | [PR #54917](https://github.com/qgis/QGIS/pull/54917) | N/A |
...
| Make QgsBookmark string output more explicit about it being EMPTY | nehlášeno | [PR #54923](https://github.com/qgis/QGIS/pull/54923) | N/A |
| Fix extent computation in QgsAFSProvider | nehlášeno | [PR #54944](https://github.com/qgis/QGIS/pull/54944) | N/A |
| Add `tags` make target | nehlášeno | [PR #54948](https://github.com/qgis/QGIS/pull/54948) | N/A |
| Handle null rectangles in QgsExtentWidget::outputExtent | nehlášeno | [PR #54953](https://github.com/qgis/QGIS/pull/54953) | N/A |
| Handle null in QgsRectangle grow() and include() methods | nehlášeno | [PR #54955](https://github.com/qgis/QGIS/pull/54955) | N/A |
| Add QgsRectangle::setNull(), deprecating setMinimal() | nehlášeno | [PR #54934](https://github.com/qgis/QGIS/pull/54934) | N/A |
| Handle Null rectangle in QgsRectangle::buffered | nehlášeno | [PR #54967](https://github.com/qgis/QGIS/pull/54967) | N/A |
| Fix extent computation in QgsVirtualLayerProvider | nehlášeno | [PR #54976](https://github.com/qgis/QGIS/pull/54976) | N/A |
| Add a QgsRectangle::createNull() temporary static method | nehlášeno | [PR #55008](https://github.com/qgis/QGIS/pull/55008) | N/A |
| Fix testRegisterFeatureUnprojectible - Use valid extent in testRegisterFeatureUnprojectible | nehlášeno | [PR #55011](https://github.com/qgis/QGIS/pull/55011) | N/A |
| Have QgsGeometry::boundingBox return null rect for null geom | nehlášeno | [PR #55012](https://github.com/qgis/QGIS/pull/55012) | N/A |
| Have QgsGeometry::fromRect(NULL RECT) return null geometry | nehlášeno | [PR #54954](https://github.com/qgis/QGIS/pull/54954) | N/A |
...
| Run doxygen layout checker in prepare-commit script, when possible | nehlášeno | [PR #54936](https://github.com/qgis/QGIS/pull/54936) | N/A |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgs3daxissettings: Correctly read viewport ratio on a saved project | nehlášeno | [PR #54870](https://github.com/qgis/QGIS/pull/54870) |  |
...
| Fix layout label adjust size to text logic | nehlášeno | [PR #54896](https://github.com/qgis/QGIS/pull/54896) | pending |
...
| Fix layout maps force rasterisation of whole layout when map item has transparency set | nehlášeno | [PR #54882](https://github.com/qgis/QGIS/pull/54882) | Too intrusive |
...
| Fix layout labels don\'t immediately react to changes when semi-transparent | nehlášeno | [PR #54839](https://github.com/qgis/QGIS/pull/54839) | [PR #54863](https://github.com/qgis/QGIS/pull/54863) |
...
| Fix QgsField::ConfigurationFlag::None causes syntax error when starting PyQGIS | nehlášeno | [PR #54809](https://github.com/qgis/QGIS/pull/54809) | N/A |
...
| Fix crash when certain symbol pages are open in style dock and QGIS is closed or a new project opened | nehlášeno | [PR #54749](https://github.com/qgis/QGIS/pull/54749) | Too intrusive |
