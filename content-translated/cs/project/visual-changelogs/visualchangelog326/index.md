...
section: projekt
sidebar: true
title: Přehled změn pro QGIS 3.26
type: visual-changelog

---
{{<content-start >}}
# Přehled změn pro QGIS 3.26{#changelog326 }
...
Vrstvy mračna bodů v profilových mapách obsahují následující symbologické funkce:
- Jednobarevné zobrazení bodů nebo nastavení pro dědičnost klasifikace a barvení z 2D symboliky (např. RGB barvy)
- Respecting the profile curve distance tolerance setting
- Možnost snížit průhlednost bodů, které jsou dále od profilové křivky.
- Automatické zjemnění na základě viditelné oblasti a měřítka grafu, s maximální chybou obrazovky ovladatelnou uživatelem.
- Ovládání vzhledu bodů (barva, velikost a tvar)
...
### Funkce: Podpora časových vlastností pro WMS Server
...
Parsování časových hodnot bude provedeno s implementační specifikací poskytnutou OGC API - Features (OAPIF) a použije následující strukturu:
...
Tato funkce byla financována společností Gis3W.
...
Bylo přidáno nastavení na null / vymazání aktuálního symbolu, které vymaže aktuální symbol připojený k widgetu symbolového tlačítka.
...
| Název chyby | URL Issues (if reported, Github) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| QgsMapCanvas::showEvent porušení přístupu / pád QGIS | [#48438](https://github.com/qgis/QGIS/issues/48438) | [PR #48551](https://github.com/qgis/QGIS/pull/48551) | [PR #48558](https://github.com/qgis/QGIS/pull/48558) |
| \[GDAL provider\] Minimal support for GDT_Int64/GDT_UInt64 of GDAL 3.5.0 | (nehlášeno) | [PR #48553](https://github.com/qgis/QGIS/pull/48553) |  |
...
| Nelze importovat soubor Excel s novou verzí QGIS. | [#47838](https://github.com/qgis/QGIS/issues/47838) | N/A - freexl bug. Patch submitted to upstream | N/A |
| Vrstvy přidané QGIS nejsou správné, pokud je zdrojem dat kolekce | [#47610](https://github.com/qgis/QGIS/issues/47610) | [PR #48556](https://github.com/qgis/QGIS/pull/48556) | [PR #48572](https://github.com/qgis/QGIS/pull/48572) |
| SQLite: Vytvoření prostorového indexu se nepodařilo, ačkoli QGIS klamavě hlásí úspěch | [#44513](https://github.com/qgis/QGIS/issues/44513) | [PR #48557](https://github.com/qgis/QGIS/pull/48557) | [PR #48565](https://github.com/qgis/QGIS/pull/48565) |
| Uložení velké upravené bodové vrstvy trvá příliš dlouho | [#46355](https://github.com/qgis/QGIS/issues/46355) | [GDAL PR 5730](https://github.com/OSGeo/gdal/pull/5730) | [GDAL PR 5753](https://github.com/OSGeo/gdal/pull/5753) |
| Non-existent but registered attribute table in GPKG is added as empty table | [#30670](https://github.com/qgis/QGIS/issues/30670) | [GDAL PR 5752](https://github.com/OSGeo/gdal/pull/5752) | Nevhodné |
...
| Raster tiles are clipped based on the gpkg_contents bounding box of a GeoPackage | [#45530](https://github.com/qgis/QGIS/issues/45530) | Není to chyba |  |
...
| Název chyby | URL Issues (if reported, Github) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| \@project_keywords are no longer tested on Rule based filters | [#48480](https://github.com/qgis/QGIS/issues/48480) | Není to chyba |  |
...
| Random order of attributes in oracle feature query | [#35309](https://github.com/qgis/QGIS/issues/35309) | [PR #48668](https://github.com/qgis/QGIS/pull/48668) | ne |
...
| Documentation doctest failure | [QGIS developer mail list](https://lists.osgeo.org/pipermail/qgis-developer/2022-May/064720.html) | [QGIS Documentation PR 7581](https://github.com/qgis/QGIS-Documentation/pull/7581) | ne |
| \"Add to group\" option in sub layer window always add at top of layer tree | [#48694](https://github.com/qgis/QGIS/issues/48694) | [PR #48696](https://github.com/qgis/QGIS/pull/48696) | ne |
| Name/id of map objects in GetProjectSettings follows an order that is the inverse of the order used to add the map objects in a layout | [#46143](https://github.com/qgis/QGIS/issues/46143) | [PR #48728](https://github.com/qgis/QGIS/pull/48728) | ne |
| Aborted inserts in Postgis geometryless tables are saved anyway | [#48171](https://github.com/qgis/QGIS/issues/48171) | [PR #48741](https://github.com/qgis/QGIS/pull/48741) | ne |
...
| Drag and Drop Postgis-Table in QGIS Browser alters name of Geometry-Column | [#48748](https://github.com/qgis/QGIS/issues/48748) | [PR #48796](https://github.com/qgis/QGIS/pull/48796) | ne |
...
| GDAL Vector to Raster (gdal_rasterize) fail to produce ESRI ASCII as output | [#39140](https://github.com/qgis/QGIS/issues/39140) | Není to chyba |  |
...
| Název chyby | URL Issues (if reported, Github) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| Add simple bash script to run tests as done by CI | [QGIS QEP #244](https://github.com/qgis/QGIS-Enhancement-Proposals/issues/244) | [PR #48617](https://github.com/qgis/QGIS/pull/48617) | Nevhodné |
...
| Check that source files are not overridden | [#25830](https://github.com/qgis/QGIS/issues/25830) | [PR #48654](https://github.com/qgis/QGIS/pull/48654) | Nevhodné |
...
| Improve UX for virtual layer creation dialog | nehlášeno | [PR #49015](https://github.com/qgis/QGIS/pull/49015) | Nevhodné |
...
| Fix some undersized icons on hidpi displays | nehlášeno | [PR #48875](https://github.com/qgis/QGIS/pull/48875) | Nevhodné |
...
| Fix clear values for offset along line spin boxes | nehlášeno | [PR #48872](https://github.com/qgis/QGIS/pull/48872) | [PR #48878](https://github.com/qgis/QGIS/pull/48878) |
...
| Never show the transformation selection dialog for the first layer added to a project | nehlášeno | [PR #48811](https://github.com/qgis/QGIS/pull/48811) | [PR #48814](https://github.com/qgis/QGIS/pull/48814) |
...
| Fix loss of mesh layer styling when fixing a broken path to a mesh layer | nehlášeno | [PR #48765](https://github.com/qgis/QGIS/pull/48765) | [PR #48768](https://github.com/qgis/QGIS/pull/48768) |
...
| Don\'t hide parts of the mesh renderer widget if the layer is invalid | nehlášeno | [PR #48757](https://github.com/qgis/QGIS/pull/48757) |  |
| Add layer opacity widget in mesh layer renderer properties widget | nehlášeno | [PR #48756](https://github.com/qgis/QGIS/pull/48756) |  |
| Review and finish open PR [PR #44941](https://github.com/qgis/QGIS/pull/44941) |  |  |  |
| Fix a crash when QgsProject::instance() is accessed when no QgsApplication exists | nehlášeno | [PR #48721](https://github.com/qgis/QGIS/pull/48721) | N/A |
...
| Add support for map field types to memory provider, avoid data loss in models/processing | nehlášeno | [PR #48638](https://github.com/qgis/QGIS/pull/48638) | Too intrusive |
...
| Fix many memory leaks | nehlášeno | [PR #48590](https://github.com/qgis/QGIS/pull/48590) | N/A |
| Fix ctrl modifier scrolling on symbol buttons | nehlášeno | [PR #48581](https://github.com/qgis/QGIS/pull/48581) | N/A |
