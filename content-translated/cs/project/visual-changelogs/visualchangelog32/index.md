...
section: projekt
sidebar: true
title: Přehled změn QGIS 3.2
type: visual-changelog

---
{{<content-start >}}
# Přehled změn QGIS 3.2{#changelog32 }
...
Při vytváření nového filtru výrazů v nástroji pro tvorbu dotazů můžete nyní filtrovat panel náhledu hodnot polí.
...
### Funkce:  mapa na CELOU obrazovku pomocí Ctrl-Shift-Tab
...
Tato funkce byla financována od Leicestershire County Council and East Hampshire District Council
...
### Funkce: Volba metody zjednodušení pro zjednodušení mapového nástroje
...
Nové tlačítko se objeví v podformuláři atributu prvku, když je v související tabulce vybrán jeden nebo více záznamů. Tlačítko má přiblížit mapu na tyto prvky, pokud mají geometrie.
...
- Ctrl + kliknutí na název funkce v aktuálním výrazu automaticky otevře nápovědu pro tuto funkci
...
klávesová zkratka Ctrl+{no}

This feature was funded by [Technology One](https://www.technologyonecorp.com/)

This feature was developed by [Nathan Woodrow](https://nathanw.net/)
### Feature: Bookmark searching in locator
Umožňuje vyhledávání prostorových záložek. Dvojitým kliknutím na výsledek hledání se záložka přiblíží.
...
Tuto funkci vyvinul Klavs Pihlkjær
...
Tuto funkci vyvinul Nathan Woodrow, Nyall Dawson
...
This feature was developed by [Nyall Dawson (North Road)](https://north-road.com)
## Symbologie
### Funkce: Příjemnější barvy pro nové vrstvy
...
- Podpora výrazů pro text chráněný autorskými právy.
...
V prohlížeči jej můžete kliknutím pravým tlačítkem myši na materializované zobrazení obnovit.
...
Tato funkce byla financována od Arpa Piemonte (Dipartimento Tematico Geologia e Dissesto) within ERIKUS project

This feature was developed by [Nyall Dawson (North Road)](https://north-road.com) and [Faunalia](https://www.faunalia.eu)
## Forms and Widgets
### Funkce: Vícesloupcové rozložení pro widget hodnotové relace více výběrů
...
Tato funkce byla financována od Grant Boxer, NaturalGIS, Tudor Bărăscu, NotioGIS, République et canton de Neuchâtel, Arpa Piemonte, Nelson Silva, QGIS Danish User Group, Bo Victor Thomsen and Lene Fischer, North River Geographic
...
Tato funkce umožňuje uživatelům přidávat další informace k symbolům v legendě.
...
### Funkce: Načíst skript ze šablony
...
Ve verzi 3.2 nyní podporují dynamické parametry následující algoritmy:
- Smazat díry
...
Tento algoritmus prohodí hodnoty souřadnic X a Y ve vstupních geometriích. Lze jej použít k opravě geometrií, u kterých byly omylem přehozeny hodnoty zeměpisné šířky a délky.
...
This feature was developed by [Nyall Dawson (North Road)](https://north-road.com)
### Funkce: Omezit seznam tabulek pro připojení k databázi Oracle na přednastavené schéma
