...
section: projekt
sidebar: true
title: Přehled změn pro QGIS 3.30
type: visual-changelog

---
{{<content-start >}}
# Přehled změn pro QGIS 3.30{#changelog330 }
![image1](images/projects/af9e5405a8329d7de8959238a3d499da780c1598.png)

Datum vydání: 2023-03-04
...
- Zahrnout podkladovou mapu OpenStreetMap do HTML výstupu Leaflet
...
| Neaktualizuje se omezení klíč/hodnota výrazu | [#51791](https://github.com/qgis/QGIS/issues/51791) | [PR #51804](https://github.com/qgis/QGIS/pull/51804) | [PR #51811](https://github.com/qgis/QGIS/pull/51811) |
...
| Fix trust parameter not saved and not read | nehlášeno | [PR #51854](https://github.com/qgis/QGIS/pull/51854) | TODO |
...
| Split tool tries to split even without any digitized points | nehlášeno | [PR #51831](https://github.com/qgis/QGIS/pull/51831) | [PR #51955](https://github.com/qgis/QGIS/pull/51955) |
...
| Immediately apply color ramp label precision and suffix changes when auto apply is checked | Unreported | [PR #51989](https://github.com/qgis/QGIS/pull/51989) | Nevhodné |
...
| Don\'t try to download whole COG locally in order to determine open options | Unreported | [PR #51982](https://github.com/qgis/QGIS/pull/51982) | Nevhodné |
...
| Fix inefficient vector iteration when no rule based rules match current map scale | Unreported | [PR #51904](https://github.com/qgis/QGIS/pull/51904) | Nevhodné |
...
| Fix data loss in secondary geometry columns when displaying in attribute form | [#49380](https://github.com/qgis/QGIS/issues/49380) | [PR #51863](https://github.com/qgis/QGIS/pull/51863) | Nevhodné |
| Fix data loss when layers with secondary geometry columns are used in processing tools | [#49380](https://github.com/qgis/QGIS/issues/49380) | [PR #51846](https://github.com/qgis/QGIS/pull/51846) | Nevhodné |
...
| Show an icon for geometry fields | Unreported | [PR #51844](https://github.com/qgis/QGIS/pull/51844) | Nevhodné |
...
| Remember the collapsed state of the vector layer renderer group box | Unreported | [PR #51719](https://github.com/qgis/QGIS/pull/51719) | Nevhodné |
...
| Attribute table form view looses index when the \"yellow\" selection is changed | nehlášeno | [PR #52045](https://github.com/qgis/QGIS/pull/52045) |  |
| Features in Relation Editor are not selectable anymore | nehlášeno | [PR #51914](https://github.com/qgis/QGIS/pull/51914) | Unaffected |
