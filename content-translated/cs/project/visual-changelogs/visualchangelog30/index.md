...
section: projekt
sidebar: true
title: Seznam změn pro QGIS 3.0
type: visual-changelog

---
{{<content-start >}}
# Seznam změn pro QGIS 3.0{#changelog30 }
...
### Funkce: Odebrat osamocený rastrový zásuvný modul Oracle
...
### Funkce: Přidána podpora pro zoomování kolečkem myši s jemným rozlišením
...
To přidává uživatelům možnost nastavit, zda se má barevné schéma vytvořené uživatelem zobrazit v rozevíracích nabídkách barevného tlačítka.
...
Tato funkce byla financována od Andreas Neumann (partial funding)
...
Tato funkce byla financována od QGIS Sponsors and Donors
...
Tuto funkci vyvinul numerous developers
...
This feature was developed by [Nyall Dawson (North Road)](https://north-road.com/)
## Dokumentace
### Funkce: Vylepšení algoritmů zpracování
...
Tato funkce byla financována od QGIS Grant Proposal
...
Tuto funkci vyvinul Even Rouault
...
Tato funkce byla financována od Andreas Neumann, Qtibia Engineering (Tudor Barascu), Karl-Magnus Jönsson, Geonesia (Nicolas Ponzo) & numerous additional anonymous backers whose generous contributions are also highly valued!
...
This feature was developed by [Nyall Dawson (North Road)](https://north-road.com/)
### Funkce: Snadné stylování diskrétních rastrů
...
This feature was developed by [Nyall Dawson (North Road)](https://north-road.com/)
### Funkce: Panel nástrojů s vlastní označováním je nyní vždy povolen
...
Tato funkce byla financována od QGIS Grant Program
...
Tuto funkci vyvinul Kartoza & North Road
...
Tato změna umožňuje uložit výsledky označování do mezipaměti na obrázek po vykreslení mapy. Pokud lze výsledný obrázek štítku uložený v mezipaměti znovu použít pro další vykreslení, bude tomu tak, vyhne se nutnosti překreslení všech vrstev, které se účastní problému značení a řešení řešení značení. V zásadě to znamená, že **obnova plátna v důsledku změn v jakékoli NEZNAČENÉ vrstvě je mnohem rychlejší**. (Změna vrstvy, která je součástí řešení pro popisování, stále vyžaduje úplné překreslení všech označených vrstev)
...
Výběr rozsahu lze kdykoli zrušit kliknutím pravým tlačítkem nebo stisknutím klávesy Esc.
...
Tuto funkci vyvinul Alexander Lisovenko / Paul Blottiere
...
Tuto funkci vyvinul Denis Rouzaud
...
Tato funkce byla financována od Boundless
...
Tuto funkci vyvinul Patrick Valsecchi
### Funkce: Omezení pole lze vynutit nebo ne
...
Tato funkce byla financována od OpenGIS.ch
...
- Vedlejší výhodou zrušení oken composer je to, že **už teď netrpíme chybou Qt**, která blokovala použití plovoucích doků v composer oknech. Nyní můžete odpojit plovoucí panely položek / složení / atd.! Mnohem hezčí pro práci na celé obrazovce s kompozicemi na více monitorech.
...
Tato funkce byla financována od The Swiss QGIS User Group and many more!
...
Filtruje vstupní vrstvu výrazem
...
V důsledku toho byl odstraněn zásuvný modul linterpolace
...
Tuto funkci vyvinul Bernhard Ströbl
...
Umožňuje posunout geometrii o posun x/y.
...
Nabídka Profil umožňuje přepínání mezi profily nebo vytváření nových.
...
Tuto funkci vyvinul Martin Dobias
...
-  import vrstev přetažením z prohlížeče
...
Tuto funkci vyvinul Mathieu Pellerin, Alexander Bury, Paul Blottiere
...
Umožňuje vytváření indexů atributů pro vrstvy spatialite
...
Tuto funkci vyvinul Hugo Mercier
### Feature: dxf export: support reprojection
Tuto funkci vyvinul Juergen E. Fischer
### Feature: Load/save style in database for GPKG and Spatialite
Tuto funkci vyvinul Even Rouault
### Funkce: Vylepšené zpracování výchozích hodnot
...
Tato funkce byla financována od Canton of Zug and the QGEP project
...
V červenci proběhla prezentace na FOSS4G-EU.

Tato funkce byla financována od QGIS.ORG Donors
...
Tato funkce byla financována společností DB Fahrwegdienste GmbH
...
Tím se konečně vrátí konzistentní stav pojmenování v API pro geometrii
### Renames
| QGIS 2 | QGIS 3 |
| --- | --- |
...
Tuto funkci vyvinul Matthias, Nyall and others
...
Pokud má úloha závislé vrstvy, které mají být odstraněny, úloha se automaticky zruší.
