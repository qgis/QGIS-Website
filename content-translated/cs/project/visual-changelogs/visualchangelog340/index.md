...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| QGIS Server filter does not work as expected for intersection filters | [#58220](https://github.com/qgis/QGIS/issues/58220) | Nelze reprodukovat |  |
...
| PostgreSQL authentication gets back to basic if a layer is opened with "execute SQL" from QGIS explorer panel | [#58784](https://github.com/qgis/QGIS/issues/58784) | Nelze reprodukovat |  |
...
| In layer Filter "lower" function not working with diacritical marks | [#58893](https://github.com/qgis/QGIS/issues/58893) | Nelze reprodukovat |  |
...
| Fix issue with vertical lines not visible in the elevation profile tool | nehlášeno | [PR #58959](https://github.com/qgis/QGIS/pull/58959) | N/A |
