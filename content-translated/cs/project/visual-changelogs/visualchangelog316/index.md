...
section: projekt
sidebar: true
title: Přehled změn pro QGIS 3.16
type: visual-changelog

---
{{<content-start >}}
# Přehled změn pro QGIS 3.16{#changelog316 }
...
- Umožňuje uživatelům filtrovat seznam stylů tak, aby se zobrazovaly pouze ty, které jsou aktuálně viditelné.
...
This feature was developed by [Nyall Dawson](https://api.github.com/users/nyalldawson)
### Ovládací kotevní bod pro štítky řádků
...
To přidává podporu pro vykreslování osy na skládaných sloupcových diagramech, pokud byla osa nastavena. Implementace je založena na vykreslování os pro diagram histogramu.
...
Pokud není na plátně mapy povolena časová navigace, výsledky identifikace obsahují pouze informace o aktivních skupinách datových sad, které mají statické datové sady definované v dialogu vlastností sítě.
...
This feature was developed by [Nedjima Belgacem](https://api.github.com/users/NEDJIMAbelgacem)
### Povolení vložených a vzdálených 3D modelů pro 3D bodové symboly
...
To umožňuje snazší přemístění a umístění světelných zdrojů vzhledem k obsahu scény.
...
Tato funkce byla financována městem Canning
...
- Annotations:
  - Paralelně k Tick (Vedle/ Horizontální / Vertikální vzestupný / Vertikální sestupný)
...
Tato funkce byla financována od SMEC/SJ

This feature was developed by [Nyall Dawson](https://api.github.com/users/nyalldawson)
### Export atlas layout as image algorithm
A new native processing algorithm was added to export layout atlases as images.

To je užitečné v modelech, kde se zpracovávají soubory vzdálených dat s cílem použít je jako vrstvy pokrytí atlasu.
...
| Exporting to geopackage changes field type from DATE to DATETIME | [#37857](https://github.com/qgis/QGIS/issues/37857) | není chyba |  |
...
| Přepínání mezi informačními výstupními formáty WMS hází: CRITICAL QTableWidget: nelze vložit položku, která je již vlastněna jiným QTableWidgetem. | [#37215](https://github.com/qgis/QGIS/issues/37215) | [PR #38770](https://github.com/qgis/QGIS/pull/38770) | [PR #38783](https://github.com/qgis/QGIS/pull/38783) |
...
| VectorFileWriter/OGR provider: workaround GDAL 3.1.x bug regarding XLSX and ODS creation | nehlášeno | [PR #38837](https://github.com/qgis/QGIS/pull/38837) | [PR #38853](https://github.com/qgis/QGIS/pull/38853) |
| Coordinate operation widget: avoid repeating scope and remarks | nehlášeno | [PR #38847](https://github.com/qgis/QGIS/pull/38847) | N/A |
...
### Opravy chyb od Alessandra Pasottiho
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Správce zdrojů dat: Velikost okna WMS/WMTS nelze měnit | [#38903](https://github.com/qgis/QGIS/issues/38903) | works for me, pending feedback |  |
...
| Allow to set precision for raster single band presudocolor classification | nehlášeno | [PR #39079](https://github.com/qgis/QGIS/pull/39079) |  |
...
| unreported crash when calling data provider\'s lastError on no errors | nehlášeno | [PR #39267](https://github.com/qgis/QGIS/pull/39267) | N/A |
...
| Transakční skupiny: neaktuální vrstvy, které po uložení nelze upravovat | [#39282](https://github.com/qgis/QGIS/issues/39282) | [PR #39286](https://github.com/qgis/QGIS/pull/39286) | není kritický |
...
| Wrong extension handling in links when layer name has dots | nehlášeno | [PR #39346](https://github.com/qgis/QGIS/pull/39346) | N/A |
...
| Seqmentation fault 11 on QGIS shutdown on MacOS | nehlášeno | [PR #38806](https://github.com/qgis/QGIS/pull/38806) | [PR #38748](https://github.com/qgis/QGIS/pull/38748) |
...
| QGIS padá při startu na Macu | [#38858](https://github.com/qgis/QGIS/issues/38858) | poškozený uživatelský profil | N/A |
...
| Customization: the widget catcher can\'t select icon from a toolbar when it\'s under a group of icons | [#22967](https://github.com/qgis/QGIS/issues/22967) | [PR #39209](https://github.com/qgis/QGIS/pull/39209) | není kritický |
...
### Opravy chyb od Paula Blottiera
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Fixes OGC API Features certification | nehlášeno | [PR #37622](https://github.com/qgis/QGIS/pull/37622) | N/A |
...
| m function returns Nan when used with a 2d point geometry | nehlášeno | [PR #38831](https://github.com/qgis/QGIS/pull/38831)/commits/829ee25d431b2b3d1ea08fa8a930bb519ab2dd2f |  |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| Legend nodes overlapping each other after inserting | [#38881](https://github.com/qgis/QGIS/issues/38881) | [PR #38882](https://github.com/qgis/QGIS/pull/38882) | není kritický |
| Poor legend performance with complex legends | [#38890](https://github.com/qgis/QGIS/issues/38890) | [PR #38891](https://github.com/qgis/QGIS/pull/38891) | není kritický |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| QgsProcessingAlgRunnerTask started inside function crashes QGIS | [#38583](https://github.com/qgis/QGIS/issues/38583) | Neopraví |  |
...
| Closed ID column for temporary layer is not detected when creating virtual layers using data source manager | [#34830](https://github.com/qgis/QGIS/issues/34830) | Neopraví |  |
...
| Closed virtual fields can\'t be filtered | [#28072](https://github.com/qgis/QGIS/issues/28072) | Nereprodukováno |  |
| Qgis crached after calculated field removed | [#26486](https://github.com/qgis/QGIS/issues/26486) | Nereprodukováno |  |
| sql \"order by\" does not work with the \"Add/Edit Virtual Layer\" feature | [#29043](https://github.com/qgis/QGIS/issues/29043) | Neopraví |  |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| correctly determine if variables are static in aggregate expression and filter, give \@parent in generic aggregates | [#33382](https://github.com/qgis/QGIS/issues/33382) | [PR #39391](https://github.com/qgis/QGIS/pull/39391) | ne |
| Freeze when using aggregate in a virtual field | [#39366](https://github.com/qgis/QGIS/issues/39366) | Neopraví |  |
...
| Název chyby | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| Core topology fixer issues | nehlášeno | [PR #39392](https://github.com/qgis/QGIS/pull/39392) |  |
...
| Improve default lighting of 3d scenes | nehlášeno | [Commit 350bc602e0ecd0f93dc2cc90ab34ce09993a687b](https://github.com/qgis/QGIS/commit/350bc602e0ecd0f93dc2cc90ab34ce09993a687b) | N/A |
...
| Fix preview symbol when offsetting point symbols isn\'t shown correctly | nehlášeno | [Commit 62409b92ce20a84dd92188cf42a98d7cdc0b08c3](https://github.com/qgis/QGIS/commit/62409b92ce20a84dd92188cf42a98d7cdc0b08c3) | N/A |
| Use click-click behavior for rotate and offset marker tools | nehlášeno | [Commit 00a3a6b8057f96dfa6c37943427a276cd3a5065d](https://github.com/qgis/QGIS/commit/00a3a6b8057f96dfa6c37943427a276cd3a5065d) | N/A |
| Avoid massive UI hangs when a layer has complicated actions defined | nehlášeno | [Commit 9aa805c15bb2cf8f9ba33fd2905f5784d6eb4668](https://github.com/qgis/QGIS/commit/9aa805c15bb2cf8f9ba33fd2905f5784d6eb4668) | Too risky |
| Ensure display expression is used for map action tool, not raw feature ids | nehlášeno | [Commit e304d4d7e3eae0f48f336c7eb34542be6055df5d](https://github.com/qgis/QGIS/commit/e304d4d7e3eae0f48f336c7eb34542be6055df5d) | Low priority |
| Improve UX when configuring lights in a 3d scene, fixes confusing interface | nehlášeno | [Commit 3019b82100d4fc405f64cebcddf9aaae253c4293](https://github.com/qgis/QGIS/commit/3019b82100d4fc405f64cebcddf9aaae253c4293) | N/A |
...
| Expose metadata tab for mesh layers | nehlášeno | [Commit 9482b1be70f36f778f6a409847244c5ff8a6a739](https://github.com/qgis/QGIS/commit/9482b1be70f36f778f6a409847244c5ff8a6a739) | N/A |
...
| Don\'t force a whole layout map to be rasterised just because one vector layer has non 100% opacity | nehlášeno | [Commit 2d15a4cfad6c732cf640fbb0eabd625856b643ca](https://github.com/qgis/QGIS/commit/2d15a4cfad6c732cf640fbb0eabd625856b643ca) | Too risky |
| Ensure mesh layer properties follows same appearance as other layer types | nehlášeno | [Commit 3c67e1acde24a49bcb0356c2ef5ed6cb8102fdac](https://github.com/qgis/QGIS/commit/3c67e1acde24a49bcb0356c2ef5ed6cb8102fdac) | N/A |
| Speed up mesh triangulation algorithm by avoiding a bunch of unnecessary QVector detachments | nehlášeno | [Commit 46ef391a7acf10515a11c19b69fafa4548046448](https://github.com/qgis/QGIS/commit/46ef391a7acf10515a11c19b69fafa4548046448) | N/A |
| Don\'t allow users to set 3d terrain to mesh or DEM without selecting an elevation layer, instead show friendly warning | nehlášeno | [Commit 0d9f1da846c70764fa6840309b5460f713b30e1f](https://github.com/qgis/QGIS/commit/0d9f1da846c70764fa6840309b5460f713b30e1f) | N/A |
| Avoid 3d map config dialog opening with initially out-of-sync selected pane | nehlášeno | [Commit 8b6477208f3c34e228734f7c04d32625965c48ed](https://github.com/qgis/QGIS/commit/8b6477208f3c34e228734f7c04d32625965c48ed) | N/A |
| Fix menu not shown when clicking \'add\' item in style manager dialog and color ramp tab is active | nehlášeno | [Commit a085ce84b81a46896c9f00ee64eccaea63dad29a](https://github.com/qgis/QGIS/commit/a085ce84b81a46896c9f00ee64eccaea63dad29a) | N/A |
| Oprava při pokusu o vytvoření nového kapátka z první stránky v dialogu správce stylů nic nedělá | nehlášeno | [Commit 34fb646f7ab69f20072b4d74ebec0595054089d7](https://github.com/qgis/QGIS/commit/34fb646f7ab69f20072b4d74ebec0595054089d7) | N/A |
| \[processing\] Fix generated layers stored in geopackage always report a feature count of 0 | nehlášeno | [Commit 0675d99b34ee209a09857dfcba47cb5a92f55154](https://github.com/qgis/QGIS/commit/0675d99b34ee209a09857dfcba47cb5a92f55154) | Too risky |
| Fix Import Geotagged photos algorithm incorrectly assigns form widgets when saving the results to GPKG | nehlášeno | [Commit ff336ade18f4d6b307e4ed0e98fee77ee11a157c](https://github.com/qgis/QGIS/commit/ff336ade18f4d6b307e4ed0e98fee77ee11a157c) | [PR #39563](https://github.com/qgis/QGIS/pull/39563) |
| \[processing\] Ensure driverName is passed to QgsVectorLayerExporter so that GPKG specific optimisations can be applied when saving outputs to geopackage | nehlášeno | [Commit 501c63feb3887e18da35188062546186d8a767ac](https://github.com/qgis/QGIS/commit/501c63feb3887e18da35188062546186d8a767ac) | Too risky |
...
| Use proper SQL code editor in filter preview widget in vector layer properties, don\'t show filter as disabled | nehlášeno | [Commit 0f4270cfe600e77f09db7727bd3ba965be7acb0e](https://github.com/qgis/QGIS/commit/0f4270cfe600e77f09db7727bd3ba965be7acb0e) | N/A |
| Fix boolean literal presentation in dox/PyQGIS docs | nehlášeno | [Commit 746ee315bd0a4140f6e84617d547cc89103f79aa](https://github.com/qgis/QGIS/commit/746ee315bd0a4140f6e84617d547cc89103f79aa) | N/A |
| Speed up QGIS geometry validation | nehlášeno | [Commit 2a15c3b0a4a631db1b55ac7e46256fdbd89949f9](https://github.com/qgis/QGIS/commit/2a15c3b0a4a631db1b55ac7e46256fdbd89949f9) | Too risky |
...
| Allow expanding xls, ods, gpx, pdf files in browser so that layer sources can be repaired for these file types | nehlášeno | [Commit 252976b739527e213f5d1c8c98a345911dfeab32](https://github.com/qgis/QGIS/commit/252976b739527e213f5d1c8c98a345911dfeab32) | N/A |
| \[processing\] Fix \"Split with lines\" algorithm can get stuck in an endless loop | nehlášeno | [Commit 05645b320d8547f50a308843e961e343c383036d](https://github.com/qgis/QGIS/commit/05645b320d8547f50a308843e961e343c383036d) | Too risky |
| Don\'t show cascaded feature deletion warnings and feedback if joined deleted features came from an auxilary layer | nehlášeno | [Commit 8c79b94fcc14e41d4442a018554e889f81b8e080](https://github.com/qgis/QGIS/commit/8c79b94fcc14e41d4442a018554e889f81b8e080) | N/A |
...
| Fix edited and new features no longer correctly show their corresponding color shading in the feature list view | nehlášeno | [Commit a195b056624c2fabe231be7c0e96c3d63e052e5b](https://github.com/qgis/QGIS/commit/a195b056624c2fabe231be7c0e96c3d63e052e5b) | Too risky/low priority |
...
| Ensure all code editors in QGIS follow the same appearance and behavior | nehlášeno | (many) | N/A |
| When creating a CRS from WKT and the WKT has an embedded CRS name, correctly use this to set the QgsCoordinateReferenceSystem description | nehlášeno | [Commit 9a35b27630982d63101c57c3e3440dcbf1a7786f](https://github.com/qgis/QGIS/commit/9a35b27630982d63101c57c3e3440dcbf1a7786f) | Possible after further user testing |
| Big speed up for scripts which fire off many individual feature requests to a memory provider layer | nehlášeno | [Commit 1d2bb41752c51e6c9b84124a1ce1599d3d42b41c](https://github.com/qgis/QGIS/commit/1d2bb41752c51e6c9b84124a1ce1599d3d42b41c) | Too risky |
| \[console\] Fix exception when running scripts | nehlášeno | [Commit 5c8013df6129a2bc06d25a98ff20dbf27621bff5](https://github.com/qgis/QGIS/commit/5c8013df6129a2bc06d25a98ff20dbf27621bff5) | N/A |
| \[layouts\] Fix resizing multiline label items to adjust to the size of their text | nehlášeno | [Commit 6829e6351e1dab18f1fa0c0443107eb7617794c7](https://github.com/qgis/QGIS/commit/6829e6351e1dab18f1fa0c0443107eb7617794c7) | Too risky |
| Improve appearance of PyQGIS documentation for functions which return multiple values | nehlášeno | [Commit 0001ec27a43cbf4c99d1525c3c5f75183e96f5c3](https://github.com/qgis/QGIS/commit/0001ec27a43cbf4c99d1525c3c5f75183e96f5c3) | N/A |
| \[processing\] Don\'t raise a generic \"something went wrong\" exception when calling processing.run(), instead use proper descriptive exception | nehlášeno | [Commit 2207c30a247e5907a12185165b4bd220e255bbdc](https://github.com/qgis/QGIS/commit/2207c30a247e5907a12185165b4bd220e255bbdc) | Too risky |
...
| \[processing\] Fix crash in model designer when a child algorithm contains hidden parameters | nehlášeno | [Commit f3c9f9bfbc2fc456c77965be4c1e65cc692bc0d0](https://github.com/qgis/QGIS/commit/f3c9f9bfbc2fc456c77965be4c1e65cc692bc0d0) | N/A |
| Ensure True/False are treated as Python keywords in Python code editor | nehlášeno | [Commit 5f661045c078b7938550c2c9d0798664c6f65f5a](https://github.com/qgis/QGIS/commit/5f661045c078b7938550c2c9d0798664c6f65f5a) | N/A |
...
| Fix dropping processing script algorithm .py file on QGIS no longer triggers the algorithm to execute | nehlášeno | [Commit 64bf347d7e1d664fc674c5ca602ce6c4bedecdf9](https://github.com/qgis/QGIS/commit/64bf347d7e1d664fc674c5ca602ce6c4bedecdf9) | N/A |
...
| When restoring a custom CRS from XML, if the CRS does NOT match any of the existing user defined CRS\'s on the QGIS profile then still restore the previously saved name of the custom CRS | nehlášeno | [Commit e6d316ace7031821e04ca625e35f7c2c4d57f639](https://github.com/qgis/QGIS/commit/e6d316ace7031821e04ca625e35f7c2c4d57f639) | Possible after further user testing |
| Don\'t refer to valid but custom CRSes as \"Unknown CRS\" and instead use \"Custom CRS\" phrasing | nehlášeno | [Commit d3833fd8d6c4b4f0673c4c2337044c224675185f](https://github.com/qgis/QGIS/commit/d3833fd8d6c4b4f0673c4c2337044c224675185f) | Possible after further user testing |
...
| Improve behavior of CRS selector and transformation widgets | nehlášeno | many | N/A |
...
| \[layouts\] When selecting a CRS for a map item, don\'t show misleading no crs option at the top of the dialog | nehlášeno | [Commit c3a26db4babbef46ae1b7904bb9d1f0ee9e273ad](https://github.com/qgis/QGIS/commit/c3a26db4babbef46ae1b7904bb9d1f0ee9e273ad) | Too risky |
| Fix \"layer has no CRS\" message incorrectly show at the top of many projection selection dialog boxes | nehlášeno | [Commit c68d05cc40f8f2c828e5204e6e4f5f11e68b4a7c](https://github.com/qgis/QGIS/commit/c68d05cc40f8f2c828e5204e6e4f5f11e68b4a7c) | Too risky |
...
| Avoid qt warning when dragging a non-color object over color buttons | nehlášeno | [Commit fd771bba68da84b1ce8023898b9662b5dc619693](https://github.com/qgis/QGIS/commit/fd771bba68da84b1ce8023898b9662b5dc619693) | N/A |
...
| Don\'t try to write empty rendered rings/geometries to GeoPDF outputs | nehlášeno | [Commit 96753cfd1b9e986841158675bda365e585c48c27](https://github.com/qgis/QGIS/commit/96753cfd1b9e986841158675bda365e585c48c27) | Possible after further user testing |
...
| Dramatic speed up for calling some frequently used methods from PyQGIS | nehlášeno | [Commit d4a2dddac5a2fd4fcf901cc3d50f70a6119ca1ca](https://github.com/qgis/QGIS/commit/d4a2dddac5a2fd4fcf901cc3d50f70a6119ca1ca) | Too risky |
...
| Fix incorrect capitalization in title of new layout name dialog | nehlášeno | [Commit 92d0ec59a1c26c4ac33d35b9e6c93344845eddca](https://github.com/qgis/QGIS/commit/92d0ec59a1c26c4ac33d35b9e6c93344845eddca) | N/A |
...
| \[browser\] Correctly save expanded node state when closing QGIS | nehlášeno | [Commit 2eff061bf3cdcb3f36956e43098adfcb0359b5eb](https://github.com/qgis/QGIS/commit/2eff061bf3cdcb3f36956e43098adfcb0359b5eb) | Too risky |
| \[browser\] Gpkg and other container types can be dragged to the map to allow layers to be added from them | nehlášeno | [Commit 0234d4e9e10f3fbb5732f66e00eebd038f502ab0](https://github.com/qgis/QGIS/commit/0234d4e9e10f3fbb5732f66e00eebd038f502ab0) | Too risky |
...
| Fix can no longer paste colors from text strings | nehlášeno | [PR #39561](https://github.com/qgis/QGIS/pull/39561) | N/A |
