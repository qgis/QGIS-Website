...
title: Práce s QGIS v infrastruktuře prostorových dat Jalisco v Mexiku
type: case-study

---
{{<content-start >}}
# Práce s QGIS v infrastruktuře prostorových dat Jalisco v Mexiku
...
Instituto de Información Territorial del Estado de Jalisco je vládní organizace, která byla založena v roce 1998 za účelem sdílení geografických informací mezi vládními agenturami Jalisco v Mexiku.
...
V průběhu let instituce shromáždila spoustu informací v několika formátech, jako jsou mimo jiné SHP, DWG, DXF, GeoTIFF a ECW. Chtěli jsme tedy mít všechny tyto informace dostupné, uspořádané a ve společném formátu, abychom je mohli poskytovat a zobrazovat na internetu.
