...
title: Vytváření výstupu podobného arcHYDRO pomocí QGIS
type: case-study

---
{{<content-start >}}
# Vytváření výstupu podobného arcHYDRO pomocí QGIS
...
Pro vytvoření srážkových sítí jsem provedl statistickou analýzu tabulek GHCN, abych zjistil hloubky srážek pro návrhové bouřky s návratností 1,2,5,10,50,100 let. Poté jsem si stáhl volně dostupnou vzorovou síť PRISM pro Čínu a za předpokladu lineárního vztahu jsem převedl průměrné hodnoty buněk na maximální hodnoty buněk, abych mohl vytvořit sítě maximálních intenzit srážek.
## Závěr
