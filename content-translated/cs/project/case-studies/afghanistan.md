...
title: Dánská odminovací skupina používá QGIS v Afghánistánu
type: case-study

---
{{<content-start >}}
# Dánská odminovací skupina používá QGIS v Afghánistánu
...
QGIS se také dobře synchronizuje s daty získanými při operacích v terénu pomocí ručních přístrojů Garmin GPS, což umožňuje vytvářet odminovací mapy s vyznačením míst nalezených a zničených min.
