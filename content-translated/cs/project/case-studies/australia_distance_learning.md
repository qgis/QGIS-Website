...
title: QGIS pro dálkové studium a výuku GIS na univerzitách
type: case-study

---
{{<content-start >}}
# QGIS pro dálkové studium a výuku GIS na univerzitách
...
## Úvod
University of Southern Queensland (USQ) je regionální univerzita v jihovýchodním Queenslandu v Austrálii. Studuje na ní 28 000 studentů, a to jak v kampusu, tak mimo něj. Přístup studentů mimo kampus k moderním technologiím, jako jsou internetové služby, se značně liší. Používají také různé typy počítačů (např. notebooky, stolní počítače atd.) s různými operačními systémy (např. Windows, MacOS a Linux).

Poskytování vzdělávání v režimu On-campus i Off-campus s sebou nese mnoho technologických výzev. Výuka kurzu GIS vyžaduje překonání těchto výzev. Do základního kurzu GIS se každoročně zapíše v průměru 300-350 studentů. Přibližně 80 % z nich studuje v režimu off-campus.
...
Vzdělávání v oblasti GIS není úplné bez praktických dovedností při zpracování dat. Poskytnout praktické dovednosti v oblasti GIS studentům mimo kampus však není snadné kvůli problémům s přístupem k internetu, cenou softwarových licencí a kompatibilitou s různými počítačovými operačními systémy.
...
Pro naše potřeby byly vyhodnoceny různé geoprostorové programy s otevřeným přístupem. QGIS se ukázal jako nejvhodnější pro překonání téměř všech problémů, kterým jsme čelili. Mezi jeho konkrétní výhody patřila bezplatná dostupnost, uživatelská přívětivost, přizpůsobivost a nezávislost na platformě. Přijali jsme jej a obohatili o další výukové zdroje vyvinuté v USQ.
...
- *Detailnost zaznamenaných audiovizuálních záznamů QGIS.*
- *Používání a učení se softwaru QGIS*
- *Software QGIS byl zajímavý*
- *Kurz se mi líbil, zejména používání QGIS*
- *Dobrá volba používat open source software*
- *Videa pomáhající s orientací v QGIS byla fantastická*
- *Praktické činnosti a výuka QGIS*
- *Používání programů prostřednictvím QGIS v praxi*
- *QGIS byl skvělý pro získání zkušeností s používáním softwaru GIS*
- *Školící videa QGIS pomohla naučit se základy balíku GIS*
- *Přednášky pomohly s QGIS tím, že vám přesně ukázaly, jak program používat*
- *Použití QGIS pomohlo rozdělit a pochopit teorii přednesenou v tomto kurzu*
- *Cvičení QGIS jsou dobře navržena a provádějí studenty krok za krokem procesem používání GIS*.
...
## Závěr
Závěrem lze říci, že používání softwaru QGIS při výuce kurzů GIS na vzdělávacích institucích s online výukovým prostředím přináší velké výhody jak studentům, tak univerzitě. Pro úspěšné využití QGIS pro výuku a učení jsou však důležité dva aspekty. Zaprvé je třeba vytvořit přizpůsobené praktické výukové zdroje vhodné pro místní prostředí a zadruhé by měl postup hodnocení vyžadovat použití softwaru.
## Autoři
