...
* QGIS vystymas/kodo keitimas
* Indėlis į QGIS dokumentaciją ir mokymo medžiagą
* QGIS medžiagos vertimas
* Priedų kūrimas
* Problemų registravimas
* Naujų savybių kūrimo finansavimas
* QGIS sponsoriavimas ir finansinis indėlis
* Įsitraukimas į vietines QGIS naudotojų grupes
* Atvirų QGIS kursų publikavimas
* QGIS knygų rašymas

#### Programa
Jūs turite pateikti visų jūsų kursų mokymo medžiagą, įskaitant pratimus, paskaitas ir duomenis. Bus tikrinamas medžiagos šiuolaikiškumas, QGIS projekto pateikimo tikslumas ir bendra kokybė. Jei medžiaga bus nepakankamos kokybės, tai gali būti atmetimo priežastis.
