...
Tai nesusipratimas, kurį mes kartas nuo karto girdime, bet jis neteisingas. QGIS parama yra neprivaloma. Atsisiuntus QGIS rodomas pranešimas, primenantis, kad galite pasirinktinai paremti QGIS. Kaip ten bebūtų, jūs galite spausti „Uždaryti šį pranešimą“ ir be jokių problemų tęsti atsisiuntimą. Mes norime, kad QGIS būtų prieinamas visiems, nepriklausomai nuo to, kokia yra jūsų finansinės situacija. Jei QGIS naudojate pirmą kartą, mes rekomenduojame atsisiųsti, įdiegti ir išbandyti QGIS, kad suprastumėte, ar programinė įranga naudinga ir tinka jūsų užduotims spręsti. Tik tada, jei jums patinka QGIS ir ji stipriai padeda jūsų darbe, užduotyse ar procesuose, jūs turėtumėte pagalvoti apie QGIS paramą ar tapimą palaikančiu nariu.
### Kaip užduoti QGIS klausimą?
...
- pageidautina informatyvią jūsų laiško antraštę
- kurią QGIS versiją jūs naudojate šiuo metu (tiksliai)
- ką tikitės gauti
- jei galima, ką jūs jau pabandėte ir kokį gavote rezultatą
- jei jūsų klausimas yra apie tai, kad kažkas sulūžta, taipogi galite nurodyti:
  - kokia konkrečiai yra klaida (jei galima: ekrano nuotrauką, klaidų suvestinę, klaidos teksto kopiją)
  - kuri operacinė sistema ir versija
  - kaip įdiegėte (osgeo4w? atskiras diegimas? patys susikompiliavote?)
  - kokiu metu sulūžo (perdiegimo, naujo diegimo, sistemos atnaujinimo, projekto pakeitimo)
...
{{<rich-box-end >}}
### Kaip parenkami QGIS laidų pavadinimai?
Po sėkmingai vystytojų susitikimo Ciuriche (Šveicarijoje) mes nusprendėme, kad kita laida turėtų būti su juo susijusi. Nuo tada visos laidos vadinamos pagal vystytojų susitikimų vietas.
### Ar galiu atverti ECS failus su QGIS?
...
## Developer questions
### Ar galiu savarankiškai susikompiliuoti QGIS?
...
**Cituokite QGIS serverio dokumentaciją**
...
**Cituokite QGIS API dokumentaciją**
...
```
### Aš sukūriau žemėlapį su QGIS, ar turiu paminėti QGIS?
...
{{<rich-content-start themeClass="coloring-1" >}}
##### Note
Nerašykite ©QGIS, nes QGIS neturi autorinių teisių į jūsų darbą.
