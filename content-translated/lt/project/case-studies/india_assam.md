...
title: QGIS tigrų stebėjimui (naudojant slaptas kameras Nameri Tigrų rezervate, Assam'e,
  Indijos Sonitpur apskrityje)
type: case-study

---
{{<content-start >}}
# QGIS tigrų stebėjimui (naudojant slaptas kameras Nameri Tigrų rezervate, Assam'e, Indijos Sonitpur apskrityje)
...
Tokiame kraštovaizdyje pagrindinės saugomos rūšys yra Karališkas Bengalijos tigras, Azijos dramblys, Indijos bizonas, paprastasis leopardas, laukinis šuo, Sambaro elnias, lojantis elnias, šernas-elnias, laukinis šernas ir keletas kitų rūšių. NTR paukščių įvairovė taip pat įspūdinga: iki šiol identifikuota virš 370 paukščių rūšių. Rezervatą tvarko Assam'o miškų departamentas, Assamo vyriausybė.
## QGIS naudojimas rašant slaptų kamerų studiją
Indijos Nacionalinė tigrų apsaugos vadovybė (NTCA) nuo 2011 metų paskelbė, kad tigrus stebėti slaptomis kameromis yra privaloma visuose tigrų rezervatuose. Pagal šį naują protokolą 100 kvadratinių kilometrų tigrų rezervatų bus įdiegtos 25 kamerų poros, atrankos periodas 40-60 dienų. Šis naujas tigrų stebėjimo protokolas stipriai priklauso nuo GIS.
...
2012-13 metais mes įdiegėme NTR'e šį naują tigrų stebėjimo protokolą naudodami QGIS. Visų pirma mes suskaitmeninome NTR ribas QGIS'u ir įrašėme jas kaip poligoną. Šis ribos poligonas buvo eksportuotas į GPS navigacijos lauko apžiūrų metu tikslams. Mes vykdėme išsamią NTR apžiūrą, ieškodami tigrų buvimo ženklų, tokių kaip išmatų ir apdraskymų. Buvo įrašytos tigrų ženklų GPS pozicijos, taipogi ir vietos, tinkamos slaptoms kameroms. Baigus apžiūrą, duomenys buvo perkelti į QGIS naudojant GPS įrankius tolesniam apdorojimui ir galutinėms kamerų pozicijoms nustatyti. Buvo paruoštas shape failas su tigrų ženklais ir galimomis slaptų kamerų pozicijomis.
...
Šį straipsnį parašė Rajendra G. Garawad 2013 metų kovą. Jis yra Indijos Assam'o Nameri Tigrų rezervato lauko direktorius. Jis turi miško mokslų, apsaugos ir žemės tvarkymo magistro laipsnį.
