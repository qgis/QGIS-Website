...
title: QGIS nuotoliniam mokymui ir GIS dėstymui Universitetuose
type: case-study

---
{{<content-start >}}
# QGIS nuotoliniam mokymui ir GIS dėstymui Universitetuose
...
## Įvadas
Pietų Kvynslando Universitetas (USQ) yra regioninis universitetas pietryčių Australijoje. Jame 28000 studentų mokosi miestelyje ir už jo ribų. Ne studentų miestelyje besimokančių studentų prieiga prie modernių technologijų, tokių kaip interneto paslaugos, stipriai keičiasi. Jie taip pat naudoja skirtingus kompiuterių tipus (pvz. skreitinukus, darbastalio kompiuterius ir pan.) su skirtingomis operacinėmis sistemomis (pvz. Windows, MacOS ir Linux).

Mokymas tiek miestelyje, tiek ir už jo ribų turi daug iššūkių. GIS kurso mokymas reikalauja įveikti šiuos iššūkius. Vidutiniškai 300-350 studentų įstoja į bazinį GIS kursą kiekvienais metais. Apie 80% iš jų studijuoja ne miestelyje.
...
## QGIS Pietų Kvynslando Universitete
GIS mokymai nepilni be praktinių apdorojimo žinių. Bet teikti praktines GIS žinias studentams už miestelio ribų nėra paprasta, nes kyla problemų su interneto prieiga, programinės įrangos licencijų kainomis ir suderinamumu su skirtingomis kompiuterių Operacinėmis sistemomis.
...
Mūsų poreikiams buvo įvertinos skirtinga geoerdvinė programinė įranga. QGIS pasirodė labiausiai tinkamas visų mūsų iššūkių sprendimui. Ypatingai naudinga pasirodė laisvas priėjimas, draugiškumas, pritaikomumas ir nepriklausomybė nuo platformų. Mes jį panaudojom ir papildėm papildomais mokymosi resursais, sukurtais USQ.
...
- *Įrašytos QGIS audio-vizualinės medžiagos detalumas.*
- *QGIS programinės įrangos naudojimas ir mokymasis*
- *QGIS programinė įranga buvo įdomi*
- *Man patiko kursas, ypač QGIS naudojimas*
- *Puiki proga naudoti atviro kodo programinę įrangą*
- *QGIS orientavimosi pagalbos video medžiaga buvo fantastiška*
- *QGIS praktinės užduotys ir mokymas*
- *Praktinis programų naudojimas su QGIS*
- *QGIS buvo puiki susipažįstant su GIS programine įranga*
- *QGIS mokymo video medžiaga padėjo išmokti GIS paketo pagrindus*
- *Paskaitos padėjo su QGIS, parodant kaip tiksliai naudoti programą*
- *QGIS naudojimas padėjo išsiveržti ir suprasti teoriją, kuri dėstoma šiame kurse*
- *QGIS pratimai gerai sukurti ir leidžia studentams pažingsniui naudoti GIS*
...
## Išvada
Taigi QGIS programinės įrangos naudojimas dėstant GIS kursus mokymosi institucijose su internetu pasiekiamomis mokymosi aplinkomis suteikia didžiulę naudą tiek studentams, tiek ir universitetui. Yra du svarbūs aspektai, kad QGIS būtų sėkmingai naudojamas mokymuisi ir mokymui. Visų pirma reikia sukurti savo praktinio mokymosi resursus, tinkamus vietinei aplinkai. Antra, įvertinimo procedūra turi reikalauti programinės įrangos naudojimo.
## Autoriai
