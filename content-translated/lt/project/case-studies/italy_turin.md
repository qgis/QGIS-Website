...
Geo-hidrologinių Turino apsaugos tyrimo institutas (IRPI), kuris yra Italijos nacionalinės tyrimų tarybos (CNR) narys, savo veiklą pradėjo 1970 metais. Nuo įsteigimo surinktos įvairios žinios, pavyzdžiui hirdogeologinių Alpine-Po upės (šiaurės Italijoje) savybių sistemos studija, natūralių nelaimių stebėjimas, prognozavimas ir prevencija. Šios užduotys vykdomos naudojant tarpdisciplininį požiūrį, įskaitant židinio mokslus, inžineriją ir geomatiką.
...
Fotogramų rinkinys yra ypatingai svarbus ir tyrimams (pavyzdžiui Godone et al, 2014) ir profesionalioms aplinkoms (4 pav.). Aprašytų procedūrų ir įrankių dėka rinkinys pilnai prieinamas ir nuo 2009 metų fotogramos naudojamos keliuose projektuose tiek vidiniuose instituto, tiek ir išoriniuose projektuose. QGIS savybės ir priedai leidžia kurti įrankius ir procedūras, optimizuojančias fotogramų archyvą tiek jo įgyvendinimo, tiek ir valdymo aspektu.
...
Franco Godone specializuotas technikas, dirbantis Geo-hirdologiniame Turino aplinkos tyrimo institute (IRPI-CNR) nuo 1972 metų. Dirba su alpių regionų topografiniais ir aerofotogrametriniais tyrimais ir duomenų analize.
