...
section: projektą
sidebar: true
title: QGIS 3.30 pakeitimai
type: visual-changelog

---
{{<content-start >}}
# QGIS 3.30 pakeitimai{#changelog330 }
![image1](images/projects/af9e5405a8329d7de8959238a3d499da780c1598.png)

Laidos data: 2023-03-04
...
- Leaflet HTML išvesties pavadinimas
- Leaflet HTML išvesties šaltiniai
- Įtraukti OpenStreetMap bazinį žemėlapį Leaflet HTML išvestyje
...
| Weird interval QgsDoubleSpinbox behavior in graduated symbology with fixed interval | [#51687](https://github.com/qgis/QGIS/issues/51687) | [PR #51714](https://github.com/qgis/QGIS/pull/51714) | Ne |
...
| wms getLegendGraphic call the group and not the layer when many style layers add from browser | [#51759](https://github.com/qgis/QGIS/issues/51759) | [PR #51765](https://github.com/qgis/QGIS/pull/51765) | Ne |
...
| Changes on geometry get discarded on save edits when layer filter is enabled (gpkg layer) | [#51934](https://github.com/qgis/QGIS/issues/51934) | Man veikia |  |
...
| PyQGIS QgsPolygon creation crashes | [#51978](https://github.com/qgis/QGIS/issues/51978) | [PR #52004](https://github.com/qgis/QGIS/pull/52004) | PADARYTI |
...
| Crash when switching style to point displacement from geometry generator | [#51070](https://github.com/qgis/QGIS/issues/51070) | [PR #51784](https://github.com/qgis/QGIS/pull/51784) | PADARYTI |
| Fix trust parameter not saved and not read | not reported | [PR #51854](https://github.com/qgis/QGIS/pull/51854) | PADARYTI |
...
| Immediately apply color ramp label precision and suffix changes when auto apply is checked | Unreported | [PR #51989](https://github.com/qgis/QGIS/pull/51989) | Neaktualu |
...
| Don\'t try to download whole COG locally in order to determine open options | Unreported | [PR #51982](https://github.com/qgis/QGIS/pull/51982) | Neaktualu |
...
| Fix inefficient vector iteration when no rule based rules match current map scale | Unreported | [PR #51904](https://github.com/qgis/QGIS/pull/51904) | Neaktualu |
...
| Fix data loss in secondary geometry columns when displaying in attribute form | [#49380](https://github.com/qgis/QGIS/issues/49380) | [PR #51863](https://github.com/qgis/QGIS/pull/51863) | Neaktualu |
| Fix data loss when layers with secondary geometry columns are used in processing tools | [#49380](https://github.com/qgis/QGIS/issues/49380) | [PR #51846](https://github.com/qgis/QGIS/pull/51846) | Neaktualu |
...
| Show an icon for geometry fields | Unreported | [PR #51844](https://github.com/qgis/QGIS/pull/51844) | Neaktualu |
...
| Remember the collapsed state of the vector layer renderer group box | Unreported | [PR #51719](https://github.com/qgis/QGIS/pull/51719) | Neaktualu |
...
| Attribute table form view looses index when the \"yellow\" selection is changed | nepranešta | [PR #52045](https://github.com/qgis/QGIS/pull/52045) |  |
| Features in Relation Editor are not selectable anymore | nepranešta | [PR #51914](https://github.com/qgis/QGIS/pull/51914) | Unaffected |
