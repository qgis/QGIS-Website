...
| Problem with Reloading SLD file in QGIS | [#50152](https://github.com/qgis/QGIS/issues/50152) | [PR #50266](https://github.com/qgis/QGIS/pull/50266) | eilėje |
| Unreported endless alg splitwithlines | Unreported | [PR #50279](https://github.com/qgis/QGIS/pull/50279) | Not recommended |
| Processing algorithm \"Split with lines\" does not split polygon | [#50227](https://github.com/qgis/QGIS/issues/50227) | Ne riktas |  |
...
| Wrong interpretation of SLD color opacity | [#44657](https://github.com/qgis/QGIS/issues/44657) | Ne riktas |  |
...
| SpatiaLite - Added feature vanishes, attribute dialog does not show required fields | [#50523](https://github.com/qgis/QGIS/issues/50523) | [PR #50573](https://github.com/qgis/QGIS/pull/50573) | eilėje |
...
| Rikto pavadinimas | URL issues.qgis.org (jei pranešta) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| GML import is missing one feature without geometry | [#50215](https://github.com/qgis/QGIS/issues/50215) | [PR #50231](https://github.com/qgis/QGIS/pull/50231) | Neaktualu |
...
| QGIS ignores field inherited from parent feature type in WFS 2.0 services | [#42660](https://github.com/qgis/QGIS/issues/42660) | [PR #50300](https://github.com/qgis/QGIS/pull/50300) | Neaktualu |
...
| Build fails with WITH_POSTGRESQL=OFF | [#50075](https://github.com/qgis/QGIS/issues/50075) | Atsiliepimai |  |
...
| Fix broken logic in clearing python console history | Nepranešta | [PR #50504](https://github.com/qgis/QGIS/pull/50504) | [PR #50515](https://github.com/qgis/QGIS/pull/50515) |
| Fix QgsFileWidget does not reactivate widget\'s window after selecting a file/folder via the browse button on mac | Nepranešta | [PR #50501](https://github.com/qgis/QGIS/pull/50501) | [PR #50502](https://github.com/qgis/QGIS/pull/50502) |
| Fix code folding not shown for non-python code editor classes | Nepranešta | [PR #50492](https://github.com/qgis/QGIS/pull/50492) |  |
| Fix leak in GEOS geometry library use | Nepranešta | [PR #50379](https://github.com/qgis/QGIS/pull/50379) |  |
...
| Fix truncation of recent project list removes too many items, raises a warning | Nepranešta | [PR #50394](https://github.com/qgis/QGIS/pull/50394) | [PR #50397](https://github.com/qgis/QGIS/pull/50397) |
...
| Fix broken path in svg raises Qt warnings while rendering | Nepranešta | [PR #50383](https://github.com/qgis/QGIS/pull/50383) |  |
...
| Avoid a redundant calculation of visible layer extent in overview canvas | Nepranešta | [PR #50329](https://github.com/qgis/QGIS/pull/50329) | [PR #50336](https://github.com/qgis/QGIS/pull/50336) |
