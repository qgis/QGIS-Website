...
| Rikto pavadinimas | URL issues.qgis.org (jei pranešta) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| Wrong raster projection on HIDPI screens | [#46882](https://github.com/qgis/QGIS/issues/46882) | [PR #46931](https://github.com/qgis/QGIS/pull/46931) | PADARYTI |
| Data Source Manager title not translatable | [#46929](https://github.com/qgis/QGIS/issues/46929) | [PR #46932](https://github.com/qgis/QGIS/pull/46932) | PADARYTI |
| QGIS 3.22 - Identical map names in print composer | [#46927](https://github.com/qgis/QGIS/issues/46927) | Man veikia |  |
| Bold and italic attributes of labels that reinitialize | [#46896](https://github.com/qgis/QGIS/issues/46896) | Man veikia |  |
...
| Virtual layer not loaded correctly after re-opening a project | [#46834](https://github.com/qgis/QGIS/issues/46834) | [PR #46938](https://github.com/qgis/QGIS/pull/46938) | PADARYTI |
| QGIS crashes while calling readLayerXml() | [#46741](https://github.com/qgis/QGIS/issues/46741) | Man veikia |  |
| Crash when changing orientation of page in layout | [#46575](https://github.com/qgis/QGIS/issues/46575) | [PR #46972](https://github.com/qgis/QGIS/pull/46972) | PADARYTI |
| \"sort\" funcionality of attributes table sort numeric fields as text | [#34935](https://github.com/qgis/QGIS/issues/34935) | [PR #47035](https://github.com/qgis/QGIS/pull/47035) | PADARYTI |
| OAPIF: api-key not included when requesting /collections endpoint | [#46535](https://github.com/qgis/QGIS/issues/46535) | [PR #47145](https://github.com/qgis/QGIS/pull/47145) | PADARYTI |
| XML notation if missing from tooltips in vector file writer dialog | [#46508](https://github.com/qgis/QGIS/issues/46508) | [PR #47148](https://github.com/qgis/QGIS/pull/47148) | PADARYTI |
| Ignore out of range option in interpolated symbol renderer creates artifacts if start value is out of range | [#46362](https://github.com/qgis/QGIS/issues/46362) | [PR #47174](https://github.com/qgis/QGIS/pull/47174) | PADARYTI |
| start width \> end width is ignored when using the \"exact\" color interpolation method | [#46371](https://github.com/qgis/QGIS/issues/46371) | [PR #47195](https://github.com/qgis/QGIS/pull/47195) | PADARYTI |
...
| (Un)force hide form in relation widget | [#47226](https://github.com/qgis/QGIS/issues/47226) | [PR #47245](https://github.com/qgis/QGIS/pull/47245) | PADARYTI |
...
| HTML/String-ish QByteArray as result of expression function breaks expression preview display | [#46174](https://github.com/qgis/QGIS/issues/46174) | [PR #47229](https://github.com/qgis/QGIS/pull/47229) | PADARYTI |
...
| Layout Attribute Table sorting does not work in Print Layouts when column name has spaces | [#43744](https://github.com/qgis/QGIS/issues/43744) | [PR #47249](https://github.com/qgis/QGIS/pull/47249) | PADARYTI |
...
| fix server crash | nepranešta | [PR #47271](https://github.com/qgis/QGIS/pull/47271) | PADARYTI |
| Load QGIS project from command line from a PostgreSQL project | [#47270](https://github.com/qgis/QGIS/issues/47270) | [PR #47272](https://github.com/qgis/QGIS/pull/47272) | PADARYTI |
...
| Value map widget: \"value\"/\"description\" inconsistency when table added to print layouts | [#41798](https://github.com/qgis/QGIS/issues/41798) | [PR #47300](https://github.com/qgis/QGIS/pull/47300) | PADARYTI |
| Missing entries in attributetable in layout with atlas at page break | [#44086](https://github.com/qgis/QGIS/issues/44086) | [PR #47303](https://github.com/qgis/QGIS/pull/47303) | PADARYTI |
| Server OAPIF: bbox filter isn\'t working if data source CRS is not EPSG:4326/WGS84 | [#47302](https://github.com/qgis/QGIS/issues/47302) | [PR #47318](https://github.com/qgis/QGIS/pull/47318) | PADARYTI |
...
| Filter for WFS layer: The \"Tables\" button is missing | [#46887](https://github.com/qgis/QGIS/issues/46887) | Ne riktas |  |
...
| Rikto pavadinimas | URL issues.qgis.org (jei pranešta) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| Trying to add GPKG from data source manager crashes QGIS master | [#46463](https://github.com/qgis/QGIS/issues/46463) | [PR #46928](https://github.com/qgis/QGIS/pull/46928) | neaktualu |
...
| Fixes to QgsGeometry::addPart + new test cases | nepranešta | [PR #47009](https://github.com/qgis/QGIS/pull/47009) |  |
...
| Error opening data loader dialog from MetaSearch | [#40490](https://github.com/qgis/QGIS/issues/40490) | Man veikia |  |
...
| Wrong signature of the QgsProcessingParameterMeshDatasetGroups when exporting to Python | nepranešta | [PR #47152](https://github.com/qgis/QGIS/pull/47152) | [PR #47156](https://github.com/qgis/QGIS/pull/47156) |
...
| Unable to delete files .shp and .dbf using python code (removeMapLayers, deleteShapeFile) | [#39428](https://github.com/qgis/QGIS/issues/39428) | Man veikia |  |
| QgsProcessingParameterFile extension option | [#45633](https://github.com/qgis/QGIS/issues/45633) | Ne riktas |  |
...
| Fix output filename when a raster is saved in a format without extension | nepranešta | [PR #46992](https://github.com/qgis/QGIS/pull/46992) | PADARYTI |
| WFS GetFeature document and exceptions | nepranešta | [PR #47198](https://github.com/qgis/QGIS/pull/47198) | PADARYTI |
| Exluding a print layout in project propteries -\> server do not avoid that a GetPrint request can be done for that layout | [#46140](https://github.com/qgis/QGIS/issues/46140) | [PR #47199](https://github.com/qgis/QGIS/pull/47199) | PADARYTI |
| Server: Can\'t enable WFS3 API update endpoint (PUT/PATCH) on layers without geometry | [#46119](https://github.com/qgis/QGIS/issues/46119) | Man veikia |  |
...
| Rikto pavadinimas | URL issues.qgis.org (jei pranešta) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| Add .tsv extension to delimited text supported files filter | reported on youtube screencast | [PR #47181](https://github.com/qgis/QGIS/pull/47181) | laukiama |
| Fix line anchor placements are reversed for labels which sit below lines | nepranešta | [PR #47181](https://github.com/qgis/QGIS/pull/47181) | [PR #47181](https://github.com/qgis/QGIS/pull/47181) |
| Fix incorrect return code from QgsProcessingModelAlgorithm::fromFile when file does not exist | nepranešta | [PR #47161](https://github.com/qgis/QGIS/pull/47161) | [PR #47162](https://github.com/qgis/QGIS/pull/47162) |
| Fix many georeferencer regressions | multiple | nepranešta | laukiama |
...
| Fix sqlite errors on startup caused by default style database import logic | nepranešta | [PR #47070](https://github.com/qgis/QGIS/pull/47070) | not suitable |
| Fix color widgets incorrectly change colors when mouse is hovered over widget | nepranešta | [PR #47069](https://github.com/qgis/QGIS/pull/47069) | [PR #47077](https://github.com/qgis/QGIS/pull/47077) |
| Avoid crs definition errors when closing options dialog | [#47014](https://github.com/qgis/QGIS/issues/47014) | [PR #47061](https://github.com/qgis/QGIS/pull/47061) | nėra |
| Fix duplicate shortcut registered warning on startup | nepranešta | [PR #46983](https://github.com/qgis/QGIS/pull/46983) | not suitable |
| Fix scroll wheel events get \"stuck\" when scrolling to bottom of areas | nepranešta | [PR #46958](https://github.com/qgis/QGIS/pull/46958) | [PR #46987](https://github.com/qgis/QGIS/pull/46987) |
...
| Fix broken merge features tool | nepranešta | [PR #46924](https://github.com/qgis/QGIS/pull/46924) | nėra |
