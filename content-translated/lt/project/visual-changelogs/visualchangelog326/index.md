...
| Rikto pavadinimas | URL Issues (if reported, Github) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Non-existent but registered attribute table in GPKG is added as empty table | [#30670](https://github.com/qgis/QGIS/issues/30670) | [GDAL PR 5752](https://github.com/OSGeo/gdal/pull/5752) | Neaktualu |
...
| Raster tiles are clipped based on the gpkg_contents bounding box of a GeoPackage | [#45530](https://github.com/qgis/QGIS/issues/45530) | Ne riktas |  |
...
| Rikto pavadinimas | URL Issues (if reported, Github) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| \@project_keywords are no longer tested on Rule based filters | [#48480](https://github.com/qgis/QGIS/issues/48480) | Ne riktas |  |
...
| Highlight of identified feature not displaying correctly on \"geometry generator\" marker from different CRS | [#48439](https://github.com/qgis/QGIS/issues/48439) | [PR #48579](https://github.com/qgis/QGIS/pull/48579) | PADARYTI |
| Cannot past copied features as temporary scratch layer | [#48401](https://github.com/qgis/QGIS/issues/48401) | [PR #48611](https://github.com/qgis/QGIS/pull/48611) | PADARYTI |
| QGIS crash by opening a form with relation content | [#48443](https://github.com/qgis/QGIS/issues/48443) | [PR #48616](https://github.com/qgis/QGIS/pull/48616) | PADARYTI |
| Relation reference widget: filter expression does not work with variables | [#48190](https://github.com/qgis/QGIS/issues/48190) | [PR #48619](https://github.com/qgis/QGIS/pull/48619) | PADARYTI |
...
| Inconsistent coordinate rounding in Raster \"Layer Properties\" | [#48767](https://github.com/qgis/QGIS/issues/48767) | [PR #48790](https://github.com/qgis/QGIS/pull/48790) | PADARYTI |
...
| Layer filter does not work on multiline strings values with linebreaks | [#47530](https://github.com/qgis/QGIS/issues/47530) | [PR #48818](https://github.com/qgis/QGIS/pull/48818) | nereikia |
...
| Server GetPrint with multiple maps following map themes apply prefixed LAYERS (map0:LAYERS) to all maps | [PR #48923](https://github.com/qgis/QGIS/pull/48923) | [PR #48923](https://github.com/qgis/QGIS/pull/48923) | PADARYTI |
...
| GDAL Vector to Raster (gdal_rasterize) fail to produce ESRI ASCII as output | [#39140](https://github.com/qgis/QGIS/issues/39140) | Ne riktas |  |
...
| Rikto pavadinimas | URL Issues (if reported, Github) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| Add simple bash script to run tests as done by CI | [QGIS QEP #244](https://github.com/qgis/QGIS-Enhancement-Proposals/issues/244) | [PR #48617](https://github.com/qgis/QGIS/pull/48617) | Neaktualu |
...
| Check that source files are not overridden | [#25830](https://github.com/qgis/QGIS/issues/25830) | [PR #48654](https://github.com/qgis/QGIS/pull/48654) | Neaktualu |
...
| Improve UX for virtual layer creation dialog | nepranešta | [PR #49015](https://github.com/qgis/QGIS/pull/49015) | Neaktualu |
...
| Fix some undersized icons on hidpi displays | nepranešta | [PR #48875](https://github.com/qgis/QGIS/pull/48875) | Neaktualu |
...
| Fix clear values for offset along line spin boxes | nepranešta | [PR #48872](https://github.com/qgis/QGIS/pull/48872) | [PR #48878](https://github.com/qgis/QGIS/pull/48878) |
...
| Never show the transformation selection dialog for the first layer added to a project | nepranešta | [PR #48811](https://github.com/qgis/QGIS/pull/48811) | [PR #48814](https://github.com/qgis/QGIS/pull/48814) |
...
| Fix loss of mesh layer styling when fixing a broken path to a mesh layer | nepranešta | [PR #48765](https://github.com/qgis/QGIS/pull/48765) | [PR #48768](https://github.com/qgis/QGIS/pull/48768) |
...
| Don\'t hide parts of the mesh renderer widget if the layer is invalid | nepranešta | [PR #48757](https://github.com/qgis/QGIS/pull/48757) |  |
| Add layer opacity widget in mesh layer renderer properties widget | nepranešta | [PR #48756](https://github.com/qgis/QGIS/pull/48756) |  |
| Review and finish open PR [PR #44941](https://github.com/qgis/QGIS/pull/44941) |  |  |  |
| Fix a crash when QgsProject::instance() is accessed when no QgsApplication exists | nepranešta | [PR #48721](https://github.com/qgis/QGIS/pull/48721) | N/A |
...
| Add support for map field types to memory provider, avoid data loss in models/processing | nepranešta | [PR #48638](https://github.com/qgis/QGIS/pull/48638) | Too intrusive |
...
| Fix many memory leaks | nepranešta | [PR #48590](https://github.com/qgis/QGIS/pull/48590) | N/A |
| Fix ctrl modifier scrolling on symbol buttons | nepranešta | [PR #48581](https://github.com/qgis/QGIS/pull/48581) | N/A |
