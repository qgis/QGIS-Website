...
| GDAL processing provider: "FutureWarning: Neither ogr.UseExceptions() nor ogr.DontUseExceptions() has been explicitly called" warning | [#57344](https://github.com/qgis/QGIS/issues/57344) | [PR #57477](https://github.com/qgis/QGIS/pull/57477) | Neaktualu |
...
| Rikto pavadinimas | URL issues.qgis.org (jei pranešta) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| QGIS Server GetFeatureInfo issue on WMTS layer | [#57441](https://github.com/qgis/QGIS/issues/57441) | [PR #57491](https://github.com/qgis/QGIS/pull/57491) | eilėje |
...
| Generate XYZ tiles' does not render labels from ArcGIS Vector Tile Service layers | [#57443](https://github.com/qgis/QGIS/issues/57443) | [PR #57517](https://github.com/qgis/QGIS/pull/57517) | eilėje |
| Empty space after host name in SQL server, cause inconsistent error | [#57358](https://github.com/qgis/QGIS/issues/57358) | [PR #57518](https://github.com/qgis/QGIS/pull/57518) | eilėje |
| GDAL/OGR processing algorithms may silently output incorrect result if an input is a vector "memory" layer with a "fid" column | [#57343](https://github.com/qgis/QGIS/issues/57343) | [PR #57522](https://github.com/qgis/QGIS/pull/57522) | eilėje |
| attribute table row sorting doesn't work | [#57338](https://github.com/qgis/QGIS/issues/57338) | [PR #57624](https://github.com/qgis/QGIS/pull/57624) | eilėje |
| Unable to edit elements in the print layout after locking an element | [#57331](https://github.com/qgis/QGIS/issues/57331) | [PR #57543](https://github.com/qgis/QGIS/pull/57543) | eilėje |
...
| Server: OAPIF/WFS3 service collection id missmatch | [#57556](https://github.com/qgis/QGIS/issues/57556) | [PR #57561](https://github.com/qgis/QGIS/pull/57561) | eilėje |
...
| [ux][layouts] Fix legend item style mutex | nepranešta | [PR #57605](https://github.com/qgis/QGIS/pull/57605) | N/A |
...
| QGIS Server wrongly positions the map objects in the output when there's more than one map | [#57631](https://github.com/qgis/QGIS/issues/57631) | Ne riktas |  |
...
| Identify Results for raster data value does not use correct decimal separator | [#57765](https://github.com/qgis/QGIS/issues/57765) | [PR #57769](https://github.com/qgis/QGIS/pull/57769) | eilėje |
...
| Rikto pavadinimas | URL issues.qgis.org (jei pranešta) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Wrongly displayed action widget | [#33464](https://github.com/qgis/QGIS/issues/33464), [#57398](https://github.com/qgis/QGIS/issues/57398), [#56966](https://github.com/qgis/QGIS/issues/56966) | [PR #57475](https://github.com/qgis/QGIS/pull/57475) | Neaktualu |
| Custom properties variableNames and variableValues are cleared when more than one layer custom variable exist | [#57334](https://github.com/qgis/QGIS/issues/57334) | [PR #57490](https://github.com/qgis/QGIS/pull/57490) | Neaktualu |
| Default values depending on other fields are not correctly applied when field not part of form made by Drag and Drop Designer | [#57411](https://github.com/qgis/QGIS/issues/57411) | [PR #57527](https://github.com/qgis/QGIS/pull/57527) | Neaktualu |
...
| Rikto pavadinimas | URL issues.qgis.org (jei pranešta) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Source-tree documentation improvements | nepranešta | [PR #57594](https://github.com/qgis/QGIS/pull/57594) |  |
...
| Rikto pavadinimas | URL issues.qgis.org (jei pranešta) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Avoid crash on summary when error list is empty | nepranešta | [PR #57658](https://github.com/qgis/QGIS/pull/57658) | [PR #57661](https://github.com/qgis/QGIS/pull/57661) |
...
| Postgres layer with multi geometry columns fails to export | [#57757](https://github.com/qgis/QGIS/issues/57757) | Ne riktas |  |
...
| Rikto pavadinimas | URL issues.qgis.org (jei pranešta) | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgsabstractmaterialsettings: Handle selection in addParametersToEffect | nepranešta | [PR #57803](https://github.com/qgis/QGIS/pull/57803) | not backported |
| qgs3daxis: Fix cube face picking | nepranešta | [PR #57848](https://github.com/qgis/QGIS/pull/57848) |  |
...
| Fix some grass vectors incorrectly show as datasets | nepranešta | [PR #57780](https://github.com/qgis/QGIS/pull/57780) | [PR #57786](https://github.com/qgis/QGIS/pull/57786) |
...
| Limit fixed interval classification to generate at most 999 classes | [PR #50290](https://github.com/qgis/QGIS/pull/50290) | [PR #57722](https://github.com/qgis/QGIS/pull/57722) | Neaktualu |
| Don't try to connect widget to null vector tile layers | nepranešta | [PR #57721](https://github.com/qgis/QGIS/pull/57721) | N/A |
| Don't show invalid "Style not found in database" warning when adding vector tile layers | nepranešta | [PR #57714](https://github.com/qgis/QGIS/pull/57714) | Neaktualu |
| Replace processing default extension setting with string based setting | [#57676](https://github.com/qgis/QGIS/issues/57676) | [PR #57702](https://github.com/qgis/QGIS/pull/57702) | Neaktualu |
...
| Fix add feature dialog does not restore position when shown modally | nepranešta | [PR #57686](https://github.com/qgis/QGIS/pull/57686) | [PR #57700](https://github.com/qgis/QGIS/pull/57700) |
| Fix python script editor "open in external editor" action | nepranešta | [PR #57682](https://github.com/qgis/QGIS/pull/57682) | Neaktualu |
| Fix broken prefetch capabilities for raster layers | nepranešta | [PR #57663](https://github.com/qgis/QGIS/pull/57663) | [PR #57667](https://github.com/qgis/QGIS/pull/57667) |
| Fix missing field type information in eg the horizontal header tooltips in attribute table | nepranešta | [PR #57621](https://github.com/qgis/QGIS/pull/57621) | Neaktualu |
| Don't try to paint to indexed image | nepranešta | [PR #57601](https://github.com/qgis/QGIS/pull/57601) |  |
| Clamp values for set_color_part function to avoid qt warnings when out of range values are specified | nepranešta | [PR #57600](https://github.com/qgis/QGIS/pull/57600) |  |
| Add some tests for rendering text with RTL markers | [PR #57586](https://github.com/qgis/QGIS/pull/57586) |  |  |
| Fix rotation based orientation when html labeling enabled | nepranešta | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Too intrusive |
| Fix data defined font size is ignored when HTML labeling is active | nepranešta | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Too intrusive |
| Don't set @value to line height when evaluating multi line alignment | nepranešta | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Too intrusive |
...
| Fix incorrect buffers drawn for html label item | nepranešta | [PR #57551](https://github.com/qgis/QGIS/pull/57551) | [PR #57571](https://github.com/qgis/QGIS/pull/57571) |
| Fix label mask sizes get reset to 0 | nepranešta | [PR #57555](https://github.com/qgis/QGIS/pull/57555) | [PR #57569](https://github.com/qgis/QGIS/pull/57569) |
...
| Make brush and stroke style combo box icons visible on dark themes | nepranešta | [PR #57506](https://github.com/qgis/QGIS/pull/57506) | [PR #57510](https://github.com/qgis/QGIS/pull/57510) |
