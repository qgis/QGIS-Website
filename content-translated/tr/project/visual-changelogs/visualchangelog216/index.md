...
section: proje
sidebar: true
title: QGIS 2.16 için değişim günlüğü
type: visual-changelog

---
{{<content-start >}}
# QGIS 2.16 için değişim günlüğü{#changelog216 }
...
Yaptığımız çalışmaları takdir eden çeşitli kuruluşlardan yıllık destek alıyoruz ve projeye giden onca çabayı kolaylaştırmak istiyoruz. Bu sponsorlar bizim teşekkürlerimiz ile aşağıda listelenmiştir!
