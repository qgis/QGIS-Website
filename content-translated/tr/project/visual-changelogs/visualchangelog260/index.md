...
section: proje
sidebar: true
title: QGIS 2.6 için değişim günlüğü
type: visual-changelog

---
{{<content-start >}}
# QGIS 2.6 için değişim günlüğü{#changelog26 }
Release date: 2014-10-31

Bir sonraki QGIS 2.6.0 sürümü için sürüm notu. En popüler Ücretsiz masaüstü CBS'yi daha da fazla özellikli ve kullanışlı hale getirmek için birçok yeni özellik, ince ayar ve iyileştirme ekledik.
...
{{<table-of-contents >}}
## Genel
### Özellik: Özelliklerdeki proje dosya ismi
Proje özellikleri iletisindeki QGIS proje dosyası için tüm dizini görebilirisiniz.

![](images/entries/8662dc4a69298f603dd9038d1199ab16fd25f786.webp)
### Özellik: Silme/geri alma tuşları ile ölçerken son noktayı çıkarma izni.
Şimdi alanları ve mesafeleri ölçerken, silme ve geri alma tuşunu kullanarak ölçüm hattınızdaki istenmeyen köşeleri silebilirsiniz.
...
### Özellik: Editör widget'ları
Editör widget'larına bir takım iyileştirmeler yaptık:
- new edit widget for date/time capable of setting null dates
- filtre satırı düzenle
