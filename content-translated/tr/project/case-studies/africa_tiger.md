...
title: 'Su Gözlem ve Bilgi Sistemi: Afrikadaki Birleştirilmiş Su Kaynakları Yönetimi
  için Yer Gözlem Verisi Kullanımını Etkinleştirme'
type: case-study

---
{{<content-start >}}
# Su Gözlem ve Bilgi Sistemi: Afrikadaki Birleştirilmiş Su Kaynakları Yönetimi için Yer Gözlem Verisi Kullanımını Etkinleştirme
