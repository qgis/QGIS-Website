...
title: QGIS le Fundy Footpath Örnek Haritası oluşturmak
type: case-study

---
{{<content-start >}}
# QGIS le Fundy Footpath Örnek Haritası oluşturmak
...
## Proje
QGIS te yeni bir Fundy Footpath haritası oluşturma işlevi üç parçaya ayrılabilir:
- Veri toplama
- Veri düzeltmek ve hazırlama.
- Harita üretimi.
...
Nihai harita ürününde kullanılacak verileri hazırlamak üzere belirli görevleri yerine getirmek için QGIS içindeki aşağıdaki araçlar kullanılmıştır:
- GPS ile toplanan veriler düzenleme araç çubuğunu kullanarak temizlendi.
- NRCan ve SNB'den elde edilen vektör verileri bir araya getirilmiş, sorgulanmış ve vektör araçları kullanılarak nihai harita alanı için kırpılmıştır.
...
Bu makale Ocak 2013'te Jarrett Totton tarafından verildi. Jarrett, Alberta, Kanada'da yaşayan bir GIS teknolojistidir.
