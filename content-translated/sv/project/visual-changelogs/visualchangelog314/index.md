...
1. Skapa slumpraster (binomial fördelning)
2. Skapa slumpraster (exponentiell fördelning)
3. Skapa slumpraster (gamma-fördelning)
4. Skapa slumpraster (negativ binominal fördelning)
5. Skapa slumpraster (normalfördelning)
6. Skapa slumpraster (poissonfördelning)
7. Skapa slumpraster (jämn fördelning)
...
This feature was developed by [Nyall Dawson](https://api.github.com/users/nyalldawson)
## Applikations- och Projektalternativ
...
| Fixes to numbered list handling in dox/PyQGIS API | unreported | [Commit 74400c7](https://github.com/qgis/QGIS/commit/74400c7ff88d563dad74dad41860f9b603214973) | Nej |
| Fix cross references in PyQGIS docs | unreported | [Commit 81a9db9](https://github.com/qgis/QGIS/commit/81a9db9f57706cba9b11e4372dd1bf50fcd7bc6a) | Nej |
