...
section: projekt
sidebar: true
title: Ändringslogg för QGIS 2.18
type: visual-changelog

---
{{<content-start >}}
# Ändringslogg för QGIS 2.18{#changelog218 }
...
{{<table-of-contents >}}
## Sponsorer för QGIS-version 2.18.0
Årligen får vi också stöd från olika organisationer som uppskattar det arbete vi gör och vill underlätta en hållbar utveckling av det arbete som går in i projektet. Dessa sponsorer listas nedan med vårt tack!
