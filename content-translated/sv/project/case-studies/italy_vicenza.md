...
Ett schema som förklarar arbetsflödet:
...
Samtidigt ritades byggnadsfasaderna i QCAD (LibreCAD).

PDR:en (piani di recupero) måste följa strikta regler som kräver en bestämd grafik:
- Nuvarande status
- Projektstatus
- Avsedd användning (nuvarande)
- Avsedd användning (projekt)
