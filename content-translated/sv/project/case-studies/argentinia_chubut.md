...
## Om projektet
Huvudsyftet med projektet var att föreläsa för elever i 12:e klass, i genomförandet av GIS som ett verktyg för att optimera och förbättra hanteringen av geografisk information, och för att ge ett stöd till beslutsprocessen.
...
- Användning av GIS som ett tekniskt verktyg för att bekräfta social-rumsliga hypoteser.
...
- Praktiska och teoretiska lektioner; framförallt genom användandet av QGIS och fördelen av urbana grönområden och dess geografiska konsekvenser.
- Kartografisk modellering, definiering av vektorlager, utveckling av GIS-databaser.
- Fältarbeten (trädens registrerade data och GPS-positioner)
...
## Författare
Denna artikel skrevs i september 2011 av Mauro Novara och Alberto Vázquez från Argentina.
