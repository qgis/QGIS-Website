...
sidebar: true
subtitle: Att ge alla tillgång till verktyg för spatial visualisering och beslutsfattande
title: Översikt över QGIS
type: page
...
Upplev QGIS omfattande uppsättning designalternativ för att förverkliga dina kartografiska idéer.
...
Skapa och redigera punkter, linjer, polygoner och mesher med precision.
###### Avancerade konstruktionsverktyg
Skapa geometrier med kurvor, CAD-liknande verktyg och ett stort antal geometriska transformationer.
...
Få insikter från dina data med hjälp av vårt omfattande utbud av hundratals analysverktyg.
###### Automatiserade arbetsflöden för analys
Kombinera analysverktyg visuellt för att enkelt skapa reproducerbara arbetsflöden.
###### Utökad analysmiljö
...
Övervinn utmaningarna med dataintegration med stöd för en mängd olika datakällor och format.
###### Standarder och interoperabilitet
Förstärk din påverkan genom att utforska, använda och skapa webbtjänster baserade på branschstandarder.
...
Dra nytta av de kraftfulla funktionerna för symbologi, märkning och blandning för att imponera på världen med dina kartor.
...
[Gå till kartutställningen]({{< ref "project/overview/maps.md" >}})
