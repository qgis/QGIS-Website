...
{{<content-start >}}
# Infrastruktur
Sidan bör visa all infrastruktur och alla tjänster som QGIS använder, samt aktuella kontakter och ägare.
...
**Main contact:** Gary
## Huvudserver
{{<rich-list listLink="http://documentation.qgis.org" layoutClass="half" listTitle="Huvudserver" listSubtitle="http://documentation.qgis.org" >}}
...
Dokumentation och hemsida
-
{{<rich-list listLink="http://docs.qgis.org" layoutClass="half" listTitle="Dokumentation" listSubtitle="http://docs.qgis.org" >}}

{{<rich-list listLink="http://new.qgis.org" layoutClass="half" listTitle="Hemsida" listSubtitle="http://new.qgis.org" >}}
...
Flickr-grupper
-
{{<rich-list listLink="http://www.flickr.com/groups/qgis/pool/" layoutClass="half" listTitle="Skärmbilder" listSubtitle="http://www.flickr.com/groups/qgis/pool/" >}}
