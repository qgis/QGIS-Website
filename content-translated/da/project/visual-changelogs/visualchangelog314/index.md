...
1. Opret tilfældigt rasterlag (binominal fordeling)
2. Opret tilfældigt rasterlag (eksponentiel fordeling)
3. Opret tilfældigt rasterlag (gammafordeling)
4. Create random raster layer (negative binomial distribution)
5. Opret tilfældigt rasterlag (normal fordeling)
6. Opret tilfældigt rasterlag (poisson fordeling)
7. Opret tilfældigt rasterlag (uniform fordeling)
