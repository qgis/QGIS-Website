...
Ændringslog for den næste version af QGIS 2.4.0. Vægten på denne version har meget været på polering og ydeevne - vi har tilføjet mange nye funktioner, justeringer og forbedringer for at gøre brugergrænsefladen mere ensartet med professionelt udseende (og forhåbentligt nemmere at bruge). Der er lavet meget på Layout (som bruges til at udskrive kort), for at gøre det til en bedre platform til at danne flotte kartografiske udtryk.
...
Vi har nogle nye funktioner tilgængelige i udtryksbyggeren.
- bounding box (grænser)
- bounding box width & height (bounds_width/bounds_height)
- min/max x/y koordinater (xmin/xmax/ymin/ymax)
...
### Funktion: Forbedringer til HTML rammer
HTML rammer i Layout er blevet forbedret. Der er en ny **tilføj ramme** knap som kan bruges til manuelt at lave flere linkede rammer. Vi har også forbedret vores sidedelings logik, så det er mindre sandsynligt at der vil komme siddelinger som går midt gennem tekstlinjer når der bruges HTML rammer.
