...
section: 프로젝트
sidebar: true
title: QGIS 3.22 변경로그
type: visual-changelog

---
{{<content-start >}}
# QGIS 3.22 변경로그{#changelog322 }
...
| Warning message \'Cannot create temporary SpatiaLite cache\' when adding many WFS-layers | [#44971](https://github.com/qgis/QGIS/issues/44971) | 중복 |  |  |
...
| QGIS on linux crashes when opening many geopackages at once | [#43620](https://github.com/qgis/QGIS/issues/43620) | [PR #45211](https://github.com/qgis/QGIS/pull/45211) | Ｘ |  |
...
| QGIS crash after loading WMS layer via script and zooming in and out | [#44095](https://github.com/qgis/QGIS/issues/44095) | [PR #45254](https://github.com/qgis/QGIS/pull/45254) | Ｘ | Mostly a usage issue |
...
| projecting label coordinates for multiPoint geometry crashes QGIS | [#45148](https://github.com/qgis/QGIS/issues/45148) | [PR #45150](https://github.com/qgis/QGIS/pull/45150) | Ｘ |  |
...
| Attributes - Update All button - Creates Corrupted Fields - GeoJSON file | [#45139](https://github.com/qgis/QGIS/issues/45139) | [PR #45174](https://github.com/qgis/QGIS/pull/45174) | Ｘ |  |
| WMS parent layer added via QGIS Browser doesn\'t use default style | [#45192](https://github.com/qgis/QGIS/issues/45192) | [PR #45209](https://github.com/qgis/QGIS/pull/45209) | Ｘ |  |
...
| Copying table by Drag&Drop in Browser (2) doesn\'t copy the table structure correctly | [#45286](https://github.com/qgis/QGIS/issues/45286) | [PR #45375](https://github.com/qgis/QGIS/pull/45375) | Ｘ |  |
...
| Create spatialite trigger with DBManager do not work | [#45420](https://github.com/qgis/QGIS/issues/45420) | [PR #45553](https://github.com/qgis/QGIS/pull/45553) | Ｘ |  |
...
| macOS: Symbol not found: \_\_cg_jpeg_resync_to_restart when reprojecting raster layer with GDAL warp on macOS | [#40164](https://github.com/qgis/QGIS/issues/40164) | Ｘ | Ｘ | Not an issue with the nightly (qgis-deps-0.9) anymore |
...
| VertexTool. Fixes move vertex on Z layer if CRS are differents (with Vincent Cloarec) | 보고되지 않음 | [PR #45020](https://github.com/qgis/QGIS/pull/45020) | Not backported. Introduce new methods. |  |
...
| \[FIX\] GeometryValidator init curve support | 보고되지 않음 | [PR #45272](https://github.com/qgis/QGIS/pull/45272) |  |  |
...
| Attachment widget options are reset when you reopen the field widget properties | [#45089](https://github.com/qgis/QGIS/issues/45089) | 중복 |  |  |
