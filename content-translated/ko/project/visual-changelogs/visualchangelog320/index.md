...
section: 프로젝트
sidebar: true
title: QGIS 3.20 변경로그
type: visual-changelog

---
{{<content-start >}}
# QGIS 3.20 변경로그{#changelog320 }
...
이 배포판은 최근 QGIS 배포판에 도입된 방대한 분야의 첨단 기능을 강화하는 섬세한 변경 및 안정성 업데이트들을 포함합니다. 이 배포판에는 좌표계와 투영체 정보의 관리 및 표시에 대한 고급 변경 사항 등 수많은 데이터 관리 기능 향상이 포함되어 있습니다. 좌표계에 대한 이런 향상 사항들 가운데, 동적 좌표계의 좌표 기원(epoch) 및 초정밀도 무결성(high accuracy integrity) 경고에 대해 기본적으로 지원하게 되었습니다. 이렇게 QGIS 3.20은 초정밀 시스템을 위한 GIS 및 데이터 관리 분야에서 최첨단의 자리를 굳히게 됐습니다.
...
## 일반
### 기능: 속성 테이블 열기 추가 옵션
필터를 사용해서 캔버스 내에 선택한 항목 또는 가시화된 항목만 표시하도록 속성 테이블을 여는 데 사용할 수 있었던 단축키가 메뉴 툴바에 통합되어 특히 대용량 데이터셋을 작업하는 경우 손쉽게 사용할 수 있고 사용자 경험도 향상시킵니다.
...
| 보조 저장 장치에 저장할 수 없습니다 | [#26365](https://github.com/qgis/QGIS/issues/26365) | [PR #43560](https://github.com/qgis/QGIS/pull/43560) | Risky |
...
| Filter expression from relation reference widget on attributes form, not working properly | [#42803](https://github.com/qgis/QGIS/issues/42803) | [PR #43523](https://github.com/qgis/QGIS/pull/43523) | ○ |
...
| Plugin manager doesn\'t work with proxy | [#43284](https://github.com/qgis/QGIS/issues/43284) | 피드백 |  |
