...
section: 프로젝트
sidebar: true
title: QGIS 3.28 변경로그
type: visual-changelog

---
{{<content-start >}}
# QGIS 3.28 변경로그{#changelog328 }
...
스플래시 스크린에는 1847년 Giuseppe Molini가 그린 피렌체의 희귀하고 특별한 지도가 있습니다. 이 웅장하게 새겨진 지도는 원래 피렌체 건축가 Ferdinando Ruggieri가 1731년에 그린 것입니다. 남쪽을 향한 지도는 Arno 강 양쪽으로 뻗어있는 Florence의 오래된 벽으로 둘러싸인 중심을 덮습니다. 오른쪽 상단 사분면에는 Florence의 백합 상징이 있습니다. 이 지도는 1847년에 인쇄되었지만 두꺼운 종이에 동판을 새겨 17세기 스타일로 준비되었습니다. 1847 년 피렌체는 정치적 변화의 정점에 있었습니다. 이 희귀한 지도가 제작된 지 1년 후, Tuscany 대공은 Florence 전역의 정치적 시위에 대응하여 Tuscany에 최초의 헌법을 부여했습니다.
...
QGIS는 자유 소프트웨어이며 사용하기 위해 어떤 것도 지불할 의무가 없습니다. 사실을 말하자면, 우리는 여러분이 여러분의 재정적 또는 사회적 상태와 상관없이 QGIS를 널리 사용하기를 바랍니다. 우리는 공간적 의사 결정 도구를 통해 사람들에게 힘을 주게 된다면 모든 인류를 위한 더 나은 사회를 맞이할 것이라 믿습니다.

{{<table-of-contents >}}
## 중요 변경 사항
### 기능: QGIS 3.16 이전 버전들과의 심볼에 대한 하위 호환성을 제거
...
3D 보기에서 데이터를 렌더링하는 데 사용할 수 있는 새로운 주변 폐색 효과는 3D 데이터 깊이 인식을 개선하는 데 유용합니다. 이것은 후처리 효과이며 눈 돔 조명(EDL, Eye Dome Lighting)과 결합하여 매우 흥미로운 결과를 얻을 수 있습니다. 효과가 지나치게 단순화되면 카메라에 보이지 않는 기능을 사용하여 주변 요소의 질감을 조정하고 어둡게 하며, 이를 통해 대비, 기능 정의 및 차별화를 개선할 수 있습니다.
...
| Attribute Table Integer entries not showing due to window size | [#50181](https://github.com/qgis/QGIS/issues/50181) | [PR #50201](https://github.com/qgis/QGIS/pull/50201) | 권장하지 않음 |
| WFS3 collections field name/displayName mix in request/response | [#49399](https://github.com/qgis/QGIS/issues/49399) | [PR #50203](https://github.com/qgis/QGIS/pull/50203) | 권장하지 않음 |
...
| Unreported endless alg splitwithlines | Unreported | [PR #50279](https://github.com/qgis/QGIS/pull/50279) | 권장하지 않음 |
...
| SVG is not rendered for SVG Marker symbol | [#50208](https://github.com/qgis/QGIS/issues/50208) | 못 고침, Qt 이슈 |  |
...
| Build fails with WITH_POSTGRESQL=OFF | [#50075](https://github.com/qgis/QGIS/issues/50075) | 피드백 |  |
...
| QGIS master exports out of bounds in layout | [#48624](https://github.com/qgis/QGIS/issues/48624) | 못 고침, Qt 이슈 |  |
| Layout bleeding to edge outside map window | [#49638](https://github.com/qgis/QGIS/issues/49638) | 못 고침, Qt 이슈 |  |
...
| Auxiliary storage and removed layers | [#44667](https://github.com/qgis/QGIS/issues/44667) | [PR #50479](https://github.com/qgis/QGIS/pull/50479) | 권장하지 않음 |
...
| Fix broken logic in clearing python console history | 보고되지 않음 | [PR #50504](https://github.com/qgis/QGIS/pull/50504) | [PR #50515](https://github.com/qgis/QGIS/pull/50515) |
| Fix QgsFileWidget does not reactivate widget\'s window after selecting a file/folder via the browse button on mac | 보고되지 않음 | [PR #50501](https://github.com/qgis/QGIS/pull/50501) | [PR #50502](https://github.com/qgis/QGIS/pull/50502) |
| Fix code folding not shown for non-python code editor classes | 보고되지 않음 | [PR #50492](https://github.com/qgis/QGIS/pull/50492) |  |
| Fix leak in GEOS geometry library use | 보고되지 않음 | [PR #50379](https://github.com/qgis/QGIS/pull/50379) |  |
...
| Fix truncation of recent project list removes too many items, raises a warning | 보고되지 않음 | [PR #50394](https://github.com/qgis/QGIS/pull/50394) | [PR #50397](https://github.com/qgis/QGIS/pull/50397) |
...
| Fix broken path in svg raises Qt warnings while rendering | 보고되지 않음 | [PR #50383](https://github.com/qgis/QGIS/pull/50383) |  |
...
| Avoid a redundant calculation of visible layer extent in overview canvas | 보고되지 않음 | [PR #50329](https://github.com/qgis/QGIS/pull/50329) | [PR #50336](https://github.com/qgis/QGIS/pull/50336) |
