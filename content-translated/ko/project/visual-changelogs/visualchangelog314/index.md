...
QGIS는 자유 소프트웨어로 사용하는 데 그 어떤 것도 지불할 필요가 없습니다. 사실을 말하자면, 우리는 여러분이 QGIS를 여러분의 재정적 또는 사회적 상태와 상관없이 널리 사용하기를 바랍니다. 우리는 사람들이 공간적 의사결정 도구를 사용하게 되면 모든 인류가 더 나은 사회를 맞이할 것이라 확신합니다.
...
1. 랜덤 래스터 레이어 생성 (이항 분포)
2. 랜덤 래스터 레이어 생성 (지수 분포)
3. 랜덤 래스터 레이어 생성 (감마 분포)
4. 랜덤 래스터 레이어 생성 (음의 이항 분포)
5. 랜덤 래스터 레이어 생성 (정규 분포)
6. 랜덤 래스터 레이어 생성 (푸아송 분포)
7. 랜덤 래스터 레이어 생성 (균등 분포)
...
| Fixes to numbered list handling in dox/PyQGIS API | unreported | [Commit 74400c7](https://github.com/qgis/QGIS/commit/74400c7ff88d563dad74dad41860f9b603214973) | Ｘ |
| Fix cross references in PyQGIS docs | unreported | [Commit 81a9db9](https://github.com/qgis/QGIS/commit/81a9db9f57706cba9b11e4372dd1bf50fcd7bc6a) | Ｘ |
