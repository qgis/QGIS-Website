...
section: 프로젝트
sidebar: true
title: QGIS 3.16 변경로그
type: visual-changelog

---
{{<content-start >}}
# QGIS 3.16 변경로그{#changelog316 }
![image1](images/projects/dbc0cef663f2f652e0961ac2ed168eb45ed2e182.png)

Release date: 2020-10-23

QGIS 프로젝트를 위한 또 다른 멋진 날! 새로운 장기 지원 릴리스는 QGIS Desktop과 QGIS Server 모두에 광범위한 기능을 제공합니다. 이 릴리스에서는 3D 매핑, 다른 데이터 유형의 메시 생성, 추가 공간 분석 도구, 기호 및 사용자 인터페이스 향상을 위한 다양한 새 옵션을 제공합니다. 다양한 도구가 계속 확장되는 처리 프레임워크에 통합되었으며 이제 QGIS 브라우저는 이전에 DB 관리자 플러그인 용으로 예약된 고급 데이터베이스 상호 작용 기능을 지원합니다. 이는 이번 릴리스에서 도입된 몇 가지 개선 사항이며, 이전 LTS 사용자는 3.10 이후로 사용할 수 있는 수많은 새로운 기능을 찾을 수 있습니다. 이 새로운 릴리스의 몇 가지 추가 하이라이트를 아래에 자세히 설명하게되어 기쁩니다.
...
| Geometry generator symbol not rendered if the feature itself is not on the map canvas | [#38579](https://github.com/qgis/QGIS/issues/38579) | 피드백 |  |
...
| QGIS crash removing QgsAnnotation in python | [#36098](https://github.com/qgis/QGIS/issues/36098) | 피드백 |  |
...
| Virtual field in virtual layer not found | [#38523](https://github.com/qgis/QGIS/issues/38523) | 피드백 |  |
...
| fails to generate virtual geometry layer based on virtual wkt field | [#28265](https://github.com/qgis/QGIS/issues/28265) | 피드백 |  |
...
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| correctly determine if variables are static in aggregate expression and filter, give \@parent in generic aggregates | [#33382](https://github.com/qgis/QGIS/issues/33382) | [PR #39391](https://github.com/qgis/QGIS/pull/39391) | Ｘ |
