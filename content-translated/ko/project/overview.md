...
### QGIS 서버
사용자의 QGIS 프로젝트와 레이어들을 OGC 호환 WMS, WMTS, WFS 및 WCS 서비스로 공개합니다. 어떤 레이어를 어느 속성, 조판 및 좌표계로 내보낼지 제어합니다. QGIS 서버는 WMS 1.3버전에 대한 참조 구현(reference implementation)으로 간주됩니다.
...
{{<rich-content-start themeClass="coloring-6" >}}
### QGIS 데스크탑
지리공간 정보를 생성, 편집, 시각화, 분석해서 공개(publish)합니다.
