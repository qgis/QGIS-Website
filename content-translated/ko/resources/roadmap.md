...
- 짝수 버전 번호 (2.18, 3.2 등)는 릴리스 버전.
- 홀수 버전 번호 (2.99, 3.1 등)는 개발 버전.
...
| 플랫폼 | 위치 |
| --- | --- |
| 윈도우 | [OSGeo4W]({{< ref "resources/installation-guide#online-osgeo4w-installer" >}}) |
| 리눅스 | [Debian/Ubuntu]({{< ref "resources/installation-guide#repositories" >}}) |
