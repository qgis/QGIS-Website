...
## 개요
실험 및 응용 지리학 연구실(LEAG)는 체코공화국(Vysoká škola obchodní a hotelová, s.r.o.) 브르노에 있는 호텔및경영대학의 일부로서, 이 대학에서는 관광, 경영 그리고 호텔 운영에 대한 고등교육을 제공하고 있습니다. LEAG는 사회-경제적 공간 처리 모델링, 공간 패턴 분석, 장소성과 지역성의 실체에 대한 묘사와 모니터링에 집중하고 있습니다. 
...
- 그래픽 사용자 인터페이스(상업적 제품에 근접한)
- 사용자 요구 기능의 빠른 개발과 통합
- 안정성과 상호호환성(우리는 Windows와 Ubuntu 리눅스 플랫폼을 사용합니다.)
- 기타(Horst Düster 박사가 사례 연구에서 언급함)
...
- 공간적 위치와 거주민 간의 패턴 모델링 
- 지형 시각화를 위한 3차원 모델 생성 (더 나아가 기복에 음용을 주기 위해 활용)
- 중소기업 데이터베이스를 저장, 생성 및 편집(추가적으로 시각화)
...
이 글은 2010년 11월에 Jakub Trojan이 제공한 것입니다. 그는 경영및호텔관리대학(체코공화국 Bron에 있는)의 학술 연구진 중의 한 명입니다. 그는 이곳에서 실험 및 응용 지리학 연구실을 세우고 연구를 이끌고 있습니다. 그는 Masaryk 대학(체코공화국 Brno에 있는) 과학부, 지리학 연구소의 박사과정 학생이기도 합니다. 
