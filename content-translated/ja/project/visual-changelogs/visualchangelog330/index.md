...
section: project
sidebar: true
title: QGIS 3.30 の変更履歴
type: visual-changelog

---
{{<content-start >}}
# QGIS 3.30 の変更履歴{#changelog330 }
...
## 印刷レイアウト
### 機能: 印刷レイアウトのショートカットマネージャ
ショートカットマネージャーは、プライマリQGISインターフェースの設定メニューからアクセスでき、ユーザーが既存のキーボードショートカットを設定およびオーバーライドできるようにし、QGISアクションを実行するためのユーザー定義メソッドをサポートします。
...
### 機能: レイアウト凡例でテキストレンダラを使用
This change allows the use of the full-text renderer capabilities for legend titles, subtitles, and item text.

これにより、バッファー、シャドウ、フォント間隔制御、およびテキスト形式での使用が許可されているその他の利用可能なオプション (混合 HTML 形式を含む) を構成できます。

この機能は NIBIO によって資金提供されました
...
| バグの表題 | URL issues.qgis.org （報告された場合） | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix using interpolated line symbol layer for polygon outlines | 未報告 | [PR #52030](https://github.com/qgis/QGIS/pull/52030) | [PR #52032](https://github.com/qgis/QGIS/pull/52032) |
...
| Immediately apply color ramp label precision and suffix changes when auto apply is checked | 未報告 | [PR #51989](https://github.com/qgis/QGIS/pull/51989) | Not appropriate |
...
| Don\'t try to download whole COG locally in order to determine open options | 未報告 | [PR #51982](https://github.com/qgis/QGIS/pull/51982) | Not appropriate |
...
| Fix inefficient vector iteration when no rule based rules match current map scale | 未報告 | [PR #51904](https://github.com/qgis/QGIS/pull/51904) | Not appropriate |
| Fix logic for triggering a full model reset in attribute table after changing attributes | 未報告 | [PR #51890](https://github.com/qgis/QGIS/pull/51890) | [PR #51892](https://github.com/qgis/QGIS/pull/51892) |
...
| Show an icon for geometry fields | 未報告 | [PR #51844](https://github.com/qgis/QGIS/pull/51844) | Not appropriate |
| Fix geometry fields incorrectly show as \"range\" types in fields list | 未報告 | [PR #51842](https://github.com/qgis/QGIS/pull/51842) | [PR #51860](https://github.com/qgis/QGIS/pull/51860) |
...
| Re-permit format_number to omit group separators | 未報告 | [PR #51761](https://github.com/qgis/QGIS/pull/51761) | [PR #51763](https://github.com/qgis/QGIS/pull/51763) |
| Remember the collapsed state of the vector layer renderer group box | 未報告 | [PR #51719](https://github.com/qgis/QGIS/pull/51719) | Not appropriate |
...
| Fix crash when showing tooltips for invalid layers | 未報告 | [PR #51703](https://github.com/qgis/QGIS/pull/51703) | [PR #51708](https://github.com/qgis/QGIS/pull/51708) |
| Fix map tips do not show for vector layers where the HTML map tip option isn\'t used | 未報告 | [PR #51702](https://github.com/qgis/QGIS/pull/51702) | Unaffected |
...
| \[georeferencer\] Fix warning about missing output file name doesn\'t show in all circumstances | 未報告 | [PR #51673](https://github.com/qgis/QGIS/pull/51673) | [PR #51739](https://github.com/qgis/QGIS/pull/51739) |
...
| Attribute table form view looses index when the \"yellow\" selection is changed | 未報告 | [PR #52045](https://github.com/qgis/QGIS/pull/52045) |  |
| Features in Relation Editor are not selectable anymore | 未報告 | [PR #51914](https://github.com/qgis/QGIS/pull/51914) | Unaffected |
