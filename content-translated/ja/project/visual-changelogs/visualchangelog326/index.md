...
section: project
sidebar: true
title: QGIS 3.26の変更履歴
type: visual-changelog

---
{{<content-start >}}
# QGIS 3.26の変更履歴{#changelog326 }
...
## 注目すべき修正
### Even Rouaultによるバグ修正
| バグの表題 | URL Issues (if reported, Github) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Raster tiles are clipped based on the gpkg_contents bounding box of a GeoPackage | [#45530](https://github.com/qgis/QGIS/issues/45530) | バグではない |  |
...
| バグの表題 | URL Issues (if reported, Github) | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| \@project_keywords are no longer tested on Rule based filters | [#48480](https://github.com/qgis/QGIS/issues/48480) | バグではない |  |
...
| Random order of attributes in oracle feature query | [#35309](https://github.com/qgis/QGIS/issues/35309) | [PR #48668](https://github.com/qgis/QGIS/pull/48668) | いいえ |
...
| Documentation doctest failure | [QGIS developer mail list](https://lists.osgeo.org/pipermail/qgis-developer/2022-May/064720.html) | [QGIS Documentation PR 7581](https://github.com/qgis/QGIS-Documentation/pull/7581) | いいえ |
| \"Add to group\" option in sub layer window always add at top of layer tree | [#48694](https://github.com/qgis/QGIS/issues/48694) | [PR #48696](https://github.com/qgis/QGIS/pull/48696) | いいえ |
| Name/id of map objects in GetProjectSettings follows an order that is the inverse of the order used to add the map objects in a layout | [#46143](https://github.com/qgis/QGIS/issues/46143) | [PR #48728](https://github.com/qgis/QGIS/pull/48728) | いいえ |
| Aborted inserts in Postgis geometryless tables are saved anyway | [#48171](https://github.com/qgis/QGIS/issues/48171) | [PR #48741](https://github.com/qgis/QGIS/pull/48741) | いいえ |
...
| Drag and Drop Postgis-Table in QGIS Browser alters name of Geometry-Column | [#48748](https://github.com/qgis/QGIS/issues/48748) | [PR #48796](https://github.com/qgis/QGIS/pull/48796) | いいえ |
| Layer filter does not work on multiline strings values with linebreaks | [#47530](https://github.com/qgis/QGIS/issues/47530) | [PR #48818](https://github.com/qgis/QGIS/pull/48818) | 必要なし |
...
| GDAL Vector to Raster (gdal_rasterize) fail to produce ESRI ASCII as output | [#39140](https://github.com/qgis/QGIS/issues/39140) | バグではない |  |
...
| test_provider_eptprovider occasionally aborts | [#48778](https://github.com/qgis/QGIS/issues/48778) | [PR #48793](https://github.com/qgis/QGIS/pull/48793) | 必要なし |
...
| Improve UX for virtual layer creation dialog | 未報告 | [PR #49015](https://github.com/qgis/QGIS/pull/49015) | Not appropriate |
...
| Fix some undersized icons on hidpi displays | 未報告 | [PR #48875](https://github.com/qgis/QGIS/pull/48875) | Not appropriate |
...
| Fix clear values for offset along line spin boxes | 未報告 | [PR #48872](https://github.com/qgis/QGIS/pull/48872) | [PR #48878](https://github.com/qgis/QGIS/pull/48878) |
...
| Never show the transformation selection dialog for the first layer added to a project | 未報告 | [PR #48811](https://github.com/qgis/QGIS/pull/48811) | [PR #48814](https://github.com/qgis/QGIS/pull/48814) |
...
| Fix loss of mesh layer styling when fixing a broken path to a mesh layer | 未報告 | [PR #48765](https://github.com/qgis/QGIS/pull/48765) | [PR #48768](https://github.com/qgis/QGIS/pull/48768) |
...
| Don\'t hide parts of the mesh renderer widget if the layer is invalid | 未報告 | [PR #48757](https://github.com/qgis/QGIS/pull/48757) |  |
| Add layer opacity widget in mesh layer renderer properties widget | 未報告 | [PR #48756](https://github.com/qgis/QGIS/pull/48756) |  |
| Review and finish open PR [PR #44941](https://github.com/qgis/QGIS/pull/44941) |  |  |  |
| Fix a crash when QgsProject::instance() is accessed when no QgsApplication exists | 未報告 | [PR #48721](https://github.com/qgis/QGIS/pull/48721) | N/A |
...
| Add support for map field types to memory provider, avoid data loss in models/processing | 未報告 | [PR #48638](https://github.com/qgis/QGIS/pull/48638) | Too intrusive |
...
| Fix many memory leaks | 未報告 | [PR #48590](https://github.com/qgis/QGIS/pull/48590) | N/A |
| Fix ctrl modifier scrolling on symbol buttons | 未報告 | [PR #48581](https://github.com/qgis/QGIS/pull/48581) | N/A |
