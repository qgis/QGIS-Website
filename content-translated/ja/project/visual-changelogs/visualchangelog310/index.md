...
section: project
sidebar: true
title: QGIS 3.10 の変更履歴
type: visual-changelog

---
{{<content-start >}}
# QGIS 3.10 の変更履歴{#changelog310 }
...
この機能により、右横書きロケールにフレンドリーな凡例を作成することができます。ユーザーフレンドリーなものにするために、RTLベースのロケールで新しい凡例を作成するときは、デフォルトでこの右横書きスタイル配置になるようにしています。
...
GeoPDF エクスポートには GDAL 3.0 以降に基づいた QGIS ビルドが必要であることに注意。
...
この変更により、幅広い地図縮尺にエレガントに対応するグリッドを持つレイアウトやレイアウトテンプレートを作成できるようになりました！
...
この機能は Olivier Dalangによって開発されました
### 機能: 詳細設定モデルパラメータ
...
| --- | --- | --- | --- |
| 印刷レイアウトのアイテムを削除したときにクラッシュ | [#31549](https://github.com/qgis/QGIS/issues/31549) |  |  |
| DBマネージャ pythonエラー | [#31457](https://github.com/qgis/QGIS/issues/31457) |  |  |
| QGIS 3.4.11: GetFeatureInfoの応答でPDF URLをクリックするとエラーが生成される | [#31542](https://github.com/qgis/QGIS/issues/31542) | 3.8とマスターで修正済み（by自分） |  |
| ウォッチファイルが新しいカラムを追加しない | [#31452](https://github.com/qgis/QGIS/issues/31452) |  |  |
| 古いプロジェクト／スタイルからのラベルのバックグラウンドが無くなる | [#31427](https://github.com/qgis/QGIS/issues/31427) | [PR #3164](https://github.com/qgis/QGIS/pull/31647) |  |
...
| シンボロジタブウィジェットが、レイヤのプロパティダイアログの範囲で水平方向に拡大しない | [#31449](https://github.com/qgis/QGIS/issues/31449) | [PR #3166](https://github.com/qgis/QGIS/pull/31665) |  |
| ウォッチファイルが新しいカラムを追加しない | [#31452](https://github.com/qgis/QGIS/issues/31452) |  |  |
| 報告されていないが#31452に関係 | [PR #3168](https://github.com/qgis/QGIS/pull/31688) |  |  |
| QGISでWMSサービスを追加できない。同じURLは他のクライアントでは動作する | [#31661](https://github.com/qgis/QGIS/issues/31661) |  |  |
| QGIS Server - 機能のダウンロードに失敗しました：SSLハンドシェイクに失敗しました | [#31675](https://github.com/qgis/QGIS/issues/31675) |  |  |
| ラスタ計算機で条件付き乗算を行う際の明らかな回帰 | [#31193](https://github.com/qgis/QGIS/issues/31193) | [PR #3169](https://github.com/qgis/QGIS/pull/31690) |  |
| 壊れたGPKGのブラウザアクション | [#31730](https://github.com/qgis/QGIS/issues/31730) | [PR #3173](https://github.com/qgis/QGIS/pull/31731) |  |
| データソースマネージャダイアログのサイズ変更は、フォーカスされていないパネルのサイズ変更に失敗します | [#31732](https://github.com/qgis/QGIS/issues/31732) | [PR #3174](https://github.com/qgis/QGIS/pull/31741) |  |
| マルチパートからシングルパートへのインプレースプロセシングは、ユニークな制約を処理しません | [#31634](https://github.com/qgis/QGIS/issues/31634) | [PR #3175](https://github.com/qgis/QGIS/pull/31750) | [PR #3181](https://github.com/qgis/QGIS/pull/31810) |
| python経由で凡例を追加するとクラッシュする | [#31713](https://github.com/qgis/QGIS/issues/31713) |  |  |
| UI: 凡例は、分類範囲が更新された後もリフレッシュされません | [#31643](https://github.com/qgis/QGIS/issues/31643) | 影響なし | [PR #3183](https://github.com/qgis/QGIS/pull/31834) |
...
| サーバ GetLegendGraphics contextual (BBOX) が WIDTH と HEIGHT が指定されていない場合に失敗します | [#31846](https://github.com/qgis/QGIS/issues/31846) | [PR #3186](https://github.com/qgis/QGIS/pull/31865) | [PR #3188](https://github.com/qgis/QGIS/pull/31882) |
| 範囲/トリム クラッシュ | [#31864](https://github.com/qgis/QGIS/issues/31864) |  |  |
| UI: 任意のクリックで、クラスの数を上下させると2回トリガーされます | [#31635](https://github.com/qgis/QGIS/issues/31635) | [PR #3187](https://github.com/qgis/QGIS/pull/31871) |  |
| GPKGプロジェクトは、ストレージから削除された後、ダーティとマークされません | [#30550](https://github.com/qgis/QGIS/issues/30550) | [PR #3187](https://github.com/qgis/QGIS/pull/31876) |  |
| QgsJsonUtils内のQVariantListからJSONへの変換に関する報告されていない問題を修正 | 未報告 | [PR #3192](https://github.com/qgis/QGIS/pull/31920) |  |
| WMSを追加するときにクラッシュ | [#31927](https://github.com/qgis/QGIS/issues/31927) | [#31927](https://github.com/qgis/QGIS/issues/31927) | [PR #3197](https://github.com/qgis/QGIS/pull/31979) |
| OpenCLがオンのとき、ラスタ計算機の符号を変えるが機能しない | [#32023](https://github.com/qgis/QGIS/issues/32023) | [PR #3202](https://github.com/qgis/QGIS/pull/32026) |  |
...
| QGISラスタ計算機がnodataだけのラスタを出力する | [#32025](https://github.com/qgis/QGIS/issues/32025) | [PR #3202](https://github.com/qgis/QGIS/pull/32026) |  |
| PostgreSQLからプロジェクトを開くときの問題 | [#32050](https://github.com/qgis/QGIS/issues/32050) | [PR #3206](https://github.com/qgis/QGIS/pull/32062) |  |
| 内容に基づいた凡例でGetLegendGraphicが全て同じシンボルを表示する | [#32020](https://github.com/qgis/QGIS/issues/32020) |  |  |
...
| geopackageにインデックスを作成するのに失敗する (QGIS 3.8.3) | [#32094](https://github.com/qgis/QGIS/issues/32094) |  |  |
...
| 内容に基づいた凡例でGetLegendGraphicが全て同じシンボルを表示する | [#32020](https://github.com/qgis/QGIS/issues/32020) | [PR #3212](https://github.com/qgis/QGIS/pull/32120) |  |
| WFS contextual legend issue when canvas CRS is different than layer\'s CRS | 未報告 | [PR #3212](https://github.com/qgis/QGIS/pull/32120) |  |
| PostGIS/geojson: intフィールドに負の数字が入力できない | [#32149](https://github.com/qgis/QGIS/issues/32149) | [PR #3216](https://github.com/qgis/QGIS/pull/32161) |  |
| WMSサービスがたくさんのレイヤを含んでいるとき、WMSレイヤプロパティの情報タブが応答しない | [#32213](https://github.com/qgis/QGIS/issues/32213) | [PR #3226](https://github.com/qgis/QGIS/pull/32269) |  |
| データソースUI - PostgreSQLテーブルの複数行コメントは、グリッドテーブルを読みにくくします。 | [#32257](https://github.com/qgis/QGIS/issues/32257) | [PR #3233](https://github.com/qgis/QGIS/pull/32336) |  |
| プラグインがオフの場合、nullポインタの参照がさらに増える | [#32347](https://github.com/qgis/QGIS/issues/32347) | [PR #3235](https://github.com/qgis/QGIS/pull/32351) |  |
| プラグインがオフの場合、nullポインタの参照 | [#32338](https://github.com/qgis/QGIS/issues/32338) | [PR #3234](https://github.com/qgis/QGIS/pull/32345) |  |
...
| バグの表題 | URLイシュー（報告された場合） | URL PRまたはコメント | 3.4 backport PR or commit |
| --- | --- | --- | --- |
| プロセシングのGDALスクリプトは、属性名に引用符が必要 | [#30878](https://github.com/qgis/QGIS/issues/30878) | [PR #3171](https://github.com/qgis/QGIS/pull/31712) | [PR #3171](https://github.com/qgis/QGIS/pull/31717) |
| プロセシング GDAL アルゴリズムは、WFS 入力レイヤを正しく処理しません | [#29663](https://github.com/qgis/QGIS/issues/29663) | [PR #3173](https://github.com/qgis/QGIS/pull/31735) |  |
...
| プロセシングレイヤのコンボボックスで選択した地物の使用を切り替えることができない | [#30636](https://github.com/qgis/QGIS/issues/30636) | [PR #3173](https://github.com/qgis/QGIS/pull/31739) |  |
...
| v.drape - SpatiaLite形式のとき25Dでエクスポートしない | [#30066](https://github.com/qgis/QGIS/issues/30066) |  |  |
| カスタムクエリパラメータにサービスurlが含まれない | [#26761](https://github.com/qgis/QGIS/issues/26761) |  |  |
| プロセシング: 起動時にpytonのエラー | [#29535](https://github.com/qgis/QGIS/issues/29535) |  |  |
...
| プロセシングアルゴリズムダイアログでインポートに失敗する未報告の問題 | 未報告 | [PR #3190](https://github.com/qgis/QGIS/pull/31902) |  |
...
| データベースマネージャ: PostGISジオメトリカラムを改名するとジオメトリタイプとSRSが無くなる | [#27613](https://github.com/qgis/QGIS/issues/27613) | [PR #3192](https://github.com/qgis/QGIS/pull/31929) |  |
| 再び開く時、ジオリファレンサが最後の画像を不正確に表示 | [#26700](https://github.com/qgis/QGIS/issues/26700) | [PR #3193](https://github.com/qgis/QGIS/pull/31932) |  |
| データベースマネージャ: 新しいレイヤが生成されたとき、レイヤを作成するダイアログは閉じるかクリアされるべき | [#25535](https://github.com/qgis/QGIS/issues/25535) | [PR #3195](https://github.com/qgis/QGIS/pull/31956) |  |
...
| バグの表題 | URLイシュー（報告された場合） | URL PRまたはコメント | 3.4 backport PR or commit |
| --- | --- | --- | --- |
| 再現可能なクラッシュ：ウィジェットのプロパティとして保存されたQgsHighlightインスタンスの取得 | [#30766](https://github.com/qgis/QGIS/issues/30766) | [PR #3173](https://github.com/qgis/QGIS/pull/31733) | [PR #3197](https://github.com/qgis/QGIS/pull/31977) |
| レイヤスタイリング メッシュレイヤがカラーランプの変更に反応しない（初回） | [#29188](https://github.com/qgis/QGIS/issues/29188) | [PR #3198](https://github.com/qgis/QGIS/pull/31981) |  |
| QSortFilterProxyModelを閉じるときにqgisがクラッシュ | [#31721](https://github.com/qgis/QGIS/issues/31721) |  |  |
| QGISがフリーズ | [#29742](https://github.com/qgis/QGIS/issues/29742) |  |  |
| プロジェクトを保存しようとしたときにクラッシュ | [#29896](https://github.com/qgis/QGIS/issues/29896) |  |  |
| 高度なデジタイズが起動された状態で終了するとクラッシュ | [#29143](https://github.com/qgis/QGIS/issues/29143) |  |  |
| macOSのappの名前を変更すると認証エラー | [#32163](https://github.com/qgis/QGIS/issues/32163) |  |  |
| Mac OS Catalinaに更新したあとでQGISが開けない | [#32167](https://github.com/qgis/QGIS/issues/32167) |  |  |
...
| バグの表題 | URLイシュー（報告された場合） | URL PRまたはコメント | 3.4 backport PR or commit |
| --- | --- | --- | --- |
| Windowsプラットフォームで、QgsCoordinateTransformPrivate::freeProjを終了するときにQGISマスタがクラッシュ | [#31762](https://github.com/qgis/QGIS/issues/31762) | [PR #3176](https://github.com/qgis/QGIS/pull/31764) | [Commit 08bb3fe](https://github.com/qgis/QGIS/commit/08bb3fea3fc3f574755ecc0a7dc8381a9822e4cd) |
| Windowsプラットフォームで、QgsCoordinateTransformPrivate::freeProjを終了するときにQGISマスタがクラッシュ | [#31762](https://github.com/qgis/QGIS/issues/31762) | [PR #3184](https://github.com/qgis/QGIS/pull/31848) | [PR #3185](https://github.com/qgis/QGIS/pull/31850) |
...
| プロジェクトで使用していたGDALドライバを終了した後にQGISがクラッシュ | [#29212](https://github.com/qgis/QGIS/issues/29212) | [PR #3177](https://github.com/qgis/QGIS/pull/31772) | [PR #3180](https://github.com/qgis/QGIS/pull/31802) |
| GS7BG形式でエクスポート中にクラッシュ | [#31775](https://github.com/qgis/QGIS/issues/31775) | [PR #3178](https://github.com/qgis/QGIS/pull/31785) | [PR #3183](https://github.com/qgis/QGIS/pull/31836) |
| GDAL/OGR形式変換アルゴリズムで、pgdumpが認識された形式でない | [#31421](https://github.com/qgis/QGIS/issues/31421) | [PR #3181](https://github.com/qgis/QGIS/pull/31811) | not worth |
| PBFファイルが正しく読み込まれない | [#31062](https://github.com/qgis/QGIS/issues/31062) | [PR #3181](https://github.com/qgis/QGIS/pull/31812) | [PR #31835](https://github.com/qgis/QGIS/pull/31835) |
...
| バグの表題 | URLイシュー（報告された場合） | URL PRまたはコメント | 3.4 backport PR or commit |
| --- | --- | --- | --- |
| データベースマネージャからPostGISラスタを追加する際に、追加ごとにパスワードを要求されます | [#31162](https://github.com/qgis/QGIS/issues/31162) |  |  |
...
| ファイルINSTALLがdoc/api/htmlを見つけられない | [#31842](https://github.com/qgis/QGIS/issues/31842) | [Commit 3225f491](https://github.com/qgis/QGIS/commit/3225f4911a1199fc217aeca9fa63d9bf3d1b82c0) | n/a |
...
| cmake/FindGEOS.cmake:162 でCMakeエラー | [#32170](https://github.com/qgis/QGIS/issues/32170) | [Commit bc9bb888](https://github.com/qgis/QGIS/commit/bc9bb8880a3db5a05c697f5d56708757a2ce999d) | [Commit 27f13936](https://github.com/qgis/QGIS/commit/27f13936afd970d766f398584a1ea509dc15b907) |
...
| PostGISデータの読み込みが極端に遅い | [#26186](https://github.com/qgis/QGIS/issues/26186) | [PR #31858](https://github.com/qgis/QGIS/pull/31858) |  |
...
| バグの表題 | URLイシュー（報告された場合） | URL PRまたはコメント | 3.4 backport PR or commit |
| --- | --- | --- | --- |
| 無効なレイヤのシンボロジタブを開く際にクラッシュ | [#32041](https://github.com/qgis/QGIS/issues/32041) | [#32041](https://github.com/qgis/QGIS/issues/32041) | n/a |
| PR reviews | いっぱい :D |  |  |
| Windowsでqgzが一時的としてマークされる | [#32118](https://github.com/qgis/QGIS/issues/32118) |  |  |
| 文脈によってジオメトリ型の選択ができる | [#32121](https://github.com/qgis/QGIS/issues/32121) | [PR #32125](https://github.com/qgis/QGIS/pull/32125) | n/a |
...
| バグの表題 | URLイシュー（報告された場合） | URL PRまたはコメント | 3.4 backport PR or commit |
| --- | --- | --- | --- |
| GetCapabilities docで無効なschemaLocationを修正 | [#32085](https://github.com/qgis/QGIS/issues/32085) | [PR #32352](https://github.com/qgis/QGIS/pull/32352) |  |
...
| WMS GetPrint リクエストの不透明度の不具合 | [#29317](https://github.com/qgis/QGIS/issues/29317) |  |  |
| 未報告の不具合: QMLスタイルファイルを読み込み後に無効なレンダラータイプ | 未報告の不具合 | [PR #32388](https://github.com/qgis/QGIS/pull/32388) |  |
...
| メモリリークを修正 | [Commit 5be31915](https://github.com/qgis/QGIS/commit/5be319157f112a2fdbab7f03d0010d69f1e79157) | n/a |  |
...
| Fix uncaught transform exception when determining AFS layer bounds | 未報告 | [Commit 857697dd](https://github.com/qgis/QGIS/commit/857697dd9919e80fc03e0c2059e56ce7311e9b49) | n/a |
| Fix qt warning thrown when converting a 2.18 project | 未報告 | [Commit 12ad9fca](https://github.com/qgis/QGIS/commit/12ad9fca1ed5027129161ee5b5c764b8374d0b51) | n/a |
...
| Don\'t force fallback to WGS84 for unknown layer CRSes | 未報告 | [Commit 93741566](https://github.com/qgis/QGIS/commit/937415663f609fa7e41056aeb1176a0a145accc1) | n/a |
| メモリレイヤが非EPSG CRS符号を使えない修正 | 未報告だがたくさんのバグの原因かもしれない | [Commit 2dad68f7](https://github.com/qgis/QGIS/commit/2dad68f76396a419b25fa8dad2b7b16552086740) | n/a |
| 報告セクションを削除した後のクラッシュを修正 | [#31302](https://github.com/qgis/QGIS/issues/31302) | [Commit 3356460c](https://github.com/qgis/QGIS/commit/3356460ce70af15105880d135271595dccfc397c) | [Commit d3230ac0](https://github.com/qgis/QGIS/commit/d3230ac0c545604a97fa3028ca3e846bff65004c) |
| Ensure polygon rings generated for rendering are always closed | 未報告 | [Commit a69e38d9](https://github.com/qgis/QGIS/commit/a69e38d9c358faea5ae4a8628add1e6721cc23e8) | n/a |
| Don\'t crash QgsTessellator when an empty polygon is added | 未報告 | [Commit 761b2e77](https://github.com/qgis/QGIS/commit/761b2e778594f4051a72d02b898354f501e336fe) | n/a |
| Fix crash in topology checker plugin after a check is canceled | 未報告 | [Commit 606bcd35](https://github.com/qgis/QGIS/commit/606bcd35143d09cca5b1ec45bdb5b13236e4376b) | n/a |
...
| Fix crash on exit when topology checker dock is open with visible results | 未報告 | [Commit 64375ad4](https://github.com/qgis/QGIS/commit/64375ad4d28597eb97808f64e1481915df7a676c) | n/a |
...
| QgsTessellatorの大幅な速度向上 | [Commit 577e1e96](https://github.com/qgis/QGIS/commit/577e1e962d4004f9cd11a169860e0b099216c963) | n/a |  |
...
| QgsContrastEnhancementFunctionの最適化 | [Commit f5c21a0f](https://github.com/qgis/QGIS/commit/f5c21a0fbd72fe840900e0ad35c4af285fbd8a79) | n/a |  |
...
| QgsImageOperationでのオーバーフローを回避 | [Commit aefbf662](https://github.com/qgis/QGIS/commit/aefbf6627256637cf455b2df409b3a4bf8171b33) | [Commit 9f4d3a87](https://github.com/qgis/QGIS/commit/9f4d3a8745b2d89faeb6a9272369eaa772e3638c) |  |
...
| \[reports\] Fix crash when print button clicked before a report section is opened | 未報告 | [Commit c93fd0a4](https://github.com/qgis/QGIS/commit/c93fd0a4350ea14db9728ad17ada06e70eb9ffd6) | n/a |
...
| Fix project load status indicator can get \"stuck\" after project load | 未報告 | [Commit 40d95b69](https://github.com/qgis/QGIS/commit/40d95b69d91ade71473f5ea0182040d8398cc668) | n/a |
