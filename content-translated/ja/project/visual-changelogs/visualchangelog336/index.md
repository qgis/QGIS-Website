...
section: project
sidebar: true
title: QGIS 3.36 の変更履歴
type: visual-changelog

---
{{<content-start >}}
# QGIS 3.36 の変更履歴{#changelog336 }
![](images/projects/fc93f461b927dd4960936f3391cf00321f9552cc.png)

リリース日: 2024-02-23

QGISプロジェクトはQGIS 3.36のリリースに示されているように、オープンソース地理空間技術の限界を押し広げ続けています。プロジェクトは新機能と改善によりユーザーがより優れた空間的意思決定を行えるよう支援し続けており、OGC SensorThings APIデータソース向けの新しいコアデータプロバイダーも導入されています。

リリース名について：Windsor and Maidenhead自治区議会は、2010/11年（バージョン1.8！）に早くもQGISに移行した最初の英国地方自治体の一つでした。Simon MilesとMatt TravisがWindsor and MaidenheadでUK QGISユーザーグループを立ち上げました。第一回のUKユーザーグループミーティングもここで開催されました。Windsor and Maidenheadは多くのQGISプラグインにも財政的に貢献し、ブロンズスポンサーでもありました。

このリリースに追加された注目の新機能の一つは、アニメーション地図の作成を容易にするテンポラルコントローラーの新しい "ムービーモード" です。このリリースには、マップチップ（デスクトップおよびサーバー）の新機能や、メッシュ、ポイントクラウド、3D Tilesなどの高度なデータタイプを活用できるようにする3D機能の拡充の改善も含まれています。
...
導入されたすべての新機能を手早く確認するには、 [YouTubeのハイライト動画](https://www.youtube.com/watch?v=WS9W1fo9Aso) をご覧ください。
...
## Breaking Changes
### 機能: OTB Processing provider を削除しました
**継続的なメンテナンスが行われていないため、QGISからOrfeo ToolBox（OTB）プロセッシングプロバイダーを削除するという難しい決定を下しました。この機能を必要とするユーザー、プラグイン、またはスクリプトは、それに応じて修正する必要があります。**

QGISコミュニティの意欲あるメンバーには、OTBサポートを復活させるためのサードパーティのコミュニティメンテナンスプラグインを作成することが推奨されています。
## 時系列
...
| Open Feld Calculator Crash | [#55898](https://github.com/qgis/QGIS/issues/55898) | フィードバック |  |
...
| Attribute table frame, with "allow url to be read as HTML format" has not expected result like hyperlink when output PDF file is maked from "GetPrint" request from QGIS Server | [#52370](https://github.com/qgis/QGIS/issues/52370) | バグではない |  |
...
| SHP: Fix unreported issue with spatialindex | 未報告 | [PR #56366](https://github.com/qgis/QGIS/pull/56366) | [PR #56399](https://github.com/qgis/QGIS/pull/56399) |
...
| [PostgreSQL provider] Add missing namespace escaping in SQL requests | 未報告 | [PR #56173](https://github.com/qgis/QGIS/pull/56173) | [PR #56186](https://github.com/qgis/QGIS/pull/56186) |
...
| Catch potential QgsCsException at various places; improve qgscoordinatetransform.h doc | 未報告 | [PR #56212](https://github.com/qgis/QGIS/pull/56212) | [PR #56244](https://github.com/qgis/QGIS/pull/56244) |
...
| TIN: Enable fromWkb/fromWkt | 未報告 | [PR #56071](https://github.com/qgis/QGIS/pull/56071) | いいえ |
| [OGC] Polygon: fix rings order | 未報告 | [PR #55306](https://github.com/qgis/QGIS/pull/55306) | いいえ |
...
| バグの表題 | URL issues.qgis.org （報告された場合） | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| [3D] disable altitude binding if altitude clamping is absolute | 未報告 | [PR #56154](https://github.com/qgis/QGIS/pull/56154) | [PR #56198](https://github.com/qgis/QGIS/pull/56198) |
...
| Fix GUI freezing when changing raster renderer | 未報告 | [PR #56000](https://github.com/qgis/QGIS/pull/56000) | [PR #56077](https://github.com/qgis/QGIS/pull/56077) |
...
| Allow deleting geometry part of singlepart features | 未報告 | [PR #56279](https://github.com/qgis/QGIS/pull/56279) |  |
...
| Problem with Georeferencing Tool-QGIS 3.28.12 Firenze | [#55167](https://github.com/qgis/QGIS/issues/55167) | バグではない |  |
...
| Ensure that saving map [canvas] as image/PDF takes high DPI scaling factor into account | 未報告 | [PR #56400](https://github.com/qgis/QGIS/pull/56400) |  |
| MBTiles layers are valid when dataset is missing | 未報告 | [PR #56296](https://github.com/qgis/QGIS/pull/56296) | [PR #56298](https://github.com/qgis/QGIS/pull/56298) |
...
| DXF map theme style override not respected | 未報告 | [PR #56162](https://github.com/qgis/QGIS/pull/56162) | [PR #56164](https://github.com/qgis/QGIS/pull/56164) |
...
| Pixelated QGIS logo in user profile selector dialog on high DPI screens | 未報告 | [PR #56053](https://github.com/qgis/QGIS/pull/56053) | [PR #56065](https://github.com/qgis/QGIS/pull/56065) |
| Pixelated overview panel rendering on high DPI screens | 未報告 | [PR #56050](https://github.com/qgis/QGIS/pull/56050) | [PR #56087](https://github.com/qgis/QGIS/pull/56087) |
| Welcome screen issues on high DPI screens | 未報告 | [PR #56048](https://github.com/qgis/QGIS/pull/56048) | [PR #56084](https://github.com/qgis/QGIS/pull/56084) |
...
| Missing checkbox partially checked state styling for non-default themes | 未報告 | [PR #56290](https://github.com/qgis/QGIS/pull/56290) | [PR #56306](https://github.com/qgis/QGIS/pull/56306) |
...
| バグの表題 | URL issues.qgis.org （報告された場合） | URL Commit (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix broken coordinate transforms on qt6 builds | 未報告 | [PR #55914](https://github.com/qgis/QGIS/pull/55914) | [PR #55935](https://github.com/qgis/QGIS/pull/55935) |
| Fix crash in QgsRasterPipe when removing roles | 未報告 | [PR #55955](https://github.com/qgis/QGIS/pull/55955) | [PR #56008](https://github.com/qgis/QGIS/pull/56008) |
| Fix broken data defined override buttons in text format widget when no layer is associated | 未報告 | [PR #55989](https://github.com/qgis/QGIS/pull/55989) | N/A |
| Avoid use of pygments in metasearch | 未報告 | [PR #56160](https://github.com/qgis/QGIS/pull/56160) | N/A |
| Fixes filters applied to a duplicated AFS layer also incorrectly apply to the original layer | 未報告 | [PR #56195](https://github.com/qgis/QGIS/pull/56195) | [PR #56221](https://github.com/qgis/QGIS/pull/56221) |
| [processing] Don't try to interpret distance widget value as CRS | 未報告 | [PR #56292](https://github.com/qgis/QGIS/pull/56292) | [PR #56297](https://github.com/qgis/QGIS/pull/56297) |
...
| Fix calculation of string stats when nulls are present | 未報告 | [PR #56305](https://github.com/qgis/QGIS/pull/56305) | [PR #56322](https://github.com/qgis/QGIS/pull/56322) |
| Don't use (broken) QgsCoordinateReferenceSystem::createFromSrsId method for virtual point clouds | 未報告 | [PR #56325](https://github.com/qgis/QGIS/pull/56325) | [PR #56333](https://github.com/qgis/QGIS/pull/56333) |
| Make datetime stats range type consistent across Qt versions | 未報告 | [PR #56355](https://github.com/qgis/QGIS/pull/56355) | [PR #56437](https://github.com/qgis/QGIS/pull/56437) |
| Fix crash in QgsStringUtils::truncateMiddleOfString on qt 6 | 未報告 | [PR #56356](https://github.com/qgis/QGIS/pull/56356) | N/A |
| Fix handling of font family from HTML on Qt 6 builds | 未報告 | [PR #56358](https://github.com/qgis/QGIS/pull/56358) | [PR #56436](https://github.com/qgis/QGIS/pull/56436) |
...
| Fix crash when applying vector properties dialog | 未報告 | [PR #56412](https://github.com/qgis/QGIS/pull/56412) | N/A |
| Don't force calculate layer extents when saving layers | 未報告 | [PR #56433](https://github.com/qgis/QGIS/pull/56433) | [PR #56444](https://github.com/qgis/QGIS/pull/56444) |
| Don't force full calculation of layer extent when cloning layers | 未報告 | [PR #56434](https://github.com/qgis/QGIS/pull/56434) | N/A |
...
| Fix a deadlock in remote COPC handling (3D views) | 未報告 | [PR #56388](https://github.com/qgis/QGIS/pull/56388) | [PR #56419](https://github.com/qgis/QGIS/pull/56419) |
| Fix a crash in point cloud renderer when cleaning up preview painter | 未報告 | [PR #56409](https://github.com/qgis/QGIS/pull/56409) | N/A |
| Fix a deadlock with local COPC files in 2D rendering | 未報告 | [PR #56432](https://github.com/qgis/QGIS/pull/56432) | [PR #56458](https://github.com/qgis/QGIS/pull/56458) |
