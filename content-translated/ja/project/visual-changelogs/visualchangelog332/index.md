...
section: project
sidebar: true
title: QGIS 3.32の変更履歴
type: visual-changelog

---
{{<content-start >}}
# QGIS 3.32の変更履歴{#changelog332 }
...
| バグの表題 | URL issues (Github, if reported) | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Qgis Server WMTS returns wrong WGS84BoundingBox for the layer | [#53213](https://github.com/qgis/QGIS/issues/53213) | 再現できません | Form not showing (randomly) values except when triggering \"Editing Mode\" |
...
| Snap to random vertices after splitting features | [#53040](https://github.com/qgis/QGIS/issues/53040) | 再現できません | Cartographic label placement with \"Distance Offset: From Symbol Bounds\" shows offset for MultiPoint features |
...
| Options for some values in Processing are not saved after close window | [#53204](https://github.com/qgis/QGIS/issues/53204) | [PR #53458](https://github.com/qgis/QGIS/pull/53458) | いいえ |
| Unable to import layer from Postgis view or materialized view , if it has no no primary key | [#52943](https://github.com/qgis/QGIS/issues/52943) | バグではない |  |
...
| Avoid UI lock when closing Execute SQL window | 未報告 | [PR #53448](https://github.com/qgis/QGIS/pull/53448) | Too risky |
...
| Fix a crash on QGIS close | 未報告 | [PR #53414](https://github.com/qgis/QGIS/pull/53414) | [PR #53418](https://github.com/qgis/QGIS/pull/53418) |
...
| Fix crash when writing processing history entry | 未報告 | [PR #53394](https://github.com/qgis/QGIS/pull/53394) | NA |
...
| Fix point text annotation rotation, alignment issues | 未報告 | [PR #53337](https://github.com/qgis/QGIS/pull/53337) | NA |
| Expand range of z index spin for annotations | 未報告 | [PR #53319](https://github.com/qgis/QGIS/pull/53319) | [PR #53326](https://github.com/qgis/QGIS/pull/53326) |
| Fix incorrect scaling of text background markers in annotations | 未報告 | [PR #53318](https://github.com/qgis/QGIS/pull/53318) | Fix crash on invalid grass layer paths |
...
| Fix crash when creating new grass mapsets when \"set\" is pressed and no region is selected | 未報告 | [PR #53293](https://github.com/qgis/QGIS/pull/53293) | [PR #53311](https://github.com/qgis/QGIS/pull/53311) |
