...
section: project
sidebar: true
title: QGIS 3.24の変更履歴
type: visual-changelog

---
{{<content-start >}}
# QGIS 3.24の変更履歴{#changelog324 }
...
この改善により、最初 **と** 最後の頂点の両方にマーカーを持ったマーカー（またはハッシュ）ラインを作成することがかなり容易になります（その他の便利な組み合わせもあります！）
...
| fix server crash | 未報告 | [PR #47271](https://github.com/qgis/QGIS/pull/47271) | TODO |
...
| Filter for WFS layer: The \"Tables\" button is missing | [#46887](https://github.com/qgis/QGIS/issues/46887) | バグではない |  |
...
| バグの表題 | URL issues.qgis.org （報告された場合） | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| Trying to add GPKG from data source manager crashes QGIS master | [#46463](https://github.com/qgis/QGIS/issues/46463) | [PR #46928](https://github.com/qgis/QGIS/pull/46928) | 無関係 |
...
| Fixes to QgsGeometry::addPart + new test cases | 未報告 | [PR #47009](https://github.com/qgis/QGIS/pull/47009) |  |
...
| Wrong signature of the QgsProcessingParameterMeshDatasetGroups when exporting to Python | 未報告 | [PR #47152](https://github.com/qgis/QGIS/pull/47152) | [PR #47156](https://github.com/qgis/QGIS/pull/47156) |
...
| QgsProcessingParameterFile extension option | [#45633](https://github.com/qgis/QGIS/issues/45633) | バグではない |  |
...
| Fix output filename when a raster is saved in a format without extension | 未報告 | [PR #46992](https://github.com/qgis/QGIS/pull/46992) | TODO |
| WFS GetFeature document and exceptions | 未報告 | [PR #47198](https://github.com/qgis/QGIS/pull/47198) | TODO |
...
| バグの表題 | URL issues.qgis.org （報告された場合） | URL Commit (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix HTTP Post with MultiPart | [#46989](https://github.com/qgis/QGIS/issues/46989) | [PR #47006](https://github.com/qgis/QGIS/pull/47006) | 必要なし |
...
| Fix line anchor placements are reversed for labels which sit below lines | 未報告 | [PR #47181](https://github.com/qgis/QGIS/pull/47181) | [PR #47181](https://github.com/qgis/QGIS/pull/47181) |
| Fix incorrect return code from QgsProcessingModelAlgorithm::fromFile when file does not exist | 未報告 | [PR #47161](https://github.com/qgis/QGIS/pull/47161) | [PR #47162](https://github.com/qgis/QGIS/pull/47162) |
| Fix many georeferencer regressions | multiple | 未報告 | pending |
...
| Fix sqlite errors on startup caused by default style database import logic | 未報告 | [PR #47070](https://github.com/qgis/QGIS/pull/47070) | not suitable |
| Fix color widgets incorrectly change colors when mouse is hovered over widget | 未報告 | [PR #47069](https://github.com/qgis/QGIS/pull/47069) | [PR #47077](https://github.com/qgis/QGIS/pull/47077) |
...
| Fix duplicate shortcut registered warning on startup | 未報告 | [PR #46983](https://github.com/qgis/QGIS/pull/46983) | not suitable |
| Fix scroll wheel events get \"stuck\" when scrolling to bottom of areas | 未報告 | [PR #46958](https://github.com/qgis/QGIS/pull/46958) | [PR #46987](https://github.com/qgis/QGIS/pull/46987) |
...
| Fix broken merge features tool | 未報告 | [PR #46924](https://github.com/qgis/QGIS/pull/46924) | n/a |
