...
section: project
sidebar: true
title: QGIS 3.28 の変更履歴
type: visual-changelog

---
{{<content-start >}}
# QGIS 3.28 の変更履歴{#changelog328 }
...
| QGIS not responding when entering page size using custom width or height fields | [#50104](https://github.com/qgis/QGIS/issues/50104) | 再現できません |  |
...
| Layer style panel and Layer panel do not show same visibility settings for layer style | [#49998](https://github.com/qgis/QGIS/issues/49998) | 再現できません |  |
| Crash while opening Options dialog after switching locale | [#50239](https://github.com/qgis/QGIS/issues/50239)9 | [PR #50263](https://github.com/qgis/QGIS/pull/50263) | 必要なし |
| 未報告のMSSQL接続APIのエラー | 未報告 | [PR #50194](https://github.com/qgis/QGIS/pull/50194) | [PR #50454](https://github.com/qgis/QGIS/pull/50454) |
| Identify and select tools don\'t work with geometry-based query layers | [#50242](https://github.com/qgis/QGIS/issues/50242) | 再現できません |  |
...
| Unreported endless alg splitwithlines | 未報告 | [PR #50279](https://github.com/qgis/QGIS/pull/50279) | Not recommended |
| Processing algorithm \"Split with lines\" does not split polygon | [#50227](https://github.com/qgis/QGIS/issues/50227) | バグではない |  |
| 式が複数行の文字列を分割しない | [#49666](https://github.com/qgis/QGIS/issues/49666) | [PR #50295](https://github.com/qgis/QGIS/pull/50295) | [PR #50455](https://github.com/qgis/QGIS/pull/50455) |
...
| Wrong interpretation of SLD color opacity | [#44657](https://github.com/qgis/QGIS/issues/44657) | バグではない |  |
| SLDエクスポート／インポートのラベルサイズ誤り | [#35561](https://github.com/qgis/QGIS/issues/35561) | [PR #50347](https://github.com/qgis/QGIS/pull/50347) | 必要なし |
...
| WFS/QgsOapifProvider does not take the pageSize from the dialog into account | [#49404](https://github.com/qgis/QGIS/issues/49404) | [PR #50236](https://github.com/qgis/QGIS/pull/50236) | 必要なし |
...
| \[Processing\] Fix typo in smoothing parameter name of gdal_grid algorithms | 未報告 | [PR #50261](https://github.com/qgis/QGIS/pull/50261) | [PR #50331](https://github.com/qgis/QGIS/pull/50331) |
...
| world_map.gpkg: little fix to avoid warning with recent GDAL versions | 未報告 | [PR #50304](https://github.com/qgis/QGIS/pull/50304) | 必要なし |
...
| Build fails with WITH_POSTGRESQL=OFF | [#50075](https://github.com/qgis/QGIS/issues/50075) | フィードバック |  |
...
| Cannot move labels | [#47542](https://github.com/qgis/QGIS/issues/47542) | 再現できません |  |
...
| Fixes log messages when a job error is not related to a specific layer | 未報告 | [PR #50372](https://github.com/qgis/QGIS/pull/50372) | 必要なし |
...
| Improve selection of PostGIS raster overviews | 未報告 | [PR #50554](https://github.com/qgis/QGIS/pull/50554) | [PR #50575](https://github.com/qgis/QGIS/pull/50575) |
...
| Include type name in message about unsupported qfield validations | 未報告 | [PR #50589](https://github.com/qgis/QGIS/pull/50589) |  |
...
| Fix broken logic in clearing python console history | 未報告 | [PR #50504](https://github.com/qgis/QGIS/pull/50504) | [PR #50515](https://github.com/qgis/QGIS/pull/50515) |
| Fix QgsFileWidget does not reactivate widget\'s window after selecting a file/folder via the browse button on mac | 未報告 | [PR #50501](https://github.com/qgis/QGIS/pull/50501) | [PR #50502](https://github.com/qgis/QGIS/pull/50502) |
| Fix code folding not shown for non-python code editor classes | 未報告 | [PR #50492](https://github.com/qgis/QGIS/pull/50492) |  |
| Fix leak in GEOS geometry library use | 未報告 | [PR #50379](https://github.com/qgis/QGIS/pull/50379) |  |
...
| Fix truncation of recent project list removes too many items, raises a warning | 未報告 | [PR #50394](https://github.com/qgis/QGIS/pull/50394) | [PR #50397](https://github.com/qgis/QGIS/pull/50397) |
...
| Fix broken path in svg raises Qt warnings while rendering | 未報告 | [PR #50383](https://github.com/qgis/QGIS/pull/50383) |  |
...
| \[spatialite\] Fix corrupted default attribute values when fields are loaded using gaiaVectorLayer | 個人的な報告 | [PR #50360](https://github.com/qgis/QGIS/pull/50360) | [PR #50361](https://github.com/qgis/QGIS/pull/50361) |
...
| ジオリファレンサウィンドウへのファイルのドラッグ＆ドロップを修正 | [#49175](https://github.com/qgis/QGIS/issues/49175) | [PR #50338](https://github.com/qgis/QGIS/pull/50338) | Not required |
...
| Avoid a redundant calculation of visible layer extent in overview canvas | 未報告 | [PR #50329](https://github.com/qgis/QGIS/pull/50329) | [PR #50336](https://github.com/qgis/QGIS/pull/50336) |
