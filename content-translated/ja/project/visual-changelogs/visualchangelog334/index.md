...
section: project
sidebar: true
title: QGIS 3.34 の変更履歴
type: visual-changelog

---
{{<content-start >}}
# QGIS 3.34 の変更履歴{#changelog334 }
![image0](images/entries/334splash.webp)

リリース日: 2023-10-29

QGISオープンソース地理空間データ分析・可視化ソフトウェアの機能に重要な機能強化をもたらすQGISプロジェクトのメジャーリリース、QGIS 3.34をご紹介します。

このリリースには、既存のAPI、式、ツールのさまざまな機能強化、印刷レイアウトの変更、および2Dと3Dの両方のコンテキストのレンダリングオプションの改善が含まれています。

導入されたすべての新機能を手早く確認するには、YouTubeのハイライト動画をご覧ください: <https://www.youtube.com/watch?v=LHFVo0edaXE>
...
## Cesium 3D Tiles
[Cesium](https://www.cesium.com/) プロジェクトからのエコシステム助成金のおかげで、QGISがCesium 3D Tiles形式の3Dコンテンツの読み込みをサポートするようになりました！タイルはローカルまたはリモートデータソース（Cesium ionプラットフォームやGoogle Earth フォトリアリスティックタイルを含む）から読み込むことができ、2Dおよび3Dマップビューの両方で表示されます。2Dビューでは元のテクスチャまたはタイルジオメトリのワイヤーフレームビューでスタイリングすることでタイルコンテンツの外観を制御でき、3Dおよび2Dビューの両方で希望の詳細レベルも制御できます。
...
この機能は [Martin Dobias](https://github.com/wonder-sk) と [Nyall Dawson](https://github.com/nyalldawson) によって開発されました
## ツール
### 機能: 計測ツールの小数点区切り文字としての \"ドット\" の強制適用オプション
計測ツールに新しい `常に小数点を使用`  チェックボックスオプションが追加されました。このオプションにより、現在のロケールがカンマを使用している場合でも、計測値と座標が小数点（ドット）区切り文字を使用してクリップボードにコピーされるようになります。

これにより、ユーザーロケールが小数点区切り文字としてカンマを使用している場合でも、カンマ区切り（CSV）データをコピーできるようになります。
...
### 機能: 識別ツール使用時の識別されたラスターピクセルのハイライト表示
QGISがマップキャンバス上のラスターピクセルの識別された地物結果のジオメトリを表示するようになりました。これはベクター、ベクタータイル、ポイントクラウドの地物タイプに対する識別ツールの既存の動作と一致します。

これは類似した色のピクセルのセクションを持つラスターを識別する際に、ピクセルの正確な範囲を視覚的に判断することが難しい場合に役立ちます。

![image2](images/entries/dc219caa150c9bbcb15aece90744f63e54ec25a1.webp)

This feature was developed by [Nyall Dawson](https://github.com/nyalldawson)
### 機能: 識別結果でのクリックされたポイントのラスター行/列の表示
ラスターレイヤーで識別ツールを使用する際、導出された結果に識別されたピクセルの行番号と列番号が含まれるようになりました。

![image3](images/entries/0889d275dfefea4c7c7d13ebc5dc6fd237573076.webp)

この機能は [Hannes & Nyall Dawson](https://github.com/kannes) によって開発されました
## シンボロジ
### 機能: ベクターレイヤーの選択色と選択シンボルのオーバーライド設定
新しいレイヤーレンダリング設定により、選択された地物をハイライト表示する際にシステムまたはプロジェクトのデフォルトの代わりに使用される色とシンボルをユーザーが制御できるようになります。

この設定は各レイヤーで定義され、明示的に定義されたシンボロジーを適用することで選択された地物の可視性を向上させるのに役立ちます。

これは以下のような様々なシナリオで役立ちます:
- レイヤーが選択シンボロジーと一致するシンボルの色やスタイルを使用しており、地物の選択が表示されない場合
- ラインレイヤーが細いシンボルを使用しており、選択されたラインを色付けしても十分に視認できない場合
- 複雑なシンボロジー（ラスター/グラジェントフィル/ライン/カラーランプを使用したシェイプバーストなど）を持つレイヤーにはデフォルトの選択色が適用されませんでした。このようなシナリオでは、ユーザーはレイヤー内の選択された地物に使用するよりシンプルなシンボルを指定できるようになります。
...
| 0 port in OAuth2 callback URI | [#54562](https://github.com/qgis/QGIS/issues/54562) | 再現できません | N/A |
...
| バグの表題 | URL issues.qgis.org （報告された場合） | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgsgeos.cpp: fix a -Wunused-variable warning | 未報告 | [PR #54612](https://github.com/qgis/QGIS/pull/54612) | N/A |
| qgsvirtualpointcloudprovider.cpp: add a missing variable initialization | 未報告 | [PR #54613](https://github.com/qgis/QGIS/pull/54613) | N/A |
...
| Syntactical error with the use of == instead of = for comparison in the WHERE clause | [#54608](https://github.com/qgis/QGIS/issues/54608) | 修正済み | Unable to write any additional layers to an existing FGDB |
...
| Spatial filtering of multipart polygons within a shapefile dataset broken | [GDAL issue 8481](https://github.com/OSGeo/gdal/issues/8481) | バグではない |  |
...
| バグの表題 | URL issues.qgis.org （報告された場合） | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix segfault in coordinate transform | 未報告 | [PR #54609](https://github.com/qgis/QGIS/pull/54609) | N/A |
...
| バグの表題 | URL issues.qgis.org （報告された場合） | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Have QgsRectangle null rectangle printed as EMPTY in wkt | 未報告 | [PR #54831](https://github.com/qgis/QGIS/pull/54831) | N/A |
| Fix aspect ratio computation in QgsLayoutItemMap::zoomToExtent | 未報告 | [PR #54827](https://github.com/qgis/QGIS/pull/54827) | N/A |
| Do not include a BoundingBox tag in GetFeatureInfo responses, when it is null | 未報告 | [PR #54858](https://github.com/qgis/QGIS/pull/54858) | N/A |
| Always run the spell and shell checkers if possible, print warning when not possible | 未報告 | [PR #54847](https://github.com/qgis/QGIS/pull/54847) | N/A |
| Tweak Null rectangle handling | 未報告 | [PR #54872](https://github.com/qgis/QGIS/pull/54872) | N/A |
| Run spellcheck only on changed files in prepare_commit.sh | 未報告 | [PR #54893](https://github.com/qgis/QGIS/pull/54893) | N/A |
| Fix prepare_commit.sh | 未報告 | [PR #54918](https://github.com/qgis/QGIS/pull/54918) | N/A |
| Fix extent computation in QgsSpatiaLiteProvider | 未報告 | [PR #54917](https://github.com/qgis/QGIS/pull/54917) | N/A |
...
| Make QgsBookmark string output more explicit about it being EMPTY | 未報告 | [PR #54923](https://github.com/qgis/QGIS/pull/54923) | N/A |
| Fix extent computation in QgsAFSProvider | 未報告 | [PR #54944](https://github.com/qgis/QGIS/pull/54944) | N/A |
| Add `tags` make target | 未報告 | [PR #54948](https://github.com/qgis/QGIS/pull/54948) | N/A |
| Handle null rectangles in QgsExtentWidget::outputExtent | 未報告 | [PR #54953](https://github.com/qgis/QGIS/pull/54953) | N/A |
| Handle null in QgsRectangle grow() and include() methods | 未報告 | [PR #54955](https://github.com/qgis/QGIS/pull/54955) | N/A |
| Add QgsRectangle::setNull(), deprecating setMinimal() | 未報告 | [PR #54934](https://github.com/qgis/QGIS/pull/54934) | N/A |
| Handle Null rectangle in QgsRectangle::buffered | 未報告 | [PR #54967](https://github.com/qgis/QGIS/pull/54967) | N/A |
| Fix extent computation in QgsVirtualLayerProvider | 未報告 | [PR #54976](https://github.com/qgis/QGIS/pull/54976) | N/A |
| Add a QgsRectangle::createNull() temporary static method | 未報告 | [PR #55008](https://github.com/qgis/QGIS/pull/55008) | N/A |
| Fix testRegisterFeatureUnprojectible - Use valid extent in testRegisterFeatureUnprojectible | 未報告 | [PR #55011](https://github.com/qgis/QGIS/pull/55011) | N/A |
| Have QgsGeometry::boundingBox return null rect for null geom | 未報告 | [PR #55012](https://github.com/qgis/QGIS/pull/55012) | N/A |
| Have QgsGeometry::fromRect(NULL RECT) return null geometry | 未報告 | [PR #54954](https://github.com/qgis/QGIS/pull/54954) | N/A |
...
| Run doxygen layout checker in prepare-commit script, when possible | 未報告 | [PR #54936](https://github.com/qgis/QGIS/pull/54936) | N/A |
...
| バグの表題 | URL issues.qgis.org （報告された場合） | URL Commit (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgs3daxissettings: Correctly read viewport ratio on a saved project | 未報告 | [PR #54870](https://github.com/qgis/QGIS/pull/54870) |  |
...
| Fix layout label adjust size to text logic | 未報告 | [PR #54896](https://github.com/qgis/QGIS/pull/54896) | pending |
...
| Fix layout maps force rasterisation of whole layout when map item has transparency set | 未報告 | [PR #54882](https://github.com/qgis/QGIS/pull/54882) | Too intrusive |
...
| Fix layout labels don\'t immediately react to changes when semi-transparent | 未報告 | [PR #54839](https://github.com/qgis/QGIS/pull/54839) | [PR #54863](https://github.com/qgis/QGIS/pull/54863) |
...
| Fix QgsField::ConfigurationFlag::None causes syntax error when starting PyQGIS | 未報告 | [PR #54809](https://github.com/qgis/QGIS/pull/54809) | N/A |
...
| Fix crash when certain symbol pages are open in style dock and QGIS is closed or a new project opened | 未報告 | [PR #54749](https://github.com/qgis/QGIS/pull/54749) | Too intrusive |
