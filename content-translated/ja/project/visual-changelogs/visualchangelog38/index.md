...
---
{{<content-start >}}
# QGIS 3.8の変更履歴{#changelog38 }
![image1](images/projects/403e44c7e958cff5d07a1eaf12af76ade88c564d.png)

リリース日: 2019-06-21

QGIS 3.8では、新しい変更と既存機能の多数の磨き上げの広範なリストができあがりました。ここではハイライトをカバーします。いつものように、QGISはオープンソースプロジェクトです。可能なら、寄付をしたり、スポンサーになったり、コードドキュメントやウェブサイト等への貢献をしたり、といった我々の活動の支援を検討して下さい。
...
私たちはあなたの地図ができるだけ美しくなるようにしたいので、QGIS 3.8ではマーカーの角度はシンボルの両側の指定された距離に沿って線を平均化することで計算されます。例えば、4mmの範囲で線の角度を平均化すると、シンボル配置から2mmの両側にある線上のポイントを取り、それらを使用してそのシンボルの線の角度を計算します。これにより、全体の線の方向からの微小な局所的な偏差を滑らかにする（または削除する！）効果があり、マーカーやハッシュラインの視覚的な方向性が向上します。
...
この機能は Matteo Nastasi によって開発されました
...
North RoadのNyall Dawsonさんが開発した新しい表現機能:
...
iMHere AsiaのMathieu Pellerinが開発した新しい数式関数:
...
この機能は Raymond Nijssen によって開発されました
...
この機能は Hansestadt Herford, SWK mbH, Datenbankgesellschaft mbH によって資金提供されました
...
この機能は Rashad Kanavath によって開発されました
...
この機能は Nyall Dawson (North Road) & Mathieu Pellerin (iMHere Asia) によって開発されました
...
この機能は Jürgen Fischer in collaboration with Matthias Kuhn によって開発されました
## QGISサーバー
...
| QGIS server ignores custom rendering order when loading parent group | [#21917](https://issues.qgis.org/issues/21917) | [PR #9878](https://github.com/qgis/QGIS/pull/9878) | 終了 |
| WMS Client: GetFeatureInfo in JSON format doesn\'t display numeric attribute values | [#21735](https://issues.qgis.org/issues/21735) | [PR #9879](https://github.com/qgis/QGIS/pull/9879) | 終了 |
| Crash when adding New Field to ShapeLayer | [#22100](https://issues.qgis.org/issues/22100) |  |  |
| Priority in labelling not greyed out when data defined settings are enabled | [#22077](https://issues.qgis.org/issues/22077) | 無効 |  |
...
| Issue exporting raster layer to Geopackage | [#20848](https://issues.qgis.org/issues/20848) | [PR #10036](https://github.com/qgis/QGIS/pull/10036) | 終了 |
| Create vector New shapefile POLYGON | [#22107](https://issues.qgis.org/issues/22107) | 無効 |  |
...
| Relation reference widget wrong feature when \"on map identification\" | [#22071](https://issues.qgis.org/issues/22071) | [PR #10047](https://github.com/qgis/QGIS/pull/10047) | 終了 |
| DB Manger imports the wrong data | [#22033](https://issues.qgis.org/issues/22033) | [PR #10077](https://github.com/qgis/QGIS/pull/10077) | 終了 |
| qgis crash when filtering a layer with an attachment field | [#21775](https://issues.qgis.org/issues/21775) | Fixed by Nyall |  |
| Raster calculator, abs() not working | [#29824](https://github.com/qgis/QGIS/issues/29824) | [PR #29965](https://github.com/qgis/QGIS/pull/29965) | 終了 |
| Valid file URL link fails in Identify window | [#29879](https://github.com/qgis/QGIS/issues/29879) | [PR #29967](https://github.com/qgis/QGIS/pull/29967) | 終了 |
| QgsProject.instance().clear() crashes QGIS when LayoutDesigner Window is open | [#29821](https://github.com/qgis/QGIS/issues/29821) | [PR #29968](https://github.com/qgis/QGIS/pull/29968) | 終了 |
| QGIS Server WFS DescribeFeatureType advertises double precision virtual fields as integer | [#29767](https://github.com/qgis/QGIS/issues/29767) | [PR #29970](https://github.com/qgis/QGIS/pull/29970) | 終了 |
| テンプレートをエクスポートするときにQGISがクラッシュ | [#29798](https://github.com/qgis/QGIS/issues/29798) | [PR #29981](https://github.com/qgis/QGIS/pull/29981) | 終了 |
| Export atlas as image fail when expression filename contain dot | [#29980](https://github.com/qgis/QGIS/issues/29980) | [PR #29983](https://github.com/qgis/QGIS/pull/29983) | 終了 |
...
| QGIS crashes with PostgreSQL views | [#29673](https://github.com/qgis/QGIS/issues/29673) | 再現できない及び意見を求められない |  |
...
| Crash when calling QgsRasterHistogram.histogramVector | [#29700](https://github.com/qgis/QGIS/issues/29700) | [PR #30033](https://github.com/qgis/QGIS/pull/30033) | 終了 |
| Do not offer to \"Import settings from Qgis2?\" if no such settings exist | [#30082](https://github.com/qgis/QGIS/issues/30082) | [PR #30092](https://github.com/qgis/QGIS/pull/30092) | 終了 |
...
| Drag and drop geopackage from filesystem into map misses vector layers, loses names for raster layers | [#30050](https://github.com/qgis/QGIS/issues/30050) | [PR #30098](https://github.com/qgis/QGIS/pull/30098) | 終了 |
...
| Unable to add new features in QGIS for PostGIS table using sequence for gid. Data type serial: \'integer overflow\' | [#30041](https://github.com/qgis/QGIS/issues/30041) | [PR #30184](https://github.com/qgis/QGIS/pull/30184) | 終了 |
...
| バグの表題 | URL issues.qgis.org （報告された場合） | URL Commit (Github) | 3.4 backport commit (GitHub) |
| --- | --- | --- | --- |
| v.net.distance - node cost column | [#22013](https://issues.qgis.org/issues/22013) | [PR #10060](https://github.com/qgis/QGIS/pull/10060) | 終了 |
| shapefile to raster conversion does not work | [#21922](https://issues.qgis.org/issues/21922) |  |  |
| GRASS r.in.lidar.info, can only choose *.txt not the intended* .las | [#21910](https://issues.qgis.org/issues/21910) | [PR #10061](https://github.com/qgis/QGIS/pull/10061) | 終了 |
| SAGA OpenCV Image Analysis | [#21746](https://issues.qgis.org/issues/21746) |  |  |
| SAGA \"saga split rgb bands\" tool is not inside any (SAGA) group of tools | [#21849](https://issues.qgis.org/issues/21849) | [PR #10062](https://github.com/qgis/QGIS/pull/10062) | 終了 |
| r.sun cannot be executed because it calls on two incompatible options | [#21637](https://issues.qgis.org/issues/21637) | [PR #10074](https://github.com/qgis/QGIS/pull/10074) | 終了 |
...
| Majority filter (SAGA) returns erroneous results if input is .tif | [#22118](https://issues.qgis.org/issues/22118) | 無効 |  |
| Processing batch process interface: no way to go back | [#16893](https://issues.qgis.org/issues/16893) | [PR #10080](https://github.com/qgis/QGIS/pull/10080) | 終了 |
| DB Manager rename PostGIS column error | [#21425](https://issues.qgis.org/issues/21425) | [PR #10082](https://github.com/qgis/QGIS/pull/10082) | 必要なし |
| Word wrapping not working in maptips | [#21388](https://issues.qgis.org/issues/21388) | [PR #10081](https://github.com/qgis/QGIS/pull/10081) | 終了 |
| Styles stored in QML files with same name as layer no longer auto loaded | [#21691](https://issues.qgis.org/issues/21691) | [PR #14660](https://github.com/qgis/QGIS/pull/14660) | 終了 |
| QGIS 3.4.6 crashed when I tried classifying a layer | [#21693](https://issues.qgis.org/issues/21693) | [PR #29951](https://github.com/qgis/QGIS/pull/29951) | 終了 |
| Fixed table not working under User defined filter (SAGA) | [#29999](https://github.com/qgis/QGIS/issues/29999) | [PR #30001](https://github.com/qgis/QGIS/pull/30001) | 終了 |
...
| r.mapcalc.simpleのバッチ処理エラー | [#29822](https://github.com/qgis/QGIS/issues/29822) |  |  |
...
| WFS GetFeature fails on TypeNames parameter | [#21768](https://issues.qgis.org/issues/21768) | [PR #29946](https://github.com/qgis/QGIS/pull/29946) | 終了 |
| Cannot load GPX file automatically after creating it QGIS 3.4.7 QGIS 3.6.2 | [#22005](https://issues.qgis.org/issues/22005) | [PR #29947](https://github.com/qgis/QGIS/pull/29947) | 終了 |
| SpatiaLiteキャッシュを作成できません | [#29819](https://github.com/qgis/QGIS/issues/29819) | [PR #29949](https://github.com/qgis/QGIS/pull/29949) | 終了 |
| PostGIS closed circle in Curved Polygon is not displayed | [#29895](https://github.com/qgis/QGIS/issues/29895) | [PR #30010](https://github.com/qgis/QGIS/pull/30010) | 終了 |
| Fix GeoJSON output of MultiPolygon/MultiSurface | [PR #30012](https://github.com/qgis/QGIS/pull/30012) | [PR #30012](https://github.com/qgis/QGIS/pull/30012) | 必要なし |
| Multipatch features are not shown anymore | [#29376](https://github.com/qgis/QGIS/issues/29376) | [PR #30024](https://github.com/qgis/QGIS/pull/30024) | 終了 |
| Multiple issues and deadlocks with WFS | [#29258](https://github.com/qgis/QGIS/issues/29258) | [PR #30026](https://github.com/qgis/QGIS/pull/30026) | 終了 |
| WFS provider: Avoid dangling download progress dialog | [PR #30039](https://github.com/qgis/QGIS/pull/30039) | [PR #30039](https://github.com/qgis/QGIS/pull/30039) | 終了 |
...
| バグの表題 | URL issues.qgis.org （報告された場合） | URL Commit (Github) | 3.4 backport commit (GitHub) |
| --- | --- | --- | --- |
| フィールド名に空白のあるGeoPackage地物を編集するとQGISがクラッシュ | [#29630](https://github.com/qgis/QGIS/issues/29630) | [PR #29997](https://github.com/qgis/QGIS/pull/29997) | TODO |
| pgレイヤを更新するとクラッシュ | [#29814](https://github.com/qgis/QGIS/issues/29814) | 重複 | N/A |
| XMDF file type missing from Madiera 3.4.5 | [#29381](https://github.com/qgis/QGIS/issues/29381) | 無効 | N/A |
...
| フィールドを編集するとクラッシュ | [#29200](https://github.com/qgis/QGIS/issues/29200) | unable to replicate | N/A |
| 頂点エディタを閉じるとappがクラッシュする | [#30028](https://github.com/qgis/QGIS/issues/30028) | [PR #30030](https://github.com/qgis/QGIS/pull/30030) | TODO |
...
| バグの表題 | URL issues.qgis.org （報告された場合） | URL Commit (Github) | 3.4 backport commit (GitHub) |
| --- | --- | --- | --- |
| 回転したポイントを選択してもスナップしない | [#29706](https://github.com/qgis/QGIS/issues/29706) | duplicate / not a bug |  |
...
| Improve the advanced digitizing by angle | [#30133](https://github.com/qgis/QGIS/issues/30133) | バグではない |  |
