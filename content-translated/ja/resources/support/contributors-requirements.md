...
# 貢献者の要件
## 新しい貢献者に求められるもの
私たちは新しいコミュニティの貢献者を歓迎します。私たちはあなたの仕事を行うためのプラットフォームとしてQGISを使用してもらいたいと思ってます、QGISはそのための素晴らしいプラットフォームだと考えています。コード、パッチ、またはドキュメントをQGISプロジェクトに提供するには、すべての開発者/チームメンバーが以下の事項を守る必要があります:
...
- これらの要件は、コミット権限を望む開発者とパッチを提出する開発者の両方に適用されます。
