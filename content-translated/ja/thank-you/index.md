...
ダウンロードには時間がかかる場合があります。　**ダウンロードマネージャー** で **進捗状況を確認してください**  。
 ...
 ダウンロードが開始されない場合は、 [QGIS.orgのダウンロードページ](https://download.qgis.org/downloads/) から手動でダウンロードできます。
...
![QGIS 開発者第1回ミーティング](qgis_1st_conference.png "QGIS Developers 1st meeting")
...
{{<rich-content-start themeClass="coloring-1" >}}
##### 初回起動時のヒント
QGISの導入にあたってご不明な点がある場合は、初回インストールの完全ガイドをご参照ください。 [インストールガイド]({{< ref "resources/installation-guide" >}})
