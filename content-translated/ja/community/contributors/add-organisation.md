...
draft: false
sidebar: true
title: あなたの団体をQGIS貢献者に追加しましょう
type: page

---
{{<content-start >}}
# あなたの団体をQGIS貢献者に追加しましょう
ようこそ! あなたの団体がQGISに貢献している場合、私たちの [貢献者ページ](/community/contributors/) で紹介することができます。以下の簡単な手順に従ってくださいs:
____
## ステップ 1: 自分の団体の詳細を用意する
### 必要なもの
- 団体の名称、スローガン、ウェブサイトURL
- QGISとのかかわり合いの簡潔な説明
- QGISに貢献するチームメンバー達のGitHubユーザー名
- 団体のロゴ（web用に最適化されたPNG又はSVG）

____
## ステップ 2: テンプレートに入力する
このテンプレートをコピーし、自分の団体の情報でカスタマイズしてください:
```
{
...
4. （ステップ 2から） **自分の団体のエントリを貼り付けてください**
5. **「変更をコミットする」をクリックし** 、次のような説明を与えてください: *"Add [自分の団体名称] to contributors"*
...
3. 承認されマージされると、あなたの団体が [貢献者のページ](/community/contributors/) に現れます！
