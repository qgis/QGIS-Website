...
QGISユーザーのリスト
-
ユーザーの質問の主なリスト：一般的なQGISの議論に使用されます。また、そのインストールと使用に関する特定の質問もあります。
...
QGIS開発者のリスト
-
QGISコアまたはプラグインの開発に関する質問のメインリスト。 コーディング、ビルド手順について議論し、QGISに関連するUX（ユーザーエクスペリエンス）/ユーザビリティの問題について口出し、収集、議論できます。
...
QGISコミュニティチーム
-
このリストは、ドキュメント、ユーザーガイド、Webサイト、ブログ、メーリングリスト、フォーラム、翻訳作業などのトピックを扱っています。ユーザーガイドでも作業したい場合は、このリストを参考にして質問してください。
...
QGIS翻訳
-
このリストは、翻訳作業を扱っています。 Webサイト、マニュアル、またはグラフィカルユーザーインターフェイス（GUI）の翻訳作業を行う場合は、この一覧を参考にして質問してください。
...
-
このリストは、QGIS全体の管理と方向性に関する運営委員会の問題を議論するために使用されます。

{{<rich-list listLink="http://lists.osgeo.org/mailman/listinfo/qgis-psc" layoutClass="half" listTitle="QGISプロジェクト運営委員会 (PSC)リスト" listSubtitle="http://lists.osgeo.org/mailman/listinfo/qgis-psc" >}}
