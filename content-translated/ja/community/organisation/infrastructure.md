...
{{<content-start >}}
# インフラストラクチャー
このページには、QGISが使用するすべてのインフラストラクチャとサービス、および現在の連絡先または所有者が表示されます。
...
**Main contact:** Gary
## メインサーバー
{{<rich-list listLink="http://documentation.qgis.org" layoutClass="half" listTitle="メインサーバー" listSubtitle="http://documentation.qgis.org" >}}
...
フリッカー・グループ
-
{{<rich-list listLink="http://www.flickr.com/groups/qgis/pool/" layoutClass="half" listTitle="スクリーンショット" listSubtitle="http://www.flickr.com/groups/qgis/pool/" >}}

{{<rich-list listLink="http://www.flickr.com/groups/qgis-screenshots/" layoutClass="half" listTitle="地図" listSubtitle="http://www.flickr.com/groups/qgis-screenshots/" >}}
