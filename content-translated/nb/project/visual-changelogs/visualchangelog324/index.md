...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.22 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| fix server crash | ikke rapportert | [PR #47271](https://github.com/qgis/QGIS/pull/47271) | TODO |
...
| Fixes to QgsGeometry::addPart + new test cases | ikke rapportert | [PR #47009](https://github.com/qgis/QGIS/pull/47009) |  |
...
| Wrong signature of the QgsProcessingParameterMeshDatasetGroups when exporting to Python | ikke rapportert | [PR #47152](https://github.com/qgis/QGIS/pull/47152) | [PR #47156](https://github.com/qgis/QGIS/pull/47156) |
...
| Fix output filename when a raster is saved in a format without extension | ikke rapportert | [PR #46992](https://github.com/qgis/QGIS/pull/46992) | TODO |
| WFS GetFeature document and exceptions | ikke rapportert | [PR #47198](https://github.com/qgis/QGIS/pull/47198) | TODO |
...
| Fix line anchor placements are reversed for labels which sit below lines | ikke rapportert | [PR #47181](https://github.com/qgis/QGIS/pull/47181) | [PR #47181](https://github.com/qgis/QGIS/pull/47181) |
| Fix incorrect return code from QgsProcessingModelAlgorithm::fromFile when file does not exist | ikke rapportert | [PR #47161](https://github.com/qgis/QGIS/pull/47161) | [PR #47162](https://github.com/qgis/QGIS/pull/47162) |
| Fix many georeferencer regressions | multiple | ikke rapportert | pending |
...
| Fix sqlite errors on startup caused by default style database import logic | ikke rapportert | [PR #47070](https://github.com/qgis/QGIS/pull/47070) | not suitable |
| Fix color widgets incorrectly change colors when mouse is hovered over widget | ikke rapportert | [PR #47069](https://github.com/qgis/QGIS/pull/47069) | [PR #47077](https://github.com/qgis/QGIS/pull/47077) |
| Avoid crs definition errors when closing options dialog | [#47014](https://github.com/qgis/QGIS/issues/47014) | [PR #47061](https://github.com/qgis/QGIS/pull/47061) | i/t |
| Fix duplicate shortcut registered warning on startup | ikke rapportert | [PR #46983](https://github.com/qgis/QGIS/pull/46983) | not suitable |
| Fix scroll wheel events get \"stuck\" when scrolling to bottom of areas | ikke rapportert | [PR #46958](https://github.com/qgis/QGIS/pull/46958) | [PR #46987](https://github.com/qgis/QGIS/pull/46987) |
...
| Fix broken merge features tool | ikke rapportert | [PR #46924](https://github.com/qgis/QGIS/pull/46924) | i/t |
