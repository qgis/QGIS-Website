...
1. Opprett tilfeldig rasterlag (binomisk fordelt)
2. Opprett tilfeldig rasterlag (eksponentialfordelt)
3. Opprett tilfeldig rasterlag (gammafordelt)
4. Opprett tilfeldig rasterlag (negativ binomisk fordelt)
5. Opprett tilfeldig rasterlag (normalfordelt)
6. Opprett tilfeldig rasterlag (Poisson-fordelt)
7. Opprett tilfeldig rasterlag (uniformt fordelt)
...
| GPKG browser drag&drop not working | ikke rapportert | [PR #36972](https://github.com/qgis/QGIS/pull/36972) | [PR #37159](https://github.com/qgis/QGIS/pull/37159) |
...
| Støttelager kan ikke brukes av lag som ikke kan redigeres | [#30376](https://github.com/qgis/QGIS/issues/30376) | Already fixed. Closed. | N/A |
...
| Oracle: Tabeller listes én gang for Polygon og én gang for MultiPolygon, men begge viser alle geometrier | [#32521](https://github.com/qgis/QGIS/issues/32521) | [PR #34358](https://github.com/qgis/QGIS/pull/34358) | N/A |
...
| Fix redirection of the stdout results to temporary files in GRASS Processing algorithms | ikke rapportert | [PR #36618](https://github.com/qgis/QGIS/pull/36618) | [PR #36684](https://github.com/qgis/QGIS/pull/36684) |
| Fix GRASS r.tileset algorithm | ikke rapportert | [PR #36645](https://github.com/qgis/QGIS/pull/36645) | [PR #36695](https://github.com/qgis/QGIS/pull/36695) |
...
| Attributes shift in the Service area algorithm results | ikke rapportert | [PR #37074](https://github.com/qgis/QGIS/pull/37074), [PR #37097](https://github.com/qgis/QGIS/pull/37097) | N/A |
| Processing testing framework does not apply rounding to values casted to numbers | ikke rapportert | [PR #37234](https://github.com/qgis/QGIS/pull/37234) | N/A |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | Tilbakeføring til 3.10 (Github) |
| --- | --- | --- | --- |
| Fix leak in mesh 3d renderer | ikke rapportert | [Commit 4b5a63d](https://github.com/qgis/QGIS/commit/4b5a63d11b7ea5baf6931c8abf86e132c706c1be) | N/A |
...
| Fix font in CSS code editor | ikke rapportert | [Commit 63cb42c](https://github.com/qgis/QGIS/commit/63cb42c298ef5ab732274bce205e49171b797ae4) | not critical |
...
| Fix all Qt 5.14 deprecation warnings | ikke rapportert | [Commit 3717adc](https://github.com/qgis/QGIS/commit/3717adcef6315f4b9a0089bfc2393cede937b644) | No \-- too intrusive |
...
| Fixes to numbered list handling in dox/PyQGIS API | ikke rapportert | [Commit 74400c7](https://github.com/qgis/QGIS/commit/74400c7ff88d563dad74dad41860f9b603214973) | Nei |
| Fix cross references in PyQGIS docs | ikke rapportert | [Commit 81a9db9](https://github.com/qgis/QGIS/commit/81a9db9f57706cba9b11e4372dd1bf50fcd7bc6a) | Nei |
...
| Fix list item formatting in PyQGIS docs | ikke rapportert | [Commit 84ec481](https://github.com/qgis/QGIS/commit/84ec481aa8f3d3bb487272122414c765e77a2ea2) | N/A |
...
| Avoid some QGIS startup warnings | ikke rapportert | [Commit 013f682](https://github.com/qgis/QGIS/commit/013f682bd3c6addd163a78d3776c578ae37377c6) | N/A |
...
| \[labeling\] Fix incorrect label placement after moving an \'unplaced\' label | ikke rapportert | [Commit cbfb7f4](https://github.com/qgis/QGIS/commit/cbfb7f4ce25e10aab5f7b8cee147afb801042704) | [PR 36718 Commit 9189dec](https://github.com/qgis/QGIS/pull/36718/commits/9189dec7633b2eb6a1075bb35c2f90f6b90ba63a) |
| Don\'t block creation of new geopackages in vector save as dialog | ikke rapportert | [Commit 8ccd127](https://github.com/qgis/QGIS/commit/8ccd127f4d8bf66fb04b6484147ed116acf66d91) | N/A |
...
| \[3d\] When showing edges, data defined polygon height was not accounted for | ikke rapportert | [Commit e516231](https://github.com/qgis/QGIS/commit/e516231bb2854405ea78a0cec40ad96295e9f8c6) | N/A |
| Fixes for \"Show all\" labeling mode | ikke rapportert | [Commit 2b91bd0](https://github.com/qgis/QGIS/commit/2b91bd0cafff66f14ceb49b104bf2f2cc6ae714d) | N/A |
...
| Avoid corrupted project thumbnail images in some circumstances | ikke rapportert | [Commit f404e6e](https://github.com/qgis/QGIS/commit/f404e6e162df954ffb200d550b6c32375b7270c1) | N/A |
...
| Fix placement of message bar \'clear all\' menu arrow on hidpi screens | ikke rapportert | [Commit 8a9975b](https://github.com/qgis/QGIS/commit/8a9975b4ff6b7a8a79bef05230db28754500fa40) | not critical |
...
| Fix incorrect warning message when turning off atlas preview | ikke rapportert | [Commit 3b0af960](https://github.com/qgis/QGIS/commit/3b0af960dd90af15cbe32e2fd7642408031e70f5) | N/A |
...
| Improve plugin watchdog message and UX | ikke rapportert | [Commit 150b373](https://github.com/qgis/QGIS/commit/150b373c7ae61c0548ab0803f9b30a36b15e7ab4) | No \-- too intrusive |
...
| Avoid proj \'object is not a concatenated operation\' warnings | ikke rapportert | [Commit 6baa209](https://github.com/qgis/QGIS/commit/6baa209285f452e5996537b1b0f1b5d924d5c59b) |  |
...
| Don\'t try to identify CRSes created just for ellipsoid definitions | ikke rapportert | [Commit 15b318b](https://github.com/qgis/QGIS/commit/15b318b50de9131ed1dd6bbf73ae5eb7572579a7) | No \-- too intrusive |
...
| fix layer tree dependencies (showinf symbols and main layer) | ikke rapportert | [PR #37000](https://github.com/qgis/QGIS/pull/37000) | N/A |
