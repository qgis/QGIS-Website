...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Qgis have problem to render GeometryCollection for Gml, other viewer like mygeodata website render ok | [\#66225](https://github.com/qgis/QGIS/issues/66225) | Duplikat |  |
...
| Layout bleeding to edge outside map window | [\#49638](https://github.com/qgis/QGIS/issues/49638) | Fast |  |
| Fix flaky test_gui_fileuploader | Ikke rapportert | [PR \#66543](https://github.com/qgis/QGIS/pull/66543) |  |
| Hidden actions from user defined toolbar are still visible. | Ikke rapportert | [PR \#66620](https://github.com/qgis/QGIS/pull/66620) |  |
...
| Password is not removed when it's at the the end of uri | Ikke rapportert | [PR \#66625](https://github.com/qgis/QGIS/pull/66625) | TODO |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
| Allow QGIS to access curves from OGC API provider | Ikke rapportert | [PR \#66452](https://github.com/qgis/QGIS/pull/66452) | N/A |
...
| Ensure consistency in MultiCurves: don't allow NurbsCurves | Ikke rapportert | [PR \#66676](https://github.com/qgis/QGIS/pull/66676) | N/A |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix field displayString on primitive JSON values | Ikke rapportert | [PR \#66575](https://github.com/qgis/QGIS/pull/66575) | N/A |
...
| QGIS server OGC API: Limits and offset parameters ignored when plugin changing parameters | [\#65858](https://github.com/qgis/QGIS/issues/65858) | Fast | [PR \#66480](https://github.com/qgis/QGIS/pull/66480) |
...
| DB-håndtering | [\#59470](https://github.com/qgis/QGIS/issues/59470) | Cannot reproduce |  |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.44 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix deadlock when rendering annotation layers | Ikke rapportert | [PR \#66712](https://github.com/qgis/QGIS/pull/66712) | [PR \#66742](https://github.com/qgis/QGIS/pull/66742) |
| Fix crashes in QgsFeatureListComboBox if layer is unloaded | Ikke rapportert | [PR \#66697](https://github.com/qgis/QGIS/pull/66697) | [PR \#66708](https://github.com/qgis/QGIS/pull/66708) |
| Every entry in relation reference widget is shown in italic | Ikke rapportert | [PR \#66649](https://github.com/qgis/QGIS/pull/66649) | Not appropriate |
| Fix buggy processing relief colors widget | Ikke rapportert | [PR \#66602](https://github.com/qgis/QGIS/pull/66602) | Not appropriate |
| Fix QgsImageCache lossy conversion of images | Ikke rapportert | [PR \#66585](https://github.com/qgis/QGIS/pull/66585) | Not appropriate |
...
| Fix intermittent failure of GRASS raster tests | Ikke rapportert | [PR \#66546](https://github.com/qgis/QGIS/pull/66546) | N/A |
...
| Use correct lossless method to store metal rough colors | Ikke rapportert | [PR \#66521](https://github.com/qgis/QGIS/pull/66521) | N/A |
| Ensure color picker opens inline for 3d settings in style dock | Ikke rapportert | [PR \#66520](https://github.com/qgis/QGIS/pull/66520) | Not appropriate |
| Fix misalignment of spin boxes in color dialog | Ikke rapportert | [PR \#66498](https://github.com/qgis/QGIS/pull/66498) | Not appropriate |
| Use unlit material instead of phong material when more appropriate | Ikke rapportert | [PR \#66490](https://github.com/qgis/QGIS/pull/66490) | Not appropriate |
...
| Partially fix slow expression builder widget construction times | Ikke rapportert | [PR \#66385](https://github.com/qgis/QGIS/pull/66385) | Not appropriate |
...
| WMS Ensure we store deduced CRS in provider/layer sources | Ikke rapportert | [PR \#66379](https://github.com/qgis/QGIS/pull/66379) | Not appropriate |
...
| Fix model is zoomed right out when opening model designer | Ikke rapportert | [PR \#66335](https://github.com/qgis/QGIS/pull/66335) | QGIS 4 only |
