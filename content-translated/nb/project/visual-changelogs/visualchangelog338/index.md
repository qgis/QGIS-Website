...
| [ux][layouts] Fix legend item style mutex | ikke rapportert | [PR #57605](https://github.com/qgis/QGIS/pull/57605) | N/A |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Source-tree documentation improvements | ikke rapportert | [PR #57594](https://github.com/qgis/QGIS/pull/57594) |  |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Avoid crash on summary when error list is empty | ikke rapportert | [PR #57658](https://github.com/qgis/QGIS/pull/57658) | [PR #57661](https://github.com/qgis/QGIS/pull/57661) |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgsabstractmaterialsettings: Handle selection in addParametersToEffect | ikke rapportert | [PR #57803](https://github.com/qgis/QGIS/pull/57803) | not backported |
| qgs3daxis: Fix cube face picking | ikke rapportert | [PR #57848](https://github.com/qgis/QGIS/pull/57848) |  |
...
| Fix some grass vectors incorrectly show as datasets | ikke rapportert | [PR #57780](https://github.com/qgis/QGIS/pull/57780) | [PR #57786](https://github.com/qgis/QGIS/pull/57786) |
...
| Don't try to connect widget to null vector tile layers | ikke rapportert | [PR #57721](https://github.com/qgis/QGIS/pull/57721) | N/A |
| Don't show invalid "Style not found in database" warning when adding vector tile layers | ikke rapportert | [PR #57714](https://github.com/qgis/QGIS/pull/57714) | Not appropriate |
...
| Fix add feature dialog does not restore position when shown modally | ikke rapportert | [PR #57686](https://github.com/qgis/QGIS/pull/57686) | [PR #57700](https://github.com/qgis/QGIS/pull/57700) |
| Fix python script editor "open in external editor" action | ikke rapportert | [PR #57682](https://github.com/qgis/QGIS/pull/57682) | Not appropriate |
| Fix broken prefetch capabilities for raster layers | ikke rapportert | [PR #57663](https://github.com/qgis/QGIS/pull/57663) | [PR #57667](https://github.com/qgis/QGIS/pull/57667) |
| Fix missing field type information in eg the horizontal header tooltips in attribute table | ikke rapportert | [PR #57621](https://github.com/qgis/QGIS/pull/57621) | Not appropriate |
| Don't try to paint to indexed image | ikke rapportert | [PR #57601](https://github.com/qgis/QGIS/pull/57601) |  |
| Clamp values for set_color_part function to avoid qt warnings when out of range values are specified | ikke rapportert | [PR #57600](https://github.com/qgis/QGIS/pull/57600) |  |
| Add some tests for rendering text with RTL markers | [PR #57586](https://github.com/qgis/QGIS/pull/57586) |  |  |
| Fix rotation based orientation when html labeling enabled | ikke rapportert | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Too intrusive |
| Fix data defined font size is ignored when HTML labeling is active | ikke rapportert | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Too intrusive |
| Don't set @value to line height when evaluating multi line alignment | ikke rapportert | [PR #57582](https://github.com/qgis/QGIS/pull/57582) | Too intrusive |
...
| Fix incorrect buffers drawn for html label item | ikke rapportert | [PR #57551](https://github.com/qgis/QGIS/pull/57551) | [PR #57571](https://github.com/qgis/QGIS/pull/57571) |
| Fix label mask sizes get reset to 0 | ikke rapportert | [PR #57555](https://github.com/qgis/QGIS/pull/57555) | [PR #57569](https://github.com/qgis/QGIS/pull/57569) |
...
| Make brush and stroke style combo box icons visible on dark themes | ikke rapportert | [PR #57506](https://github.com/qgis/QGIS/pull/57506) | [PR #57510](https://github.com/qgis/QGIS/pull/57510) |
