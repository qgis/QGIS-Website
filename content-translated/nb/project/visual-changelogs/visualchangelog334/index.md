...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| QGIS cannot connect to MySQL if user\'s password contains commas. | [#54493](https://github.com/qgis/QGIS/issues/54493) | [PR #54573](https://github.com/qgis/QGIS/pull/54573) | Nei |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgsgeos.cpp: fix a -Wunused-variable warning | ikke rapportert | [PR #54612](https://github.com/qgis/QGIS/pull/54612) | N/A |
| qgsvirtualpointcloudprovider.cpp: add a missing variable initialization | ikke rapportert | [PR #54613](https://github.com/qgis/QGIS/pull/54613) | N/A |
...
| Syntactical error with the use of == instead of = for comparison in the WHERE clause | [#54608](https://github.com/qgis/QGIS/issues/54608) | Allerede fikset | Unable to write any additional layers to an existing FGDB |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix segfault in coordinate transform | ikke rapportert | [PR #54609](https://github.com/qgis/QGIS/pull/54609) | N/A |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Have QgsRectangle null rectangle printed as EMPTY in wkt | ikke rapportert | [PR #54831](https://github.com/qgis/QGIS/pull/54831) | N/A |
| Fix aspect ratio computation in QgsLayoutItemMap::zoomToExtent | ikke rapportert | [PR #54827](https://github.com/qgis/QGIS/pull/54827) | N/A |
| Do not include a BoundingBox tag in GetFeatureInfo responses, when it is null | ikke rapportert | [PR #54858](https://github.com/qgis/QGIS/pull/54858) | N/A |
| Always run the spell and shell checkers if possible, print warning when not possible | ikke rapportert | [PR #54847](https://github.com/qgis/QGIS/pull/54847) | N/A |
| Tweak Null rectangle handling | ikke rapportert | [PR #54872](https://github.com/qgis/QGIS/pull/54872) | N/A |
| Run spellcheck only on changed files in prepare_commit.sh | ikke rapportert | [PR #54893](https://github.com/qgis/QGIS/pull/54893) | N/A |
| Fix prepare_commit.sh | ikke rapportert | [PR #54918](https://github.com/qgis/QGIS/pull/54918) | N/A |
| Fix extent computation in QgsSpatiaLiteProvider | ikke rapportert | [PR #54917](https://github.com/qgis/QGIS/pull/54917) | N/A |
...
| Make QgsBookmark string output more explicit about it being EMPTY | ikke rapportert | [PR #54923](https://github.com/qgis/QGIS/pull/54923) | N/A |
| Fix extent computation in QgsAFSProvider | ikke rapportert | [PR #54944](https://github.com/qgis/QGIS/pull/54944) | N/A |
| Add `tags` make target | ikke rapportert | [PR #54948](https://github.com/qgis/QGIS/pull/54948) | N/A |
| Handle null rectangles in QgsExtentWidget::outputExtent | ikke rapportert | [PR #54953](https://github.com/qgis/QGIS/pull/54953) | N/A |
| Handle null in QgsRectangle grow() and include() methods | ikke rapportert | [PR #54955](https://github.com/qgis/QGIS/pull/54955) | N/A |
| Add QgsRectangle::setNull(), deprecating setMinimal() | ikke rapportert | [PR #54934](https://github.com/qgis/QGIS/pull/54934) | N/A |
| Handle Null rectangle in QgsRectangle::buffered | ikke rapportert | [PR #54967](https://github.com/qgis/QGIS/pull/54967) | N/A |
| Fix extent computation in QgsVirtualLayerProvider | ikke rapportert | [PR #54976](https://github.com/qgis/QGIS/pull/54976) | N/A |
| Add a QgsRectangle::createNull() temporary static method | ikke rapportert | [PR #55008](https://github.com/qgis/QGIS/pull/55008) | N/A |
| Fix testRegisterFeatureUnprojectible - Use valid extent in testRegisterFeatureUnprojectible | ikke rapportert | [PR #55011](https://github.com/qgis/QGIS/pull/55011) | N/A |
| Have QgsGeometry::boundingBox return null rect for null geom | ikke rapportert | [PR #55012](https://github.com/qgis/QGIS/pull/55012) | N/A |
| Have QgsGeometry::fromRect(NULL RECT) return null geometry | ikke rapportert | [PR #54954](https://github.com/qgis/QGIS/pull/54954) | N/A |
...
| Run doxygen layout checker in prepare-commit script, when possible | ikke rapportert | [PR #54936](https://github.com/qgis/QGIS/pull/54936) | N/A |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgs3daxissettings: Correctly read viewport ratio on a saved project | ikke rapportert | [PR #54870](https://github.com/qgis/QGIS/pull/54870) |  |
...
| Fix layout label adjust size to text logic | ikke rapportert | [PR #54896](https://github.com/qgis/QGIS/pull/54896) | pending |
...
| Fix layout maps force rasterisation of whole layout when map item has transparency set | ikke rapportert | [PR #54882](https://github.com/qgis/QGIS/pull/54882) | Too intrusive |
...
| Fix layout labels don\'t immediately react to changes when semi-transparent | ikke rapportert | [PR #54839](https://github.com/qgis/QGIS/pull/54839) | [PR #54863](https://github.com/qgis/QGIS/pull/54863) |
...
| Fix QgsField::ConfigurationFlag::None causes syntax error when starting PyQGIS | ikke rapportert | [PR #54809](https://github.com/qgis/QGIS/pull/54809) | N/A |
...
| Fix crash when certain symbol pages are open in style dock and QGIS is closed or a new project opened | ikke rapportert | [PR #54749](https://github.com/qgis/QGIS/pull/54749) | Too intrusive |
