...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
...
| Server: landingpage webapp only functions if built with server python plugins support | [\#64556](https://github.com/qgis/QGIS/issues/64556) | [PR \#64763](https://github.com/qgis/QGIS/pull/64763) | Nei |
| Raster calculator fails when OpenCL acceleration is turned on | [\#64574](https://github.com/qgis/QGIS/issues/64574) | [PR \#64779](https://github.com/qgis/QGIS/pull/64779) | Nei |
...
| \[ogr\]\[gpkg\] Fix wrong row count when attribute filter | [\#65067](https://github.com/qgis/QGIS/issues/65067) | [PR \#65097](https://github.com/qgis/QGIS/pull/65097) | Nei |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgis/gdal garbage collection causes segfault | [\#58724](https://github.com/qgis/QGIS/issues/58724) | [PR \#64766](https://github.com/qgis/QGIS/pull/64766) | Nei |
...
| QgsVectorFileWriter: fix writing NurbsCurve to OGR, by converting them to LineString | Ikke rapportert | [PR \#64906](https://github.com/qgis/QGIS/pull/64906) | N/A |
| Build issue on NixOS | [\#64937](https://github.com/qgis/QGIS/issues/64937) | Ugyldig |  |
...
| Replace all remaining uses of connect(,SIGNAL,,SLOT) in src/ | Ikke rapportert | [PR \#63832](https://github.com/qgis/QGIS/pull/63832) | N/A |
...
| Fix build warnings on Fedora | Ikke rapportert | [PR \#63910](https://github.com/qgis/QGIS/pull/63910) | N/A |
| Fix cppcheck missingOverride and functionConst warnings | Ikke rapportert | [PR \#63913](https://github.com/qgis/QGIS/pull/63913) | N/A |
| \[CI\] Port OGC tests to ubuntu:25.10 Qt6 | Ikke rapportert | [PR \#64135](https://github.com/qgis/QGIS/pull/64135) | N/A |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| pyqt5_to_pyqt6.py: Some known incompatibilities do not lead to error exit code | [\#62559](https://github.com/qgis/QGIS/issues/62559) | [PR \#63526](https://github.com/qgis/QGIS/pull/63526) | Nei |
| \[PyQt5_to_PyQt6\] Fix all imports coming from Qt module | Ikke rapportert | [PR \#63565](https://github.com/qgis/QGIS/pull/63565) |  |
...
| The "Session Role" function is not applied to loaded layers | [\#62930](https://github.com/qgis/QGIS/issues/62930) | Allerede fikset |  |
...
| With composite foreign keys, all widgets are configured by default | [\#32048](https://github.com/qgis/QGIS/issues/32048) | [PR \#65059](https://github.com/qgis/QGIS/pull/65059) | nei |
...
| Crash in layer styling panel when closing a project if DD Property Assistant is open | Ikke rapportert | [PR \#63549](https://github.com/qgis/QGIS/pull/63549) |  |
...
| Layers added using a .qlr file cannot be added to an open Elevation Profile View | [\#58533](https://github.com/qgis/QGIS/issues/58533) | Allerede fikset |  |
...
| Fix 3d view shortcuts | Ikke rapportert | [PR \#63523](https://github.com/qgis/QGIS/pull/63523) |  |
| Fix zooming with right mouse button in 3D views | Ikke rapportert | [PR \#63537](https://github.com/qgis/QGIS/pull/63537) |  |
| Fix 3d point lights | Ikke rapportert | [PR \#63525](https://github.com/qgis/QGIS/pull/63525) |  |
...
| \[3D\] Avoid clamping vertices to actual nodata value | Ikke rapportert | [PR \#64845](https://github.com/qgis/QGIS/pull/64845) |  |
| Data corruption using "Split Features" on a LineStringZ in GeoJSON | [\#63581](https://github.com/qgis/QGIS/issues/63581) | [PR \#64986](https://github.com/qgis/QGIS/pull/64986) | Pågår |
...
| Fix sip_include.sh after pyqt5 removal | Ikke rapportert | [PR \#64974](https://github.com/qgis/QGIS/pull/64974) | N/A |
| Make the extent widget hold the full precision of the chosen extent | Ikke rapportert | [PR \#64919](https://github.com/qgis/QGIS/pull/64919) |  |
| Fix endless terrain levels generation | Ikke rapportert | [PR \#64875](https://github.com/qgis/QGIS/pull/64875) |  |
| Always check pointer initialized inside if initializer | Ikke rapportert | [PR \#64871](https://github.com/qgis/QGIS/pull/64871) |  |
...
| Tidy includes in point clouds and 3d code | Ikke rapportert | [PR \#64820](https://github.com/qgis/QGIS/pull/64820) |  |
| Remove code for QT version \< 6.6 | Ikke rapportert | [PR \#64809](https://github.com/qgis/QGIS/pull/64809) |  |
...
| Avoid module wide QtConcurrent imports | Ikke rapportert | [PR \#64775](https://github.com/qgis/QGIS/pull/64775) |  |
| Avoid crash when edit-in-place layer is removed | Ikke rapportert | [PR \#65107](https://github.com/qgis/QGIS/pull/65107) | Topo |
...
| Some feature are not rendered in a 3d map view when using rule based renderer | [\#47581](https://github.com/qgis/QGIS/issues/47581) | Allerede fikset |  |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| qgs3daxis: Fix axis label visibility in qt6 | Ikke rapportert | [PR \#63585](https://github.com/qgis/QGIS/pull/63585) |  |
| qgs3daxis: Fix cube picking in qt6 when clicking on a label | Ikke rapportert | [PR \#63585](https://github.com/qgis/QGIS/pull/63585) |  |
| \[3D\] fix terrain obj export | Ikke rapportert | [PR \#63173](https://github.com/qgis/QGIS/pull/63173) |  |
...
| Fix handling of tiled scene and vector tile layers in Processing | Ikke rapportert | [PR \#63323](https://github.com/qgis/QGIS/pull/63323) | [PR \#63343](https://github.com/qgis/QGIS/pull/63343) |
...
| Fix crash and wrong coordinate order in the WCS source widget | Ikke rapportert | [PR \#63615](https://github.com/qgis/QGIS/pull/63615) | [PR \#63632](https://github.com/qgis/QGIS/pull/63632) |
| Fix several issues with geometry check algorithms | Ikke rapportert | [PR \#63304](https://github.com/qgis/QGIS/pull/63304) |  |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.40 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix nothing happens when zooming to very small line feature extent | Ikke rapportert | [PR \#65215](https://github.com/qgis/QGIS/pull/65215) | [PR \#65274](https://github.com/qgis/QGIS/pull/65274) |
| Don't immediately validate child algorithms in models | Ikke rapportert | [PR \#65183](https://github.com/qgis/QGIS/pull/65183) | N/A |
| \[browser\] Don't permit renaming tables which are open in the current project | Ikke rapportert | [PR \#65182](https://github.com/qgis/QGIS/pull/65182) | N/A |
| Extend timeout for processing executable tests | Ikke rapportert | [PR \#65161](https://github.com/qgis/QGIS/pull/65161) | [PR \#65224](https://github.com/qgis/QGIS/pull/65224) |
| Downgrade thread safety check to non-fatal | Ikke rapportert | [PR \#65148](https://github.com/qgis/QGIS/pull/65148) | N/A |
...
| \[server\] Fix completely broken service url setting handling | Ikke rapportert | [PR \#65117](https://github.com/qgis/QGIS/pull/65117) | [PR \#65226](https://github.com/qgis/QGIS/pull/65226) |
| Fix broken value range when calling deprecated setComponentValue int variant | Ikke rapportert | [PR \#65115](https://github.com/qgis/QGIS/pull/65115) | [PR \#65135](https://github.com/qgis/QGIS/pull/65135) |
| \[wms\] Fix regression in encode/decodeUri | Ikke rapportert | [PR \#65114](https://github.com/qgis/QGIS/pull/65114) | N/A |
| Fix a bunch of python tests weren't actually run on CI | Ikke rapportert | [PR \#65113](https://github.com/qgis/QGIS/pull/65113) |  |
| Fix assert triggered on qt6 builds | Ikke rapportert | [PR \#65079](https://github.com/qgis/QGIS/pull/65079) | N/A |
| \[gdal\] Fix openfilegdb raster path decoding/encoding | Ikke rapportert | [PR \#65078](https://github.com/qgis/QGIS/pull/65078) | [PR \#65096](https://github.com/qgis/QGIS/pull/65096) |
| Fix mdb files not shown in browser for non-windows platforms | Ikke rapportert | [PR \#65077](https://github.com/qgis/QGIS/pull/65077) | [PR \#65098](https://github.com/qgis/QGIS/pull/65098) |
| Fix failing dock widget test on newer Qt versions | Ikke rapportert | [PR \#65073](https://github.com/qgis/QGIS/pull/65073) | N/A |
| \[browser\] Prevent deletion or rename of fields when table is open in project | Ikke rapportert | [PR \#64958](https://github.com/qgis/QGIS/pull/64958) | Not suitable |
| Fix strict curved label anchoring when placement is on line | Ikke rapportert | [PR \#64736](https://github.com/qgis/QGIS/pull/64736) | [PR \#64801](https://github.com/qgis/QGIS/pull/64801) |
...
| Ensure QString and Qt::StringLiterals namespace are present when needed | Ikke rapportert | [PR \#64724](https://github.com/qgis/QGIS/pull/64724) | N/A |
