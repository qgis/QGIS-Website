...
| test_provider_ogr.py: do not alter source test data, to keep 'git status' clean | Ikke rapportert | [PR #58734](https://github.com/qgis/QGIS/pull/58734) | N/A |
...
| [BUGFIX] [PostgreSQL] Properly take into account 'name' type | Ikke rapportert | [PR #59147](https://github.com/qgis/QGIS/pull/59147) | TODO |
...
| [Layout] Missing atlas layer attributes in expression "Fields and Values" group for fixed table item | [#58774](https://github.com/qgis/QGIS/issues/58774) | [PR #58778](https://github.com/qgis/QGIS/pull/58778) | Nei |
| Clearing the default value expression cannot be canceled / undone | [#58767](https://github.com/qgis/QGIS/issues/58767) | [PR #58787](https://github.com/qgis/QGIS/pull/58787) | Nei |
...
| QGIS Server: fixed width of 200 px of cascaded WMS layer legends | [#57422](https://github.com/qgis/QGIS/issues/57422) | [PR #58790](https://github.com/qgis/QGIS/pull/58790) | Nei |
| Random Points in Polygons behaves unexpectedly | [#58737](https://github.com/qgis/QGIS/issues/58737) | [PR #58815](https://github.com/qgis/QGIS/pull/58815) | Nei |
...
| pyqt5_to_pyqt6.py fails on infinite recursion | [#58659](https://github.com/qgis/QGIS/issues/58659) | [PR #58785](https://github.com/qgis/QGIS/pull/58785) | Nei |
...
| Calling several times waitForFinished on task would cause a deadlock | Ikke rapportert | [PR #58799](https://github.com/qgis/QGIS/pull/58799) | Nei |
...
| Fix unsafe use of QgsProject::instance from vector layer classes | Ikke rapportert | [PR #59118](https://github.com/qgis/QGIS/pull/59118) | Too risky |
| When excluding tests, only exclude exact matches | Ikke rapportert | [PR #59116](https://github.com/qgis/QGIS/pull/59116) | N/A |
| When layout scalebar settings are invalid, show warning message | Ikke rapportert | [PR #59088](https://github.com/qgis/QGIS/pull/59088) | N/A |
...
| QgsMapLayer::setDataSource don't require layer name, provider | Ikke rapportert | [PR #58953](https://github.com/qgis/QGIS/pull/58953) | N/A |
| Fix incompatibility between text wrapping and HTML text formatting | Ikke rapportert | [PR #58952](https://github.com/qgis/QGIS/pull/58952) | N/A |
...
| Fix missing canvas variables in some expression editors | Ikke rapportert | [PR #58907](https://github.com/qgis/QGIS/pull/58907) | [PR #58934](https://github.com/qgis/QGIS/pull/58934) |
...
| QgsDistanceArea methods should raise QgsCsException when errors occur | Ikke rapportert | [PR #58795](https://github.com/qgis/QGIS/pull/58795) | N/A |
| Don't apply reset-to-zero step size logic in spin boxes when no special value text is set | Ikke rapportert | [PR #58836](https://github.com/qgis/QGIS/pull/58836) | N/A |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix use of QgsReferencedGeometry in expressions | Ikke rapportert | [PR #59180](https://github.com/qgis/QGIS/pull/59180) |  |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.34 backport commit (GitHub) |
| --- | --- | --- | --- |
| Clipping of long WKT strings for geometry parameters by using our geometry widget | Ikke rapportert | [PR #59209](https://github.com/qgis/QGIS/pull/59209) | N/A |
...
| Bad styling of scrollbars in the plugin manager dialog | Ikke rapportert | [PR #58713](https://github.com/qgis/QGIS/pull/58713) | [PR #58721](https://github.com/qgis/QGIS/pull/58721) |
...
| Bad plugin manager's look on dark themes | Ikke rapportert | [PR #58606](https://github.com/qgis/QGIS/pull/58606) |  |
...
| Fix layout map item preview rendering of XYZ layers with known tile DPI | Ikke rapportert | [PR #58543](https://github.com/qgis/QGIS/pull/58543) | [PR #58566](https://github.com/qgis/QGIS/pull/58566) |
...
| Fix issue with vertical lines not visible in the elevation profile tool | ikke rapportert | [PR #58959](https://github.com/qgis/QGIS/pull/58959) | N/A |
