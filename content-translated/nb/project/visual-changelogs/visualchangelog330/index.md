...
- Tittel i resulterende Leaflet-HTML-fil
- Navngivelse i resulterende Leaflet-HTML-fil
- Ta med OpenStreetMap-grunnkartet i resulterende Leaflet-HTML-fil
...
| Weird interval QgsDoubleSpinbox behavior in graduated symbology with fixed interval | [#51687](https://github.com/qgis/QGIS/issues/51687) | [PR #51714](https://github.com/qgis/QGIS/pull/51714) | Nei |
...
| wms getLegendGraphic call the group and not the layer when many style layers add from browser | [#51759](https://github.com/qgis/QGIS/issues/51759) | [PR #51765](https://github.com/qgis/QGIS/pull/51765) | Nei |
...
| Feil | URL til feilrapport (hvis rapportert) | URL til innsjekk (Github) | 3.28 backport commit (GitHub) |
| --- | --- | --- | --- |
| Fix using interpolated line symbol layer for polygon outlines | Ikke rapportert | [PR #52030](https://github.com/qgis/QGIS/pull/52030) | [PR #52032](https://github.com/qgis/QGIS/pull/52032) |
...
| Immediately apply color ramp label precision and suffix changes when auto apply is checked | Ikke rapportert | [PR #51989](https://github.com/qgis/QGIS/pull/51989) | Not appropriate |
...
| Don\'t try to download whole COG locally in order to determine open options | Ikke rapportert | [PR #51982](https://github.com/qgis/QGIS/pull/51982) | Not appropriate |
...
| Fix inefficient vector iteration when no rule based rules match current map scale | Ikke rapportert | [PR #51904](https://github.com/qgis/QGIS/pull/51904) | Not appropriate |
| Fix logic for triggering a full model reset in attribute table after changing attributes | Ikke rapportert | [PR #51890](https://github.com/qgis/QGIS/pull/51890) | [PR #51892](https://github.com/qgis/QGIS/pull/51892) |
...
| Show an icon for geometry fields | Ikke rapportert | [PR #51844](https://github.com/qgis/QGIS/pull/51844) | Not appropriate |
| Fix geometry fields incorrectly show as \"range\" types in fields list | Ikke rapportert | [PR #51842](https://github.com/qgis/QGIS/pull/51842) | [PR #51860](https://github.com/qgis/QGIS/pull/51860) |
...
| Re-permit format_number to omit group separators | Ikke rapportert | [PR #51761](https://github.com/qgis/QGIS/pull/51761) | [PR #51763](https://github.com/qgis/QGIS/pull/51763) |
| Remember the collapsed state of the vector layer renderer group box | Ikke rapportert | [PR #51719](https://github.com/qgis/QGIS/pull/51719) | Not appropriate |
...
| Fix crash when showing tooltips for invalid layers | Ikke rapportert | [PR #51703](https://github.com/qgis/QGIS/pull/51703) | [PR #51708](https://github.com/qgis/QGIS/pull/51708) |
| Fix map tips do not show for vector layers where the HTML map tip option isn\'t used | Ikke rapportert | [PR #51702](https://github.com/qgis/QGIS/pull/51702) | Unaffected |
...
| \[georeferencer\] Fix warning about missing output file name doesn\'t show in all circumstances | Ikke rapportert | [PR #51673](https://github.com/qgis/QGIS/pull/51673) | [PR #51739](https://github.com/qgis/QGIS/pull/51739) |
...
| Attribute table form view looses index when the \"yellow\" selection is changed | ikke rapportert | [PR #52045](https://github.com/qgis/QGIS/pull/52045) |  |
| Features in Relation Editor are not selectable anymore | ikke rapportert | [PR #51914](https://github.com/qgis/QGIS/pull/51914) | Unaffected |
