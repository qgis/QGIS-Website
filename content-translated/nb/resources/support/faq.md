...
### Hvordan bør jeg stille spørsmål om QGIS?
...
- la e-posten din ha et beskrivende emne
- hvilken QGIS-versjon du bruker (eksakt versjonsnummer)
- hva slags svar du forventer
- hvis relevant: hva du har forsøkt, og resultatet du fikk
- hvis spørsmålet gjelder noe som er feil så kan du opplyse om:
  - beskriv feilen så godt som mulig (gi f.eks. et skjermbilde, kopier inn feilmeldinga eller tilbakesporingsloggen («stack trace»)
  - hvilket operativsystem du bruker, og versjonsnummeret
  - hvordan du installerte QGIS (osgeo4w? frittstående installasjonsprogram? kompilerte selv?)
  - når oppstod feilen (ominstallasjon, ny installasjon, systemoppdatering, prosjektendringer)
...
{{<rich-box-end >}}
### Hvordan velges QGIS' utgivelsesnavn?
...
```
### Jeg laget et kart med QGIS; må jeg nevne QGIS?
...
{{<rich-content-start themeClass="coloring-1" >}}
##### Note
Ikke skriv «©QGIS» – QGIS har ikke opphavsretten til dine verk.
