...
{{<content-start >}}
# Brukergrupper
## Gjeldende liste over QGIS-brukergrupper
...
## Formålet med brukergrupper
* Organisere brukermøter
...
* Samle inn casestudier av lokal QGIS-bruk
...
* Etablere interessegrupper, f.eks. oppmåling, urban planlegging, nettjenester, og så videre.
* Starte opp eller koordinere programmoduler slik som oppmåling, urban planlegging, nettjenester og så videre.
* Electing a representative to act as a [QGIS Voting Member]({{< ref "/community/organisation#voting-members" >}})

## Generelle antakelser og anbefalinger
...
* informer det internasjonale prosjektet fra tid til annen om de lokale aktivitetene
...
Her er for eksempel vedtektene til den sveitsiske QGIS-brukergruppen:
