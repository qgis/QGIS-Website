...
1. Vytvorenie náhodnej rastrovej vrstvy (binomické rozdelenie)
2. Vytvorenie náhodnej rastrovej vrstvy (exponenciálne rozdelenie)
3. Vytvorenie náhodnej rastrovej vrstvy (gama rozdelenie)
4. Vytvorenie náhodnej rastrovej vrstvy (negatívne binomické rozdelenie)
5. Vytvorenie náhodnej rastrovej vrstvy (normálne rozdelenie)
6. Vytvorenie náhodnej rastrovej vrstvy (poissonovo rozdelenie)
7. Vytvorenie náhodnej rastrovej vrstvy (rovnomerné rozdelenie)
