...
Tento algoritmus zamieňa hodnoty súradníc X a Y vo vstupných geometriách. Môže sa použiť na opravu geometrických útvarov, ktorých hodnoty zemepisnej šírky a dĺžky boli omylom obrátené.
