...
QGIS è sviluppato da un team di volontari, società e organizzazioni.
...
{{<rich-content-start themeClass="coloring-1" >}}
## Bank transfer
Utilizza i dati sottostanti per effettuare una donazione tramite bonifico bancario internazionale:
...
È anche possibile usare il proprio account Paypal per effettuare una donazione.
