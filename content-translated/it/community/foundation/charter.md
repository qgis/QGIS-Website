---
description: QGIS.ORG è l'associazione mondiale degli utenti e degli sviluppatori
  di QGIS. QGIS.ORG è costituita come associazione svizzera (Verein im Sinne des Schweizerischen
  Zivilgesetzbuches (Art. 60-79 ZGB)).
draft: false
layout: single
sidebar: true
title: Statuto di QGIS.org
type: page
