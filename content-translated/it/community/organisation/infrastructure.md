...
{{<content-start >}}
# Infrastruttura
Questa pagina mostra l'intera infrastruttura e i servizi che usa QGIS, inclusi i contatti attuali e i responsabili.
...
**Main contact:** Gary
## Server principale
{{<rich-list listLink="http://documentation.qgis.org" layoutClass="half" listTitle="Server principale" listSubtitle="http://documentation.qgis.org" >}}
...
-
{{<rich-list listLink="http://docs.qgis.org" layoutClass="half" listTitle="Documentazione" listSubtitle="http://docs.qgis.org" >}}

{{<rich-list listLink="http://new.qgis.org" layoutClass="half" listTitle="Sito internet" listSubtitle="http://new.qgis.org" >}}
