...
section: progetto
sidebar: true
title: Elenco cambiamenti per QGIS 3.20
type: visual-changelog

---
{{<content-start >}}
# Elenco cambiamenti per QGIS 3.20{#changelog320 }
![image1](images/projects/712c5f48a25ce79a413e9cc34336e05100b7f0c1.png)

Data di rilascio: 2021-06-18
...
Questa funzionalità è stata sviluppata da [Raymond Nijssen](https://github.com/raymondnijssen)
...
Questa funzionalità è stata finanziata da Ville d\'Yverdon-les-Bains
...
Questa funzionalità è stata finanziata da Natural resources Canada Contract: 3000720707
...
Questa funzionalità è stata finanziata da QGIS Denmark user-group
...
Questa funzionalità è stata finanziata da Stadt Zürich
...
Questa funzionalità è stata finanziata da SLYR
...
Questa funzionalità è stata finanziata da [Hobu](https://hobu.co/)

Questa funzionalità è stata sviluppata da [Belgacem Nedjima (Lutra Consulting)](https://www.lutraconsulting.co.uk/)
## Layout di stampe
...
Questa funzionalità è stata finanziata da Kanton Zug - Amt für Raum und Verkehr (ARV)
...
Questa funzionalità è stata finanziata da Canton of Luzern
...
Questa funzionalità è stata finanziata da Alta Ehf
...
Questa funzionalità è stata finanziata da North Road / SLYR
...
Questa funzionalità è stata sviluppata da [Marco Bernasocchi (OPENGIS.ch)](https://www.opengis.ch)
...
Questa funzionalità è stata finanziata da [Canton of Solothurn](https://so.ch/verwaltung/bau-und-justizdepartement/amt-fuer-geoinformation/geoportal/)

Questa funzionalità è stata sviluppata da [Damiano Lombardi](http://damiano@opengis.ch)
## Legenda Layer
...
Questa funzionalità è stata finanziata da Canton of Glarus
...
Questa funzionalità è stata sviluppata da [talledodiego](https://github.com/talledodiego)
...
Questa funzionalità è stata sviluppata da [Stefan Conrads](https://github.com/stefancon)
...
Questa funzionalità è stata finanziata da Natural resources Canada Contract: 3000720411
...
Questa funzionalità è stata sviluppata da [Stéphane Brunner](https://github.com/sbrunner)
## Notable Fixes
### Feature: Bug fixes by Even Rouault
| Bug Title | URL (if reported, Github) | URL Commit (Github) | 3.16 backport commit (GitHub) |
| --- | --- | --- | --- |
| compiler warning in QgsMeshDatasetGroupStore::readXml() | unreported | [PR #43304](https://github.com/qgis/QGIS/pull/43304) | N/D |
...
Questa funzionalità è stata sviluppata da [Even Rouault](https://www.spatialys.com/en/home/)
...
| \"show label\" is disabled in widget designer but label keeps displaying in attribute form if you use tabs in the Drag and-Drop Designer and the field widget was placed in any tab | [#43103](https://github.com/qgis/QGIS/issues/43103) | [PR #43435](https://github.com/qgis/QGIS/pull/43435) | Da fare |
...
| Pyqgis 3.18.3 error when adding wms layer | [#43580](https://github.com/qgis/QGIS/issues/43580) | [PR #43581](https://github.com/qgis/QGIS/pull/43581) | Da fare |
| \"Reuse last entered attribute values\" slows creation of new features on large vector | [#42909](https://github.com/qgis/QGIS/issues/42909) | [PR #43584](https://github.com/qgis/QGIS/pull/43584) | Da fare |
...
| Impossibile salvare dati ausiliari | [#26365](https://github.com/qgis/QGIS/issues/26365) | [PR #43560](https://github.com/qgis/QGIS/pull/43560) | Risky |
...
Questa funzionalità è stata sviluppata da [Paul Blottiere](https://www.qcooperative.net/)
...
| Filter expression from relation reference widget on attributes form, not working properly | [#42803](https://github.com/qgis/QGIS/issues/42803) | [PR #43523](https://github.com/qgis/QGIS/pull/43523) | sì |
