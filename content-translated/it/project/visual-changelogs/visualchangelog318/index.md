...
section: progetto
sidebar: true
title: Elenco cambiamenti per QGIS 3.18
type: visual-changelog

---
{{<content-start >}}
# Elenco cambiamenti per QGIS 3.18{#changelog318 }
![image1](images/projects/606afcefcc3f5fd4ff00db9b4cb04b22485044db.png)

Data di rilascio: 2021-02-19
...
{{<table-of-contents >}}
## Interfaccia Utente
### Funzionalità: Nascondi attributi derivati da informazioni risultati
...
Questa funzionalità è stata sviluppata da [Richard Duivenvoorde](https://api.github.com/users/rduivenvoorde)
...
### Funzionalità: GUI per SVG dinamici
...
Questa funzionalità è stata sviluppata da [Patrice Pineault](https://api.github.com/users/TurboGraphxBeige)
...
Questa funzionalità è stata sviluppata da [Will Cohen](https://api.github.com/users/willcohen)
...
Questa funzionalità è stata sviluppata da [Lutra Consulting (Vincent Cloarec)](https://www.lutraconsulting.co.uk/projects/mdal/)
...
Questa funzionalità è stata finanziata da [QGIS grant 2020](https://qgis.org/)

Questa funzionalità è stata sviluppata da [Lutra Consulting (Peter Petrik)](https://www.lutraconsulting.co.uk/)
## Funzionalità 3D
...
Questa funzionalità è stata sviluppata da [Lutra Consulting (Nedjima Belgacem)](https://www.lutraconsulting.co.uk)
...
Questa funzionalità è stata finanziata da [Kristianstad](https://www.kristianstad.se)
...
Questa funzionalità è stata finanziata da [Point Cloud data support in QGIS](https://www.lutraconsulting.co.uk/blog/2021/02/18/qgis-3-18-point-cloud/)
...
Questa funzionalità è stata finanziata da [Point Cloud data support in QGIS crowd funding campaign](https://www.lutraconsulting.co.uk/blog/2021/02/18/qgis-3-18-point-cloud/)
...
Questa funzionalità è stata finanziata da [Point Cloud data support in QGIS crowd funding campaign](https://www.lutraconsulting.co.uk)
...
Questa funzionalità è stata finanziata da [Hans van der Kwast](https://www.youtube.com/c/HansvanderKwast)
...
Questa funzionalità è stata sviluppata da [Lutra Consulting (Viktor Sklencar)](https://www.lutraconsulting.co.uk)
## Analysis Tools
...
Questa funzionalità è stata sviluppata da [Pelle Rosenbeck Gøeg](https://api.github.com/users/pellegoeg)
...
Questa funzionalità è stata finanziata da **ARPA Piemonte**
...
Questa funzionalità è stata finanziata da [SRK Consulting](https://www.srk.com)
...
Questa funzionalità è stata sviluppata da [mazano](https://api.github.com/users/NyakudyaA)
...
Questa funzionalità è stata finanziata da [ms.GIS](http://msgis.com/)
...
Questa funzionalità è stata sviluppata da [Maxim Rylov](https://api.github.com/users/mrylov)
...
Questa funzionalità è stata finanziata da Metropole de Lille
...
Questa funzionalità è stata sviluppata da [Salvatore Larosa](https://api.github.com/users/slarosa)
...
| QGIS crashes when cancelling add child form | [#41295](https://github.com/qgis/QGIS/issues/41295) | [PR #41375](https://github.com/qgis/QGIS/pull/41375) | N/D |
...
| QgsCompoundColorWidget instance crash when QgsApplication::colorSchemeRegistry() is empty \\ | [#28208](https://github.com/qgis/QGIS/issues/28208) | non valido |  |
...
| Imported GeoTIFF not using data extent to select CRS - NAD83 vs NAD83(CSRS) | [#41456](https://github.com/qgis/QGIS/issues/41456) | non valido |  |
| Georeferencer: fix crash on .points files generated by older QGIS versions | not reported | [PR #41480](https://github.com/qgis/QGIS/pull/41480) | N/D |
...
Questa funzionalità è stata sviluppata da [Julien Cabieces](https://oslandia.com/en/)
...
| Fix add/remove buttons have no icons in create relationship dialogs | not reported | [Commit 2e81dbc](https://github.com/qgis/QGIS/commit/2e81dbcc50e510afc9033be9a99bfcb2512f6fd9) | N/D |
...
| When labelling job takes a long time to render, don\'t clear the map canvas between the finished layer render state and final state | not reported | [Commit 1beb1bd](https://github.com/qgis/QGIS/commit/1beb1bdc788ba64f826c54d3ab587fcc5289afb4) | N/D |
...
| Fix crash when no layers exist in project | not reported | [Commit 039bc20](https://github.com/qgis/QGIS/commit/039bc202733d57e5daaa13d417eb78b2c072851d) | N/D |
...
| Don\'t show duplicate \"source\"/\"path\" rows for local files | not reported | [Commit 8aa9c6a](https://github.com/qgis/QGIS/commit/8aa9c6a142523aed85ce74d70b93c04553e13dc0) | N/D |
