...
section: progetto
sidebar: true
title: Elenco cambiamenti per QGIS 3.6
type: visual-changelog

---
{{<content-start >}}
# Elenco cambiamenti per QGIS 3.6{#changelog36 }
![image1](images/projects/f335c2ee37b714ad6eec143246d947f09a5ff2f1.png)

Data di rilascio: 2019-02-22
...
### Aggiungi un nuovo vertice senza muoverlo
...
Questa funzionalità è stata finanziata da [German QGIS user group](http://qgis.de/)
...
Nel caso di un taglio, dovete selezionare la parte che sarà accorciata cliccando su di essa.

Questa funzionalità è stata finanziata da [Mairie de Megève](https://www.megeve.fr/)

Questa funzionalità è stata sviluppata da [Loïc Bartoletti (Oslandia)](https://www.oslandia.com)
### Funzione: Rettangolo da 3 punti (proiettato)
...
Questa funzionalità è stata finanziata da Lutra Consulting
...
Questa funzionalità è stata sviluppata da Nyall Dawson, Mathieu Pellerin
...
Questa funzionalità è stata sviluppata da Alexis Roy-Lizotte
...
Questa funzionalità è stata finanziata da QGIS User Group Germany
...
Questa funzionalità è stata sviluppata da Matthias Kuhn
...
Questa funzionalità è stata finanziata da [SMEC/SJ](http://www.smec.com/en_au)
...
Questa funzionalità è stata finanziata da OSGeo UK, GeoServer PSC, Brad Hards

Questa funzionalità è stata sviluppata da [Luigi Pirelli and GeoSolutions](https://www.geo-solutions.it/)
## Digitalizzazione
...
Questa funzionalità è stata sviluppata da [Faneva Andriamiadantsoa](https://github.com/Fanevanjanahary)
...
Questa funzionalità è stata sviluppata da [Corentin Falcone (SIRS)](https://www.sirs-fr.com/sirs/fr/)
## Moduli e Widget
...
Questa funzionalità è stata sviluppata da konst
...
Questa funzionalità è stata finanziata da Alessandro Pasotti - ItOpen
...
Questa funzionalità è stata sviluppata da Nyall Dawson, Nathan Woodrow
...
Questa funzionalità è stata finanziata da [Solspec](http://solspec.io)
...
Questa funzionalità è stata finanziata da [Nyall Dawson (North Road)](https://north-road.com)
...
Questa funzionalità è stata finanziata da [Kanton Zug, Amt für Geoinformation](https://geo.zg.ch/)

Questa funzionalità è stata sviluppata da David Signer (OPENGIS.ch)
...
Questa funzionalità è stata sviluppata da Marco Hugentobler
...
Questa funzionalità è stata sviluppata da 3liz
...
Questa funzionalità è stata finanziata da [Veolia](https://www.veolia.com)

Questa funzionalità è stata sviluppata da [Paul Blottiere (Oslandia)](http://oslandia.com/)
## Plugin
...
Questa funzionalità è stata sviluppata da Nathan Woodrow
...
Questa funzionalità è stata finanziata da QGIS community
...
| --- | --- | --- | --- |
| QGIS Server: WFS issue using the EXP_FILTER parameter | [#20927](https://issues.qgis.org/issues/20927) | [PR #8924](https://github.com/qgis/QGIS/pull/8924) | Fatto |
...
| QGIS Server WFS DescribeFeatureType not following TYPENAME parameter | [#20198](https://issues.qgis.org/issues/20198) | [PR #8948](https://github.com/qgis/QGIS/pull/8948) | Fatto |
| QGIS Server 3.4 can\'t reset numeric field using WFS Update | [#20961](https://issues.qgis.org/issues/20961) | [PR #8958](https://github.com/qgis/QGIS/pull/8958) | Fatto |
| WFS provider shows numeric NULL fields with 0 instead of NULL | [#20961](https://issues.qgis.org/issues/20961) | [PR #8958](https://github.com/qgis/QGIS/pull/8958) | Fatto |
| OWS project title in project properties cannot be set to blank/empty | unreported | [PR #8958](https://github.com/qgis/QGIS/pull/8958) | Fatto |
| Form Value relation based on WFS layer | [#21077](https://issues.qgis.org/issues/21077) | [PR #8970](https://github.com/qgis/QGIS/pull/8970) | Fatto |
| Button positions in Database styles manager dialog | [#21068](https://issues.qgis.org/issues/21068) | [PR #8971](https://github.com/qgis/QGIS/pull/8971) | Fatto |
...
| Error opening network KML page: Range downloading not supported by this server! | [#21091](https://issues.qgis.org/issues/21091) | [PR #8985](https://github.com/qgis/QGIS/pull/8985) | Fatto |
| Can\'t add a virtual field or update a existing field of a WFS layer using the field calculator | [#21086](https://issues.qgis.org/issues/21086) | [PR #8990](https://github.com/qgis/QGIS/pull/8990) | Fatto |
...
| Delimitedtext layer saves absolute path when project in relative path mode | [#21150](https://issues.qgis.org/issues/21150) | [PR #9099](https://github.com/qgis/QGIS/pull/9099) | Fatto |
| field calculator doesn\'t load values for gpkg containing blank spaces or n dash (hypen) in field names | [#21100](https://issues.qgis.org/issues/21100) | [PR #9071](https://github.com/qgis/QGIS/pull/9071) | Fatto |
...
| Layer Properties \> Load Style \> From database \> \'Other styles \...\' \> Description column contains Name text, should contain Description text (it is a geopackage layer) | [#21254](https://issues.qgis.org/issues/21254) | [PR #9170](https://github.com/qgis/QGIS/pull/9170) | Fatto |
| Comments in SQL query in DB Manager breaks the query | [#21271](https://issues.qgis.org/issues/21271) | [PR #9180](https://github.com/qgis/QGIS/pull/9180) | N/D |
| Bug with multiple Else items in rule-based style | [#21281](https://issues.qgis.org/issues/21281) | [PR #9181](https://github.com/qgis/QGIS/pull/9181) | Fatto |
| GetFeatureInfo not send Geometry when set into project | [#21172](https://issues.qgis.org/issues/21172) | Cannot reproduce with 3.5 | N/D |
| Geometry Checker Crashes | [#21259](https://issues.qgis.org/issues/21259) | [PR #9191](https://github.com/qgis/QGIS/pull/9191) | Fatto |
| QGIS crashes when createInstance() uses wrong constructor in a QgsProcessingAlgorithm subclass | [#21270](https://issues.qgis.org/issues/21270) | [PR #9193](https://github.com/qgis/QGIS/pull/9193) | Fatto |
...
| Attribute forms do not show anymore constraints messages | [#21266](https://issues.qgis.org/issues/21266) | Closed as invalid after several tests and some talks with Giovanni Manghi | N/D |
...
| Punti dentro poligoni | [#20798](https://issues.qgis.org/issues/20798) | Cannot reproduce with 3.5 |  |
...
Questa funzionalità è stata sviluppata da [Jürgen Fischer](https://www.norbit.de/)
...
| QGIS 3.5 not loading or saving multi-dimensional arrays properly from PostGIS layers | [#20872](https://issues.qgis.org/issues/20872) | [PR #9048](https://github.com/qgis/QGIS/pull/9048) | Da fare |
...
Questa funzionalità è stata finanziata da [QGIS user group Germany](https://www.qgis.de/)

Questa funzionalità è stata sviluppata da [Martin Dobias](https://www.lutraconsulting.co.uk/)
...
| Fix invalid data source message is always shown after dragging and dropping vector layers to QGIS window | N/D | [Direct commit](https://github.com/qgis/QGIS/commit/a1d8d9ae5d8ff5130e3ccd179617b1e9c0bf4062) | N/D |
...
| Avoid project being marked dirty as soon as its opened | N/D | [Direct commit](https://github.com/qgis/QGIS/commit/394e5d8d76480c1235c49e46d52f5f4a277cf824) | N/D |
...
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.4 backport commit (GitHub) |
| --- | --- | --- | --- |
| Qgis 3.4.1 crashes when accessing methods of feature | [#20752](https://issues.qgis.org/issues/20752) | chiuso |  |
...
| QGIS 3.4.1 advanced modification and snap block QGIS | [#20568](https://issues.qgis.org/issues/20568) | chiuso |  |
...
Questa funzionalità è stata sviluppata da [Hugo Mercier](https://oslandia.com/)
