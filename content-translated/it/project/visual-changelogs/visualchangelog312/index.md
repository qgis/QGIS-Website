...
section: progetto
sidebar: true
title: Elenco cambiamenti per QGIS 3.12
type: visual-changelog

---
{{<content-start >}}
# Elenco cambiamenti per QGIS 3.12{#changelog312 }
![image1](images/projects/dbf38cfe3b603e7e0b840336d39b399a1a46e52d.png)

Data di rilascio: 2020-02-21
...
Questa funzionalità è stata finanziata da [Kartoza](http://kartoza.com/)

Questa funzionalità è stata sviluppata da [Samweli Mwakisambwe](http://samweli.github.io/)
...
Questa funzionalità è stata finanziata da GEM foundation
...
Questa funzionalità è stata finanziata da [TUFLOW](http://www.tuflow.com)

Questa funzionalità è stata sviluppata da [Vincent Cloarec (Lutra Consulting)](http://www.lutraconsulting.co.uk)
...
Questa funzionalità è stata finanziata da [QGIS.CH and others through a cofunding campaign](https://oslandia.com/en/offre-qgis/selective-masking/)

Questa funzionalità è stata sviluppata da [Hugo Mercier (Oslandia)](https://www.oslandia.com)
...
- se i simboli vicini ai bordi dei poligoni devono essere ritagliati sul confine del poligono o no
- un numero casuale di simboli, per dare un posizionamento coerente dei simboli ogni volta che le mappe vengono aggiornate (permette anche il posizionamento casuale per funzionare bene con il server QGIS e la rappresentazione basata su mattonelle)

![image16](https://user-images.githubusercontent.com/1829991/66734145-51267480-eea5-11e9-9e0a-3bfeee15f976.png)

Questa funzionalità è stata finanziata da [SLYR](https://north-road.com/slyr/)
...
Questa funzionalità è stata finanziata da [Lutra Consulting](http://www.lutraconsulting.co.uk)
...
Questa funzionalità è stata finanziata da [Austrian Ministry of Agriculture, Forestry, Environment and Water Management](https://www.bmlfuw.gv.at)

Questa funzionalità è stata sviluppata da [Peter Petrik (Lutra Consulting)](http://www.lutraconsulting.co.uk)
...
Questa funzionalità è stata finanziata da QGIS.org grant.
...
Questa funzionalità è stata finanziata da [SwissTierras-Colombia](https://www.proadmintierra.info)
...
Questa funzionalità è stata finanziata da [Salvatore Fiandaca](https://pigrecoinfinito.com/2019/12/14/field-calc-di-qgis-save-expressions-crowdfunding/)
...
Questa funzionalità è stata sviluppata da Pete King
...
Questa funzionalità è stata sviluppata da Richard Duivenvoorde
...
Questa funzionalità è stata sviluppata da Raymond Nijssen, Nyall Dawson
...
Questa funzionalità è stata sviluppata da olivierdalang
...
Questa funzionalità è stata finanziata da [Amt für Wald und Wild Zug](https://www.zg.ch/behoerden/direktion-des-innern/wald-und-wild)
...
Questa funzionalità è stata finanziata da [Kanton Schaffhausen](https://sh.ch/CMS/Webseite/Kanton-Schaffhausen/Beh-rde/Verwaltung/Volkswirtschaftsdepartement/Amt-f-r-Geoinformation-1262910-DE.html)
...
Questa funzionalità è stata finanziata da [QWAT user group](http://qwat.org/about/)
...
Questa funzionalità è stata finanziata da QGIS.org bugfixing

Questa funzionalità è stata sviluppata da [Denis Rouzaud, OPENGIS.ch](https://opengis.ch)
## Legenda Layer
...
Questa funzionalità è stata sviluppata da [Sandro Mani](https://api.github.com/users/manisandro)
## Analysis Tools
...
Questa funzionalità è stata finanziata da [BikePlan](https://www.bikeplan.ch/)
...
Questa funzionalità è stata finanziata da [Limerick City and County Council](https://www.limerick.ie/council)
...
Questa funzionalità è stata finanziata da Limerick City and County Council
...
Questa funzionalità è stata sviluppata da [Samweli Mwakisambwe](https://api.github.com/users/Samweli)
## Sorgenti Dati
...
Questa funzionalità è stata finanziata da Lille Metropole
...
Questa funzionalità è stata finanziata da Christmas Holidays Inc.
...
Questa funzionalità è stata finanziata da [Planet](https://planet.com)
...
Questa funzionalità è stata sviluppata da Éric Lemoine
## Programmabilità
...
Questa funzionalità è stata finanziata da QWAT/QGEP group
...
| Fields are shifted when importing a layer with an FID attribute into GeoPackage | [#32927](https://github.com/qgis/QGIS/issues/32927) | [PR #32934](https://github.com/qgis/QGIS/pull/32934) | N/D |
...
| Drop use of deprecated QgsCoordinateReferenceSystem constructor | [PR #34186](https://github.com/qgis/QGIS/pull/34186) | [Commit b4fa419](https://github.com/qgis/QGIS/commit/b4fa419f7654ea7d1bce666b99f0534c415d8634) | N/D |
| Only look for pointcloud in its installed extension schema | [#33509](https://github.com/qgis/QGIS/issues/33509) | [Commit 1f44b29](https://github.com/qgis/QGIS/commit/1f44b29933bff3b8806bba75b761dd47b6c349c8) | N/D |
...
Questa funzionalità è stata sviluppata da Sandro Santilli
...
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.10 backport commit (GitHub) |
| --- | --- | --- | --- |
| Snapping and vertex tool not working with some layers if snapping was enabled when loaded | [#33449](https://github.com/qgis/QGIS/issues/33449) | [PR #33757](https://github.com/qgis/QGIS/pull/33757) | N/D |
| Snapping not possible in new project with new layer | [#32969](https://github.com/qgis/QGIS/issues/32969) | Duplicato | - |
...
| \"view feature form\" opens the wrong feature/record | [#33880](https://github.com/qgis/QGIS/issues/33880) | [PR #34009](https://github.com/qgis/QGIS/pull/34009) | Da fare |
...
| Crash while using Oracle views with primary key defined as number without precision | [#31626](https://github.com/qgis/QGIS/issues/31626) | [PR #34312](https://github.com/qgis/QGIS/pull/34312) | Da fare |
| WCS client stopped working on a specific service from 2.18 to 3.x | [#33339](https://github.com/qgis/QGIS/issues/33339) | [PR #34300](https://github.com/qgis/QGIS/pull/34300) | Da fare |
| Crash in relation reference test | [#34779](https://github.com/qgis/QGIS/issues/34779) | [PR #34822](https://github.com/qgis/QGIS/pull/34822) | Da fare |
...
| Rubberband not working correctly with \"Shapes\" digtizing in rotated map window | [#33287](https://github.com/qgis/QGIS/issues/33287) | Duplicato |  |
