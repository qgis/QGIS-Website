...
section: progetto
sidebar: true
title: Elenco cambiamenti per QGIS 3.2
type: visual-changelog

---
{{<content-start >}}
# Elenco cambiamenti per QGIS 3.2{#changelog32 }
![image1](images/projects/8f04d904f903b8bff930e6c968fe46928e6cc012.png)

Data di rilascio: 2018-06-22
...
## Generale
### Funzionalità: Il nuovo formato file compresso di progetto  .qgz è ora il formato predefinito
...
Questa funzionalità è stata sviluppata da [OSLANDIA - Paul Blottiere](https://github.com/pblottiere)
### Funzionalità: Filtro per i valori di un campo nel Costruttore di interrogazioni
Quando si crea una nuova espressione-filtro nel Costruttore di interrogazioni, è ora possibile applicare un filtro nel pannello di anteprima dei valori dei campi.

![image30](images/entries/731d930d07ca6d35f6bff727ef94a6322fcf21d0.gif.400x300_q85_crop.webp)

Questa funzionalità è stata sviluppata da [Salvatore Larosa](https://github.com/slarosa)
### Funzionalità: Mappa a tutto schermo tramite Ctrl-Shift-Tab
...
## Strumenti mappa
### Funzionalità: Lo strumento Semplifica geometrie adesso può anche smussare le geometrie
...
### Funzionalità: lo strumento Informazioni elementi con opzioni supplementari
Con i nuovi miglioramenti, l'utente può ora usare strumenti simili a quelli per la Selezione per informazioni su elementi multipli

Questa funzionalità è stata finanziata da Leicestershire County Council ed East Hampshire District Council

Questa funzionalità è stata sviluppata da [Martin Dobias and Viktor Sklencar](https://www.lutraconsulting.co.uk)
### Funzionalità: Memorizzare anche lo stato espanso/racchiuso dei nodi nel Tema della mappa
Ciascun tema della mappa registrerà anche quali layer, gruppi ed elementi della legenda sono espansi, in modo che, quando un tema della mappa viene selezionato, lo stato espanso/racchiuso viene applicato nell'albero dei layer.
...
Una nuova vista della mappa può essere configurata con zoom alla selezione corrente. Potrebbe essere combinata con differenti temi della mappa come in questo esempio.

![image4](images/entries/17848d809ce5a999115619ace229b6f07dba272a.PNG.400x300_q85_crop.webp)

Questa funzionalità è stata finanziata da [Technology One](https://www.technologyonecorp.com/)

Questa funzionalità è stata sviluppata da [Nathan Woodrow](https://nathanw.net/)
### Funzionalità: Scelta del metodo per per lo strumento di semplificazione delle geometrie
...
Questa funzionalità è stata sviluppata da Klavs Pihlkjær
...
Questa funzionalità è stata sviluppata da Nathan Woodrow, Nyall Dawson
...
Questa funzionalità è stata sviluppata da [Matthias Kuhn, OPENGIS.ch](https://opengis.ch)
...
Questa funzionalità è stata finanziata da Arpa Piemonte (Dipartimento Tematico Geologia e Dissesto) within ERIKUS project

Questa funzionalità è stata sviluppata da [Nyall Dawson (North Road)](https://north-road.com) e [Faunalia](https://www.faunalia.eu)
## Moduli e Widget
...
Questa funzionalità è stata finanziata da [Grundbuch- und Vermessungsamt des Kanton Zug](https://www.zg.ch/behoerden/direktion-des-innern/grundbuch-und-vermessungsamt/gis-fachstelle)

Questa funzionalità è stata sviluppata da [David Signer, OPENGIS.ch](https://opengis.ch)
...
Questa funzionalità è stata finanziata da Grant Boxer, NaturalGIS, Tudor Bărăscu, NotioGIS, République et canton de Neuchâtel, Arpa Piemonte, Nelson Silva, QGIS Danish User Group, Bo Victor Thomsen and Lene Fischer, North River Geographic

Questa funzionalità è stata sviluppata da [Alessandro Pasotti (North Road)](https://north-road.com)
## Legenda Layer
...
Questa funzionalità è stata finanziata da [Kartoza/InaSAFE](http://kartoza.com/en/)
...
Questa funzionalità è stata sviluppata da [Mathieu Pellerin, Nyall Dawson](http://www.imhere-asia.com/)
...
Questa funzionalità è stata sviluppata da [Matteo Ghetta (Faunalia)](http://www.faunalia.eu/)
...
Questa funzionalità è stata sviluppata da [Martin Dobias, Peter Petrik (Lutra Consulting)](https://www.lutraconsulting.co.uk) e [Faunalia](https://www.faunalia.eu)
## Browser
...
Questa funzionalità è stata sviluppata da [Peter Petrik and Martin Dobias (Lutra Consulting)](https://www.lutraconsulting.co.uk)
...
Questa funzionalità è stata finanziata da [Open Spatial](http://www.openspatial.com)
