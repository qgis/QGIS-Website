...
Questa funzionalità è stata finanziata da [Aleix Pol](https://github.com/aleixpol)

Questa funzionalità è stata sviluppata da [Aleix Pol](https://github.com/aleixpol)
### Funzionalità: i file SVG possono essere incorporati nei progetti e nella simbologia
Permette di incorporare immagini SVG utilizzte per la simbologia, le etichette, etc., direttamente all'interno di un file di progetto (o in uno stile QML, o in un modello di stampa QPT!) codificando l'immagine svg come una stringa base64 standard.

I file incorporati possono inoltre essere estratti da progetti e simbologie e salvati su disco come file SVG.

Questa funzionalità è stata finanziata da [SMEC/SJ](http://smec.com)

Questa funzionalità è stata sviluppata da [Nyall Dawson](https://north-road.com)
### Funzionalità: accelerazione OpenCL
Questa funzionalità è stata finanziata da [QGIS.org](https://qgis.org)

Questa funzionalità è stata sviluppata da [Alessandro Pasotti](https://qgis.org)
## Espressioni
### Funzionalità: Nuove funzioni e variabili per le espressioni
Molte nuove funzioni sono state aggiunte per le espressioni in QGIS 3.4. Queste includono molte funzioni utili per manipolare e lavorare con gli array e gli oggetti delle mappe (dizionari).
...
Inoltre alcune nuove variabili sono state rese disponibili anche per l'uso con le espressioni di QGIS:
...
Questa funzionalità è stata sviluppata da [Etienne Trimaille, Matteo Ghetta, Matthias Kuhn, Mathieu Pellerin, Nyall Dawson](https://qgis.org)
...
Questa funzionalità è stata finanziata da Leicestershire County Council
...
Questa funzionalità è stata finanziata da [iMhere Asia](https://www.imhere-asia.com/)

Questa funzionalità è stata sviluppata da [Mathieu Pellerin](https://www.imhere-asia.com/)
...
Questa funzionalità è stata sviluppata da Mathieu Pellerin (iMHere Asia), Nyall Dawson (North Road)
...
Questa funzionalità è stata finanziata da [QGIS Project](https://qgis.org/)

Questa funzionalità è stata sviluppata da [David Signer and Matthias Kuhn (OPENGIS.ch)](https://www.opengis.ch)
## Simbologia
...
Questa funzionalità è stata sviluppata da [Peter Petrik (Lutra Consulting)](https://www.lutraconsulting.co.uk/blog/2018/10/18/mdal/)
### Feature: Classify symmetric in graduated renderer
Questa funzionalità è stata finanziata da <https://github.com/pierreloicq>

Questa funzionalità è stata sviluppata da <https://github.com/pierreloicq>
...
Questa funzionalità è stata finanziata da [qwat group](http://qwat.org/)

Questa funzionalità è stata sviluppata da [Denis Rouzaud (OPENGIS.ch GmbH)](https://www.opengis.ch)
## Digitalizzazione
...
Questa funzionalità è stata finanziata da [Andrea Rossi](https://github.com/rossia)

Questa funzionalità è stata sviluppata da [Andrea Rossi](https://github.com/rossia)
...
Questa funzionalità è stata finanziata da [lbartoletti](https://github.com/lbartoletti)

Questa funzionalità è stata sviluppata da [lbartoletti](https://github.com/lbartoletti)
...
Questa funzionalità è stata sviluppata da [Paul Blottiere (Oslandia)](https://oslandia.com/en/home-en/)
...
Questa funzionalità è stata finanziata da [Kanton Solothurn](https://www.so.ch/verwaltung/bau-und-justizdepartement/amt-fuer-geoinformation/)
...
Questa funzionalità è stata finanziata da [QGIS Usergroup Switzerland and QGEP Project](https://www.qgis.ch/en)
...
Questa funzionalità è stata finanziata da [Arpa Piemonte (Dipartimento Tematico Geologia e Dissesto) within ERIKUS project](https://www.arpa.piemonte.it/)

Questa funzionalità è stata sviluppata da [Martin Dobias (Lutra Consulting)](https://www.lutraconsulting.co.uk) e [Faunalia](https://www.faunalia.eu)
...
Questa funzionalità è stata finanziata da [Borys Jurgiel](https://github.com/borysiasty)

Questa funzionalità è stata sviluppata da [Borys Jurgiel](https://github.com/borysiasty)
## Moduli e Widget
...
Questa funzionalità è stata finanziata da [QGIS community through crowd-funding](https://north-road.com/drill-down-cascading-forms/)

Questa funzionalità è stata sviluppata da Alessandro Pasotti (with North Road)
...
Questa funzionalità è stata finanziata da [QGIS community through crowd-funding](https://www.lutraconsulting.co.uk/crowdfunding/more-qgis-3d/)
...
Questa funzionalità è stata finanziata da [Crowdfunding campaign](https://north-road.com/edit-features-in-place-using-qgis-spatial-operations-campaign/)
...
Questa funzionalità è stata finanziata da [Faunalia](https://www.faunalia.eu)

Questa funzionalità è stata sviluppata da [Matteo Ghetta (Faunalia)](https://www.faunalia.eu)
...
Questa funzionalità è stata finanziata da <https://qgis.org>

Questa funzionalità è stata sviluppata da [Detlev Neumann, Rudi von Staden](https://qgis.org)
...
Questa funzionalità è stata finanziata da [QGIS](https://qgis.org)
...
Questa funzionalità è stata finanziata da [InaSAFE DFAT](https://www.dfat.gov.au/)
...
Questa funzionalità è stata finanziata da [Monsanto Company](https://monsanto.com/)

Questa funzionalità è stata sviluppata da [Larry Shaffer, Alessandro Pasotti](https://qgis.org)
...
Questa funzionalità è stata finanziata da [Lutra Consulting](https://www.lutraconsulting.co.uk/blog/2018/10/18/mdal/)
...
Questa funzionalità è stata sviluppata da [3Liz](https://3liz.com)
...
Questa funzionalità è stata finanziata da <https://github.com/rldhont>

Questa funzionalità è stata sviluppata da <https://github.com/rldhont>
...
Questa funzionalità è stata sviluppata da [Eric Lemoine](https://github.com/elemoine)
## Plugin
...
Questa funzionalità è stata finanziata da [Oester Messtechnik](https://messtechnik.ch/)
...
Questa funzionalità è stata finanziata da Good will
...
Questa funzionalità è stata sviluppata da [Martian Dobias (Lutra Consulting)](https://www.lutraconsulting.co.uk/)
...
Questa funzionalità è stata finanziata da [Department of Environment, Land and Infrastructure Engineering (DIATI)](https://www.faunalia.eu/en/)
