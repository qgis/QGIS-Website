...
section: progetto
sidebar: true
title: Elenco cambiamenti per QGIS 3.8
type: visual-changelog

---
{{<content-start >}}
# Elenco cambiamenti per QGIS 3.8{#changelog38 }
![image1](images/projects/403e44c7e958cff5d07a1eaf12af76ade88c564d.png)

Data di rilascio: 2019-06-21
...
Questa funzionalità è stata finanziata da [Oslandia](https://oslandia.com)

Questa funzionalità è stata sviluppata da [Loïc Bartoletti (Oslandia)](https://oslandia.com)
## Interfaccia Utente
### Funzionalità: Pulsamte Salva su Modello
...
Questa funzionalità è stata sviluppata da [Matthias Kuhn (OPENGIS.ch)](http://www.opengis.ch/)
...
Questa funzionalità è stata sviluppata da [Mathieu Pellerin](http://imhere-asia.com/)
...
Questa funzionalità è stata sviluppata da henrik
...
Questa funzionalità è stata finanziata da anonimi
...
Questa funzionalità è stata sviluppata da [Martin Dobias (Lutra Consulting)](https://www.lutraconsulting.co.uk)
### Funzionalità: Esporta animazioni 3D
...
Questa funzionalità è stata finanziata da [Northumberland National Park Authority](https://www.northumberlandnationalpark.org.uk/)

Questa funzionalità è stata sviluppata da [Peter Petrik (Lutra Consulting)](https://www.lutraconsulting.co.uk)
...
Questa funzionalità è stata finanziata da [Crowdfunding: More QGIS 3D](https://www.lutraconsulting.co.uk/crowdfunding/more-qgis-3d/)
...
Questa funzionalità è stata sviluppata da Matteo Nastasi
...
Questa funzionalità è stata finanziata da [SMEC/SJ](https://www.smec.com/)
...
Questa funzionalità è stata sviluppata da Nyall Dawson di North Road:
...
Nuove funzioni di espressione sviluppate da Mathieu Pellerin di iMHere Asia:
...
Questa funzionalità è stata sviluppata da [Olivier Dalang and OPENGIS.ch](https://www.opengis.ch)
...
Questa funzionalità è stata sviluppata da [Olivier Dalang and OPENGIS.ch](https://www.opengis.ch)
### Novità: miglioramenti nell'editor dei vertici
Per questa versione abbiamo migliorato l'editor dei vertici in modo che ora si colleghino correttamente i vertici *selezionati nella canvas* con i *vertici per la modifica manuale delle coordinate nella tabella*.

![image22](images/entries/e518f5fc5b2decdbaba6272249cdfb3b6c2ad2fe.gif)

Questa funzionalità è stata finanziata da [QGIS User Group Switzerland](https://qgis.ch)

Questa funzionalità è stata sviluppata da [Denis Rouzaud, OPENGIS.ch](https://www.opengis.ch)
## Moduli e Widget
...
Grazie alla generosa sponsorizzazione di A.R.P.A Piemonte (una delle agenzie ambientali regionali italiane) abbiamo sviluppato un nuovo widget che permette l'accesso ai valori dell'elemento anche attraverso le espressioni in un modulo (form) html.

![image23](images/entries/3932162893e8bb8d20d284d7a99ead2de9dac601.gif)

Questa funzionalità è stata finanziata da [A.R.P.A. Piemonte](http://www.arpa.piemonte.it)
...
Questa funzionalità è stata finanziata da [regioDATA](https://www.regiodata-gmbh.de/)
...
Questo nuovo algoritmo Processing calcola l'area e la copertura percentuale con cui gli elementi di un livello di input sono sovrapposti agli elementi di una selezione di livelli sovrapposti. Nuovi attributi vengono aggiunti al livello di output riportando l'area totale di sovrapposizione e la percentuale degli elementi in entrata sovrapposti da ciascuno dei livelli di sovrapposizione selezionati.
...
Questa funzionalità è stata sviluppata da Raymond Nijssen
...
Questa funzionalità è stata sviluppata da [Nyall Dawson (North Road)](http://north-road.com)
### Funzionalità: Genera tasselli raster XYZ
...
Questa funzionalità è stata finanziata da Hansestadt Herford, SWK mbH, Datenbankgesellschaft mbH

Questa funzionalità è stata sviluppata da [Lutra Consulting](https://www.lutraconsulting.co.uk/)
...
Questa funzionalità è stata sviluppata da Rashad Kanavath
...
Questa funzionalità è stata finanziata da [QCooperative](https://www.qcooperative.net)
...
Questa funzionalità è stata finanziata da [ICSM](https://www.icsm.gov.au/)

Questa funzionalità è stata sviluppata da [Nyall Dawson (North Road)](http://north-road.com)
## Sorgenti Dati
### Feature: postgres provider: add support for generated identity columns
Questa funzionalità è stata sviluppata da jef-n
...
Questa funzionalità è stata sviluppata da Nyall Dawson (North Road) & Mathieu Pellerin (iMHere Asia)
...
Questa funzionalità è stata sviluppata da [Tamas Szekeres](https://github.com/szekerest)
...
Questa funzionalità è stata finanziata da VEOLIA
...
Questa funzionalità è stata sviluppata da Jürgen Fischer in collaborazione con Matthias Kuhn
## QGIS Server
...
Questa funzionalità è stata finanziata da [GISCE TI](https://gisce.net/)

Questa funzionalità è stata sviluppata da [Alessandro Pasotti](http://www.itopen.it/)
## Programmabilità
...
| QGIS server ignores custom rendering order when loading parent group | [#21917](https://issues.qgis.org/issues/21917) | [PR #9878](https://github.com/qgis/QGIS/pull/9878) | Fatto |
| WMS Client: GetFeatureInfo in JSON format doesn\'t display numeric attribute values | [#21735](https://issues.qgis.org/issues/21735) | [PR #9879](https://github.com/qgis/QGIS/pull/9879) | Fatto |
| Crash when adding New Field to ShapeLayer | [#22100](https://issues.qgis.org/issues/22100) |  |  |
| Priority in labelling not greyed out when data defined settings are enabled | [#22077](https://issues.qgis.org/issues/22077) | Non valido |  |
...
| Issue exporting raster layer to Geopackage | [#20848](https://issues.qgis.org/issues/20848) | [PR #10036](https://github.com/qgis/QGIS/pull/10036) | Fatto |
| Create vector New shapefile POLYGON | [#22107](https://issues.qgis.org/issues/22107) | non valido |  |
...
| Relation reference widget wrong feature when \"on map identification\" | [#22071](https://issues.qgis.org/issues/22071) | [PR #10047](https://github.com/qgis/QGIS/pull/10047) | Fatto |
| DB Manger imports the wrong data | [#22033](https://issues.qgis.org/issues/22033) | [PR #10077](https://github.com/qgis/QGIS/pull/10077) | Fatto |
| qgis crash when filtering a layer with an attachment field | [#21775](https://issues.qgis.org/issues/21775) | Fixed by Nyall |  |
| Raster calculator, abs() not working | [#29824](https://github.com/qgis/QGIS/issues/29824) | [PR #29965](https://github.com/qgis/QGIS/pull/29965) | Fatto |
| Valid file URL link fails in Identify window | [#29879](https://github.com/qgis/QGIS/issues/29879) | [PR #29967](https://github.com/qgis/QGIS/pull/29967) | Fatto |
| QgsProject.instance().clear() crashes QGIS when LayoutDesigner Window is open | [#29821](https://github.com/qgis/QGIS/issues/29821) | [PR #29968](https://github.com/qgis/QGIS/pull/29968) | Fatto |
| QGIS Server WFS DescribeFeatureType advertises double precision virtual fields as integer | [#29767](https://github.com/qgis/QGIS/issues/29767) | [PR #29970](https://github.com/qgis/QGIS/pull/29970) | Fatto |
| QGIS crahses when exporting a template | [#29798](https://github.com/qgis/QGIS/issues/29798) | [PR #29981](https://github.com/qgis/QGIS/pull/29981) | Fatto |
| Export atlas as image fail when expression filename contain dot | [#29980](https://github.com/qgis/QGIS/issues/29980) | [PR #29983](https://github.com/qgis/QGIS/pull/29983) | Fatto |
...
| Map Composer crashes QGIS when copying mixture of elements in page layout | [#29747](https://github.com/qgis/QGIS/issues/29747) | [PR #30017](https://github.com/qgis/QGIS/pull/30017) | Da fare |
...
| Browser - \"Project home\" folder shortcut does not appear when a new project is saved | [#29919](https://github.com/qgis/QGIS/issues/29919) | [PR #30025](https://github.com/qgis/QGIS/pull/30025) | Da fare |
| Crash when calling QgsRasterHistogram.histogramVector | [#29700](https://github.com/qgis/QGIS/issues/29700) | [PR #30033](https://github.com/qgis/QGIS/pull/30033) | Fatto |
| Do not offer to \"Import settings from Qgis2?\" if no such settings exist | [#30082](https://github.com/qgis/QGIS/issues/30082) | [PR #30092](https://github.com/qgis/QGIS/pull/30092) | Fatto |
| In gpkg, query builder prevents autogenerate of pasted feature with same fid as hidden feature | [#30062](https://github.com/qgis/QGIS/issues/30062) | [PR #30096](https://github.com/qgis/QGIS/pull/30096) | Da fare |
| Drag and drop geopackage from filesystem into map misses vector layers, loses names for raster layers | [#30050](https://github.com/qgis/QGIS/issues/30050) | [PR #30098](https://github.com/qgis/QGIS/pull/30098) | Fatto |
| Qgis crashes when try to identify a layer with duplicated fields | [#29937](https://github.com/qgis/QGIS/issues/29937) | [PR #30100](https://github.com/qgis/QGIS/pull/30100) | Da fare |
...
| Unable to add new features in QGIS for PostGIS table using sequence for gid. Data type serial: \'integer overflow\' | [#30041](https://github.com/qgis/QGIS/issues/30041) | [PR #30184](https://github.com/qgis/QGIS/pull/30184) | Fatto |

Questa funzionalità è stata finanziata da [QGIS.ORG donors and sponsors](https://www.qgis.org/)

Questa funzionalità è stata sviluppata da [Alessandro Pasotti](https://www.itopen.it/)
### Feature: Bug fixes by Alexander Bruy
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.4 backport commit (GitHub) |
| --- | --- | --- | --- |
| v.net.distance - node cost column | [#22013](https://issues.qgis.org/issues/22013) | [PR #10060](https://github.com/qgis/QGIS/pull/10060) | Fatto |
| shapefile to raster conversion does not work | [#21922](https://issues.qgis.org/issues/21922) |  |  |
| GRASS r.in.lidar.info, can only choose *.txt not the intended* .las | [#21910](https://issues.qgis.org/issues/21910) | [PR #10061](https://github.com/qgis/QGIS/pull/10061) | Fatto |
| SAGA OpenCV Image Analysis | [#21746](https://issues.qgis.org/issues/21746) |  |  |
| SAGA \"saga split rgb bands\" tool is not inside any (SAGA) group of tools | [#21849](https://issues.qgis.org/issues/21849) | [PR #10062](https://github.com/qgis/QGIS/pull/10062) | Fatto |
| r.sun cannot be executed because it calls on two incompatible options | [#21637](https://issues.qgis.org/issues/21637) | [PR #10074](https://github.com/qgis/QGIS/pull/10074) | Fatto |
...
| Majority filter (SAGA) returns erroneous results if input is .tif | [#22118](https://issues.qgis.org/issues/22118) | non valido |  |
| Processing batch process interface: no way to go back | [#16893](https://issues.qgis.org/issues/16893) | [PR #10080](https://github.com/qgis/QGIS/pull/10080) | Fatto |
...
| Word wrapping not working in maptips | [#21388](https://issues.qgis.org/issues/21388) | [PR #10081](https://github.com/qgis/QGIS/pull/10081) | Fatto |
| Styles stored in QML files with same name as layer no longer auto loaded | [#21691](https://issues.qgis.org/issues/21691) | [PR #14660](https://github.com/qgis/QGIS/pull/14660) | Fatto |
| QGIS 3.4.6 crashed when I tried classifying a layer | [#21693](https://issues.qgis.org/issues/21693) | [PR #29951](https://github.com/qgis/QGIS/pull/29951) | Fatto |
| Fixed table not working under User defined filter (SAGA) | [#29999](https://github.com/qgis/QGIS/issues/29999) | [PR #30001](https://github.com/qgis/QGIS/pull/30001) | Fatto |
...
Questa funzionalità è stata sviluppata da [Alexander Bruy](https://bruy.me/)
...
Questa funzionalità è stata sviluppata da Victor Olaya
...
| WFS GetFeature fails on TypeNames parameter | [#21768](https://issues.qgis.org/issues/21768) | [PR #29946](https://github.com/qgis/QGIS/pull/29946) | Fatto |
| Cannot load GPX file automatically after creating it QGIS 3.4.7 QGIS 3.6.2 | [#22005](https://issues.qgis.org/issues/22005) | [PR #29947](https://github.com/qgis/QGIS/pull/29947) | Fatto |
| Impossibile creare la cache temporanea SpatiaLite | [#29819](https://github.com/qgis/QGIS/issues/29819) | [PR #29949](https://github.com/qgis/QGIS/pull/29949) | Fatto |
| PostGIS closed circle in Curved Polygon is not displayed | [#29895](https://github.com/qgis/QGIS/issues/29895) | [PR #30010](https://github.com/qgis/QGIS/pull/30010) | Fatto |
...
| Multipatch features are not shown anymore | [#29376](https://github.com/qgis/QGIS/issues/29376) | [PR #30024](https://github.com/qgis/QGIS/pull/30024) | Fatto |
| Multiple issues and deadlocks with WFS | [#29258](https://github.com/qgis/QGIS/issues/29258) | [PR #30026](https://github.com/qgis/QGIS/pull/30026) | Fatto |
| WFS provider: Avoid dangling download progress dialog | [PR #30039](https://github.com/qgis/QGIS/pull/30039) | [PR #30039](https://github.com/qgis/QGIS/pull/30039) | Fatto |
...
| Bug Title | URL issues.qgis.org (if reported) | URL Commit (Github) | 3.4 backport commit (GitHub) |
| --- | --- | --- | --- |
| Editing a GeoPackage feature with spaces in the field names can crash QGIS | [#29630](https://github.com/qgis/QGIS/issues/29630) | [PR #29997](https://github.com/qgis/QGIS/pull/29997) | Da fare |
| Crash on update pg layer | [#29814](https://github.com/qgis/QGIS/issues/29814) | duplicate | N/D |
| XMDF file type missing from Madiera 3.4.5 | [#29381](https://github.com/qgis/QGIS/issues/29381) | non valido | N/D |
...
| Crash when editing fields | [#29200](https://github.com/qgis/QGIS/issues/29200) | unable to replicate | N/D |
| Closing Vertex Edititor crashes the app | [#30028](https://github.com/qgis/QGIS/issues/30028) | [PR #30030](https://github.com/qgis/QGIS/pull/30030) | Da fare |
...
Questa funzionalità è stata sviluppata da [Loïc Bartoletti](https://oslandia.com/en/)
