...
| [cleanup] Limit number of hardcoded strings for layer type by leveraging QgsMapLayerFactory::typeToString() | Nessuno | [PR #60360](https://github.com/qgis/QGIS/pull/60360) | N/D |
...
| Unable to perform zip or export to PDF/image | [#59911](https://github.com/qgis/QGIS/issues/59911) | Not a bug | N/D |
| QgisVectorLayerEditUtils addTopologicalPoints causes overlaps | [#58350](https://github.com/qgis/QGIS/issues/58350) | Not a bug | N/D |
| QGIS should never poll a PostGIS/WMS/WFS/etc connections unless specifically asked to | [#58303](https://github.com/qgis/QGIS/issues/58303) | Cannot reproduce | N/D |
...
| [Clang] Remove some deprecated warnings | Unreported | [PR #60428](https://github.com/qgis/QGIS/pull/60428) | N/D |
| Label mask in Geopackage | [#59245](https://github.com/qgis/QGIS/issues/59245) | Cannot reproduce | N/D |
...
| Fix incorrect compilation of "field IN (...) or field NOT IN (...)" | unreported | [PR #60630](https://github.com/qgis/QGIS/pull/60630) | N/D |
...
| [stac] Port more API to use unique_ptr | unreported | [PR #60627](https://github.com/qgis/QGIS/pull/60627) | N/D |
