...
title: 'Utilizzare un GIS gratuito alla Scuola Superiore Jaime Moniz: QGIS'
type: case-study

---
{{<content-start >}}
# Utilizzare un GIS gratuito alla Scuola Superiore Jaime Moniz: QGIS
...
## Dalla classe al il mondo dell'istruzione
...
## Conclusione
Nell'analisi di tutto l'intero progetto, ritengo che l'idea di usare QGIS, come strumento, per raggiungere alcuni scopi didattici, è stata una scelta eccellente. All'inizio, il suo uso ha coinvolto un sacco di aspettative. Non avevo mai usato prima un GIS, quindi, stavo imparando e insegnando allo stesso tempo. Il fatto che il GIS si è rivelato essere estremamente facile da usare, con le informazioni disponibili on-line, è stata una benedizione per me. Inoltre, la scuola non ha dovuto pagare per un'altra licenza software né era dipendente dal rinnovo delle licenze, che ha migliorato sensibilmente la qualità dell'insegnamento, senza ulteriori spese. Allo stato attuale, gli studenti utilizzano QGIS quasi da soli a realizzano i loro diversi piani di lavoro. Spero che il risultato finale mostri la quantità di sforzo usata in tutto il processo di apprendimento.
## Riferimenti
...
Questo articolo è stato scritto nel marzo 2011 dal Fátima Vale con il supporto di Luís Antunes (supervisore degli studenti nel DRIGOT). In quel momento, lei è insegnante nella Scuola Secondaria Moniz Jaime e insegnante supervisore durante il periodo di formazione degli studenti nelle diverse istituzioni.
