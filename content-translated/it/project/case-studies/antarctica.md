...
title: 'Quantarctica: un pacchetto GIS per l''Antartide'
type: case-study

---
{{<content-start >}}
# Quantarctica: un pacchetto GIS per l'Antartide
...
Quantarctica è stato utilizzato per esaminare i dati geografici su scala continentale e scala locale, per la visualizzazione dei dati sui progetti scientifici, con le mappe di base o con altri insiemi di dati scientifici, per preparare le mappe per le pubblicazioni scientifiche e proposte. Quantarctica ha finora dimostrato di essere un grande strumento, e una buona alternativa e integrazione con altri software utilizzati dai ricercatori. E ha fornito nuove opportunità per i nostri ricercatori nel loro lavoro quotidiano.
...
Da tre anni Quantarctica viene utilizzato dai nostri glaciologi, ci sono state molte richieste nella comunità di ricerca al di fuori dell'istituto per condividere questo prodotto, e abbiamo iniziato a sviluppare una versione pubblica e migliorata per sostituire la versione in-house. A seguito di test sul campo antartico, e l'aggiunta di nuovi insiemi di dati rilevanti, Quantarctica versione 1.0 è stata finalmente completata e reso disponibile per il download nel luglio 2013.
...
<figcaption>Anders Skoglund e Kenichi Matsuoka</figcaption>
</figure>
