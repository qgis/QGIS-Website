...
title: Utilizzo di QGIS per un corso di formazione sulla fauna selvatica in Tanzania
type: case-study

---
{{<content-start >}}
# Utilizzo di QGIS per un corso di formazione sulla fauna selvatica in Tanzania
...
## Introduzione
Nel sud della Tanzania, il progetto Elephant Udzungwa (UEP) sta utilizzando QGIS per la sua formazione nel campo della ricerca e della conservazione della fauna selvatica. Nel febbraio del 2012, ha tenuto un seminario di due giorni per il personale Ecologia e protezione (anti-bracconaggio) del Parco Nazionale dei Monti Udzungwa, insieme con i membri della Udzungwa Ecological Monitoring Centre.
## Informazioni sul corso
I tirocinanti utilizzano il proprio computer portatile e sono stati forniti con il programma di installazione di QGIS 1.7.3 con dati che coprono il Parco Nazionale: frontiere protette della zona, mappe topografiche digitalizzate, un DEM, strade, punti per i ranger, e tipi di habitat.
...
Il GIS ci ha offerto diverse attrattive: non solo è completamente libero, ma la sua natura open source lo rende responsivo allo sviluppo di particolari bisogni; QGIS gira meglio nei vecchi computer ed ha un unstaller relativamente piccolo; ed in generale abbiamo trovato che è amichevole per l'utente per i nuovi arrivati del GIS.
...
Uno speciale ringraziamento al fondo US Fish and Wildlife Service African Elephant Fund per il supporto fornito a questo training.
## Collegamenti
