...
title: Uso della console python per preparare mappe offline da WMS (scaricatore di
  mattonelle)
type: case-study
...
## Uso di QGIS
QGIS offre uno strumento per connettersi e accedere a qualsiasi servizio WMS. La connessione WMS si basa su un semplice URL e, una volta stabilita la connessione, la mappa può essere visualizzata nella vista mappa di QGIS. Se si salva la mappa dell’estensione visibile dalla vista mappa di QGIS in formato jpg (File \> Salva come immagine), viene creato un file world contenente le coordinate geografiche di quella specifica regione. Ad esempio, sample.jpg è la mappa e sample.jpgw contiene le coordinate. Ciò significa che l’immagine scaricata è georeferenziata. È possibile scaricare manualmente i tasselli in formato raster e utilizzarle in seguito offline. Il download manuale è consigliabile se l’area è molto piccola o se sono sufficienti immagini a bassa risoluzione.
