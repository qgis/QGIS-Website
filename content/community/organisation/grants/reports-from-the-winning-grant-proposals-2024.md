...
# Source: https://blog.qgis.org/2025/02/07/reports-from-the-winning-grant-proposals-2024/
# To update: Run 'scripts/fetch_grants.py' (automated nightly via GitHub Actions)
# See CONTRIBUTING.md section: Automated Content and Manual Edit Guidelines

title: "Reports from the winning grant proposals 2024"
date: "2025-02-07"
description: "With the QGIS Grant Programme 2024 (Updates #1 & #2), we were able to support 7 enhancement proposals that improve…"
...
<p><a href="https://blog.qgis.org/2025/02/07/reports-from-the-winning-grant-proposals-2024/" target="_blank" rel="noopener noreferrer">View original post on blog.qgis.org ↗</a></p>
