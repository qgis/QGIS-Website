...
test('resources pages', async ({ page }) => {
  ...
  await expect(page.getByText('QGIS.org, |yeartag|. QGIS Geographic Information System. QGIS Association. http')).toBeVisible();
  ...
  await expect(page.getByText('QGIS.org, |yeartag|. QGIS |').first()).toBeVisible();
  await expect(page.getByText('Cite the QGIS Installation')).toBeVisible();
  await expect(page.getByText('QGIS.org, |yeartag|. QGIS |').nth(1)).toBeVisible();
  ...
  await expect(page.getByText('QGIS.org, |yeartag|. QGIS |ltrversion|. Geographic Information System User')).toBeVisible();
  await expect(page.getByText('Cite the QGIS Server')).toBeVisible();
  await expect(page.getByText('QGIS.org, |yeartag|. QGIS |').nth(3)).toBeVisible();
  await expect(page.getByText('Cite the QGIS API')).toBeVisible();
  await expect(page.getByText('QGIS.org, |yeartag|. QGIS |').nth(4)).toBeVisible();
